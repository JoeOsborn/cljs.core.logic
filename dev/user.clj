(ns user
  ...
  (:require
   ...
   [cemerick.austin]
   [cemerick.austin.repls :refer [browser-repl-env exec]]
...
(defn browser-connected-repl-js
  []
  (let [repl-url (:repl-url @browser-repl-env)]
    (format ";goog.require('clojure.browser.repl');clojure.browser.repl.connect.call(null, '%s');" repl-url)))
