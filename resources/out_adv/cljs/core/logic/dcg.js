...
var __GT_lcons = null;
var __GT_lcons__3 = (function (env,p__34474,i){var vec__34478 = p__34474;var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,0,null);var c = vec__34478;return __GT_lcons.cljs$core$IFn$_invoke$arity$4(env,c,i,false);
});
var __GT_lcons__4 = (function (env,p__34475,i,quoted){var vec__34479 = p__34475;var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34479,0,null);var c = vec__34479;if(cljs.core.empty_QMARK_(c))
...
__GT_lcons = function(env,p__34475,i,quoted){
switch(arguments.length){
case 3:
return __GT_lcons__3.call(this,env,p__34475,i);
case 4:
return __GT_lcons__4.call(this,env,p__34475,i,quoted);
}
...
cljs.core.logic.dcg._BANG_dcg_QMARK_ = (function _BANG_dcg_QMARK_(clause){var and__9611__auto__ = cljs.core.sequential_QMARK_(clause);if(and__9611__auto__)
...
cljs.core.logic.dcg.fresh_expr_QMARK_ = (function fresh_expr_QMARK_(clause){var and__9611__auto__ = cljs.core.seq_QMARK_(clause);if(and__9611__auto__)
...
var mark_clauses__2 = (function (p__34480,i){var vec__34482 = p__34480;var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34482,0,null);var r = cljs.core.nthnext(vec__34482,1);var cs = vec__34482;if((cljs.core.seq(cs) == null))
...
mark_clauses = function(p__34480,i){
switch(arguments.length){
case 1:
return mark_clauses__1.call(this,p__34480);
case 2:
return mark_clauses__2.call(this,p__34480,i);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;
cljs.core.logic.dcg.handle_clauses = (function handle_clauses(env,p__34483){var vec__34485 = p__34483;var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34485,0,null);var r = cljs.core.nthnext(vec__34485,1);var cs = vec__34485;if((cljs.core.seq(cs) == null))
{return cljs.core.List.EMPTY;
} else
{if(cljs.core.logic.dcg.fresh_expr_QMARK_(c))
