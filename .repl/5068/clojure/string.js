...
{{
var G__17280 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17280;
continue;
}
} else
...
{var pred__17284 = cljs.core._EQ_;var expr__17285 = limit;if(pred__17284.call(null,1,expr__17285))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__17284.call(null,2,expr__17285))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__17287 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17288 = (limit__$1 - 1);
var G__17289 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17287;
limit__$1 = G__17288;
parts = G__17289;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___17291 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___17291))
{var replacement_17292 = temp__4092__auto___17291;buffer.append([cljs.core.str(replacement_17292)].join(''));
} else
{buffer.append(ch);
}
{
var G__17293 = (index + 1);
index = G__17293;
continue;
}
}
