...
reader_error.cljs$lang$applyTo = (function (arglist__17249){
var rdr = cljs.core.first(arglist__17249);
var msg = cljs.core.rest(arglist__17249);
...
{{
var G__17250 = (function (){sb.append(ch);
return sb;
})();
var G__17251 = cljs.reader.read_char.call(null,rdr);
sb = G__17250;
ch = G__17251;
continue;
}
...
{{
var G__17252 = cljs.reader.read_char.call(null,rdr);
ch = G__17252;
continue;
}
} else
...
var G__17253 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__17253;
continue;
}
} else
...
var G__17254 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__17254;
continue;
}
}
...
{{
var G__17255 = (function (){buffer.append(ch);
return buffer;
})();
var G__17256 = cljs.reader.read_char.call(null,reader);
buffer = G__17255;
ch = G__17256;
continue;
}
...
{if(("\\" === ch))
{{
var G__17257 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__17258 = cljs.reader.read_char.call(null,reader);
buffer = G__17257;
ch = G__17258;
continue;
}
...
{{
var G__17259 = (function (){buffer.append(ch);
return buffer;
})();
var G__17260 = cljs.reader.read_char.call(null,reader);
buffer = G__17259;
ch = G__17260;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__17262 = o;if(G__17262)
{var bit__5323__auto__ = (G__17262.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__17262.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__17262.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__17262);
} else
{return false;
}
}
...
{{
var G__17263 = reader;
var G__17264 = eof_is_error;
var G__17265 = sentinel;
var G__17266 = is_recursive;
reader = G__17263;
eof_is_error = G__17264;
sentinel = G__17265;
is_recursive = G__17266;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__17267 = cljs.reader.read_comment.call(null,reader,ch);
var G__17268 = eof_is_error;
var G__17269 = sentinel;
var G__17270 = is_recursive;
reader = G__17267;
eof_is_error = G__17268;
sentinel = G__17269;
is_recursive = G__17270;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__17271 = reader;
var G__17272 = eof_is_error;
var G__17273 = sentinel;
var G__17274 = is_recursive;
reader = G__17271;
eof_is_error = G__17272;
sentinel = G__17273;
is_recursive = G__17274;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__17277 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__17277,0,null);var years = cljs.core.nth.call(null,vec__17277,1,null);var months = cljs.core.nth.call(null,vec__17277,2,null);var days = cljs.core.nth.call(null,vec__17277,3,null);var hours = cljs.core.nth.call(null,vec__17277,4,null);var minutes = cljs.core.nth.call(null,vec__17277,5,null);var seconds = cljs.core.nth.call(null,vec__17277,6,null);var fraction = cljs.core.nth.call(null,vec__17277,7,null);var offset_sign = cljs.core.nth.call(null,vec__17277,8,null);var offset_hours = cljs.core.nth.call(null,vec__17277,9,null);var offset_minutes = cljs.core.nth.call(null,vec__17277,10,null);var v = vec__17277;if(cljs.core.not.call(null,v))
...
{var vec__17279 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__17279,0,null);var months = cljs.core.nth.call(null,vec__17279,1,null);var days = cljs.core.nth.call(null,vec__17279,2,null);var hours = cljs.core.nth.call(null,vec__17279,3,null);var minutes = cljs.core.nth.call(null,vec__17279,4,null);var seconds = cljs.core.nth.call(null,vec__17279,5,null);var ms = cljs.core.nth.call(null,vec__17279,6,null);var offset = cljs.core.nth.call(null,vec__17279,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
