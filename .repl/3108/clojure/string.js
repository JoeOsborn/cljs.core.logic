...
{{
var G__333697 = cljs.core.pop.call(null,v__$1);
v__$1 = G__333697;
continue;
}
} else
...
{var pred__333701 = cljs.core._EQ_;var expr__333702 = limit;if(cljs.core.truth_(pred__333701.call(null,1,expr__333702)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__333701.call(null,2,expr__333702)))
...
var G__333704 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__333705 = (limit__$1 - 1);
var G__333706 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__333704;
limit__$1 = G__333705;
parts = G__333706;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___333708 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___333708))
{var replacement_333709 = temp__4096__auto___333708;buffer.append([cljs.core.str(replacement_333709)].join(''));
} else
{buffer.append(ch);
}
{
var G__333710 = (index + 1);
index = G__333710;
continue;
}
}
