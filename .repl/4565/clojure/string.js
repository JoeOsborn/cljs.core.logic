...
{{
var G__186641 = cljs.core.pop.call(null,v__$1);
v__$1 = G__186641;
continue;
}
} else
...
{var pred__186645 = cljs.core._EQ_;var expr__186646 = limit;if(pred__186645.call(null,1,expr__186646))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__186645.call(null,2,expr__186646))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__186648 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__186649 = (limit__$1 - 1);
var G__186650 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__186648;
limit__$1 = G__186649;
parts = G__186650;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___186652 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___186652))
{var replacement_186653 = temp__4092__auto___186652;buffer.append([cljs.core.str(replacement_186653)].join(''));
} else
{buffer.append(ch);
}
{
var G__186654 = (index + 1);
index = G__186654;
continue;
}
}
