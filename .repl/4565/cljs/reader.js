...
reader_error.cljs$lang$applyTo = (function (arglist__186937){
var rdr = cljs.core.first(arglist__186937);
var msg = cljs.core.rest(arglist__186937);
...
{{
var G__186938 = (function (){sb.append(ch);
return sb;
})();
var G__186939 = cljs.reader.read_char.call(null,rdr);
sb = G__186938;
ch = G__186939;
continue;
}
...
{{
var G__186940 = cljs.reader.read_char.call(null,rdr);
ch = G__186940;
continue;
}
} else
...
var G__186941 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__186941;
continue;
}
} else
...
var G__186942 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__186942;
continue;
}
}
...
{{
var G__186943 = (function (){buffer.append(ch);
return buffer;
})();
var G__186944 = cljs.reader.read_char.call(null,reader);
buffer = G__186943;
ch = G__186944;
continue;
}
...
{if(("\\" === ch))
{{
var G__186945 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__186946 = cljs.reader.read_char.call(null,reader);
buffer = G__186945;
ch = G__186946;
continue;
}
...
{{
var G__186947 = (function (){buffer.append(ch);
return buffer;
})();
var G__186948 = cljs.reader.read_char.call(null,reader);
buffer = G__186947;
ch = G__186948;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__186950 = o;if(G__186950)
{var bit__5323__auto__ = (G__186950.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__186950.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__186950.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__186950);
} else
{return false;
}
}
...
{{
var G__186951 = reader;
var G__186952 = eof_is_error;
var G__186953 = sentinel;
var G__186954 = is_recursive;
reader = G__186951;
eof_is_error = G__186952;
sentinel = G__186953;
is_recursive = G__186954;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__186955 = cljs.reader.read_comment.call(null,reader,ch);
var G__186956 = eof_is_error;
var G__186957 = sentinel;
var G__186958 = is_recursive;
reader = G__186955;
eof_is_error = G__186956;
sentinel = G__186957;
is_recursive = G__186958;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__186959 = reader;
var G__186960 = eof_is_error;
var G__186961 = sentinel;
var G__186962 = is_recursive;
reader = G__186959;
eof_is_error = G__186960;
sentinel = G__186961;
is_recursive = G__186962;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__186965 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__186965,0,null);var years = cljs.core.nth.call(null,vec__186965,1,null);var months = cljs.core.nth.call(null,vec__186965,2,null);var days = cljs.core.nth.call(null,vec__186965,3,null);var hours = cljs.core.nth.call(null,vec__186965,4,null);var minutes = cljs.core.nth.call(null,vec__186965,5,null);var seconds = cljs.core.nth.call(null,vec__186965,6,null);var fraction = cljs.core.nth.call(null,vec__186965,7,null);var offset_sign = cljs.core.nth.call(null,vec__186965,8,null);var offset_hours = cljs.core.nth.call(null,vec__186965,9,null);var offset_minutes = cljs.core.nth.call(null,vec__186965,10,null);var v = vec__186965;if(cljs.core.not.call(null,v))
...
{var vec__186967 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__186967,0,null);var months = cljs.core.nth.call(null,vec__186967,1,null);var days = cljs.core.nth.call(null,vec__186967,2,null);var hours = cljs.core.nth.call(null,vec__186967,3,null);var minutes = cljs.core.nth.call(null,vec__186967,4,null);var seconds = cljs.core.nth.call(null,vec__186967,5,null);var ms = cljs.core.nth.call(null,vec__186967,6,null);var offset = cljs.core.nth.call(null,vec__186967,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
