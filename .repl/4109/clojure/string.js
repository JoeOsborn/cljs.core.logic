...
{{
var G__136643 = cljs.core.pop.call(null,v__$1);
v__$1 = G__136643;
continue;
}
} else
...
{var pred__136647 = cljs.core._EQ_;var expr__136648 = limit;if(cljs.core.truth_(pred__136647.call(null,1,expr__136648)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__136647.call(null,2,expr__136648)))
...
var G__136650 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__136651 = (limit__$1 - 1);
var G__136652 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__136650;
limit__$1 = G__136651;
parts = G__136652;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___136654 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___136654))
{var replacement_136655 = temp__4096__auto___136654;buffer.append([cljs.core.str(replacement_136655)].join(''));
} else
{buffer.append(ch);
}
{
var G__136656 = (index + 1);
index = G__136656;
continue;
}
}
