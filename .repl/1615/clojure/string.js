...
{{
var G__196801 = cljs.core.pop.call(null,v__$1);
v__$1 = G__196801;
continue;
}
} else
...
{var pred__196805 = cljs.core._EQ_;var expr__196806 = limit;if(cljs.core.truth_(pred__196805.call(null,1,expr__196806)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__196805.call(null,2,expr__196806)))
...
var G__196808 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__196809 = (limit__$1 - 1);
var G__196810 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__196808;
limit__$1 = G__196809;
parts = G__196810;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___196812 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___196812))
{var replacement_196813 = temp__4096__auto___196812;buffer.append([cljs.core.str(replacement_196813)].join(''));
} else
{buffer.append(ch);
}
{
var G__196814 = (index + 1);
index = G__196814;
continue;
}
}
