...
reader_error.cljs$lang$applyTo = (function (arglist__9651){
var rdr = cljs.core.first(arglist__9651);
var msg = cljs.core.rest(arglist__9651);
...
{{
var G__9652 = (function (){sb.append(ch);
return sb;
})();
...
{{
var G__9654 = cljs.reader.read_char.call(null,rdr);
ch = G__9654;
continue;
}
} else
...
var G__9655 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9655;
continue;
}
} else
...
var G__9656 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9656;
continue;
}
}
...
{{
var G__9657 = (function (){buffer.append(ch);
return buffer;
})();
var G__9658 = cljs.reader.read_char.call(null,reader);
buffer = G__9657;
ch = G__9658;
continue;
}
...
{if(("\\" === ch))
{{
var G__9659 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9660 = cljs.reader.read_char.call(null,reader);
buffer = G__9659;
ch = G__9660;
continue;
}
...
{{
var G__9661 = (function (){buffer.append(ch);
return buffer;
})();
var G__9662 = cljs.reader.read_char.call(null,reader);
buffer = G__9661;
ch = G__9662;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9664 = o;if(G__9664)
{var bit__5323__auto__ = (G__9664.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9664.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9664.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9664);
} else
{return false;
}
}
...
{{
var G__9665 = reader;
var G__9666 = eof_is_error;
var G__9667 = sentinel;
var G__9668 = is_recursive;
reader = G__9665;
eof_is_error = G__9666;
sentinel = G__9667;
is_recursive = G__9668;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9669 = cljs.reader.read_comment.call(null,reader,ch);
var G__9670 = eof_is_error;
var G__9671 = sentinel;
var G__9672 = is_recursive;
reader = G__9669;
eof_is_error = G__9670;
sentinel = G__9671;
is_recursive = G__9672;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9673 = reader;
var G__9674 = eof_is_error;
var G__9675 = sentinel;
var G__9676 = is_recursive;
reader = G__9673;
eof_is_error = G__9674;
sentinel = G__9675;
is_recursive = G__9676;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9679 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9679,0,null);var years = cljs.core.nth.call(null,vec__9679,1,null);var months = cljs.core.nth.call(null,vec__9679,2,null);var days = cljs.core.nth.call(null,vec__9679,3,null);var hours = cljs.core.nth.call(null,vec__9679,4,null);var minutes = cljs.core.nth.call(null,vec__9679,5,null);var seconds = cljs.core.nth.call(null,vec__9679,6,null);var fraction = cljs.core.nth.call(null,vec__9679,7,null);var offset_sign = cljs.core.nth.call(null,vec__9679,8,null);var offset_hours = cljs.core.nth.call(null,vec__9679,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9679,10,null);var v = vec__9679;if(cljs.core.not.call(null,v))
...
{var vec__9681 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9681,0,null);var months = cljs.core.nth.call(null,vec__9681,1,null);var days = cljs.core.nth.call(null,vec__9681,2,null);var hours = cljs.core.nth.call(null,vec__9681,3,null);var minutes = cljs.core.nth.call(null,vec__9681,4,null);var seconds = cljs.core.nth.call(null,vec__9681,5,null);var ms = cljs.core.nth.call(null,vec__9681,6,null);var offset = cljs.core.nth.call(null,vec__9681,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
