...
{{
var G__9682 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9682;
continue;
}
} else
...
{var pred__9686 = cljs.core._EQ_;var expr__9687 = limit;if(pred__9686.call(null,1,expr__9687))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9686.call(null,2,expr__9687))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9689 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9690 = (limit__$1 - 1);
var G__9691 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9689;
limit__$1 = G__9690;
parts = G__9691;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9693 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9693))
{var replacement_9694 = temp__4092__auto___9693;buffer.append([cljs.core.str(replacement_9694)].join(''));
} else
{buffer.append(ch);
}
{
