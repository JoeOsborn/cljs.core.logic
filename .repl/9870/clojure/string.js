...
{{
var G__100771 = cljs.core.pop.call(null,v__$1);
v__$1 = G__100771;
continue;
}
} else
...
{var pred__100775 = cljs.core._EQ_;var expr__100776 = limit;if(pred__100775.call(null,1,expr__100776))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__100775.call(null,2,expr__100776))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__100778 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__100779 = (limit__$1 - 1);
var G__100780 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__100778;
limit__$1 = G__100779;
parts = G__100780;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___100782 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___100782))
{var replacement_100783 = temp__4092__auto___100782;buffer.append([cljs.core.str(replacement_100783)].join(''));
} else
{buffer.append(ch);
}
{
var G__100784 = (index + 1);
index = G__100784;
continue;
}
}
