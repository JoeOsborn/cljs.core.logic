...
reader_error.cljs$lang$applyTo = (function (arglist__100740){
var rdr = cljs.core.first(arglist__100740);
var msg = cljs.core.rest(arglist__100740);
...
{{
var G__100741 = (function (){sb.append(ch);
return sb;
})();
var G__100742 = cljs.reader.read_char.call(null,rdr);
sb = G__100741;
ch = G__100742;
continue;
}
...
{{
var G__100743 = cljs.reader.read_char.call(null,rdr);
ch = G__100743;
continue;
}
} else
...
var G__100744 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__100744;
continue;
}
} else
...
var G__100745 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__100745;
continue;
}
}
...
{{
var G__100746 = (function (){buffer.append(ch);
return buffer;
})();
var G__100747 = cljs.reader.read_char.call(null,reader);
buffer = G__100746;
ch = G__100747;
continue;
}
...
{if(("\\" === ch))
{{
var G__100748 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__100749 = cljs.reader.read_char.call(null,reader);
buffer = G__100748;
ch = G__100749;
continue;
}
...
{{
var G__100750 = (function (){buffer.append(ch);
return buffer;
})();
var G__100751 = cljs.reader.read_char.call(null,reader);
buffer = G__100750;
ch = G__100751;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__100753 = o;if(G__100753)
{var bit__5323__auto__ = (G__100753.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__100753.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__100753.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__100753);
} else
{return false;
}
}
...
{{
var G__100754 = reader;
var G__100755 = eof_is_error;
var G__100756 = sentinel;
var G__100757 = is_recursive;
reader = G__100754;
eof_is_error = G__100755;
sentinel = G__100756;
is_recursive = G__100757;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__100758 = cljs.reader.read_comment.call(null,reader,ch);
var G__100759 = eof_is_error;
var G__100760 = sentinel;
var G__100761 = is_recursive;
reader = G__100758;
eof_is_error = G__100759;
sentinel = G__100760;
is_recursive = G__100761;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__100762 = reader;
var G__100763 = eof_is_error;
var G__100764 = sentinel;
var G__100765 = is_recursive;
reader = G__100762;
eof_is_error = G__100763;
sentinel = G__100764;
is_recursive = G__100765;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__100768 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__100768,0,null);var years = cljs.core.nth.call(null,vec__100768,1,null);var months = cljs.core.nth.call(null,vec__100768,2,null);var days = cljs.core.nth.call(null,vec__100768,3,null);var hours = cljs.core.nth.call(null,vec__100768,4,null);var minutes = cljs.core.nth.call(null,vec__100768,5,null);var seconds = cljs.core.nth.call(null,vec__100768,6,null);var fraction = cljs.core.nth.call(null,vec__100768,7,null);var offset_sign = cljs.core.nth.call(null,vec__100768,8,null);var offset_hours = cljs.core.nth.call(null,vec__100768,9,null);var offset_minutes = cljs.core.nth.call(null,vec__100768,10,null);var v = vec__100768;if(cljs.core.not.call(null,v))
...
{var vec__100770 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__100770,0,null);var months = cljs.core.nth.call(null,vec__100770,1,null);var days = cljs.core.nth.call(null,vec__100770,2,null);var hours = cljs.core.nth.call(null,vec__100770,3,null);var minutes = cljs.core.nth.call(null,vec__100770,4,null);var seconds = cljs.core.nth.call(null,vec__100770,5,null);var ms = cljs.core.nth.call(null,vec__100770,6,null);var offset = cljs.core.nth.call(null,vec__100770,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
