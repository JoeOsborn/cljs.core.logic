...
{{
var G__507781 = cljs.core.pop.call(null,v__$1);
v__$1 = G__507781;
continue;
}
} else
...
{var pred__507785 = cljs.core._EQ_;var expr__507786 = limit;if(cljs.core.truth_(pred__507785.call(null,1,expr__507786)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__507785.call(null,2,expr__507786)))
...
var G__507788 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__507789 = (limit__$1 - 1);
var G__507790 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__507788;
limit__$1 = G__507789;
parts = G__507790;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___507792 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___507792))
{var replacement_507793 = temp__4096__auto___507792;buffer.append([cljs.core.str(replacement_507793)].join(''));
} else
{buffer.append(ch);
}
{
var G__507794 = (index + 1);
index = G__507794;
continue;
}
}
