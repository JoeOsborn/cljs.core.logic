...
{{
var G__9301 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9301;
continue;
}
} else
...
{var pred__9305 = cljs.core._EQ_;var expr__9306 = limit;if(pred__9305.call(null,1,expr__9306))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9305.call(null,2,expr__9306))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9308 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9309 = (limit__$1 - 1);
var G__9310 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9308;
limit__$1 = G__9309;
parts = G__9310;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9312 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9312))
{var replacement_9313 = temp__4092__auto___9312;buffer.append([cljs.core.str(replacement_9313)].join(''));
} else
{buffer.append(ch);
}
{
