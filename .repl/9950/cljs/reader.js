...
reader_error.cljs$lang$applyTo = (function (arglist__9270){
var rdr = cljs.core.first(arglist__9270);
var msg = cljs.core.rest(arglist__9270);
...
{{
var G__9271 = (function (){sb.append(ch);
return sb;
})();
...
{{
var G__9273 = cljs.reader.read_char.call(null,rdr);
ch = G__9273;
continue;
}
} else
...
var G__9274 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9274;
continue;
}
} else
...
var G__9275 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9275;
continue;
}
}
...
{{
var G__9276 = (function (){buffer.append(ch);
return buffer;
})();
var G__9277 = cljs.reader.read_char.call(null,reader);
buffer = G__9276;
ch = G__9277;
continue;
}
...
{if(("\\" === ch))
{{
var G__9278 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__9280 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9283 = o;if(G__9283)
{var bit__5323__auto__ = (G__9283.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9283.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9283.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9283);
} else
{return false;
}
}
...
{{
var G__9284 = reader;
var G__9285 = eof_is_error;
var G__9286 = sentinel;
var G__9287 = is_recursive;
reader = G__9284;
eof_is_error = G__9285;
sentinel = G__9286;
is_recursive = G__9287;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9288 = cljs.reader.read_comment.call(null,reader,ch);
var G__9289 = eof_is_error;
var G__9290 = sentinel;
var G__9291 = is_recursive;
reader = G__9288;
eof_is_error = G__9289;
sentinel = G__9290;
is_recursive = G__9291;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9292 = reader;
var G__9293 = eof_is_error;
var G__9294 = sentinel;
var G__9295 = is_recursive;
reader = G__9292;
eof_is_error = G__9293;
sentinel = G__9294;
is_recursive = G__9295;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9298 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9298,0,null);var years = cljs.core.nth.call(null,vec__9298,1,null);var months = cljs.core.nth.call(null,vec__9298,2,null);var days = cljs.core.nth.call(null,vec__9298,3,null);var hours = cljs.core.nth.call(null,vec__9298,4,null);var minutes = cljs.core.nth.call(null,vec__9298,5,null);var seconds = cljs.core.nth.call(null,vec__9298,6,null);var fraction = cljs.core.nth.call(null,vec__9298,7,null);var offset_sign = cljs.core.nth.call(null,vec__9298,8,null);var offset_hours = cljs.core.nth.call(null,vec__9298,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9298,10,null);var v = vec__9298;if(cljs.core.not.call(null,v))
...
{var vec__9300 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9300,0,null);var months = cljs.core.nth.call(null,vec__9300,1,null);var days = cljs.core.nth.call(null,vec__9300,2,null);var hours = cljs.core.nth.call(null,vec__9300,3,null);var minutes = cljs.core.nth.call(null,vec__9300,4,null);var seconds = cljs.core.nth.call(null,vec__9300,5,null);var ms = cljs.core.nth.call(null,vec__9300,6,null);var offset = cljs.core.nth.call(null,vec__9300,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
