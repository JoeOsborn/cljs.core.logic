...
{{
var G__16195 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16195;
continue;
}
} else
...
{var pred__16199 = cljs.core._EQ_;var expr__16200 = limit;if(cljs.core.truth_(pred__16199.call(null,1,expr__16200)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16199.call(null,2,expr__16200)))
...
var G__16202 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16203 = (limit__$1 - 1);
var G__16204 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16202;
limit__$1 = G__16203;
parts = G__16204;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___16206 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___16206))
{var replacement_16207 = temp__4096__auto___16206;buffer.append([cljs.core.str(replacement_16207)].join(''));
} else
{buffer.append(ch);
}
{
var G__16208 = (index + 1);
index = G__16208;
continue;
}
}
