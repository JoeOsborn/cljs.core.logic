...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj16609 = {};return obj16609;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__16610){
var rdr = cljs.core.first(arglist__16610);
var msg = cljs.core.rest(arglist__16610);
...
{{
var G__16611 = (function (){sb.append(ch);
return sb;
})();
var G__16612 = cljs.reader.read_char.call(null,rdr);
sb = G__16611;
ch = G__16612;
continue;
}
...
{{
var G__16613 = cljs.reader.read_char.call(null,rdr);
ch = G__16613;
continue;
}
} else
...
var G__16614 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__16614;
continue;
}
} else
...
var G__16615 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__16615;
continue;
}
}
...
{{
var G__16616 = (function (){buffer.append(ch);
return buffer;
})();
var G__16617 = cljs.reader.read_char.call(null,reader);
buffer = G__16616;
ch = G__16617;
continue;
}
...
{if(("\\" === ch))
{{
var G__16618 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__16620 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__16623 = o;if(G__16623)
{var bit__11683__auto__ = (G__16623.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11683__auto__) || (G__16623.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__16623.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__16623);
} else
{return false;
}
}
...
{{
var G__16624 = reader;
var G__16625 = eof_is_error;
var G__16626 = sentinel;
var G__16627 = is_recursive;
reader = G__16624;
eof_is_error = G__16625;
sentinel = G__16626;
is_recursive = G__16627;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__16628 = cljs.reader.read_comment.call(null,reader,ch);
var G__16629 = eof_is_error;
var G__16630 = sentinel;
var G__16631 = is_recursive;
reader = G__16628;
eof_is_error = G__16629;
sentinel = G__16630;
is_recursive = G__16631;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__16632 = reader;
var G__16633 = eof_is_error;
var G__16634 = sentinel;
var G__16635 = is_recursive;
reader = G__16632;
eof_is_error = G__16633;
sentinel = G__16634;
is_recursive = G__16635;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__16638 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__16638,0,null);var years = cljs.core.nth.call(null,vec__16638,1,null);var months = cljs.core.nth.call(null,vec__16638,2,null);var days = cljs.core.nth.call(null,vec__16638,3,null);var hours = cljs.core.nth.call(null,vec__16638,4,null);var minutes = cljs.core.nth.call(null,vec__16638,5,null);var seconds = cljs.core.nth.call(null,vec__16638,6,null);var fraction = cljs.core.nth.call(null,vec__16638,7,null);var offset_sign = cljs.core.nth.call(null,vec__16638,8,null);var offset_hours = cljs.core.nth.call(null,vec__16638,9,null);var offset_minutes = cljs.core.nth.call(null,vec__16638,10,null);var v = vec__16638;if(cljs.core.not.call(null,v))
...
{var vec__16640 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__16640,0,null);var months = cljs.core.nth.call(null,vec__16640,1,null);var days = cljs.core.nth.call(null,vec__16640,2,null);var hours = cljs.core.nth.call(null,vec__16640,3,null);var minutes = cljs.core.nth.call(null,vec__16640,4,null);var seconds = cljs.core.nth.call(null,vec__16640,5,null);var ms = cljs.core.nth.call(null,vec__16640,6,null);var offset = cljs.core.nth.call(null,vec__16640,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
