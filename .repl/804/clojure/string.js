...
{{
var G__9261 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9261;
continue;
}
} else
...
{var pred__9265 = cljs.core._EQ_;var expr__9266 = limit;if(pred__9265.call(null,1,expr__9266))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9265.call(null,2,expr__9266))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9268 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9269 = (limit__$1 - 1);
var G__9270 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9268;
limit__$1 = G__9269;
parts = G__9270;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9272 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9272))
{var replacement_9273 = temp__4092__auto___9272;buffer.append([cljs.core.str(replacement_9273)].join(''));
} else
{buffer.append(ch);
}
{
