...
{{
var G__18957 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18957;
continue;
}
} else
...
{var pred__18961 = cljs.core._EQ_;var expr__18962 = limit;if(pred__18961.call(null,1,expr__18962))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__18961.call(null,2,expr__18962))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__18964 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18965 = (limit__$1 - 1);
var G__18966 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18964;
limit__$1 = G__18965;
parts = G__18966;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___18968 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___18968))
{var replacement_18969 = temp__4092__auto___18968;buffer.append([cljs.core.str(replacement_18969)].join(''));
} else
{buffer.append(ch);
}
{
var G__18970 = (index + 1);
index = G__18970;
continue;
}
}
