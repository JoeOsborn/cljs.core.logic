...
reader_error.cljs$lang$applyTo = (function (arglist__18926){
var rdr = cljs.core.first(arglist__18926);
var msg = cljs.core.rest(arglist__18926);
...
{{
var G__18927 = (function (){sb.append(ch);
return sb;
})();
var G__18928 = cljs.reader.read_char.call(null,rdr);
sb = G__18927;
ch = G__18928;
continue;
}
...
{{
var G__18929 = cljs.reader.read_char.call(null,rdr);
ch = G__18929;
continue;
}
} else
...
var G__18930 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__18930;
continue;
}
} else
...
var G__18931 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__18931;
continue;
}
}
...
{{
var G__18932 = (function (){buffer.append(ch);
return buffer;
})();
var G__18933 = cljs.reader.read_char.call(null,reader);
buffer = G__18932;
ch = G__18933;
continue;
}
...
{if(("\\" === ch))
{{
var G__18934 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__18935 = cljs.reader.read_char.call(null,reader);
buffer = G__18934;
ch = G__18935;
continue;
}
...
{{
var G__18936 = (function (){buffer.append(ch);
return buffer;
})();
var G__18937 = cljs.reader.read_char.call(null,reader);
buffer = G__18936;
ch = G__18937;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__18939 = o;if(G__18939)
{var bit__5323__auto__ = (G__18939.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__18939.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__18939.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__18939);
} else
{return false;
}
}
...
{{
var G__18940 = reader;
var G__18941 = eof_is_error;
var G__18942 = sentinel;
var G__18943 = is_recursive;
reader = G__18940;
eof_is_error = G__18941;
sentinel = G__18942;
is_recursive = G__18943;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__18944 = cljs.reader.read_comment.call(null,reader,ch);
var G__18945 = eof_is_error;
var G__18946 = sentinel;
var G__18947 = is_recursive;
reader = G__18944;
eof_is_error = G__18945;
sentinel = G__18946;
is_recursive = G__18947;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__18948 = reader;
var G__18949 = eof_is_error;
var G__18950 = sentinel;
var G__18951 = is_recursive;
reader = G__18948;
eof_is_error = G__18949;
sentinel = G__18950;
is_recursive = G__18951;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__18954 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__18954,0,null);var years = cljs.core.nth.call(null,vec__18954,1,null);var months = cljs.core.nth.call(null,vec__18954,2,null);var days = cljs.core.nth.call(null,vec__18954,3,null);var hours = cljs.core.nth.call(null,vec__18954,4,null);var minutes = cljs.core.nth.call(null,vec__18954,5,null);var seconds = cljs.core.nth.call(null,vec__18954,6,null);var fraction = cljs.core.nth.call(null,vec__18954,7,null);var offset_sign = cljs.core.nth.call(null,vec__18954,8,null);var offset_hours = cljs.core.nth.call(null,vec__18954,9,null);var offset_minutes = cljs.core.nth.call(null,vec__18954,10,null);var v = vec__18954;if(cljs.core.not.call(null,v))
...
{var vec__18956 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__18956,0,null);var months = cljs.core.nth.call(null,vec__18956,1,null);var days = cljs.core.nth.call(null,vec__18956,2,null);var hours = cljs.core.nth.call(null,vec__18956,3,null);var minutes = cljs.core.nth.call(null,vec__18956,4,null);var seconds = cljs.core.nth.call(null,vec__18956,5,null);var ms = cljs.core.nth.call(null,vec__18956,6,null);var offset = cljs.core.nth.call(null,vec__18956,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
