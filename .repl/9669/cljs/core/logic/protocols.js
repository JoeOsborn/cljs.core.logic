...
cljs.core.logic.protocols.non_storable_QMARK_ = (function non_storable_QMARK_(x){var G__18915 = x;if(G__18915)
...
{return G__18915.cljs$core$logic$protocols$INonStorable$;
}
})()))
{return true;
} else
{if((!G__18915.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.INonStorable,G__18915);
} else
{return false;
}
}
...
cljs.core.logic.protocols.id = (function id(c){if((function (){var G__18917 = c;if(G__18917)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__18917.cljs$core$logic$protocols$IConstraintId$;
}
})()))
{return true;
} else
{if((!G__18917.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IConstraintId,G__18917);
} else
{return false;
}
}
...
cljs.core.logic.protocols.with_id = (function with_id(c,id){if((function (){var G__18919 = c;if(G__18919)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__18919.cljs$core$logic$protocols$IWithConstraintId$;
}
})()))
{return true;
} else
{if((!G__18919.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IWithConstraintId,G__18919);
} else
{return false;
}
}
...
cljs.core.logic.protocols.reifiable_QMARK_ = (function reifiable_QMARK_(x){var G__18921 = x;if(G__18921)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__18921.cljs$core$logic$protocols$IReifiableConstraint$;
}
})()))
{return true;
} else
{if((!G__18921.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IReifiableConstraint,G__18921);
} else
{return false;
}
}
...
cljs.core.logic.protocols.enforceable_QMARK_ = (function enforceable_QMARK_(x){var G__18923 = x;if(G__18923)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__18923.cljs$core$logic$protocols$IEnforceableConstraint$;
}
})()))
{return true;
} else
{if((!G__18923.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IEnforceableConstraint,G__18923);
} else
{return false;
}
}
...
cljs.core.logic.protocols.tree_constraint_QMARK_ = (function tree_constraint_QMARK_(x){var G__18925 = x;if(G__18925)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__18925.clojure$core$logic$protocols$ITreeConstraint$;
}
})()))
{return true;
} else
{if((!G__18925.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,clojure.core.logic.protocols.ITreeConstraint,G__18925);
} else
{return false;
}
}
