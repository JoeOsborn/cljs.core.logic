...
{{
var G__17860 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17860;
continue;
}
} else
...
{var pred__17864 = cljs.core._EQ_;var expr__17865 = limit;if(pred__17864.call(null,1,expr__17865))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__17864.call(null,2,expr__17865))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__17867 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17868 = (limit__$1 - 1);
var G__17869 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17867;
limit__$1 = G__17868;
parts = G__17869;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___17871 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___17871))
{var replacement_17872 = temp__4092__auto___17871;buffer.append([cljs.core.str(replacement_17872)].join(''));
} else
{buffer.append(ch);
}
{
var G__17873 = (index + 1);
index = G__17873;
continue;
}
}
