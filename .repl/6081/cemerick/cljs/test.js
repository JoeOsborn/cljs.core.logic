...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__62793 = m;var map__62793__$1 = ((cljs.core.seq_QMARK_.call(null,map__62793))?cljs.core.apply.call(null,cljs.core.hash_map,map__62793):map__62793);var line = cljs.core.get.call(null,map__62793__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__62793__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__62795 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__62795))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__62795))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_62796;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_62797 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_62797;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_62798 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___62799 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___62799))
{var message_62800 = temp__4098__auto___62799;cljs.core.println.call(null,message_62800);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_62798;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_62801 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___62802 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___62802))
{var message_62803 = temp__4098__auto___62802;cljs.core.println.call(null,message_62803);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_62801;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_62804 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_62804;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_62805 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_62805;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__62806){
var ns_sym = cljs.core.first(arglist__62806);
arglist__62806 = cljs.core.next(arglist__62806);
var fixture_type = cljs.core.first(arglist__62806);
var fixture_fns = cljs.core.rest(arglist__62806);
...
try{t.call(null);
}catch (e62810){if((e62810 instanceof Error))
{var e_62811 = e62810;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_62811], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e62810;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_62809;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__62816 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__62817 = null;var count__62818 = 0;var i__62819 = 0;while(true){
if((i__62819 < count__62818))
{var v = cljs.core._nth.call(null,chunk__62817,i__62819);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__62816,chunk__62817,count__62818,i__62819,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__62816,chunk__62817,count__62818,i__62819,v))
);
} else
{}
{
var G__62820 = seq__62816;
var G__62821 = chunk__62817;
var G__62822 = count__62818;
var G__62823 = (i__62819 + 1);
seq__62816 = G__62820;
chunk__62817 = G__62821;
count__62818 = G__62822;
i__62819 = G__62823;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__62816);if(temp__4098__auto__)
{var seq__62816__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__62816__$1))
{var c__11280__auto__ = cljs.core.chunk_first.call(null,seq__62816__$1);{
var G__62824 = cljs.core.chunk_rest.call(null,seq__62816__$1);
var G__62825 = c__11280__auto__;
var G__62826 = cljs.core.count.call(null,c__11280__auto__);
var G__62827 = 0;
seq__62816 = G__62824;
chunk__62817 = G__62825;
count__62818 = G__62826;
i__62819 = G__62827;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__62816__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__62816,chunk__62817,count__62818,i__62819,v,seq__62816__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__62816,chunk__62817,count__62818,i__62819,v,seq__62816__$1,temp__4098__auto__))
);
} else
{}
{
var G__62828 = cljs.core.next.call(null,seq__62816__$1);
var G__62829 = null;
var G__62830 = 0;
var G__62831 = 0;
seq__62816 = G__62828;
chunk__62817 = G__62829;
count__62818 = G__62830;
i__62819 = G__62831;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_62833 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___62834 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___62834))
{var test_hook_62835 = temp__4096__auto___62834;test_hook_62835.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_62833;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__62836){
var namespaces = cljs.core.seq(arglist__62836);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__62837_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__62837_SHARP_));
