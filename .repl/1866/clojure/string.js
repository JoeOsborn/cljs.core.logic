...
{{
var G__24323 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24323;
continue;
}
} else
...
{var pred__24327 = cljs.core._EQ_;var expr__24328 = limit;if(cljs.core.truth_(pred__24327.call(null,1,expr__24328)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24327.call(null,2,expr__24328)))
...
var G__24330 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24331 = (limit__$1 - 1);
var G__24332 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24330;
limit__$1 = G__24331;
parts = G__24332;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___24334 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___24334))
{var replacement_24335 = temp__4096__auto___24334;buffer.append([cljs.core.str(replacement_24335)].join(''));
} else
{buffer.append(ch);
}
{
var G__24336 = (index + 1);
index = G__24336;
continue;
}
}
