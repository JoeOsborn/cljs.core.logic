...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__147944 = m;var map__147944__$1 = ((cljs.core.seq_QMARK_.call(null,map__147944))?cljs.core.apply.call(null,cljs.core.hash_map,map__147944):map__147944);var line = cljs.core.get.call(null,map__147944__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__147944__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__147946 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__147946))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__147946))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_147947;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_147948 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_147948;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_147949 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___147950 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___147950))
{var message_147951 = temp__4098__auto___147950;cljs.core.println.call(null,message_147951);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_147949;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_147952 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___147953 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___147953))
{var message_147954 = temp__4098__auto___147953;cljs.core.println.call(null,message_147954);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_147955;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_147956 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_147956;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__147957){
var ns_sym = cljs.core.first(arglist__147957);
arglist__147957 = cljs.core.next(arglist__147957);
var fixture_type = cljs.core.first(arglist__147957);
var fixture_fns = cljs.core.rest(arglist__147957);
...
try{t.call(null);
}catch (e147961){if((e147961 instanceof Error))
{var e_147962 = e147961;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_147962], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e147961;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_147960;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__147967 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__147968 = null;var count__147969 = 0;var i__147970 = 0;while(true){
if((i__147970 < count__147969))
{var v = cljs.core._nth.call(null,chunk__147968,i__147970);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__147967,chunk__147968,count__147969,i__147970,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__147967,chunk__147968,count__147969,i__147970,v))
);
} else
{}
{
var G__147971 = seq__147967;
var G__147972 = chunk__147968;
var G__147973 = count__147969;
var G__147974 = (i__147970 + 1);
seq__147967 = G__147971;
chunk__147968 = G__147972;
count__147969 = G__147973;
i__147970 = G__147974;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__147967);if(temp__4098__auto__)
{var seq__147967__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__147967__$1))
{var c__11280__auto__ = cljs.core.chunk_first.call(null,seq__147967__$1);{
var G__147975 = cljs.core.chunk_rest.call(null,seq__147967__$1);
var G__147976 = c__11280__auto__;
var G__147977 = cljs.core.count.call(null,c__11280__auto__);
var G__147978 = 0;
seq__147967 = G__147975;
chunk__147968 = G__147976;
count__147969 = G__147977;
i__147970 = G__147978;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__147967__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__147967,chunk__147968,count__147969,i__147970,v,seq__147967__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__147967,chunk__147968,count__147969,i__147970,v,seq__147967__$1,temp__4098__auto__))
);
} else
{}
{
var G__147979 = cljs.core.next.call(null,seq__147967__$1);
var G__147980 = null;
var G__147981 = 0;
var G__147982 = 0;
seq__147967 = G__147979;
chunk__147968 = G__147980;
count__147969 = G__147981;
i__147970 = G__147982;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_147984 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___147985 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___147985))
{var test_hook_147986 = temp__4096__auto___147985;test_hook_147986.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_147984;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__147987){
var namespaces = cljs.core.seq(arglist__147987);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__147988_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__147988_SHARP_));
