...
{{
var G__147507 = cljs.core.pop.call(null,v__$1);
v__$1 = G__147507;
continue;
}
} else
...
{var pred__147511 = cljs.core._EQ_;var expr__147512 = limit;if(cljs.core.truth_(pred__147511.call(null,1,expr__147512)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__147511.call(null,2,expr__147512)))
...
var G__147514 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__147515 = (limit__$1 - 1);
var G__147516 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__147514;
limit__$1 = G__147515;
parts = G__147516;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___147518 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___147518))
{var replacement_147519 = temp__4096__auto___147518;buffer.append([cljs.core.str(replacement_147519)].join(''));
} else
{buffer.append(ch);
}
{
var G__147520 = (index + 1);
index = G__147520;
continue;
}
}
