...
{{
var G__74342 = cljs.core.pop.call(null,v__$1);
v__$1 = G__74342;
continue;
}
} else
...
{var pred__74346 = cljs.core._EQ_;var expr__74347 = limit;if(pred__74346.call(null,1,expr__74347))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__74346.call(null,2,expr__74347))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__74349 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__74350 = (limit__$1 - 1);
var G__74351 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__74349;
limit__$1 = G__74350;
parts = G__74351;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___74353 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___74353))
{var replacement_74354 = temp__4092__auto___74353;buffer.append([cljs.core.str(replacement_74354)].join(''));
} else
{buffer.append(ch);
}
{
var G__74355 = (index + 1);
index = G__74355;
continue;
}
}
