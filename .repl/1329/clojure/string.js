...
{{
var G__309792 = cljs.core.pop.call(null,v__$1);
v__$1 = G__309792;
continue;
}
} else
...
{var pred__309799 = cljs.core._EQ_;var expr__309800 = limit;if(pred__309799.call(null,1,expr__309800))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__309799.call(null,2,expr__309800))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__309802 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__309803 = (limit__$1 - 1);
var G__309804 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__309802;
limit__$1 = G__309803;
parts = G__309804;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___309812 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___309812))
{var replacement_309813 = temp__4092__auto___309812;buffer.append([cljs.core.str(replacement_309813)].join(''));
} else
{buffer.append(ch);
}
{
var G__309814 = (index + 1);
index = G__309814;
continue;
}
}
