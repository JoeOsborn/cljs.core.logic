...
{{
var G__33332 = cljs.core.pop.call(null,v__$1);
v__$1 = G__33332;
continue;
}
} else
...
{var pred__33336 = cljs.core._EQ_;var expr__33337 = limit;if(pred__33336.call(null,1,expr__33337))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__33336.call(null,2,expr__33337))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__33339 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__33340 = (limit__$1 - 1);
var G__33341 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__33339;
limit__$1 = G__33340;
parts = G__33341;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___33343 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___33343))
{var replacement_33344 = temp__4092__auto___33343;buffer.append([cljs.core.str(replacement_33344)].join(''));
} else
{buffer.append(ch);
}
{
var G__33345 = (index + 1);
index = G__33345;
continue;
}
}
