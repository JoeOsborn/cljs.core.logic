...
{{
var G__51104 = cljs.core.pop.call(null,v__$1);
v__$1 = G__51104;
continue;
}
} else
...
{var pred__51108 = cljs.core._EQ_;var expr__51109 = limit;if(pred__51108.call(null,1,expr__51109))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__51108.call(null,2,expr__51109))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__51111 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__51112 = (limit__$1 - 1);
var G__51113 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__51111;
limit__$1 = G__51112;
parts = G__51113;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___51115 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___51115))
{var replacement_51116 = temp__4092__auto___51115;buffer.append([cljs.core.str(replacement_51116)].join(''));
} else
{buffer.append(ch);
}
{
var G__51117 = (index + 1);
index = G__51117;
continue;
}
}
