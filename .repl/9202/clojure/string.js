...
{{
var G__31180 = cljs.core.pop.call(null,v__$1);
v__$1 = G__31180;
continue;
}
} else
...
{var pred__31184 = cljs.core._EQ_;var expr__31185 = limit;if(cljs.core.truth_(pred__31184.call(null,1,expr__31185)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__31184.call(null,2,expr__31185)))
...
var G__31187 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__31188 = (limit__$1 - 1);
var G__31189 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__31187;
limit__$1 = G__31188;
parts = G__31189;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___31191 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___31191))
{var replacement_31192 = temp__4096__auto___31191;buffer.append([cljs.core.str(replacement_31192)].join(''));
} else
{buffer.append(ch);
}
{
var G__31193 = (index + 1);
index = G__31193;
continue;
}
}
