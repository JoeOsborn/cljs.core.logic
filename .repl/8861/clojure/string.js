...
{{
var G__170078 = cljs.core.pop.call(null,v__$1);
v__$1 = G__170078;
continue;
}
} else
...
{var pred__170082 = cljs.core._EQ_;var expr__170083 = limit;if(pred__170082.call(null,1,expr__170083))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__170082.call(null,2,expr__170083))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__170085 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__170086 = (limit__$1 - 1);
var G__170087 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__170085;
limit__$1 = G__170086;
parts = G__170087;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___170089 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___170089))
{var replacement_170090 = temp__4092__auto___170089;buffer.append([cljs.core.str(replacement_170090)].join(''));
} else
{buffer.append(ch);
}
{
var G__170091 = (index + 1);
index = G__170091;
continue;
}
}
