...
{{
var G__254397 = cljs.core.pop.call(null,v__$1);
v__$1 = G__254397;
continue;
}
} else
...
{var pred__254401 = cljs.core._EQ_;var expr__254402 = limit;if(cljs.core.truth_(pred__254401.call(null,1,expr__254402)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__254401.call(null,2,expr__254402)))
...
var G__254404 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__254405 = (limit__$1 - 1);
var G__254406 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__254404;
limit__$1 = G__254405;
parts = G__254406;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___254408 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___254408))
{var replacement_254409 = temp__4096__auto___254408;buffer.append([cljs.core.str(replacement_254409)].join(''));
} else
{buffer.append(ch);
}
{
var G__254410 = (index + 1);
index = G__254410;
continue;
}
}
