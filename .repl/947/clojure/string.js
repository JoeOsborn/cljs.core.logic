...
{{
var G__156627 = cljs.core.pop.call(null,v__$1);
v__$1 = G__156627;
continue;
}
} else
...
{var pred__156631 = cljs.core._EQ_;var expr__156632 = limit;if(pred__156631.call(null,1,expr__156632))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__156631.call(null,2,expr__156632))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__156634 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__156635 = (limit__$1 - 1);
var G__156636 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__156634;
limit__$1 = G__156635;
parts = G__156636;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___156638 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___156638))
{var replacement_156639 = temp__4092__auto___156638;buffer.append([cljs.core.str(replacement_156639)].join(''));
} else
{buffer.append(ch);
}
{
var G__156640 = (index + 1);
index = G__156640;
continue;
}
}
