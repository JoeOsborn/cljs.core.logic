...
{{
var G__282641 = cljs.core.pop.call(null,v__$1);
v__$1 = G__282641;
continue;
}
} else
...
{var pred__282645 = cljs.core._EQ_;var expr__282646 = limit;if(pred__282645.call(null,1,expr__282646))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__282645.call(null,2,expr__282646))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__282648 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__282649 = (limit__$1 - 1);
var G__282650 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__282648;
limit__$1 = G__282649;
parts = G__282650;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___282652 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___282652))
{var replacement_282653 = temp__4092__auto___282652;buffer.append([cljs.core.str(replacement_282653)].join(''));
} else
{buffer.append(ch);
}
{
var G__282654 = (index + 1);
index = G__282654;
continue;
}
}
