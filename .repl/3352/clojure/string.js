...
{{
var G__51148 = cljs.core.pop.call(null,v__$1);
v__$1 = G__51148;
continue;
}
} else
...
{var pred__51152 = cljs.core._EQ_;var expr__51153 = limit;if(pred__51152.call(null,1,expr__51153))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__51152.call(null,2,expr__51153))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__51155 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__51156 = (limit__$1 - 1);
var G__51157 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__51155;
limit__$1 = G__51156;
parts = G__51157;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___51159 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___51159))
{var replacement_51160 = temp__4092__auto___51159;buffer.append([cljs.core.str(replacement_51160)].join(''));
} else
{buffer.append(ch);
}
{
var G__51161 = (index + 1);
index = G__51161;
continue;
}
}
