...
{{
var G__21684 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21684;
continue;
}
} else
...
{var pred__21688 = cljs.core._EQ_;var expr__21689 = limit;if(pred__21688.call(null,1,expr__21689))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__21688.call(null,2,expr__21689))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__21691 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21692 = (limit__$1 - 1);
var G__21693 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__21691;
limit__$1 = G__21692;
parts = G__21693;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___21695 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___21695))
{var replacement_21696 = temp__4092__auto___21695;buffer.append([cljs.core.str(replacement_21696)].join(''));
} else
{buffer.append(ch);
}
{
var G__21697 = (index + 1);
index = G__21697;
continue;
}
}
