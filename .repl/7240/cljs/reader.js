...
reader_error.cljs$lang$applyTo = (function (arglist__21653){
var rdr = cljs.core.first(arglist__21653);
var msg = cljs.core.rest(arglist__21653);
...
{{
var G__21654 = (function (){sb.append(ch);
return sb;
})();
var G__21655 = cljs.reader.read_char.call(null,rdr);
sb = G__21654;
ch = G__21655;
continue;
}
...
{{
var G__21656 = cljs.reader.read_char.call(null,rdr);
ch = G__21656;
continue;
}
} else
...
var G__21657 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__21657;
continue;
}
} else
...
var G__21658 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__21658;
continue;
}
}
...
{{
var G__21659 = (function (){buffer.append(ch);
return buffer;
})();
...
{if(("\\" === ch))
{{
var G__21661 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__21662 = cljs.reader.read_char.call(null,reader);
buffer = G__21661;
ch = G__21662;
continue;
}
...
{{
var G__21663 = (function (){buffer.append(ch);
return buffer;
})();
var G__21664 = cljs.reader.read_char.call(null,reader);
buffer = G__21663;
ch = G__21664;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__21666 = o;if(G__21666)
{var bit__5323__auto__ = (G__21666.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__21666.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__21666.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__21666);
} else
{return false;
}
}
...
{{
var G__21671 = cljs.reader.read_comment.call(null,reader,ch);
...
{{
var G__21675 = reader;
var G__21676 = eof_is_error;
var G__21677 = sentinel;
var G__21678 = is_recursive;
reader = G__21675;
eof_is_error = G__21676;
sentinel = G__21677;
is_recursive = G__21678;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__21681 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__21681,0,null);var years = cljs.core.nth.call(null,vec__21681,1,null);var months = cljs.core.nth.call(null,vec__21681,2,null);var days = cljs.core.nth.call(null,vec__21681,3,null);var hours = cljs.core.nth.call(null,vec__21681,4,null);var minutes = cljs.core.nth.call(null,vec__21681,5,null);var seconds = cljs.core.nth.call(null,vec__21681,6,null);var fraction = cljs.core.nth.call(null,vec__21681,7,null);var offset_sign = cljs.core.nth.call(null,vec__21681,8,null);var offset_hours = cljs.core.nth.call(null,vec__21681,9,null);var offset_minutes = cljs.core.nth.call(null,vec__21681,10,null);var v = vec__21681;if(cljs.core.not.call(null,v))
...
{var vec__21683 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__21683,0,null);var months = cljs.core.nth.call(null,vec__21683,1,null);var days = cljs.core.nth.call(null,vec__21683,2,null);var hours = cljs.core.nth.call(null,vec__21683,3,null);var minutes = cljs.core.nth.call(null,vec__21683,4,null);var seconds = cljs.core.nth.call(null,vec__21683,5,null);var ms = cljs.core.nth.call(null,vec__21683,6,null);var offset = cljs.core.nth.call(null,vec__21683,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
