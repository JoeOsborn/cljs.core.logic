...
{{
var G__360082 = cljs.core.pop.call(null,v__$1);
v__$1 = G__360082;
continue;
}
} else
...
{var pred__360086 = cljs.core._EQ_;var expr__360087 = limit;if(cljs.core.truth_(pred__360086.call(null,1,expr__360087)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__360086.call(null,2,expr__360087)))
...
var G__360089 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__360090 = (limit__$1 - 1);
var G__360091 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__360089;
limit__$1 = G__360090;
parts = G__360091;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___360093 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___360093))
{var replacement_360094 = temp__4096__auto___360093;buffer.append([cljs.core.str(replacement_360094)].join(''));
} else
{buffer.append(ch);
}
{
var G__360095 = (index + 1);
index = G__360095;
continue;
}
}
