...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__44951 = m;var map__44951__$1 = ((cljs.core.seq_QMARK_.call(null,map__44951))?cljs.core.apply.call(null,cljs.core.hash_map,map__44951):map__44951);var line = cljs.core.get.call(null,map__44951__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__44951__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__44953 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__44953))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__44953))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_44954;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_44955 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_44955;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_44956 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___44957 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___44957))
{var message_44958 = temp__4094__auto___44957;cljs.core.println.call(null,message_44958);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_44956;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_44959 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___44960 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___44960))
{var message_44961 = temp__4094__auto___44960;cljs.core.println.call(null,message_44961);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_44962;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_44963 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_44963;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__44964){
var ns_sym = cljs.core.first(arglist__44964);
arglist__44964 = cljs.core.next(arglist__44964);
var fixture_type = cljs.core.first(arglist__44964);
var fixture_fns = cljs.core.rest(arglist__44964);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_44967 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__4704__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e44968){if((e44968 instanceof Error))
{var e_44969 = e44968;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_44969], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e44968;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_44967;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__44974 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__44975 = null;var count__44976 = 0;var i__44977 = 0;while(true){
if((i__44977 < count__44976))
{var v = cljs.core._nth.call(null,chunk__44975,i__44977);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__44974,chunk__44975,count__44976,i__44977,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__44974,chunk__44975,count__44976,i__44977,v))
);
} else
{}
{
var G__44978 = seq__44974;
var G__44979 = chunk__44975;
var G__44980 = count__44976;
var G__44981 = (i__44977 + 1);
seq__44974 = G__44978;
chunk__44975 = G__44979;
count__44976 = G__44980;
i__44977 = G__44981;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__44974);if(temp__4094__auto__)
{var seq__44974__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__44974__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__44974__$1);{
var G__44982 = cljs.core.chunk_rest.call(null,seq__44974__$1);
var G__44983 = c__5421__auto__;
var G__44984 = cljs.core.count.call(null,c__5421__auto__);
var G__44985 = 0;
seq__44974 = G__44982;
chunk__44975 = G__44983;
count__44976 = G__44984;
i__44977 = G__44985;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__44974__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__44974,chunk__44975,count__44976,i__44977,v,seq__44974__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__44974,chunk__44975,count__44976,i__44977,v,seq__44974__$1,temp__4094__auto__))
);
} else
{}
{
var G__44986 = cljs.core.next.call(null,seq__44974__$1);
var G__44987 = null;
var G__44988 = 0;
var G__44989 = 0;
seq__44974 = G__44986;
chunk__44975 = G__44987;
count__44976 = G__44988;
i__44977 = G__44989;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_44991 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___44992 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___44992))
{var test_hook_44993 = temp__4092__auto___44992;test_hook_44993.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_44991;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__44994){
var namespaces = cljs.core.seq(arglist__44994);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__44995_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__44995_SHARP_));
