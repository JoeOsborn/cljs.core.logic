...
{{
var G__44936 = cljs.core.pop.call(null,v__$1);
v__$1 = G__44936;
continue;
}
} else
...
{var pred__44940 = cljs.core._EQ_;var expr__44941 = limit;if(pred__44940.call(null,1,expr__44941))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__44940.call(null,2,expr__44941))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__44943 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__44944 = (limit__$1 - 1);
var G__44945 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__44943;
limit__$1 = G__44944;
parts = G__44945;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___44947 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___44947))
{var replacement_44948 = temp__4092__auto___44947;buffer.append([cljs.core.str(replacement_44948)].join(''));
} else
{buffer.append(ch);
}
{
var G__44949 = (index + 1);
index = G__44949;
continue;
}
}
