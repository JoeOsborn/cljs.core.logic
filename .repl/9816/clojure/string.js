...
{{
var G__51778 = cljs.core.pop.call(null,v__$1);
v__$1 = G__51778;
continue;
}
} else
...
{var pred__51782 = cljs.core._EQ_;var expr__51783 = limit;if(pred__51782.call(null,1,expr__51783))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__51782.call(null,2,expr__51783))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__51785 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__51786 = (limit__$1 - 1);
var G__51787 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__51785;
limit__$1 = G__51786;
parts = G__51787;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___51789 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___51789))
{var replacement_51790 = temp__4092__auto___51789;buffer.append([cljs.core.str(replacement_51790)].join(''));
} else
{buffer.append(ch);
}
{
var G__51791 = (index + 1);
index = G__51791;
continue;
}
}
