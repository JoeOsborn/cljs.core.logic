...
{{
var G__52645 = cljs.core.pop.call(null,v__$1);
v__$1 = G__52645;
continue;
}
} else
...
{var pred__52649 = cljs.core._EQ_;var expr__52650 = limit;if(pred__52649.call(null,1,expr__52650))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__52649.call(null,2,expr__52650))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__52652 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__52653 = (limit__$1 - 1);
var G__52654 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__52652;
limit__$1 = G__52653;
parts = G__52654;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___52656 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___52656))
{var replacement_52657 = temp__4092__auto___52656;buffer.append([cljs.core.str(replacement_52657)].join(''));
} else
{buffer.append(ch);
}
{
var G__52658 = (index + 1);
index = G__52658;
continue;
}
}
