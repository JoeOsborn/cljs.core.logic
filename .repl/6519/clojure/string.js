...
{{
var G__275727 = cljs.core.pop.call(null,v__$1);
v__$1 = G__275727;
continue;
}
} else
...
{var pred__275731 = cljs.core._EQ_;var expr__275732 = limit;if(pred__275731.call(null,1,expr__275732))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__275731.call(null,2,expr__275732))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__275734 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__275735 = (limit__$1 - 1);
var G__275736 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__275734;
limit__$1 = G__275735;
parts = G__275736;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___275738 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___275738))
{var replacement_275739 = temp__4092__auto___275738;buffer.append([cljs.core.str(replacement_275739)].join(''));
} else
{buffer.append(ch);
}
{
var G__275740 = (index + 1);
index = G__275740;
continue;
}
}
