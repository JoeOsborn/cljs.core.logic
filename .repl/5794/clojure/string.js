...
{{
var G__16444 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16444;
continue;
}
} else
...
{var pred__16448 = cljs.core._EQ_;var expr__16449 = limit;if(cljs.core.truth_(pred__16448.call(null,1,expr__16449)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16448.call(null,2,expr__16449)))
...
var G__16451 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16452 = (limit__$1 - 1);
var G__16453 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16451;
limit__$1 = G__16452;
parts = G__16453;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___16455 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___16455))
{var replacement_16456 = temp__4096__auto___16455;buffer.append([cljs.core.str(replacement_16456)].join(''));
} else
{buffer.append(ch);
}
{
var G__16457 = (index + 1);
index = G__16457;
continue;
}
}
