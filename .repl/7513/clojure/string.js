...
{{
var G__105051 = cljs.core.pop.call(null,v__$1);
v__$1 = G__105051;
continue;
}
} else
...
{var pred__105055 = cljs.core._EQ_;var expr__105056 = limit;if(cljs.core.truth_(pred__105055.call(null,1,expr__105056)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__105055.call(null,2,expr__105056)))
...
var G__105058 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__105059 = (limit__$1 - 1);
var G__105060 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__105058;
limit__$1 = G__105059;
parts = G__105060;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___105062 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___105062))
{var replacement_105063 = temp__4096__auto___105062;buffer.append([cljs.core.str(replacement_105063)].join(''));
} else
{buffer.append(ch);
}
{
var G__105064 = (index + 1);
index = G__105064;
continue;
}
}
