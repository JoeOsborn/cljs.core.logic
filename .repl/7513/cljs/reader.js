...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj105019 = {};return obj105019;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__105020){
var rdr = cljs.core.first(arglist__105020);
var msg = cljs.core.rest(arglist__105020);
...
{{
var G__105021 = (function (){sb.append(ch);
return sb;
})();
var G__105022 = cljs.reader.read_char.call(null,rdr);
sb = G__105021;
ch = G__105022;
continue;
}
...
{{
var G__105023 = cljs.reader.read_char.call(null,rdr);
ch = G__105023;
continue;
}
} else
...
var G__105024 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__105024;
continue;
}
} else
...
var G__105025 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__105025;
continue;
}
}
...
{{
var G__105026 = (function (){buffer.append(ch);
return buffer;
})();
var G__105027 = cljs.reader.read_char.call(null,reader);
buffer = G__105026;
ch = G__105027;
continue;
}
...
{if(("\\" === ch))
{{
var G__105028 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__105029 = cljs.reader.read_char.call(null,reader);
buffer = G__105028;
ch = G__105029;
continue;
}
...
{{
var G__105030 = (function (){buffer.append(ch);
return buffer;
})();
var G__105031 = cljs.reader.read_char.call(null,reader);
buffer = G__105030;
ch = G__105031;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__105033 = o;if(G__105033)
{var bit__7442__auto__ = (G__105033.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__7442__auto__) || (G__105033.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__105033.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__105033);
} else
{return false;
}
}
...
{{
var G__105034 = reader;
var G__105035 = eof_is_error;
var G__105036 = sentinel;
var G__105037 = is_recursive;
reader = G__105034;
eof_is_error = G__105035;
sentinel = G__105036;
is_recursive = G__105037;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__105038 = cljs.reader.read_comment.call(null,reader,ch);
var G__105039 = eof_is_error;
var G__105040 = sentinel;
var G__105041 = is_recursive;
reader = G__105038;
eof_is_error = G__105039;
sentinel = G__105040;
is_recursive = G__105041;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__105042 = reader;
var G__105043 = eof_is_error;
var G__105044 = sentinel;
var G__105045 = is_recursive;
reader = G__105042;
eof_is_error = G__105043;
sentinel = G__105044;
is_recursive = G__105045;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__105048 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__105048,0,null);var years = cljs.core.nth.call(null,vec__105048,1,null);var months = cljs.core.nth.call(null,vec__105048,2,null);var days = cljs.core.nth.call(null,vec__105048,3,null);var hours = cljs.core.nth.call(null,vec__105048,4,null);var minutes = cljs.core.nth.call(null,vec__105048,5,null);var seconds = cljs.core.nth.call(null,vec__105048,6,null);var fraction = cljs.core.nth.call(null,vec__105048,7,null);var offset_sign = cljs.core.nth.call(null,vec__105048,8,null);var offset_hours = cljs.core.nth.call(null,vec__105048,9,null);var offset_minutes = cljs.core.nth.call(null,vec__105048,10,null);var v = vec__105048;if(cljs.core.not.call(null,v))
...
{var vec__105050 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__105050,0,null);var months = cljs.core.nth.call(null,vec__105050,1,null);var days = cljs.core.nth.call(null,vec__105050,2,null);var hours = cljs.core.nth.call(null,vec__105050,3,null);var minutes = cljs.core.nth.call(null,vec__105050,4,null);var seconds = cljs.core.nth.call(null,vec__105050,5,null);var ms = cljs.core.nth.call(null,vec__105050,6,null);var offset = cljs.core.nth.call(null,vec__105050,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
