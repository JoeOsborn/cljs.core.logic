...
{{
var G__77249 = cljs.core.pop.call(null,v__$1);
v__$1 = G__77249;
continue;
}
} else
...
{var pred__77253 = cljs.core._EQ_;var expr__77254 = limit;if(cljs.core.truth_(pred__77253.call(null,1,expr__77254)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__77253.call(null,2,expr__77254)))
...
var G__77256 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__77257 = (limit__$1 - 1);
var G__77258 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__77256;
limit__$1 = G__77257;
parts = G__77258;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___77260 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___77260))
{var replacement_77261 = temp__4096__auto___77260;buffer.append([cljs.core.str(replacement_77261)].join(''));
} else
{buffer.append(ch);
}
{
var G__77262 = (index + 1);
index = G__77262;
continue;
}
}
