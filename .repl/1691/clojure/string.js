...
{{
var G__349319 = cljs.core.pop.call(null,v__$1);
v__$1 = G__349319;
continue;
}
} else
...
{var pred__349323 = cljs.core._EQ_;var expr__349324 = limit;if(cljs.core.truth_(pred__349323.call(null,1,expr__349324)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__349323.call(null,2,expr__349324)))
...
var G__349326 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__349327 = (limit__$1 - 1);
var G__349328 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__349326;
limit__$1 = G__349327;
parts = G__349328;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___349330 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___349330))
{var replacement_349331 = temp__4096__auto___349330;buffer.append([cljs.core.str(replacement_349331)].join(''));
} else
{buffer.append(ch);
}
{
var G__349332 = (index + 1);
index = G__349332;
continue;
}
}
