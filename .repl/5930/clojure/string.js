...
{{
var G__155684 = cljs.core.pop.call(null,v__$1);
v__$1 = G__155684;
continue;
}
} else
...
{var pred__155688 = cljs.core._EQ_;var expr__155689 = limit;if(cljs.core.truth_(pred__155688.call(null,1,expr__155689)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__155688.call(null,2,expr__155689)))
...
var G__155691 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__155692 = (limit__$1 - 1);
var G__155693 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__155691;
limit__$1 = G__155692;
parts = G__155693;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___155695 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___155695))
{var replacement_155696 = temp__4096__auto___155695;buffer.append([cljs.core.str(replacement_155696)].join(''));
} else
{buffer.append(ch);
}
{
var G__155697 = (index + 1);
index = G__155697;
continue;
}
}
