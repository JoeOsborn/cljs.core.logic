...
{var vec__12711 = expr__$1;var f = cljs.core.nth.call(null,vec__12711,0,null);var n = cljs.core.nthnext.call(null,vec__12711,1);var skip = cljs.core._EQ_.call(null,f,new cljs.core.Symbol(null,".",".",-1640531481,null));var tail = prep_STAR_.call(null,n,store,lcons_QMARK_,skip);if(skip)
{return tail;
} else
...
{return cljs.core.logic.unifier.queue.call(null,s,cljs.core.logic.unifier._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__12712_SHARP_){return cljs.core.logic.lvar.call(null,p1__12712_SHARP_,false);
}),vs))));
} else
...
{return cljs.core.logic.unifier.queue.call(null,s,cljs.core.logic.unifier._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__12713_SHARP_){return cljs.core.logic.lvar.call(null,p1__12713_SHARP_,false);
...
cljs.core.logic.unifier.queue_constraints = (function queue_constraints(s,p__12714){var vec__12716 = p__12714;var vs = cljs.core.nth.call(null,vec__12716,0,null);var cs = cljs.core.nth.call(null,vec__12716,1,null);var cs__$1 = ((!(cljs.core.sequential_QMARK_.call(null,cs)))?cljs.core.PersistentVector.fromArray([cs], true):cs);return cljs.core.reduce.call(null,(function (s__$1,c){return cljs.core.logic.unifier.queue_constraint.call(null,s__$1,c,vs);
}),s,cs__$1);
});
cljs.core.logic.unifier._unify_STAR_ = (function _unify_STAR_(init_s,u,w){return cljs.core.first.call(null,cljs.core.logic.unifier.take_STAR_.call(null,(function (){return cljs.core.logic.unifier.fresh.call(null,cljs.core.PersistentVector.fromArray([cljs.core.logic.unifier.q], true),cljs.core.logic.unifier._EQ__EQ_.call(null,u,w),cljs.core.logic.unifier._EQ__EQ_.call(null,cljs.core.logic.unifier.q,u),(function (a){return cljs.core.logic.unifier.fix_constraints.call(null,a);
}),cljs.core.logic.unifier.reifyg.call(null,cljs.core.logic.unifier.q)).call(null,init_s);
})));
});
cljs.core.logic.unifier.init_s = (function init_s(opts,s){var s__$1 = cljs.core.reduce.call(null,(function (s__$1,p__12719){var vec__12720 = p__12719;var k = cljs.core.nth.call(null,vec__12720,0,null);var v = cljs.core.nth.call(null,vec__12720,1,null);return cljs.core.logic.unifier._EQ__EQ_.call(null,k,v).call(null,s__$1);
...
var unify_STAR___2 = (function (opts,ts){var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.unifier.empty_s);return cljs.core.logic.unifier._unify_STAR_.call(null,cljs.core.vary_meta.call(null,init_s,cljs.core.assoc,new cljs.core.Keyword(null,"reify-vars","reify-vars",4368745730),false),cljs.core.reduce.call(null,(function (p1__12721_SHARP_,p2__12722_SHARP_){return cljs.core.logic.unifier._unify_STAR_.call(null,init_s,p1__12721_SHARP_,p2__12722_SHARP_);
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__12737){var vec__12738 = p__12737;var sym = cljs.core.nth.call(null,vec__12738,0,null);var var$ = cljs.core.nth.call(null,vec__12738,1,null);return cljs.core.PersistentVector.fromArray([sym,cljs.core.logic.unifier._reify.call(null,s__$1,var$)], true);
}),cljs.core.filter.call(null,(function (p__12739){var vec__12740 = p__12739;var sym = cljs.core.nth.call(null,vec__12740,0,null);var var$ = cljs.core.nth.call(null,vec__12740,1,null);return cljs.core.not_EQ_.call(null,cljs.core.logic.unifier.walk.call(null,s__$1,var$),var$);
...
var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.unifier.empty_s);return cljs.core.reduce.call(null,(function (p1__12723_SHARP_,p2__12724_SHARP_){return _unifier_STAR_.call(null,init_s,p1__12723_SHARP_,p2__12724_SHARP_);
}),ts);
});
...
var unify__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__12743){var vec__12744 = p__12743;var k = cljs.core.nth.call(null,vec__12744,0,null);var v = cljs.core.nth.call(null,vec__12744,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], true);
...
var unifier__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__12748){var vec__12749 = p__12748;var k = cljs.core.nth.call(null,vec__12749,0,null);var v = cljs.core.nth.call(null,vec__12749,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], true);
...
return (function (p1__12745_SHARP_){return new cljs.core.Keyword("cljs.core.logic.unifier","lvars","cljs.core.logic.unifier/lvars",1819622758).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12745_SHARP_));
