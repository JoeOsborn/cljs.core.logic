...
{{
var G__11674 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11674;
continue;
}
} else
...
{var pred__11678 = cljs.core._EQ_;var expr__11679 = limit;if(pred__11678.call(null,1,expr__11679))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__11678.call(null,2,expr__11679))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__11681 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11682 = (limit__$1 - 1);
var G__11683 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11681;
limit__$1 = G__11682;
parts = G__11683;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___11685 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___11685))
{var replacement_11686 = temp__4092__auto___11685;buffer.append([cljs.core.str(replacement_11686)].join(''));
} else
{buffer.append(ch);
}
{
var G__11687 = (index + 1);
index = G__11687;
continue;
}
}
