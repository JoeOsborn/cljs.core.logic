...
{{
var G__56529 = cljs.core.pop.call(null,v__$1);
v__$1 = G__56529;
continue;
}
} else
...
{var pred__56533 = cljs.core._EQ_;var expr__56534 = limit;if(pred__56533.call(null,1,expr__56534))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__56533.call(null,2,expr__56534))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__56536 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__56537 = (limit__$1 - 1);
var G__56538 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__56536;
limit__$1 = G__56537;
parts = G__56538;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___56540 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___56540))
{var replacement_56541 = temp__4092__auto___56540;buffer.append([cljs.core.str(replacement_56541)].join(''));
} else
{buffer.append(ch);
}
{
var G__56542 = (index + 1);
index = G__56542;
continue;
}
}
