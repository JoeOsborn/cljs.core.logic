...
{{
var G__49208 = cljs.core.pop.call(null,v__$1);
v__$1 = G__49208;
continue;
}
} else
...
{var pred__49212 = cljs.core._EQ_;var expr__49213 = limit;if(cljs.core.truth_(pred__49212.call(null,1,expr__49213)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__49212.call(null,2,expr__49213)))
...
var G__49215 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__49216 = (limit__$1 - 1);
var G__49217 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__49215;
limit__$1 = G__49216;
parts = G__49217;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___49219 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___49219))
{var replacement_49220 = temp__4096__auto___49219;buffer.append([cljs.core.str(replacement_49220)].join(''));
} else
{buffer.append(ch);
}
{
var G__49221 = (index + 1);
index = G__49221;
continue;
}
}
