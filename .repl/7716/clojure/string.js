...
{{
var G__9617 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9617;
continue;
}
} else
...
{var pred__9621 = cljs.core._EQ_;var expr__9622 = limit;if(pred__9621.call(null,1,expr__9622))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9621.call(null,2,expr__9622))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9624 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9625 = (limit__$1 - 1);
var G__9626 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9624;
limit__$1 = G__9625;
parts = G__9626;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9628 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9628))
{var replacement_9629 = temp__4092__auto___9628;buffer.append([cljs.core.str(replacement_9629)].join(''));
} else
{buffer.append(ch);
}
{
