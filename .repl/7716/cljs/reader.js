...
reader_error.cljs$lang$applyTo = (function (arglist__9586){
var rdr = cljs.core.first(arglist__9586);
var msg = cljs.core.rest(arglist__9586);
...
{{
var G__9587 = (function (){sb.append(ch);
return sb;
})();
var G__9588 = cljs.reader.read_char.call(null,rdr);
sb = G__9587;
ch = G__9588;
continue;
}
...
var G__9590 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9590;
continue;
}
} else
...
var G__9591 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9591;
continue;
}
}
...
{if(("\\" === ch))
{{
var G__9594 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__9596 = (function (){buffer.append(ch);
return buffer;
})();
var G__9597 = cljs.reader.read_char.call(null,reader);
buffer = G__9596;
ch = G__9597;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9599 = o;if(G__9599)
{var bit__5323__auto__ = (G__9599.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9599.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9599.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9599);
} else
{return false;
}
}
...
{{
var G__9604 = cljs.reader.read_comment.call(null,reader,ch);
...
{{
var G__9608 = reader;
var G__9609 = eof_is_error;
var G__9610 = sentinel;
var G__9611 = is_recursive;
reader = G__9608;
eof_is_error = G__9609;
sentinel = G__9610;
is_recursive = G__9611;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9614 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9614,0,null);var years = cljs.core.nth.call(null,vec__9614,1,null);var months = cljs.core.nth.call(null,vec__9614,2,null);var days = cljs.core.nth.call(null,vec__9614,3,null);var hours = cljs.core.nth.call(null,vec__9614,4,null);var minutes = cljs.core.nth.call(null,vec__9614,5,null);var seconds = cljs.core.nth.call(null,vec__9614,6,null);var fraction = cljs.core.nth.call(null,vec__9614,7,null);var offset_sign = cljs.core.nth.call(null,vec__9614,8,null);var offset_hours = cljs.core.nth.call(null,vec__9614,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9614,10,null);var v = vec__9614;if(cljs.core.not.call(null,v))
...
{var vec__9616 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9616,0,null);var months = cljs.core.nth.call(null,vec__9616,1,null);var days = cljs.core.nth.call(null,vec__9616,2,null);var hours = cljs.core.nth.call(null,vec__9616,3,null);var minutes = cljs.core.nth.call(null,vec__9616,4,null);var seconds = cljs.core.nth.call(null,vec__9616,5,null);var ms = cljs.core.nth.call(null,vec__9616,6,null);var offset = cljs.core.nth.call(null,vec__9616,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
