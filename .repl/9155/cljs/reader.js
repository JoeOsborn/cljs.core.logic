...
reader_error.cljs$lang$applyTo = (function (arglist__259138){
var rdr = cljs.core.first(arglist__259138);
var msg = cljs.core.rest(arglist__259138);
...
{{
var G__259139 = (function (){sb.append(ch);
return sb;
})();
var G__259140 = cljs.reader.read_char.call(null,rdr);
sb = G__259139;
ch = G__259140;
continue;
}
...
{{
var G__259141 = cljs.reader.read_char.call(null,rdr);
ch = G__259141;
continue;
}
} else
...
var G__259142 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__259142;
continue;
}
} else
...
var G__259143 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__259143;
continue;
}
}
...
{{
var G__259144 = (function (){buffer.append(ch);
return buffer;
})();
var G__259145 = cljs.reader.read_char.call(null,reader);
buffer = G__259144;
ch = G__259145;
continue;
}
...
{if(("\\" === ch))
{{
var G__259146 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__259147 = cljs.reader.read_char.call(null,reader);
buffer = G__259146;
ch = G__259147;
continue;
}
...
{{
var G__259148 = (function (){buffer.append(ch);
return buffer;
})();
var G__259149 = cljs.reader.read_char.call(null,reader);
buffer = G__259148;
ch = G__259149;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__259151 = o;if(G__259151)
{var bit__5323__auto__ = (G__259151.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__259151.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__259151.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__259151);
} else
{return false;
}
}
...
{{
var G__259152 = reader;
var G__259153 = eof_is_error;
var G__259154 = sentinel;
var G__259155 = is_recursive;
reader = G__259152;
eof_is_error = G__259153;
sentinel = G__259154;
is_recursive = G__259155;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__259156 = cljs.reader.read_comment.call(null,reader,ch);
var G__259157 = eof_is_error;
var G__259158 = sentinel;
var G__259159 = is_recursive;
reader = G__259156;
eof_is_error = G__259157;
sentinel = G__259158;
is_recursive = G__259159;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__259160 = reader;
var G__259161 = eof_is_error;
var G__259162 = sentinel;
var G__259163 = is_recursive;
reader = G__259160;
eof_is_error = G__259161;
sentinel = G__259162;
is_recursive = G__259163;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__259166 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__259166,0,null);var years = cljs.core.nth.call(null,vec__259166,1,null);var months = cljs.core.nth.call(null,vec__259166,2,null);var days = cljs.core.nth.call(null,vec__259166,3,null);var hours = cljs.core.nth.call(null,vec__259166,4,null);var minutes = cljs.core.nth.call(null,vec__259166,5,null);var seconds = cljs.core.nth.call(null,vec__259166,6,null);var fraction = cljs.core.nth.call(null,vec__259166,7,null);var offset_sign = cljs.core.nth.call(null,vec__259166,8,null);var offset_hours = cljs.core.nth.call(null,vec__259166,9,null);var offset_minutes = cljs.core.nth.call(null,vec__259166,10,null);var v = vec__259166;if(cljs.core.not.call(null,v))
...
{var vec__259168 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__259168,0,null);var months = cljs.core.nth.call(null,vec__259168,1,null);var days = cljs.core.nth.call(null,vec__259168,2,null);var hours = cljs.core.nth.call(null,vec__259168,3,null);var minutes = cljs.core.nth.call(null,vec__259168,4,null);var seconds = cljs.core.nth.call(null,vec__259168,5,null);var ms = cljs.core.nth.call(null,vec__259168,6,null);var offset = cljs.core.nth.call(null,vec__259168,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
