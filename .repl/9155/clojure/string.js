...
{{
var G__258842 = cljs.core.pop.call(null,v__$1);
v__$1 = G__258842;
continue;
}
} else
...
{var pred__258846 = cljs.core._EQ_;var expr__258847 = limit;if(pred__258846.call(null,1,expr__258847))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__258846.call(null,2,expr__258847))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__258849 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__258850 = (limit__$1 - 1);
var G__258851 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__258849;
limit__$1 = G__258850;
parts = G__258851;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___258853 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___258853))
{var replacement_258854 = temp__4092__auto___258853;buffer.append([cljs.core.str(replacement_258854)].join(''));
} else
{buffer.append(ch);
}
{
var G__258855 = (index + 1);
index = G__258855;
continue;
}
}
