...
{{
var G__12337 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12337;
continue;
}
} else
...
{var pred__12341 = cljs.core._EQ_;var expr__12342 = limit;if(pred__12341.call(null,1,expr__12342))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__12341.call(null,2,expr__12342))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__12344 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12345 = (limit__$1 - 1);
var G__12346 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12344;
limit__$1 = G__12345;
parts = G__12346;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___12348 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___12348))
{var replacement_12349 = temp__4092__auto___12348;buffer.append([cljs.core.str(replacement_12349)].join(''));
} else
{buffer.append(ch);
}
{
var G__12350 = (index + 1);
index = G__12350;
continue;
}
}
