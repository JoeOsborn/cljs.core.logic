...
{var bit__5323__auto__ = (G__12319.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__12319.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__12319.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__12319);
} else
{return false;
}
}
...
{var vec__12336 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__12336,0,null);var months = cljs.core.nth.call(null,vec__12336,1,null);var days = cljs.core.nth.call(null,vec__12336,2,null);var hours = cljs.core.nth.call(null,vec__12336,3,null);var minutes = cljs.core.nth.call(null,vec__12336,4,null);var seconds = cljs.core.nth.call(null,vec__12336,5,null);var ms = cljs.core.nth.call(null,vec__12336,6,null);var offset = cljs.core.nth.call(null,vec__12336,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
