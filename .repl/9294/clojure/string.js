...
{{
var G__287868 = cljs.core.pop.call(null,v__$1);
v__$1 = G__287868;
continue;
}
} else
...
{var pred__287872 = cljs.core._EQ_;var expr__287873 = limit;if(pred__287872.call(null,1,expr__287873))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__287872.call(null,2,expr__287873))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__287876 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__287877 = (limit__$1 - 1);
var G__287878 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__287876;
limit__$1 = G__287877;
parts = G__287878;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___287890 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___287890))
{var replacement_287892 = temp__4092__auto___287890;buffer.append([cljs.core.str(replacement_287892)].join(''));
} else
{buffer.append(ch);
}
{
var G__287893 = (index + 1);
index = G__287893;
continue;
}
}
