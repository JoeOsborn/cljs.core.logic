...
{{
var G__203522 = cljs.core.pop.call(null,v__$1);
v__$1 = G__203522;
continue;
}
} else
...
{var pred__203526 = cljs.core._EQ_;var expr__203527 = limit;if(pred__203526.call(null,1,expr__203527))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__203526.call(null,2,expr__203527))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__203529 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__203530 = (limit__$1 - 1);
var G__203531 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__203529;
limit__$1 = G__203530;
parts = G__203531;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___203533 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___203533))
{var replacement_203534 = temp__4092__auto___203533;buffer.append([cljs.core.str(replacement_203534)].join(''));
} else
{buffer.append(ch);
}
{
var G__203535 = (index + 1);
index = G__203535;
continue;
}
}
