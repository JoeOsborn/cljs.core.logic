...
reader_error.cljs$lang$applyTo = (function (arglist__203818){
var rdr = cljs.core.first(arglist__203818);
var msg = cljs.core.rest(arglist__203818);
...
{{
var G__203819 = (function (){sb.append(ch);
return sb;
})();
var G__203820 = cljs.reader.read_char.call(null,rdr);
sb = G__203819;
ch = G__203820;
continue;
}
...
{{
var G__203821 = cljs.reader.read_char.call(null,rdr);
ch = G__203821;
continue;
}
} else
...
var G__203822 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__203822;
continue;
}
} else
...
var G__203823 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__203823;
continue;
}
}
...
{{
var G__203824 = (function (){buffer.append(ch);
return buffer;
})();
var G__203825 = cljs.reader.read_char.call(null,reader);
buffer = G__203824;
ch = G__203825;
continue;
}
...
{if(("\\" === ch))
{{
var G__203826 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__203827 = cljs.reader.read_char.call(null,reader);
buffer = G__203826;
ch = G__203827;
continue;
}
...
{{
var G__203828 = (function (){buffer.append(ch);
return buffer;
})();
var G__203829 = cljs.reader.read_char.call(null,reader);
buffer = G__203828;
ch = G__203829;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__203831 = o;if(G__203831)
{var bit__5323__auto__ = (G__203831.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__203831.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__203831.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__203831);
} else
{return false;
}
}
...
{{
var G__203832 = reader;
var G__203833 = eof_is_error;
var G__203834 = sentinel;
var G__203835 = is_recursive;
reader = G__203832;
eof_is_error = G__203833;
sentinel = G__203834;
is_recursive = G__203835;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__203836 = cljs.reader.read_comment.call(null,reader,ch);
var G__203837 = eof_is_error;
var G__203838 = sentinel;
var G__203839 = is_recursive;
reader = G__203836;
eof_is_error = G__203837;
sentinel = G__203838;
is_recursive = G__203839;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__203840 = reader;
var G__203841 = eof_is_error;
var G__203842 = sentinel;
var G__203843 = is_recursive;
reader = G__203840;
eof_is_error = G__203841;
sentinel = G__203842;
is_recursive = G__203843;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__203846 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__203846,0,null);var years = cljs.core.nth.call(null,vec__203846,1,null);var months = cljs.core.nth.call(null,vec__203846,2,null);var days = cljs.core.nth.call(null,vec__203846,3,null);var hours = cljs.core.nth.call(null,vec__203846,4,null);var minutes = cljs.core.nth.call(null,vec__203846,5,null);var seconds = cljs.core.nth.call(null,vec__203846,6,null);var fraction = cljs.core.nth.call(null,vec__203846,7,null);var offset_sign = cljs.core.nth.call(null,vec__203846,8,null);var offset_hours = cljs.core.nth.call(null,vec__203846,9,null);var offset_minutes = cljs.core.nth.call(null,vec__203846,10,null);var v = vec__203846;if(cljs.core.not.call(null,v))
...
{var vec__203848 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__203848,0,null);var months = cljs.core.nth.call(null,vec__203848,1,null);var days = cljs.core.nth.call(null,vec__203848,2,null);var hours = cljs.core.nth.call(null,vec__203848,3,null);var minutes = cljs.core.nth.call(null,vec__203848,4,null);var seconds = cljs.core.nth.call(null,vec__203848,5,null);var ms = cljs.core.nth.call(null,vec__203848,6,null);var offset = cljs.core.nth.call(null,vec__203848,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
