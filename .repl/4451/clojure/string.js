...
{{
var G__19146 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19146;
continue;
}
} else
...
{var pred__19150 = cljs.core._EQ_;var expr__19151 = limit;if(pred__19150.call(null,1,expr__19151))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__19150.call(null,2,expr__19151))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__19153 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19154 = (limit__$1 - 1);
var G__19155 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19153;
limit__$1 = G__19154;
parts = G__19155;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___19157 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___19157))
{var replacement_19158 = temp__4092__auto___19157;buffer.append([cljs.core.str(replacement_19158)].join(''));
} else
{buffer.append(ch);
}
{
var G__19159 = (index + 1);
index = G__19159;
continue;
}
}
