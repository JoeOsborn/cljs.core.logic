...
{{
var G__11929 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11929;
continue;
}
} else
...
{var pred__11933 = cljs.core._EQ_;var expr__11934 = limit;if(cljs.core.truth_(pred__11933.call(null,1,expr__11934)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11933.call(null,2,expr__11934)))
...
var G__11936 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11937 = (limit__$1 - 1);
var G__11938 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11936;
limit__$1 = G__11937;
parts = G__11938;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___11940 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___11940))
{var replacement_11941 = temp__4092__auto___11940;buffer.append([cljs.core.str(replacement_11941)].join(''));
} else
{buffer.append(ch);
}
{
var G__11942 = (index + 1);
index = G__11942;
continue;
}
}
