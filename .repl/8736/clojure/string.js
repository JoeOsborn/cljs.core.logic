...
{{
var G__8363 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8363;
continue;
}
} else
...
{var pred__8367 = cljs.core._EQ_;var expr__8368 = limit;if(pred__8367.call(null,1,expr__8368))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__8367.call(null,2,expr__8368))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__8370 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8371 = (limit__$1 - 1);
var G__8372 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8370;
limit__$1 = G__8371;
parts = G__8372;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___8374 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___8374))
{var replacement_8375 = temp__4092__auto___8374;buffer.append([cljs.core.str(replacement_8375)].join(''));
} else
{buffer.append(ch);
}
{
