...
{{
var G__9325 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9325;
continue;
}
} else
...
{var pred__9329 = cljs.core._EQ_;var expr__9330 = limit;if(pred__9329.call(null,1,expr__9330))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9329.call(null,2,expr__9330))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9332 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9333 = (limit__$1 - 1);
var G__9334 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9332;
limit__$1 = G__9333;
parts = G__9334;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9336 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9336))
{var replacement_9337 = temp__4092__auto___9336;buffer.append([cljs.core.str(replacement_9337)].join(''));
} else
{buffer.append(ch);
}
{
