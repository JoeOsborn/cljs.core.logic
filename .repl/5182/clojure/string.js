...
{{
var G__66720 = cljs.core.pop.call(null,v__$1);
v__$1 = G__66720;
continue;
}
} else
...
{var pred__66724 = cljs.core._EQ_;var expr__66725 = limit;if(cljs.core.truth_(pred__66724.call(null,1,expr__66725)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__66724.call(null,2,expr__66725)))
...
var G__66727 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__66728 = (limit__$1 - 1);
var G__66729 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__66727;
limit__$1 = G__66728;
parts = G__66729;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___66731 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___66731))
{var replacement_66732 = temp__4096__auto___66731;buffer.append([cljs.core.str(replacement_66732)].join(''));
} else
{buffer.append(ch);
}
{
var G__66733 = (index + 1);
index = G__66733;
continue;
}
}
