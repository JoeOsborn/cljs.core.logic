...
{{
var G__158314 = cljs.core.pop.call(null,v__$1);
v__$1 = G__158314;
continue;
}
} else
...
{var pred__158318 = cljs.core._EQ_;var expr__158319 = limit;if(pred__158318.call(null,1,expr__158319))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__158318.call(null,2,expr__158319))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__158321 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__158322 = (limit__$1 - 1);
var G__158323 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__158321;
limit__$1 = G__158322;
parts = G__158323;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___158325 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___158325))
{var replacement_158326 = temp__4092__auto___158325;buffer.append([cljs.core.str(replacement_158326)].join(''));
} else
{buffer.append(ch);
}
{
var G__158327 = (index + 1);
index = G__158327;
continue;
}
}
