...
reader_error.cljs$lang$applyTo = (function (arglist__158610){
var rdr = cljs.core.first(arglist__158610);
var msg = cljs.core.rest(arglist__158610);
...
{{
var G__158611 = (function (){sb.append(ch);
return sb;
})();
var G__158612 = cljs.reader.read_char.call(null,rdr);
sb = G__158611;
ch = G__158612;
continue;
}
...
{{
var G__158613 = cljs.reader.read_char.call(null,rdr);
ch = G__158613;
continue;
}
} else
...
var G__158614 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__158614;
continue;
}
} else
...
var G__158615 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__158615;
continue;
}
}
...
{{
var G__158616 = (function (){buffer.append(ch);
return buffer;
})();
var G__158617 = cljs.reader.read_char.call(null,reader);
buffer = G__158616;
ch = G__158617;
continue;
}
...
{if(("\\" === ch))
{{
var G__158618 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__158619 = cljs.reader.read_char.call(null,reader);
buffer = G__158618;
ch = G__158619;
continue;
}
...
{{
var G__158620 = (function (){buffer.append(ch);
return buffer;
})();
var G__158621 = cljs.reader.read_char.call(null,reader);
buffer = G__158620;
ch = G__158621;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__158623 = o;if(G__158623)
{var bit__5323__auto__ = (G__158623.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__158623.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__158623.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__158623);
} else
{return false;
}
}
...
{{
var G__158624 = reader;
var G__158625 = eof_is_error;
var G__158626 = sentinel;
var G__158627 = is_recursive;
reader = G__158624;
eof_is_error = G__158625;
sentinel = G__158626;
is_recursive = G__158627;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__158628 = cljs.reader.read_comment.call(null,reader,ch);
var G__158629 = eof_is_error;
var G__158630 = sentinel;
var G__158631 = is_recursive;
reader = G__158628;
eof_is_error = G__158629;
sentinel = G__158630;
is_recursive = G__158631;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__158632 = reader;
var G__158633 = eof_is_error;
var G__158634 = sentinel;
var G__158635 = is_recursive;
reader = G__158632;
eof_is_error = G__158633;
sentinel = G__158634;
is_recursive = G__158635;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__158638 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__158638,0,null);var years = cljs.core.nth.call(null,vec__158638,1,null);var months = cljs.core.nth.call(null,vec__158638,2,null);var days = cljs.core.nth.call(null,vec__158638,3,null);var hours = cljs.core.nth.call(null,vec__158638,4,null);var minutes = cljs.core.nth.call(null,vec__158638,5,null);var seconds = cljs.core.nth.call(null,vec__158638,6,null);var fraction = cljs.core.nth.call(null,vec__158638,7,null);var offset_sign = cljs.core.nth.call(null,vec__158638,8,null);var offset_hours = cljs.core.nth.call(null,vec__158638,9,null);var offset_minutes = cljs.core.nth.call(null,vec__158638,10,null);var v = vec__158638;if(cljs.core.not.call(null,v))
...
{var vec__158640 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__158640,0,null);var months = cljs.core.nth.call(null,vec__158640,1,null);var days = cljs.core.nth.call(null,vec__158640,2,null);var hours = cljs.core.nth.call(null,vec__158640,3,null);var minutes = cljs.core.nth.call(null,vec__158640,4,null);var seconds = cljs.core.nth.call(null,vec__158640,5,null);var ms = cljs.core.nth.call(null,vec__158640,6,null);var offset = cljs.core.nth.call(null,vec__158640,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
