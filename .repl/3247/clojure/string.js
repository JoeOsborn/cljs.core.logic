...
{{
var G__43084 = cljs.core.pop.call(null,v__$1);
v__$1 = G__43084;
continue;
}
} else
...
{var pred__43088 = cljs.core._EQ_;var expr__43089 = limit;if(cljs.core.truth_(pred__43088.call(null,1,expr__43089)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__43088.call(null,2,expr__43089)))
...
var G__43091 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__43092 = (limit__$1 - 1);
var G__43093 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__43091;
limit__$1 = G__43092;
parts = G__43093;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___43095 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___43095))
{var replacement_43096 = temp__4096__auto___43095;buffer.append([cljs.core.str(replacement_43096)].join(''));
} else
{buffer.append(ch);
}
{
var G__43097 = (index + 1);
index = G__43097;
continue;
}
}
