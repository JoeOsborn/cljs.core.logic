...
{{
var G__9335 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9335;
continue;
}
} else
...
{var pred__9339 = cljs.core._EQ_;var expr__9340 = limit;if(pred__9339.call(null,1,expr__9340))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9339.call(null,2,expr__9340))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
{var ch = s.charAt(index);var temp__4092__auto___9346 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9346))
{var replacement_9347 = temp__4092__auto___9346;buffer.append([cljs.core.str(replacement_9347)].join(''));
} else
{buffer.append(ch);
}
{
