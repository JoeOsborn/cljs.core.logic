...
{{
var G__96486 = cljs.core.pop.call(null,v__$1);
v__$1 = G__96486;
continue;
}
} else
...
{var pred__96490 = cljs.core._EQ_;var expr__96491 = limit;if(pred__96490.call(null,1,expr__96491))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__96490.call(null,2,expr__96491))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__96493 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__96494 = (limit__$1 - 1);
var G__96495 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__96493;
limit__$1 = G__96494;
parts = G__96495;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___96497 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___96497))
{var replacement_96498 = temp__4092__auto___96497;buffer.append([cljs.core.str(replacement_96498)].join(''));
} else
{buffer.append(ch);
}
{
var G__96499 = (index + 1);
index = G__96499;
continue;
}
}
