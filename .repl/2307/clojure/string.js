...
{{
var G__9317 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9317;
continue;
}
} else
...
{var pred__9321 = cljs.core._EQ_;var expr__9322 = limit;if(pred__9321.call(null,1,expr__9322))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9321.call(null,2,expr__9322))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9324 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9325 = (limit__$1 - 1);
var G__9326 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9324;
limit__$1 = G__9325;
parts = G__9326;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9328 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9328))
{var replacement_9329 = temp__4092__auto___9328;buffer.append([cljs.core.str(replacement_9329)].join(''));
} else
{buffer.append(ch);
}
{
