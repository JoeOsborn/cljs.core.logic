...
reader_error.cljs$lang$applyTo = (function (arglist__9286){
var rdr = cljs.core.first(arglist__9286);
var msg = cljs.core.rest(arglist__9286);
...
{{
var G__9287 = (function (){sb.append(ch);
return sb;
})();
var G__9288 = cljs.reader.read_char.call(null,rdr);
sb = G__9287;
ch = G__9288;
continue;
}
...
{{
var G__9289 = cljs.reader.read_char.call(null,rdr);
ch = G__9289;
continue;
}
} else
...
var G__9290 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9290;
continue;
}
} else
...
var G__9291 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9291;
continue;
}
}
...
{{
var G__9292 = (function (){buffer.append(ch);
return buffer;
})();
var G__9293 = cljs.reader.read_char.call(null,reader);
buffer = G__9292;
ch = G__9293;
continue;
}
...
{if(("\\" === ch))
{{
var G__9294 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__9296 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9299 = o;if(G__9299)
{var bit__5323__auto__ = (G__9299.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9299.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9299.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9299);
} else
{return false;
}
}
...
{{
var G__9300 = reader;
var G__9301 = eof_is_error;
var G__9302 = sentinel;
var G__9303 = is_recursive;
reader = G__9300;
eof_is_error = G__9301;
sentinel = G__9302;
is_recursive = G__9303;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9304 = cljs.reader.read_comment.call(null,reader,ch);
var G__9305 = eof_is_error;
var G__9306 = sentinel;
var G__9307 = is_recursive;
reader = G__9304;
eof_is_error = G__9305;
sentinel = G__9306;
is_recursive = G__9307;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9314 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9314,0,null);var years = cljs.core.nth.call(null,vec__9314,1,null);var months = cljs.core.nth.call(null,vec__9314,2,null);var days = cljs.core.nth.call(null,vec__9314,3,null);var hours = cljs.core.nth.call(null,vec__9314,4,null);var minutes = cljs.core.nth.call(null,vec__9314,5,null);var seconds = cljs.core.nth.call(null,vec__9314,6,null);var fraction = cljs.core.nth.call(null,vec__9314,7,null);var offset_sign = cljs.core.nth.call(null,vec__9314,8,null);var offset_hours = cljs.core.nth.call(null,vec__9314,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9314,10,null);var v = vec__9314;if(cljs.core.not.call(null,v))
...
{var vec__9316 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9316,0,null);var months = cljs.core.nth.call(null,vec__9316,1,null);var days = cljs.core.nth.call(null,vec__9316,2,null);var hours = cljs.core.nth.call(null,vec__9316,3,null);var minutes = cljs.core.nth.call(null,vec__9316,4,null);var seconds = cljs.core.nth.call(null,vec__9316,5,null);var ms = cljs.core.nth.call(null,vec__9316,6,null);var offset = cljs.core.nth.call(null,vec__9316,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
