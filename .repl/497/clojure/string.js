...
{{
var G__134680 = cljs.core.pop.call(null,v__$1);
v__$1 = G__134680;
continue;
}
} else
...
{var pred__134684 = cljs.core._EQ_;var expr__134685 = limit;if(cljs.core.truth_(pred__134684.call(null,1,expr__134685)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__134684.call(null,2,expr__134685)))
...
var G__134687 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__134688 = (limit__$1 - 1);
var G__134689 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__134687;
limit__$1 = G__134688;
parts = G__134689;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___134691 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___134691))
{var replacement_134692 = temp__4096__auto___134691;buffer.append([cljs.core.str(replacement_134692)].join(''));
} else
{buffer.append(ch);
}
{
var G__134693 = (index + 1);
index = G__134693;
continue;
}
}
