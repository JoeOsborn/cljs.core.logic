...
{{
var G__616399 = cljs.core.pop.call(null,v__$1);
v__$1 = G__616399;
continue;
}
} else
...
{var pred__616403 = cljs.core._EQ_;var expr__616404 = limit;if(cljs.core.truth_(pred__616403.call(null,1,expr__616404)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__616403.call(null,2,expr__616404)))
...
var G__616406 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__616407 = (limit__$1 - 1);
var G__616408 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__616406;
limit__$1 = G__616407;
parts = G__616408;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___616410 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___616410))
{var replacement_616411 = temp__4096__auto___616410;buffer.append([cljs.core.str(replacement_616411)].join(''));
} else
{buffer.append(ch);
}
{
var G__616412 = (index + 1);
index = G__616412;
continue;
}
}
