...
{{
var G__316520 = cljs.core.pop.call(null,v__$1);
v__$1 = G__316520;
continue;
}
} else
...
{var pred__316524 = cljs.core._EQ_;var expr__316525 = limit;if(pred__316524.call(null,1,expr__316525))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__316524.call(null,2,expr__316525))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__316527 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__316528 = (limit__$1 - 1);
var G__316529 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__316527;
limit__$1 = G__316528;
parts = G__316529;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___316531 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___316531))
{var replacement_316532 = temp__4092__auto___316531;buffer.append([cljs.core.str(replacement_316532)].join(''));
} else
{buffer.append(ch);
}
{
var G__316533 = (index + 1);
index = G__316533;
continue;
}
}
