...
reader_error.cljs$lang$applyTo = (function (arglist__79715){
var rdr = cljs.core.first(arglist__79715);
var msg = cljs.core.rest(arglist__79715);
...
{{
var G__79716 = (function (){sb.append(ch);
return sb;
})();
var G__79717 = cljs.reader.read_char.call(null,rdr);
sb = G__79716;
ch = G__79717;
continue;
}
...
{{
var G__79718 = cljs.reader.read_char.call(null,rdr);
ch = G__79718;
continue;
}
} else
...
var G__79719 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__79719;
continue;
}
} else
...
var G__79720 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__79720;
continue;
}
}
...
{{
var G__79721 = (function (){buffer.append(ch);
return buffer;
})();
var G__79722 = cljs.reader.read_char.call(null,reader);
buffer = G__79721;
ch = G__79722;
continue;
}
...
{if(("\\" === ch))
{{
var G__79723 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__79724 = cljs.reader.read_char.call(null,reader);
buffer = G__79723;
ch = G__79724;
continue;
}
...
{{
var G__79725 = (function (){buffer.append(ch);
return buffer;
})();
var G__79726 = cljs.reader.read_char.call(null,reader);
buffer = G__79725;
ch = G__79726;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__79728 = o;if(G__79728)
{var bit__5323__auto__ = (G__79728.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__79728.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__79728.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__79728);
} else
{return false;
}
}
...
{{
var G__79729 = reader;
var G__79730 = eof_is_error;
var G__79731 = sentinel;
var G__79732 = is_recursive;
reader = G__79729;
eof_is_error = G__79730;
sentinel = G__79731;
is_recursive = G__79732;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__79733 = cljs.reader.read_comment.call(null,reader,ch);
var G__79734 = eof_is_error;
var G__79735 = sentinel;
var G__79736 = is_recursive;
reader = G__79733;
eof_is_error = G__79734;
sentinel = G__79735;
is_recursive = G__79736;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__79737 = reader;
var G__79738 = eof_is_error;
var G__79739 = sentinel;
var G__79740 = is_recursive;
reader = G__79737;
eof_is_error = G__79738;
sentinel = G__79739;
is_recursive = G__79740;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__79743 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__79743,0,null);var years = cljs.core.nth.call(null,vec__79743,1,null);var months = cljs.core.nth.call(null,vec__79743,2,null);var days = cljs.core.nth.call(null,vec__79743,3,null);var hours = cljs.core.nth.call(null,vec__79743,4,null);var minutes = cljs.core.nth.call(null,vec__79743,5,null);var seconds = cljs.core.nth.call(null,vec__79743,6,null);var fraction = cljs.core.nth.call(null,vec__79743,7,null);var offset_sign = cljs.core.nth.call(null,vec__79743,8,null);var offset_hours = cljs.core.nth.call(null,vec__79743,9,null);var offset_minutes = cljs.core.nth.call(null,vec__79743,10,null);var v = vec__79743;if(cljs.core.not.call(null,v))
...
{var vec__79745 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__79745,0,null);var months = cljs.core.nth.call(null,vec__79745,1,null);var days = cljs.core.nth.call(null,vec__79745,2,null);var hours = cljs.core.nth.call(null,vec__79745,3,null);var minutes = cljs.core.nth.call(null,vec__79745,4,null);var seconds = cljs.core.nth.call(null,vec__79745,5,null);var ms = cljs.core.nth.call(null,vec__79745,6,null);var offset = cljs.core.nth.call(null,vec__79745,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
