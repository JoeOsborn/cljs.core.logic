...
{{
var G__79746 = cljs.core.pop.call(null,v__$1);
v__$1 = G__79746;
continue;
}
} else
...
{var pred__79750 = cljs.core._EQ_;var expr__79751 = limit;if(pred__79750.call(null,1,expr__79751))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__79750.call(null,2,expr__79751))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__79753 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__79754 = (limit__$1 - 1);
var G__79755 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__79753;
limit__$1 = G__79754;
parts = G__79755;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___79757 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___79757))
{var replacement_79758 = temp__4092__auto___79757;buffer.append([cljs.core.str(replacement_79758)].join(''));
} else
{buffer.append(ch);
}
{
var G__79759 = (index + 1);
index = G__79759;
continue;
}
}
