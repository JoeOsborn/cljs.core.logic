...
{{
var G__55436 = cljs.core.pop.call(null,v__$1);
v__$1 = G__55436;
continue;
}
} else
...
{var pred__55440 = cljs.core._EQ_;var expr__55441 = limit;if(pred__55440.call(null,1,expr__55441))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__55440.call(null,2,expr__55441))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__55443 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__55444 = (limit__$1 - 1);
var G__55445 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__55443;
limit__$1 = G__55444;
parts = G__55445;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___55447 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___55447))
{var replacement_55448 = temp__4092__auto___55447;buffer.append([cljs.core.str(replacement_55448)].join(''));
} else
{buffer.append(ch);
}
{
var G__55449 = (index + 1);
index = G__55449;
continue;
}
}
