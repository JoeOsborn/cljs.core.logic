...
{{
var G__16387 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16387;
continue;
}
} else
...
{var pred__16391 = cljs.core._EQ_;var expr__16392 = limit;if(cljs.core.truth_(pred__16391.call(null,1,expr__16392)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16391.call(null,2,expr__16392)))
...
var G__16394 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16395 = (limit__$1 - 1);
var G__16396 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16394;
limit__$1 = G__16395;
parts = G__16396;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___16398 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___16398))
{var replacement_16399 = temp__4096__auto___16398;buffer.append([cljs.core.str(replacement_16399)].join(''));
} else
{buffer.append(ch);
}
{
var G__16400 = (index + 1);
index = G__16400;
continue;
}
}
