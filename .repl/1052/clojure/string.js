...
{{
var G__102941 = cljs.core.pop.call(null,v__$1);
v__$1 = G__102941;
continue;
}
} else
...
{var pred__102945 = cljs.core._EQ_;var expr__102946 = limit;if(cljs.core.truth_(pred__102945.call(null,1,expr__102946)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__102945.call(null,2,expr__102946)))
...
var G__102948 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__102949 = (limit__$1 - 1);
var G__102950 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__102948;
limit__$1 = G__102949;
parts = G__102950;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___102952 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___102952))
{var replacement_102953 = temp__4096__auto___102952;buffer.append([cljs.core.str(replacement_102953)].join(''));
} else
{buffer.append(ch);
}
{
var G__102954 = (index + 1);
index = G__102954;
continue;
}
}
