...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj103345 = {};return obj103345;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__10544__auto__ = reader;if(and__10544__auto__)
...
{var x__11159__auto__ = (((reader == null))?null:reader);return (function (){var or__10556__auto__ = (cljs.reader.read_char[goog.typeOf(x__11159__auto__)]);if(or__10556__auto__)
{return or__10556__auto__;
} else
{var or__10556__auto____$1 = (cljs.reader.read_char["_"]);if(or__10556__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__10544__auto__ = reader;if(and__10544__auto__)
...
{var x__11159__auto__ = (((reader == null))?null:reader);return (function (){var or__10556__auto__ = (cljs.reader.unread[goog.typeOf(x__11159__auto__)]);if(or__10556__auto__)
{return or__10556__auto__;
} else
{var or__10556__auto____$1 = (cljs.reader.unread["_"]);if(or__10556__auto____$1)
{return or__10556__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__11100__auto__,writer__11101__auto__,opt__11102__auto__){return cljs.core._write.call(null,writer__11101__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__10556__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__103346){
var rdr = cljs.core.first(arglist__103346);
var msg = cljs.core.rest(arglist__103346);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__10544__auto__ = !((ch === "#"));if(and__10544__auto__)
{var and__10544__auto____$1 = !((ch === "'"));if(and__10544__auto____$1)
{var and__10544__auto____$2 = !((ch === ":"));if(and__10544__auto____$2)
...
{{
var G__103347 = (function (){sb.append(ch);
return sb;
})();
var G__103348 = cljs.reader.read_char.call(null,rdr);
sb = G__103347;
ch = G__103348;
continue;
}
...
{{
var G__103349 = cljs.reader.read_char.call(null,rdr);
ch = G__103349;
continue;
}
} else
...
var G__103350 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__103350;
continue;
}
} else
...
var G__103351 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__103351;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__10556__auto__ = (ch == null);if(or__10556__auto__)
{return or__10556__auto__;
} else
{var or__10556__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__10556__auto____$1)
{return or__10556__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__10556__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
...
{{
var G__103352 = (function (){buffer.append(ch);
return buffer;
})();
var G__103353 = cljs.reader.read_char.call(null,reader);
buffer = G__103352;
ch = G__103353;
continue;
}
...
{if(("\\" === ch))
{{
var G__103354 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__103355 = cljs.reader.read_char.call(null,reader);
buffer = G__103354;
ch = G__103355;
continue;
}
...
{{
var G__103356 = (function (){buffer.append(ch);
return buffer;
})();
var G__103357 = cljs.reader.read_char.call(null,reader);
buffer = G__103356;
ch = G__103357;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__103359 = o;if(G__103359)
{var bit__11182__auto__ = (G__103359.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11182__auto__) || (G__103359.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__103359.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__103359);
} else
{return false;
}
}
...
{{
var G__103360 = reader;
var G__103361 = eof_is_error;
var G__103362 = sentinel;
var G__103363 = is_recursive;
reader = G__103360;
eof_is_error = G__103361;
sentinel = G__103362;
is_recursive = G__103363;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__103364 = cljs.reader.read_comment.call(null,reader,ch);
var G__103365 = eof_is_error;
var G__103366 = sentinel;
var G__103367 = is_recursive;
reader = G__103364;
eof_is_error = G__103365;
sentinel = G__103366;
is_recursive = G__103367;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__103368 = reader;
var G__103369 = eof_is_error;
var G__103370 = sentinel;
var G__103371 = is_recursive;
reader = G__103368;
eof_is_error = G__103369;
sentinel = G__103370;
is_recursive = G__103371;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__103374 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__103374,0,null);var years = cljs.core.nth.call(null,vec__103374,1,null);var months = cljs.core.nth.call(null,vec__103374,2,null);var days = cljs.core.nth.call(null,vec__103374,3,null);var hours = cljs.core.nth.call(null,vec__103374,4,null);var minutes = cljs.core.nth.call(null,vec__103374,5,null);var seconds = cljs.core.nth.call(null,vec__103374,6,null);var fraction = cljs.core.nth.call(null,vec__103374,7,null);var offset_sign = cljs.core.nth.call(null,vec__103374,8,null);var offset_hours = cljs.core.nth.call(null,vec__103374,9,null);var offset_minutes = cljs.core.nth.call(null,vec__103374,10,null);var v = vec__103374;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__10556__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return 0;
}
...
{var vec__103376 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__103376,0,null);var months = cljs.core.nth.call(null,vec__103376,1,null);var days = cljs.core.nth.call(null,vec__103376,2,null);var hours = cljs.core.nth.call(null,vec__103376,3,null);var minutes = cljs.core.nth.call(null,vec__103376,4,null);var seconds = cljs.core.nth.call(null,vec__103376,5,null);var ms = cljs.core.nth.call(null,vec__103376,6,null);var offset = cljs.core.nth.call(null,vec__103376,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
