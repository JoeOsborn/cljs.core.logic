...
reader_error.cljs$lang$applyTo = (function (arglist__13355){
var rdr = cljs.core.first(arglist__13355);
var msg = cljs.core.rest(arglist__13355);
...
{{
var G__13356 = (function (){sb.append(ch);
return sb;
})();
var G__13357 = cljs.reader.read_char.call(null,rdr);
sb = G__13356;
ch = G__13357;
continue;
}
...
{{
var G__13358 = cljs.reader.read_char.call(null,rdr);
ch = G__13358;
continue;
}
} else
...
var G__13359 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__13359;
continue;
}
} else
...
var G__13360 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__13360;
continue;
}
}
...
{{
var G__13361 = (function (){buffer.append(ch);
return buffer;
})();
...
{if(("\\" === ch))
{{
var G__13363 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__13365 = (function (){buffer.append(ch);
return buffer;
})();
var G__13366 = cljs.reader.read_char.call(null,reader);
buffer = G__13365;
ch = G__13366;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__13368 = o;if(G__13368)
{var bit__5604__auto__ = (G__13368.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5604__auto__) || (G__13368.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__13368.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__13368);
} else
{return false;
}
}
...
{{
var G__13369 = reader;
var G__13370 = eof_is_error;
var G__13371 = sentinel;
var G__13372 = is_recursive;
reader = G__13369;
eof_is_error = G__13370;
sentinel = G__13371;
is_recursive = G__13372;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__13373 = cljs.reader.read_comment.call(null,reader,ch);
var G__13374 = eof_is_error;
var G__13375 = sentinel;
var G__13376 = is_recursive;
reader = G__13373;
eof_is_error = G__13374;
sentinel = G__13375;
is_recursive = G__13376;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__13377 = reader;
var G__13378 = eof_is_error;
var G__13379 = sentinel;
var G__13380 = is_recursive;
reader = G__13377;
eof_is_error = G__13378;
sentinel = G__13379;
is_recursive = G__13380;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__13383 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__13383,0,null);var years = cljs.core.nth.call(null,vec__13383,1,null);var months = cljs.core.nth.call(null,vec__13383,2,null);var days = cljs.core.nth.call(null,vec__13383,3,null);var hours = cljs.core.nth.call(null,vec__13383,4,null);var minutes = cljs.core.nth.call(null,vec__13383,5,null);var seconds = cljs.core.nth.call(null,vec__13383,6,null);var fraction = cljs.core.nth.call(null,vec__13383,7,null);var offset_sign = cljs.core.nth.call(null,vec__13383,8,null);var offset_hours = cljs.core.nth.call(null,vec__13383,9,null);var offset_minutes = cljs.core.nth.call(null,vec__13383,10,null);var v = vec__13383;if(cljs.core.not.call(null,v))
...
{var vec__13385 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__13385,0,null);var months = cljs.core.nth.call(null,vec__13385,1,null);var days = cljs.core.nth.call(null,vec__13385,2,null);var hours = cljs.core.nth.call(null,vec__13385,3,null);var minutes = cljs.core.nth.call(null,vec__13385,4,null);var seconds = cljs.core.nth.call(null,vec__13385,5,null);var ms = cljs.core.nth.call(null,vec__13385,6,null);var offset = cljs.core.nth.call(null,vec__13385,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
