...
{{
var G__13386 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13386;
continue;
}
} else
...
{var pred__13390 = cljs.core._EQ_;var expr__13391 = limit;if(pred__13390.call(null,1,expr__13391))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__13390.call(null,2,expr__13391))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__13393 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13394 = (limit__$1 - 1);
var G__13395 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13393;
limit__$1 = G__13394;
parts = G__13395;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___13397 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___13397))
{var replacement_13398 = temp__4092__auto___13397;buffer.append([cljs.core.str(replacement_13398)].join(''));
} else
{buffer.append(ch);
}
{
var G__13399 = (index + 1);
index = G__13399;
continue;
}
}
