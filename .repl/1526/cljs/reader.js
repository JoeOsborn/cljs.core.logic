...
reader_error.cljs$lang$applyTo = (function (arglist__332934){
var rdr = cljs.core.first(arglist__332934);
var msg = cljs.core.rest(arglist__332934);
...
{{
var G__332935 = (function (){sb.append(ch);
return sb;
})();
var G__332936 = cljs.reader.read_char.call(null,rdr);
sb = G__332935;
ch = G__332936;
continue;
}
...
{{
var G__332937 = cljs.reader.read_char.call(null,rdr);
ch = G__332937;
continue;
}
} else
...
var G__332938 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__332938;
continue;
}
} else
...
var G__332939 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__332939;
continue;
}
}
...
{{
var G__332940 = (function (){buffer.append(ch);
return buffer;
})();
var G__332941 = cljs.reader.read_char.call(null,reader);
buffer = G__332940;
ch = G__332941;
continue;
}
...
{if(("\\" === ch))
{{
var G__332942 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__332943 = cljs.reader.read_char.call(null,reader);
buffer = G__332942;
ch = G__332943;
continue;
}
...
{{
var G__332944 = (function (){buffer.append(ch);
return buffer;
})();
var G__332945 = cljs.reader.read_char.call(null,reader);
buffer = G__332944;
ch = G__332945;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__332947 = o;if(G__332947)
{var bit__5323__auto__ = (G__332947.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__332947.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__332947.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__332947);
} else
{return false;
}
}
...
{{
var G__332948 = reader;
var G__332949 = eof_is_error;
var G__332950 = sentinel;
var G__332951 = is_recursive;
reader = G__332948;
eof_is_error = G__332949;
sentinel = G__332950;
is_recursive = G__332951;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__332952 = cljs.reader.read_comment.call(null,reader,ch);
var G__332953 = eof_is_error;
var G__332954 = sentinel;
var G__332955 = is_recursive;
reader = G__332952;
eof_is_error = G__332953;
sentinel = G__332954;
is_recursive = G__332955;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__332956 = reader;
var G__332957 = eof_is_error;
var G__332958 = sentinel;
var G__332959 = is_recursive;
reader = G__332956;
eof_is_error = G__332957;
sentinel = G__332958;
is_recursive = G__332959;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__332962 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__332962,0,null);var years = cljs.core.nth.call(null,vec__332962,1,null);var months = cljs.core.nth.call(null,vec__332962,2,null);var days = cljs.core.nth.call(null,vec__332962,3,null);var hours = cljs.core.nth.call(null,vec__332962,4,null);var minutes = cljs.core.nth.call(null,vec__332962,5,null);var seconds = cljs.core.nth.call(null,vec__332962,6,null);var fraction = cljs.core.nth.call(null,vec__332962,7,null);var offset_sign = cljs.core.nth.call(null,vec__332962,8,null);var offset_hours = cljs.core.nth.call(null,vec__332962,9,null);var offset_minutes = cljs.core.nth.call(null,vec__332962,10,null);var v = vec__332962;if(cljs.core.not.call(null,v))
...
{var vec__332964 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__332964,0,null);var months = cljs.core.nth.call(null,vec__332964,1,null);var days = cljs.core.nth.call(null,vec__332964,2,null);var hours = cljs.core.nth.call(null,vec__332964,3,null);var minutes = cljs.core.nth.call(null,vec__332964,4,null);var seconds = cljs.core.nth.call(null,vec__332964,5,null);var ms = cljs.core.nth.call(null,vec__332964,6,null);var offset = cljs.core.nth.call(null,vec__332964,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
