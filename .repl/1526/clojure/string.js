...
{{
var G__332638 = cljs.core.pop.call(null,v__$1);
v__$1 = G__332638;
continue;
}
} else
...
{var pred__332642 = cljs.core._EQ_;var expr__332643 = limit;if(pred__332642.call(null,1,expr__332643))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__332642.call(null,2,expr__332643))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__332645 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__332646 = (limit__$1 - 1);
var G__332647 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__332645;
limit__$1 = G__332646;
parts = G__332647;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___332649 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___332649))
{var replacement_332650 = temp__4092__auto___332649;buffer.append([cljs.core.str(replacement_332650)].join(''));
} else
{buffer.append(ch);
}
{
var G__332651 = (index + 1);
index = G__332651;
continue;
}
}
