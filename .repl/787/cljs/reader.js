...
reader_error.cljs$lang$applyTo = (function (arglist__53390){
var rdr = cljs.core.first(arglist__53390);
var msg = cljs.core.rest(arglist__53390);
...
{{
var G__53391 = (function (){sb.append(ch);
return sb;
})();
var G__53392 = cljs.reader.read_char.call(null,rdr);
sb = G__53391;
ch = G__53392;
continue;
}
...
{{
var G__53393 = cljs.reader.read_char.call(null,rdr);
ch = G__53393;
continue;
}
} else
...
var G__53394 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__53394;
continue;
}
} else
...
var G__53395 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__53395;
continue;
}
}
...
{{
var G__53396 = (function (){buffer.append(ch);
return buffer;
})();
var G__53397 = cljs.reader.read_char.call(null,reader);
buffer = G__53396;
ch = G__53397;
continue;
}
...
{if(("\\" === ch))
{{
var G__53398 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__53399 = cljs.reader.read_char.call(null,reader);
buffer = G__53398;
ch = G__53399;
continue;
}
...
{{
var G__53400 = (function (){buffer.append(ch);
return buffer;
})();
var G__53401 = cljs.reader.read_char.call(null,reader);
buffer = G__53400;
ch = G__53401;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__53403 = o;if(G__53403)
{var bit__5323__auto__ = (G__53403.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__53403.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__53403.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__53403);
} else
{return false;
}
}
...
{{
var G__53404 = reader;
var G__53405 = eof_is_error;
var G__53406 = sentinel;
var G__53407 = is_recursive;
reader = G__53404;
eof_is_error = G__53405;
sentinel = G__53406;
is_recursive = G__53407;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__53408 = cljs.reader.read_comment.call(null,reader,ch);
var G__53409 = eof_is_error;
var G__53410 = sentinel;
var G__53411 = is_recursive;
reader = G__53408;
eof_is_error = G__53409;
sentinel = G__53410;
is_recursive = G__53411;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__53412 = reader;
var G__53413 = eof_is_error;
var G__53414 = sentinel;
var G__53415 = is_recursive;
reader = G__53412;
eof_is_error = G__53413;
sentinel = G__53414;
is_recursive = G__53415;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__53418 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__53418,0,null);var years = cljs.core.nth.call(null,vec__53418,1,null);var months = cljs.core.nth.call(null,vec__53418,2,null);var days = cljs.core.nth.call(null,vec__53418,3,null);var hours = cljs.core.nth.call(null,vec__53418,4,null);var minutes = cljs.core.nth.call(null,vec__53418,5,null);var seconds = cljs.core.nth.call(null,vec__53418,6,null);var fraction = cljs.core.nth.call(null,vec__53418,7,null);var offset_sign = cljs.core.nth.call(null,vec__53418,8,null);var offset_hours = cljs.core.nth.call(null,vec__53418,9,null);var offset_minutes = cljs.core.nth.call(null,vec__53418,10,null);var v = vec__53418;if(cljs.core.not.call(null,v))
...
{var vec__53420 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__53420,0,null);var months = cljs.core.nth.call(null,vec__53420,1,null);var days = cljs.core.nth.call(null,vec__53420,2,null);var hours = cljs.core.nth.call(null,vec__53420,3,null);var minutes = cljs.core.nth.call(null,vec__53420,4,null);var seconds = cljs.core.nth.call(null,vec__53420,5,null);var ms = cljs.core.nth.call(null,vec__53420,6,null);var offset = cljs.core.nth.call(null,vec__53420,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
