...
{{
var G__52961 = cljs.core.pop.call(null,v__$1);
v__$1 = G__52961;
continue;
}
} else
...
{var pred__52965 = cljs.core._EQ_;var expr__52966 = limit;if(pred__52965.call(null,1,expr__52966))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__52965.call(null,2,expr__52966))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__52968 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__52969 = (limit__$1 - 1);
var G__52970 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__52968;
limit__$1 = G__52969;
parts = G__52970;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___52972 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___52972))
{var replacement_52973 = temp__4092__auto___52972;buffer.append([cljs.core.str(replacement_52973)].join(''));
} else
{buffer.append(ch);
}
{
var G__52974 = (index + 1);
index = G__52974;
continue;
}
}
