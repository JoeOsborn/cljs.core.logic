...
reader_error.cljs$lang$applyTo = (function (arglist__16999){
var rdr = cljs.core.first(arglist__16999);
var msg = cljs.core.rest(arglist__16999);
...
{{
var G__17000 = (function (){sb.append(ch);
return sb;
})();
var G__17001 = cljs.reader.read_char.call(null,rdr);
sb = G__17000;
ch = G__17001;
continue;
}
...
{{
var G__17002 = cljs.reader.read_char.call(null,rdr);
ch = G__17002;
continue;
}
} else
...
var G__17003 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__17003;
continue;
}
} else
...
var G__17004 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__17004;
continue;
}
}
...
{{
var G__17005 = (function (){buffer.append(ch);
return buffer;
})();
var G__17006 = cljs.reader.read_char.call(null,reader);
buffer = G__17005;
ch = G__17006;
continue;
}
...
{if(("\\" === ch))
{{
var G__17007 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__17008 = cljs.reader.read_char.call(null,reader);
buffer = G__17007;
ch = G__17008;
continue;
}
...
{{
var G__17009 = (function (){buffer.append(ch);
return buffer;
})();
var G__17010 = cljs.reader.read_char.call(null,reader);
buffer = G__17009;
ch = G__17010;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__17012 = o;if(G__17012)
{var bit__5323__auto__ = (G__17012.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__17012.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__17012.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__17012);
} else
{return false;
}
}
...
{{
var G__17013 = reader;
var G__17014 = eof_is_error;
var G__17015 = sentinel;
var G__17016 = is_recursive;
reader = G__17013;
eof_is_error = G__17014;
sentinel = G__17015;
is_recursive = G__17016;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__17017 = cljs.reader.read_comment.call(null,reader,ch);
var G__17018 = eof_is_error;
var G__17019 = sentinel;
var G__17020 = is_recursive;
reader = G__17017;
eof_is_error = G__17018;
sentinel = G__17019;
is_recursive = G__17020;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__17021 = reader;
var G__17022 = eof_is_error;
var G__17023 = sentinel;
var G__17024 = is_recursive;
reader = G__17021;
eof_is_error = G__17022;
sentinel = G__17023;
is_recursive = G__17024;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__17027 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__17027,0,null);var years = cljs.core.nth.call(null,vec__17027,1,null);var months = cljs.core.nth.call(null,vec__17027,2,null);var days = cljs.core.nth.call(null,vec__17027,3,null);var hours = cljs.core.nth.call(null,vec__17027,4,null);var minutes = cljs.core.nth.call(null,vec__17027,5,null);var seconds = cljs.core.nth.call(null,vec__17027,6,null);var fraction = cljs.core.nth.call(null,vec__17027,7,null);var offset_sign = cljs.core.nth.call(null,vec__17027,8,null);var offset_hours = cljs.core.nth.call(null,vec__17027,9,null);var offset_minutes = cljs.core.nth.call(null,vec__17027,10,null);var v = vec__17027;if(cljs.core.not.call(null,v))
...
{var vec__17029 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__17029,0,null);var months = cljs.core.nth.call(null,vec__17029,1,null);var days = cljs.core.nth.call(null,vec__17029,2,null);var hours = cljs.core.nth.call(null,vec__17029,3,null);var minutes = cljs.core.nth.call(null,vec__17029,4,null);var seconds = cljs.core.nth.call(null,vec__17029,5,null);var ms = cljs.core.nth.call(null,vec__17029,6,null);var offset = cljs.core.nth.call(null,vec__17029,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
