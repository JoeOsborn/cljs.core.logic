...
{{
var G__17032 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17032;
continue;
}
} else
...
{var pred__17036 = cljs.core._EQ_;var expr__17037 = limit;if(pred__17036.call(null,1,expr__17037))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__17036.call(null,2,expr__17037))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__17039 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17040 = (limit__$1 - 1);
var G__17041 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17039;
limit__$1 = G__17040;
parts = G__17041;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___17043 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___17043))
{var replacement_17044 = temp__4092__auto___17043;buffer.append([cljs.core.str(replacement_17044)].join(''));
} else
{buffer.append(ch);
}
{
var G__17045 = (index + 1);
index = G__17045;
continue;
}
}
