...
{{
var G__96792 = cljs.core.pop.call(null,v__$1);
v__$1 = G__96792;
continue;
}
} else
...
{var pred__96796 = cljs.core._EQ_;var expr__96797 = limit;if(pred__96796.call(null,1,expr__96797))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__96796.call(null,2,expr__96797))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__96799 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__96800 = (limit__$1 - 1);
var G__96801 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__96799;
limit__$1 = G__96800;
parts = G__96801;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___96803 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___96803))
{var replacement_96804 = temp__4092__auto___96803;buffer.append([cljs.core.str(replacement_96804)].join(''));
} else
{buffer.append(ch);
}
{
var G__96805 = (index + 1);
index = G__96805;
continue;
}
}
