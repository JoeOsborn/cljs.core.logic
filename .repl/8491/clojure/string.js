...
{{
var G__210131 = cljs.core.pop.call(null,v__$1);
v__$1 = G__210131;
continue;
}
} else
...
{var pred__210135 = cljs.core._EQ_;var expr__210136 = limit;if(cljs.core.truth_(pred__210135.call(null,1,expr__210136)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__210135.call(null,2,expr__210136)))
...
var G__210138 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__210139 = (limit__$1 - 1);
var G__210140 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__210138;
limit__$1 = G__210139;
parts = G__210140;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___210142 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___210142))
{var replacement_210143 = temp__4096__auto___210142;buffer.append([cljs.core.str(replacement_210143)].join(''));
} else
{buffer.append(ch);
}
{
var G__210144 = (index + 1);
index = G__210144;
continue;
}
}
