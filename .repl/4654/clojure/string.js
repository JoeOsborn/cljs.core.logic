...
{{
var G__26564 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26564;
continue;
}
} else
...
{var pred__26568 = cljs.core._EQ_;var expr__26569 = limit;if(pred__26568.call(null,1,expr__26569))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__26568.call(null,2,expr__26569))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__26571 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26572 = (limit__$1 - 1);
var G__26573 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26571;
limit__$1 = G__26572;
parts = G__26573;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___26575 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___26575))
{var replacement_26576 = temp__4092__auto___26575;buffer.append([cljs.core.str(replacement_26576)].join(''));
} else
{buffer.append(ch);
}
{
var G__26577 = (index + 1);
index = G__26577;
continue;
}
}
