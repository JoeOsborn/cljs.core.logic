...
{{
var G__242899 = cljs.core.pop.call(null,v__$1);
v__$1 = G__242899;
continue;
}
} else
...
{var pred__242903 = cljs.core._EQ_;var expr__242904 = limit;if(cljs.core.truth_(pred__242903.call(null,1,expr__242904)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__242903.call(null,2,expr__242904)))
...
var G__242906 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__242907 = (limit__$1 - 1);
var G__242908 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__242906;
limit__$1 = G__242907;
parts = G__242908;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___242910 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___242910))
{var replacement_242911 = temp__4096__auto___242910;buffer.append([cljs.core.str(replacement_242911)].join(''));
} else
{buffer.append(ch);
}
{
var G__242912 = (index + 1);
index = G__242912;
continue;
}
}
