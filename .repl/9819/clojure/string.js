...
{{
var G__50095 = cljs.core.pop.call(null,v__$1);
v__$1 = G__50095;
continue;
}
} else
...
{var pred__50099 = cljs.core._EQ_;var expr__50100 = limit;if(pred__50099.call(null,1,expr__50100))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__50099.call(null,2,expr__50100))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__50102 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__50103 = (limit__$1 - 1);
var G__50104 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__50102;
limit__$1 = G__50103;
parts = G__50104;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___50106 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___50106))
{var replacement_50107 = temp__4092__auto___50106;buffer.append([cljs.core.str(replacement_50107)].join(''));
} else
{buffer.append(ch);
}
{
var G__50108 = (index + 1);
index = G__50108;
continue;
}
}
