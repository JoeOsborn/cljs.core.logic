...
reader_error.cljs$lang$applyTo = (function (arglist__50064){
var rdr = cljs.core.first(arglist__50064);
var msg = cljs.core.rest(arglist__50064);
...
{{
var G__50065 = (function (){sb.append(ch);
return sb;
})();
var G__50066 = cljs.reader.read_char.call(null,rdr);
sb = G__50065;
ch = G__50066;
continue;
}
...
{{
var G__50067 = cljs.reader.read_char.call(null,rdr);
ch = G__50067;
continue;
}
} else
...
var G__50068 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__50068;
continue;
}
} else
...
var G__50069 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__50069;
continue;
}
}
...
{{
var G__50070 = (function (){buffer.append(ch);
return buffer;
})();
var G__50071 = cljs.reader.read_char.call(null,reader);
buffer = G__50070;
ch = G__50071;
continue;
}
...
{if(("\\" === ch))
{{
var G__50072 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__50073 = cljs.reader.read_char.call(null,reader);
buffer = G__50072;
ch = G__50073;
continue;
}
...
{{
var G__50074 = (function (){buffer.append(ch);
return buffer;
})();
var G__50075 = cljs.reader.read_char.call(null,reader);
buffer = G__50074;
ch = G__50075;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__50077 = o;if(G__50077)
{var bit__5323__auto__ = (G__50077.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__50077.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__50077.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__50077);
} else
{return false;
}
}
...
{{
var G__50078 = reader;
var G__50079 = eof_is_error;
var G__50080 = sentinel;
var G__50081 = is_recursive;
reader = G__50078;
eof_is_error = G__50079;
sentinel = G__50080;
is_recursive = G__50081;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__50082 = cljs.reader.read_comment.call(null,reader,ch);
var G__50083 = eof_is_error;
var G__50084 = sentinel;
var G__50085 = is_recursive;
reader = G__50082;
eof_is_error = G__50083;
sentinel = G__50084;
is_recursive = G__50085;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__50086 = reader;
var G__50087 = eof_is_error;
var G__50088 = sentinel;
var G__50089 = is_recursive;
reader = G__50086;
eof_is_error = G__50087;
sentinel = G__50088;
is_recursive = G__50089;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__50092 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__50092,0,null);var years = cljs.core.nth.call(null,vec__50092,1,null);var months = cljs.core.nth.call(null,vec__50092,2,null);var days = cljs.core.nth.call(null,vec__50092,3,null);var hours = cljs.core.nth.call(null,vec__50092,4,null);var minutes = cljs.core.nth.call(null,vec__50092,5,null);var seconds = cljs.core.nth.call(null,vec__50092,6,null);var fraction = cljs.core.nth.call(null,vec__50092,7,null);var offset_sign = cljs.core.nth.call(null,vec__50092,8,null);var offset_hours = cljs.core.nth.call(null,vec__50092,9,null);var offset_minutes = cljs.core.nth.call(null,vec__50092,10,null);var v = vec__50092;if(cljs.core.not.call(null,v))
...
{var vec__50094 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__50094,0,null);var months = cljs.core.nth.call(null,vec__50094,1,null);var days = cljs.core.nth.call(null,vec__50094,2,null);var hours = cljs.core.nth.call(null,vec__50094,3,null);var minutes = cljs.core.nth.call(null,vec__50094,4,null);var seconds = cljs.core.nth.call(null,vec__50094,5,null);var ms = cljs.core.nth.call(null,vec__50094,6,null);var offset = cljs.core.nth.call(null,vec__50094,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
