...
{{
var G__15646 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15646;
continue;
}
} else
...
{var pred__15650 = cljs.core._EQ_;var expr__15651 = limit;if(pred__15650.call(null,1,expr__15651))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__15650.call(null,2,expr__15651))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__15653 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15654 = (limit__$1 - 1);
var G__15655 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15653;
limit__$1 = G__15654;
parts = G__15655;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___15657 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___15657))
{var replacement_15658 = temp__4092__auto___15657;buffer.append([cljs.core.str(replacement_15658)].join(''));
} else
{buffer.append(ch);
}
{
var G__15659 = (index + 1);
index = G__15659;
continue;
}
}
