...
{{
var G__94832 = cljs.core.pop.call(null,v__$1);
v__$1 = G__94832;
continue;
}
} else
...
{var pred__94836 = cljs.core._EQ_;var expr__94837 = limit;if(cljs.core.truth_(pred__94836.call(null,1,expr__94837)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__94836.call(null,2,expr__94837)))
...
var G__94839 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__94840 = (limit__$1 - 1);
var G__94841 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__94839;
limit__$1 = G__94840;
parts = G__94841;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___94843 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___94843))
{var replacement_94844 = temp__4096__auto___94843;buffer.append([cljs.core.str(replacement_94844)].join(''));
} else
{buffer.append(ch);
}
{
var G__94845 = (index + 1);
index = G__94845;
continue;
}
}
