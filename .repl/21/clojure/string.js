...
{{
var G__233515 = cljs.core.pop.call(null,v__$1);
v__$1 = G__233515;
continue;
}
} else
...
{var pred__233519 = cljs.core._EQ_;var expr__233520 = limit;if(pred__233519.call(null,1,expr__233520))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__233519.call(null,2,expr__233520))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__233522 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__233523 = (limit__$1 - 1);
var G__233524 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__233522;
limit__$1 = G__233523;
parts = G__233524;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___233526 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___233526))
{var replacement_233527 = temp__4092__auto___233526;buffer.append([cljs.core.str(replacement_233527)].join(''));
} else
{buffer.append(ch);
}
{
var G__233528 = (index + 1);
index = G__233528;
continue;
}
}
