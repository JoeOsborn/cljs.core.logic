...
reader_error.cljs$lang$applyTo = (function (arglist__233811){
var rdr = cljs.core.first(arglist__233811);
var msg = cljs.core.rest(arglist__233811);
...
{{
var G__233812 = (function (){sb.append(ch);
return sb;
})();
var G__233813 = cljs.reader.read_char.call(null,rdr);
sb = G__233812;
ch = G__233813;
continue;
}
...
{{
var G__233814 = cljs.reader.read_char.call(null,rdr);
ch = G__233814;
continue;
}
} else
...
var G__233815 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__233815;
continue;
}
} else
...
var G__233816 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__233816;
continue;
}
}
...
{{
var G__233817 = (function (){buffer.append(ch);
return buffer;
})();
var G__233818 = cljs.reader.read_char.call(null,reader);
buffer = G__233817;
ch = G__233818;
continue;
}
...
{if(("\\" === ch))
{{
var G__233819 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__233820 = cljs.reader.read_char.call(null,reader);
buffer = G__233819;
ch = G__233820;
continue;
}
...
{{
var G__233821 = (function (){buffer.append(ch);
return buffer;
})();
var G__233822 = cljs.reader.read_char.call(null,reader);
buffer = G__233821;
ch = G__233822;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__233824 = o;if(G__233824)
{var bit__5323__auto__ = (G__233824.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__233824.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__233824.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__233824);
} else
{return false;
}
}
...
{{
var G__233825 = reader;
var G__233826 = eof_is_error;
var G__233827 = sentinel;
var G__233828 = is_recursive;
reader = G__233825;
eof_is_error = G__233826;
sentinel = G__233827;
is_recursive = G__233828;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__233829 = cljs.reader.read_comment.call(null,reader,ch);
var G__233830 = eof_is_error;
var G__233831 = sentinel;
var G__233832 = is_recursive;
reader = G__233829;
eof_is_error = G__233830;
sentinel = G__233831;
is_recursive = G__233832;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__233833 = reader;
var G__233834 = eof_is_error;
var G__233835 = sentinel;
var G__233836 = is_recursive;
reader = G__233833;
eof_is_error = G__233834;
sentinel = G__233835;
is_recursive = G__233836;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__233839 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__233839,0,null);var years = cljs.core.nth.call(null,vec__233839,1,null);var months = cljs.core.nth.call(null,vec__233839,2,null);var days = cljs.core.nth.call(null,vec__233839,3,null);var hours = cljs.core.nth.call(null,vec__233839,4,null);var minutes = cljs.core.nth.call(null,vec__233839,5,null);var seconds = cljs.core.nth.call(null,vec__233839,6,null);var fraction = cljs.core.nth.call(null,vec__233839,7,null);var offset_sign = cljs.core.nth.call(null,vec__233839,8,null);var offset_hours = cljs.core.nth.call(null,vec__233839,9,null);var offset_minutes = cljs.core.nth.call(null,vec__233839,10,null);var v = vec__233839;if(cljs.core.not.call(null,v))
...
{var vec__233841 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__233841,0,null);var months = cljs.core.nth.call(null,vec__233841,1,null);var days = cljs.core.nth.call(null,vec__233841,2,null);var hours = cljs.core.nth.call(null,vec__233841,3,null);var minutes = cljs.core.nth.call(null,vec__233841,4,null);var seconds = cljs.core.nth.call(null,vec__233841,5,null);var ms = cljs.core.nth.call(null,vec__233841,6,null);var offset = cljs.core.nth.call(null,vec__233841,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
