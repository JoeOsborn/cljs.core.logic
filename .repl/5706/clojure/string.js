...
{{
var G__15487 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15487;
continue;
}
} else
...
{var pred__15491 = cljs.core._EQ_;var expr__15492 = limit;if(cljs.core.truth_(pred__15491.call(null,1,expr__15492)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15491.call(null,2,expr__15492)))
...
var G__15500 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15501 = (limit__$1 - 1);
var G__15502 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15500;
limit__$1 = G__15501;
parts = G__15502;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___15506 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___15506))
{var replacement_15507 = temp__4096__auto___15506;buffer.append([cljs.core.str(replacement_15507)].join(''));
} else
{buffer.append(ch);
}
{
var G__15508 = (index + 1);
index = G__15508;
continue;
}
}
