...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj16040 = {};return obj16040;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__16041){
var rdr = cljs.core.first(arglist__16041);
var msg = cljs.core.rest(arglist__16041);
...
{{
var G__16042 = (function (){sb.append(ch);
return sb;
})();
var G__16043 = cljs.reader.read_char.call(null,rdr);
sb = G__16042;
ch = G__16043;
continue;
}
...
{{
var G__16044 = cljs.reader.read_char.call(null,rdr);
ch = G__16044;
continue;
}
} else
...
var G__16045 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__16045;
continue;
}
} else
...
var G__16046 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__16046;
continue;
}
}
...
{{
var G__16047 = (function (){buffer.append(ch);
return buffer;
})();
var G__16048 = cljs.reader.read_char.call(null,reader);
buffer = G__16047;
ch = G__16048;
continue;
}
...
{if(("\\" === ch))
{{
var G__16049 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__16050 = cljs.reader.read_char.call(null,reader);
buffer = G__16049;
ch = G__16050;
continue;
}
...
{{
var G__16051 = (function (){buffer.append(ch);
return buffer;
})();
var G__16052 = cljs.reader.read_char.call(null,reader);
buffer = G__16051;
ch = G__16052;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__16054 = o;if(G__16054)
{var bit__11182__auto__ = (G__16054.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11182__auto__) || (G__16054.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__16054.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__16054);
} else
{return false;
}
}
...
{{
var G__16055 = reader;
var G__16056 = eof_is_error;
var G__16057 = sentinel;
var G__16058 = is_recursive;
reader = G__16055;
eof_is_error = G__16056;
sentinel = G__16057;
is_recursive = G__16058;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__16059 = cljs.reader.read_comment.call(null,reader,ch);
var G__16060 = eof_is_error;
var G__16061 = sentinel;
var G__16062 = is_recursive;
reader = G__16059;
eof_is_error = G__16060;
sentinel = G__16061;
is_recursive = G__16062;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__16063 = reader;
var G__16064 = eof_is_error;
var G__16065 = sentinel;
var G__16066 = is_recursive;
reader = G__16063;
eof_is_error = G__16064;
sentinel = G__16065;
is_recursive = G__16066;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__16071 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__16071,0,null);var years = cljs.core.nth.call(null,vec__16071,1,null);var months = cljs.core.nth.call(null,vec__16071,2,null);var days = cljs.core.nth.call(null,vec__16071,3,null);var hours = cljs.core.nth.call(null,vec__16071,4,null);var minutes = cljs.core.nth.call(null,vec__16071,5,null);var seconds = cljs.core.nth.call(null,vec__16071,6,null);var fraction = cljs.core.nth.call(null,vec__16071,7,null);var offset_sign = cljs.core.nth.call(null,vec__16071,8,null);var offset_hours = cljs.core.nth.call(null,vec__16071,9,null);var offset_minutes = cljs.core.nth.call(null,vec__16071,10,null);var v = vec__16071;if(cljs.core.not.call(null,v))
...
{var vec__16073 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__16073,0,null);var months = cljs.core.nth.call(null,vec__16073,1,null);var days = cljs.core.nth.call(null,vec__16073,2,null);var hours = cljs.core.nth.call(null,vec__16073,3,null);var minutes = cljs.core.nth.call(null,vec__16073,4,null);var seconds = cljs.core.nth.call(null,vec__16073,5,null);var ms = cljs.core.nth.call(null,vec__16073,6,null);var offset = cljs.core.nth.call(null,vec__16073,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
