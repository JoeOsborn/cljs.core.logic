...
{{
var G__196449 = cljs.core.pop.call(null,v__$1);
v__$1 = G__196449;
continue;
}
} else
...
{var pred__196453 = cljs.core._EQ_;var expr__196454 = limit;if(cljs.core.truth_(pred__196453.call(null,1,expr__196454)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__196453.call(null,2,expr__196454)))
...
var G__196456 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__196457 = (limit__$1 - 1);
var G__196458 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__196456;
limit__$1 = G__196457;
parts = G__196458;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___196460 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___196460))
{var replacement_196461 = temp__4096__auto___196460;buffer.append([cljs.core.str(replacement_196461)].join(''));
} else
{buffer.append(ch);
}
{
var G__196462 = (index + 1);
index = G__196462;
continue;
}
}
