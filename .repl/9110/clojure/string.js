...
{{
var G__40715 = cljs.core.pop.call(null,v__$1);
v__$1 = G__40715;
continue;
}
} else
...
{var pred__40719 = cljs.core._EQ_;var expr__40720 = limit;if(cljs.core.truth_(pred__40719.call(null,1,expr__40720)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__40719.call(null,2,expr__40720)))
...
var G__40722 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__40723 = (limit__$1 - 1);
var G__40724 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__40722;
limit__$1 = G__40723;
parts = G__40724;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___40726 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___40726))
{var replacement_40727 = temp__4096__auto___40726;buffer.append([cljs.core.str(replacement_40727)].join(''));
} else
{buffer.append(ch);
}
{
var G__40728 = (index + 1);
index = G__40728;
continue;
}
}
