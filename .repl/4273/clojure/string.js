...
{{
var G__30249 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30249;
continue;
}
} else
...
{var pred__30253 = cljs.core._EQ_;var expr__30254 = limit;if(pred__30253.call(null,1,expr__30254))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__30253.call(null,2,expr__30254))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__30256 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30257 = (limit__$1 - 1);
var G__30258 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__30256;
limit__$1 = G__30257;
parts = G__30258;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___30260 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___30260))
{var replacement_30261 = temp__4092__auto___30260;buffer.append([cljs.core.str(replacement_30261)].join(''));
} else
{buffer.append(ch);
}
{
var G__30262 = (index + 1);
index = G__30262;
continue;
}
}
