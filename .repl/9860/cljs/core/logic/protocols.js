...
cljs.core.logic.protocols.non_storable_QMARK_ = (function non_storable_QMARK_(x){var G__32434 = x;if(G__32434)
...
{return G__32434.cljs$core$logic$protocols$INonStorable$;
}
})()))
{return true;
} else
{if((!G__32434.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.INonStorable,G__32434);
} else
{return false;
}
}
...
cljs.core.logic.protocols.id = (function id(c){if((function (){var G__32447 = c;if(G__32447)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__32447.cljs$core$logic$protocols$IConstraintId$;
}
})()))
{return true;
} else
{if((!G__32447.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IConstraintId,G__32447);
} else
{return false;
}
}
...
cljs.core.logic.protocols.with_id = (function with_id(c,id){if((function (){var G__32449 = c;if(G__32449)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__32449.cljs$core$logic$protocols$IWithConstraintId$;
}
})()))
{return true;
} else
{if((!G__32449.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IWithConstraintId,G__32449);
} else
{return false;
}
}
...
cljs.core.logic.protocols.reifiable_QMARK_ = (function reifiable_QMARK_(x){var G__32452 = x;if(G__32452)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__32452.cljs$core$logic$protocols$IReifiableConstraint$;
}
})()))
{return true;
} else
{if((!G__32452.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IReifiableConstraint,G__32452);
} else
{return false;
}
}
...
cljs.core.logic.protocols.enforceable_QMARK_ = (function enforceable_QMARK_(x){var G__32454 = x;if(G__32454)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__32454.cljs$core$logic$protocols$IEnforceableConstraint$;
}
})()))
{return true;
} else
{if((!G__32454.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IEnforceableConstraint,G__32454);
} else
{return false;
}
}
...
cljs.core.logic.protocols.tree_constraint_QMARK_ = (function tree_constraint_QMARK_(x){var G__32463 = x;if(G__32463)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__32463.clojure$core$logic$protocols$ITreeConstraint$;
}
})()))
{return true;
} else
{if((!G__32463.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,clojure.core.logic.protocols.ITreeConstraint,G__32463);
} else
{return false;
}
}
