...
{{
var G__33205 = cljs.core.pop.call(null,v__$1);
v__$1 = G__33205;
continue;
}
} else
...
{var pred__33209 = cljs.core._EQ_;var expr__33210 = limit;if(pred__33209.call(null,1,expr__33210))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__33209.call(null,2,expr__33210))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__33212 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__33213 = (limit__$1 - 1);
var G__33214 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__33212;
limit__$1 = G__33213;
parts = G__33214;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___33216 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___33216))
{var replacement_33217 = temp__4092__auto___33216;buffer.append([cljs.core.str(replacement_33217)].join(''));
} else
{buffer.append(ch);
}
{
var G__33218 = (index + 1);
index = G__33218;
continue;
}
}
