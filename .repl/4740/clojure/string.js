...
{{
var G__65530 = cljs.core.pop.call(null,v__$1);
v__$1 = G__65530;
continue;
}
} else
...
{var pred__65534 = cljs.core._EQ_;var expr__65535 = limit;if(pred__65534.call(null,1,expr__65535))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__65534.call(null,2,expr__65535))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__65537 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__65538 = (limit__$1 - 1);
var G__65539 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__65537;
limit__$1 = G__65538;
parts = G__65539;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___65541 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___65541))
{var replacement_65542 = temp__4092__auto___65541;buffer.append([cljs.core.str(replacement_65542)].join(''));
} else
{buffer.append(ch);
}
{
var G__65543 = (index + 1);
index = G__65543;
continue;
}
}
