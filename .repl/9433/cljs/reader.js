...
reader_error.cljs$lang$applyTo = (function (arglist__209477){
var rdr = cljs.core.first(arglist__209477);
var msg = cljs.core.rest(arglist__209477);
...
{{
var G__209478 = (function (){sb.append(ch);
return sb;
})();
var G__209479 = cljs.reader.read_char.call(null,rdr);
sb = G__209478;
ch = G__209479;
continue;
}
...
{{
var G__209480 = cljs.reader.read_char.call(null,rdr);
ch = G__209480;
continue;
}
} else
...
var G__209481 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__209481;
continue;
}
} else
...
var G__209482 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__209482;
continue;
}
}
...
{{
var G__209483 = (function (){buffer.append(ch);
return buffer;
})();
var G__209484 = cljs.reader.read_char.call(null,reader);
buffer = G__209483;
ch = G__209484;
continue;
}
...
{if(("\\" === ch))
{{
var G__209485 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__209486 = cljs.reader.read_char.call(null,reader);
buffer = G__209485;
ch = G__209486;
continue;
}
...
{{
var G__209487 = (function (){buffer.append(ch);
return buffer;
})();
var G__209488 = cljs.reader.read_char.call(null,reader);
buffer = G__209487;
ch = G__209488;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__209490 = o;if(G__209490)
{var bit__5323__auto__ = (G__209490.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__209490.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__209490.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__209490);
} else
{return false;
}
}
...
{{
var G__209491 = reader;
var G__209492 = eof_is_error;
var G__209493 = sentinel;
var G__209494 = is_recursive;
reader = G__209491;
eof_is_error = G__209492;
sentinel = G__209493;
is_recursive = G__209494;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__209495 = cljs.reader.read_comment.call(null,reader,ch);
var G__209496 = eof_is_error;
var G__209497 = sentinel;
var G__209498 = is_recursive;
reader = G__209495;
eof_is_error = G__209496;
sentinel = G__209497;
is_recursive = G__209498;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__209499 = reader;
var G__209500 = eof_is_error;
var G__209501 = sentinel;
var G__209502 = is_recursive;
reader = G__209499;
eof_is_error = G__209500;
sentinel = G__209501;
is_recursive = G__209502;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__209505 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__209505,0,null);var years = cljs.core.nth.call(null,vec__209505,1,null);var months = cljs.core.nth.call(null,vec__209505,2,null);var days = cljs.core.nth.call(null,vec__209505,3,null);var hours = cljs.core.nth.call(null,vec__209505,4,null);var minutes = cljs.core.nth.call(null,vec__209505,5,null);var seconds = cljs.core.nth.call(null,vec__209505,6,null);var fraction = cljs.core.nth.call(null,vec__209505,7,null);var offset_sign = cljs.core.nth.call(null,vec__209505,8,null);var offset_hours = cljs.core.nth.call(null,vec__209505,9,null);var offset_minutes = cljs.core.nth.call(null,vec__209505,10,null);var v = vec__209505;if(cljs.core.not.call(null,v))
...
{var vec__209507 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__209507,0,null);var months = cljs.core.nth.call(null,vec__209507,1,null);var days = cljs.core.nth.call(null,vec__209507,2,null);var hours = cljs.core.nth.call(null,vec__209507,3,null);var minutes = cljs.core.nth.call(null,vec__209507,4,null);var seconds = cljs.core.nth.call(null,vec__209507,5,null);var ms = cljs.core.nth.call(null,vec__209507,6,null);var offset = cljs.core.nth.call(null,vec__209507,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
