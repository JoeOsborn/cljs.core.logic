...
{{
var G__209181 = cljs.core.pop.call(null,v__$1);
v__$1 = G__209181;
continue;
}
} else
...
{var pred__209185 = cljs.core._EQ_;var expr__209186 = limit;if(pred__209185.call(null,1,expr__209186))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__209185.call(null,2,expr__209186))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__209188 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__209189 = (limit__$1 - 1);
var G__209190 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__209188;
limit__$1 = G__209189;
parts = G__209190;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___209192 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___209192))
{var replacement_209193 = temp__4092__auto___209192;buffer.append([cljs.core.str(replacement_209193)].join(''));
} else
{buffer.append(ch);
}
{
var G__209194 = (index + 1);
index = G__209194;
continue;
}
}
