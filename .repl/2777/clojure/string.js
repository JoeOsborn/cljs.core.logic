...
{{
var G__644982 = cljs.core.pop.call(null,v__$1);
v__$1 = G__644982;
continue;
}
} else
...
{var pred__644986 = cljs.core._EQ_;var expr__644987 = limit;if(cljs.core.truth_(pred__644986.call(null,1,expr__644987)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__644986.call(null,2,expr__644987)))
...
var G__644989 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__644990 = (limit__$1 - 1);
var G__644991 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__644989;
limit__$1 = G__644990;
parts = G__644991;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___644993 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___644993))
{var replacement_644994 = temp__4096__auto___644993;buffer.append([cljs.core.str(replacement_644994)].join(''));
} else
{buffer.append(ch);
}
{
var G__644995 = (index + 1);
index = G__644995;
continue;
}
}
