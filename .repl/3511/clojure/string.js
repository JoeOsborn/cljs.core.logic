...
{{
var G__111072 = cljs.core.pop.call(null,v__$1);
v__$1 = G__111072;
continue;
}
} else
...
{var pred__111076 = cljs.core._EQ_;var expr__111077 = limit;if(cljs.core.truth_(pred__111076.call(null,1,expr__111077)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__111076.call(null,2,expr__111077)))
...
var G__111079 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__111080 = (limit__$1 - 1);
var G__111081 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__111079;
limit__$1 = G__111080;
parts = G__111081;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___111083 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___111083))
{var replacement_111084 = temp__4096__auto___111083;buffer.append([cljs.core.str(replacement_111084)].join(''));
} else
{buffer.append(ch);
}
{
var G__111085 = (index + 1);
index = G__111085;
continue;
}
}
