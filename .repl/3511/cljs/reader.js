...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj111476 = {};return obj111476;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__111477){
var rdr = cljs.core.first(arglist__111477);
var msg = cljs.core.rest(arglist__111477);
...
{{
var G__111478 = (function (){sb.append(ch);
return sb;
})();
var G__111479 = cljs.reader.read_char.call(null,rdr);
sb = G__111478;
ch = G__111479;
continue;
}
...
{{
var G__111480 = cljs.reader.read_char.call(null,rdr);
ch = G__111480;
continue;
}
} else
...
var G__111481 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__111481;
continue;
}
} else
...
var G__111482 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__111482;
continue;
}
}
...
{{
var G__111483 = (function (){buffer.append(ch);
return buffer;
})();
var G__111484 = cljs.reader.read_char.call(null,reader);
buffer = G__111483;
ch = G__111484;
continue;
}
...
{if(("\\" === ch))
{{
var G__111485 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__111486 = cljs.reader.read_char.call(null,reader);
buffer = G__111485;
ch = G__111486;
continue;
}
...
{{
var G__111487 = (function (){buffer.append(ch);
return buffer;
})();
var G__111488 = cljs.reader.read_char.call(null,reader);
buffer = G__111487;
ch = G__111488;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__111490 = o;if(G__111490)
{var bit__11182__auto__ = (G__111490.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11182__auto__) || (G__111490.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__111490.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__111490);
} else
{return false;
}
}
...
{{
var G__111491 = reader;
var G__111492 = eof_is_error;
var G__111493 = sentinel;
var G__111494 = is_recursive;
reader = G__111491;
eof_is_error = G__111492;
sentinel = G__111493;
is_recursive = G__111494;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__111495 = cljs.reader.read_comment.call(null,reader,ch);
var G__111496 = eof_is_error;
var G__111497 = sentinel;
var G__111498 = is_recursive;
reader = G__111495;
eof_is_error = G__111496;
sentinel = G__111497;
is_recursive = G__111498;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__111499 = reader;
var G__111500 = eof_is_error;
var G__111501 = sentinel;
var G__111502 = is_recursive;
reader = G__111499;
eof_is_error = G__111500;
sentinel = G__111501;
is_recursive = G__111502;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__111505 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__111505,0,null);var years = cljs.core.nth.call(null,vec__111505,1,null);var months = cljs.core.nth.call(null,vec__111505,2,null);var days = cljs.core.nth.call(null,vec__111505,3,null);var hours = cljs.core.nth.call(null,vec__111505,4,null);var minutes = cljs.core.nth.call(null,vec__111505,5,null);var seconds = cljs.core.nth.call(null,vec__111505,6,null);var fraction = cljs.core.nth.call(null,vec__111505,7,null);var offset_sign = cljs.core.nth.call(null,vec__111505,8,null);var offset_hours = cljs.core.nth.call(null,vec__111505,9,null);var offset_minutes = cljs.core.nth.call(null,vec__111505,10,null);var v = vec__111505;if(cljs.core.not.call(null,v))
...
{var vec__111507 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__111507,0,null);var months = cljs.core.nth.call(null,vec__111507,1,null);var days = cljs.core.nth.call(null,vec__111507,2,null);var hours = cljs.core.nth.call(null,vec__111507,3,null);var minutes = cljs.core.nth.call(null,vec__111507,4,null);var seconds = cljs.core.nth.call(null,vec__111507,5,null);var ms = cljs.core.nth.call(null,vec__111507,6,null);var offset = cljs.core.nth.call(null,vec__111507,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
