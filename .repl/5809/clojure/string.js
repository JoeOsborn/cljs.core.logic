...
{{
var G__16241 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16241;
continue;
}
} else
...
{var pred__16245 = cljs.core._EQ_;var expr__16246 = limit;if(cljs.core.truth_(pred__16245.call(null,1,expr__16246)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16245.call(null,2,expr__16246)))
...
var G__16248 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16249 = (limit__$1 - 1);
var G__16250 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16248;
limit__$1 = G__16249;
parts = G__16250;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16252 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16252))
{var replacement_16253 = temp__4092__auto___16252;buffer.append([cljs.core.str(replacement_16253)].join(''));
} else
{buffer.append(ch);
}
{
var G__16254 = (index + 1);
index = G__16254;
continue;
}
}
