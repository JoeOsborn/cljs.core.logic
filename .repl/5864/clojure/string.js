...
{{
var G__338012 = cljs.core.pop.call(null,v__$1);
v__$1 = G__338012;
continue;
}
} else
...
{var pred__338016 = cljs.core._EQ_;var expr__338017 = limit;if(pred__338016.call(null,1,expr__338017))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__338016.call(null,2,expr__338017))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__338019 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__338020 = (limit__$1 - 1);
var G__338021 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__338019;
limit__$1 = G__338020;
parts = G__338021;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___338023 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___338023))
{var replacement_338024 = temp__4092__auto___338023;buffer.append([cljs.core.str(replacement_338024)].join(''));
} else
{buffer.append(ch);
}
{
var G__338025 = (index + 1);
index = G__338025;
continue;
}
}
