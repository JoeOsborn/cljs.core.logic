...
reader_error.cljs$lang$applyTo = (function (arglist__338308){
var rdr = cljs.core.first(arglist__338308);
var msg = cljs.core.rest(arglist__338308);
...
{{
var G__338309 = (function (){sb.append(ch);
return sb;
})();
var G__338310 = cljs.reader.read_char.call(null,rdr);
sb = G__338309;
ch = G__338310;
continue;
}
...
{{
var G__338311 = cljs.reader.read_char.call(null,rdr);
ch = G__338311;
continue;
}
} else
...
var G__338312 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__338312;
continue;
}
} else
...
var G__338313 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__338313;
continue;
}
}
...
{{
var G__338314 = (function (){buffer.append(ch);
return buffer;
})();
var G__338315 = cljs.reader.read_char.call(null,reader);
buffer = G__338314;
ch = G__338315;
continue;
}
...
{if(("\\" === ch))
{{
var G__338316 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__338317 = cljs.reader.read_char.call(null,reader);
buffer = G__338316;
ch = G__338317;
continue;
}
...
{{
var G__338318 = (function (){buffer.append(ch);
return buffer;
})();
var G__338319 = cljs.reader.read_char.call(null,reader);
buffer = G__338318;
ch = G__338319;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__338321 = o;if(G__338321)
{var bit__5323__auto__ = (G__338321.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__338321.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__338321.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__338321);
} else
{return false;
}
}
...
{{
var G__338322 = reader;
var G__338323 = eof_is_error;
var G__338324 = sentinel;
var G__338325 = is_recursive;
reader = G__338322;
eof_is_error = G__338323;
sentinel = G__338324;
is_recursive = G__338325;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__338326 = cljs.reader.read_comment.call(null,reader,ch);
var G__338327 = eof_is_error;
var G__338328 = sentinel;
var G__338329 = is_recursive;
reader = G__338326;
eof_is_error = G__338327;
sentinel = G__338328;
is_recursive = G__338329;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__338330 = reader;
var G__338331 = eof_is_error;
var G__338332 = sentinel;
var G__338333 = is_recursive;
reader = G__338330;
eof_is_error = G__338331;
sentinel = G__338332;
is_recursive = G__338333;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__338336 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__338336,0,null);var years = cljs.core.nth.call(null,vec__338336,1,null);var months = cljs.core.nth.call(null,vec__338336,2,null);var days = cljs.core.nth.call(null,vec__338336,3,null);var hours = cljs.core.nth.call(null,vec__338336,4,null);var minutes = cljs.core.nth.call(null,vec__338336,5,null);var seconds = cljs.core.nth.call(null,vec__338336,6,null);var fraction = cljs.core.nth.call(null,vec__338336,7,null);var offset_sign = cljs.core.nth.call(null,vec__338336,8,null);var offset_hours = cljs.core.nth.call(null,vec__338336,9,null);var offset_minutes = cljs.core.nth.call(null,vec__338336,10,null);var v = vec__338336;if(cljs.core.not.call(null,v))
...
{var vec__338338 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__338338,0,null);var months = cljs.core.nth.call(null,vec__338338,1,null);var days = cljs.core.nth.call(null,vec__338338,2,null);var hours = cljs.core.nth.call(null,vec__338338,3,null);var minutes = cljs.core.nth.call(null,vec__338338,4,null);var seconds = cljs.core.nth.call(null,vec__338338,5,null);var ms = cljs.core.nth.call(null,vec__338338,6,null);var offset = cljs.core.nth.call(null,vec__338338,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
