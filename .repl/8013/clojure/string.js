...
{{
var G__137450 = cljs.core.pop.call(null,v__$1);
v__$1 = G__137450;
continue;
}
} else
...
{var pred__137454 = cljs.core._EQ_;var expr__137455 = limit;if(pred__137454.call(null,1,expr__137455))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__137454.call(null,2,expr__137455))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__137457 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__137458 = (limit__$1 - 1);
var G__137459 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__137457;
limit__$1 = G__137458;
parts = G__137459;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___137461 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___137461))
{var replacement_137462 = temp__4092__auto___137461;buffer.append([cljs.core.str(replacement_137462)].join(''));
} else
{buffer.append(ch);
}
{
var G__137463 = (index + 1);
index = G__137463;
continue;
}
}
