...
{{
var G__12876 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12876;
continue;
}
} else
...
{var pred__12880 = cljs.core._EQ_;var expr__12881 = limit;if(pred__12880.call(null,1,expr__12881))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__12880.call(null,2,expr__12881))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__12883 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12884 = (limit__$1 - 1);
var G__12885 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12883;
limit__$1 = G__12884;
parts = G__12885;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___12887 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___12887))
{var replacement_12888 = temp__4092__auto___12887;buffer.append([cljs.core.str(replacement_12888)].join(''));
} else
{buffer.append(ch);
}
{
