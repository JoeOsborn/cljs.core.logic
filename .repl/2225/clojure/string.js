...
{{
var G__16956 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16956;
continue;
}
} else
...
{var pred__16960 = cljs.core._EQ_;var expr__16961 = limit;if(pred__16960.call(null,1,expr__16961))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__16960.call(null,2,expr__16961))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__16963 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16964 = (limit__$1 - 1);
var G__16965 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16963;
limit__$1 = G__16964;
parts = G__16965;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16967 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16967))
{var replacement_16968 = temp__4092__auto___16967;buffer.append([cljs.core.str(replacement_16968)].join(''));
} else
{buffer.append(ch);
}
{
var G__16969 = (index + 1);
index = G__16969;
continue;
}
}
