...
{{
var G__73607 = cljs.core.pop.call(null,v__$1);
v__$1 = G__73607;
continue;
}
} else
...
{var pred__73611 = cljs.core._EQ_;var expr__73612 = limit;if(cljs.core.truth_(pred__73611.call(null,1,expr__73612)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__73611.call(null,2,expr__73612)))
...
var G__73614 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__73615 = (limit__$1 - 1);
var G__73616 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__73614;
limit__$1 = G__73615;
parts = G__73616;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___73618 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___73618))
{var replacement_73619 = temp__4096__auto___73618;buffer.append([cljs.core.str(replacement_73619)].join(''));
} else
{buffer.append(ch);
}
{
var G__73620 = (index + 1);
index = G__73620;
continue;
}
}
