...
{{
var G__11462 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11462;
continue;
}
} else
...
{var pred__11466 = cljs.core._EQ_;var expr__11467 = limit;if(pred__11466.call(null,1,expr__11467))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__11466.call(null,2,expr__11467))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__11469 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11470 = (limit__$1 - 1);
var G__11471 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11469;
limit__$1 = G__11470;
parts = G__11471;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___11473 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___11473))
{var replacement_11474 = temp__4092__auto___11473;buffer.append([cljs.core.str(replacement_11474)].join(''));
} else
{buffer.append(ch);
}
{
