...
{{
var G__100418 = cljs.core.pop.call(null,v__$1);
v__$1 = G__100418;
continue;
}
} else
...
{var pred__100422 = cljs.core._EQ_;var expr__100423 = limit;if(cljs.core.truth_(pred__100422.call(null,1,expr__100423)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__100422.call(null,2,expr__100423)))
...
var G__100425 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__100426 = (limit__$1 - 1);
var G__100427 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__100425;
limit__$1 = G__100426;
parts = G__100427;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___100429 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___100429))
{var replacement_100430 = temp__4096__auto___100429;buffer.append([cljs.core.str(replacement_100430)].join(''));
} else
{buffer.append(ch);
}
{
var G__100431 = (index + 1);
index = G__100431;
continue;
}
}
