...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj100386 = {};return obj100386;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__100387){
var rdr = cljs.core.first(arglist__100387);
var msg = cljs.core.rest(arglist__100387);
...
{{
var G__100388 = (function (){sb.append(ch);
return sb;
})();
var G__100389 = cljs.reader.read_char.call(null,rdr);
sb = G__100388;
ch = G__100389;
continue;
}
...
{{
var G__100390 = cljs.reader.read_char.call(null,rdr);
ch = G__100390;
continue;
}
} else
...
var G__100391 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__100391;
continue;
}
} else
...
var G__100392 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__100392;
continue;
}
}
...
{{
var G__100393 = (function (){buffer.append(ch);
return buffer;
})();
var G__100394 = cljs.reader.read_char.call(null,reader);
buffer = G__100393;
ch = G__100394;
continue;
}
...
{if(("\\" === ch))
{{
var G__100395 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__100396 = cljs.reader.read_char.call(null,reader);
buffer = G__100395;
ch = G__100396;
continue;
}
...
{{
var G__100397 = (function (){buffer.append(ch);
return buffer;
})();
var G__100398 = cljs.reader.read_char.call(null,reader);
buffer = G__100397;
ch = G__100398;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__100400 = o;if(G__100400)
{var bit__5761__auto__ = (G__100400.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5761__auto__) || (G__100400.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__100400.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__100400);
} else
{return false;
}
}
...
{{
var G__100401 = reader;
var G__100402 = eof_is_error;
var G__100403 = sentinel;
var G__100404 = is_recursive;
reader = G__100401;
eof_is_error = G__100402;
sentinel = G__100403;
is_recursive = G__100404;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__100405 = cljs.reader.read_comment.call(null,reader,ch);
var G__100406 = eof_is_error;
var G__100407 = sentinel;
var G__100408 = is_recursive;
reader = G__100405;
eof_is_error = G__100406;
sentinel = G__100407;
is_recursive = G__100408;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__100409 = reader;
var G__100410 = eof_is_error;
var G__100411 = sentinel;
var G__100412 = is_recursive;
reader = G__100409;
eof_is_error = G__100410;
sentinel = G__100411;
is_recursive = G__100412;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__100415 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__100415,0,null);var years = cljs.core.nth.call(null,vec__100415,1,null);var months = cljs.core.nth.call(null,vec__100415,2,null);var days = cljs.core.nth.call(null,vec__100415,3,null);var hours = cljs.core.nth.call(null,vec__100415,4,null);var minutes = cljs.core.nth.call(null,vec__100415,5,null);var seconds = cljs.core.nth.call(null,vec__100415,6,null);var fraction = cljs.core.nth.call(null,vec__100415,7,null);var offset_sign = cljs.core.nth.call(null,vec__100415,8,null);var offset_hours = cljs.core.nth.call(null,vec__100415,9,null);var offset_minutes = cljs.core.nth.call(null,vec__100415,10,null);var v = vec__100415;if(cljs.core.not.call(null,v))
...
{var vec__100417 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__100417,0,null);var months = cljs.core.nth.call(null,vec__100417,1,null);var days = cljs.core.nth.call(null,vec__100417,2,null);var hours = cljs.core.nth.call(null,vec__100417,3,null);var minutes = cljs.core.nth.call(null,vec__100417,4,null);var seconds = cljs.core.nth.call(null,vec__100417,5,null);var ms = cljs.core.nth.call(null,vec__100417,6,null);var offset = cljs.core.nth.call(null,vec__100417,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
