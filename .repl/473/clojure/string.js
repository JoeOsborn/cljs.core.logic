...
{{
var G__306606 = cljs.core.pop.call(null,v__$1);
v__$1 = G__306606;
continue;
}
} else
...
{var pred__306610 = cljs.core._EQ_;var expr__306611 = limit;if(cljs.core.truth_(pred__306610.call(null,1,expr__306611)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__306610.call(null,2,expr__306611)))
...
var G__306613 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__306614 = (limit__$1 - 1);
var G__306615 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__306613;
limit__$1 = G__306614;
parts = G__306615;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___306617 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___306617))
{var replacement_306618 = temp__4096__auto___306617;buffer.append([cljs.core.str(replacement_306618)].join(''));
} else
{buffer.append(ch);
}
{
var G__306619 = (index + 1);
index = G__306619;
continue;
}
}
