...
{{
var G__142666 = cljs.core.pop.call(null,v__$1);
v__$1 = G__142666;
continue;
}
} else
...
{var pred__142670 = cljs.core._EQ_;var expr__142671 = limit;if(cljs.core.truth_(pred__142670.call(null,1,expr__142671)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__142670.call(null,2,expr__142671)))
...
var G__142673 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__142674 = (limit__$1 - 1);
var G__142675 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__142673;
limit__$1 = G__142674;
parts = G__142675;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___142677 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___142677))
{var replacement_142678 = temp__4096__auto___142677;buffer.append([cljs.core.str(replacement_142678)].join(''));
} else
{buffer.append(ch);
}
{
var G__142679 = (index + 1);
index = G__142679;
continue;
}
}
