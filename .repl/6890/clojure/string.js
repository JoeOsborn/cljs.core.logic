...
{{
var G__223950 = cljs.core.pop.call(null,v__$1);
v__$1 = G__223950;
continue;
}
} else
...
{var pred__223954 = cljs.core._EQ_;var expr__223955 = limit;if(pred__223954.call(null,1,expr__223955))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__223954.call(null,2,expr__223955))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__223957 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__223958 = (limit__$1 - 1);
var G__223959 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__223957;
limit__$1 = G__223958;
parts = G__223959;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___223961 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___223961))
{var replacement_223962 = temp__4092__auto___223961;buffer.append([cljs.core.str(replacement_223962)].join(''));
} else
{buffer.append(ch);
}
{
var G__223963 = (index + 1);
index = G__223963;
continue;
}
}
