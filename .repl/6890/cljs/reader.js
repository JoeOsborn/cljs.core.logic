...
reader_error.cljs$lang$applyTo = (function (arglist__224246){
var rdr = cljs.core.first(arglist__224246);
var msg = cljs.core.rest(arglist__224246);
...
{{
var G__224247 = (function (){sb.append(ch);
return sb;
})();
var G__224248 = cljs.reader.read_char.call(null,rdr);
sb = G__224247;
ch = G__224248;
continue;
}
...
{{
var G__224249 = cljs.reader.read_char.call(null,rdr);
ch = G__224249;
continue;
}
} else
...
var G__224250 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__224250;
continue;
}
} else
...
var G__224251 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__224251;
continue;
}
}
...
{{
var G__224252 = (function (){buffer.append(ch);
return buffer;
})();
var G__224253 = cljs.reader.read_char.call(null,reader);
buffer = G__224252;
ch = G__224253;
continue;
}
...
{if(("\\" === ch))
{{
var G__224254 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__224255 = cljs.reader.read_char.call(null,reader);
buffer = G__224254;
ch = G__224255;
continue;
}
...
{{
var G__224256 = (function (){buffer.append(ch);
return buffer;
})();
var G__224257 = cljs.reader.read_char.call(null,reader);
buffer = G__224256;
ch = G__224257;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__224259 = o;if(G__224259)
{var bit__5323__auto__ = (G__224259.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__224259.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__224259.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__224259);
} else
{return false;
}
}
...
{{
var G__224260 = reader;
var G__224261 = eof_is_error;
var G__224262 = sentinel;
var G__224263 = is_recursive;
reader = G__224260;
eof_is_error = G__224261;
sentinel = G__224262;
is_recursive = G__224263;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__224264 = cljs.reader.read_comment.call(null,reader,ch);
var G__224265 = eof_is_error;
var G__224266 = sentinel;
var G__224267 = is_recursive;
reader = G__224264;
eof_is_error = G__224265;
sentinel = G__224266;
is_recursive = G__224267;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__224268 = reader;
var G__224269 = eof_is_error;
var G__224270 = sentinel;
var G__224271 = is_recursive;
reader = G__224268;
eof_is_error = G__224269;
sentinel = G__224270;
is_recursive = G__224271;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__224274 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__224274,0,null);var years = cljs.core.nth.call(null,vec__224274,1,null);var months = cljs.core.nth.call(null,vec__224274,2,null);var days = cljs.core.nth.call(null,vec__224274,3,null);var hours = cljs.core.nth.call(null,vec__224274,4,null);var minutes = cljs.core.nth.call(null,vec__224274,5,null);var seconds = cljs.core.nth.call(null,vec__224274,6,null);var fraction = cljs.core.nth.call(null,vec__224274,7,null);var offset_sign = cljs.core.nth.call(null,vec__224274,8,null);var offset_hours = cljs.core.nth.call(null,vec__224274,9,null);var offset_minutes = cljs.core.nth.call(null,vec__224274,10,null);var v = vec__224274;if(cljs.core.not.call(null,v))
...
{var vec__224276 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__224276,0,null);var months = cljs.core.nth.call(null,vec__224276,1,null);var days = cljs.core.nth.call(null,vec__224276,2,null);var hours = cljs.core.nth.call(null,vec__224276,3,null);var minutes = cljs.core.nth.call(null,vec__224276,4,null);var seconds = cljs.core.nth.call(null,vec__224276,5,null);var ms = cljs.core.nth.call(null,vec__224276,6,null);var offset = cljs.core.nth.call(null,vec__224276,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
