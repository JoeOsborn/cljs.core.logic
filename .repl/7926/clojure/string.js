...
{{
var G__58526 = cljs.core.pop.call(null,v__$1);
v__$1 = G__58526;
continue;
}
} else
...
{var pred__58530 = cljs.core._EQ_;var expr__58531 = limit;if(pred__58530.call(null,1,expr__58531))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__58530.call(null,2,expr__58531))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__58533 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__58534 = (limit__$1 - 1);
var G__58535 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__58533;
limit__$1 = G__58534;
parts = G__58535;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___58537 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___58537))
{var replacement_58538 = temp__4092__auto___58537;buffer.append([cljs.core.str(replacement_58538)].join(''));
} else
{buffer.append(ch);
}
{
var G__58539 = (index + 1);
index = G__58539;
continue;
}
}
