...
{{
var G__367976 = cljs.core.pop.call(null,v__$1);
v__$1 = G__367976;
continue;
}
} else
...
{var pred__367980 = cljs.core._EQ_;var expr__367981 = limit;if(cljs.core.truth_(pred__367980.call(null,1,expr__367981)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__367980.call(null,2,expr__367981)))
...
var G__367983 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__367984 = (limit__$1 - 1);
var G__367985 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__367983;
limit__$1 = G__367984;
parts = G__367985;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___367987 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___367987))
{var replacement_367988 = temp__4096__auto___367987;buffer.append([cljs.core.str(replacement_367988)].join(''));
} else
{buffer.append(ch);
}
{
var G__367989 = (index + 1);
index = G__367989;
continue;
}
}
