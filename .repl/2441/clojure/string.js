...
{{
var G__139683 = cljs.core.pop.call(null,v__$1);
v__$1 = G__139683;
continue;
}
} else
...
{var pred__139687 = cljs.core._EQ_;var expr__139688 = limit;if(cljs.core.truth_(pred__139687.call(null,1,expr__139688)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__139687.call(null,2,expr__139688)))
...
var G__139690 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__139691 = (limit__$1 - 1);
var G__139692 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__139690;
limit__$1 = G__139691;
parts = G__139692;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___139694 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___139694))
{var replacement_139695 = temp__4096__auto___139694;buffer.append([cljs.core.str(replacement_139695)].join(''));
} else
{buffer.append(ch);
}
{
var G__139696 = (index + 1);
index = G__139696;
continue;
}
}
