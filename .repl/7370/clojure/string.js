...
{{
var G__54259 = cljs.core.pop.call(null,v__$1);
v__$1 = G__54259;
continue;
}
} else
...
{var pred__54263 = cljs.core._EQ_;var expr__54264 = limit;if(cljs.core.truth_(pred__54263.call(null,1,expr__54264)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__54263.call(null,2,expr__54264)))
...
var G__54266 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__54267 = (limit__$1 - 1);
var G__54268 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__54266;
limit__$1 = G__54267;
parts = G__54268;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___54270 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___54270))
{var replacement_54271 = temp__4096__auto___54270;buffer.append([cljs.core.str(replacement_54271)].join(''));
} else
{buffer.append(ch);
}
{
var G__54272 = (index + 1);
index = G__54272;
continue;
}
}
