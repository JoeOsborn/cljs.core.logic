...
{{
var G__598750 = cljs.core.pop.call(null,v__$1);
v__$1 = G__598750;
continue;
}
} else
...
{var pred__598754 = cljs.core._EQ_;var expr__598755 = limit;if(cljs.core.truth_(pred__598754.call(null,1,expr__598755)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__598754.call(null,2,expr__598755)))
...
var G__598757 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__598758 = (limit__$1 - 1);
var G__598759 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__598757;
limit__$1 = G__598758;
parts = G__598759;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___598761 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___598761))
{var replacement_598762 = temp__4096__auto___598761;buffer.append([cljs.core.str(replacement_598762)].join(''));
} else
{buffer.append(ch);
}
{
var G__598763 = (index + 1);
index = G__598763;
continue;
}
}
