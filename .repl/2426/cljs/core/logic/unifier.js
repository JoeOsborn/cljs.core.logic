...
{var vec__36284 = expr__$1;var f = cljs.core.nth.call(null,vec__36284,0,null);var n = cljs.core.nthnext.call(null,vec__36284,1);var skip = cljs.core._EQ_.call(null,f,new cljs.core.Symbol(null,".",".",-1640531481,null));var tail = prep_STAR_.call(null,n,store,lcons_QMARK_,skip);if(skip)
{return tail;
} else
...
*/
cljs.core.logic.unifier.prep = (function prep(expr){var lvars = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prepped = (cljs.core.truth_(cljs.core.logic.unifier.lvarq_sym_QMARK_.call(null,expr))?cljs.core.logic.unifier.proc_lvar.call(null,expr,lvars):(cljs.core.truth_(cljs.core.logic.unifier.lcons_expr_QMARK_.call(null,expr))?cljs.core.logic.unifier.prep_STAR_.call(null,expr,lvars,true):((new cljs.core.Keyword(null,"else","else",1017020587))?cljs.core.logic.protocols.walk_term.call(null,expr,cljs.core.logic.unifier.replace_lvar.call(null,lvars)):null)));if((function (){var G__36286 = prepped;if(G__36286)
{var bit__5323__auto__ = (G__36286.cljs$lang$protocol_mask$partition0$ & 131072);if((bit__5323__auto__) || (G__36286.cljs$core$IMeta$))
{return true;
} else
{if((!G__36286.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMeta,G__36286);
} else
{return false;
}
}
...
{return cljs.core.logic.protocols.queue.call(null,s,cljs.core.logic.protocols._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__36287_SHARP_){return cljs.core.logic.lvar.call(null,p1__36287_SHARP_,false);
}),vs))));
} else
...
{return cljs.core.logic.protocols.queue.call(null,s,cljs.core.logic.protocols._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__36288_SHARP_){return cljs.core.logic.lvar.call(null,p1__36288_SHARP_,false);
...
cljs.core.logic.unifier.queue_constraints = (function queue_constraints(s,p__36289){var vec__36291 = p__36289;var vs = cljs.core.nth.call(null,vec__36291,0,null);var cs = cljs.core.nth.call(null,vec__36291,1,null);var cs__$1 = ((!(cljs.core.sequential_QMARK_.call(null,cs)))?cljs.core.PersistentVector.fromArray([cs], true):cs);return cljs.core.reduce.call(null,(function (s__$1,c){return cljs.core.logic.unifier.queue_constraint.call(null,s__$1,c,vs);
}),s,cs__$1);
});
cljs.core.logic.unifier._unify_STAR_ = (function _unify_STAR_(init_s,u,w){return cljs.core.first.call(null,cljs.core.logic.protocols.take_STAR_.call(null,(function (){return (function (a__32148__auto__){return (function _inc(){var q = cljs.core.logic.lvar.call(null,new cljs.core.Symbol(null,"q","q",-1640531414,null));return cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,a__32148__auto__,cljs.core.logic._EQ__EQ_.call(null,u,w)),cljs.core.logic._EQ__EQ_.call(null,q,u)),(function (a){return cljs.core.logic.fix_constraints.call(null,a);
})),cljs.core.logic.reifyg.call(null,q));
});
}).call(null,init_s);
})));
});
cljs.core.logic.unifier.init_s = (function init_s(opts,s){var s__$1 = cljs.core.reduce.call(null,(function (s__$1,p__36294){var vec__36295 = p__36294;var k = cljs.core.nth.call(null,vec__36295,0,null);var v = cljs.core.nth.call(null,vec__36295,1,null);return cljs.core.logic._EQ__EQ_.call(null,k,v).call(null,s__$1);
...
var unify_STAR___2 = (function (opts,ts){var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.empty_s);return cljs.core.logic.unifier._unify_STAR_.call(null,cljs.core.vary_meta.call(null,init_s,cljs.core.assoc,new cljs.core.Keyword(null,"reify-vars","reify-vars",4368745730),false),cljs.core.reduce.call(null,(function (p1__36296_SHARP_,p2__36297_SHARP_){return cljs.core.logic.unifier._unify_STAR_.call(null,init_s,p1__36296_SHARP_,p2__36297_SHARP_);
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__36312){var vec__36313 = p__36312;var sym = cljs.core.nth.call(null,vec__36313,0,null);var var$ = cljs.core.nth.call(null,vec__36313,1,null);return cljs.core.PersistentVector.fromArray([sym,cljs.core.logic._reify.call(null,s__$1,var$)], true);
}),cljs.core.filter.call(null,(function (p__36314){var vec__36315 = p__36314;var sym = cljs.core.nth.call(null,vec__36315,0,null);var var$ = cljs.core.nth.call(null,vec__36315,1,null);return cljs.core.not_EQ_.call(null,cljs.core.logic.protocols.walk.call(null,s__$1,var$),var$);
...
var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.empty_s);return cljs.core.reduce.call(null,(function (p1__36298_SHARP_,p2__36299_SHARP_){return _unifier_STAR_.call(null,init_s,p1__36298_SHARP_,p2__36299_SHARP_);
}),ts);
});
...
var unify__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__36318){var vec__36319 = p__36318;var k = cljs.core.nth.call(null,vec__36319,0,null);var v = cljs.core.nth.call(null,vec__36319,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], true);
...
var unifier__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__36323){var vec__36324 = p__36323;var k = cljs.core.nth.call(null,vec__36324,0,null);var v = cljs.core.nth.call(null,vec__36324,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], true);
...
return (function (p1__36320_SHARP_){return new cljs.core.Keyword("cljs.core.logic.unifier","lvars","cljs.core.logic.unifier/lvars",1819622758).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__36320_SHARP_));
