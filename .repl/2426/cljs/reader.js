...
reader_error.cljs$lang$applyTo = (function (arglist__36206){
var rdr = cljs.core.first(arglist__36206);
var msg = cljs.core.rest(arglist__36206);
...
{{
var G__36207 = (function (){sb.append(ch);
return sb;
})();
var G__36208 = cljs.reader.read_char.call(null,rdr);
sb = G__36207;
ch = G__36208;
continue;
}
...
{{
var G__36209 = cljs.reader.read_char.call(null,rdr);
ch = G__36209;
continue;
}
} else
...
var G__36210 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__36210;
continue;
}
} else
...
var G__36211 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__36211;
continue;
}
}
...
{{
var G__36212 = (function (){buffer.append(ch);
return buffer;
})();
var G__36213 = cljs.reader.read_char.call(null,reader);
buffer = G__36212;
ch = G__36213;
continue;
}
...
{if(("\\" === ch))
{{
var G__36214 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__36215 = cljs.reader.read_char.call(null,reader);
buffer = G__36214;
ch = G__36215;
continue;
}
...
{{
var G__36216 = (function (){buffer.append(ch);
return buffer;
})();
var G__36217 = cljs.reader.read_char.call(null,reader);
buffer = G__36216;
ch = G__36217;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__36219 = o;if(G__36219)
{var bit__5323__auto__ = (G__36219.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__36219.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__36219.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__36219);
} else
{return false;
}
}
...
{{
var G__36220 = reader;
var G__36221 = eof_is_error;
var G__36222 = sentinel;
var G__36223 = is_recursive;
reader = G__36220;
eof_is_error = G__36221;
sentinel = G__36222;
is_recursive = G__36223;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__36224 = cljs.reader.read_comment.call(null,reader,ch);
var G__36225 = eof_is_error;
var G__36226 = sentinel;
var G__36227 = is_recursive;
reader = G__36224;
eof_is_error = G__36225;
sentinel = G__36226;
is_recursive = G__36227;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__36228 = reader;
var G__36229 = eof_is_error;
var G__36230 = sentinel;
var G__36231 = is_recursive;
reader = G__36228;
eof_is_error = G__36229;
sentinel = G__36230;
is_recursive = G__36231;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__36234 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__36234,0,null);var years = cljs.core.nth.call(null,vec__36234,1,null);var months = cljs.core.nth.call(null,vec__36234,2,null);var days = cljs.core.nth.call(null,vec__36234,3,null);var hours = cljs.core.nth.call(null,vec__36234,4,null);var minutes = cljs.core.nth.call(null,vec__36234,5,null);var seconds = cljs.core.nth.call(null,vec__36234,6,null);var fraction = cljs.core.nth.call(null,vec__36234,7,null);var offset_sign = cljs.core.nth.call(null,vec__36234,8,null);var offset_hours = cljs.core.nth.call(null,vec__36234,9,null);var offset_minutes = cljs.core.nth.call(null,vec__36234,10,null);var v = vec__36234;if(cljs.core.not.call(null,v))
...
{var vec__36236 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__36236,0,null);var months = cljs.core.nth.call(null,vec__36236,1,null);var days = cljs.core.nth.call(null,vec__36236,2,null);var hours = cljs.core.nth.call(null,vec__36236,3,null);var minutes = cljs.core.nth.call(null,vec__36236,4,null);var seconds = cljs.core.nth.call(null,vec__36236,5,null);var ms = cljs.core.nth.call(null,vec__36236,6,null);var offset = cljs.core.nth.call(null,vec__36236,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
