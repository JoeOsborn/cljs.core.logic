...
{{
var G__35908 = cljs.core.pop.call(null,v__$1);
v__$1 = G__35908;
continue;
}
} else
...
{var pred__35912 = cljs.core._EQ_;var expr__35913 = limit;if(pred__35912.call(null,1,expr__35913))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__35912.call(null,2,expr__35913))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__35915 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__35916 = (limit__$1 - 1);
var G__35917 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__35915;
limit__$1 = G__35916;
parts = G__35917;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___35919 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___35919))
{var replacement_35920 = temp__4092__auto___35919;buffer.append([cljs.core.str(replacement_35920)].join(''));
} else
{buffer.append(ch);
}
{
var G__35921 = (index + 1);
index = G__35921;
continue;
}
}
