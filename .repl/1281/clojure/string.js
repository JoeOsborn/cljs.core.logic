...
{{
var G__442772 = cljs.core.pop.call(null,v__$1);
v__$1 = G__442772;
continue;
}
} else
...
{var pred__442776 = cljs.core._EQ_;var expr__442777 = limit;if(cljs.core.truth_(pred__442776.call(null,1,expr__442777)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__442776.call(null,2,expr__442777)))
...
var G__442779 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__442780 = (limit__$1 - 1);
var G__442781 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__442779;
limit__$1 = G__442780;
parts = G__442781;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___442783 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___442783))
{var replacement_442784 = temp__4096__auto___442783;buffer.append([cljs.core.str(replacement_442784)].join(''));
} else
{buffer.append(ch);
}
{
var G__442785 = (index + 1);
index = G__442785;
continue;
}
}
