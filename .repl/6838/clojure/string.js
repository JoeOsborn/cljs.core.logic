...
{{
var G__16312 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16312;
continue;
}
} else
...
{var pred__16316 = cljs.core._EQ_;var expr__16317 = limit;if(pred__16316.call(null,1,expr__16317))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__16316.call(null,2,expr__16317))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__16319 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16320 = (limit__$1 - 1);
var G__16321 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16319;
limit__$1 = G__16320;
parts = G__16321;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16323 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16323))
{var replacement_16324 = temp__4092__auto___16323;buffer.append([cljs.core.str(replacement_16324)].join(''));
} else
{buffer.append(ch);
}
{
var G__16325 = (index + 1);
index = G__16325;
continue;
}
}
