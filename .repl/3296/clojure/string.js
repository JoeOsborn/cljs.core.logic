...
{{
var G__657184 = cljs.core.pop.call(null,v__$1);
v__$1 = G__657184;
continue;
}
} else
...
{var pred__657188 = cljs.core._EQ_;var expr__657189 = limit;if(cljs.core.truth_(pred__657188.call(null,1,expr__657189)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__657188.call(null,2,expr__657189)))
...
var G__657191 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__657192 = (limit__$1 - 1);
var G__657193 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__657191;
limit__$1 = G__657192;
parts = G__657193;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___657195 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___657195))
{var replacement_657196 = temp__4096__auto___657195;buffer.append([cljs.core.str(replacement_657196)].join(''));
} else
{buffer.append(ch);
}
{
var G__657197 = (index + 1);
index = G__657197;
continue;
}
}
