...
reader_error.cljs$lang$applyTo = (function (arglist__151544){
var rdr = cljs.core.first(arglist__151544);
var msg = cljs.core.rest(arglist__151544);
...
{{
var G__151545 = (function (){sb.append(ch);
return sb;
})();
var G__151546 = cljs.reader.read_char.call(null,rdr);
sb = G__151545;
ch = G__151546;
continue;
}
...
{{
var G__151547 = cljs.reader.read_char.call(null,rdr);
ch = G__151547;
continue;
}
} else
...
var G__151548 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__151548;
continue;
}
} else
...
var G__151549 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__151549;
continue;
}
}
...
{{
var G__151550 = (function (){buffer.append(ch);
return buffer;
})();
var G__151551 = cljs.reader.read_char.call(null,reader);
buffer = G__151550;
ch = G__151551;
continue;
}
...
{if(("\\" === ch))
{{
var G__151552 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__151553 = cljs.reader.read_char.call(null,reader);
buffer = G__151552;
ch = G__151553;
continue;
}
...
{{
var G__151554 = (function (){buffer.append(ch);
return buffer;
})();
var G__151555 = cljs.reader.read_char.call(null,reader);
buffer = G__151554;
ch = G__151555;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__151557 = o;if(G__151557)
{var bit__5323__auto__ = (G__151557.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__151557.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__151557.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__151557);
} else
{return false;
}
}
...
{{
var G__151558 = reader;
var G__151559 = eof_is_error;
var G__151560 = sentinel;
var G__151561 = is_recursive;
reader = G__151558;
eof_is_error = G__151559;
sentinel = G__151560;
is_recursive = G__151561;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__151562 = cljs.reader.read_comment.call(null,reader,ch);
var G__151563 = eof_is_error;
var G__151564 = sentinel;
var G__151565 = is_recursive;
reader = G__151562;
eof_is_error = G__151563;
sentinel = G__151564;
is_recursive = G__151565;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__151566 = reader;
var G__151567 = eof_is_error;
var G__151568 = sentinel;
var G__151569 = is_recursive;
reader = G__151566;
eof_is_error = G__151567;
sentinel = G__151568;
is_recursive = G__151569;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__151572 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__151572,0,null);var years = cljs.core.nth.call(null,vec__151572,1,null);var months = cljs.core.nth.call(null,vec__151572,2,null);var days = cljs.core.nth.call(null,vec__151572,3,null);var hours = cljs.core.nth.call(null,vec__151572,4,null);var minutes = cljs.core.nth.call(null,vec__151572,5,null);var seconds = cljs.core.nth.call(null,vec__151572,6,null);var fraction = cljs.core.nth.call(null,vec__151572,7,null);var offset_sign = cljs.core.nth.call(null,vec__151572,8,null);var offset_hours = cljs.core.nth.call(null,vec__151572,9,null);var offset_minutes = cljs.core.nth.call(null,vec__151572,10,null);var v = vec__151572;if(cljs.core.not.call(null,v))
...
{var vec__151574 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__151574,0,null);var months = cljs.core.nth.call(null,vec__151574,1,null);var days = cljs.core.nth.call(null,vec__151574,2,null);var hours = cljs.core.nth.call(null,vec__151574,3,null);var minutes = cljs.core.nth.call(null,vec__151574,4,null);var seconds = cljs.core.nth.call(null,vec__151574,5,null);var ms = cljs.core.nth.call(null,vec__151574,6,null);var offset = cljs.core.nth.call(null,vec__151574,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
