...
{{
var G__151575 = cljs.core.pop.call(null,v__$1);
v__$1 = G__151575;
continue;
}
} else
...
{var pred__151579 = cljs.core._EQ_;var expr__151580 = limit;if(pred__151579.call(null,1,expr__151580))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__151579.call(null,2,expr__151580))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__151582 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__151583 = (limit__$1 - 1);
var G__151584 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__151582;
limit__$1 = G__151583;
parts = G__151584;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___151586 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___151586))
{var replacement_151587 = temp__4092__auto___151586;buffer.append([cljs.core.str(replacement_151587)].join(''));
} else
{buffer.append(ch);
}
{
var G__151588 = (index + 1);
index = G__151588;
continue;
}
}
