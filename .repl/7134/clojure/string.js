...
{{
var G__14752 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14752;
continue;
}
} else
...
{var pred__14756 = cljs.core._EQ_;var expr__14757 = limit;if(cljs.core.truth_(pred__14756.call(null,1,expr__14757)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14756.call(null,2,expr__14757)))
...
var G__14759 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14760 = (limit__$1 - 1);
var G__14761 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14759;
limit__$1 = G__14760;
parts = G__14761;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___14763 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___14763))
{var replacement_14764 = temp__4096__auto___14763;buffer.append([cljs.core.str(replacement_14764)].join(''));
} else
{buffer.append(ch);
}
{
var G__14765 = (index + 1);
index = G__14765;
continue;
}
}
