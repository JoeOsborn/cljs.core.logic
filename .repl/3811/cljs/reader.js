...
reader_error.cljs$lang$applyTo = (function (arglist__60199){
var rdr = cljs.core.first(arglist__60199);
var msg = cljs.core.rest(arglist__60199);
...
{{
var G__60200 = (function (){sb.append(ch);
return sb;
})();
var G__60201 = cljs.reader.read_char.call(null,rdr);
sb = G__60200;
ch = G__60201;
continue;
}
...
{{
var G__60202 = cljs.reader.read_char.call(null,rdr);
ch = G__60202;
continue;
}
} else
...
var G__60203 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__60203;
continue;
}
} else
...
var G__60204 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__60204;
continue;
}
}
...
{{
var G__60205 = (function (){buffer.append(ch);
return buffer;
})();
var G__60206 = cljs.reader.read_char.call(null,reader);
buffer = G__60205;
ch = G__60206;
continue;
}
...
{if(("\\" === ch))
{{
var G__60207 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__60208 = cljs.reader.read_char.call(null,reader);
buffer = G__60207;
ch = G__60208;
continue;
}
...
{{
var G__60209 = (function (){buffer.append(ch);
return buffer;
})();
var G__60210 = cljs.reader.read_char.call(null,reader);
buffer = G__60209;
ch = G__60210;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__60212 = o;if(G__60212)
{var bit__5323__auto__ = (G__60212.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__60212.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__60212.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__60212);
} else
{return false;
}
}
...
{{
var G__60213 = reader;
var G__60214 = eof_is_error;
var G__60215 = sentinel;
var G__60216 = is_recursive;
reader = G__60213;
eof_is_error = G__60214;
sentinel = G__60215;
is_recursive = G__60216;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__60217 = cljs.reader.read_comment.call(null,reader,ch);
var G__60218 = eof_is_error;
var G__60219 = sentinel;
var G__60220 = is_recursive;
reader = G__60217;
eof_is_error = G__60218;
sentinel = G__60219;
is_recursive = G__60220;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__60221 = reader;
var G__60222 = eof_is_error;
var G__60223 = sentinel;
var G__60224 = is_recursive;
reader = G__60221;
eof_is_error = G__60222;
sentinel = G__60223;
is_recursive = G__60224;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__60227 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__60227,0,null);var years = cljs.core.nth.call(null,vec__60227,1,null);var months = cljs.core.nth.call(null,vec__60227,2,null);var days = cljs.core.nth.call(null,vec__60227,3,null);var hours = cljs.core.nth.call(null,vec__60227,4,null);var minutes = cljs.core.nth.call(null,vec__60227,5,null);var seconds = cljs.core.nth.call(null,vec__60227,6,null);var fraction = cljs.core.nth.call(null,vec__60227,7,null);var offset_sign = cljs.core.nth.call(null,vec__60227,8,null);var offset_hours = cljs.core.nth.call(null,vec__60227,9,null);var offset_minutes = cljs.core.nth.call(null,vec__60227,10,null);var v = vec__60227;if(cljs.core.not.call(null,v))
...
{var vec__60229 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__60229,0,null);var months = cljs.core.nth.call(null,vec__60229,1,null);var days = cljs.core.nth.call(null,vec__60229,2,null);var hours = cljs.core.nth.call(null,vec__60229,3,null);var minutes = cljs.core.nth.call(null,vec__60229,4,null);var seconds = cljs.core.nth.call(null,vec__60229,5,null);var ms = cljs.core.nth.call(null,vec__60229,6,null);var offset = cljs.core.nth.call(null,vec__60229,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
