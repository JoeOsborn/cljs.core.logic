...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__60245 = m;var map__60245__$1 = ((cljs.core.seq_QMARK_.call(null,map__60245))?cljs.core.apply.call(null,cljs.core.hash_map,map__60245):map__60245);var line = cljs.core.get.call(null,map__60245__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__60245__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__60247 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__60247))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__60247))
...
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"default","default",2558708147),(function (m){var _STAR_print_fn_STAR_60248 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_60248;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_60249 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_60249;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_60250 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___60251 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___60251))
{var message_60252 = temp__4094__auto___60251;cljs.core.println.call(null,message_60252);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_60250;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_60253 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___60254 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___60254))
{var message_60255 = temp__4094__auto___60254;cljs.core.println.call(null,message_60255);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_60253;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_60256 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_60256;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_60257 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_60257;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__60258){
var ns_sym = cljs.core.first(arglist__60258);
arglist__60258 = cljs.core.next(arglist__60258);
var fixture_type = cljs.core.first(arglist__60258);
var fixture_fns = cljs.core.rest(arglist__60258);
...
try{t.call(null);
}catch (e60262){if((e60262 instanceof Error))
{var e_60263 = e60262;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_60263], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e60262;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_60261;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__60268 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__60269 = null;var count__60270 = 0;var i__60271 = 0;while(true){
if((i__60271 < count__60270))
{var v = cljs.core._nth.call(null,chunk__60269,i__60271);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__60268,chunk__60269,count__60270,i__60271,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__60268,chunk__60269,count__60270,i__60271,v))
);
} else
{}
{
var G__60272 = seq__60268;
var G__60273 = chunk__60269;
var G__60274 = count__60270;
var G__60275 = (i__60271 + 1);
seq__60268 = G__60272;
chunk__60269 = G__60273;
count__60270 = G__60274;
i__60271 = G__60275;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__60268);if(temp__4094__auto__)
{var seq__60268__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__60268__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__60268__$1);{
var G__60276 = cljs.core.chunk_rest.call(null,seq__60268__$1);
var G__60277 = c__5421__auto__;
var G__60278 = cljs.core.count.call(null,c__5421__auto__);
var G__60279 = 0;
seq__60268 = G__60276;
chunk__60269 = G__60277;
count__60270 = G__60278;
i__60271 = G__60279;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__60268__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__60268,chunk__60269,count__60270,i__60271,v,seq__60268__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__60268,chunk__60269,count__60270,i__60271,v,seq__60268__$1,temp__4094__auto__))
);
} else
{}
{
var G__60280 = cljs.core.next.call(null,seq__60268__$1);
var G__60281 = null;
var G__60282 = 0;
var G__60283 = 0;
seq__60268 = G__60280;
chunk__60269 = G__60281;
count__60270 = G__60282;
i__60271 = G__60283;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_60285 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___60286 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___60286))
{var test_hook_60287 = temp__4092__auto___60286;test_hook_60287.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_60285;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__60288){
var namespaces = cljs.core.seq(arglist__60288);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__60289_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__60289_SHARP_));
