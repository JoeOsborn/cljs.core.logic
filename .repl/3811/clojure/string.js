...
{{
var G__60230 = cljs.core.pop.call(null,v__$1);
v__$1 = G__60230;
continue;
}
} else
...
{var pred__60234 = cljs.core._EQ_;var expr__60235 = limit;if(pred__60234.call(null,1,expr__60235))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__60234.call(null,2,expr__60235))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__60237 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__60238 = (limit__$1 - 1);
var G__60239 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__60237;
limit__$1 = G__60238;
parts = G__60239;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___60241 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___60241))
{var replacement_60242 = temp__4092__auto___60241;buffer.append([cljs.core.str(replacement_60242)].join(''));
} else
{buffer.append(ch);
}
{
var G__60243 = (index + 1);
index = G__60243;
continue;
}
}
