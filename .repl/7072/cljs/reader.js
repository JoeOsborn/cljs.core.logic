...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj10250 = {};return obj10250;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__10251){
var rdr = cljs.core.first(arglist__10251);
var msg = cljs.core.rest(arglist__10251);
...
{{
var G__10252 = (function (){sb.append(ch);
return sb;
})();
var G__10253 = cljs.reader.read_char.call(null,rdr);
sb = G__10252;
ch = G__10253;
continue;
}
...
{{
var G__10254 = cljs.reader.read_char.call(null,rdr);
ch = G__10254;
continue;
}
} else
...
var G__10255 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10255;
continue;
}
} else
...
var G__10256 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10256;
continue;
}
}
...
{{
var G__10257 = (function (){buffer.append(ch);
return buffer;
})();
var G__10258 = cljs.reader.read_char.call(null,reader);
buffer = G__10257;
ch = G__10258;
continue;
}
...
{if(("\\" === ch))
{{
var G__10259 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10260 = cljs.reader.read_char.call(null,reader);
buffer = G__10259;
ch = G__10260;
continue;
}
...
{{
var G__10261 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10264 = o;if(G__10264)
{var bit__5761__auto__ = (G__10264.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5761__auto__) || (G__10264.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10264.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10264);
} else
{return false;
}
}
...
{{
var G__10265 = reader;
var G__10266 = eof_is_error;
var G__10267 = sentinel;
var G__10268 = is_recursive;
reader = G__10265;
eof_is_error = G__10266;
sentinel = G__10267;
is_recursive = G__10268;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10269 = cljs.reader.read_comment.call(null,reader,ch);
var G__10270 = eof_is_error;
var G__10271 = sentinel;
var G__10272 = is_recursive;
reader = G__10269;
eof_is_error = G__10270;
sentinel = G__10271;
is_recursive = G__10272;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10273 = reader;
var G__10274 = eof_is_error;
var G__10275 = sentinel;
var G__10276 = is_recursive;
reader = G__10273;
eof_is_error = G__10274;
sentinel = G__10275;
is_recursive = G__10276;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10279 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10279,0,null);var years = cljs.core.nth.call(null,vec__10279,1,null);var months = cljs.core.nth.call(null,vec__10279,2,null);var days = cljs.core.nth.call(null,vec__10279,3,null);var hours = cljs.core.nth.call(null,vec__10279,4,null);var minutes = cljs.core.nth.call(null,vec__10279,5,null);var seconds = cljs.core.nth.call(null,vec__10279,6,null);var fraction = cljs.core.nth.call(null,vec__10279,7,null);var offset_sign = cljs.core.nth.call(null,vec__10279,8,null);var offset_hours = cljs.core.nth.call(null,vec__10279,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10279,10,null);var v = vec__10279;if(cljs.core.not.call(null,v))
...
{var vec__10281 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__10281,0,null);var months = cljs.core.nth.call(null,vec__10281,1,null);var days = cljs.core.nth.call(null,vec__10281,2,null);var hours = cljs.core.nth.call(null,vec__10281,3,null);var minutes = cljs.core.nth.call(null,vec__10281,4,null);var seconds = cljs.core.nth.call(null,vec__10281,5,null);var ms = cljs.core.nth.call(null,vec__10281,6,null);var offset = cljs.core.nth.call(null,vec__10281,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
