...
{{
var G__10282 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10282;
continue;
}
} else
...
{var pred__10286 = cljs.core._EQ_;var expr__10287 = limit;if(cljs.core.truth_(pred__10286.call(null,1,expr__10287)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10286.call(null,2,expr__10287)))
...
var G__10289 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10290 = (limit__$1 - 1);
var G__10291 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10289;
limit__$1 = G__10290;
parts = G__10291;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___10293 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___10293))
{var replacement_10294 = temp__4096__auto___10293;buffer.append([cljs.core.str(replacement_10294)].join(''));
} else
{buffer.append(ch);
}
{
var G__10295 = (index + 1);
index = G__10295;
continue;
}
}
