...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj10981 = {};return obj10981;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__10982){
var rdr = cljs.core.first(arglist__10982);
var msg = cljs.core.rest(arglist__10982);
...
{{
var G__10983 = (function (){sb.append(ch);
return sb;
})();
var G__10984 = cljs.reader.read_char.call(null,rdr);
sb = G__10983;
ch = G__10984;
continue;
}
...
var G__10986 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10986;
continue;
}
} else
...
var G__10987 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10987;
continue;
}
}
...
{{
var G__10988 = (function (){buffer.append(ch);
return buffer;
})();
var G__10989 = cljs.reader.read_char.call(null,reader);
buffer = G__10988;
ch = G__10989;
continue;
}
...
{if(("\\" === ch))
{{
var G__10990 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10991 = cljs.reader.read_char.call(null,reader);
buffer = G__10990;
ch = G__10991;
continue;
}
...
{{
var G__10992 = (function (){buffer.append(ch);
return buffer;
})();
var G__10993 = cljs.reader.read_char.call(null,reader);
buffer = G__10992;
ch = G__10993;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10995 = o;if(G__10995)
{var bit__5763__auto__ = (G__10995.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5763__auto__) || (G__10995.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10995.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10995);
} else
{return false;
}
}
...
{{
var G__10996 = reader;
var G__10997 = eof_is_error;
var G__10998 = sentinel;
var G__10999 = is_recursive;
reader = G__10996;
eof_is_error = G__10997;
sentinel = G__10998;
is_recursive = G__10999;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__11000 = cljs.reader.read_comment.call(null,reader,ch);
var G__11001 = eof_is_error;
var G__11002 = sentinel;
var G__11003 = is_recursive;
reader = G__11000;
eof_is_error = G__11001;
sentinel = G__11002;
is_recursive = G__11003;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__11004 = reader;
var G__11005 = eof_is_error;
var G__11006 = sentinel;
var G__11007 = is_recursive;
reader = G__11004;
eof_is_error = G__11005;
sentinel = G__11006;
is_recursive = G__11007;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__11010 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__11010,0,null);var years = cljs.core.nth.call(null,vec__11010,1,null);var months = cljs.core.nth.call(null,vec__11010,2,null);var days = cljs.core.nth.call(null,vec__11010,3,null);var hours = cljs.core.nth.call(null,vec__11010,4,null);var minutes = cljs.core.nth.call(null,vec__11010,5,null);var seconds = cljs.core.nth.call(null,vec__11010,6,null);var fraction = cljs.core.nth.call(null,vec__11010,7,null);var offset_sign = cljs.core.nth.call(null,vec__11010,8,null);var offset_hours = cljs.core.nth.call(null,vec__11010,9,null);var offset_minutes = cljs.core.nth.call(null,vec__11010,10,null);var v = vec__11010;if(cljs.core.not.call(null,v))
...
{var vec__11012 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__11012,0,null);var months = cljs.core.nth.call(null,vec__11012,1,null);var days = cljs.core.nth.call(null,vec__11012,2,null);var hours = cljs.core.nth.call(null,vec__11012,3,null);var minutes = cljs.core.nth.call(null,vec__11012,4,null);var seconds = cljs.core.nth.call(null,vec__11012,5,null);var ms = cljs.core.nth.call(null,vec__11012,6,null);var offset = cljs.core.nth.call(null,vec__11012,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
