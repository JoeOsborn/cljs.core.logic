...
{var vec__13171 = expr__$1;var f = cljs.core.nth.call(null,vec__13171,0,null);var n = cljs.core.nthnext.call(null,vec__13171,1);var skip = cljs.core._EQ_.call(null,f,new cljs.core.Symbol(null,".",".",-1640531481,null));var tail = prep_STAR_.call(null,n,store,lcons_QMARK_,skip);if(skip)
{return tail;
} else
...
*/
cljs.core.logic.unifier.prep = (function prep(expr){var lvars = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prepped = ((cljs.core.logic.unifier.lvarq_sym_QMARK_.call(null,expr))?cljs.core.logic.unifier.proc_lvar.call(null,expr,lvars):(cljs.core.truth_(cljs.core.logic.unifier.lcons_expr_QMARK_.call(null,expr))?cljs.core.logic.unifier.prep_STAR_.call(null,expr,lvars,true):((new cljs.core.Keyword(null,"else","else",1017020587))?cljs.core.logic.protocols.walk_term.call(null,expr,cljs.core.logic.unifier.replace_lvar.call(null,lvars)):null)));if((function (){var G__13173 = prepped;if(G__13173)
{var bit__7442__auto__ = (G__13173.cljs$lang$protocol_mask$partition0$ & 131072);if((bit__7442__auto__) || (G__13173.cljs$core$IMeta$))
{return true;
} else
{if((!G__13173.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMeta,G__13173);
} else
{return false;
}
}
...
{return cljs.core.logic.protocols.queue.call(null,s,cljs.core.logic.protocols._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__13174_SHARP_){return (new cljs.core.logic.LVar(p1__13174_SHARP_,false,"p1__13174#",p1__13174_SHARP_,-977428264,null));
}),vs))));
} else
...
{return cljs.core.logic.protocols.queue.call(null,s,cljs.core.logic.protocols._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__13175_SHARP_){return (new cljs.core.logic.LVar(p1__13175_SHARP_,false,"p1__13175#",p1__13175_SHARP_,-977428233,null));
...
cljs.core.logic.unifier.queue_constraints = (function queue_constraints(s,p__13176){var vec__13178 = p__13176;var vs = cljs.core.nth.call(null,vec__13178,0,null);var cs = cljs.core.nth.call(null,vec__13178,1,null);var cs__$1 = ((!(cljs.core.sequential_QMARK_.call(null,cs)))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cs], null):cs);return cljs.core.reduce.call(null,(function (s__$1,c){return cljs.core.logic.unifier.queue_constraint.call(null,s__$1,c,vs);
}),s,cs__$1);
});
cljs.core.logic.unifier._unify_STAR_ = (function _unify_STAR_(init_s,u,w){return cljs.core.first.call(null,cljs.core.logic.protocols.take_STAR_.call(null,(function (){return (function (a__6255__auto__){return (function _inc(){var q = (new cljs.core.logic.LVar(13182,true,"q__13182",new cljs.core.Symbol(null,"q","q",-1640531414,null),549166104,null));return cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,a__6255__auto__,cljs.core.logic._EQ__EQ_.call(null,u,w)),cljs.core.logic._EQ__EQ_.call(null,q,u)),(function (a){return cljs.core.logic.fix_constraints.call(null,a);
})),cljs.core.logic.reifyg.call(null,q));
});
}).call(null,init_s);
})));
});
cljs.core.logic.unifier.init_s = (function init_s(opts,s){var s__$1 = cljs.core.reduce.call(null,(function (s__$1,p__13185){var vec__13186 = p__13185;var k = cljs.core.nth.call(null,vec__13186,0,null);var v = cljs.core.nth.call(null,vec__13186,1,null);return cljs.core.logic._EQ__EQ_.call(null,k,v).call(null,s__$1);
...
var unify_STAR___2 = (function (opts,ts){var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.empty_s);return cljs.core.logic.unifier._unify_STAR_.call(null,cljs.core.vary_meta.call(null,init_s,cljs.core.assoc,new cljs.core.Keyword(null,"reify-vars","reify-vars",4368745730),false),cljs.core.reduce.call(null,(function (p1__13187_SHARP_,p2__13188_SHARP_){return cljs.core.logic.unifier._unify_STAR_.call(null,init_s,p1__13187_SHARP_,p2__13188_SHARP_);
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__13203){var vec__13204 = p__13203;var sym = cljs.core.nth.call(null,vec__13204,0,null);var var$ = cljs.core.nth.call(null,vec__13204,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sym,cljs.core.logic._reify.call(null,s__$1,var$)], null);
}),cljs.core.filter.call(null,(function (p__13205){var vec__13206 = p__13205;var sym = cljs.core.nth.call(null,vec__13206,0,null);var var$ = cljs.core.nth.call(null,vec__13206,1,null);return cljs.core.not_EQ_.call(null,cljs.core.logic.protocols.walk.call(null,s__$1,var$),var$);
...
var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.empty_s);return cljs.core.reduce.call(null,(function (p1__13189_SHARP_,p2__13190_SHARP_){return _unifier_STAR_.call(null,init_s,p1__13189_SHARP_,p2__13190_SHARP_);
}),ts);
});
...
var unify__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__13209){var vec__13210 = p__13209;var k = cljs.core.nth.call(null,vec__13210,0,null);var v = cljs.core.nth.call(null,vec__13210,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.logic.LVar(k,false,"k",k,107,null)),cljs.core.logic.unifier.prep.call(null,v)], null);
...
var unifier__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__13214){var vec__13215 = p__13214;var k = cljs.core.nth.call(null,vec__13215,0,null);var v = cljs.core.nth.call(null,vec__13215,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.logic.LVar(k,false,"k",k,107,null)),cljs.core.logic.unifier.prep.call(null,v)], null);
...
return (function (p1__13211_SHARP_){return new cljs.core.Keyword("cljs.core.logic.unifier","lvars","cljs.core.logic.unifier/lvars",1819622758).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13211_SHARP_));
