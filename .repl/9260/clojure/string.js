...
{{
var G__10473 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10473;
continue;
}
} else
...
{var pred__10477 = cljs.core._EQ_;var expr__10478 = limit;if(cljs.core.truth_(pred__10477.call(null,1,expr__10478)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10477.call(null,2,expr__10478)))
...
var G__10480 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10481 = (limit__$1 - 1);
var G__10482 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10480;
limit__$1 = G__10481;
parts = G__10482;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___10484 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___10484))
{var replacement_10485 = temp__4096__auto___10484;buffer.append([cljs.core.str(replacement_10485)].join(''));
} else
{buffer.append(ch);
}
{
var G__10486 = (index + 1);
index = G__10486;
continue;
}
}
