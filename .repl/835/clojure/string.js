...
{{
var G__21448 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21448;
continue;
}
} else
...
{var pred__21452 = cljs.core._EQ_;var expr__21453 = limit;if(pred__21452.call(null,1,expr__21453))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__21452.call(null,2,expr__21453))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__21455 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21456 = (limit__$1 - 1);
var G__21457 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__21455;
limit__$1 = G__21456;
parts = G__21457;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___21459 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___21459))
{var replacement_21460 = temp__4092__auto___21459;buffer.append([cljs.core.str(replacement_21460)].join(''));
} else
{buffer.append(ch);
}
{
var G__21461 = (index + 1);
index = G__21461;
continue;
}
}
