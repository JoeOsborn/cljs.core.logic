...
{{
var G__44789 = cljs.core.pop.call(null,v__$1);
v__$1 = G__44789;
continue;
}
} else
...
{var pred__44793 = cljs.core._EQ_;var expr__44794 = limit;if(cljs.core.truth_(pred__44793.call(null,1,expr__44794)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__44793.call(null,2,expr__44794)))
...
var G__44796 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__44797 = (limit__$1 - 1);
var G__44798 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__44796;
limit__$1 = G__44797;
parts = G__44798;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___44800 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___44800))
{var replacement_44801 = temp__4096__auto___44800;buffer.append([cljs.core.str(replacement_44801)].join(''));
} else
{buffer.append(ch);
}
{
var G__44802 = (index + 1);
index = G__44802;
continue;
}
}
