...
reader_error.cljs$lang$applyTo = (function (arglist__21417){
var rdr = cljs.core.first(arglist__21417);
var msg = cljs.core.rest(arglist__21417);
...
{{
var G__21418 = (function (){sb.append(ch);
return sb;
})();
var G__21419 = cljs.reader.read_char.call(null,rdr);
sb = G__21418;
ch = G__21419;
continue;
}
...
var G__21421 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__21421;
continue;
}
} else
...
var G__21422 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__21422;
continue;
}
}
...
{{
var G__21423 = (function (){buffer.append(ch);
return buffer;
})();
var G__21424 = cljs.reader.read_char.call(null,reader);
buffer = G__21423;
ch = G__21424;
continue;
}
...
{if(("\\" === ch))
{{
var G__21425 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__21426 = cljs.reader.read_char.call(null,reader);
buffer = G__21425;
ch = G__21426;
continue;
}
...
{{
var G__21427 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__21430 = o;if(G__21430)
{var bit__5323__auto__ = (G__21430.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__21430.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__21430.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__21430);
} else
{return false;
}
}
...
{{
var G__21431 = reader;
var G__21432 = eof_is_error;
var G__21433 = sentinel;
var G__21434 = is_recursive;
reader = G__21431;
eof_is_error = G__21432;
sentinel = G__21433;
is_recursive = G__21434;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__21435 = cljs.reader.read_comment.call(null,reader,ch);
var G__21436 = eof_is_error;
var G__21437 = sentinel;
var G__21438 = is_recursive;
reader = G__21435;
eof_is_error = G__21436;
sentinel = G__21437;
is_recursive = G__21438;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__21439 = reader;
var G__21440 = eof_is_error;
var G__21441 = sentinel;
var G__21442 = is_recursive;
reader = G__21439;
eof_is_error = G__21440;
sentinel = G__21441;
is_recursive = G__21442;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__21445 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__21445,0,null);var years = cljs.core.nth.call(null,vec__21445,1,null);var months = cljs.core.nth.call(null,vec__21445,2,null);var days = cljs.core.nth.call(null,vec__21445,3,null);var hours = cljs.core.nth.call(null,vec__21445,4,null);var minutes = cljs.core.nth.call(null,vec__21445,5,null);var seconds = cljs.core.nth.call(null,vec__21445,6,null);var fraction = cljs.core.nth.call(null,vec__21445,7,null);var offset_sign = cljs.core.nth.call(null,vec__21445,8,null);var offset_hours = cljs.core.nth.call(null,vec__21445,9,null);var offset_minutes = cljs.core.nth.call(null,vec__21445,10,null);var v = vec__21445;if(cljs.core.not.call(null,v))
...
{var vec__21447 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__21447,0,null);var months = cljs.core.nth.call(null,vec__21447,1,null);var days = cljs.core.nth.call(null,vec__21447,2,null);var hours = cljs.core.nth.call(null,vec__21447,3,null);var minutes = cljs.core.nth.call(null,vec__21447,4,null);var seconds = cljs.core.nth.call(null,vec__21447,5,null);var ms = cljs.core.nth.call(null,vec__21447,6,null);var offset = cljs.core.nth.call(null,vec__21447,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
