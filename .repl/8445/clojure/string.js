...
{{
var G__684671 = cljs.core.pop.call(null,v__$1);
v__$1 = G__684671;
continue;
}
} else
...
{var pred__684675 = cljs.core._EQ_;var expr__684676 = limit;if(cljs.core.truth_(pred__684675.call(null,1,expr__684676)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__684675.call(null,2,expr__684676)))
...
var G__684678 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__684679 = (limit__$1 - 1);
var G__684680 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__684678;
limit__$1 = G__684679;
parts = G__684680;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___684682 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___684682))
{var replacement_684683 = temp__4096__auto___684682;buffer.append([cljs.core.str(replacement_684683)].join(''));
} else
{buffer.append(ch);
}
{
var G__684684 = (index + 1);
index = G__684684;
continue;
}
}
