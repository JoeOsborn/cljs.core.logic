...
{{
var G__163753 = cljs.core.pop.call(null,v__$1);
v__$1 = G__163753;
continue;
}
} else
...
{var pred__163757 = cljs.core._EQ_;var expr__163758 = limit;if(cljs.core.truth_(pred__163757.call(null,1,expr__163758)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__163757.call(null,2,expr__163758)))
...
var G__163760 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__163761 = (limit__$1 - 1);
var G__163762 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__163760;
limit__$1 = G__163761;
parts = G__163762;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___163764 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___163764))
{var replacement_163765 = temp__4096__auto___163764;buffer.append([cljs.core.str(replacement_163765)].join(''));
} else
{buffer.append(ch);
}
{
var G__163766 = (index + 1);
index = G__163766;
continue;
}
}
