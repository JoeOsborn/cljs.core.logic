...
reader_error.cljs$lang$applyTo = (function (arglist__95102){
var rdr = cljs.core.first(arglist__95102);
var msg = cljs.core.rest(arglist__95102);
...
{{
var G__95103 = (function (){sb.append(ch);
return sb;
})();
var G__95104 = cljs.reader.read_char.call(null,rdr);
sb = G__95103;
ch = G__95104;
continue;
}
...
{{
var G__95105 = cljs.reader.read_char.call(null,rdr);
ch = G__95105;
continue;
}
} else
...
var G__95106 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__95106;
continue;
}
} else
...
var G__95107 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__95107;
continue;
}
}
...
{{
var G__95108 = (function (){buffer.append(ch);
return buffer;
})();
var G__95109 = cljs.reader.read_char.call(null,reader);
buffer = G__95108;
ch = G__95109;
continue;
}
...
{if(("\\" === ch))
{{
var G__95110 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__95111 = cljs.reader.read_char.call(null,reader);
buffer = G__95110;
ch = G__95111;
continue;
}
...
{{
var G__95112 = (function (){buffer.append(ch);
return buffer;
})();
var G__95113 = cljs.reader.read_char.call(null,reader);
buffer = G__95112;
ch = G__95113;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__95115 = o;if(G__95115)
{var bit__5323__auto__ = (G__95115.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__95115.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__95115.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__95115);
} else
{return false;
}
}
...
{{
var G__95116 = reader;
var G__95117 = eof_is_error;
var G__95118 = sentinel;
var G__95119 = is_recursive;
reader = G__95116;
eof_is_error = G__95117;
sentinel = G__95118;
is_recursive = G__95119;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__95120 = cljs.reader.read_comment.call(null,reader,ch);
var G__95121 = eof_is_error;
var G__95122 = sentinel;
var G__95123 = is_recursive;
reader = G__95120;
eof_is_error = G__95121;
sentinel = G__95122;
is_recursive = G__95123;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__95124 = reader;
var G__95125 = eof_is_error;
var G__95126 = sentinel;
var G__95127 = is_recursive;
reader = G__95124;
eof_is_error = G__95125;
sentinel = G__95126;
is_recursive = G__95127;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__95130 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__95130,0,null);var years = cljs.core.nth.call(null,vec__95130,1,null);var months = cljs.core.nth.call(null,vec__95130,2,null);var days = cljs.core.nth.call(null,vec__95130,3,null);var hours = cljs.core.nth.call(null,vec__95130,4,null);var minutes = cljs.core.nth.call(null,vec__95130,5,null);var seconds = cljs.core.nth.call(null,vec__95130,6,null);var fraction = cljs.core.nth.call(null,vec__95130,7,null);var offset_sign = cljs.core.nth.call(null,vec__95130,8,null);var offset_hours = cljs.core.nth.call(null,vec__95130,9,null);var offset_minutes = cljs.core.nth.call(null,vec__95130,10,null);var v = vec__95130;if(cljs.core.not.call(null,v))
...
{var vec__95132 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__95132,0,null);var months = cljs.core.nth.call(null,vec__95132,1,null);var days = cljs.core.nth.call(null,vec__95132,2,null);var hours = cljs.core.nth.call(null,vec__95132,3,null);var minutes = cljs.core.nth.call(null,vec__95132,4,null);var seconds = cljs.core.nth.call(null,vec__95132,5,null);var ms = cljs.core.nth.call(null,vec__95132,6,null);var offset = cljs.core.nth.call(null,vec__95132,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
