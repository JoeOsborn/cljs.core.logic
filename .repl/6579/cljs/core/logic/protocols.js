...
cljs.core.logic.protocols.non_storable_QMARK_ = (function non_storable_QMARK_(x){var G__94789 = x;if(G__94789)
...
{return G__94789.cljs$core$logic$protocols$INonStorable$;
}
})()))
{return true;
} else
{if((!G__94789.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.INonStorable,G__94789);
} else
{return false;
}
}
...
cljs.core.logic.protocols.id = (function id(c){if((function (){var G__94791 = c;if(G__94791)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__94791.cljs$core$logic$protocols$IConstraintId$;
}
})()))
{return true;
} else
{if((!G__94791.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IConstraintId,G__94791);
} else
{return false;
}
}
...
cljs.core.logic.protocols.with_id = (function with_id(c,id){if((function (){var G__94793 = c;if(G__94793)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__94793.cljs$core$logic$protocols$IWithConstraintId$;
}
})()))
{return true;
} else
{if((!G__94793.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IWithConstraintId,G__94793);
} else
{return false;
}
}
...
cljs.core.logic.protocols.reifiable_QMARK_ = (function reifiable_QMARK_(x){var G__94795 = x;if(G__94795)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__94795.cljs$core$logic$protocols$IReifiableConstraint$;
}
})()))
{return true;
} else
{if((!G__94795.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IReifiableConstraint,G__94795);
} else
{return false;
}
}
...
cljs.core.logic.protocols.enforceable_QMARK_ = (function enforceable_QMARK_(x){var G__94797 = x;if(G__94797)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__94797.cljs$core$logic$protocols$IEnforceableConstraint$;
}
})()))
{return true;
} else
{if((!G__94797.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IEnforceableConstraint,G__94797);
} else
{return false;
}
}
...
cljs.core.logic.protocols.tree_constraint_QMARK_ = (function tree_constraint_QMARK_(x){var G__94799 = x;if(G__94799)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__94799.clojure$core$logic$protocols$ITreeConstraint$;
}
})()))
{return true;
} else
{if((!G__94799.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,clojure.core.logic.protocols.ITreeConstraint,G__94799);
} else
{return false;
}
}
