...
{{
var G__95133 = cljs.core.pop.call(null,v__$1);
v__$1 = G__95133;
continue;
}
} else
...
{var pred__95137 = cljs.core._EQ_;var expr__95138 = limit;if(pred__95137.call(null,1,expr__95138))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__95137.call(null,2,expr__95138))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__95140 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__95141 = (limit__$1 - 1);
var G__95142 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__95140;
limit__$1 = G__95141;
parts = G__95142;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___95144 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___95144))
{var replacement_95145 = temp__4092__auto___95144;buffer.append([cljs.core.str(replacement_95145)].join(''));
} else
{buffer.append(ch);
}
{
var G__95146 = (index + 1);
index = G__95146;
continue;
}
}
