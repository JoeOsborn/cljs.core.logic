...
{{
var G__461942 = cljs.core.pop.call(null,v__$1);
v__$1 = G__461942;
continue;
}
} else
...
{var pred__461946 = cljs.core._EQ_;var expr__461947 = limit;if(cljs.core.truth_(pred__461946.call(null,1,expr__461947)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__461946.call(null,2,expr__461947)))
...
var G__461949 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__461950 = (limit__$1 - 1);
var G__461951 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__461949;
limit__$1 = G__461950;
parts = G__461951;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___461953 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___461953))
{var replacement_461954 = temp__4096__auto___461953;buffer.append([cljs.core.str(replacement_461954)].join(''));
} else
{buffer.append(ch);
}
{
var G__461955 = (index + 1);
index = G__461955;
continue;
}
}
