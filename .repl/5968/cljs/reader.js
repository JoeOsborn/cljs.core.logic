...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj24372 = {};return obj24372;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__24373){
var rdr = cljs.core.first(arglist__24373);
var msg = cljs.core.rest(arglist__24373);
...
{{
var G__24374 = (function (){sb.append(ch);
return sb;
})();
var G__24375 = cljs.reader.read_char.call(null,rdr);
sb = G__24374;
ch = G__24375;
continue;
}
...
{{
var G__24376 = cljs.reader.read_char.call(null,rdr);
ch = G__24376;
continue;
}
} else
...
var G__24377 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__24377;
continue;
}
} else
...
var G__24378 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__24378;
continue;
}
}
...
{{
var G__24379 = (function (){buffer.append(ch);
return buffer;
})();
var G__24380 = cljs.reader.read_char.call(null,reader);
buffer = G__24379;
ch = G__24380;
continue;
}
...
{if(("\\" === ch))
{{
var G__24381 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__24382 = cljs.reader.read_char.call(null,reader);
buffer = G__24381;
ch = G__24382;
continue;
}
...
{{
var G__24383 = (function (){buffer.append(ch);
return buffer;
})();
var G__24384 = cljs.reader.read_char.call(null,reader);
buffer = G__24383;
ch = G__24384;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__24386 = o;if(G__24386)
{var bit__11182__auto__ = (G__24386.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11182__auto__) || (G__24386.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__24386.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__24386);
} else
{return false;
}
}
...
{{
var G__24387 = reader;
var G__24388 = eof_is_error;
var G__24389 = sentinel;
var G__24390 = is_recursive;
reader = G__24387;
eof_is_error = G__24388;
sentinel = G__24389;
is_recursive = G__24390;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__24391 = cljs.reader.read_comment.call(null,reader,ch);
var G__24392 = eof_is_error;
var G__24393 = sentinel;
var G__24394 = is_recursive;
reader = G__24391;
eof_is_error = G__24392;
sentinel = G__24393;
is_recursive = G__24394;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__24395 = reader;
var G__24396 = eof_is_error;
var G__24397 = sentinel;
var G__24398 = is_recursive;
reader = G__24395;
eof_is_error = G__24396;
sentinel = G__24397;
is_recursive = G__24398;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__24401 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__24401,0,null);var years = cljs.core.nth.call(null,vec__24401,1,null);var months = cljs.core.nth.call(null,vec__24401,2,null);var days = cljs.core.nth.call(null,vec__24401,3,null);var hours = cljs.core.nth.call(null,vec__24401,4,null);var minutes = cljs.core.nth.call(null,vec__24401,5,null);var seconds = cljs.core.nth.call(null,vec__24401,6,null);var fraction = cljs.core.nth.call(null,vec__24401,7,null);var offset_sign = cljs.core.nth.call(null,vec__24401,8,null);var offset_hours = cljs.core.nth.call(null,vec__24401,9,null);var offset_minutes = cljs.core.nth.call(null,vec__24401,10,null);var v = vec__24401;if(cljs.core.not.call(null,v))
...
{var vec__24403 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__24403,0,null);var months = cljs.core.nth.call(null,vec__24403,1,null);var days = cljs.core.nth.call(null,vec__24403,2,null);var hours = cljs.core.nth.call(null,vec__24403,3,null);var minutes = cljs.core.nth.call(null,vec__24403,4,null);var seconds = cljs.core.nth.call(null,vec__24403,5,null);var ms = cljs.core.nth.call(null,vec__24403,6,null);var offset = cljs.core.nth.call(null,vec__24403,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
