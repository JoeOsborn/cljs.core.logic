...
{{
var G__24404 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24404;
continue;
}
} else
...
{var pred__24408 = cljs.core._EQ_;var expr__24409 = limit;if(cljs.core.truth_(pred__24408.call(null,1,expr__24409)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24408.call(null,2,expr__24409)))
...
var G__24411 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24412 = (limit__$1 - 1);
var G__24413 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24411;
limit__$1 = G__24412;
parts = G__24413;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___24415 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___24415))
{var replacement_24416 = temp__4096__auto___24415;buffer.append([cljs.core.str(replacement_24416)].join(''));
} else
{buffer.append(ch);
}
{
var G__24417 = (index + 1);
index = G__24417;
continue;
}
}
