...
{{
var G__119185 = cljs.core.pop.call(null,v__$1);
v__$1 = G__119185;
continue;
}
} else
...
{var pred__119189 = cljs.core._EQ_;var expr__119190 = limit;if(cljs.core.truth_(pred__119189.call(null,1,expr__119190)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__119189.call(null,2,expr__119190)))
...
var G__119192 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__119193 = (limit__$1 - 1);
var G__119194 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__119192;
limit__$1 = G__119193;
parts = G__119194;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___119196 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___119196))
{var replacement_119197 = temp__4096__auto___119196;buffer.append([cljs.core.str(replacement_119197)].join(''));
} else
{buffer.append(ch);
}
{
var G__119198 = (index + 1);
index = G__119198;
continue;
}
}
