...
{{
var G__60701 = cljs.core.pop.call(null,v__$1);
v__$1 = G__60701;
continue;
}
} else
...
{var pred__60705 = cljs.core._EQ_;var expr__60706 = limit;if(cljs.core.truth_(pred__60705.call(null,1,expr__60706)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__60705.call(null,2,expr__60706)))
...
var G__60708 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__60709 = (limit__$1 - 1);
var G__60710 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__60708;
limit__$1 = G__60709;
parts = G__60710;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___60712 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___60712))
{var replacement_60713 = temp__4096__auto___60712;buffer.append([cljs.core.str(replacement_60713)].join(''));
} else
{buffer.append(ch);
}
{
var G__60714 = (index + 1);
index = G__60714;
continue;
}
}
