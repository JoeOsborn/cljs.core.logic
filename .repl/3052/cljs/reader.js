...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj61189 = {};return obj61189;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__61190){
var rdr = cljs.core.first(arglist__61190);
var msg = cljs.core.rest(arglist__61190);
...
{{
var G__61191 = (function (){sb.append(ch);
return sb;
})();
var G__61192 = cljs.reader.read_char.call(null,rdr);
sb = G__61191;
ch = G__61192;
continue;
}
...
{{
var G__61193 = cljs.reader.read_char.call(null,rdr);
ch = G__61193;
continue;
}
} else
...
var G__61194 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__61194;
continue;
}
} else
...
var G__61195 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__61195;
continue;
}
}
...
{{
var G__61196 = (function (){buffer.append(ch);
return buffer;
})();
var G__61197 = cljs.reader.read_char.call(null,reader);
buffer = G__61196;
ch = G__61197;
continue;
}
...
{if(("\\" === ch))
{{
var G__61198 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__61199 = cljs.reader.read_char.call(null,reader);
buffer = G__61198;
ch = G__61199;
continue;
}
...
{{
var G__61200 = (function (){buffer.append(ch);
return buffer;
})();
var G__61201 = cljs.reader.read_char.call(null,reader);
buffer = G__61200;
ch = G__61201;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__61203 = o;if(G__61203)
{var bit__5761__auto__ = (G__61203.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5761__auto__) || (G__61203.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__61203.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__61203);
} else
{return false;
}
}
...
{{
var G__61204 = reader;
var G__61205 = eof_is_error;
var G__61206 = sentinel;
var G__61207 = is_recursive;
reader = G__61204;
eof_is_error = G__61205;
sentinel = G__61206;
is_recursive = G__61207;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__61208 = cljs.reader.read_comment.call(null,reader,ch);
var G__61209 = eof_is_error;
var G__61210 = sentinel;
var G__61211 = is_recursive;
reader = G__61208;
eof_is_error = G__61209;
sentinel = G__61210;
is_recursive = G__61211;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__61212 = reader;
var G__61213 = eof_is_error;
var G__61214 = sentinel;
var G__61215 = is_recursive;
reader = G__61212;
eof_is_error = G__61213;
sentinel = G__61214;
is_recursive = G__61215;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__61218 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__61218,0,null);var years = cljs.core.nth.call(null,vec__61218,1,null);var months = cljs.core.nth.call(null,vec__61218,2,null);var days = cljs.core.nth.call(null,vec__61218,3,null);var hours = cljs.core.nth.call(null,vec__61218,4,null);var minutes = cljs.core.nth.call(null,vec__61218,5,null);var seconds = cljs.core.nth.call(null,vec__61218,6,null);var fraction = cljs.core.nth.call(null,vec__61218,7,null);var offset_sign = cljs.core.nth.call(null,vec__61218,8,null);var offset_hours = cljs.core.nth.call(null,vec__61218,9,null);var offset_minutes = cljs.core.nth.call(null,vec__61218,10,null);var v = vec__61218;if(cljs.core.not.call(null,v))
...
{var vec__61220 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__61220,0,null);var months = cljs.core.nth.call(null,vec__61220,1,null);var days = cljs.core.nth.call(null,vec__61220,2,null);var hours = cljs.core.nth.call(null,vec__61220,3,null);var minutes = cljs.core.nth.call(null,vec__61220,4,null);var seconds = cljs.core.nth.call(null,vec__61220,5,null);var ms = cljs.core.nth.call(null,vec__61220,6,null);var offset = cljs.core.nth.call(null,vec__61220,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
