...
{{
var G__61221 = cljs.core.pop.call(null,v__$1);
v__$1 = G__61221;
continue;
}
} else
...
{var pred__61225 = cljs.core._EQ_;var expr__61226 = limit;if(cljs.core.truth_(pred__61225.call(null,1,expr__61226)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__61225.call(null,2,expr__61226)))
...
var G__61228 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__61229 = (limit__$1 - 1);
var G__61230 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__61228;
limit__$1 = G__61229;
parts = G__61230;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___61232 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___61232))
{var replacement_61233 = temp__4096__auto___61232;buffer.append([cljs.core.str(replacement_61233)].join(''));
} else
{buffer.append(ch);
}
{
var G__61234 = (index + 1);
index = G__61234;
continue;
}
}
