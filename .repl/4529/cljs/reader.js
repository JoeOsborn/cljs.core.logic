...
reader_error.cljs$lang$applyTo = (function (arglist__299384){
var rdr = cljs.core.first(arglist__299384);
var msg = cljs.core.rest(arglist__299384);
...
{{
var G__299385 = (function (){sb.append(ch);
return sb;
})();
var G__299386 = cljs.reader.read_char.call(null,rdr);
sb = G__299385;
ch = G__299386;
continue;
}
...
{{
var G__299387 = cljs.reader.read_char.call(null,rdr);
ch = G__299387;
continue;
}
} else
...
var G__299388 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__299388;
continue;
}
} else
...
var G__299389 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__299389;
continue;
}
}
...
{{
var G__299390 = (function (){buffer.append(ch);
return buffer;
})();
var G__299391 = cljs.reader.read_char.call(null,reader);
buffer = G__299390;
ch = G__299391;
continue;
}
...
{if(("\\" === ch))
{{
var G__299392 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__299393 = cljs.reader.read_char.call(null,reader);
buffer = G__299392;
ch = G__299393;
continue;
}
...
{{
var G__299394 = (function (){buffer.append(ch);
return buffer;
})();
var G__299395 = cljs.reader.read_char.call(null,reader);
buffer = G__299394;
ch = G__299395;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__299397 = o;if(G__299397)
{var bit__5323__auto__ = (G__299397.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__299397.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__299397.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__299397);
} else
{return false;
}
}
...
{{
var G__299398 = reader;
var G__299399 = eof_is_error;
var G__299400 = sentinel;
var G__299401 = is_recursive;
reader = G__299398;
eof_is_error = G__299399;
sentinel = G__299400;
is_recursive = G__299401;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__299402 = cljs.reader.read_comment.call(null,reader,ch);
var G__299403 = eof_is_error;
var G__299404 = sentinel;
var G__299405 = is_recursive;
reader = G__299402;
eof_is_error = G__299403;
sentinel = G__299404;
is_recursive = G__299405;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__299406 = reader;
var G__299407 = eof_is_error;
var G__299408 = sentinel;
var G__299409 = is_recursive;
reader = G__299406;
eof_is_error = G__299407;
sentinel = G__299408;
is_recursive = G__299409;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__299412 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__299412,0,null);var years = cljs.core.nth.call(null,vec__299412,1,null);var months = cljs.core.nth.call(null,vec__299412,2,null);var days = cljs.core.nth.call(null,vec__299412,3,null);var hours = cljs.core.nth.call(null,vec__299412,4,null);var minutes = cljs.core.nth.call(null,vec__299412,5,null);var seconds = cljs.core.nth.call(null,vec__299412,6,null);var fraction = cljs.core.nth.call(null,vec__299412,7,null);var offset_sign = cljs.core.nth.call(null,vec__299412,8,null);var offset_hours = cljs.core.nth.call(null,vec__299412,9,null);var offset_minutes = cljs.core.nth.call(null,vec__299412,10,null);var v = vec__299412;if(cljs.core.not.call(null,v))
...
{var vec__299414 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__299414,0,null);var months = cljs.core.nth.call(null,vec__299414,1,null);var days = cljs.core.nth.call(null,vec__299414,2,null);var hours = cljs.core.nth.call(null,vec__299414,3,null);var minutes = cljs.core.nth.call(null,vec__299414,4,null);var seconds = cljs.core.nth.call(null,vec__299414,5,null);var ms = cljs.core.nth.call(null,vec__299414,6,null);var offset = cljs.core.nth.call(null,vec__299414,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
