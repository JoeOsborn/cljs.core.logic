...
{{
var G__299088 = cljs.core.pop.call(null,v__$1);
v__$1 = G__299088;
continue;
}
} else
...
{var pred__299092 = cljs.core._EQ_;var expr__299093 = limit;if(pred__299092.call(null,1,expr__299093))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__299092.call(null,2,expr__299093))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__299095 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__299096 = (limit__$1 - 1);
var G__299097 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__299095;
limit__$1 = G__299096;
parts = G__299097;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___299099 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___299099))
{var replacement_299100 = temp__4092__auto___299099;buffer.append([cljs.core.str(replacement_299100)].join(''));
} else
{buffer.append(ch);
}
{
var G__299101 = (index + 1);
index = G__299101;
continue;
}
}
