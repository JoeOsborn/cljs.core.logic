...
{{
var G__164925 = cljs.core.pop.call(null,v__$1);
v__$1 = G__164925;
continue;
}
} else
...
{var pred__164929 = cljs.core._EQ_;var expr__164930 = limit;if(pred__164929.call(null,1,expr__164930))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__164929.call(null,2,expr__164930))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__164932 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__164933 = (limit__$1 - 1);
var G__164934 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__164932;
limit__$1 = G__164933;
parts = G__164934;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___164936 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___164936))
{var replacement_164937 = temp__4092__auto___164936;buffer.append([cljs.core.str(replacement_164937)].join(''));
} else
{buffer.append(ch);
}
{
var G__164938 = (index + 1);
index = G__164938;
continue;
}
}
