...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__165255 = m;var map__165255__$1 = ((cljs.core.seq_QMARK_.call(null,map__165255))?cljs.core.apply.call(null,cljs.core.hash_map,map__165255):map__165255);var line = cljs.core.get.call(null,map__165255__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__165255__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__165257 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__165257))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__165257))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_165258;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_165259 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_165259;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_165260 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___165261 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___165261))
{var message_165262 = temp__4094__auto___165261;cljs.core.println.call(null,message_165262);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_165260;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_165263 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___165264 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___165264))
{var message_165265 = temp__4094__auto___165264;cljs.core.println.call(null,message_165265);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_165266;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_165267 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_165267;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__165268){
var ns_sym = cljs.core.first(arglist__165268);
arglist__165268 = cljs.core.next(arglist__165268);
var fixture_type = cljs.core.first(arglist__165268);
var fixture_fns = cljs.core.rest(arglist__165268);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_165271 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__4704__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e165272){if((e165272 instanceof Error))
{var e_165273 = e165272;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_165273], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e165272;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_165271;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__165278 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__165279 = null;var count__165280 = 0;var i__165281 = 0;while(true){
if((i__165281 < count__165280))
{var v = cljs.core._nth.call(null,chunk__165279,i__165281);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__165278,chunk__165279,count__165280,i__165281,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__165278,chunk__165279,count__165280,i__165281,v))
);
} else
{}
{
var G__165282 = seq__165278;
var G__165283 = chunk__165279;
var G__165284 = count__165280;
var G__165285 = (i__165281 + 1);
seq__165278 = G__165282;
chunk__165279 = G__165283;
count__165280 = G__165284;
i__165281 = G__165285;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__165278);if(temp__4094__auto__)
{var seq__165278__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__165278__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__165278__$1);{
var G__165286 = cljs.core.chunk_rest.call(null,seq__165278__$1);
var G__165287 = c__5421__auto__;
var G__165288 = cljs.core.count.call(null,c__5421__auto__);
var G__165289 = 0;
seq__165278 = G__165286;
chunk__165279 = G__165287;
count__165280 = G__165288;
i__165281 = G__165289;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__165278__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__165278,chunk__165279,count__165280,i__165281,v,seq__165278__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__165278,chunk__165279,count__165280,i__165281,v,seq__165278__$1,temp__4094__auto__))
);
} else
{}
{
var G__165290 = cljs.core.next.call(null,seq__165278__$1);
var G__165291 = null;
var G__165292 = 0;
var G__165293 = 0;
seq__165278 = G__165290;
chunk__165279 = G__165291;
count__165280 = G__165292;
i__165281 = G__165293;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_165295 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___165296 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___165296))
{var test_hook_165297 = temp__4092__auto___165296;test_hook_165297.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_165295;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__165298){
var namespaces = cljs.core.seq(arglist__165298);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__165299_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__165299_SHARP_));
