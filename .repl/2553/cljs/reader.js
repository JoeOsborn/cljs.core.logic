...
reader_error.cljs$lang$applyTo = (function (arglist__165221){
var rdr = cljs.core.first(arglist__165221);
var msg = cljs.core.rest(arglist__165221);
...
{{
var G__165222 = (function (){sb.append(ch);
return sb;
})();
var G__165223 = cljs.reader.read_char.call(null,rdr);
sb = G__165222;
ch = G__165223;
continue;
}
...
{{
var G__165226 = cljs.reader.read_char.call(null,rdr);
ch = G__165226;
continue;
}
} else
...
var G__165227 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__165227;
continue;
}
} else
...
var G__165228 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__165228;
continue;
}
}
...
{{
var G__165229 = (function (){buffer.append(ch);
return buffer;
})();
var G__165230 = cljs.reader.read_char.call(null,reader);
buffer = G__165229;
ch = G__165230;
continue;
}
...
{if(("\\" === ch))
{{
var G__165231 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__165232 = cljs.reader.read_char.call(null,reader);
buffer = G__165231;
ch = G__165232;
continue;
}
...
{{
var G__165233 = (function (){buffer.append(ch);
return buffer;
})();
var G__165234 = cljs.reader.read_char.call(null,reader);
buffer = G__165233;
ch = G__165234;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__165236 = o;if(G__165236)
{var bit__5323__auto__ = (G__165236.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__165236.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__165236.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__165236);
} else
{return false;
}
}
...
{{
var G__165237 = reader;
var G__165238 = eof_is_error;
var G__165239 = sentinel;
var G__165240 = is_recursive;
reader = G__165237;
eof_is_error = G__165238;
sentinel = G__165239;
is_recursive = G__165240;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__165241 = cljs.reader.read_comment.call(null,reader,ch);
var G__165242 = eof_is_error;
var G__165243 = sentinel;
var G__165244 = is_recursive;
reader = G__165241;
eof_is_error = G__165242;
sentinel = G__165243;
is_recursive = G__165244;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__165245 = reader;
var G__165246 = eof_is_error;
var G__165247 = sentinel;
var G__165248 = is_recursive;
reader = G__165245;
eof_is_error = G__165246;
sentinel = G__165247;
is_recursive = G__165248;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__165251 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__165251,0,null);var years = cljs.core.nth.call(null,vec__165251,1,null);var months = cljs.core.nth.call(null,vec__165251,2,null);var days = cljs.core.nth.call(null,vec__165251,3,null);var hours = cljs.core.nth.call(null,vec__165251,4,null);var minutes = cljs.core.nth.call(null,vec__165251,5,null);var seconds = cljs.core.nth.call(null,vec__165251,6,null);var fraction = cljs.core.nth.call(null,vec__165251,7,null);var offset_sign = cljs.core.nth.call(null,vec__165251,8,null);var offset_hours = cljs.core.nth.call(null,vec__165251,9,null);var offset_minutes = cljs.core.nth.call(null,vec__165251,10,null);var v = vec__165251;if(cljs.core.not.call(null,v))
...
{var vec__165253 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__165253,0,null);var months = cljs.core.nth.call(null,vec__165253,1,null);var days = cljs.core.nth.call(null,vec__165253,2,null);var hours = cljs.core.nth.call(null,vec__165253,3,null);var minutes = cljs.core.nth.call(null,vec__165253,4,null);var seconds = cljs.core.nth.call(null,vec__165253,5,null);var ms = cljs.core.nth.call(null,vec__165253,6,null);var offset = cljs.core.nth.call(null,vec__165253,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
