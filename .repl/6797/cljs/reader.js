...
reader_error.cljs$lang$applyTo = (function (arglist__127725){
var rdr = cljs.core.first(arglist__127725);
var msg = cljs.core.rest(arglist__127725);
...
{{
var G__127726 = (function (){sb.append(ch);
return sb;
})();
var G__127727 = cljs.reader.read_char.call(null,rdr);
sb = G__127726;
ch = G__127727;
continue;
}
...
{{
var G__127728 = cljs.reader.read_char.call(null,rdr);
ch = G__127728;
continue;
}
} else
...
var G__127729 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__127729;
continue;
}
} else
...
var G__127730 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__127730;
continue;
}
}
...
{{
var G__127731 = (function (){buffer.append(ch);
return buffer;
})();
var G__127732 = cljs.reader.read_char.call(null,reader);
buffer = G__127731;
ch = G__127732;
continue;
}
...
{if(("\\" === ch))
{{
var G__127733 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__127734 = cljs.reader.read_char.call(null,reader);
buffer = G__127733;
ch = G__127734;
continue;
}
...
{{
var G__127735 = (function (){buffer.append(ch);
return buffer;
})();
var G__127736 = cljs.reader.read_char.call(null,reader);
buffer = G__127735;
ch = G__127736;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__127738 = o;if(G__127738)
{var bit__5323__auto__ = (G__127738.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__127738.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__127738.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__127738);
} else
{return false;
}
}
...
{{
var G__127739 = reader;
var G__127740 = eof_is_error;
var G__127741 = sentinel;
var G__127742 = is_recursive;
reader = G__127739;
eof_is_error = G__127740;
sentinel = G__127741;
is_recursive = G__127742;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__127743 = cljs.reader.read_comment.call(null,reader,ch);
var G__127744 = eof_is_error;
var G__127745 = sentinel;
var G__127746 = is_recursive;
reader = G__127743;
eof_is_error = G__127744;
sentinel = G__127745;
is_recursive = G__127746;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__127747 = reader;
var G__127748 = eof_is_error;
var G__127749 = sentinel;
var G__127750 = is_recursive;
reader = G__127747;
eof_is_error = G__127748;
sentinel = G__127749;
is_recursive = G__127750;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__127753 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__127753,0,null);var years = cljs.core.nth.call(null,vec__127753,1,null);var months = cljs.core.nth.call(null,vec__127753,2,null);var days = cljs.core.nth.call(null,vec__127753,3,null);var hours = cljs.core.nth.call(null,vec__127753,4,null);var minutes = cljs.core.nth.call(null,vec__127753,5,null);var seconds = cljs.core.nth.call(null,vec__127753,6,null);var fraction = cljs.core.nth.call(null,vec__127753,7,null);var offset_sign = cljs.core.nth.call(null,vec__127753,8,null);var offset_hours = cljs.core.nth.call(null,vec__127753,9,null);var offset_minutes = cljs.core.nth.call(null,vec__127753,10,null);var v = vec__127753;if(cljs.core.not.call(null,v))
...
{var vec__127755 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__127755,0,null);var months = cljs.core.nth.call(null,vec__127755,1,null);var days = cljs.core.nth.call(null,vec__127755,2,null);var hours = cljs.core.nth.call(null,vec__127755,3,null);var minutes = cljs.core.nth.call(null,vec__127755,4,null);var seconds = cljs.core.nth.call(null,vec__127755,5,null);var ms = cljs.core.nth.call(null,vec__127755,6,null);var offset = cljs.core.nth.call(null,vec__127755,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
