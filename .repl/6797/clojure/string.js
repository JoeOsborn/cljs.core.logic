...
{{
var G__127429 = cljs.core.pop.call(null,v__$1);
v__$1 = G__127429;
continue;
}
} else
...
{var pred__127433 = cljs.core._EQ_;var expr__127434 = limit;if(pred__127433.call(null,1,expr__127434))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__127433.call(null,2,expr__127434))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__127436 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__127437 = (limit__$1 - 1);
var G__127438 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__127436;
limit__$1 = G__127437;
parts = G__127438;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___127440 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___127440))
{var replacement_127441 = temp__4092__auto___127440;buffer.append([cljs.core.str(replacement_127441)].join(''));
} else
{buffer.append(ch);
}
{
var G__127442 = (index + 1);
index = G__127442;
continue;
}
}
