...
{{
var G__20330 = cljs.core.pop.call(null,v__$1);
v__$1 = G__20330;
continue;
}
} else
...
{var pred__20334 = cljs.core._EQ_;var expr__20335 = limit;if(pred__20334.call(null,1,expr__20335))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__20334.call(null,2,expr__20335))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__20337 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__20338 = (limit__$1 - 1);
var G__20339 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__20337;
limit__$1 = G__20338;
parts = G__20339;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___20341 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___20341))
{var replacement_20342 = temp__4092__auto___20341;buffer.append([cljs.core.str(replacement_20342)].join(''));
} else
{buffer.append(ch);
}
{
