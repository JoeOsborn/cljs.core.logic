...
{{
var G__23196 = cljs.core.pop.call(null,v__$1);
v__$1 = G__23196;
continue;
}
} else
...
{var pred__23200 = cljs.core._EQ_;var expr__23201 = limit;if(pred__23200.call(null,1,expr__23201))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__23200.call(null,2,expr__23201))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__23203 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__23204 = (limit__$1 - 1);
var G__23205 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__23203;
limit__$1 = G__23204;
parts = G__23205;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___23207 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___23207))
{var replacement_23208 = temp__4092__auto___23207;buffer.append([cljs.core.str(replacement_23208)].join(''));
} else
{buffer.append(ch);
}
{
var G__23209 = (index + 1);
index = G__23209;
continue;
}
}
