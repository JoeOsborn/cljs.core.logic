...
{{
var G__92235 = cljs.core.pop.call(null,v__$1);
v__$1 = G__92235;
continue;
}
} else
...
{var pred__92239 = cljs.core._EQ_;var expr__92240 = limit;if(pred__92239.call(null,1,expr__92240))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__92239.call(null,2,expr__92240))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__92242 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__92243 = (limit__$1 - 1);
var G__92244 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__92242;
limit__$1 = G__92243;
parts = G__92244;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___92246 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___92246))
{var replacement_92247 = temp__4092__auto___92246;buffer.append([cljs.core.str(replacement_92247)].join(''));
} else
{buffer.append(ch);
}
{
var G__92248 = (index + 1);
index = G__92248;
continue;
}
}
