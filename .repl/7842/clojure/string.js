...
{{
var G__30742 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30742;
continue;
}
} else
...
{var pred__30746 = cljs.core._EQ_;var expr__30747 = limit;if(pred__30746.call(null,1,expr__30747))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__30746.call(null,2,expr__30747))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__30749 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30750 = (limit__$1 - 1);
var G__30751 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__30749;
limit__$1 = G__30750;
parts = G__30751;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___30753 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___30753))
{var replacement_30754 = temp__4092__auto___30753;buffer.append([cljs.core.str(replacement_30754)].join(''));
} else
{buffer.append(ch);
}
{
