...
{{
var G__110400 = cljs.core.pop.call(null,v__$1);
v__$1 = G__110400;
continue;
}
} else
...
{var pred__110404 = cljs.core._EQ_;var expr__110405 = limit;if(pred__110404.call(null,1,expr__110405))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__110404.call(null,2,expr__110405))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__110407 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__110408 = (limit__$1 - 1);
var G__110409 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__110407;
limit__$1 = G__110408;
parts = G__110409;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___110411 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___110411))
{var replacement_110412 = temp__4092__auto___110411;buffer.append([cljs.core.str(replacement_110412)].join(''));
} else
{buffer.append(ch);
}
{
var G__110413 = (index + 1);
index = G__110413;
continue;
}
}
