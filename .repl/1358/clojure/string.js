...
{{
var G__105369 = cljs.core.pop.call(null,v__$1);
v__$1 = G__105369;
continue;
}
} else
...
{var pred__105373 = cljs.core._EQ_;var expr__105374 = limit;if(cljs.core.truth_(pred__105373.call(null,1,expr__105374)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__105373.call(null,2,expr__105374)))
...
var G__105376 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__105377 = (limit__$1 - 1);
var G__105378 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__105376;
limit__$1 = G__105377;
parts = G__105378;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___105380 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___105380))
{var replacement_105381 = temp__4096__auto___105380;buffer.append([cljs.core.str(replacement_105381)].join(''));
} else
{buffer.append(ch);
}
{
var G__105382 = (index + 1);
index = G__105382;
continue;
}
}
