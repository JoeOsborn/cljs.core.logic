...
{{
var G__87716 = cljs.core.pop.call(null,v__$1);
v__$1 = G__87716;
continue;
}
} else
...
{var pred__87720 = cljs.core._EQ_;var expr__87721 = limit;if(pred__87720.call(null,1,expr__87721))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__87720.call(null,2,expr__87721))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__87723 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__87724 = (limit__$1 - 1);
var G__87725 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__87723;
limit__$1 = G__87724;
parts = G__87725;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___87727 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___87727))
{var replacement_87728 = temp__4092__auto___87727;buffer.append([cljs.core.str(replacement_87728)].join(''));
} else
{buffer.append(ch);
}
{
var G__87729 = (index + 1);
index = G__87729;
continue;
}
}
