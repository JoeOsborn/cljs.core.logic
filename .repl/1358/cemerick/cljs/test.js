...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__87731 = m;var map__87731__$1 = ((cljs.core.seq_QMARK_.call(null,map__87731))?cljs.core.apply.call(null,cljs.core.hash_map,map__87731):map__87731);var line = cljs.core.get.call(null,map__87731__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__87731__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__87733 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__87733))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__87733))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_87734;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_87735 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_87735;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_87736 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___87737 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___87737))
{var message_87738 = temp__4094__auto___87737;cljs.core.println.call(null,message_87738);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_87736;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_87739 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___87740 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___87740))
{var message_87741 = temp__4094__auto___87740;cljs.core.println.call(null,message_87741);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_87742;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_87743 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_87743;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__87744){
var ns_sym = cljs.core.first(arglist__87744);
arglist__87744 = cljs.core.next(arglist__87744);
var fixture_type = cljs.core.first(arglist__87744);
var fixture_fns = cljs.core.rest(arglist__87744);
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_87747;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__87754 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__87755 = null;var count__87756 = 0;var i__87757 = 0;while(true){
if((i__87757 < count__87756))
{var v = cljs.core._nth.call(null,chunk__87755,i__87757);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__87754,chunk__87755,count__87756,i__87757,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__87754,chunk__87755,count__87756,i__87757,v))
);
} else
{}
{
var G__87758 = seq__87754;
var G__87759 = chunk__87755;
var G__87760 = count__87756;
var G__87761 = (i__87757 + 1);
seq__87754 = G__87758;
chunk__87755 = G__87759;
count__87756 = G__87760;
i__87757 = G__87761;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__87754);if(temp__4094__auto__)
{var seq__87754__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__87754__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__87754__$1);{
var G__87762 = cljs.core.chunk_rest.call(null,seq__87754__$1);
var G__87763 = c__5421__auto__;
var G__87764 = cljs.core.count.call(null,c__5421__auto__);
var G__87765 = 0;
seq__87754 = G__87762;
chunk__87755 = G__87763;
count__87756 = G__87764;
i__87757 = G__87765;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__87754__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__87754,chunk__87755,count__87756,i__87757,v,seq__87754__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__87754,chunk__87755,count__87756,i__87757,v,seq__87754__$1,temp__4094__auto__))
);
} else
{}
{
var G__87766 = cljs.core.next.call(null,seq__87754__$1);
var G__87767 = null;
var G__87768 = 0;
var G__87769 = 0;
seq__87754 = G__87766;
chunk__87755 = G__87767;
count__87756 = G__87768;
i__87757 = G__87769;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_87771 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___87772 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___87772))
{var test_hook_87773 = temp__4092__auto___87772;test_hook_87773.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_87771;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__87774){
var namespaces = cljs.core.seq(arglist__87774);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__87775_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__87775_SHARP_));
