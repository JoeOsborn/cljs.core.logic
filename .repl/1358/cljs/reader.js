...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj105337 = {};return obj105337;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__5123__auto__ = reader;if(and__5123__auto__)
...
{var x__5738__auto__ = (((reader == null))?null:reader);return (function (){var or__5135__auto__ = (cljs.reader.read_char[goog.typeOf(x__5738__auto__)]);if(or__5135__auto__)
{return or__5135__auto__;
} else
{var or__5135__auto____$1 = (cljs.reader.read_char["_"]);if(or__5135__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__5123__auto__ = reader;if(and__5123__auto__)
...
{var x__5738__auto__ = (((reader == null))?null:reader);return (function (){var or__5135__auto__ = (cljs.reader.unread[goog.typeOf(x__5738__auto__)]);if(or__5135__auto__)
{return or__5135__auto__;
} else
{var or__5135__auto____$1 = (cljs.reader.unread["_"]);if(or__5135__auto____$1)
{return or__5135__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__5679__auto__,writer__5680__auto__,opt__5681__auto__){return cljs.core._write.call(null,writer__5680__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__5135__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__105338){
var rdr = cljs.core.first(arglist__105338);
var msg = cljs.core.rest(arglist__105338);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__5123__auto__ = !((ch === "#"));if(and__5123__auto__)
{var and__5123__auto____$1 = !((ch === "'"));if(and__5123__auto____$1)
{var and__5123__auto____$2 = !((ch === ":"));if(and__5123__auto____$2)
...
{{
var G__105339 = (function (){sb.append(ch);
return sb;
})();
var G__105340 = cljs.reader.read_char.call(null,rdr);
sb = G__105339;
ch = G__105340;
continue;
}
...
{{
var G__105341 = cljs.reader.read_char.call(null,rdr);
ch = G__105341;
continue;
}
} else
...
var G__105342 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__105342;
continue;
}
} else
...
var G__105343 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__105343;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__5135__auto__ = (ch == null);if(or__5135__auto__)
{return or__5135__auto__;
} else
{var or__5135__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__5135__auto____$1)
{return or__5135__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__5135__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
...
{{
var G__105344 = (function (){buffer.append(ch);
return buffer;
})();
var G__105345 = cljs.reader.read_char.call(null,reader);
buffer = G__105344;
ch = G__105345;
continue;
}
...
{if(("\\" === ch))
{{
var G__105346 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__105347 = cljs.reader.read_char.call(null,reader);
buffer = G__105346;
ch = G__105347;
continue;
}
...
{{
var G__105348 = (function (){buffer.append(ch);
return buffer;
})();
var G__105349 = cljs.reader.read_char.call(null,reader);
buffer = G__105348;
ch = G__105349;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__105351 = o;if(G__105351)
{var bit__5761__auto__ = (G__105351.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5761__auto__) || (G__105351.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__105351.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__105351);
} else
{return false;
}
}
...
{{
var G__105352 = reader;
var G__105353 = eof_is_error;
var G__105354 = sentinel;
var G__105355 = is_recursive;
reader = G__105352;
eof_is_error = G__105353;
sentinel = G__105354;
is_recursive = G__105355;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__105356 = cljs.reader.read_comment.call(null,reader,ch);
var G__105357 = eof_is_error;
var G__105358 = sentinel;
var G__105359 = is_recursive;
reader = G__105356;
eof_is_error = G__105357;
sentinel = G__105358;
is_recursive = G__105359;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__105360 = reader;
var G__105361 = eof_is_error;
var G__105362 = sentinel;
var G__105363 = is_recursive;
reader = G__105360;
eof_is_error = G__105361;
sentinel = G__105362;
is_recursive = G__105363;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__105366 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__105366,0,null);var years = cljs.core.nth.call(null,vec__105366,1,null);var months = cljs.core.nth.call(null,vec__105366,2,null);var days = cljs.core.nth.call(null,vec__105366,3,null);var hours = cljs.core.nth.call(null,vec__105366,4,null);var minutes = cljs.core.nth.call(null,vec__105366,5,null);var seconds = cljs.core.nth.call(null,vec__105366,6,null);var fraction = cljs.core.nth.call(null,vec__105366,7,null);var offset_sign = cljs.core.nth.call(null,vec__105366,8,null);var offset_hours = cljs.core.nth.call(null,vec__105366,9,null);var offset_minutes = cljs.core.nth.call(null,vec__105366,10,null);var v = vec__105366;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__5135__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__5135__auto__))
{return or__5135__auto__;
} else
{return 0;
}
...
{var vec__105368 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__105368,0,null);var months = cljs.core.nth.call(null,vec__105368,1,null);var days = cljs.core.nth.call(null,vec__105368,2,null);var hours = cljs.core.nth.call(null,vec__105368,3,null);var minutes = cljs.core.nth.call(null,vec__105368,4,null);var seconds = cljs.core.nth.call(null,vec__105368,5,null);var ms = cljs.core.nth.call(null,vec__105368,6,null);var offset = cljs.core.nth.call(null,vec__105368,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
