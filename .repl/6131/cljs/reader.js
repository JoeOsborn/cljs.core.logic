...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj26995 = {};return obj26995;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__26996){
var rdr = cljs.core.first(arglist__26996);
var msg = cljs.core.rest(arglist__26996);
...
{{
var G__26997 = (function (){sb.append(ch);
return sb;
})();
var G__26998 = cljs.reader.read_char.call(null,rdr);
sb = G__26997;
ch = G__26998;
continue;
}
...
{{
var G__26999 = cljs.reader.read_char.call(null,rdr);
ch = G__26999;
continue;
}
} else
...
var G__27000 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__27000;
continue;
}
} else
...
var G__27001 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__27001;
continue;
}
}
...
{{
var G__27002 = (function (){buffer.append(ch);
return buffer;
})();
...
{if(("\\" === ch))
{{
var G__27004 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__27005 = cljs.reader.read_char.call(null,reader);
buffer = G__27004;
ch = G__27005;
continue;
}
...
{{
var G__27006 = (function (){buffer.append(ch);
return buffer;
})();
var G__27007 = cljs.reader.read_char.call(null,reader);
buffer = G__27006;
ch = G__27007;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__27009 = o;if(G__27009)
{var bit__7442__auto__ = (G__27009.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__7442__auto__) || (G__27009.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__27009.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__27009);
} else
{return false;
}
}
...
{{
var G__27010 = reader;
var G__27011 = eof_is_error;
var G__27012 = sentinel;
var G__27013 = is_recursive;
reader = G__27010;
eof_is_error = G__27011;
sentinel = G__27012;
is_recursive = G__27013;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__27014 = cljs.reader.read_comment.call(null,reader,ch);
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__27024 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__27024,0,null);var years = cljs.core.nth.call(null,vec__27024,1,null);var months = cljs.core.nth.call(null,vec__27024,2,null);var days = cljs.core.nth.call(null,vec__27024,3,null);var hours = cljs.core.nth.call(null,vec__27024,4,null);var minutes = cljs.core.nth.call(null,vec__27024,5,null);var seconds = cljs.core.nth.call(null,vec__27024,6,null);var fraction = cljs.core.nth.call(null,vec__27024,7,null);var offset_sign = cljs.core.nth.call(null,vec__27024,8,null);var offset_hours = cljs.core.nth.call(null,vec__27024,9,null);var offset_minutes = cljs.core.nth.call(null,vec__27024,10,null);var v = vec__27024;if(cljs.core.not.call(null,v))
...
{var vec__27026 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__27026,0,null);var months = cljs.core.nth.call(null,vec__27026,1,null);var days = cljs.core.nth.call(null,vec__27026,2,null);var hours = cljs.core.nth.call(null,vec__27026,3,null);var minutes = cljs.core.nth.call(null,vec__27026,4,null);var seconds = cljs.core.nth.call(null,vec__27026,5,null);var ms = cljs.core.nth.call(null,vec__27026,6,null);var offset = cljs.core.nth.call(null,vec__27026,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
