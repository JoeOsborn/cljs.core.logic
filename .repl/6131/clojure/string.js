...
{{
var G__26401 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26401;
continue;
}
} else
...
{var pred__26405 = cljs.core._EQ_;var expr__26406 = limit;if(cljs.core.truth_(pred__26405.call(null,1,expr__26406)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26405.call(null,2,expr__26406)))
...
var G__26408 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26409 = (limit__$1 - 1);
var G__26410 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26408;
limit__$1 = G__26409;
parts = G__26410;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___26412 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___26412))
{var replacement_26413 = temp__4096__auto___26412;buffer.append([cljs.core.str(replacement_26413)].join(''));
} else
{buffer.append(ch);
}
{
var G__26414 = (index + 1);
index = G__26414;
continue;
}
}
