...
{{
var G__207720 = cljs.core.pop.call(null,v__$1);
v__$1 = G__207720;
continue;
}
} else
...
{var pred__207724 = cljs.core._EQ_;var expr__207725 = limit;if(cljs.core.truth_(pred__207724.call(null,1,expr__207725)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__207724.call(null,2,expr__207725)))
...
var G__207727 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__207728 = (limit__$1 - 1);
var G__207729 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__207727;
limit__$1 = G__207728;
parts = G__207729;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___207731 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___207731))
{var replacement_207732 = temp__4096__auto___207731;buffer.append([cljs.core.str(replacement_207732)].join(''));
} else
{buffer.append(ch);
}
{
var G__207733 = (index + 1);
index = G__207733;
continue;
}
}
