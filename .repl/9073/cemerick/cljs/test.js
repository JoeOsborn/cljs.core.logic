...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__39843 = m;var map__39843__$1 = ((cljs.core.seq_QMARK_.call(null,map__39843))?cljs.core.apply.call(null,cljs.core.hash_map,map__39843):map__39843);var line = cljs.core.get.call(null,map__39843__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__39843__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__39845 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__39845))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__39845))
...
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"default","default",2558708147),(function (m){var _STAR_print_fn_STAR_39846 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__11188__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__11188__auto__))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_39846;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_39847 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__11188__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__11188__auto__))
{return or__11188__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_39847;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_39848 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__11188__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__11188__auto__))
{return or__11188__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___39849 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___39849))
{var message_39850 = temp__4098__auto___39849;cljs.core.println.call(null,message_39850);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_39848;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_39851 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__11188__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__11188__auto__))
{return or__11188__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___39852 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___39852))
{var message_39853 = temp__4098__auto___39852;cljs.core.println.call(null,message_39853);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_39854;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_39855 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__11188__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__11188__auto__))
{return or__11188__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_39855;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__39856){
var ns_sym = cljs.core.first(arglist__39856);
arglist__39856 = cljs.core.next(arglist__39856);
var fixture_type = cljs.core.first(arglist__39856);
var fixture_fns = cljs.core.rest(arglist__39856);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_39859 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__11188__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__11188__auto__))
{return or__11188__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e39860){if((e39860 instanceof Error))
{var e_39861 = e39860;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_39861], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e39860;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_39859;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__39866 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__39867 = null;var count__39868 = 0;var i__39869 = 0;while(true){
if((i__39869 < count__39868))
{var v = cljs.core._nth.call(null,chunk__39867,i__39869);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__39866,chunk__39867,count__39868,i__39869,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__39866,chunk__39867,count__39868,i__39869,v))
);
} else
{}
{
var G__39870 = seq__39866;
var G__39871 = chunk__39867;
var G__39872 = count__39868;
var G__39873 = (i__39869 + 1);
seq__39866 = G__39870;
chunk__39867 = G__39871;
count__39868 = G__39872;
i__39869 = G__39873;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__39866);if(temp__4098__auto__)
{var seq__39866__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__39866__$1))
{var c__11912__auto__ = cljs.core.chunk_first.call(null,seq__39866__$1);{
var G__39874 = cljs.core.chunk_rest.call(null,seq__39866__$1);
var G__39875 = c__11912__auto__;
var G__39876 = cljs.core.count.call(null,c__11912__auto__);
var G__39877 = 0;
seq__39866 = G__39874;
chunk__39867 = G__39875;
count__39868 = G__39876;
i__39869 = G__39877;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__39866__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__39866,chunk__39867,count__39868,i__39869,v,seq__39866__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__39866,chunk__39867,count__39868,i__39869,v,seq__39866__$1,temp__4098__auto__))
);
} else
{}
{
var G__39878 = cljs.core.next.call(null,seq__39866__$1);
var G__39879 = null;
var G__39880 = 0;
var G__39881 = 0;
seq__39866 = G__39878;
chunk__39867 = G__39879;
count__39868 = G__39880;
i__39869 = G__39881;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_39883 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___39884 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___39884))
{var test_hook_39885 = temp__4096__auto___39884;test_hook_39885.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_39883;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__39886){
var namespaces = cljs.core.seq(arglist__39886);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__39887_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__39887_SHARP_));
