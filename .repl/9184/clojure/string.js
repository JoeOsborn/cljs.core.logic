...
{{
var G__37845 = cljs.core.pop.call(null,v__$1);
v__$1 = G__37845;
continue;
}
} else
...
{var pred__37849 = cljs.core._EQ_;var expr__37850 = limit;if(pred__37849.call(null,1,expr__37850))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__37849.call(null,2,expr__37850))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__37852 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__37853 = (limit__$1 - 1);
var G__37854 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__37852;
limit__$1 = G__37853;
parts = G__37854;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___37856 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___37856))
{var replacement_37857 = temp__4092__auto___37856;buffer.append([cljs.core.str(replacement_37857)].join(''));
} else
{buffer.append(ch);
}
{
var G__37858 = (index + 1);
index = G__37858;
continue;
}
}
