...
{var vec__24108 = expr__$1;var f = cljs.core.nth.call(null,vec__24108,0,null);var n = cljs.core.nthnext.call(null,vec__24108,1);var skip = cljs.core._EQ_.call(null,f,new cljs.core.Symbol(null,".",".",-1640531481,null));var tail = prep_STAR_.call(null,n,store,lcons_QMARK_,skip);if(skip)
{return tail;
} else
...
{return cljs.core.logic.unifier.queue.call(null,s,cljs.core.logic.unifier._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__24109_SHARP_){return cljs.core.logic.lvar.call(null,p1__24109_SHARP_,false);
}),vs))));
} else
...
{return cljs.core.logic.unifier.queue.call(null,s,cljs.core.logic.unifier._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__24110_SHARP_){return cljs.core.logic.lvar.call(null,p1__24110_SHARP_,false);
...
cljs.core.logic.unifier.queue_constraints = (function queue_constraints(s,p__24111){var vec__24113 = p__24111;var vs = cljs.core.nth.call(null,vec__24113,0,null);var cs = cljs.core.nth.call(null,vec__24113,1,null);var cs__$1 = ((!(cljs.core.sequential_QMARK_.call(null,cs)))?cljs.core.PersistentVector.fromArray([cs], true):cs);return cljs.core.reduce.call(null,(function (s__$1,c){return cljs.core.logic.unifier.queue_constraint.call(null,s__$1,c,vs);
}),s,cs__$1);
});
cljs.core.logic.unifier._unify_STAR_ = (function _unify_STAR_(init_s,u,w){return cljs.core.first.call(null,cljs.core.logic.unifier.take_STAR_.call(null,(function (){return (function (a__20439__auto__){return (function _inc(){var q = cljs.core.logic.lvar.call(null,new cljs.core.Symbol(null,"q","q",-1640531414,null));return cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,cljs.core.logic.protocols.bind.call(null,a__20439__auto__,cljs.core.logic.unifier._EQ__EQ_.call(null,u,w)),cljs.core.logic.unifier._EQ__EQ_.call(null,q,u)),(function (a){return cljs.core.logic.unifier.fix_constraints.call(null,a);
})),cljs.core.logic.unifier.reifyg.call(null,q));
});
}).call(null,init_s);
})));
});
cljs.core.logic.unifier.init_s = (function init_s(opts,s){var s__$1 = cljs.core.reduce.call(null,(function (s__$1,p__24116){var vec__24117 = p__24116;var k = cljs.core.nth.call(null,vec__24117,0,null);var v = cljs.core.nth.call(null,vec__24117,1,null);return cljs.core.logic.unifier._EQ__EQ_.call(null,k,v).call(null,s__$1);
...
var unify_STAR___2 = (function (opts,ts){var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.unifier.empty_s);return cljs.core.logic.unifier._unify_STAR_.call(null,cljs.core.vary_meta.call(null,init_s,cljs.core.assoc,new cljs.core.Keyword(null,"reify-vars","reify-vars",4368745730),false),cljs.core.reduce.call(null,(function (p1__24118_SHARP_,p2__24119_SHARP_){return cljs.core.logic.unifier._unify_STAR_.call(null,init_s,p1__24118_SHARP_,p2__24119_SHARP_);
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__24134){var vec__24135 = p__24134;var sym = cljs.core.nth.call(null,vec__24135,0,null);var var$ = cljs.core.nth.call(null,vec__24135,1,null);return cljs.core.PersistentVector.fromArray([sym,cljs.core.logic.unifier._reify.call(null,s__$1,var$)], true);
}),cljs.core.filter.call(null,(function (p__24136){var vec__24137 = p__24136;var sym = cljs.core.nth.call(null,vec__24137,0,null);var var$ = cljs.core.nth.call(null,vec__24137,1,null);return cljs.core.not_EQ_.call(null,cljs.core.logic.unifier.walk.call(null,s__$1,var$),var$);
...
var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.unifier.empty_s);return cljs.core.reduce.call(null,(function (p1__24120_SHARP_,p2__24121_SHARP_){return _unifier_STAR_.call(null,init_s,p1__24120_SHARP_,p2__24121_SHARP_);
}),ts);
});
...
var unify__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__24140){var vec__24141 = p__24140;var k = cljs.core.nth.call(null,vec__24141,0,null);var v = cljs.core.nth.call(null,vec__24141,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], true);
...
var unifier__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__24145){var vec__24146 = p__24145;var k = cljs.core.nth.call(null,vec__24146,0,null);var v = cljs.core.nth.call(null,vec__24146,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], true);
...
return (function (p1__24142_SHARP_){return new cljs.core.Keyword("cljs.core.logic.unifier","lvars","cljs.core.logic.unifier/lvars",1819622758).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__24142_SHARP_));
