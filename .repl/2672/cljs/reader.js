...
reader_error.cljs$lang$applyTo = (function (arglist__24004){
var rdr = cljs.core.first(arglist__24004);
var msg = cljs.core.rest(arglist__24004);
...
{{
var G__24005 = (function (){sb.append(ch);
return sb;
})();
var G__24006 = cljs.reader.read_char.call(null,rdr);
sb = G__24005;
ch = G__24006;
continue;
}
...
{{
var G__24007 = cljs.reader.read_char.call(null,rdr);
ch = G__24007;
continue;
}
} else
...
var G__24008 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__24008;
continue;
}
} else
...
var G__24009 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__24009;
continue;
}
}
...
{{
var G__24010 = (function (){buffer.append(ch);
return buffer;
})();
var G__24011 = cljs.reader.read_char.call(null,reader);
buffer = G__24010;
ch = G__24011;
continue;
}
...
{if(("\\" === ch))
{{
var G__24012 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__24013 = cljs.reader.read_char.call(null,reader);
buffer = G__24012;
ch = G__24013;
continue;
}
...
{{
var G__24014 = (function (){buffer.append(ch);
return buffer;
})();
var G__24015 = cljs.reader.read_char.call(null,reader);
buffer = G__24014;
ch = G__24015;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__24017 = o;if(G__24017)
{var bit__5323__auto__ = (G__24017.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__24017.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__24017.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__24017);
} else
{return false;
}
}
...
{{
var G__24018 = reader;
var G__24019 = eof_is_error;
var G__24020 = sentinel;
var G__24021 = is_recursive;
reader = G__24018;
eof_is_error = G__24019;
sentinel = G__24020;
is_recursive = G__24021;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__24022 = cljs.reader.read_comment.call(null,reader,ch);
var G__24023 = eof_is_error;
var G__24024 = sentinel;
var G__24025 = is_recursive;
reader = G__24022;
eof_is_error = G__24023;
sentinel = G__24024;
is_recursive = G__24025;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__24026 = reader;
var G__24027 = eof_is_error;
var G__24028 = sentinel;
var G__24029 = is_recursive;
reader = G__24026;
eof_is_error = G__24027;
sentinel = G__24028;
is_recursive = G__24029;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__24032 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__24032,0,null);var years = cljs.core.nth.call(null,vec__24032,1,null);var months = cljs.core.nth.call(null,vec__24032,2,null);var days = cljs.core.nth.call(null,vec__24032,3,null);var hours = cljs.core.nth.call(null,vec__24032,4,null);var minutes = cljs.core.nth.call(null,vec__24032,5,null);var seconds = cljs.core.nth.call(null,vec__24032,6,null);var fraction = cljs.core.nth.call(null,vec__24032,7,null);var offset_sign = cljs.core.nth.call(null,vec__24032,8,null);var offset_hours = cljs.core.nth.call(null,vec__24032,9,null);var offset_minutes = cljs.core.nth.call(null,vec__24032,10,null);var v = vec__24032;if(cljs.core.not.call(null,v))
...
{var vec__24034 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__24034,0,null);var months = cljs.core.nth.call(null,vec__24034,1,null);var days = cljs.core.nth.call(null,vec__24034,2,null);var hours = cljs.core.nth.call(null,vec__24034,3,null);var minutes = cljs.core.nth.call(null,vec__24034,4,null);var seconds = cljs.core.nth.call(null,vec__24034,5,null);var ms = cljs.core.nth.call(null,vec__24034,6,null);var offset = cljs.core.nth.call(null,vec__24034,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
