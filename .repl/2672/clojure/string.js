...
{{
var G__24035 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24035;
continue;
}
} else
...
{var pred__24039 = cljs.core._EQ_;var expr__24040 = limit;if(pred__24039.call(null,1,expr__24040))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__24039.call(null,2,expr__24040))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__24042 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24043 = (limit__$1 - 1);
var G__24044 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24042;
limit__$1 = G__24043;
parts = G__24044;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___24046 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___24046))
{var replacement_24047 = temp__4092__auto___24046;buffer.append([cljs.core.str(replacement_24047)].join(''));
} else
{buffer.append(ch);
}
{
var G__24048 = (index + 1);
index = G__24048;
continue;
}
}
