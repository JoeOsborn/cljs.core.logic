...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__24062 = m;var map__24062__$1 = ((cljs.core.seq_QMARK_.call(null,map__24062))?cljs.core.apply.call(null,cljs.core.hash_map,map__24062):map__24062);var line = cljs.core.get.call(null,map__24062__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__24062__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__24064 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__24064))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__24064))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24065;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_24066 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24066;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_24067 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___24068 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___24068))
{var message_24069 = temp__4094__auto___24068;cljs.core.println.call(null,message_24069);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24067;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_24070 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___24071 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___24071))
{var message_24072 = temp__4094__auto___24071;cljs.core.println.call(null,message_24072);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24073;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_24074 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_24074;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__24075){
var ns_sym = cljs.core.first(arglist__24075);
arglist__24075 = cljs.core.next(arglist__24075);
var fixture_type = cljs.core.first(arglist__24075);
var fixture_fns = cljs.core.rest(arglist__24075);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_24078 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__4704__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return v;
}
...
{var e_24080 = e24079;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_24080], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e24079;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_24078;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__24085 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__24086 = null;var count__24087 = 0;var i__24088 = 0;while(true){
if((i__24088 < count__24087))
{var v = cljs.core._nth.call(null,chunk__24086,i__24088);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__24085,chunk__24086,count__24087,i__24088,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__24085,chunk__24086,count__24087,i__24088,v))
);
} else
{}
{
var G__24089 = seq__24085;
var G__24090 = chunk__24086;
var G__24091 = count__24087;
var G__24092 = (i__24088 + 1);
seq__24085 = G__24089;
chunk__24086 = G__24090;
count__24087 = G__24091;
i__24088 = G__24092;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__24085);if(temp__4094__auto__)
{var seq__24085__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__24085__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__24085__$1);{
var G__24093 = cljs.core.chunk_rest.call(null,seq__24085__$1);
var G__24094 = c__5421__auto__;
var G__24095 = cljs.core.count.call(null,c__5421__auto__);
var G__24096 = 0;
seq__24085 = G__24093;
chunk__24086 = G__24094;
count__24087 = G__24095;
i__24088 = G__24096;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__24085__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__24085,chunk__24086,count__24087,i__24088,v,seq__24085__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__24085,chunk__24086,count__24087,i__24088,v,seq__24085__$1,temp__4094__auto__))
);
} else
{}
{
var G__24097 = cljs.core.next.call(null,seq__24085__$1);
var G__24098 = null;
var G__24099 = 0;
var G__24100 = 0;
seq__24085 = G__24097;
chunk__24086 = G__24098;
count__24087 = G__24099;
i__24088 = G__24100;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_24102 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___24103 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___24103))
{var test_hook_24104 = temp__4092__auto___24103;test_hook_24104.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_24102;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__24105){
var namespaces = cljs.core.seq(arglist__24105);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__24106_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__24106_SHARP_));
