...
reader_error.cljs$lang$applyTo = (function (arglist__270627){
var rdr = cljs.core.first(arglist__270627);
var msg = cljs.core.rest(arglist__270627);
...
{{
var G__270628 = (function (){sb.append(ch);
return sb;
})();
var G__270629 = cljs.reader.read_char.call(null,rdr);
sb = G__270628;
ch = G__270629;
continue;
}
...
{{
var G__270630 = cljs.reader.read_char.call(null,rdr);
ch = G__270630;
continue;
}
} else
...
var G__270631 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__270631;
continue;
}
} else
...
var G__270632 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__270632;
continue;
}
}
...
{{
var G__270633 = (function (){buffer.append(ch);
return buffer;
})();
var G__270634 = cljs.reader.read_char.call(null,reader);
buffer = G__270633;
ch = G__270634;
continue;
}
...
{if(("\\" === ch))
{{
var G__270635 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__270636 = cljs.reader.read_char.call(null,reader);
buffer = G__270635;
ch = G__270636;
continue;
}
...
{{
var G__270637 = (function (){buffer.append(ch);
return buffer;
})();
var G__270638 = cljs.reader.read_char.call(null,reader);
buffer = G__270637;
ch = G__270638;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__270640 = o;if(G__270640)
{var bit__5323__auto__ = (G__270640.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__270640.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__270640.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__270640);
} else
{return false;
}
}
...
{{
var G__270641 = reader;
var G__270642 = eof_is_error;
var G__270643 = sentinel;
var G__270644 = is_recursive;
reader = G__270641;
eof_is_error = G__270642;
sentinel = G__270643;
is_recursive = G__270644;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__270645 = cljs.reader.read_comment.call(null,reader,ch);
var G__270646 = eof_is_error;
var G__270647 = sentinel;
var G__270648 = is_recursive;
reader = G__270645;
eof_is_error = G__270646;
sentinel = G__270647;
is_recursive = G__270648;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__270649 = reader;
var G__270650 = eof_is_error;
var G__270651 = sentinel;
var G__270652 = is_recursive;
reader = G__270649;
eof_is_error = G__270650;
sentinel = G__270651;
is_recursive = G__270652;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__270655 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__270655,0,null);var years = cljs.core.nth.call(null,vec__270655,1,null);var months = cljs.core.nth.call(null,vec__270655,2,null);var days = cljs.core.nth.call(null,vec__270655,3,null);var hours = cljs.core.nth.call(null,vec__270655,4,null);var minutes = cljs.core.nth.call(null,vec__270655,5,null);var seconds = cljs.core.nth.call(null,vec__270655,6,null);var fraction = cljs.core.nth.call(null,vec__270655,7,null);var offset_sign = cljs.core.nth.call(null,vec__270655,8,null);var offset_hours = cljs.core.nth.call(null,vec__270655,9,null);var offset_minutes = cljs.core.nth.call(null,vec__270655,10,null);var v = vec__270655;if(cljs.core.not.call(null,v))
...
{var vec__270657 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__270657,0,null);var months = cljs.core.nth.call(null,vec__270657,1,null);var days = cljs.core.nth.call(null,vec__270657,2,null);var hours = cljs.core.nth.call(null,vec__270657,3,null);var minutes = cljs.core.nth.call(null,vec__270657,4,null);var seconds = cljs.core.nth.call(null,vec__270657,5,null);var ms = cljs.core.nth.call(null,vec__270657,6,null);var offset = cljs.core.nth.call(null,vec__270657,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
