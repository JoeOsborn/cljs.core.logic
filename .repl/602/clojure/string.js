...
{{
var G__270331 = cljs.core.pop.call(null,v__$1);
v__$1 = G__270331;
continue;
}
} else
...
{var pred__270335 = cljs.core._EQ_;var expr__270336 = limit;if(pred__270335.call(null,1,expr__270336))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__270335.call(null,2,expr__270336))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__270338 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__270339 = (limit__$1 - 1);
var G__270340 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__270338;
limit__$1 = G__270339;
parts = G__270340;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___270342 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___270342))
{var replacement_270343 = temp__4092__auto___270342;buffer.append([cljs.core.str(replacement_270343)].join(''));
} else
{buffer.append(ch);
}
{
var G__270344 = (index + 1);
index = G__270344;
continue;
}
}
