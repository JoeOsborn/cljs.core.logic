...
{{
var G__304458 = cljs.core.pop.call(null,v__$1);
v__$1 = G__304458;
continue;
}
} else
...
{var pred__304462 = cljs.core._EQ_;var expr__304463 = limit;if(pred__304462.call(null,1,expr__304463))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__304462.call(null,2,expr__304463))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__304465 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__304466 = (limit__$1 - 1);
var G__304467 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__304465;
limit__$1 = G__304466;
parts = G__304467;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___304469 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___304469))
{var replacement_304470 = temp__4092__auto___304469;buffer.append([cljs.core.str(replacement_304470)].join(''));
} else
{buffer.append(ch);
}
{
var G__304471 = (index + 1);
index = G__304471;
continue;
}
}
