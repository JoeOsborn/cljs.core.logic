...
reader_error.cljs$lang$applyTo = (function (arglist__304754){
var rdr = cljs.core.first(arglist__304754);
var msg = cljs.core.rest(arglist__304754);
...
{{
var G__304755 = (function (){sb.append(ch);
return sb;
})();
var G__304756 = cljs.reader.read_char.call(null,rdr);
sb = G__304755;
ch = G__304756;
continue;
}
...
{{
var G__304757 = cljs.reader.read_char.call(null,rdr);
ch = G__304757;
continue;
}
} else
...
var G__304758 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__304758;
continue;
}
} else
...
var G__304759 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__304759;
continue;
}
}
...
{{
var G__304760 = (function (){buffer.append(ch);
return buffer;
})();
var G__304761 = cljs.reader.read_char.call(null,reader);
buffer = G__304760;
ch = G__304761;
continue;
}
...
{if(("\\" === ch))
{{
var G__304762 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__304763 = cljs.reader.read_char.call(null,reader);
buffer = G__304762;
ch = G__304763;
continue;
}
...
{{
var G__304764 = (function (){buffer.append(ch);
return buffer;
})();
var G__304765 = cljs.reader.read_char.call(null,reader);
buffer = G__304764;
ch = G__304765;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__304767 = o;if(G__304767)
{var bit__5323__auto__ = (G__304767.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__304767.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__304767.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__304767);
} else
{return false;
}
}
...
{{
var G__304768 = reader;
var G__304769 = eof_is_error;
var G__304770 = sentinel;
var G__304771 = is_recursive;
reader = G__304768;
eof_is_error = G__304769;
sentinel = G__304770;
is_recursive = G__304771;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__304772 = cljs.reader.read_comment.call(null,reader,ch);
var G__304773 = eof_is_error;
var G__304774 = sentinel;
var G__304775 = is_recursive;
reader = G__304772;
eof_is_error = G__304773;
sentinel = G__304774;
is_recursive = G__304775;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__304776 = reader;
var G__304777 = eof_is_error;
var G__304778 = sentinel;
var G__304779 = is_recursive;
reader = G__304776;
eof_is_error = G__304777;
sentinel = G__304778;
is_recursive = G__304779;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__304782 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__304782,0,null);var years = cljs.core.nth.call(null,vec__304782,1,null);var months = cljs.core.nth.call(null,vec__304782,2,null);var days = cljs.core.nth.call(null,vec__304782,3,null);var hours = cljs.core.nth.call(null,vec__304782,4,null);var minutes = cljs.core.nth.call(null,vec__304782,5,null);var seconds = cljs.core.nth.call(null,vec__304782,6,null);var fraction = cljs.core.nth.call(null,vec__304782,7,null);var offset_sign = cljs.core.nth.call(null,vec__304782,8,null);var offset_hours = cljs.core.nth.call(null,vec__304782,9,null);var offset_minutes = cljs.core.nth.call(null,vec__304782,10,null);var v = vec__304782;if(cljs.core.not.call(null,v))
...
{var vec__304784 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__304784,0,null);var months = cljs.core.nth.call(null,vec__304784,1,null);var days = cljs.core.nth.call(null,vec__304784,2,null);var hours = cljs.core.nth.call(null,vec__304784,3,null);var minutes = cljs.core.nth.call(null,vec__304784,4,null);var seconds = cljs.core.nth.call(null,vec__304784,5,null);var ms = cljs.core.nth.call(null,vec__304784,6,null);var offset = cljs.core.nth.call(null,vec__304784,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
