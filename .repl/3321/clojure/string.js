...
{{
var G__9646 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9646;
continue;
}
} else
...
{var pred__9650 = cljs.core._EQ_;var expr__9651 = limit;if(pred__9650.call(null,1,expr__9651))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9650.call(null,2,expr__9651))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9653 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9654 = (limit__$1 - 1);
var G__9655 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9653;
limit__$1 = G__9654;
parts = G__9655;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9657 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9657))
{var replacement_9658 = temp__4092__auto___9657;buffer.append([cljs.core.str(replacement_9658)].join(''));
} else
{buffer.append(ch);
}
{
