...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__283393 = m;var map__283393__$1 = ((cljs.core.seq_QMARK_.call(null,map__283393))?cljs.core.apply.call(null,cljs.core.hash_map,map__283393):map__283393);var line = cljs.core.get.call(null,map__283393__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__283393__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__283395 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__283395))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__283395))
...
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"default","default",2558708147),(function (m){var _STAR_print_fn_STAR_283396 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283396;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_283397 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283397;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_283398 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___283399 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___283399))
{var message_283400 = temp__4098__auto___283399;cljs.core.println.call(null,message_283400);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283398;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_283401 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___283402 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___283402))
{var message_283403 = temp__4098__auto___283402;cljs.core.println.call(null,message_283403);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283401;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_283404 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283404;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_283405 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283405;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__283406){
var ns_sym = cljs.core.first(arglist__283406);
arglist__283406 = cljs.core.next(arglist__283406);
var fixture_type = cljs.core.first(arglist__283406);
var fixture_fns = cljs.core.rest(arglist__283406);
...
try{t.call(null);
}catch (e283410){if((e283410 instanceof Error))
{var e_283411 = e283410;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_283411], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e283410;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_283409;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__283416 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__283417 = null;var count__283418 = 0;var i__283419 = 0;while(true){
if((i__283419 < count__283418))
{var v = cljs.core._nth.call(null,chunk__283417,i__283419);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__283416,chunk__283417,count__283418,i__283419,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__283416,chunk__283417,count__283418,i__283419,v))
);
} else
{}
{
var G__283420 = seq__283416;
var G__283421 = chunk__283417;
var G__283422 = count__283418;
var G__283423 = (i__283419 + 1);
seq__283416 = G__283420;
chunk__283417 = G__283421;
count__283418 = G__283422;
i__283419 = G__283423;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__283416);if(temp__4098__auto__)
{var seq__283416__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__283416__$1))
{var c__11280__auto__ = cljs.core.chunk_first.call(null,seq__283416__$1);{
var G__283424 = cljs.core.chunk_rest.call(null,seq__283416__$1);
var G__283425 = c__11280__auto__;
var G__283426 = cljs.core.count.call(null,c__11280__auto__);
var G__283427 = 0;
seq__283416 = G__283424;
chunk__283417 = G__283425;
count__283418 = G__283426;
i__283419 = G__283427;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__283416__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__283416,chunk__283417,count__283418,i__283419,v,seq__283416__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__283416,chunk__283417,count__283418,i__283419,v,seq__283416__$1,temp__4098__auto__))
);
} else
{}
{
var G__283428 = cljs.core.next.call(null,seq__283416__$1);
var G__283429 = null;
var G__283430 = 0;
var G__283431 = 0;
seq__283416 = G__283428;
chunk__283417 = G__283429;
count__283418 = G__283430;
i__283419 = G__283431;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_283433 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___283434 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___283434))
{var test_hook_283435 = temp__4096__auto___283434;test_hook_283435.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_283433;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__283436){
var namespaces = cljs.core.seq(arglist__283436);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__283437_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__283437_SHARP_));
