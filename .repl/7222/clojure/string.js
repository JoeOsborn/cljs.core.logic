...
{{
var G__9795 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9795;
continue;
}
} else
...
{var pred__9799 = cljs.core._EQ_;var expr__9800 = limit;if(pred__9799.call(null,1,expr__9800))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9799.call(null,2,expr__9800))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9802 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9803 = (limit__$1 - 1);
var G__9804 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9802;
limit__$1 = G__9803;
parts = G__9804;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9806 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9806))
{var replacement_9807 = temp__4092__auto___9806;buffer.append([cljs.core.str(replacement_9807)].join(''));
} else
{buffer.append(ch);
}
{
