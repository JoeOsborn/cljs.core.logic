...
{{
var G__82284 = cljs.core.pop.call(null,v__$1);
v__$1 = G__82284;
continue;
}
} else
...
{var pred__82288 = cljs.core._EQ_;var expr__82289 = limit;if(cljs.core.truth_(pred__82288.call(null,1,expr__82289)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__82288.call(null,2,expr__82289)))
...
var G__82291 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__82292 = (limit__$1 - 1);
var G__82293 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__82291;
limit__$1 = G__82292;
parts = G__82293;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___82295 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___82295))
{var replacement_82296 = temp__4092__auto___82295;buffer.append([cljs.core.str(replacement_82296)].join(''));
} else
{buffer.append(ch);
}
{
var G__82297 = (index + 1);
index = G__82297;
continue;
}
}
