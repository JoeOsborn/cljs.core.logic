...
{{
var G__16238 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16238;
continue;
}
} else
...
{var pred__16242 = cljs.core._EQ_;var expr__16243 = limit;if(pred__16242.call(null,1,expr__16243))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__16242.call(null,2,expr__16243))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__16245 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16246 = (limit__$1 - 1);
var G__16247 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16245;
limit__$1 = G__16246;
parts = G__16247;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16249 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16249))
{var replacement_16250 = temp__4092__auto___16249;buffer.append([cljs.core.str(replacement_16250)].join(''));
} else
{buffer.append(ch);
}
{
