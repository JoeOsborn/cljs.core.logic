...
reader_error.cljs$lang$applyTo = (function (arglist__16207){
var rdr = cljs.core.first(arglist__16207);
var msg = cljs.core.rest(arglist__16207);
...
{{
var G__16208 = (function (){sb.append(ch);
return sb;
})();
var G__16209 = cljs.reader.read_char.call(null,rdr);
sb = G__16208;
ch = G__16209;
continue;
}
...
{{
var G__16210 = cljs.reader.read_char.call(null,rdr);
ch = G__16210;
continue;
}
} else
...
var G__16211 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__16211;
continue;
}
} else
...
var G__16212 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__16212;
continue;
}
}
...
{{
var G__16213 = (function (){buffer.append(ch);
return buffer;
})();
var G__16214 = cljs.reader.read_char.call(null,reader);
buffer = G__16213;
ch = G__16214;
continue;
}
...
{if(("\\" === ch))
{{
var G__16215 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__16216 = cljs.reader.read_char.call(null,reader);
buffer = G__16215;
ch = G__16216;
continue;
}
...
{{
var G__16217 = (function (){buffer.append(ch);
return buffer;
})();
var G__16218 = cljs.reader.read_char.call(null,reader);
buffer = G__16217;
ch = G__16218;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__16220 = o;if(G__16220)
{var bit__5323__auto__ = (G__16220.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__16220.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__16220.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__16220);
} else
{return false;
}
}
...
{{
var G__16221 = reader;
var G__16222 = eof_is_error;
var G__16223 = sentinel;
var G__16224 = is_recursive;
reader = G__16221;
eof_is_error = G__16222;
sentinel = G__16223;
is_recursive = G__16224;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__16225 = cljs.reader.read_comment.call(null,reader,ch);
var G__16226 = eof_is_error;
var G__16227 = sentinel;
var G__16228 = is_recursive;
reader = G__16225;
eof_is_error = G__16226;
sentinel = G__16227;
is_recursive = G__16228;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__16229 = reader;
var G__16230 = eof_is_error;
var G__16231 = sentinel;
var G__16232 = is_recursive;
reader = G__16229;
eof_is_error = G__16230;
sentinel = G__16231;
is_recursive = G__16232;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__16235 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__16235,0,null);var years = cljs.core.nth.call(null,vec__16235,1,null);var months = cljs.core.nth.call(null,vec__16235,2,null);var days = cljs.core.nth.call(null,vec__16235,3,null);var hours = cljs.core.nth.call(null,vec__16235,4,null);var minutes = cljs.core.nth.call(null,vec__16235,5,null);var seconds = cljs.core.nth.call(null,vec__16235,6,null);var fraction = cljs.core.nth.call(null,vec__16235,7,null);var offset_sign = cljs.core.nth.call(null,vec__16235,8,null);var offset_hours = cljs.core.nth.call(null,vec__16235,9,null);var offset_minutes = cljs.core.nth.call(null,vec__16235,10,null);var v = vec__16235;if(cljs.core.not.call(null,v))
...
{var vec__16237 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__16237,0,null);var months = cljs.core.nth.call(null,vec__16237,1,null);var days = cljs.core.nth.call(null,vec__16237,2,null);var hours = cljs.core.nth.call(null,vec__16237,3,null);var minutes = cljs.core.nth.call(null,vec__16237,4,null);var seconds = cljs.core.nth.call(null,vec__16237,5,null);var ms = cljs.core.nth.call(null,vec__16237,6,null);var offset = cljs.core.nth.call(null,vec__16237,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
