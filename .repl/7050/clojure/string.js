...
{{
var G__50952 = cljs.core.pop.call(null,v__$1);
v__$1 = G__50952;
continue;
}
} else
...
{var pred__50956 = cljs.core._EQ_;var expr__50957 = limit;if(pred__50956.call(null,1,expr__50957))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__50956.call(null,2,expr__50957))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__50959 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__50960 = (limit__$1 - 1);
var G__50961 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__50959;
limit__$1 = G__50960;
parts = G__50961;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___50963 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___50963))
{var replacement_50964 = temp__4092__auto___50963;buffer.append([cljs.core.str(replacement_50964)].join(''));
} else
{buffer.append(ch);
}
{
var G__50965 = (index + 1);
index = G__50965;
continue;
}
}
