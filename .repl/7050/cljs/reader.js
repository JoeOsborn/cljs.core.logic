...
reader_error.cljs$lang$applyTo = (function (arglist__50921){
var rdr = cljs.core.first(arglist__50921);
var msg = cljs.core.rest(arglist__50921);
...
{{
var G__50922 = (function (){sb.append(ch);
return sb;
})();
var G__50923 = cljs.reader.read_char.call(null,rdr);
sb = G__50922;
ch = G__50923;
continue;
}
...
{{
var G__50924 = cljs.reader.read_char.call(null,rdr);
ch = G__50924;
continue;
}
} else
...
var G__50925 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__50925;
continue;
}
} else
...
var G__50926 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__50926;
continue;
}
}
...
{{
var G__50927 = (function (){buffer.append(ch);
return buffer;
})();
var G__50928 = cljs.reader.read_char.call(null,reader);
buffer = G__50927;
ch = G__50928;
continue;
}
...
{if(("\\" === ch))
{{
var G__50929 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__50930 = cljs.reader.read_char.call(null,reader);
buffer = G__50929;
ch = G__50930;
continue;
}
...
{{
var G__50931 = (function (){buffer.append(ch);
return buffer;
})();
var G__50932 = cljs.reader.read_char.call(null,reader);
buffer = G__50931;
ch = G__50932;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__50934 = o;if(G__50934)
{var bit__5323__auto__ = (G__50934.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__50934.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__50934.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__50934);
} else
{return false;
}
}
...
{{
var G__50935 = reader;
var G__50936 = eof_is_error;
var G__50937 = sentinel;
var G__50938 = is_recursive;
reader = G__50935;
eof_is_error = G__50936;
sentinel = G__50937;
is_recursive = G__50938;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__50939 = cljs.reader.read_comment.call(null,reader,ch);
var G__50940 = eof_is_error;
var G__50941 = sentinel;
var G__50942 = is_recursive;
reader = G__50939;
eof_is_error = G__50940;
sentinel = G__50941;
is_recursive = G__50942;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__50943 = reader;
var G__50944 = eof_is_error;
var G__50945 = sentinel;
var G__50946 = is_recursive;
reader = G__50943;
eof_is_error = G__50944;
sentinel = G__50945;
is_recursive = G__50946;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__50949 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__50949,0,null);var years = cljs.core.nth.call(null,vec__50949,1,null);var months = cljs.core.nth.call(null,vec__50949,2,null);var days = cljs.core.nth.call(null,vec__50949,3,null);var hours = cljs.core.nth.call(null,vec__50949,4,null);var minutes = cljs.core.nth.call(null,vec__50949,5,null);var seconds = cljs.core.nth.call(null,vec__50949,6,null);var fraction = cljs.core.nth.call(null,vec__50949,7,null);var offset_sign = cljs.core.nth.call(null,vec__50949,8,null);var offset_hours = cljs.core.nth.call(null,vec__50949,9,null);var offset_minutes = cljs.core.nth.call(null,vec__50949,10,null);var v = vec__50949;if(cljs.core.not.call(null,v))
...
{var vec__50951 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__50951,0,null);var months = cljs.core.nth.call(null,vec__50951,1,null);var days = cljs.core.nth.call(null,vec__50951,2,null);var hours = cljs.core.nth.call(null,vec__50951,3,null);var minutes = cljs.core.nth.call(null,vec__50951,4,null);var seconds = cljs.core.nth.call(null,vec__50951,5,null);var ms = cljs.core.nth.call(null,vec__50951,6,null);var offset = cljs.core.nth.call(null,vec__50951,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
