...
{{
var G__111104 = cljs.core.pop.call(null,v__$1);
v__$1 = G__111104;
continue;
}
} else
...
{var pred__111108 = cljs.core._EQ_;var expr__111109 = limit;if(cljs.core.truth_(pred__111108.call(null,1,expr__111109)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__111108.call(null,2,expr__111109)))
...
var G__111111 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__111112 = (limit__$1 - 1);
var G__111113 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__111111;
limit__$1 = G__111112;
parts = G__111113;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___111115 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___111115))
{var replacement_111116 = temp__4096__auto___111115;buffer.append([cljs.core.str(replacement_111116)].join(''));
} else
{buffer.append(ch);
}
{
var G__111117 = (index + 1);
index = G__111117;
continue;
}
}
