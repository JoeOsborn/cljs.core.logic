...
{{
var G__202826 = cljs.core.pop.call(null,v__$1);
v__$1 = G__202826;
continue;
}
} else
...
{var pred__202830 = cljs.core._EQ_;var expr__202831 = limit;if(cljs.core.truth_(pred__202830.call(null,1,expr__202831)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__202830.call(null,2,expr__202831)))
...
var G__202833 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__202834 = (limit__$1 - 1);
var G__202835 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__202833;
limit__$1 = G__202834;
parts = G__202835;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___202837 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___202837))
{var replacement_202838 = temp__4096__auto___202837;buffer.append([cljs.core.str(replacement_202838)].join(''));
} else
{buffer.append(ch);
}
{
var G__202839 = (index + 1);
index = G__202839;
continue;
}
}
