...
{{
var G__15329 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15329;
continue;
}
} else
...
{var pred__15333 = cljs.core._EQ_;var expr__15334 = limit;if(cljs.core.truth_(pred__15333.call(null,1,expr__15334)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15333.call(null,2,expr__15334)))
...
var G__15336 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15337 = (limit__$1 - 1);
var G__15338 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15336;
limit__$1 = G__15337;
parts = G__15338;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___15340 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___15340))
{var replacement_15341 = temp__4096__auto___15340;buffer.append([cljs.core.str(replacement_15341)].join(''));
} else
{buffer.append(ch);
}
{
var G__15342 = (index + 1);
index = G__15342;
continue;
}
}
