...
{{
var G__651060 = cljs.core.pop.call(null,v__$1);
v__$1 = G__651060;
continue;
}
} else
...
{var pred__651064 = cljs.core._EQ_;var expr__651065 = limit;if(cljs.core.truth_(pred__651064.call(null,1,expr__651065)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__651064.call(null,2,expr__651065)))
...
var G__651067 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__651068 = (limit__$1 - 1);
var G__651069 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__651067;
limit__$1 = G__651068;
parts = G__651069;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___651071 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___651071))
{var replacement_651072 = temp__4096__auto___651071;buffer.append([cljs.core.str(replacement_651072)].join(''));
} else
{buffer.append(ch);
}
{
var G__651073 = (index + 1);
index = G__651073;
continue;
}
}
