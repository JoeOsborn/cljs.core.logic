...
{{
var G__34762 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34762;
continue;
}
} else
...
{var pred__34766 = cljs.core._EQ_;var expr__34767 = limit;if(pred__34766.call(null,1,expr__34767))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__34766.call(null,2,expr__34767))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__34769 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34770 = (limit__$1 - 1);
var G__34771 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34769;
limit__$1 = G__34770;
parts = G__34771;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___34773 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___34773))
{var replacement_34774 = temp__4092__auto___34773;buffer.append([cljs.core.str(replacement_34774)].join(''));
} else
{buffer.append(ch);
}
{
var G__34775 = (index + 1);
index = G__34775;
continue;
}
}
