...
{{
var G__25487 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25487;
continue;
}
} else
...
{var pred__25491 = cljs.core._EQ_;var expr__25492 = limit;if(pred__25491.call(null,1,expr__25492))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__25491.call(null,2,expr__25492))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__25494 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25495 = (limit__$1 - 1);
var G__25496 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25494;
limit__$1 = G__25495;
parts = G__25496;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___25498 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___25498))
{var replacement_25499 = temp__4092__auto___25498;buffer.append([cljs.core.str(replacement_25499)].join(''));
} else
{buffer.append(ch);
}
{
var G__25500 = (index + 1);
index = G__25500;
continue;
}
}
