...
reader_error.cljs$lang$applyTo = (function (arglist__25456){
var rdr = cljs.core.first(arglist__25456);
var msg = cljs.core.rest(arglist__25456);
...
{{
var G__25457 = (function (){sb.append(ch);
return sb;
})();
var G__25458 = cljs.reader.read_char.call(null,rdr);
sb = G__25457;
ch = G__25458;
continue;
}
...
var G__25460 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__25460;
continue;
}
} else
...
var G__25461 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__25461;
continue;
}
}
...
{{
var G__25462 = (function (){buffer.append(ch);
return buffer;
})();
var G__25463 = cljs.reader.read_char.call(null,reader);
buffer = G__25462;
ch = G__25463;
continue;
}
...
{if(("\\" === ch))
{{
var G__25464 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__25465 = cljs.reader.read_char.call(null,reader);
buffer = G__25464;
ch = G__25465;
continue;
}
...
{{
var G__25466 = (function (){buffer.append(ch);
return buffer;
})();
var G__25467 = cljs.reader.read_char.call(null,reader);
buffer = G__25466;
ch = G__25467;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__25469 = o;if(G__25469)
{var bit__5323__auto__ = (G__25469.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__25469.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__25469.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__25469);
} else
{return false;
}
}
...
{{
var G__25470 = reader;
var G__25471 = eof_is_error;
var G__25472 = sentinel;
var G__25473 = is_recursive;
reader = G__25470;
eof_is_error = G__25471;
sentinel = G__25472;
is_recursive = G__25473;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__25474 = cljs.reader.read_comment.call(null,reader,ch);
var G__25475 = eof_is_error;
var G__25476 = sentinel;
var G__25477 = is_recursive;
reader = G__25474;
eof_is_error = G__25475;
sentinel = G__25476;
is_recursive = G__25477;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__25478 = reader;
var G__25479 = eof_is_error;
var G__25480 = sentinel;
var G__25481 = is_recursive;
reader = G__25478;
eof_is_error = G__25479;
sentinel = G__25480;
is_recursive = G__25481;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__25484 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__25484,0,null);var years = cljs.core.nth.call(null,vec__25484,1,null);var months = cljs.core.nth.call(null,vec__25484,2,null);var days = cljs.core.nth.call(null,vec__25484,3,null);var hours = cljs.core.nth.call(null,vec__25484,4,null);var minutes = cljs.core.nth.call(null,vec__25484,5,null);var seconds = cljs.core.nth.call(null,vec__25484,6,null);var fraction = cljs.core.nth.call(null,vec__25484,7,null);var offset_sign = cljs.core.nth.call(null,vec__25484,8,null);var offset_hours = cljs.core.nth.call(null,vec__25484,9,null);var offset_minutes = cljs.core.nth.call(null,vec__25484,10,null);var v = vec__25484;if(cljs.core.not.call(null,v))
...
{var vec__25486 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__25486,0,null);var months = cljs.core.nth.call(null,vec__25486,1,null);var days = cljs.core.nth.call(null,vec__25486,2,null);var hours = cljs.core.nth.call(null,vec__25486,3,null);var minutes = cljs.core.nth.call(null,vec__25486,4,null);var seconds = cljs.core.nth.call(null,vec__25486,5,null);var ms = cljs.core.nth.call(null,vec__25486,6,null);var offset = cljs.core.nth.call(null,vec__25486,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
