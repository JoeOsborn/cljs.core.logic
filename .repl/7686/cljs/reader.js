...
reader_error.cljs$lang$applyTo = (function (arglist__164207){
var rdr = cljs.core.first(arglist__164207);
var msg = cljs.core.rest(arglist__164207);
...
{{
var G__164208 = (function (){sb.append(ch);
return sb;
})();
var G__164209 = cljs.reader.read_char.call(null,rdr);
sb = G__164208;
ch = G__164209;
continue;
}
...
{{
var G__164210 = cljs.reader.read_char.call(null,rdr);
ch = G__164210;
continue;
}
} else
...
var G__164211 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__164211;
continue;
}
} else
...
var G__164212 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__164212;
continue;
}
}
...
{{
var G__164213 = (function (){buffer.append(ch);
return buffer;
})();
var G__164214 = cljs.reader.read_char.call(null,reader);
buffer = G__164213;
ch = G__164214;
continue;
}
...
{if(("\\" === ch))
{{
var G__164215 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__164216 = cljs.reader.read_char.call(null,reader);
buffer = G__164215;
ch = G__164216;
continue;
}
...
{{
var G__164217 = (function (){buffer.append(ch);
return buffer;
})();
var G__164218 = cljs.reader.read_char.call(null,reader);
buffer = G__164217;
ch = G__164218;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__164220 = o;if(G__164220)
{var bit__5323__auto__ = (G__164220.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__164220.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__164220.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__164220);
} else
{return false;
}
}
...
{{
var G__164221 = reader;
var G__164222 = eof_is_error;
var G__164223 = sentinel;
var G__164224 = is_recursive;
reader = G__164221;
eof_is_error = G__164222;
sentinel = G__164223;
is_recursive = G__164224;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__164225 = cljs.reader.read_comment.call(null,reader,ch);
var G__164226 = eof_is_error;
var G__164227 = sentinel;
var G__164228 = is_recursive;
reader = G__164225;
eof_is_error = G__164226;
sentinel = G__164227;
is_recursive = G__164228;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__164229 = reader;
var G__164230 = eof_is_error;
var G__164231 = sentinel;
var G__164232 = is_recursive;
reader = G__164229;
eof_is_error = G__164230;
sentinel = G__164231;
is_recursive = G__164232;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__164235 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__164235,0,null);var years = cljs.core.nth.call(null,vec__164235,1,null);var months = cljs.core.nth.call(null,vec__164235,2,null);var days = cljs.core.nth.call(null,vec__164235,3,null);var hours = cljs.core.nth.call(null,vec__164235,4,null);var minutes = cljs.core.nth.call(null,vec__164235,5,null);var seconds = cljs.core.nth.call(null,vec__164235,6,null);var fraction = cljs.core.nth.call(null,vec__164235,7,null);var offset_sign = cljs.core.nth.call(null,vec__164235,8,null);var offset_hours = cljs.core.nth.call(null,vec__164235,9,null);var offset_minutes = cljs.core.nth.call(null,vec__164235,10,null);var v = vec__164235;if(cljs.core.not.call(null,v))
...
{var vec__164237 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__164237,0,null);var months = cljs.core.nth.call(null,vec__164237,1,null);var days = cljs.core.nth.call(null,vec__164237,2,null);var hours = cljs.core.nth.call(null,vec__164237,3,null);var minutes = cljs.core.nth.call(null,vec__164237,4,null);var seconds = cljs.core.nth.call(null,vec__164237,5,null);var ms = cljs.core.nth.call(null,vec__164237,6,null);var offset = cljs.core.nth.call(null,vec__164237,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
