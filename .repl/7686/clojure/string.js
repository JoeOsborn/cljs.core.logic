...
{{
var G__163911 = cljs.core.pop.call(null,v__$1);
v__$1 = G__163911;
continue;
}
} else
...
{var pred__163915 = cljs.core._EQ_;var expr__163916 = limit;if(pred__163915.call(null,1,expr__163916))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__163915.call(null,2,expr__163916))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__163918 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__163919 = (limit__$1 - 1);
var G__163920 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__163918;
limit__$1 = G__163919;
parts = G__163920;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___163922 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___163922))
{var replacement_163923 = temp__4092__auto___163922;buffer.append([cljs.core.str(replacement_163923)].join(''));
} else
{buffer.append(ch);
}
{
var G__163924 = (index + 1);
index = G__163924;
continue;
}
}
