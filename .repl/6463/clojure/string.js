...
{{
var G__39617 = cljs.core.pop.call(null,v__$1);
v__$1 = G__39617;
continue;
}
} else
...
{var pred__39621 = cljs.core._EQ_;var expr__39622 = limit;if(cljs.core.truth_(pred__39621.call(null,1,expr__39622)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__39621.call(null,2,expr__39622)))
...
var G__39624 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__39625 = (limit__$1 - 1);
var G__39626 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__39624;
limit__$1 = G__39625;
parts = G__39626;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___39628 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___39628))
{var replacement_39629 = temp__4092__auto___39628;buffer.append([cljs.core.str(replacement_39629)].join(''));
} else
{buffer.append(ch);
}
{
var G__39630 = (index + 1);
index = G__39630;
continue;
}
}
