...
{{
var G__30602 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30602;
continue;
}
} else
...
{var pred__30606 = cljs.core._EQ_;var expr__30607 = limit;if(pred__30606.call(null,1,expr__30607))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__30606.call(null,2,expr__30607))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__30609 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30610 = (limit__$1 - 1);
var G__30611 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__30609;
limit__$1 = G__30610;
parts = G__30611;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___30613 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___30613))
{var replacement_30614 = temp__4092__auto___30613;buffer.append([cljs.core.str(replacement_30614)].join(''));
} else
{buffer.append(ch);
}
{
var G__30615 = (index + 1);
index = G__30615;
continue;
}
}
