...
{{
var G__88684 = cljs.core.pop.call(null,v__$1);
v__$1 = G__88684;
continue;
}
} else
...
{var pred__88688 = cljs.core._EQ_;var expr__88689 = limit;if(cljs.core.truth_(pred__88688.call(null,1,expr__88689)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__88688.call(null,2,expr__88689)))
...
var G__88691 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__88692 = (limit__$1 - 1);
var G__88693 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__88691;
limit__$1 = G__88692;
parts = G__88693;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___88695 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___88695))
{var replacement_88696 = temp__4096__auto___88695;buffer.append([cljs.core.str(replacement_88696)].join(''));
} else
{buffer.append(ch);
}
{
var G__88697 = (index + 1);
index = G__88697;
continue;
}
}
