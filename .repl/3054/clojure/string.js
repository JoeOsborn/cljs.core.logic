...
{{
var G__400918 = cljs.core.pop.call(null,v__$1);
v__$1 = G__400918;
continue;
}
} else
...
{var pred__400922 = cljs.core._EQ_;var expr__400923 = limit;if(cljs.core.truth_(pred__400922.call(null,1,expr__400923)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__400922.call(null,2,expr__400923)))
...
var G__400925 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__400926 = (limit__$1 - 1);
var G__400927 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__400925;
limit__$1 = G__400926;
parts = G__400927;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___400929 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___400929))
{var replacement_400930 = temp__4096__auto___400929;buffer.append([cljs.core.str(replacement_400930)].join(''));
} else
{buffer.append(ch);
}
{
var G__400931 = (index + 1);
index = G__400931;
continue;
}
}
