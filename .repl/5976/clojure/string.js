...
{{
var G__13691 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13691;
continue;
}
} else
...
{var pred__13695 = cljs.core._EQ_;var expr__13696 = limit;if(pred__13695.call(null,1,expr__13696))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__13695.call(null,2,expr__13696))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__13698 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13699 = (limit__$1 - 1);
var G__13700 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13698;
limit__$1 = G__13699;
parts = G__13700;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___13702 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___13702))
{var replacement_13703 = temp__4092__auto___13702;buffer.append([cljs.core.str(replacement_13703)].join(''));
} else
{buffer.append(ch);
}
{
var G__13704 = (index + 1);
index = G__13704;
continue;
}
}
