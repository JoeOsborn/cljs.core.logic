...
{{
var G__28886 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28886;
continue;
}
} else
...
{var pred__28890 = cljs.core._EQ_;var expr__28891 = limit;if(pred__28890.call(null,1,expr__28891))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__28890.call(null,2,expr__28891))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__28893 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28894 = (limit__$1 - 1);
var G__28895 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28893;
limit__$1 = G__28894;
parts = G__28895;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___28897 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___28897))
{var replacement_28898 = temp__4092__auto___28897;buffer.append([cljs.core.str(replacement_28898)].join(''));
} else
{buffer.append(ch);
}
{
var G__28899 = (index + 1);
index = G__28899;
continue;
}
}
