...
{{
var G__9615 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9615;
continue;
}
} else
...
{var pred__9619 = cljs.core._EQ_;var expr__9620 = limit;if(pred__9619.call(null,1,expr__9620))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9619.call(null,2,expr__9620))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9622 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9623 = (limit__$1 - 1);
var G__9624 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9622;
limit__$1 = G__9623;
parts = G__9624;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9626 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9626))
{var replacement_9627 = temp__4092__auto___9626;buffer.append([cljs.core.str(replacement_9627)].join(''));
} else
{buffer.append(ch);
}
{
