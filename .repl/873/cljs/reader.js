...
reader_error.cljs$lang$applyTo = (function (arglist__9584){
var rdr = cljs.core.first(arglist__9584);
var msg = cljs.core.rest(arglist__9584);
...
{{
var G__9585 = (function (){sb.append(ch);
return sb;
})();
var G__9586 = cljs.reader.read_char.call(null,rdr);
sb = G__9585;
ch = G__9586;
continue;
}
...
{{
var G__9587 = cljs.reader.read_char.call(null,rdr);
ch = G__9587;
continue;
}
} else
...
var G__9588 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9588;
continue;
}
} else
...
var G__9589 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9589;
continue;
}
}
...
{{
var G__9590 = (function (){buffer.append(ch);
return buffer;
})();
...
{if(("\\" === ch))
{{
var G__9592 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__9594 = (function (){buffer.append(ch);
return buffer;
})();
var G__9595 = cljs.reader.read_char.call(null,reader);
buffer = G__9594;
ch = G__9595;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9597 = o;if(G__9597)
{var bit__5323__auto__ = (G__9597.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9597.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9597.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9597);
} else
{return false;
}
}
...
{{
var G__9598 = reader;
var G__9599 = eof_is_error;
var G__9600 = sentinel;
var G__9601 = is_recursive;
reader = G__9598;
eof_is_error = G__9599;
sentinel = G__9600;
is_recursive = G__9601;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9602 = cljs.reader.read_comment.call(null,reader,ch);
var G__9603 = eof_is_error;
var G__9604 = sentinel;
var G__9605 = is_recursive;
reader = G__9602;
eof_is_error = G__9603;
sentinel = G__9604;
is_recursive = G__9605;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9606 = reader;
var G__9607 = eof_is_error;
var G__9608 = sentinel;
var G__9609 = is_recursive;
reader = G__9606;
eof_is_error = G__9607;
sentinel = G__9608;
is_recursive = G__9609;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9612 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9612,0,null);var years = cljs.core.nth.call(null,vec__9612,1,null);var months = cljs.core.nth.call(null,vec__9612,2,null);var days = cljs.core.nth.call(null,vec__9612,3,null);var hours = cljs.core.nth.call(null,vec__9612,4,null);var minutes = cljs.core.nth.call(null,vec__9612,5,null);var seconds = cljs.core.nth.call(null,vec__9612,6,null);var fraction = cljs.core.nth.call(null,vec__9612,7,null);var offset_sign = cljs.core.nth.call(null,vec__9612,8,null);var offset_hours = cljs.core.nth.call(null,vec__9612,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9612,10,null);var v = vec__9612;if(cljs.core.not.call(null,v))
...
{var vec__9614 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9614,0,null);var months = cljs.core.nth.call(null,vec__9614,1,null);var days = cljs.core.nth.call(null,vec__9614,2,null);var hours = cljs.core.nth.call(null,vec__9614,3,null);var minutes = cljs.core.nth.call(null,vec__9614,4,null);var seconds = cljs.core.nth.call(null,vec__9614,5,null);var ms = cljs.core.nth.call(null,vec__9614,6,null);var offset = cljs.core.nth.call(null,vec__9614,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
