...
{{
var G__53194 = cljs.core.pop.call(null,v__$1);
v__$1 = G__53194;
continue;
}
} else
...
{var pred__53198 = cljs.core._EQ_;var expr__53199 = limit;if(cljs.core.truth_(pred__53198.call(null,1,expr__53199)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__53198.call(null,2,expr__53199)))
...
var G__53201 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__53202 = (limit__$1 - 1);
var G__53203 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__53201;
limit__$1 = G__53202;
parts = G__53203;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___53205 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___53205))
{var replacement_53206 = temp__4096__auto___53205;buffer.append([cljs.core.str(replacement_53206)].join(''));
} else
{buffer.append(ch);
}
{
var G__53207 = (index + 1);
index = G__53207;
continue;
}
}
