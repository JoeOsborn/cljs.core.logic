...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj53162 = {};return obj53162;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__11121__auto__ = reader;if(and__11121__auto__)
...
{var x__11736__auto__ = (((reader == null))?null:reader);return (function (){var or__11133__auto__ = (cljs.reader.read_char[goog.typeOf(x__11736__auto__)]);if(or__11133__auto__)
{return or__11133__auto__;
} else
{var or__11133__auto____$1 = (cljs.reader.read_char["_"]);if(or__11133__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__11121__auto__ = reader;if(and__11121__auto__)
...
{var x__11736__auto__ = (((reader == null))?null:reader);return (function (){var or__11133__auto__ = (cljs.reader.unread[goog.typeOf(x__11736__auto__)]);if(or__11133__auto__)
{return or__11133__auto__;
} else
{var or__11133__auto____$1 = (cljs.reader.unread["_"]);if(or__11133__auto____$1)
{return or__11133__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__11677__auto__,writer__11678__auto__,opt__11679__auto__){return cljs.core._write.call(null,writer__11678__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__11133__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__53163){
var rdr = cljs.core.first(arglist__53163);
var msg = cljs.core.rest(arglist__53163);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__11121__auto__ = !((ch === "#"));if(and__11121__auto__)
{var and__11121__auto____$1 = !((ch === "'"));if(and__11121__auto____$1)
{var and__11121__auto____$2 = !((ch === ":"));if(and__11121__auto____$2)
...
{{
var G__53164 = (function (){sb.append(ch);
return sb;
})();
var G__53165 = cljs.reader.read_char.call(null,rdr);
sb = G__53164;
ch = G__53165;
continue;
}
...
{{
var G__53166 = cljs.reader.read_char.call(null,rdr);
ch = G__53166;
continue;
}
} else
...
var G__53167 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__53167;
continue;
}
} else
...
var G__53168 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__53168;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__11133__auto__ = (ch == null);if(or__11133__auto__)
{return or__11133__auto__;
} else
{var or__11133__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__11133__auto____$1)
{return or__11133__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__11133__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
...
{{
var G__53169 = (function (){buffer.append(ch);
return buffer;
})();
var G__53170 = cljs.reader.read_char.call(null,reader);
buffer = G__53169;
ch = G__53170;
continue;
}
...
{if(("\\" === ch))
{{
var G__53171 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__53172 = cljs.reader.read_char.call(null,reader);
buffer = G__53171;
ch = G__53172;
continue;
}
...
{{
var G__53173 = (function (){buffer.append(ch);
return buffer;
})();
var G__53174 = cljs.reader.read_char.call(null,reader);
buffer = G__53173;
ch = G__53174;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__53176 = o;if(G__53176)
{var bit__11759__auto__ = (G__53176.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11759__auto__) || (G__53176.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__53176.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__53176);
} else
{return false;
}
}
...
{{
var G__53177 = reader;
var G__53178 = eof_is_error;
var G__53179 = sentinel;
var G__53180 = is_recursive;
reader = G__53177;
eof_is_error = G__53178;
sentinel = G__53179;
is_recursive = G__53180;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__53181 = cljs.reader.read_comment.call(null,reader,ch);
var G__53182 = eof_is_error;
var G__53183 = sentinel;
var G__53184 = is_recursive;
reader = G__53181;
eof_is_error = G__53182;
sentinel = G__53183;
is_recursive = G__53184;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__53185 = reader;
var G__53186 = eof_is_error;
var G__53187 = sentinel;
var G__53188 = is_recursive;
reader = G__53185;
eof_is_error = G__53186;
sentinel = G__53187;
is_recursive = G__53188;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__53191 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__53191,0,null);var years = cljs.core.nth.call(null,vec__53191,1,null);var months = cljs.core.nth.call(null,vec__53191,2,null);var days = cljs.core.nth.call(null,vec__53191,3,null);var hours = cljs.core.nth.call(null,vec__53191,4,null);var minutes = cljs.core.nth.call(null,vec__53191,5,null);var seconds = cljs.core.nth.call(null,vec__53191,6,null);var fraction = cljs.core.nth.call(null,vec__53191,7,null);var offset_sign = cljs.core.nth.call(null,vec__53191,8,null);var offset_hours = cljs.core.nth.call(null,vec__53191,9,null);var offset_minutes = cljs.core.nth.call(null,vec__53191,10,null);var v = vec__53191;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__11133__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__11133__auto__))
{return or__11133__auto__;
} else
{return 0;
}
...
{var vec__53193 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__53193,0,null);var months = cljs.core.nth.call(null,vec__53193,1,null);var days = cljs.core.nth.call(null,vec__53193,2,null);var hours = cljs.core.nth.call(null,vec__53193,3,null);var minutes = cljs.core.nth.call(null,vec__53193,4,null);var seconds = cljs.core.nth.call(null,vec__53193,5,null);var ms = cljs.core.nth.call(null,vec__53193,6,null);var offset = cljs.core.nth.call(null,vec__53193,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
