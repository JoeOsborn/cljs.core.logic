...
{{
var G__268342 = cljs.core.pop.call(null,v__$1);
v__$1 = G__268342;
continue;
}
} else
...
{var pred__268346 = cljs.core._EQ_;var expr__268347 = limit;if(cljs.core.truth_(pred__268346.call(null,1,expr__268347)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__268346.call(null,2,expr__268347)))
...
var G__268349 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__268350 = (limit__$1 - 1);
var G__268351 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__268349;
limit__$1 = G__268350;
parts = G__268351;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___268353 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___268353))
{var replacement_268354 = temp__4096__auto___268353;buffer.append([cljs.core.str(replacement_268354)].join(''));
} else
{buffer.append(ch);
}
{
var G__268355 = (index + 1);
index = G__268355;
continue;
}
}
