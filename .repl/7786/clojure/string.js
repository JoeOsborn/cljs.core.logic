...
{{
var G__192880 = cljs.core.pop.call(null,v__$1);
v__$1 = G__192880;
continue;
}
} else
...
{var pred__192884 = cljs.core._EQ_;var expr__192885 = limit;if(cljs.core.truth_(pred__192884.call(null,1,expr__192885)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__192884.call(null,2,expr__192885)))
...
var G__192887 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__192888 = (limit__$1 - 1);
var G__192889 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__192887;
limit__$1 = G__192888;
parts = G__192889;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___192891 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___192891))
{var replacement_192892 = temp__4096__auto___192891;buffer.append([cljs.core.str(replacement_192892)].join(''));
} else
{buffer.append(ch);
}
{
var G__192893 = (index + 1);
index = G__192893;
continue;
}
}
