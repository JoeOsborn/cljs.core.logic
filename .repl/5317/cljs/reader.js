...
reader_error.cljs$lang$applyTo = (function (arglist__9296){
var rdr = cljs.core.first(arglist__9296);
var msg = cljs.core.rest(arglist__9296);
...
{{
var G__9297 = (function (){sb.append(ch);
return sb;
})();
var G__9298 = cljs.reader.read_char.call(null,rdr);
sb = G__9297;
ch = G__9298;
continue;
}
...
{{
var G__9299 = cljs.reader.read_char.call(null,rdr);
ch = G__9299;
continue;
}
} else
...
var G__9300 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9300;
continue;
}
} else
...
var G__9301 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9301;
continue;
}
}
...
{{
var G__9302 = (function (){buffer.append(ch);
return buffer;
})();
...
{if(("\\" === ch))
{{
var G__9304 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__9306 = (function (){buffer.append(ch);
return buffer;
})();
var G__9307 = cljs.reader.read_char.call(null,reader);
buffer = G__9306;
ch = G__9307;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9309 = o;if(G__9309)
{var bit__5323__auto__ = (G__9309.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9309.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9309.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9309);
} else
{return false;
}
}
...
{{
var G__9310 = reader;
var G__9311 = eof_is_error;
var G__9312 = sentinel;
var G__9313 = is_recursive;
reader = G__9310;
eof_is_error = G__9311;
sentinel = G__9312;
is_recursive = G__9313;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9314 = cljs.reader.read_comment.call(null,reader,ch);
var G__9315 = eof_is_error;
var G__9316 = sentinel;
var G__9317 = is_recursive;
reader = G__9314;
eof_is_error = G__9315;
sentinel = G__9316;
is_recursive = G__9317;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9324 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9324,0,null);var years = cljs.core.nth.call(null,vec__9324,1,null);var months = cljs.core.nth.call(null,vec__9324,2,null);var days = cljs.core.nth.call(null,vec__9324,3,null);var hours = cljs.core.nth.call(null,vec__9324,4,null);var minutes = cljs.core.nth.call(null,vec__9324,5,null);var seconds = cljs.core.nth.call(null,vec__9324,6,null);var fraction = cljs.core.nth.call(null,vec__9324,7,null);var offset_sign = cljs.core.nth.call(null,vec__9324,8,null);var offset_hours = cljs.core.nth.call(null,vec__9324,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9324,10,null);var v = vec__9324;if(cljs.core.not.call(null,v))
...
{var vec__9326 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9326,0,null);var months = cljs.core.nth.call(null,vec__9326,1,null);var days = cljs.core.nth.call(null,vec__9326,2,null);var hours = cljs.core.nth.call(null,vec__9326,3,null);var minutes = cljs.core.nth.call(null,vec__9326,4,null);var seconds = cljs.core.nth.call(null,vec__9326,5,null);var ms = cljs.core.nth.call(null,vec__9326,6,null);var offset = cljs.core.nth.call(null,vec__9326,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
