...
{{
var G__9327 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9327;
continue;
}
} else
...
{var pred__9331 = cljs.core._EQ_;var expr__9332 = limit;if(pred__9331.call(null,1,expr__9332))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9331.call(null,2,expr__9332))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9334 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9335 = (limit__$1 - 1);
var G__9336 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9334;
limit__$1 = G__9335;
parts = G__9336;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9338 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9338))
{var replacement_9339 = temp__4092__auto___9338;buffer.append([cljs.core.str(replacement_9339)].join(''));
} else
{buffer.append(ch);
}
{
