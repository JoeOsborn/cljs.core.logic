...
reader_error.cljs$lang$applyTo = (function (arglist__47433){
var rdr = cljs.core.first(arglist__47433);
var msg = cljs.core.rest(arglist__47433);
...
{{
var G__47434 = (function (){sb.append(ch);
return sb;
})();
var G__47435 = cljs.reader.read_char.call(null,rdr);
sb = G__47434;
ch = G__47435;
continue;
}
...
{{
var G__47436 = cljs.reader.read_char.call(null,rdr);
ch = G__47436;
continue;
}
} else
...
var G__47437 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__47437;
continue;
}
} else
...
var G__47438 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__47438;
continue;
}
}
...
{{
var G__47439 = (function (){buffer.append(ch);
return buffer;
})();
var G__47440 = cljs.reader.read_char.call(null,reader);
buffer = G__47439;
ch = G__47440;
continue;
}
...
{if(("\\" === ch))
{{
var G__47441 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__47442 = cljs.reader.read_char.call(null,reader);
buffer = G__47441;
ch = G__47442;
continue;
}
...
{{
var G__47443 = (function (){buffer.append(ch);
return buffer;
})();
var G__47444 = cljs.reader.read_char.call(null,reader);
buffer = G__47443;
ch = G__47444;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__47446 = o;if(G__47446)
{var bit__5323__auto__ = (G__47446.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__47446.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__47446.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__47446);
} else
{return false;
}
}
...
{{
var G__47447 = reader;
var G__47448 = eof_is_error;
var G__47449 = sentinel;
var G__47450 = is_recursive;
reader = G__47447;
eof_is_error = G__47448;
sentinel = G__47449;
is_recursive = G__47450;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__47451 = cljs.reader.read_comment.call(null,reader,ch);
var G__47452 = eof_is_error;
var G__47453 = sentinel;
var G__47454 = is_recursive;
reader = G__47451;
eof_is_error = G__47452;
sentinel = G__47453;
is_recursive = G__47454;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__47455 = reader;
var G__47456 = eof_is_error;
var G__47457 = sentinel;
var G__47458 = is_recursive;
reader = G__47455;
eof_is_error = G__47456;
sentinel = G__47457;
is_recursive = G__47458;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__47461 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__47461,0,null);var years = cljs.core.nth.call(null,vec__47461,1,null);var months = cljs.core.nth.call(null,vec__47461,2,null);var days = cljs.core.nth.call(null,vec__47461,3,null);var hours = cljs.core.nth.call(null,vec__47461,4,null);var minutes = cljs.core.nth.call(null,vec__47461,5,null);var seconds = cljs.core.nth.call(null,vec__47461,6,null);var fraction = cljs.core.nth.call(null,vec__47461,7,null);var offset_sign = cljs.core.nth.call(null,vec__47461,8,null);var offset_hours = cljs.core.nth.call(null,vec__47461,9,null);var offset_minutes = cljs.core.nth.call(null,vec__47461,10,null);var v = vec__47461;if(cljs.core.not.call(null,v))
...
{var vec__47463 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__47463,0,null);var months = cljs.core.nth.call(null,vec__47463,1,null);var days = cljs.core.nth.call(null,vec__47463,2,null);var hours = cljs.core.nth.call(null,vec__47463,3,null);var minutes = cljs.core.nth.call(null,vec__47463,4,null);var seconds = cljs.core.nth.call(null,vec__47463,5,null);var ms = cljs.core.nth.call(null,vec__47463,6,null);var offset = cljs.core.nth.call(null,vec__47463,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
