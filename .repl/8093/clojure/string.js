...
{{
var G__47464 = cljs.core.pop.call(null,v__$1);
v__$1 = G__47464;
continue;
}
} else
...
{var pred__47468 = cljs.core._EQ_;var expr__47469 = limit;if(pred__47468.call(null,1,expr__47469))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__47468.call(null,2,expr__47469))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__47471 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__47472 = (limit__$1 - 1);
var G__47473 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__47471;
limit__$1 = G__47472;
parts = G__47473;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___47475 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___47475))
{var replacement_47476 = temp__4092__auto___47475;buffer.append([cljs.core.str(replacement_47476)].join(''));
} else
{buffer.append(ch);
}
{
var G__47477 = (index + 1);
index = G__47477;
continue;
}
}
