...
{var pred__9381 = cljs.core._EQ_;var expr__9382 = limit;if(pred__9381.call(null,1,expr__9382))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9381.call(null,2,expr__9382))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9389 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9390 = (limit__$1 - 1);
var G__9391 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9389;
limit__$1 = G__9390;
parts = G__9391;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9399 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9399))
{var replacement_9400 = temp__4092__auto___9399;buffer.append([cljs.core.str(replacement_9400)].join(''));
} else
{buffer.append(ch);
}
{
