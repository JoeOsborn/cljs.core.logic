...
{{
var G__17754 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17754;
continue;
}
} else
...
{var pred__17758 = cljs.core._EQ_;var expr__17759 = limit;if(pred__17758.call(null,1,expr__17759))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__17758.call(null,2,expr__17759))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__17761 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17762 = (limit__$1 - 1);
var G__17763 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17761;
limit__$1 = G__17762;
parts = G__17763;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___17765 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___17765))
{var replacement_17766 = temp__4092__auto___17765;buffer.append([cljs.core.str(replacement_17766)].join(''));
} else
{buffer.append(ch);
}
{
var G__17767 = (index + 1);
index = G__17767;
continue;
}
}
