...
{{
var G__260049 = cljs.core.pop.call(null,v__$1);
v__$1 = G__260049;
continue;
}
} else
...
{var pred__260053 = cljs.core._EQ_;var expr__260054 = limit;if(cljs.core.truth_(pred__260053.call(null,1,expr__260054)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__260053.call(null,2,expr__260054)))
...
var G__260056 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__260057 = (limit__$1 - 1);
var G__260058 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__260056;
limit__$1 = G__260057;
parts = G__260058;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___260060 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___260060))
{var replacement_260061 = temp__4096__auto___260060;buffer.append([cljs.core.str(replacement_260061)].join(''));
} else
{buffer.append(ch);
}
{
var G__260062 = (index + 1);
index = G__260062;
continue;
}
}
