...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj27459 = {};return obj27459;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__5125__auto__ = reader;if(and__5125__auto__)
...
{var x__5740__auto__ = (((reader == null))?null:reader);return (function (){var or__5137__auto__ = (cljs.reader.read_char[goog.typeOf(x__5740__auto__)]);if(or__5137__auto__)
{return or__5137__auto__;
} else
{var or__5137__auto____$1 = (cljs.reader.read_char["_"]);if(or__5137__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__5125__auto__ = reader;if(and__5125__auto__)
...
{var x__5740__auto__ = (((reader == null))?null:reader);return (function (){var or__5137__auto__ = (cljs.reader.unread[goog.typeOf(x__5740__auto__)]);if(or__5137__auto__)
{return or__5137__auto__;
} else
{var or__5137__auto____$1 = (cljs.reader.unread["_"]);if(or__5137__auto____$1)
{return or__5137__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__5681__auto__,writer__5682__auto__,opt__5683__auto__){return cljs.core._write.call(null,writer__5682__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__5137__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__27460){
var rdr = cljs.core.first(arglist__27460);
var msg = cljs.core.rest(arglist__27460);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__5125__auto__ = !((ch === "#"));if(and__5125__auto__)
{var and__5125__auto____$1 = !((ch === "'"));if(and__5125__auto____$1)
{var and__5125__auto____$2 = !((ch === ":"));if(and__5125__auto____$2)
...
{{
var G__27461 = (function (){sb.append(ch);
return sb;
})();
var G__27462 = cljs.reader.read_char.call(null,rdr);
sb = G__27461;
ch = G__27462;
continue;
}
...
{{
var G__27463 = cljs.reader.read_char.call(null,rdr);
ch = G__27463;
continue;
}
} else
...
var G__27464 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__27464;
continue;
}
} else
...
var G__27465 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__27465;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__5137__auto__ = (ch == null);if(or__5137__auto__)
{return or__5137__auto__;
} else
{var or__5137__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__5137__auto____$1)
{return or__5137__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__5137__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
...
{{
var G__27466 = (function (){buffer.append(ch);
return buffer;
})();
var G__27467 = cljs.reader.read_char.call(null,reader);
buffer = G__27466;
ch = G__27467;
continue;
}
...
{if(("\\" === ch))
{{
var G__27468 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__27469 = cljs.reader.read_char.call(null,reader);
buffer = G__27468;
ch = G__27469;
continue;
}
...
{{
var G__27470 = (function (){buffer.append(ch);
return buffer;
})();
var G__27471 = cljs.reader.read_char.call(null,reader);
buffer = G__27470;
ch = G__27471;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__27473 = o;if(G__27473)
{var bit__5763__auto__ = (G__27473.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5763__auto__) || (G__27473.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__27473.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__27473);
} else
{return false;
}
}
...
{{
var G__27474 = reader;
var G__27475 = eof_is_error;
var G__27476 = sentinel;
var G__27477 = is_recursive;
reader = G__27474;
eof_is_error = G__27475;
sentinel = G__27476;
is_recursive = G__27477;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__27478 = cljs.reader.read_comment.call(null,reader,ch);
var G__27479 = eof_is_error;
var G__27480 = sentinel;
var G__27481 = is_recursive;
reader = G__27478;
eof_is_error = G__27479;
sentinel = G__27480;
is_recursive = G__27481;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__27482 = reader;
var G__27483 = eof_is_error;
var G__27484 = sentinel;
var G__27485 = is_recursive;
reader = G__27482;
eof_is_error = G__27483;
sentinel = G__27484;
is_recursive = G__27485;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__27488 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__27488,0,null);var years = cljs.core.nth.call(null,vec__27488,1,null);var months = cljs.core.nth.call(null,vec__27488,2,null);var days = cljs.core.nth.call(null,vec__27488,3,null);var hours = cljs.core.nth.call(null,vec__27488,4,null);var minutes = cljs.core.nth.call(null,vec__27488,5,null);var seconds = cljs.core.nth.call(null,vec__27488,6,null);var fraction = cljs.core.nth.call(null,vec__27488,7,null);var offset_sign = cljs.core.nth.call(null,vec__27488,8,null);var offset_hours = cljs.core.nth.call(null,vec__27488,9,null);var offset_minutes = cljs.core.nth.call(null,vec__27488,10,null);var v = vec__27488;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__5137__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__5137__auto__))
{return or__5137__auto__;
} else
{return 0;
}
...
{var vec__27490 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__27490,0,null);var months = cljs.core.nth.call(null,vec__27490,1,null);var days = cljs.core.nth.call(null,vec__27490,2,null);var hours = cljs.core.nth.call(null,vec__27490,3,null);var minutes = cljs.core.nth.call(null,vec__27490,4,null);var seconds = cljs.core.nth.call(null,vec__27490,5,null);var ms = cljs.core.nth.call(null,vec__27490,6,null);var offset = cljs.core.nth.call(null,vec__27490,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
