...
{{
var G__27491 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27491;
continue;
}
} else
...
{var pred__27495 = cljs.core._EQ_;var expr__27496 = limit;if(cljs.core.truth_(pred__27495.call(null,1,expr__27496)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27495.call(null,2,expr__27496)))
...
var G__27498 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27499 = (limit__$1 - 1);
var G__27500 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27498;
limit__$1 = G__27499;
parts = G__27500;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___27502 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___27502))
{var replacement_27503 = temp__4096__auto___27502;buffer.append([cljs.core.str(replacement_27503)].join(''));
} else
{buffer.append(ch);
}
{
var G__27504 = (index + 1);
index = G__27504;
continue;
}
}
