...
{{
var G__265690 = cljs.core.pop.call(null,v__$1);
v__$1 = G__265690;
continue;
}
} else
...
{var pred__265694 = cljs.core._EQ_;var expr__265695 = limit;if(cljs.core.truth_(pred__265694.call(null,1,expr__265695)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__265694.call(null,2,expr__265695)))
...
var G__265697 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__265698 = (limit__$1 - 1);
var G__265699 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__265697;
limit__$1 = G__265698;
parts = G__265699;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___265701 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___265701))
{var replacement_265702 = temp__4096__auto___265701;buffer.append([cljs.core.str(replacement_265702)].join(''));
} else
{buffer.append(ch);
}
{
var G__265703 = (index + 1);
index = G__265703;
continue;
}
}
