...
{{
var G__10182 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10182;
continue;
}
} else
...
{var pred__10186 = cljs.core._EQ_;var expr__10187 = limit;if(pred__10186.call(null,1,expr__10187))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10186.call(null,2,expr__10187))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10189 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10190 = (limit__$1 - 1);
var G__10191 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10189;
limit__$1 = G__10190;
parts = G__10191;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10193 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10193))
{var replacement_10194 = temp__4092__auto___10193;buffer.append([cljs.core.str(replacement_10194)].join(''));
} else
{buffer.append(ch);
}
{
var G__10195 = (index + 1);
index = G__10195;
continue;
}
}
