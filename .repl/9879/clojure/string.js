...
{{
var G__663281 = cljs.core.pop.call(null,v__$1);
v__$1 = G__663281;
continue;
}
} else
...
{var pred__663285 = cljs.core._EQ_;var expr__663286 = limit;if(cljs.core.truth_(pred__663285.call(null,1,expr__663286)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__663285.call(null,2,expr__663286)))
...
var G__663288 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__663289 = (limit__$1 - 1);
var G__663290 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__663288;
limit__$1 = G__663289;
parts = G__663290;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___663292 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___663292))
{var replacement_663293 = temp__4096__auto___663292;buffer.append([cljs.core.str(replacement_663293)].join(''));
} else
{buffer.append(ch);
}
{
var G__663294 = (index + 1);
index = G__663294;
continue;
}
}
