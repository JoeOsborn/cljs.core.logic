...
{{
var G__591705 = cljs.core.pop.call(null,v__$1);
v__$1 = G__591705;
continue;
}
} else
...
{var pred__591709 = cljs.core._EQ_;var expr__591710 = limit;if(cljs.core.truth_(pred__591709.call(null,1,expr__591710)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__591709.call(null,2,expr__591710)))
...
var G__591712 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__591713 = (limit__$1 - 1);
var G__591714 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__591712;
limit__$1 = G__591713;
parts = G__591714;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___591716 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___591716))
{var replacement_591717 = temp__4096__auto___591716;buffer.append([cljs.core.str(replacement_591717)].join(''));
} else
{buffer.append(ch);
}
{
var G__591718 = (index + 1);
index = G__591718;
continue;
}
}
