...
{{
var G__59185 = cljs.core.pop.call(null,v__$1);
v__$1 = G__59185;
continue;
}
} else
...
{var pred__59189 = cljs.core._EQ_;var expr__59190 = limit;if(pred__59189.call(null,1,expr__59190))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__59189.call(null,2,expr__59190))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__59192 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__59193 = (limit__$1 - 1);
var G__59194 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__59192;
limit__$1 = G__59193;
parts = G__59194;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___59196 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___59196))
{var replacement_59197 = temp__4092__auto___59196;buffer.append([cljs.core.str(replacement_59197)].join(''));
} else
{buffer.append(ch);
}
{
var G__59198 = (index + 1);
index = G__59198;
continue;
}
}
