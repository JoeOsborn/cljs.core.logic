...
{{
var G__9322 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9322;
continue;
}
} else
...
{var pred__9326 = cljs.core._EQ_;var expr__9327 = limit;if(pred__9326.call(null,1,expr__9327))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9326.call(null,2,expr__9327))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9329 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9330 = (limit__$1 - 1);
var G__9331 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9329;
limit__$1 = G__9330;
parts = G__9331;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9333 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9333))
{var replacement_9334 = temp__4092__auto___9333;buffer.append([cljs.core.str(replacement_9334)].join(''));
} else
{buffer.append(ch);
}
{
