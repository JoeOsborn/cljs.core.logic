...
{{
var G__112208 = cljs.core.pop.call(null,v__$1);
v__$1 = G__112208;
continue;
}
} else
...
{var pred__112212 = cljs.core._EQ_;var expr__112213 = limit;if(cljs.core.truth_(pred__112212.call(null,1,expr__112213)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__112212.call(null,2,expr__112213)))
...
var G__112215 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__112216 = (limit__$1 - 1);
var G__112217 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__112215;
limit__$1 = G__112216;
parts = G__112217;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___112219 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___112219))
{var replacement_112220 = temp__4096__auto___112219;buffer.append([cljs.core.str(replacement_112220)].join(''));
} else
{buffer.append(ch);
}
{
var G__112221 = (index + 1);
index = G__112221;
continue;
}
}
