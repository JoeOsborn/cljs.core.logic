...
{{
var G__9351 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9351;
continue;
}
} else
...
{var pred__9355 = cljs.core._EQ_;var expr__9356 = limit;if(pred__9355.call(null,1,expr__9356))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9355.call(null,2,expr__9356))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9358 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9359 = (limit__$1 - 1);
var G__9360 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9358;
limit__$1 = G__9359;
parts = G__9360;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9362 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9362))
{var replacement_9363 = temp__4092__auto___9362;buffer.append([cljs.core.str(replacement_9363)].join(''));
} else
{buffer.append(ch);
}
{
