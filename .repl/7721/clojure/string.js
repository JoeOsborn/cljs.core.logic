...
{{
var G__73218 = cljs.core.pop.call(null,v__$1);
v__$1 = G__73218;
continue;
}
} else
...
{var pred__73222 = cljs.core._EQ_;var expr__73223 = limit;if(pred__73222.call(null,1,expr__73223))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__73222.call(null,2,expr__73223))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__73225 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__73226 = (limit__$1 - 1);
var G__73227 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__73225;
limit__$1 = G__73226;
parts = G__73227;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___73229 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___73229))
{var replacement_73230 = temp__4092__auto___73229;buffer.append([cljs.core.str(replacement_73230)].join(''));
} else
{buffer.append(ch);
}
{
var G__73231 = (index + 1);
index = G__73231;
continue;
}
}
