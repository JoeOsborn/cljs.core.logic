...
reader_error.cljs$lang$applyTo = (function (arglist__117970){
var rdr = cljs.core.first(arglist__117970);
var msg = cljs.core.rest(arglist__117970);
...
{{
var G__117971 = (function (){sb.append(ch);
return sb;
})();
var G__117972 = cljs.reader.read_char.call(null,rdr);
sb = G__117971;
ch = G__117972;
continue;
}
...
{{
var G__117973 = cljs.reader.read_char.call(null,rdr);
ch = G__117973;
continue;
}
} else
...
var G__117974 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__117974;
continue;
}
} else
...
var G__117975 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__117975;
continue;
}
}
...
{{
var G__117976 = (function (){buffer.append(ch);
return buffer;
})();
var G__117977 = cljs.reader.read_char.call(null,reader);
buffer = G__117976;
ch = G__117977;
continue;
}
...
{if(("\\" === ch))
{{
var G__117978 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__117979 = cljs.reader.read_char.call(null,reader);
buffer = G__117978;
ch = G__117979;
continue;
}
...
{{
var G__117980 = (function (){buffer.append(ch);
return buffer;
})();
var G__117981 = cljs.reader.read_char.call(null,reader);
buffer = G__117980;
ch = G__117981;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__117983 = o;if(G__117983)
{var bit__5323__auto__ = (G__117983.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__117983.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__117983.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__117983);
} else
{return false;
}
}
...
{{
var G__117984 = reader;
var G__117985 = eof_is_error;
var G__117986 = sentinel;
var G__117987 = is_recursive;
reader = G__117984;
eof_is_error = G__117985;
sentinel = G__117986;
is_recursive = G__117987;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__117988 = cljs.reader.read_comment.call(null,reader,ch);
var G__117989 = eof_is_error;
var G__117990 = sentinel;
var G__117991 = is_recursive;
reader = G__117988;
eof_is_error = G__117989;
sentinel = G__117990;
is_recursive = G__117991;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__117992 = reader;
var G__117993 = eof_is_error;
var G__117994 = sentinel;
var G__117995 = is_recursive;
reader = G__117992;
eof_is_error = G__117993;
sentinel = G__117994;
is_recursive = G__117995;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__117998 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__117998,0,null);var years = cljs.core.nth.call(null,vec__117998,1,null);var months = cljs.core.nth.call(null,vec__117998,2,null);var days = cljs.core.nth.call(null,vec__117998,3,null);var hours = cljs.core.nth.call(null,vec__117998,4,null);var minutes = cljs.core.nth.call(null,vec__117998,5,null);var seconds = cljs.core.nth.call(null,vec__117998,6,null);var fraction = cljs.core.nth.call(null,vec__117998,7,null);var offset_sign = cljs.core.nth.call(null,vec__117998,8,null);var offset_hours = cljs.core.nth.call(null,vec__117998,9,null);var offset_minutes = cljs.core.nth.call(null,vec__117998,10,null);var v = vec__117998;if(cljs.core.not.call(null,v))
...
{var vec__118000 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__118000,0,null);var months = cljs.core.nth.call(null,vec__118000,1,null);var days = cljs.core.nth.call(null,vec__118000,2,null);var hours = cljs.core.nth.call(null,vec__118000,3,null);var minutes = cljs.core.nth.call(null,vec__118000,4,null);var seconds = cljs.core.nth.call(null,vec__118000,5,null);var ms = cljs.core.nth.call(null,vec__118000,6,null);var offset = cljs.core.nth.call(null,vec__118000,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
