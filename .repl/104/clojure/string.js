...
{{
var G__117674 = cljs.core.pop.call(null,v__$1);
v__$1 = G__117674;
continue;
}
} else
...
{var pred__117678 = cljs.core._EQ_;var expr__117679 = limit;if(pred__117678.call(null,1,expr__117679))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__117678.call(null,2,expr__117679))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__117681 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__117682 = (limit__$1 - 1);
var G__117683 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__117681;
limit__$1 = G__117682;
parts = G__117683;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___117685 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___117685))
{var replacement_117686 = temp__4092__auto___117685;buffer.append([cljs.core.str(replacement_117686)].join(''));
} else
{buffer.append(ch);
}
{
var G__117687 = (index + 1);
index = G__117687;
continue;
}
}
