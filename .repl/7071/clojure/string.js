...
{{
var G__97685 = cljs.core.pop.call(null,v__$1);
v__$1 = G__97685;
continue;
}
} else
...
{var pred__97689 = cljs.core._EQ_;var expr__97690 = limit;if(cljs.core.truth_(pred__97689.call(null,1,expr__97690)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__97689.call(null,2,expr__97690)))
...
var G__97692 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__97693 = (limit__$1 - 1);
var G__97694 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__97692;
limit__$1 = G__97693;
parts = G__97694;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___97696 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___97696))
{var replacement_97697 = temp__4092__auto___97696;buffer.append([cljs.core.str(replacement_97697)].join(''));
} else
{buffer.append(ch);
}
{
var G__97698 = (index + 1);
index = G__97698;
continue;
}
}
