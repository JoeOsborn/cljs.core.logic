...
{{
var G__16351 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16351;
continue;
}
} else
...
{var pred__16355 = cljs.core._EQ_;var expr__16356 = limit;if(pred__16355.call(null,1,expr__16356))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__16355.call(null,2,expr__16356))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__16358 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16359 = (limit__$1 - 1);
var G__16360 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16358;
limit__$1 = G__16359;
parts = G__16360;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16362 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16362))
{var replacement_16363 = temp__4092__auto___16362;buffer.append([cljs.core.str(replacement_16363)].join(''));
} else
{buffer.append(ch);
}
{
var G__16364 = (index + 1);
index = G__16364;
continue;
}
}
