...
{{
var G__132390 = cljs.core.pop.call(null,v__$1);
v__$1 = G__132390;
continue;
}
} else
...
{var pred__132394 = cljs.core._EQ_;var expr__132395 = limit;if(pred__132394.call(null,1,expr__132395))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__132394.call(null,2,expr__132395))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__132397 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__132398 = (limit__$1 - 1);
var G__132399 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__132397;
limit__$1 = G__132398;
parts = G__132399;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___132401 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___132401))
{var replacement_132402 = temp__4092__auto___132401;buffer.append([cljs.core.str(replacement_132402)].join(''));
} else
{buffer.append(ch);
}
{
var G__132403 = (index + 1);
index = G__132403;
continue;
}
}
