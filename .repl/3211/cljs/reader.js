...
reader_error.cljs$lang$applyTo = (function (arglist__132686){
var rdr = cljs.core.first(arglist__132686);
var msg = cljs.core.rest(arglist__132686);
...
{{
var G__132687 = (function (){sb.append(ch);
return sb;
})();
var G__132688 = cljs.reader.read_char.call(null,rdr);
sb = G__132687;
ch = G__132688;
continue;
}
...
{{
var G__132689 = cljs.reader.read_char.call(null,rdr);
ch = G__132689;
continue;
}
} else
...
var G__132690 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__132690;
continue;
}
} else
...
var G__132691 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__132691;
continue;
}
}
...
{{
var G__132692 = (function (){buffer.append(ch);
return buffer;
})();
var G__132693 = cljs.reader.read_char.call(null,reader);
buffer = G__132692;
ch = G__132693;
continue;
}
...
{if(("\\" === ch))
{{
var G__132694 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__132695 = cljs.reader.read_char.call(null,reader);
buffer = G__132694;
ch = G__132695;
continue;
}
...
{{
var G__132696 = (function (){buffer.append(ch);
return buffer;
})();
var G__132697 = cljs.reader.read_char.call(null,reader);
buffer = G__132696;
ch = G__132697;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__132699 = o;if(G__132699)
{var bit__5323__auto__ = (G__132699.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__132699.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__132699.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__132699);
} else
{return false;
}
}
...
{{
var G__132700 = reader;
var G__132701 = eof_is_error;
var G__132702 = sentinel;
var G__132703 = is_recursive;
reader = G__132700;
eof_is_error = G__132701;
sentinel = G__132702;
is_recursive = G__132703;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__132704 = cljs.reader.read_comment.call(null,reader,ch);
var G__132705 = eof_is_error;
var G__132706 = sentinel;
var G__132707 = is_recursive;
reader = G__132704;
eof_is_error = G__132705;
sentinel = G__132706;
is_recursive = G__132707;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__132708 = reader;
var G__132709 = eof_is_error;
var G__132710 = sentinel;
var G__132711 = is_recursive;
reader = G__132708;
eof_is_error = G__132709;
sentinel = G__132710;
is_recursive = G__132711;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__132714 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__132714,0,null);var years = cljs.core.nth.call(null,vec__132714,1,null);var months = cljs.core.nth.call(null,vec__132714,2,null);var days = cljs.core.nth.call(null,vec__132714,3,null);var hours = cljs.core.nth.call(null,vec__132714,4,null);var minutes = cljs.core.nth.call(null,vec__132714,5,null);var seconds = cljs.core.nth.call(null,vec__132714,6,null);var fraction = cljs.core.nth.call(null,vec__132714,7,null);var offset_sign = cljs.core.nth.call(null,vec__132714,8,null);var offset_hours = cljs.core.nth.call(null,vec__132714,9,null);var offset_minutes = cljs.core.nth.call(null,vec__132714,10,null);var v = vec__132714;if(cljs.core.not.call(null,v))
...
{var vec__132716 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__132716,0,null);var months = cljs.core.nth.call(null,vec__132716,1,null);var days = cljs.core.nth.call(null,vec__132716,2,null);var hours = cljs.core.nth.call(null,vec__132716,3,null);var minutes = cljs.core.nth.call(null,vec__132716,4,null);var seconds = cljs.core.nth.call(null,vec__132716,5,null);var ms = cljs.core.nth.call(null,vec__132716,6,null);var offset = cljs.core.nth.call(null,vec__132716,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
