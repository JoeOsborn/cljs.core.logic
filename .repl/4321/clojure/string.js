...
{{
var G__37661 = cljs.core.pop.call(null,v__$1);
v__$1 = G__37661;
continue;
}
} else
...
{var pred__37665 = cljs.core._EQ_;var expr__37666 = limit;if(pred__37665.call(null,1,expr__37666))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__37665.call(null,2,expr__37666))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__37668 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__37669 = (limit__$1 - 1);
var G__37670 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__37668;
limit__$1 = G__37669;
parts = G__37670;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___37672 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___37672))
{var replacement_37673 = temp__4092__auto___37672;buffer.append([cljs.core.str(replacement_37673)].join(''));
} else
{buffer.append(ch);
}
{
var G__37674 = (index + 1);
index = G__37674;
continue;
}
}
