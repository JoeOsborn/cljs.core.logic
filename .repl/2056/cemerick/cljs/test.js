...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__31910 = m;var map__31910__$1 = ((cljs.core.seq_QMARK_.call(null,map__31910))?cljs.core.apply.call(null,cljs.core.hash_map,map__31910):map__31910);var line = cljs.core.get.call(null,map__31910__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__31910__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__31912 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__31912))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__31912))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_31913;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_31914 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_31914;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_31915 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___31916 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___31916))
{var message_31917 = temp__4094__auto___31916;cljs.core.println.call(null,message_31917);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_31915;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_31918 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___31919 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___31919))
{var message_31920 = temp__4094__auto___31919;cljs.core.println.call(null,message_31920);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_31918;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_31921 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_31921;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_31922 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_31922;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__31923){
var ns_sym = cljs.core.first(arglist__31923);
arglist__31923 = cljs.core.next(arglist__31923);
var fixture_type = cljs.core.first(arglist__31923);
var fixture_fns = cljs.core.rest(arglist__31923);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_31926 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__5132__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e31927){if((e31927 instanceof Error))
{var e_31928 = e31927;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_31928], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e31927;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_31926;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__31933 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__31934 = null;var count__31935 = 0;var i__31936 = 0;while(true){
if((i__31936 < count__31935))
{var v = cljs.core._nth.call(null,chunk__31934,i__31936);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__31933,chunk__31934,count__31935,i__31936,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__31933,chunk__31934,count__31935,i__31936,v))
);
} else
{}
{
var G__31937 = seq__31933;
var G__31938 = chunk__31934;
var G__31939 = count__31935;
var G__31940 = (i__31936 + 1);
seq__31933 = G__31937;
chunk__31934 = G__31938;
count__31935 = G__31939;
i__31936 = G__31940;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__31933);if(temp__4094__auto__)
{var seq__31933__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__31933__$1))
{var c__5851__auto__ = cljs.core.chunk_first.call(null,seq__31933__$1);{
var G__31941 = cljs.core.chunk_rest.call(null,seq__31933__$1);
var G__31942 = c__5851__auto__;
var G__31943 = cljs.core.count.call(null,c__5851__auto__);
var G__31944 = 0;
seq__31933 = G__31941;
chunk__31934 = G__31942;
count__31935 = G__31943;
i__31936 = G__31944;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__31933__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__31933,chunk__31934,count__31935,i__31936,v,seq__31933__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__31933,chunk__31934,count__31935,i__31936,v,seq__31933__$1,temp__4094__auto__))
);
} else
{}
{
var G__31945 = cljs.core.next.call(null,seq__31933__$1);
var G__31946 = null;
var G__31947 = 0;
var G__31948 = 0;
seq__31933 = G__31945;
chunk__31934 = G__31946;
count__31935 = G__31947;
i__31936 = G__31948;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_31950 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___31951 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___31951))
{var test_hook_31952 = temp__4092__auto___31951;test_hook_31952.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_31950;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__31953){
var namespaces = cljs.core.seq(arglist__31953);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__31954_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__31954_SHARP_));
