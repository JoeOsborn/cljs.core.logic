...
{{
var G__30534 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30534;
continue;
}
} else
...
{var pred__30538 = cljs.core._EQ_;var expr__30539 = limit;if(cljs.core.truth_(pred__30538.call(null,1,expr__30539)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__30538.call(null,2,expr__30539)))
...
var G__30541 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30542 = (limit__$1 - 1);
var G__30543 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__30541;
limit__$1 = G__30542;
parts = G__30543;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___30545 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___30545))
{var replacement_30546 = temp__4092__auto___30545;buffer.append([cljs.core.str(replacement_30546)].join(''));
} else
{buffer.append(ch);
}
{
var G__30547 = (index + 1);
index = G__30547;
continue;
}
}
