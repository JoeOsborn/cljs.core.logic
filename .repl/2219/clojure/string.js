...
{{
var G__25603 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25603;
continue;
}
} else
...
{var pred__25607 = cljs.core._EQ_;var expr__25608 = limit;if(cljs.core.truth_(pred__25607.call(null,1,expr__25608)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__25607.call(null,2,expr__25608)))
...
var G__25610 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25611 = (limit__$1 - 1);
var G__25612 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25610;
limit__$1 = G__25611;
parts = G__25612;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___25614 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___25614))
{var replacement_25615 = temp__4092__auto___25614;buffer.append([cljs.core.str(replacement_25615)].join(''));
} else
{buffer.append(ch);
}
{
var G__25616 = (index + 1);
index = G__25616;
continue;
}
}
