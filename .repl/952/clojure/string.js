...
{{
var G__10502 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10502;
continue;
}
} else
...
{var pred__10506 = cljs.core._EQ_;var expr__10507 = limit;if(pred__10506.call(null,1,expr__10507))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10506.call(null,2,expr__10507))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10509 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10510 = (limit__$1 - 1);
var G__10511 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10509;
limit__$1 = G__10510;
parts = G__10511;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10513 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10513))
{var replacement_10514 = temp__4092__auto___10513;buffer.append([cljs.core.str(replacement_10514)].join(''));
} else
{buffer.append(ch);
}
{
var G__10515 = (index + 1);
index = G__10515;
continue;
}
}
