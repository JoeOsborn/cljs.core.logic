...
cljs.core.logic.pldb.facts_for = (function facts_for(dbs,kname){return cljs.core.mapcat.call(null,(function (p1__10126_SHARP_){return cljs.core.get_in.call(null,p1__10126_SHARP_,cljs.core.PersistentVector.fromArray([kname,new cljs.core.Keyword("cljs.core.logic.pldb","unindexed","cljs.core.logic.pldb/unindexed",3813484278)], true));
}),dbs);
});
cljs.core.logic.pldb.facts_using_index = (function facts_using_index(dbs,kname,index,val){return cljs.core.mapcat.call(null,(function (p1__10127_SHARP_){return cljs.core.get_in.call(null,p1__10127_SHARP_,cljs.core.PersistentVector.fromArray([kname,index,val], true));
}),dbs);
});
...
cljs.core.logic.pldb.index_for_query = (function index_for_query(s,q,indexes){var indexable = cljs.core.map.call(null,(function (p1__10128_SHARP_){return cljs.core.logic.pldb.ground_QMARK_.call(null,s,p1__10128_SHARP_);
}),q);var triples = cljs.core.map.call(null,cljs.core.vector,cljs.core.range.call(null),indexable,indexes);return cljs.core.first.call(null,(function (){var iter__5390__auto__ = (function iter__10137(s__10138){return (new cljs.core.LazySeq(null,(function (){var s__10138__$1 = s__10138;while(true){
var temp__4094__auto__ = cljs.core.seq.call(null,s__10138__$1);if(temp__4094__auto__)
{var s__10138__$2 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__10138__$2))
{var c__5388__auto__ = cljs.core.chunk_first.call(null,s__10138__$2);var size__5389__auto__ = cljs.core.count.call(null,c__5388__auto__);var b__10140 = cljs.core.chunk_buffer.call(null,size__5389__auto__);if((function (){var i__10139 = 0;while(true){
if((i__10139 < size__5389__auto__))
{var vec__10143 = cljs.core._nth.call(null,c__5388__auto__,i__10139);var i = cljs.core.nth.call(null,vec__10143,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__10143,1,null);var indexed = cljs.core.nth.call(null,vec__10143,2,null);if(cljs.core.truth_((function (){var and__4695__auto__ = indexable__$1;if(cljs.core.truth_(and__4695__auto__))
{return indexed;
} else
{return and__4695__auto__;
}
})()))
{cljs.core.chunk_append.call(null,b__10140,i);
{
var G__10145 = (i__10139 + 1);
i__10139 = G__10145;
continue;
}
} else
{{
var G__10146 = (i__10139 + 1);
i__10139 = G__10146;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10140),iter__10137.call(null,cljs.core.chunk_rest.call(null,s__10138__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10140),null);
}
} else
{var vec__10144 = cljs.core.first.call(null,s__10138__$2);var i = cljs.core.nth.call(null,vec__10144,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__10144,1,null);var indexed = cljs.core.nth.call(null,vec__10144,2,null);if(cljs.core.truth_((function (){var and__4695__auto__ = indexable__$1;if(cljs.core.truth_(and__4695__auto__))
{return indexed;
} else
{return and__4695__auto__;
}
})()))
{return cljs.core.cons.call(null,i,iter__10137.call(null,cljs.core.rest.call(null,s__10138__$2)));
} else
{{
var G__10147 = cljs.core.rest.call(null,s__10138__$2);
s__10138__$1 = G__10147;
continue;
}
}
}
...
return (function (p1__10148_SHARP_){return add_to_set.call(null,p1__10148_SHARP_,args);
});})(key,add_to_set))
...
return (function (db__$1,p__10152){var vec__10153 = p__10152;var is_indexed = cljs.core.nth.call(null,vec__10153,0,null);var index_num = cljs.core.nth.call(null,vec__10153,1,null);var val = cljs.core.nth.call(null,vec__10153,2,null);if(cljs.core.truth_(is_indexed))
{return cljs.core.update_in.call(null,db__$1,cljs.core.PersistentVector.fromArray([key,index_num,val], true),((function (vec__10153,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update){
return (function (p1__10149_SHARP_){return add_to_set.call(null,p1__10149_SHARP_,args);
});})(vec__10153,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update))
);
} else
{return db__$1;
}
...
db_fact.cljs$lang$applyTo = (function (arglist__10154){
var db = cljs.core.first(arglist__10154);
arglist__10154 = cljs.core.next(arglist__10154);
var rel = cljs.core.first(arglist__10154);
...
return (function (p1__10155_SHARP_){return cljs.core.disj.call(null,p1__10155_SHARP_,args);
});})(key))
...
return (function (db__$1,p__10158){var vec__10159 = p__10158;var is_indexed = cljs.core.nth.call(null,vec__10159,0,null);var index_num = cljs.core.nth.call(null,vec__10159,1,null);var val = cljs.core.nth.call(null,vec__10159,2,null);if(cljs.core.truth_(is_indexed))
...
db_retraction.cljs$lang$applyTo = (function (arglist__10160){
var db = cljs.core.first(arglist__10160);
arglist__10160 = cljs.core.next(arglist__10160);
var rel = cljs.core.first(arglist__10160);
...
var db_facts__delegate = function (base_db,facts){return cljs.core.reduce.call(null,(function (p1__10161_SHARP_,p2__10162_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_fact,p1__10161_SHARP_,p2__10162_SHARP_);
}),base_db,facts);
};
...
db_facts.cljs$lang$applyTo = (function (arglist__10163){
var base_db = cljs.core.first(arglist__10163);
var facts = cljs.core.rest(arglist__10163);
...
db.cljs$lang$applyTo = (function (arglist__10164){
var facts = cljs.core.seq(arglist__10164);
...
var db_retractions__delegate = function (base_db,retractions){return cljs.core.reduce.call(null,(function (p1__10165_SHARP_,p2__10166_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_retraction,p1__10165_SHARP_,p2__10166_SHARP_);
}),base_db,retractions);
};
...
db_retractions.cljs$lang$applyTo = (function (arglist__10167){
var base_db = cljs.core.first(arglist__10167);
var retractions = cljs.core.rest(arglist__10167);
