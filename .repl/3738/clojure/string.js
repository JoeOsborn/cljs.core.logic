...
{{
var G__161750 = cljs.core.pop.call(null,v__$1);
v__$1 = G__161750;
continue;
}
} else
...
{var pred__161754 = cljs.core._EQ_;var expr__161755 = limit;if(cljs.core.truth_(pred__161754.call(null,1,expr__161755)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__161754.call(null,2,expr__161755)))
...
var G__161757 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__161758 = (limit__$1 - 1);
var G__161759 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__161757;
limit__$1 = G__161758;
parts = G__161759;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___161761 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___161761))
{var replacement_161762 = temp__4096__auto___161761;buffer.append([cljs.core.str(replacement_161762)].join(''));
} else
{buffer.append(ch);
}
{
var G__161763 = (index + 1);
index = G__161763;
continue;
}
}
