...
{{
var G__127318 = cljs.core.pop.call(null,v__$1);
v__$1 = G__127318;
continue;
}
} else
...
{var pred__127322 = cljs.core._EQ_;var expr__127323 = limit;if(cljs.core.truth_(pred__127322.call(null,1,expr__127323)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__127322.call(null,2,expr__127323)))
...
var G__127325 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__127326 = (limit__$1 - 1);
var G__127327 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__127325;
limit__$1 = G__127326;
parts = G__127327;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___127329 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___127329))
{var replacement_127330 = temp__4096__auto___127329;buffer.append([cljs.core.str(replacement_127330)].join(''));
} else
{buffer.append(ch);
}
{
var G__127331 = (index + 1);
index = G__127331;
continue;
}
}
