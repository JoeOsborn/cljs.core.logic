...
{{
var G__631875 = cljs.core.pop.call(null,v__$1);
v__$1 = G__631875;
continue;
}
} else
...
{var pred__631879 = cljs.core._EQ_;var expr__631880 = limit;if(cljs.core.truth_(pred__631879.call(null,1,expr__631880)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__631879.call(null,2,expr__631880)))
...
var G__631882 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__631883 = (limit__$1 - 1);
var G__631884 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__631882;
limit__$1 = G__631883;
parts = G__631884;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___631886 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___631886))
{var replacement_631887 = temp__4096__auto___631886;buffer.append([cljs.core.str(replacement_631887)].join(''));
} else
{buffer.append(ch);
}
{
var G__631888 = (index + 1);
index = G__631888;
continue;
}
}
