...
{{
var G__667981 = cljs.core.pop.call(null,v__$1);
v__$1 = G__667981;
continue;
}
} else
...
{var pred__667985 = cljs.core._EQ_;var expr__667986 = limit;if(cljs.core.truth_(pred__667985.call(null,1,expr__667986)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__667985.call(null,2,expr__667986)))
...
var G__667988 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__667989 = (limit__$1 - 1);
var G__667990 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__667988;
limit__$1 = G__667989;
parts = G__667990;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___667992 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___667992))
{var replacement_667993 = temp__4096__auto___667992;buffer.append([cljs.core.str(replacement_667993)].join(''));
} else
{buffer.append(ch);
}
{
var G__667994 = (index + 1);
index = G__667994;
continue;
}
}
