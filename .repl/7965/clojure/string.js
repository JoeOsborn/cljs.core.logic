...
{{
var G__604768 = cljs.core.pop.call(null,v__$1);
v__$1 = G__604768;
continue;
}
} else
...
{var pred__604772 = cljs.core._EQ_;var expr__604773 = limit;if(cljs.core.truth_(pred__604772.call(null,1,expr__604773)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__604772.call(null,2,expr__604773)))
...
var G__604775 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__604776 = (limit__$1 - 1);
var G__604777 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__604775;
limit__$1 = G__604776;
parts = G__604777;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___604779 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___604779))
{var replacement_604780 = temp__4096__auto___604779;buffer.append([cljs.core.str(replacement_604780)].join(''));
} else
{buffer.append(ch);
}
{
var G__604781 = (index + 1);
index = G__604781;
continue;
}
}
