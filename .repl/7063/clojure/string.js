...
{{
var G__57608 = cljs.core.pop.call(null,v__$1);
v__$1 = G__57608;
continue;
}
} else
...
{var pred__57612 = cljs.core._EQ_;var expr__57613 = limit;if(cljs.core.truth_(pred__57612.call(null,1,expr__57613)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__57612.call(null,2,expr__57613)))
...
var G__57615 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__57616 = (limit__$1 - 1);
var G__57617 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__57615;
limit__$1 = G__57616;
parts = G__57617;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___57619 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___57619))
{var replacement_57620 = temp__4096__auto___57619;buffer.append([cljs.core.str(replacement_57620)].join(''));
} else
{buffer.append(ch);
}
{
var G__57621 = (index + 1);
index = G__57621;
continue;
}
}
