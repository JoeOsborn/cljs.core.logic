...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__161679 = m;var map__161679__$1 = ((cljs.core.seq_QMARK_.call(null,map__161679))?cljs.core.apply.call(null,cljs.core.hash_map,map__161679):map__161679);var line = cljs.core.get.call(null,map__161679__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__161679__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__161681 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__161681))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__161681))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_161682;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_161683 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_161683;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_161684 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___161685 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___161685))
{var message_161686 = temp__4098__auto___161685;cljs.core.println.call(null,message_161686);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_161684;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_161687 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___161688 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___161688))
{var message_161689 = temp__4098__auto___161688;cljs.core.println.call(null,message_161689);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_161687;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_161690 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_161690;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_161691 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_161691;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__161692){
var ns_sym = cljs.core.first(arglist__161692);
arglist__161692 = cljs.core.next(arglist__161692);
var fixture_type = cljs.core.first(arglist__161692);
var fixture_fns = cljs.core.rest(arglist__161692);
...
try{t.call(null);
}catch (e161696){if((e161696 instanceof Error))
{var e_161697 = e161696;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_161697], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e161696;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_161695;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__161702 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__161703 = null;var count__161704 = 0;var i__161705 = 0;while(true){
if((i__161705 < count__161704))
{var v = cljs.core._nth.call(null,chunk__161703,i__161705);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__161702,chunk__161703,count__161704,i__161705,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__161702,chunk__161703,count__161704,i__161705,v))
);
} else
{}
{
var G__161706 = seq__161702;
var G__161707 = chunk__161703;
var G__161708 = count__161704;
var G__161709 = (i__161705 + 1);
seq__161702 = G__161706;
chunk__161703 = G__161707;
count__161704 = G__161708;
i__161705 = G__161709;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__161702);if(temp__4098__auto__)
{var seq__161702__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__161702__$1))
{var c__7569__auto__ = cljs.core.chunk_first.call(null,seq__161702__$1);{
var G__161710 = cljs.core.chunk_rest.call(null,seq__161702__$1);
var G__161711 = c__7569__auto__;
var G__161712 = cljs.core.count.call(null,c__7569__auto__);
var G__161713 = 0;
seq__161702 = G__161710;
chunk__161703 = G__161711;
count__161704 = G__161712;
i__161705 = G__161713;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__161702__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__161702,chunk__161703,count__161704,i__161705,v,seq__161702__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__161702,chunk__161703,count__161704,i__161705,v,seq__161702__$1,temp__4098__auto__))
);
} else
{}
{
var G__161714 = cljs.core.next.call(null,seq__161702__$1);
var G__161715 = null;
var G__161716 = 0;
var G__161717 = 0;
seq__161702 = G__161714;
chunk__161703 = G__161715;
count__161704 = G__161716;
i__161705 = G__161717;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_161719 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___161720 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___161720))
{var test_hook_161721 = temp__4096__auto___161720;test_hook_161721.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_161719;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__161722){
var namespaces = cljs.core.seq(arglist__161722);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__161723_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__161723_SHARP_));
