...
{{
var G__159477 = cljs.core.pop.call(null,v__$1);
v__$1 = G__159477;
continue;
}
} else
...
{var pred__159481 = cljs.core._EQ_;var expr__159482 = limit;if(cljs.core.truth_(pred__159481.call(null,1,expr__159482)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__159481.call(null,2,expr__159482)))
...
var G__159484 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__159485 = (limit__$1 - 1);
var G__159486 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__159484;
limit__$1 = G__159485;
parts = G__159486;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___159488 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___159488))
{var replacement_159489 = temp__4096__auto___159488;buffer.append([cljs.core.str(replacement_159489)].join(''));
} else
{buffer.append(ch);
}
{
var G__159490 = (index + 1);
index = G__159490;
continue;
}
}
