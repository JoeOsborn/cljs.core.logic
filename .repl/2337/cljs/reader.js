...
reader_error.cljs$lang$applyTo = (function (arglist__12209){
var rdr = cljs.core.first(arglist__12209);
var msg = cljs.core.rest(arglist__12209);
...
{{
var G__12210 = (function (){sb.append(ch);
return sb;
})();
var G__12211 = cljs.reader.read_char.call(null,rdr);
sb = G__12210;
ch = G__12211;
continue;
}
...
{{
var G__12212 = cljs.reader.read_char.call(null,rdr);
ch = G__12212;
continue;
}
} else
...
var G__12213 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__12213;
continue;
}
} else
...
var G__12214 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__12214;
continue;
}
}
...
{{
var G__12215 = (function (){buffer.append(ch);
return buffer;
})();
var G__12216 = cljs.reader.read_char.call(null,reader);
buffer = G__12215;
ch = G__12216;
continue;
}
...
{if(("\\" === ch))
{{
var G__12217 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__12218 = cljs.reader.read_char.call(null,reader);
buffer = G__12217;
ch = G__12218;
continue;
}
...
{{
var G__12219 = (function (){buffer.append(ch);
return buffer;
})();
var G__12220 = cljs.reader.read_char.call(null,reader);
buffer = G__12219;
ch = G__12220;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__12222 = o;if(G__12222)
{var bit__5323__auto__ = (G__12222.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__12222.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__12222.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__12222);
} else
{return false;
}
}
...
{{
var G__12223 = reader;
var G__12224 = eof_is_error;
var G__12225 = sentinel;
var G__12226 = is_recursive;
reader = G__12223;
eof_is_error = G__12224;
sentinel = G__12225;
is_recursive = G__12226;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__12227 = cljs.reader.read_comment.call(null,reader,ch);
var G__12228 = eof_is_error;
var G__12229 = sentinel;
var G__12230 = is_recursive;
reader = G__12227;
eof_is_error = G__12228;
sentinel = G__12229;
is_recursive = G__12230;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__12231 = reader;
var G__12232 = eof_is_error;
var G__12233 = sentinel;
var G__12234 = is_recursive;
reader = G__12231;
eof_is_error = G__12232;
sentinel = G__12233;
is_recursive = G__12234;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__12237 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__12237,0,null);var years = cljs.core.nth.call(null,vec__12237,1,null);var months = cljs.core.nth.call(null,vec__12237,2,null);var days = cljs.core.nth.call(null,vec__12237,3,null);var hours = cljs.core.nth.call(null,vec__12237,4,null);var minutes = cljs.core.nth.call(null,vec__12237,5,null);var seconds = cljs.core.nth.call(null,vec__12237,6,null);var fraction = cljs.core.nth.call(null,vec__12237,7,null);var offset_sign = cljs.core.nth.call(null,vec__12237,8,null);var offset_hours = cljs.core.nth.call(null,vec__12237,9,null);var offset_minutes = cljs.core.nth.call(null,vec__12237,10,null);var v = vec__12237;if(cljs.core.not.call(null,v))
...
{var vec__12239 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__12239,0,null);var months = cljs.core.nth.call(null,vec__12239,1,null);var days = cljs.core.nth.call(null,vec__12239,2,null);var hours = cljs.core.nth.call(null,vec__12239,3,null);var minutes = cljs.core.nth.call(null,vec__12239,4,null);var seconds = cljs.core.nth.call(null,vec__12239,5,null);var ms = cljs.core.nth.call(null,vec__12239,6,null);var offset = cljs.core.nth.call(null,vec__12239,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
