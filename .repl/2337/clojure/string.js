...
{{
var G__12240 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12240;
continue;
}
} else
...
{var pred__12244 = cljs.core._EQ_;var expr__12245 = limit;if(pred__12244.call(null,1,expr__12245))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__12244.call(null,2,expr__12245))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__12247 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12248 = (limit__$1 - 1);
var G__12249 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12247;
limit__$1 = G__12248;
parts = G__12249;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___12251 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___12251))
{var replacement_12252 = temp__4092__auto___12251;buffer.append([cljs.core.str(replacement_12252)].join(''));
} else
{buffer.append(ch);
}
{
