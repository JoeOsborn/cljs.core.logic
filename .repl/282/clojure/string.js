...
{{
var G__9321 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9321;
continue;
}
} else
...
{var pred__9325 = cljs.core._EQ_;var expr__9326 = limit;if(pred__9325.call(null,1,expr__9326))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9325.call(null,2,expr__9326))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9328 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9329 = (limit__$1 - 1);
var G__9330 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9328;
limit__$1 = G__9329;
parts = G__9330;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9332 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9332))
{var replacement_9333 = temp__4092__auto___9332;buffer.append([cljs.core.str(replacement_9333)].join(''));
} else
{buffer.append(ch);
}
{
