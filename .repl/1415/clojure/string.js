...
{{
var G__8415 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8415;
continue;
}
} else
...
{var pred__8419 = cljs.core._EQ_;var expr__8420 = limit;if(pred__8419.call(null,1,expr__8420))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__8419.call(null,2,expr__8420))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__8422 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8423 = (limit__$1 - 1);
var G__8424 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8422;
limit__$1 = G__8423;
parts = G__8424;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___8426 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___8426))
{var replacement_8427 = temp__4092__auto___8426;buffer.append([cljs.core.str(replacement_8427)].join(''));
} else
{buffer.append(ch);
}
{
