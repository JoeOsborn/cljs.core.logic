...
{{
var G__26182 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26182;
continue;
}
} else
...
{var pred__26186 = cljs.core._EQ_;var expr__26187 = limit;if(cljs.core.truth_(pred__26186.call(null,1,expr__26187)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26186.call(null,2,expr__26187)))
...
var G__26189 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26190 = (limit__$1 - 1);
var G__26191 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26189;
limit__$1 = G__26190;
parts = G__26191;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___26193 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___26193))
{var replacement_26194 = temp__4096__auto___26193;buffer.append([cljs.core.str(replacement_26194)].join(''));
} else
{buffer.append(ch);
}
{
var G__26195 = (index + 1);
index = G__26195;
continue;
}
}
