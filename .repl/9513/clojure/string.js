...
{{
var G__144519 = cljs.core.pop.call(null,v__$1);
v__$1 = G__144519;
continue;
}
} else
...
{var pred__144523 = cljs.core._EQ_;var expr__144524 = limit;if(pred__144523.call(null,1,expr__144524))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__144523.call(null,2,expr__144524))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__144526 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__144527 = (limit__$1 - 1);
var G__144528 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__144526;
limit__$1 = G__144527;
parts = G__144528;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___144530 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___144530))
{var replacement_144531 = temp__4092__auto___144530;buffer.append([cljs.core.str(replacement_144531)].join(''));
} else
{buffer.append(ch);
}
{
var G__144532 = (index + 1);
index = G__144532;
continue;
}
}
