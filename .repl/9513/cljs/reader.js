...
reader_error.cljs$lang$applyTo = (function (arglist__144815){
var rdr = cljs.core.first(arglist__144815);
var msg = cljs.core.rest(arglist__144815);
...
{{
var G__144816 = (function (){sb.append(ch);
return sb;
})();
var G__144817 = cljs.reader.read_char.call(null,rdr);
sb = G__144816;
ch = G__144817;
continue;
}
...
{{
var G__144818 = cljs.reader.read_char.call(null,rdr);
ch = G__144818;
continue;
}
} else
...
var G__144819 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__144819;
continue;
}
} else
...
var G__144820 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__144820;
continue;
}
}
...
{{
var G__144821 = (function (){buffer.append(ch);
return buffer;
})();
var G__144822 = cljs.reader.read_char.call(null,reader);
buffer = G__144821;
ch = G__144822;
continue;
}
...
{if(("\\" === ch))
{{
var G__144823 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__144824 = cljs.reader.read_char.call(null,reader);
buffer = G__144823;
ch = G__144824;
continue;
}
...
{{
var G__144825 = (function (){buffer.append(ch);
return buffer;
})();
var G__144826 = cljs.reader.read_char.call(null,reader);
buffer = G__144825;
ch = G__144826;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__144828 = o;if(G__144828)
{var bit__5323__auto__ = (G__144828.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__144828.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__144828.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__144828);
} else
{return false;
}
}
...
{{
var G__144829 = reader;
var G__144830 = eof_is_error;
var G__144831 = sentinel;
var G__144832 = is_recursive;
reader = G__144829;
eof_is_error = G__144830;
sentinel = G__144831;
is_recursive = G__144832;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__144833 = cljs.reader.read_comment.call(null,reader,ch);
var G__144834 = eof_is_error;
var G__144835 = sentinel;
var G__144836 = is_recursive;
reader = G__144833;
eof_is_error = G__144834;
sentinel = G__144835;
is_recursive = G__144836;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__144837 = reader;
var G__144838 = eof_is_error;
var G__144839 = sentinel;
var G__144840 = is_recursive;
reader = G__144837;
eof_is_error = G__144838;
sentinel = G__144839;
is_recursive = G__144840;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__144843 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__144843,0,null);var years = cljs.core.nth.call(null,vec__144843,1,null);var months = cljs.core.nth.call(null,vec__144843,2,null);var days = cljs.core.nth.call(null,vec__144843,3,null);var hours = cljs.core.nth.call(null,vec__144843,4,null);var minutes = cljs.core.nth.call(null,vec__144843,5,null);var seconds = cljs.core.nth.call(null,vec__144843,6,null);var fraction = cljs.core.nth.call(null,vec__144843,7,null);var offset_sign = cljs.core.nth.call(null,vec__144843,8,null);var offset_hours = cljs.core.nth.call(null,vec__144843,9,null);var offset_minutes = cljs.core.nth.call(null,vec__144843,10,null);var v = vec__144843;if(cljs.core.not.call(null,v))
...
{var vec__144845 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__144845,0,null);var months = cljs.core.nth.call(null,vec__144845,1,null);var days = cljs.core.nth.call(null,vec__144845,2,null);var hours = cljs.core.nth.call(null,vec__144845,3,null);var minutes = cljs.core.nth.call(null,vec__144845,4,null);var seconds = cljs.core.nth.call(null,vec__144845,5,null);var ms = cljs.core.nth.call(null,vec__144845,6,null);var offset = cljs.core.nth.call(null,vec__144845,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
