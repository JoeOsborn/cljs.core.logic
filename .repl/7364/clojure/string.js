...
{{
var G__217282 = cljs.core.pop.call(null,v__$1);
v__$1 = G__217282;
continue;
}
} else
...
{var pred__217286 = cljs.core._EQ_;var expr__217287 = limit;if(cljs.core.truth_(pred__217286.call(null,1,expr__217287)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__217286.call(null,2,expr__217287)))
...
var G__217289 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__217290 = (limit__$1 - 1);
var G__217291 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__217289;
limit__$1 = G__217290;
parts = G__217291;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___217293 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___217293))
{var replacement_217294 = temp__4096__auto___217293;buffer.append([cljs.core.str(replacement_217294)].join(''));
} else
{buffer.append(ch);
}
{
var G__217295 = (index + 1);
index = G__217295;
continue;
}
}
