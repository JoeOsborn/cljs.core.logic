...
{{
var G__17028 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17028;
continue;
}
} else
...
{var pred__17032 = cljs.core._EQ_;var expr__17033 = limit;if(cljs.core.truth_(pred__17032.call(null,1,expr__17033)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__17032.call(null,2,expr__17033)))
...
var G__17035 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17036 = (limit__$1 - 1);
var G__17037 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17035;
limit__$1 = G__17036;
parts = G__17037;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___17039 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___17039))
{var replacement_17040 = temp__4096__auto___17039;buffer.append([cljs.core.str(replacement_17040)].join(''));
} else
{buffer.append(ch);
}
{
