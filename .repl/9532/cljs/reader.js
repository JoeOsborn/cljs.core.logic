...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj16996 = {};return obj16996;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__16997){
var rdr = cljs.core.first(arglist__16997);
var msg = cljs.core.rest(arglist__16997);
...
{{
var G__16998 = (function (){sb.append(ch);
return sb;
})();
var G__16999 = cljs.reader.read_char.call(null,rdr);
sb = G__16998;
ch = G__16999;
continue;
}
...
{{
var G__17000 = cljs.reader.read_char.call(null,rdr);
ch = G__17000;
continue;
}
} else
...
var G__17001 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__17001;
continue;
}
} else
...
var G__17002 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__17002;
continue;
}
}
...
{{
var G__17003 = (function (){buffer.append(ch);
return buffer;
})();
var G__17004 = cljs.reader.read_char.call(null,reader);
buffer = G__17003;
ch = G__17004;
continue;
}
...
{if(("\\" === ch))
{{
var G__17005 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__17007 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__17010 = o;if(G__17010)
{var bit__5763__auto__ = (G__17010.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5763__auto__) || (G__17010.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__17010.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__17010);
} else
{return false;
}
}
...
{{
var G__17011 = reader;
var G__17012 = eof_is_error;
var G__17013 = sentinel;
var G__17014 = is_recursive;
reader = G__17011;
eof_is_error = G__17012;
sentinel = G__17013;
is_recursive = G__17014;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__17015 = cljs.reader.read_comment.call(null,reader,ch);
var G__17016 = eof_is_error;
var G__17017 = sentinel;
var G__17018 = is_recursive;
reader = G__17015;
eof_is_error = G__17016;
sentinel = G__17017;
is_recursive = G__17018;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__17019 = reader;
var G__17020 = eof_is_error;
var G__17021 = sentinel;
var G__17022 = is_recursive;
reader = G__17019;
eof_is_error = G__17020;
sentinel = G__17021;
is_recursive = G__17022;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__17025 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__17025,0,null);var years = cljs.core.nth.call(null,vec__17025,1,null);var months = cljs.core.nth.call(null,vec__17025,2,null);var days = cljs.core.nth.call(null,vec__17025,3,null);var hours = cljs.core.nth.call(null,vec__17025,4,null);var minutes = cljs.core.nth.call(null,vec__17025,5,null);var seconds = cljs.core.nth.call(null,vec__17025,6,null);var fraction = cljs.core.nth.call(null,vec__17025,7,null);var offset_sign = cljs.core.nth.call(null,vec__17025,8,null);var offset_hours = cljs.core.nth.call(null,vec__17025,9,null);var offset_minutes = cljs.core.nth.call(null,vec__17025,10,null);var v = vec__17025;if(cljs.core.not.call(null,v))
...
{var vec__17027 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__17027,0,null);var months = cljs.core.nth.call(null,vec__17027,1,null);var days = cljs.core.nth.call(null,vec__17027,2,null);var hours = cljs.core.nth.call(null,vec__17027,3,null);var minutes = cljs.core.nth.call(null,vec__17027,4,null);var seconds = cljs.core.nth.call(null,vec__17027,5,null);var ms = cljs.core.nth.call(null,vec__17027,6,null);var offset = cljs.core.nth.call(null,vec__17027,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
