...
{{
var G__60713 = cljs.core.pop.call(null,v__$1);
v__$1 = G__60713;
continue;
}
} else
...
{var pred__60717 = cljs.core._EQ_;var expr__60718 = limit;if(cljs.core.truth_(pred__60717.call(null,1,expr__60718)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__60717.call(null,2,expr__60718)))
...
var G__60720 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__60721 = (limit__$1 - 1);
var G__60722 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__60720;
limit__$1 = G__60721;
parts = G__60722;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___60724 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___60724))
{var replacement_60725 = temp__4096__auto___60724;buffer.append([cljs.core.str(replacement_60725)].join(''));
} else
{buffer.append(ch);
}
{
var G__60726 = (index + 1);
index = G__60726;
continue;
}
}
