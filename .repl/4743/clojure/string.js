...
{{
var G__17074 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17074;
continue;
}
} else
...
{var pred__17078 = cljs.core._EQ_;var expr__17079 = limit;if(cljs.core.truth_(pred__17078.call(null,1,expr__17079)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__17078.call(null,2,expr__17079)))
...
var G__17081 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17082 = (limit__$1 - 1);
var G__17083 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17081;
limit__$1 = G__17082;
parts = G__17083;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___17085 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___17085))
{var replacement_17086 = temp__4096__auto___17085;buffer.append([cljs.core.str(replacement_17086)].join(''));
} else
{buffer.append(ch);
}
{
var G__17087 = (index + 1);
index = G__17087;
continue;
}
}
