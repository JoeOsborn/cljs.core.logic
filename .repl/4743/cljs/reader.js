...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj17466 = {};return obj17466;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__10550__auto__ = reader;if(and__10550__auto__)
...
{var x__11165__auto__ = (((reader == null))?null:reader);return (function (){var or__10562__auto__ = (cljs.reader.read_char[goog.typeOf(x__11165__auto__)]);if(or__10562__auto__)
{return or__10562__auto__;
} else
{var or__10562__auto____$1 = (cljs.reader.read_char["_"]);if(or__10562__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__10550__auto__ = reader;if(and__10550__auto__)
...
{var x__11165__auto__ = (((reader == null))?null:reader);return (function (){var or__10562__auto__ = (cljs.reader.unread[goog.typeOf(x__11165__auto__)]);if(or__10562__auto__)
{return or__10562__auto__;
} else
{var or__10562__auto____$1 = (cljs.reader.unread["_"]);if(or__10562__auto____$1)
{return or__10562__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__11106__auto__,writer__11107__auto__,opt__11108__auto__){return cljs.core._write.call(null,writer__11107__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__10562__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__17467){
var rdr = cljs.core.first(arglist__17467);
var msg = cljs.core.rest(arglist__17467);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__10550__auto__ = !((ch === "#"));if(and__10550__auto__)
{var and__10550__auto____$1 = !((ch === "'"));if(and__10550__auto____$1)
{var and__10550__auto____$2 = !((ch === ":"));if(and__10550__auto____$2)
...
{{
var G__17468 = (function (){sb.append(ch);
return sb;
})();
var G__17469 = cljs.reader.read_char.call(null,rdr);
sb = G__17468;
ch = G__17469;
continue;
}
...
{{
var G__17470 = cljs.reader.read_char.call(null,rdr);
ch = G__17470;
continue;
}
} else
...
var G__17471 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__17471;
continue;
}
} else
...
var G__17472 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__17472;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__10562__auto__ = (ch == null);if(or__10562__auto__)
{return or__10562__auto__;
} else
{var or__10562__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__10562__auto____$1)
{return or__10562__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__10562__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
...
{{
var G__17473 = (function (){buffer.append(ch);
return buffer;
})();
var G__17474 = cljs.reader.read_char.call(null,reader);
buffer = G__17473;
ch = G__17474;
continue;
}
...
{if(("\\" === ch))
{{
var G__17475 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__17476 = cljs.reader.read_char.call(null,reader);
buffer = G__17475;
ch = G__17476;
continue;
}
...
{{
var G__17477 = (function (){buffer.append(ch);
return buffer;
})();
var G__17478 = cljs.reader.read_char.call(null,reader);
buffer = G__17477;
ch = G__17478;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__17480 = o;if(G__17480)
{var bit__11188__auto__ = (G__17480.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11188__auto__) || (G__17480.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__17480.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__17480);
} else
{return false;
}
}
...
{{
var G__17481 = reader;
var G__17482 = eof_is_error;
var G__17483 = sentinel;
var G__17484 = is_recursive;
reader = G__17481;
eof_is_error = G__17482;
sentinel = G__17483;
is_recursive = G__17484;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__17485 = cljs.reader.read_comment.call(null,reader,ch);
var G__17486 = eof_is_error;
var G__17487 = sentinel;
var G__17488 = is_recursive;
reader = G__17485;
eof_is_error = G__17486;
sentinel = G__17487;
is_recursive = G__17488;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__17489 = reader;
var G__17490 = eof_is_error;
var G__17491 = sentinel;
var G__17492 = is_recursive;
reader = G__17489;
eof_is_error = G__17490;
sentinel = G__17491;
is_recursive = G__17492;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__17495 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__17495,0,null);var years = cljs.core.nth.call(null,vec__17495,1,null);var months = cljs.core.nth.call(null,vec__17495,2,null);var days = cljs.core.nth.call(null,vec__17495,3,null);var hours = cljs.core.nth.call(null,vec__17495,4,null);var minutes = cljs.core.nth.call(null,vec__17495,5,null);var seconds = cljs.core.nth.call(null,vec__17495,6,null);var fraction = cljs.core.nth.call(null,vec__17495,7,null);var offset_sign = cljs.core.nth.call(null,vec__17495,8,null);var offset_hours = cljs.core.nth.call(null,vec__17495,9,null);var offset_minutes = cljs.core.nth.call(null,vec__17495,10,null);var v = vec__17495;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__10562__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__10562__auto__))
{return or__10562__auto__;
} else
{return 0;
}
...
{var vec__17497 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__17497,0,null);var months = cljs.core.nth.call(null,vec__17497,1,null);var days = cljs.core.nth.call(null,vec__17497,2,null);var hours = cljs.core.nth.call(null,vec__17497,3,null);var minutes = cljs.core.nth.call(null,vec__17497,4,null);var seconds = cljs.core.nth.call(null,vec__17497,5,null);var ms = cljs.core.nth.call(null,vec__17497,6,null);var offset = cljs.core.nth.call(null,vec__17497,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
