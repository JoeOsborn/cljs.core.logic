...
reader_error.cljs$lang$applyTo = (function (arglist__139960){
var rdr = cljs.core.first(arglist__139960);
var msg = cljs.core.rest(arglist__139960);
...
{{
var G__139961 = (function (){sb.append(ch);
return sb;
})();
var G__139962 = cljs.reader.read_char.call(null,rdr);
sb = G__139961;
ch = G__139962;
continue;
}
...
{{
var G__139963 = cljs.reader.read_char.call(null,rdr);
ch = G__139963;
continue;
}
} else
...
var G__139964 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__139964;
continue;
}
} else
...
var G__139965 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__139965;
continue;
}
}
...
{{
var G__139966 = (function (){buffer.append(ch);
return buffer;
})();
var G__139967 = cljs.reader.read_char.call(null,reader);
buffer = G__139966;
ch = G__139967;
continue;
}
...
{if(("\\" === ch))
{{
var G__139968 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__139969 = cljs.reader.read_char.call(null,reader);
buffer = G__139968;
ch = G__139969;
continue;
}
...
{{
var G__139970 = (function (){buffer.append(ch);
return buffer;
})();
var G__139971 = cljs.reader.read_char.call(null,reader);
buffer = G__139970;
ch = G__139971;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__139973 = o;if(G__139973)
{var bit__5323__auto__ = (G__139973.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__139973.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__139973.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__139973);
} else
{return false;
}
}
...
{{
var G__139974 = reader;
var G__139975 = eof_is_error;
var G__139976 = sentinel;
var G__139977 = is_recursive;
reader = G__139974;
eof_is_error = G__139975;
sentinel = G__139976;
is_recursive = G__139977;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__139978 = cljs.reader.read_comment.call(null,reader,ch);
var G__139979 = eof_is_error;
var G__139980 = sentinel;
var G__139981 = is_recursive;
reader = G__139978;
eof_is_error = G__139979;
sentinel = G__139980;
is_recursive = G__139981;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__139982 = reader;
var G__139983 = eof_is_error;
var G__139984 = sentinel;
var G__139985 = is_recursive;
reader = G__139982;
eof_is_error = G__139983;
sentinel = G__139984;
is_recursive = G__139985;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__139988 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__139988,0,null);var years = cljs.core.nth.call(null,vec__139988,1,null);var months = cljs.core.nth.call(null,vec__139988,2,null);var days = cljs.core.nth.call(null,vec__139988,3,null);var hours = cljs.core.nth.call(null,vec__139988,4,null);var minutes = cljs.core.nth.call(null,vec__139988,5,null);var seconds = cljs.core.nth.call(null,vec__139988,6,null);var fraction = cljs.core.nth.call(null,vec__139988,7,null);var offset_sign = cljs.core.nth.call(null,vec__139988,8,null);var offset_hours = cljs.core.nth.call(null,vec__139988,9,null);var offset_minutes = cljs.core.nth.call(null,vec__139988,10,null);var v = vec__139988;if(cljs.core.not.call(null,v))
...
{var vec__139990 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__139990,0,null);var months = cljs.core.nth.call(null,vec__139990,1,null);var days = cljs.core.nth.call(null,vec__139990,2,null);var hours = cljs.core.nth.call(null,vec__139990,3,null);var minutes = cljs.core.nth.call(null,vec__139990,4,null);var seconds = cljs.core.nth.call(null,vec__139990,5,null);var ms = cljs.core.nth.call(null,vec__139990,6,null);var offset = cljs.core.nth.call(null,vec__139990,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
