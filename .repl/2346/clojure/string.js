...
{{
var G__139664 = cljs.core.pop.call(null,v__$1);
v__$1 = G__139664;
continue;
}
} else
...
{var pred__139668 = cljs.core._EQ_;var expr__139669 = limit;if(pred__139668.call(null,1,expr__139669))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__139668.call(null,2,expr__139669))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__139671 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__139672 = (limit__$1 - 1);
var G__139673 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__139671;
limit__$1 = G__139672;
parts = G__139673;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___139675 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___139675))
{var replacement_139676 = temp__4092__auto___139675;buffer.append([cljs.core.str(replacement_139676)].join(''));
} else
{buffer.append(ch);
}
{
var G__139677 = (index + 1);
index = G__139677;
continue;
}
}
