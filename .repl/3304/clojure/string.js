...
{{
var G__243075 = cljs.core.pop.call(null,v__$1);
v__$1 = G__243075;
continue;
}
} else
...
{var pred__243079 = cljs.core._EQ_;var expr__243080 = limit;if(pred__243079.call(null,1,expr__243080))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__243079.call(null,2,expr__243080))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__243082 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__243083 = (limit__$1 - 1);
var G__243084 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__243082;
limit__$1 = G__243083;
parts = G__243084;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___243086 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___243086))
{var replacement_243087 = temp__4092__auto___243086;buffer.append([cljs.core.str(replacement_243087)].join(''));
} else
{buffer.append(ch);
}
{
var G__243088 = (index + 1);
index = G__243088;
continue;
}
}
