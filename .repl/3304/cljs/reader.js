...
reader_error.cljs$lang$applyTo = (function (arglist__243371){
var rdr = cljs.core.first(arglist__243371);
var msg = cljs.core.rest(arglist__243371);
...
{{
var G__243372 = (function (){sb.append(ch);
return sb;
})();
var G__243373 = cljs.reader.read_char.call(null,rdr);
sb = G__243372;
ch = G__243373;
continue;
}
...
{{
var G__243374 = cljs.reader.read_char.call(null,rdr);
ch = G__243374;
continue;
}
} else
...
var G__243375 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__243375;
continue;
}
} else
...
var G__243376 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__243376;
continue;
}
}
...
{{
var G__243377 = (function (){buffer.append(ch);
return buffer;
})();
var G__243378 = cljs.reader.read_char.call(null,reader);
buffer = G__243377;
ch = G__243378;
continue;
}
...
{if(("\\" === ch))
{{
var G__243379 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__243380 = cljs.reader.read_char.call(null,reader);
buffer = G__243379;
ch = G__243380;
continue;
}
...
{{
var G__243381 = (function (){buffer.append(ch);
return buffer;
})();
var G__243382 = cljs.reader.read_char.call(null,reader);
buffer = G__243381;
ch = G__243382;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__243384 = o;if(G__243384)
{var bit__5323__auto__ = (G__243384.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__243384.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__243384.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__243384);
} else
{return false;
}
}
...
{{
var G__243385 = reader;
var G__243386 = eof_is_error;
var G__243387 = sentinel;
var G__243388 = is_recursive;
reader = G__243385;
eof_is_error = G__243386;
sentinel = G__243387;
is_recursive = G__243388;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__243389 = cljs.reader.read_comment.call(null,reader,ch);
var G__243390 = eof_is_error;
var G__243391 = sentinel;
var G__243392 = is_recursive;
reader = G__243389;
eof_is_error = G__243390;
sentinel = G__243391;
is_recursive = G__243392;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__243393 = reader;
var G__243394 = eof_is_error;
var G__243395 = sentinel;
var G__243396 = is_recursive;
reader = G__243393;
eof_is_error = G__243394;
sentinel = G__243395;
is_recursive = G__243396;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__243399 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__243399,0,null);var years = cljs.core.nth.call(null,vec__243399,1,null);var months = cljs.core.nth.call(null,vec__243399,2,null);var days = cljs.core.nth.call(null,vec__243399,3,null);var hours = cljs.core.nth.call(null,vec__243399,4,null);var minutes = cljs.core.nth.call(null,vec__243399,5,null);var seconds = cljs.core.nth.call(null,vec__243399,6,null);var fraction = cljs.core.nth.call(null,vec__243399,7,null);var offset_sign = cljs.core.nth.call(null,vec__243399,8,null);var offset_hours = cljs.core.nth.call(null,vec__243399,9,null);var offset_minutes = cljs.core.nth.call(null,vec__243399,10,null);var v = vec__243399;if(cljs.core.not.call(null,v))
...
{var vec__243401 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__243401,0,null);var months = cljs.core.nth.call(null,vec__243401,1,null);var days = cljs.core.nth.call(null,vec__243401,2,null);var hours = cljs.core.nth.call(null,vec__243401,3,null);var minutes = cljs.core.nth.call(null,vec__243401,4,null);var seconds = cljs.core.nth.call(null,vec__243401,5,null);var ms = cljs.core.nth.call(null,vec__243401,6,null);var offset = cljs.core.nth.call(null,vec__243401,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
