...
{{
var G__68305 = cljs.core.pop.call(null,v__$1);
v__$1 = G__68305;
continue;
}
} else
...
{var pred__68309 = cljs.core._EQ_;var expr__68310 = limit;if(cljs.core.truth_(pred__68309.call(null,1,expr__68310)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__68309.call(null,2,expr__68310)))
...
var G__68312 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__68313 = (limit__$1 - 1);
var G__68314 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__68312;
limit__$1 = G__68313;
parts = G__68314;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___68316 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___68316))
{var replacement_68317 = temp__4096__auto___68316;buffer.append([cljs.core.str(replacement_68317)].join(''));
} else
{buffer.append(ch);
}
{
var G__68318 = (index + 1);
index = G__68318;
continue;
}
}
