...
{{
var G__19433 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19433;
continue;
}
} else
...
{var pred__19437 = cljs.core._EQ_;var expr__19438 = limit;if(pred__19437.call(null,1,expr__19438))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__19437.call(null,2,expr__19438))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__19440 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19441 = (limit__$1 - 1);
var G__19442 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19440;
limit__$1 = G__19441;
parts = G__19442;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___19444 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___19444))
{var replacement_19445 = temp__4092__auto___19444;buffer.append([cljs.core.str(replacement_19445)].join(''));
} else
{buffer.append(ch);
}
{
var G__19446 = (index + 1);
index = G__19446;
continue;
}
}
