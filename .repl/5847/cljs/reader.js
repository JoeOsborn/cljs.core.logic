...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__4976__auto__ = reader;if(and__4976__auto__)
...
{var x__5581__auto__ = (((reader == null))?null:reader);return (function (){var or__4985__auto__ = (cljs.reader.read_char[goog.typeOf(x__5581__auto__)]);if(or__4985__auto__)
{return or__4985__auto__;
} else
{var or__4985__auto____$1 = (cljs.reader.read_char["_"]);if(or__4985__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__4976__auto__ = reader;if(and__4976__auto__)
...
{var x__5581__auto__ = (((reader == null))?null:reader);return (function (){var or__4985__auto__ = (cljs.reader.unread[goog.typeOf(x__5581__auto__)]);if(or__4985__auto__)
{return or__4985__auto__;
} else
{var or__4985__auto____$1 = (cljs.reader.unread["_"]);if(or__4985__auto____$1)
{return or__4985__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__5522__auto__,writer__5523__auto__,opt__5524__auto__){return cljs.core._write.call(null,writer__5523__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__4985__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__19402){
var rdr = cljs.core.first(arglist__19402);
var msg = cljs.core.rest(arglist__19402);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__4976__auto__ = !((ch === "#"));if(and__4976__auto__)
{var and__4976__auto____$1 = !((ch === "'"));if(and__4976__auto____$1)
{var and__4976__auto____$2 = !((ch === ":"));if(and__4976__auto____$2)
...
{{
var G__19403 = (function (){sb.append(ch);
return sb;
})();
var G__19404 = cljs.reader.read_char.call(null,rdr);
sb = G__19403;
ch = G__19404;
continue;
}
...
{{
var G__19405 = cljs.reader.read_char.call(null,rdr);
ch = G__19405;
continue;
}
} else
...
var G__19406 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__19406;
continue;
}
} else
...
var G__19407 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__19407;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__4985__auto__ = (ch == null);if(or__4985__auto__)
{return or__4985__auto__;
} else
{var or__4985__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__4985__auto____$1)
{return or__4985__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__4985__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
...
{{
var G__19408 = (function (){buffer.append(ch);
return buffer;
})();
var G__19409 = cljs.reader.read_char.call(null,reader);
buffer = G__19408;
ch = G__19409;
continue;
}
...
{if(("\\" === ch))
{{
var G__19410 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__19411 = cljs.reader.read_char.call(null,reader);
buffer = G__19410;
ch = G__19411;
continue;
}
...
{{
var G__19412 = (function (){buffer.append(ch);
return buffer;
})();
var G__19413 = cljs.reader.read_char.call(null,reader);
buffer = G__19412;
ch = G__19413;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__19415 = o;if(G__19415)
{var bit__5604__auto__ = (G__19415.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5604__auto__) || (G__19415.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__19415.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__19415);
} else
{return false;
}
}
...
{{
var G__19416 = reader;
var G__19417 = eof_is_error;
var G__19418 = sentinel;
var G__19419 = is_recursive;
reader = G__19416;
eof_is_error = G__19417;
sentinel = G__19418;
is_recursive = G__19419;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__19420 = cljs.reader.read_comment.call(null,reader,ch);
var G__19421 = eof_is_error;
var G__19422 = sentinel;
var G__19423 = is_recursive;
reader = G__19420;
eof_is_error = G__19421;
sentinel = G__19422;
is_recursive = G__19423;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__19424 = reader;
var G__19425 = eof_is_error;
var G__19426 = sentinel;
var G__19427 = is_recursive;
reader = G__19424;
eof_is_error = G__19425;
sentinel = G__19426;
is_recursive = G__19427;
continue;
}
} else
{return res;
...
cljs.reader.leap_year_QMARK_ = (function leap_year_QMARK_(year){var and__4976__auto__ = cljs.reader.divisible_QMARK_.call(null,year,4);if(cljs.core.truth_(and__4976__auto__))
{var or__4985__auto__ = cljs.reader.indivisible_QMARK_.call(null,year,100);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__19430 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__19430,0,null);var years = cljs.core.nth.call(null,vec__19430,1,null);var months = cljs.core.nth.call(null,vec__19430,2,null);var days = cljs.core.nth.call(null,vec__19430,3,null);var hours = cljs.core.nth.call(null,vec__19430,4,null);var minutes = cljs.core.nth.call(null,vec__19430,5,null);var seconds = cljs.core.nth.call(null,vec__19430,6,null);var fraction = cljs.core.nth.call(null,vec__19430,7,null);var offset_sign = cljs.core.nth.call(null,vec__19430,8,null);var offset_hours = cljs.core.nth.call(null,vec__19430,9,null);var offset_minutes = cljs.core.nth.call(null,vec__19430,10,null);var v = vec__19430;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__4985__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__4985__auto__))
{return or__4985__auto__;
} else
{return 0;
}
...
{var vec__19432 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__19432,0,null);var months = cljs.core.nth.call(null,vec__19432,1,null);var days = cljs.core.nth.call(null,vec__19432,2,null);var hours = cljs.core.nth.call(null,vec__19432,3,null);var minutes = cljs.core.nth.call(null,vec__19432,4,null);var seconds = cljs.core.nth.call(null,vec__19432,5,null);var ms = cljs.core.nth.call(null,vec__19432,6,null);var offset = cljs.core.nth.call(null,vec__19432,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
