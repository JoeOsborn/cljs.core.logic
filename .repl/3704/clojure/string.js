...
{{
var G__38688 = cljs.core.pop.call(null,v__$1);
v__$1 = G__38688;
continue;
}
} else
...
{var pred__38692 = cljs.core._EQ_;var expr__38693 = limit;if(pred__38692.call(null,1,expr__38693))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__38692.call(null,2,expr__38693))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__38695 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__38696 = (limit__$1 - 1);
var G__38697 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__38695;
limit__$1 = G__38696;
parts = G__38697;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___38699 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___38699))
{var replacement_38700 = temp__4092__auto___38699;buffer.append([cljs.core.str(replacement_38700)].join(''));
} else
{buffer.append(ch);
}
{
var G__38701 = (index + 1);
index = G__38701;
continue;
}
}
