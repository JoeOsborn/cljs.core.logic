...
reader_error.cljs$lang$applyTo = (function (arglist__38657){
var rdr = cljs.core.first(arglist__38657);
var msg = cljs.core.rest(arglist__38657);
...
{{
var G__38658 = (function (){sb.append(ch);
return sb;
})();
var G__38659 = cljs.reader.read_char.call(null,rdr);
sb = G__38658;
ch = G__38659;
continue;
}
...
{{
var G__38660 = cljs.reader.read_char.call(null,rdr);
ch = G__38660;
continue;
}
} else
...
var G__38661 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__38661;
continue;
}
} else
...
var G__38662 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__38662;
continue;
}
}
...
{{
var G__38663 = (function (){buffer.append(ch);
return buffer;
})();
var G__38664 = cljs.reader.read_char.call(null,reader);
buffer = G__38663;
ch = G__38664;
continue;
}
...
{if(("\\" === ch))
{{
var G__38665 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__38666 = cljs.reader.read_char.call(null,reader);
buffer = G__38665;
ch = G__38666;
continue;
}
...
{{
var G__38667 = (function (){buffer.append(ch);
return buffer;
})();
var G__38668 = cljs.reader.read_char.call(null,reader);
buffer = G__38667;
ch = G__38668;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__38670 = o;if(G__38670)
{var bit__5323__auto__ = (G__38670.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__38670.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__38670.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__38670);
} else
{return false;
}
}
...
{{
var G__38671 = reader;
var G__38672 = eof_is_error;
var G__38673 = sentinel;
var G__38674 = is_recursive;
reader = G__38671;
eof_is_error = G__38672;
sentinel = G__38673;
is_recursive = G__38674;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__38675 = cljs.reader.read_comment.call(null,reader,ch);
var G__38676 = eof_is_error;
var G__38677 = sentinel;
var G__38678 = is_recursive;
reader = G__38675;
eof_is_error = G__38676;
sentinel = G__38677;
is_recursive = G__38678;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__38679 = reader;
var G__38680 = eof_is_error;
var G__38681 = sentinel;
var G__38682 = is_recursive;
reader = G__38679;
eof_is_error = G__38680;
sentinel = G__38681;
is_recursive = G__38682;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__38685 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__38685,0,null);var years = cljs.core.nth.call(null,vec__38685,1,null);var months = cljs.core.nth.call(null,vec__38685,2,null);var days = cljs.core.nth.call(null,vec__38685,3,null);var hours = cljs.core.nth.call(null,vec__38685,4,null);var minutes = cljs.core.nth.call(null,vec__38685,5,null);var seconds = cljs.core.nth.call(null,vec__38685,6,null);var fraction = cljs.core.nth.call(null,vec__38685,7,null);var offset_sign = cljs.core.nth.call(null,vec__38685,8,null);var offset_hours = cljs.core.nth.call(null,vec__38685,9,null);var offset_minutes = cljs.core.nth.call(null,vec__38685,10,null);var v = vec__38685;if(cljs.core.not.call(null,v))
...
{var vec__38687 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__38687,0,null);var months = cljs.core.nth.call(null,vec__38687,1,null);var days = cljs.core.nth.call(null,vec__38687,2,null);var hours = cljs.core.nth.call(null,vec__38687,3,null);var minutes = cljs.core.nth.call(null,vec__38687,4,null);var seconds = cljs.core.nth.call(null,vec__38687,5,null);var ms = cljs.core.nth.call(null,vec__38687,6,null);var offset = cljs.core.nth.call(null,vec__38687,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
