...
{{
var G__82238 = cljs.core.pop.call(null,v__$1);
v__$1 = G__82238;
continue;
}
} else
...
{var pred__82242 = cljs.core._EQ_;var expr__82243 = limit;if(cljs.core.truth_(pred__82242.call(null,1,expr__82243)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__82242.call(null,2,expr__82243)))
...
var G__82245 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__82246 = (limit__$1 - 1);
var G__82247 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__82245;
limit__$1 = G__82246;
parts = G__82247;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___82249 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___82249))
{var replacement_82250 = temp__4096__auto___82249;buffer.append([cljs.core.str(replacement_82250)].join(''));
} else
{buffer.append(ch);
}
{
var G__82251 = (index + 1);
index = G__82251;
continue;
}
}
