...
{{
var G__55325 = cljs.core.pop.call(null,v__$1);
v__$1 = G__55325;
continue;
}
} else
...
{var pred__55329 = cljs.core._EQ_;var expr__55330 = limit;if(pred__55329.call(null,1,expr__55330))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__55329.call(null,2,expr__55330))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__55332 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__55333 = (limit__$1 - 1);
var G__55334 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__55332;
limit__$1 = G__55333;
parts = G__55334;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___55336 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___55336))
{var replacement_55337 = temp__4092__auto___55336;buffer.append([cljs.core.str(replacement_55337)].join(''));
} else
{buffer.append(ch);
}
{
var G__55338 = (index + 1);
index = G__55338;
continue;
}
}
