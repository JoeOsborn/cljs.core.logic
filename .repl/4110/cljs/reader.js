...
reader_error.cljs$lang$applyTo = (function (arglist__55294){
var rdr = cljs.core.first(arglist__55294);
var msg = cljs.core.rest(arglist__55294);
...
{{
var G__55295 = (function (){sb.append(ch);
return sb;
})();
...
{{
var G__55297 = cljs.reader.read_char.call(null,rdr);
ch = G__55297;
continue;
}
} else
...
var G__55298 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__55298;
continue;
}
} else
...
var G__55299 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__55299;
continue;
}
}
...
{{
var G__55300 = (function (){buffer.append(ch);
return buffer;
})();
var G__55301 = cljs.reader.read_char.call(null,reader);
buffer = G__55300;
ch = G__55301;
continue;
}
...
{if(("\\" === ch))
{{
var G__55302 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__55303 = cljs.reader.read_char.call(null,reader);
buffer = G__55302;
ch = G__55303;
continue;
}
...
{{
var G__55304 = (function (){buffer.append(ch);
return buffer;
})();
var G__55305 = cljs.reader.read_char.call(null,reader);
buffer = G__55304;
ch = G__55305;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__55307 = o;if(G__55307)
{var bit__5323__auto__ = (G__55307.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__55307.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__55307.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__55307);
} else
{return false;
}
}
...
{{
var G__55308 = reader;
var G__55309 = eof_is_error;
var G__55310 = sentinel;
var G__55311 = is_recursive;
reader = G__55308;
eof_is_error = G__55309;
sentinel = G__55310;
is_recursive = G__55311;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__55312 = cljs.reader.read_comment.call(null,reader,ch);
var G__55313 = eof_is_error;
var G__55314 = sentinel;
var G__55315 = is_recursive;
reader = G__55312;
eof_is_error = G__55313;
sentinel = G__55314;
is_recursive = G__55315;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__55316 = reader;
var G__55317 = eof_is_error;
var G__55318 = sentinel;
var G__55319 = is_recursive;
reader = G__55316;
eof_is_error = G__55317;
sentinel = G__55318;
is_recursive = G__55319;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__55322 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__55322,0,null);var years = cljs.core.nth.call(null,vec__55322,1,null);var months = cljs.core.nth.call(null,vec__55322,2,null);var days = cljs.core.nth.call(null,vec__55322,3,null);var hours = cljs.core.nth.call(null,vec__55322,4,null);var minutes = cljs.core.nth.call(null,vec__55322,5,null);var seconds = cljs.core.nth.call(null,vec__55322,6,null);var fraction = cljs.core.nth.call(null,vec__55322,7,null);var offset_sign = cljs.core.nth.call(null,vec__55322,8,null);var offset_hours = cljs.core.nth.call(null,vec__55322,9,null);var offset_minutes = cljs.core.nth.call(null,vec__55322,10,null);var v = vec__55322;if(cljs.core.not.call(null,v))
...
{var vec__55324 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__55324,0,null);var months = cljs.core.nth.call(null,vec__55324,1,null);var days = cljs.core.nth.call(null,vec__55324,2,null);var hours = cljs.core.nth.call(null,vec__55324,3,null);var minutes = cljs.core.nth.call(null,vec__55324,4,null);var seconds = cljs.core.nth.call(null,vec__55324,5,null);var ms = cljs.core.nth.call(null,vec__55324,6,null);var offset = cljs.core.nth.call(null,vec__55324,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
