...
{{
var G__7858 = cljs.core.pop.call(null,v__$1);
v__$1 = G__7858;
continue;
}
} else
...
{var pred__7862 = cljs.core._EQ_;var expr__7863 = limit;if(pred__7862.call(null,1,expr__7863))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__7862.call(null,2,expr__7863))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__7865 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__7866 = (limit__$1 - 1);
var G__7867 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__7865;
limit__$1 = G__7866;
parts = G__7867;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___7869 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___7869))
{var replacement_7870 = temp__4092__auto___7869;buffer.append([cljs.core.str(replacement_7870)].join(''));
} else
{buffer.append(ch);
}
{
