...
{{
var G__561872 = cljs.core.pop.call(null,v__$1);
v__$1 = G__561872;
continue;
}
} else
...
{var pred__561876 = cljs.core._EQ_;var expr__561877 = limit;if(cljs.core.truth_(pred__561876.call(null,1,expr__561877)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__561876.call(null,2,expr__561877)))
...
var G__561879 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__561880 = (limit__$1 - 1);
var G__561881 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__561879;
limit__$1 = G__561880;
parts = G__561881;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___561883 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___561883))
{var replacement_561884 = temp__4096__auto___561883;buffer.append([cljs.core.str(replacement_561884)].join(''));
} else
{buffer.append(ch);
}
{
var G__561885 = (index + 1);
index = G__561885;
continue;
}
}
