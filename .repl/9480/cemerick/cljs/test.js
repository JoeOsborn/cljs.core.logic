...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__145637 = m;var map__145637__$1 = ((cljs.core.seq_QMARK_.call(null,map__145637))?cljs.core.apply.call(null,cljs.core.hash_map,map__145637):map__145637);var line = cljs.core.get.call(null,map__145637__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__145637__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__145639 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__145639))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__145639))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_145640;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_145641 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_145641;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_145642 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___145643 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___145643))
{var message_145644 = temp__4094__auto___145643;cljs.core.println.call(null,message_145644);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_145642;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_145645 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___145646 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___145646))
{var message_145647 = temp__4094__auto___145646;cljs.core.println.call(null,message_145647);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_145648;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_145649 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_145649;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__145650){
var ns_sym = cljs.core.first(arglist__145650);
arglist__145650 = cljs.core.next(arglist__145650);
var fixture_type = cljs.core.first(arglist__145650);
var fixture_fns = cljs.core.rest(arglist__145650);
...
try{t.call(null);
}catch (e145654){if((e145654 instanceof Error))
{var e_145657 = e145654;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_145657], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e145654;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_145653;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__145662 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__145663 = null;var count__145664 = 0;var i__145665 = 0;while(true){
if((i__145665 < count__145664))
{var v = cljs.core._nth.call(null,chunk__145663,i__145665);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__145662,chunk__145663,count__145664,i__145665,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__145662,chunk__145663,count__145664,i__145665,v))
);
} else
{}
{
var G__145666 = seq__145662;
var G__145667 = chunk__145663;
var G__145668 = count__145664;
var G__145669 = (i__145665 + 1);
seq__145662 = G__145666;
chunk__145663 = G__145667;
count__145664 = G__145668;
i__145665 = G__145669;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__145662);if(temp__4094__auto__)
{var seq__145662__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__145662__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__145662__$1);{
var G__145670 = cljs.core.chunk_rest.call(null,seq__145662__$1);
var G__145671 = c__5421__auto__;
var G__145672 = cljs.core.count.call(null,c__5421__auto__);
var G__145673 = 0;
seq__145662 = G__145670;
chunk__145663 = G__145671;
count__145664 = G__145672;
i__145665 = G__145673;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__145662__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__145662,chunk__145663,count__145664,i__145665,v,seq__145662__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__145662,chunk__145663,count__145664,i__145665,v,seq__145662__$1,temp__4094__auto__))
);
} else
{}
{
var G__145674 = cljs.core.next.call(null,seq__145662__$1);
var G__145675 = null;
var G__145676 = 0;
var G__145677 = 0;
seq__145662 = G__145674;
chunk__145663 = G__145675;
count__145664 = G__145676;
i__145665 = G__145677;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_145679 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___145680 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___145680))
{var test_hook_145681 = temp__4092__auto___145680;test_hook_145681.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_145679;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__145682){
var namespaces = cljs.core.seq(arglist__145682);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__145683_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__145683_SHARP_));
