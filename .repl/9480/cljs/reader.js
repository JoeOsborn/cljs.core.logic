...
reader_error.cljs$lang$applyTo = (function (arglist__145605){
var rdr = cljs.core.first(arglist__145605);
var msg = cljs.core.rest(arglist__145605);
...
{{
var G__145606 = (function (){sb.append(ch);
return sb;
})();
var G__145607 = cljs.reader.read_char.call(null,rdr);
sb = G__145606;
ch = G__145607;
continue;
}
...
{{
var G__145608 = cljs.reader.read_char.call(null,rdr);
ch = G__145608;
continue;
}
} else
...
var G__145609 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__145609;
continue;
}
} else
...
var G__145610 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__145610;
continue;
}
}
...
{{
var G__145611 = (function (){buffer.append(ch);
return buffer;
})();
var G__145612 = cljs.reader.read_char.call(null,reader);
buffer = G__145611;
ch = G__145612;
continue;
}
...
{if(("\\" === ch))
{{
var G__145613 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__145614 = cljs.reader.read_char.call(null,reader);
buffer = G__145613;
ch = G__145614;
continue;
}
...
{{
var G__145615 = (function (){buffer.append(ch);
return buffer;
})();
var G__145616 = cljs.reader.read_char.call(null,reader);
buffer = G__145615;
ch = G__145616;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__145618 = o;if(G__145618)
{var bit__5323__auto__ = (G__145618.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__145618.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__145618.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__145618);
} else
{return false;
}
}
...
{{
var G__145619 = reader;
var G__145620 = eof_is_error;
var G__145621 = sentinel;
var G__145622 = is_recursive;
reader = G__145619;
eof_is_error = G__145620;
sentinel = G__145621;
is_recursive = G__145622;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__145623 = cljs.reader.read_comment.call(null,reader,ch);
var G__145624 = eof_is_error;
var G__145625 = sentinel;
var G__145626 = is_recursive;
reader = G__145623;
eof_is_error = G__145624;
sentinel = G__145625;
is_recursive = G__145626;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__145627 = reader;
var G__145628 = eof_is_error;
var G__145629 = sentinel;
var G__145630 = is_recursive;
reader = G__145627;
eof_is_error = G__145628;
sentinel = G__145629;
is_recursive = G__145630;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__145633 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__145633,0,null);var years = cljs.core.nth.call(null,vec__145633,1,null);var months = cljs.core.nth.call(null,vec__145633,2,null);var days = cljs.core.nth.call(null,vec__145633,3,null);var hours = cljs.core.nth.call(null,vec__145633,4,null);var minutes = cljs.core.nth.call(null,vec__145633,5,null);var seconds = cljs.core.nth.call(null,vec__145633,6,null);var fraction = cljs.core.nth.call(null,vec__145633,7,null);var offset_sign = cljs.core.nth.call(null,vec__145633,8,null);var offset_hours = cljs.core.nth.call(null,vec__145633,9,null);var offset_minutes = cljs.core.nth.call(null,vec__145633,10,null);var v = vec__145633;if(cljs.core.not.call(null,v))
...
{var vec__145635 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__145635,0,null);var months = cljs.core.nth.call(null,vec__145635,1,null);var days = cljs.core.nth.call(null,vec__145635,2,null);var hours = cljs.core.nth.call(null,vec__145635,3,null);var minutes = cljs.core.nth.call(null,vec__145635,4,null);var seconds = cljs.core.nth.call(null,vec__145635,5,null);var ms = cljs.core.nth.call(null,vec__145635,6,null);var offset = cljs.core.nth.call(null,vec__145635,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
