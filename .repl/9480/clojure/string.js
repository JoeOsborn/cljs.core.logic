...
{{
var G__145309 = cljs.core.pop.call(null,v__$1);
v__$1 = G__145309;
continue;
}
} else
...
{var pred__145313 = cljs.core._EQ_;var expr__145314 = limit;if(pred__145313.call(null,1,expr__145314))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__145313.call(null,2,expr__145314))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__145316 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__145317 = (limit__$1 - 1);
var G__145318 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__145316;
limit__$1 = G__145317;
parts = G__145318;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___145320 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___145320))
{var replacement_145321 = temp__4092__auto___145320;buffer.append([cljs.core.str(replacement_145321)].join(''));
} else
{buffer.append(ch);
}
{
var G__145322 = (index + 1);
index = G__145322;
continue;
}
}
