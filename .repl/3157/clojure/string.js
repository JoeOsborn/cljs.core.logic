...
{{
var G__9228 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9228;
continue;
}
} else
...
{var pred__9232 = cljs.core._EQ_;var expr__9233 = limit;if(pred__9232.call(null,1,expr__9233))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9232.call(null,2,expr__9233))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9235 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9236 = (limit__$1 - 1);
var G__9237 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9235;
limit__$1 = G__9236;
parts = G__9237;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9239 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9239))
{var replacement_9240 = temp__4092__auto___9239;buffer.append([cljs.core.str(replacement_9240)].join(''));
} else
{buffer.append(ch);
}
{
