...
reader_error.cljs$lang$applyTo = (function (arglist__9197){
var rdr = cljs.core.first(arglist__9197);
var msg = cljs.core.rest(arglist__9197);
...
{{
var G__9198 = (function (){sb.append(ch);
return sb;
})();
var G__9199 = cljs.reader.read_char.call(null,rdr);
sb = G__9198;
ch = G__9199;
continue;
}
...
{{
var G__9200 = cljs.reader.read_char.call(null,rdr);
ch = G__9200;
continue;
}
} else
...
var G__9201 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9201;
continue;
}
} else
...
var G__9202 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9202;
continue;
}
}
...
{{
var G__9203 = (function (){buffer.append(ch);
return buffer;
})();
var G__9204 = cljs.reader.read_char.call(null,reader);
buffer = G__9203;
ch = G__9204;
continue;
}
...
{if(("\\" === ch))
{{
var G__9205 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9206 = cljs.reader.read_char.call(null,reader);
buffer = G__9205;
ch = G__9206;
continue;
}
...
{{
var G__9207 = (function (){buffer.append(ch);
return buffer;
})();
var G__9208 = cljs.reader.read_char.call(null,reader);
buffer = G__9207;
ch = G__9208;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9210 = o;if(G__9210)
{var bit__5323__auto__ = (G__9210.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9210.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9210.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9210);
} else
{return false;
}
}
...
{{
var G__9211 = reader;
var G__9212 = eof_is_error;
var G__9213 = sentinel;
var G__9214 = is_recursive;
reader = G__9211;
eof_is_error = G__9212;
sentinel = G__9213;
is_recursive = G__9214;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9215 = cljs.reader.read_comment.call(null,reader,ch);
var G__9216 = eof_is_error;
var G__9217 = sentinel;
var G__9218 = is_recursive;
reader = G__9215;
eof_is_error = G__9216;
sentinel = G__9217;
is_recursive = G__9218;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9219 = reader;
var G__9220 = eof_is_error;
var G__9221 = sentinel;
var G__9222 = is_recursive;
reader = G__9219;
eof_is_error = G__9220;
sentinel = G__9221;
is_recursive = G__9222;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9225 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9225,0,null);var years = cljs.core.nth.call(null,vec__9225,1,null);var months = cljs.core.nth.call(null,vec__9225,2,null);var days = cljs.core.nth.call(null,vec__9225,3,null);var hours = cljs.core.nth.call(null,vec__9225,4,null);var minutes = cljs.core.nth.call(null,vec__9225,5,null);var seconds = cljs.core.nth.call(null,vec__9225,6,null);var fraction = cljs.core.nth.call(null,vec__9225,7,null);var offset_sign = cljs.core.nth.call(null,vec__9225,8,null);var offset_hours = cljs.core.nth.call(null,vec__9225,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9225,10,null);var v = vec__9225;if(cljs.core.not.call(null,v))
...
{var vec__9227 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9227,0,null);var months = cljs.core.nth.call(null,vec__9227,1,null);var days = cljs.core.nth.call(null,vec__9227,2,null);var hours = cljs.core.nth.call(null,vec__9227,3,null);var minutes = cljs.core.nth.call(null,vec__9227,4,null);var seconds = cljs.core.nth.call(null,vec__9227,5,null);var ms = cljs.core.nth.call(null,vec__9227,6,null);var offset = cljs.core.nth.call(null,vec__9227,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
