...
reader_error.cljs$lang$applyTo = (function (arglist__105794){
var rdr = cljs.core.first(arglist__105794);
var msg = cljs.core.rest(arglist__105794);
...
{{
var G__105795 = (function (){sb.append(ch);
return sb;
})();
var G__105796 = cljs.reader.read_char.call(null,rdr);
sb = G__105795;
ch = G__105796;
continue;
}
...
{{
var G__105797 = cljs.reader.read_char.call(null,rdr);
ch = G__105797;
continue;
}
} else
...
var G__105798 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__105798;
continue;
}
} else
...
var G__105799 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__105799;
continue;
}
}
...
{{
var G__105800 = (function (){buffer.append(ch);
return buffer;
})();
var G__105801 = cljs.reader.read_char.call(null,reader);
buffer = G__105800;
ch = G__105801;
continue;
}
...
{if(("\\" === ch))
{{
var G__105802 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__105803 = cljs.reader.read_char.call(null,reader);
buffer = G__105802;
ch = G__105803;
continue;
}
...
{{
var G__105804 = (function (){buffer.append(ch);
return buffer;
})();
var G__105805 = cljs.reader.read_char.call(null,reader);
buffer = G__105804;
ch = G__105805;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__105807 = o;if(G__105807)
{var bit__5323__auto__ = (G__105807.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__105807.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__105807.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__105807);
} else
{return false;
}
}
...
{{
var G__105808 = reader;
var G__105809 = eof_is_error;
var G__105810 = sentinel;
var G__105811 = is_recursive;
reader = G__105808;
eof_is_error = G__105809;
sentinel = G__105810;
is_recursive = G__105811;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__105812 = cljs.reader.read_comment.call(null,reader,ch);
var G__105813 = eof_is_error;
var G__105814 = sentinel;
var G__105815 = is_recursive;
reader = G__105812;
eof_is_error = G__105813;
sentinel = G__105814;
is_recursive = G__105815;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__105816 = reader;
var G__105817 = eof_is_error;
var G__105818 = sentinel;
var G__105819 = is_recursive;
reader = G__105816;
eof_is_error = G__105817;
sentinel = G__105818;
is_recursive = G__105819;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__105822 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__105822,0,null);var years = cljs.core.nth.call(null,vec__105822,1,null);var months = cljs.core.nth.call(null,vec__105822,2,null);var days = cljs.core.nth.call(null,vec__105822,3,null);var hours = cljs.core.nth.call(null,vec__105822,4,null);var minutes = cljs.core.nth.call(null,vec__105822,5,null);var seconds = cljs.core.nth.call(null,vec__105822,6,null);var fraction = cljs.core.nth.call(null,vec__105822,7,null);var offset_sign = cljs.core.nth.call(null,vec__105822,8,null);var offset_hours = cljs.core.nth.call(null,vec__105822,9,null);var offset_minutes = cljs.core.nth.call(null,vec__105822,10,null);var v = vec__105822;if(cljs.core.not.call(null,v))
...
{var vec__105824 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__105824,0,null);var months = cljs.core.nth.call(null,vec__105824,1,null);var days = cljs.core.nth.call(null,vec__105824,2,null);var hours = cljs.core.nth.call(null,vec__105824,3,null);var minutes = cljs.core.nth.call(null,vec__105824,4,null);var seconds = cljs.core.nth.call(null,vec__105824,5,null);var ms = cljs.core.nth.call(null,vec__105824,6,null);var offset = cljs.core.nth.call(null,vec__105824,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
