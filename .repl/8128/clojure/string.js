...
{{
var G__105825 = cljs.core.pop.call(null,v__$1);
v__$1 = G__105825;
continue;
}
} else
...
{var pred__105829 = cljs.core._EQ_;var expr__105830 = limit;if(pred__105829.call(null,1,expr__105830))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__105829.call(null,2,expr__105830))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__105832 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__105833 = (limit__$1 - 1);
var G__105834 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__105832;
limit__$1 = G__105833;
parts = G__105834;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___105836 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___105836))
{var replacement_105837 = temp__4092__auto___105836;buffer.append([cljs.core.str(replacement_105837)].join(''));
} else
{buffer.append(ch);
}
{
var G__105838 = (index + 1);
index = G__105838;
continue;
}
}
