...
{{
var G__27290 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27290;
continue;
}
} else
...
{var pred__27294 = cljs.core._EQ_;var expr__27295 = limit;if(pred__27294.call(null,1,expr__27295))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__27294.call(null,2,expr__27295))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__27297 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27298 = (limit__$1 - 1);
var G__27299 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27297;
limit__$1 = G__27298;
parts = G__27299;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___27301 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___27301))
{var replacement_27302 = temp__4092__auto___27301;buffer.append([cljs.core.str(replacement_27302)].join(''));
} else
{buffer.append(ch);
}
{
var G__27303 = (index + 1);
index = G__27303;
continue;
}
}
