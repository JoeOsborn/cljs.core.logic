...
reader_error.cljs$lang$applyTo = (function (arglist__27259){
var rdr = cljs.core.first(arglist__27259);
var msg = cljs.core.rest(arglist__27259);
...
{{
var G__27260 = (function (){sb.append(ch);
return sb;
})();
var G__27261 = cljs.reader.read_char.call(null,rdr);
sb = G__27260;
ch = G__27261;
continue;
}
...
{{
var G__27262 = cljs.reader.read_char.call(null,rdr);
ch = G__27262;
continue;
}
} else
...
var G__27263 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__27263;
continue;
}
} else
...
var G__27264 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__27264;
continue;
}
}
...
{{
var G__27265 = (function (){buffer.append(ch);
return buffer;
})();
var G__27266 = cljs.reader.read_char.call(null,reader);
buffer = G__27265;
ch = G__27266;
continue;
}
...
{if(("\\" === ch))
{{
var G__27267 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__27268 = cljs.reader.read_char.call(null,reader);
buffer = G__27267;
ch = G__27268;
continue;
}
...
{{
var G__27269 = (function (){buffer.append(ch);
return buffer;
})();
var G__27270 = cljs.reader.read_char.call(null,reader);
buffer = G__27269;
ch = G__27270;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__27272 = o;if(G__27272)
{var bit__5323__auto__ = (G__27272.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__27272.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__27272.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__27272);
} else
{return false;
}
}
...
{{
var G__27273 = reader;
var G__27274 = eof_is_error;
var G__27275 = sentinel;
var G__27276 = is_recursive;
reader = G__27273;
eof_is_error = G__27274;
sentinel = G__27275;
is_recursive = G__27276;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__27277 = cljs.reader.read_comment.call(null,reader,ch);
var G__27278 = eof_is_error;
var G__27279 = sentinel;
var G__27280 = is_recursive;
reader = G__27277;
eof_is_error = G__27278;
sentinel = G__27279;
is_recursive = G__27280;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__27281 = reader;
var G__27282 = eof_is_error;
var G__27283 = sentinel;
var G__27284 = is_recursive;
reader = G__27281;
eof_is_error = G__27282;
sentinel = G__27283;
is_recursive = G__27284;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__27287 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__27287,0,null);var years = cljs.core.nth.call(null,vec__27287,1,null);var months = cljs.core.nth.call(null,vec__27287,2,null);var days = cljs.core.nth.call(null,vec__27287,3,null);var hours = cljs.core.nth.call(null,vec__27287,4,null);var minutes = cljs.core.nth.call(null,vec__27287,5,null);var seconds = cljs.core.nth.call(null,vec__27287,6,null);var fraction = cljs.core.nth.call(null,vec__27287,7,null);var offset_sign = cljs.core.nth.call(null,vec__27287,8,null);var offset_hours = cljs.core.nth.call(null,vec__27287,9,null);var offset_minutes = cljs.core.nth.call(null,vec__27287,10,null);var v = vec__27287;if(cljs.core.not.call(null,v))
...
{var vec__27289 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__27289,0,null);var months = cljs.core.nth.call(null,vec__27289,1,null);var days = cljs.core.nth.call(null,vec__27289,2,null);var hours = cljs.core.nth.call(null,vec__27289,3,null);var minutes = cljs.core.nth.call(null,vec__27289,4,null);var seconds = cljs.core.nth.call(null,vec__27289,5,null);var ms = cljs.core.nth.call(null,vec__27289,6,null);var offset = cljs.core.nth.call(null,vec__27289,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
