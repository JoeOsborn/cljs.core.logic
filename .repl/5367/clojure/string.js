...
{{
var G__51438 = cljs.core.pop.call(null,v__$1);
v__$1 = G__51438;
continue;
}
} else
...
{var pred__51442 = cljs.core._EQ_;var expr__51443 = limit;if(pred__51442.call(null,1,expr__51443))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__51442.call(null,2,expr__51443))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__51445 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__51446 = (limit__$1 - 1);
var G__51447 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__51445;
limit__$1 = G__51446;
parts = G__51447;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___51449 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___51449))
{var replacement_51450 = temp__4092__auto___51449;buffer.append([cljs.core.str(replacement_51450)].join(''));
} else
{buffer.append(ch);
}
{
var G__51451 = (index + 1);
index = G__51451;
continue;
}
}
