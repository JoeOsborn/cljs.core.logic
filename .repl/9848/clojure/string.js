...
{{
var G__421029 = cljs.core.pop.call(null,v__$1);
v__$1 = G__421029;
continue;
}
} else
...
{var pred__421033 = cljs.core._EQ_;var expr__421034 = limit;if(cljs.core.truth_(pred__421033.call(null,1,expr__421034)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__421033.call(null,2,expr__421034)))
...
var G__421036 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__421037 = (limit__$1 - 1);
var G__421038 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__421036;
limit__$1 = G__421037;
parts = G__421038;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___421040 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___421040))
{var replacement_421041 = temp__4096__auto___421040;buffer.append([cljs.core.str(replacement_421041)].join(''));
} else
{buffer.append(ch);
}
{
var G__421042 = (index + 1);
index = G__421042;
continue;
}
}
