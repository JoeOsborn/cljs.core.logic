...
{{
var G__451169 = cljs.core.pop.call(null,v__$1);
v__$1 = G__451169;
continue;
}
} else
...
{var pred__451173 = cljs.core._EQ_;var expr__451174 = limit;if(cljs.core.truth_(pred__451173.call(null,1,expr__451174)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__451173.call(null,2,expr__451174)))
...
var G__451176 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__451177 = (limit__$1 - 1);
var G__451178 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__451176;
limit__$1 = G__451177;
parts = G__451178;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___451180 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___451180))
{var replacement_451181 = temp__4096__auto___451180;buffer.append([cljs.core.str(replacement_451181)].join(''));
} else
{buffer.append(ch);
}
{
var G__451182 = (index + 1);
index = G__451182;
continue;
}
}
