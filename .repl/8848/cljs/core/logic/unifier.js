...
{var vec__451184 = expr__$1;var f = cljs.core.nth.call(null,vec__451184,0,null);var n = cljs.core.nthnext.call(null,vec__451184,1);var skip = cljs.core._EQ_.call(null,f,new cljs.core.Symbol(null,".",".",-1640531481,null));var tail = prep_STAR_.call(null,n,store,lcons_QMARK_,skip);if(skip)
{return tail;
} else
...
*/
cljs.core.logic.unifier.prep = (function prep(expr){var lvars = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prepped = ((cljs.core.logic.unifier.lvarq_sym_QMARK_.call(null,expr))?cljs.core.logic.unifier.proc_lvar.call(null,expr,lvars):(cljs.core.truth_(cljs.core.logic.unifier.lcons_expr_QMARK_.call(null,expr))?cljs.core.logic.unifier.prep_STAR_.call(null,expr,lvars,true):((new cljs.core.Keyword(null,"else","else",1017020587))?cljs.core.logic._walk_term.call(null,expr,cljs.core.logic.unifier.replace_lvar.call(null,lvars)):null)));if((function (){var G__451186 = prepped;if(G__451186)
{var bit__7471__auto__ = (G__451186.cljs$lang$protocol_mask$partition0$ & 131072);if((bit__7471__auto__) || (G__451186.cljs$core$IMeta$))
{return true;
} else
{if((!G__451186.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMeta,G__451186);
} else
{return false;
}
}
...
{return cljs.core.logic._queue.call(null,s,cljs.core.logic._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__451187_SHARP_){return cljs.core.logic.lvar.call(null,p1__451187_SHARP_,false);
}),vs))));
} else
...
{return cljs.core.logic._queue.call(null,s,cljs.core.logic._unwrap.call(null,cljs.core.apply.call(null,c,cljs.core.map.call(null,(function (p1__451188_SHARP_){return cljs.core.logic.lvar.call(null,p1__451188_SHARP_,false);
...
cljs.core.logic.unifier.queue_constraints = (function queue_constraints(s,p__451189){var vec__451191 = p__451189;var vs = cljs.core.nth.call(null,vec__451191,0,null);var cs = cljs.core.nth.call(null,vec__451191,1,null);var cs__$1 = ((!(cljs.core.sequential_QMARK_.call(null,cs)))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cs], null):cs);return cljs.core.reduce.call(null,(function (s__$1,c){return cljs.core.logic.unifier.queue_constraint.call(null,s__$1,c,vs);
}),s,cs__$1);
});
cljs.core.logic.unifier._unify_STAR_ = (function _unify_STAR_(init_s,u,w){return cljs.core.first.call(null,cljs.core.logic.take_STAR_.call(null,(function (){return (function (a__447093__auto__){return (new cljs.core.logic.Inc((function (){var q = cljs.core.logic.lvar.call(null,new cljs.core.Symbol(null,"q","q",-1640531414,null));return cljs.core.logic._bind.call(null,cljs.core.logic._bind.call(null,cljs.core.logic._bind.call(null,cljs.core.logic._bind.call(null,a__447093__auto__,(function (a__447060__auto__){var has_cs_QMARK___447061__auto__ = (cljs.core.count.call(null,a__447060__auto__.cs) > 0);var temp__4098__auto__ = cljs.core.logic._unify.call(null,((has_cs_QMARK___447061__auto__)?(new cljs.core.logic.Substitutions(a__447060__auto__.s,cljs.core.PersistentVector.EMPTY,a__447060__auto__.ts,a__447060__auto__.cs,a__447060__auto__.cq,a__447060__auto__.cqs,a__447060__auto__.oc,a__447060__auto__._meta)):a__447060__auto__),u,w);if(cljs.core.truth_(temp__4098__auto__))
...
cljs.core.logic.unifier.init_s = (function init_s(opts,s){var s__$1 = cljs.core.reduce.call(null,(function (s__$1,p__451194){var vec__451195 = p__451194;var k = cljs.core.nth.call(null,vec__451195,0,null);var v = cljs.core.nth.call(null,vec__451195,1,null);return ((function (vec__451195,k,v){
...
var unify_STAR___2 = (function (opts,ts){var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.empty_s);return cljs.core.logic.unifier._unify_STAR_.call(null,cljs.core.vary_meta.call(null,init_s,cljs.core.assoc,new cljs.core.Keyword(null,"reify-vars","reify-vars",4368745730),false),cljs.core.reduce.call(null,(function (p1__451196_SHARP_,p2__451197_SHARP_){return cljs.core.logic.unifier._unify_STAR_.call(null,init_s,p1__451196_SHARP_,p2__451197_SHARP_);
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__451212){var vec__451213 = p__451212;var sym = cljs.core.nth.call(null,vec__451213,0,null);var var$ = cljs.core.nth.call(null,vec__451213,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sym,cljs.core.logic._reify.call(null,s__$1,var$)], null);
}),cljs.core.filter.call(null,(function (p__451214){var vec__451215 = p__451214;var sym = cljs.core.nth.call(null,vec__451215,0,null);var var$ = cljs.core.nth.call(null,vec__451215,1,null);return cljs.core.not_EQ_.call(null,cljs.core.logic._walk.call(null,s__$1,var$),var$);
...
var init_s = cljs.core.logic.unifier.init_s.call(null,opts,cljs.core.logic.empty_s);return cljs.core.reduce.call(null,(function (p1__451198_SHARP_,p2__451199_SHARP_){return _unifier_STAR_.call(null,init_s,p1__451198_SHARP_,p2__451199_SHARP_);
}),ts);
});
...
var unify__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__451218){var vec__451219 = p__451218;var k = cljs.core.nth.call(null,vec__451219,0,null);var v = cljs.core.nth.call(null,vec__451219,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], null);
...
var unifier__2 = (function (opts,ts){var opts__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364)))?cljs.core.assoc.call(null,opts,new cljs.core.Keyword(null,"as","as",1013907364),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__451223){var vec__451224 = p__451223;var k = cljs.core.nth.call(null,vec__451224,0,null);var v = cljs.core.nth.call(null,vec__451224,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.logic.lvar.call(null,k,false),cljs.core.logic.unifier.prep.call(null,v)], null);
...
return (function (p1__451220_SHARP_){return new cljs.core.Keyword("cljs.core.logic.unifier","lvars","cljs.core.logic.unifier/lvars",1819622758).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__451220_SHARP_));
