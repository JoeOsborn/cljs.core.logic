...
{{
var G__111583 = cljs.core.pop.call(null,v__$1);
v__$1 = G__111583;
continue;
}
} else
...
{var pred__111587 = cljs.core._EQ_;var expr__111588 = limit;if(cljs.core.truth_(pred__111587.call(null,1,expr__111588)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__111587.call(null,2,expr__111588)))
...
var G__111590 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__111591 = (limit__$1 - 1);
var G__111592 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__111590;
limit__$1 = G__111591;
parts = G__111592;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___111594 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___111594))
{var replacement_111595 = temp__4096__auto___111594;buffer.append([cljs.core.str(replacement_111595)].join(''));
} else
{buffer.append(ch);
}
{
var G__111596 = (index + 1);
index = G__111596;
continue;
}
}
