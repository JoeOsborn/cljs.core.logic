...
{{
var G__22962 = cljs.core.pop.call(null,v__$1);
v__$1 = G__22962;
continue;
}
} else
...
{var pred__22966 = cljs.core._EQ_;var expr__22967 = limit;if(pred__22966.call(null,1,expr__22967))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__22966.call(null,2,expr__22967))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__22969 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__22970 = (limit__$1 - 1);
var G__22971 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__22969;
limit__$1 = G__22970;
parts = G__22971;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___22973 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___22973))
{var replacement_22974 = temp__4092__auto___22973;buffer.append([cljs.core.str(replacement_22974)].join(''));
} else
{buffer.append(ch);
}
{
