...
{{
var G__54976 = cljs.core.pop.call(null,v__$1);
v__$1 = G__54976;
continue;
}
} else
...
{var pred__54980 = cljs.core._EQ_;var expr__54981 = limit;if(cljs.core.truth_(pred__54980.call(null,1,expr__54981)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__54980.call(null,2,expr__54981)))
...
var G__54983 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__54984 = (limit__$1 - 1);
var G__54985 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__54983;
limit__$1 = G__54984;
parts = G__54985;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___54987 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___54987))
{var replacement_54988 = temp__4096__auto___54987;buffer.append([cljs.core.str(replacement_54988)].join(''));
} else
{buffer.append(ch);
}
{
var G__54989 = (index + 1);
index = G__54989;
continue;
}
}
