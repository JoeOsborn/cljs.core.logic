...
reader_error.cljs$lang$applyTo = (function (arglist__293905){
var rdr = cljs.core.first(arglist__293905);
var msg = cljs.core.rest(arglist__293905);
...
{{
var G__293906 = (function (){sb.append(ch);
return sb;
})();
var G__293907 = cljs.reader.read_char.call(null,rdr);
sb = G__293906;
ch = G__293907;
continue;
}
...
{{
var G__293908 = cljs.reader.read_char.call(null,rdr);
ch = G__293908;
continue;
}
} else
...
var G__293909 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__293909;
continue;
}
} else
...
var G__293910 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__293910;
continue;
}
}
...
{{
var G__293911 = (function (){buffer.append(ch);
return buffer;
})();
var G__293912 = cljs.reader.read_char.call(null,reader);
buffer = G__293911;
ch = G__293912;
continue;
}
...
{if(("\\" === ch))
{{
var G__293913 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__293914 = cljs.reader.read_char.call(null,reader);
buffer = G__293913;
ch = G__293914;
continue;
}
...
{{
var G__293915 = (function (){buffer.append(ch);
return buffer;
})();
var G__293916 = cljs.reader.read_char.call(null,reader);
buffer = G__293915;
ch = G__293916;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__293918 = o;if(G__293918)
{var bit__5323__auto__ = (G__293918.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__293918.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__293918.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__293918);
} else
{return false;
}
}
...
{{
var G__293919 = reader;
var G__293920 = eof_is_error;
var G__293921 = sentinel;
var G__293922 = is_recursive;
reader = G__293919;
eof_is_error = G__293920;
sentinel = G__293921;
is_recursive = G__293922;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__293923 = cljs.reader.read_comment.call(null,reader,ch);
var G__293924 = eof_is_error;
var G__293925 = sentinel;
var G__293926 = is_recursive;
reader = G__293923;
eof_is_error = G__293924;
sentinel = G__293925;
is_recursive = G__293926;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__293927 = reader;
var G__293928 = eof_is_error;
var G__293929 = sentinel;
var G__293930 = is_recursive;
reader = G__293927;
eof_is_error = G__293928;
sentinel = G__293929;
is_recursive = G__293930;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__293933 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__293933,0,null);var years = cljs.core.nth.call(null,vec__293933,1,null);var months = cljs.core.nth.call(null,vec__293933,2,null);var days = cljs.core.nth.call(null,vec__293933,3,null);var hours = cljs.core.nth.call(null,vec__293933,4,null);var minutes = cljs.core.nth.call(null,vec__293933,5,null);var seconds = cljs.core.nth.call(null,vec__293933,6,null);var fraction = cljs.core.nth.call(null,vec__293933,7,null);var offset_sign = cljs.core.nth.call(null,vec__293933,8,null);var offset_hours = cljs.core.nth.call(null,vec__293933,9,null);var offset_minutes = cljs.core.nth.call(null,vec__293933,10,null);var v = vec__293933;if(cljs.core.not.call(null,v))
...
{var vec__293935 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__293935,0,null);var months = cljs.core.nth.call(null,vec__293935,1,null);var days = cljs.core.nth.call(null,vec__293935,2,null);var hours = cljs.core.nth.call(null,vec__293935,3,null);var minutes = cljs.core.nth.call(null,vec__293935,4,null);var seconds = cljs.core.nth.call(null,vec__293935,5,null);var ms = cljs.core.nth.call(null,vec__293935,6,null);var offset = cljs.core.nth.call(null,vec__293935,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
