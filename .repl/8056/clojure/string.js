...
{{
var G__293609 = cljs.core.pop.call(null,v__$1);
v__$1 = G__293609;
continue;
}
} else
...
{var pred__293613 = cljs.core._EQ_;var expr__293614 = limit;if(pred__293613.call(null,1,expr__293614))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__293613.call(null,2,expr__293614))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__293616 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__293617 = (limit__$1 - 1);
var G__293618 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__293616;
limit__$1 = G__293617;
parts = G__293618;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___293620 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___293620))
{var replacement_293621 = temp__4092__auto___293620;buffer.append([cljs.core.str(replacement_293621)].join(''));
} else
{buffer.append(ch);
}
{
var G__293622 = (index + 1);
index = G__293622;
continue;
}
}
