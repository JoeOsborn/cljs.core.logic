...
{{
var G__8439 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8439;
continue;
}
} else
...
{var pred__8443 = cljs.core._EQ_;var expr__8444 = limit;if(pred__8443.call(null,1,expr__8444))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__8443.call(null,2,expr__8444))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__8446 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8447 = (limit__$1 - 1);
var G__8448 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8446;
limit__$1 = G__8447;
parts = G__8448;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___8450 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___8450))
{var replacement_8451 = temp__4092__auto___8450;buffer.append([cljs.core.str(replacement_8451)].join(''));
} else
{buffer.append(ch);
}
{
