...
{{
var G__124453 = cljs.core.pop.call(null,v__$1);
v__$1 = G__124453;
continue;
}
} else
...
{var pred__124457 = cljs.core._EQ_;var expr__124458 = limit;if(cljs.core.truth_(pred__124457.call(null,1,expr__124458)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__124457.call(null,2,expr__124458)))
...
var G__124460 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__124461 = (limit__$1 - 1);
var G__124462 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__124460;
limit__$1 = G__124461;
parts = G__124462;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___124464 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___124464))
{var replacement_124465 = temp__4096__auto___124464;buffer.append([cljs.core.str(replacement_124465)].join(''));
} else
{buffer.append(ch);
}
{
var G__124466 = (index + 1);
index = G__124466;
continue;
}
}
