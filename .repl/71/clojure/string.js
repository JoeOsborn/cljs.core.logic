...
{{
var G__431086 = cljs.core.pop.call(null,v__$1);
v__$1 = G__431086;
continue;
}
} else
...
{var pred__431090 = cljs.core._EQ_;var expr__431091 = limit;if(cljs.core.truth_(pred__431090.call(null,1,expr__431091)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__431090.call(null,2,expr__431091)))
...
var G__431093 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__431094 = (limit__$1 - 1);
var G__431095 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__431093;
limit__$1 = G__431094;
parts = G__431095;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___431097 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___431097))
{var replacement_431098 = temp__4096__auto___431097;buffer.append([cljs.core.str(replacement_431098)].join(''));
} else
{buffer.append(ch);
}
{
var G__431099 = (index + 1);
index = G__431099;
continue;
}
}
