...
{{
var G__214726 = cljs.core.pop.call(null,v__$1);
v__$1 = G__214726;
continue;
}
} else
...
{var pred__214730 = cljs.core._EQ_;var expr__214731 = limit;if(cljs.core.truth_(pred__214730.call(null,1,expr__214731)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__214730.call(null,2,expr__214731)))
...
var G__214733 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__214734 = (limit__$1 - 1);
var G__214735 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__214733;
limit__$1 = G__214734;
parts = G__214735;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___214737 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___214737))
{var replacement_214738 = temp__4096__auto___214737;buffer.append([cljs.core.str(replacement_214738)].join(''));
} else
{buffer.append(ch);
}
{
var G__214739 = (index + 1);
index = G__214739;
continue;
}
}
