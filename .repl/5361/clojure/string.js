...
{{
var G__82332 = cljs.core.pop.call(null,v__$1);
v__$1 = G__82332;
continue;
}
} else
...
{var pred__82336 = cljs.core._EQ_;var expr__82337 = limit;if(pred__82336.call(null,1,expr__82337))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__82336.call(null,2,expr__82337))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__82339 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__82340 = (limit__$1 - 1);
var G__82341 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__82339;
limit__$1 = G__82340;
parts = G__82341;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___82343 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___82343))
{var replacement_82344 = temp__4092__auto___82343;buffer.append([cljs.core.str(replacement_82344)].join(''));
} else
{buffer.append(ch);
}
{
var G__82345 = (index + 1);
index = G__82345;
continue;
}
}
