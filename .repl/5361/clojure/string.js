...
{{
var G__250133 = cljs.core.pop.call(null,v__$1);
v__$1 = G__250133;
continue;
}
} else
...
{var pred__250137 = cljs.core._EQ_;var expr__250138 = limit;if(cljs.core.truth_(pred__250137.call(null,1,expr__250138)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__250137.call(null,2,expr__250138)))
...
var G__250140 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__250141 = (limit__$1 - 1);
var G__250142 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__250140;
limit__$1 = G__250141;
parts = G__250142;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___250144 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___250144))
{var replacement_250145 = temp__4096__auto___250144;buffer.append([cljs.core.str(replacement_250145)].join(''));
} else
{buffer.append(ch);
}
{
var G__250146 = (index + 1);
index = G__250146;
continue;
}
}
