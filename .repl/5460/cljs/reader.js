...
reader_error.cljs$lang$applyTo = (function (arglist__101620){
var rdr = cljs.core.first(arglist__101620);
var msg = cljs.core.rest(arglist__101620);
...
{{
var G__101621 = (function (){sb.append(ch);
return sb;
})();
var G__101622 = cljs.reader.read_char.call(null,rdr);
sb = G__101621;
ch = G__101622;
continue;
}
...
{{
var G__101623 = cljs.reader.read_char.call(null,rdr);
ch = G__101623;
continue;
}
} else
...
var G__101624 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__101624;
continue;
}
} else
...
var G__101625 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__101625;
continue;
}
}
...
{{
var G__101626 = (function (){buffer.append(ch);
return buffer;
})();
var G__101627 = cljs.reader.read_char.call(null,reader);
buffer = G__101626;
ch = G__101627;
continue;
}
...
{if(("\\" === ch))
{{
var G__101628 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__101629 = cljs.reader.read_char.call(null,reader);
buffer = G__101628;
ch = G__101629;
continue;
}
...
{{
var G__101630 = (function (){buffer.append(ch);
return buffer;
})();
var G__101631 = cljs.reader.read_char.call(null,reader);
buffer = G__101630;
ch = G__101631;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__101633 = o;if(G__101633)
{var bit__5323__auto__ = (G__101633.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__101633.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__101633.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__101633);
} else
{return false;
}
}
...
{{
var G__101634 = reader;
var G__101635 = eof_is_error;
var G__101636 = sentinel;
var G__101637 = is_recursive;
reader = G__101634;
eof_is_error = G__101635;
sentinel = G__101636;
is_recursive = G__101637;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__101638 = cljs.reader.read_comment.call(null,reader,ch);
var G__101639 = eof_is_error;
var G__101640 = sentinel;
var G__101641 = is_recursive;
reader = G__101638;
eof_is_error = G__101639;
sentinel = G__101640;
is_recursive = G__101641;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__101642 = reader;
var G__101643 = eof_is_error;
var G__101644 = sentinel;
var G__101645 = is_recursive;
reader = G__101642;
eof_is_error = G__101643;
sentinel = G__101644;
is_recursive = G__101645;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__101648 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__101648,0,null);var years = cljs.core.nth.call(null,vec__101648,1,null);var months = cljs.core.nth.call(null,vec__101648,2,null);var days = cljs.core.nth.call(null,vec__101648,3,null);var hours = cljs.core.nth.call(null,vec__101648,4,null);var minutes = cljs.core.nth.call(null,vec__101648,5,null);var seconds = cljs.core.nth.call(null,vec__101648,6,null);var fraction = cljs.core.nth.call(null,vec__101648,7,null);var offset_sign = cljs.core.nth.call(null,vec__101648,8,null);var offset_hours = cljs.core.nth.call(null,vec__101648,9,null);var offset_minutes = cljs.core.nth.call(null,vec__101648,10,null);var v = vec__101648;if(cljs.core.not.call(null,v))
...
{var vec__101650 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__101650,0,null);var months = cljs.core.nth.call(null,vec__101650,1,null);var days = cljs.core.nth.call(null,vec__101650,2,null);var hours = cljs.core.nth.call(null,vec__101650,3,null);var minutes = cljs.core.nth.call(null,vec__101650,4,null);var seconds = cljs.core.nth.call(null,vec__101650,5,null);var ms = cljs.core.nth.call(null,vec__101650,6,null);var offset = cljs.core.nth.call(null,vec__101650,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
