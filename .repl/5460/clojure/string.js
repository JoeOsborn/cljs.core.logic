...
{{
var G__101651 = cljs.core.pop.call(null,v__$1);
v__$1 = G__101651;
continue;
}
} else
...
{var pred__101655 = cljs.core._EQ_;var expr__101656 = limit;if(pred__101655.call(null,1,expr__101656))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__101655.call(null,2,expr__101656))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__101658 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__101659 = (limit__$1 - 1);
var G__101660 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__101658;
limit__$1 = G__101659;
parts = G__101660;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___101662 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___101662))
{var replacement_101663 = temp__4092__auto___101662;buffer.append([cljs.core.str(replacement_101663)].join(''));
} else
{buffer.append(ch);
}
{
var G__101664 = (index + 1);
index = G__101664;
continue;
}
}
