...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj40502 = {};return obj40502;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__11045__auto__ = reader;if(and__11045__auto__)
...
{var x__11660__auto__ = (((reader == null))?null:reader);return (function (){var or__11057__auto__ = (cljs.reader.read_char[goog.typeOf(x__11660__auto__)]);if(or__11057__auto__)
{return or__11057__auto__;
} else
{var or__11057__auto____$1 = (cljs.reader.read_char["_"]);if(or__11057__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__11045__auto__ = reader;if(and__11045__auto__)
...
{var x__11660__auto__ = (((reader == null))?null:reader);return (function (){var or__11057__auto__ = (cljs.reader.unread[goog.typeOf(x__11660__auto__)]);if(or__11057__auto__)
{return or__11057__auto__;
} else
{var or__11057__auto____$1 = (cljs.reader.unread["_"]);if(or__11057__auto____$1)
{return or__11057__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__11601__auto__,writer__11602__auto__,opt__11603__auto__){return cljs.core._write.call(null,writer__11602__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__11057__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__40503){
var rdr = cljs.core.first(arglist__40503);
var msg = cljs.core.rest(arglist__40503);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__11045__auto__ = !((ch === "#"));if(and__11045__auto__)
{var and__11045__auto____$1 = !((ch === "'"));if(and__11045__auto____$1)
{var and__11045__auto____$2 = !((ch === ":"));if(and__11045__auto____$2)
...
{{
var G__40504 = (function (){sb.append(ch);
return sb;
})();
var G__40505 = cljs.reader.read_char.call(null,rdr);
sb = G__40504;
ch = G__40505;
continue;
}
...
{{
var G__40506 = cljs.reader.read_char.call(null,rdr);
ch = G__40506;
continue;
}
} else
...
var G__40507 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__40507;
continue;
}
} else
...
var G__40508 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__40508;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__11057__auto__ = (ch == null);if(or__11057__auto__)
{return or__11057__auto__;
} else
{var or__11057__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__11057__auto____$1)
{return or__11057__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__11057__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
...
{{
var G__40509 = (function (){buffer.append(ch);
return buffer;
})();
var G__40510 = cljs.reader.read_char.call(null,reader);
buffer = G__40509;
ch = G__40510;
continue;
}
...
{if(("\\" === ch))
{{
var G__40511 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__40512 = cljs.reader.read_char.call(null,reader);
buffer = G__40511;
ch = G__40512;
continue;
}
...
{{
var G__40513 = (function (){buffer.append(ch);
return buffer;
})();
var G__40514 = cljs.reader.read_char.call(null,reader);
buffer = G__40513;
ch = G__40514;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__40516 = o;if(G__40516)
{var bit__11683__auto__ = (G__40516.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11683__auto__) || (G__40516.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__40516.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__40516);
} else
{return false;
}
}
...
{{
var G__40517 = reader;
var G__40518 = eof_is_error;
var G__40519 = sentinel;
var G__40520 = is_recursive;
reader = G__40517;
eof_is_error = G__40518;
sentinel = G__40519;
is_recursive = G__40520;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__40521 = cljs.reader.read_comment.call(null,reader,ch);
var G__40522 = eof_is_error;
var G__40523 = sentinel;
var G__40524 = is_recursive;
reader = G__40521;
eof_is_error = G__40522;
sentinel = G__40523;
is_recursive = G__40524;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__40525 = reader;
var G__40526 = eof_is_error;
var G__40527 = sentinel;
var G__40528 = is_recursive;
reader = G__40525;
eof_is_error = G__40526;
sentinel = G__40527;
is_recursive = G__40528;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__40531 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__40531,0,null);var years = cljs.core.nth.call(null,vec__40531,1,null);var months = cljs.core.nth.call(null,vec__40531,2,null);var days = cljs.core.nth.call(null,vec__40531,3,null);var hours = cljs.core.nth.call(null,vec__40531,4,null);var minutes = cljs.core.nth.call(null,vec__40531,5,null);var seconds = cljs.core.nth.call(null,vec__40531,6,null);var fraction = cljs.core.nth.call(null,vec__40531,7,null);var offset_sign = cljs.core.nth.call(null,vec__40531,8,null);var offset_hours = cljs.core.nth.call(null,vec__40531,9,null);var offset_minutes = cljs.core.nth.call(null,vec__40531,10,null);var v = vec__40531;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__11057__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__11057__auto__))
{return or__11057__auto__;
} else
{return 0;
}
...
{var vec__40533 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__40533,0,null);var months = cljs.core.nth.call(null,vec__40533,1,null);var days = cljs.core.nth.call(null,vec__40533,2,null);var hours = cljs.core.nth.call(null,vec__40533,3,null);var minutes = cljs.core.nth.call(null,vec__40533,4,null);var seconds = cljs.core.nth.call(null,vec__40533,5,null);var ms = cljs.core.nth.call(null,vec__40533,6,null);var offset = cljs.core.nth.call(null,vec__40533,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
