...
{{
var G__179357 = cljs.core.pop.call(null,v__$1);
v__$1 = G__179357;
continue;
}
} else
...
{var pred__179361 = cljs.core._EQ_;var expr__179362 = limit;if(pred__179361.call(null,1,expr__179362))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__179361.call(null,2,expr__179362))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__179364 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__179365 = (limit__$1 - 1);
var G__179366 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__179364;
limit__$1 = G__179365;
parts = G__179366;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___179368 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___179368))
{var replacement_179369 = temp__4092__auto___179368;buffer.append([cljs.core.str(replacement_179369)].join(''));
} else
{buffer.append(ch);
}
{
var G__179370 = (index + 1);
index = G__179370;
continue;
}
}
