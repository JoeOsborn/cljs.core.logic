...
reader_error.cljs$lang$applyTo = (function (arglist__179653){
var rdr = cljs.core.first(arglist__179653);
var msg = cljs.core.rest(arglist__179653);
...
{{
var G__179654 = (function (){sb.append(ch);
return sb;
})();
var G__179655 = cljs.reader.read_char.call(null,rdr);
sb = G__179654;
ch = G__179655;
continue;
}
...
{{
var G__179656 = cljs.reader.read_char.call(null,rdr);
ch = G__179656;
continue;
}
} else
...
var G__179657 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__179657;
continue;
}
} else
...
var G__179658 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__179658;
continue;
}
}
...
{{
var G__179659 = (function (){buffer.append(ch);
return buffer;
})();
var G__179660 = cljs.reader.read_char.call(null,reader);
buffer = G__179659;
ch = G__179660;
continue;
}
...
{if(("\\" === ch))
{{
var G__179661 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__179662 = cljs.reader.read_char.call(null,reader);
buffer = G__179661;
ch = G__179662;
continue;
}
...
{{
var G__179663 = (function (){buffer.append(ch);
return buffer;
})();
var G__179664 = cljs.reader.read_char.call(null,reader);
buffer = G__179663;
ch = G__179664;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__179666 = o;if(G__179666)
{var bit__5323__auto__ = (G__179666.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__179666.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__179666.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__179666);
} else
{return false;
}
}
...
{{
var G__179667 = reader;
var G__179668 = eof_is_error;
var G__179669 = sentinel;
var G__179670 = is_recursive;
reader = G__179667;
eof_is_error = G__179668;
sentinel = G__179669;
is_recursive = G__179670;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__179671 = cljs.reader.read_comment.call(null,reader,ch);
var G__179672 = eof_is_error;
var G__179673 = sentinel;
var G__179674 = is_recursive;
reader = G__179671;
eof_is_error = G__179672;
sentinel = G__179673;
is_recursive = G__179674;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__179675 = reader;
var G__179676 = eof_is_error;
var G__179677 = sentinel;
var G__179678 = is_recursive;
reader = G__179675;
eof_is_error = G__179676;
sentinel = G__179677;
is_recursive = G__179678;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__179681 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__179681,0,null);var years = cljs.core.nth.call(null,vec__179681,1,null);var months = cljs.core.nth.call(null,vec__179681,2,null);var days = cljs.core.nth.call(null,vec__179681,3,null);var hours = cljs.core.nth.call(null,vec__179681,4,null);var minutes = cljs.core.nth.call(null,vec__179681,5,null);var seconds = cljs.core.nth.call(null,vec__179681,6,null);var fraction = cljs.core.nth.call(null,vec__179681,7,null);var offset_sign = cljs.core.nth.call(null,vec__179681,8,null);var offset_hours = cljs.core.nth.call(null,vec__179681,9,null);var offset_minutes = cljs.core.nth.call(null,vec__179681,10,null);var v = vec__179681;if(cljs.core.not.call(null,v))
...
{var vec__179683 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__179683,0,null);var months = cljs.core.nth.call(null,vec__179683,1,null);var days = cljs.core.nth.call(null,vec__179683,2,null);var hours = cljs.core.nth.call(null,vec__179683,3,null);var minutes = cljs.core.nth.call(null,vec__179683,4,null);var seconds = cljs.core.nth.call(null,vec__179683,5,null);var ms = cljs.core.nth.call(null,vec__179683,6,null);var offset = cljs.core.nth.call(null,vec__179683,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
