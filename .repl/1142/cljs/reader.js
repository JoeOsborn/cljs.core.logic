...
reader_error.cljs$lang$applyTo = (function (arglist__15833){
var rdr = cljs.core.first(arglist__15833);
var msg = cljs.core.rest(arglist__15833);
...
{{
var G__15834 = (function (){sb.append(ch);
return sb;
})();
var G__15835 = cljs.reader.read_char.call(null,rdr);
sb = G__15834;
ch = G__15835;
continue;
}
...
{{
var G__15836 = cljs.reader.read_char.call(null,rdr);
ch = G__15836;
continue;
}
} else
...
var G__15837 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__15837;
continue;
}
} else
...
var G__15838 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__15838;
continue;
}
}
...
{{
var G__15839 = (function (){buffer.append(ch);
return buffer;
})();
var G__15840 = cljs.reader.read_char.call(null,reader);
buffer = G__15839;
ch = G__15840;
continue;
}
...
{if(("\\" === ch))
{{
var G__15841 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__15842 = cljs.reader.read_char.call(null,reader);
buffer = G__15841;
ch = G__15842;
continue;
}
...
{{
var G__15843 = (function (){buffer.append(ch);
return buffer;
})();
var G__15844 = cljs.reader.read_char.call(null,reader);
buffer = G__15843;
ch = G__15844;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__15846 = o;if(G__15846)
{var bit__5323__auto__ = (G__15846.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__15846.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__15846.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__15846);
} else
{return false;
}
}
...
{{
var G__15847 = reader;
var G__15848 = eof_is_error;
var G__15849 = sentinel;
var G__15850 = is_recursive;
reader = G__15847;
eof_is_error = G__15848;
sentinel = G__15849;
is_recursive = G__15850;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__15851 = cljs.reader.read_comment.call(null,reader,ch);
var G__15852 = eof_is_error;
var G__15853 = sentinel;
var G__15854 = is_recursive;
reader = G__15851;
eof_is_error = G__15852;
sentinel = G__15853;
is_recursive = G__15854;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__15855 = reader;
var G__15856 = eof_is_error;
var G__15857 = sentinel;
var G__15858 = is_recursive;
reader = G__15855;
eof_is_error = G__15856;
sentinel = G__15857;
is_recursive = G__15858;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__15861 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__15861,0,null);var years = cljs.core.nth.call(null,vec__15861,1,null);var months = cljs.core.nth.call(null,vec__15861,2,null);var days = cljs.core.nth.call(null,vec__15861,3,null);var hours = cljs.core.nth.call(null,vec__15861,4,null);var minutes = cljs.core.nth.call(null,vec__15861,5,null);var seconds = cljs.core.nth.call(null,vec__15861,6,null);var fraction = cljs.core.nth.call(null,vec__15861,7,null);var offset_sign = cljs.core.nth.call(null,vec__15861,8,null);var offset_hours = cljs.core.nth.call(null,vec__15861,9,null);var offset_minutes = cljs.core.nth.call(null,vec__15861,10,null);var v = vec__15861;if(cljs.core.not.call(null,v))
...
{var vec__15863 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__15863,0,null);var months = cljs.core.nth.call(null,vec__15863,1,null);var days = cljs.core.nth.call(null,vec__15863,2,null);var hours = cljs.core.nth.call(null,vec__15863,3,null);var minutes = cljs.core.nth.call(null,vec__15863,4,null);var seconds = cljs.core.nth.call(null,vec__15863,5,null);var ms = cljs.core.nth.call(null,vec__15863,6,null);var offset = cljs.core.nth.call(null,vec__15863,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
