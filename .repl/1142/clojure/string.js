...
{{
var G__15864 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15864;
continue;
}
} else
...
{var pred__15868 = cljs.core._EQ_;var expr__15869 = limit;if(pred__15868.call(null,1,expr__15869))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__15868.call(null,2,expr__15869))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__15871 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15872 = (limit__$1 - 1);
var G__15873 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15871;
limit__$1 = G__15872;
parts = G__15873;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___15875 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___15875))
{var replacement_15876 = temp__4092__auto___15875;buffer.append([cljs.core.str(replacement_15876)].join(''));
} else
{buffer.append(ch);
}
{
var G__15877 = (index + 1);
index = G__15877;
continue;
}
}
