...
{{
var G__25528 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25528;
continue;
}
} else
...
{var pred__25532 = cljs.core._EQ_;var expr__25533 = limit;if(pred__25532.call(null,1,expr__25533))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__25532.call(null,2,expr__25533))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__25535 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25536 = (limit__$1 - 1);
var G__25537 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__25535;
limit__$1 = G__25536;
parts = G__25537;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___25539 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___25539))
{var replacement_25540 = temp__4092__auto___25539;buffer.append([cljs.core.str(replacement_25540)].join(''));
} else
{buffer.append(ch);
}
{
var G__25541 = (index + 1);
index = G__25541;
continue;
}
}
