...
reader_error.cljs$lang$applyTo = (function (arglist__25497){
var rdr = cljs.core.first(arglist__25497);
var msg = cljs.core.rest(arglist__25497);
...
{{
var G__25498 = (function (){sb.append(ch);
return sb;
})();
var G__25499 = cljs.reader.read_char.call(null,rdr);
sb = G__25498;
ch = G__25499;
continue;
}
...
{{
var G__25500 = cljs.reader.read_char.call(null,rdr);
ch = G__25500;
continue;
}
} else
...
var G__25501 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__25501;
continue;
}
} else
...
var G__25502 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__25502;
continue;
}
}
...
{{
var G__25503 = (function (){buffer.append(ch);
return buffer;
})();
var G__25504 = cljs.reader.read_char.call(null,reader);
buffer = G__25503;
ch = G__25504;
continue;
}
...
{if(("\\" === ch))
{{
var G__25505 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__25506 = cljs.reader.read_char.call(null,reader);
buffer = G__25505;
ch = G__25506;
continue;
}
...
{{
var G__25507 = (function (){buffer.append(ch);
return buffer;
})();
var G__25508 = cljs.reader.read_char.call(null,reader);
buffer = G__25507;
ch = G__25508;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__25510 = o;if(G__25510)
{var bit__5323__auto__ = (G__25510.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__25510.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__25510.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__25510);
} else
{return false;
}
}
...
{{
var G__25511 = reader;
var G__25512 = eof_is_error;
var G__25513 = sentinel;
var G__25514 = is_recursive;
reader = G__25511;
eof_is_error = G__25512;
sentinel = G__25513;
is_recursive = G__25514;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__25515 = cljs.reader.read_comment.call(null,reader,ch);
var G__25516 = eof_is_error;
var G__25517 = sentinel;
var G__25518 = is_recursive;
reader = G__25515;
eof_is_error = G__25516;
sentinel = G__25517;
is_recursive = G__25518;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__25519 = reader;
var G__25520 = eof_is_error;
var G__25521 = sentinel;
var G__25522 = is_recursive;
reader = G__25519;
eof_is_error = G__25520;
sentinel = G__25521;
is_recursive = G__25522;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__25525 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__25525,0,null);var years = cljs.core.nth.call(null,vec__25525,1,null);var months = cljs.core.nth.call(null,vec__25525,2,null);var days = cljs.core.nth.call(null,vec__25525,3,null);var hours = cljs.core.nth.call(null,vec__25525,4,null);var minutes = cljs.core.nth.call(null,vec__25525,5,null);var seconds = cljs.core.nth.call(null,vec__25525,6,null);var fraction = cljs.core.nth.call(null,vec__25525,7,null);var offset_sign = cljs.core.nth.call(null,vec__25525,8,null);var offset_hours = cljs.core.nth.call(null,vec__25525,9,null);var offset_minutes = cljs.core.nth.call(null,vec__25525,10,null);var v = vec__25525;if(cljs.core.not.call(null,v))
...
{var vec__25527 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__25527,0,null);var months = cljs.core.nth.call(null,vec__25527,1,null);var days = cljs.core.nth.call(null,vec__25527,2,null);var hours = cljs.core.nth.call(null,vec__25527,3,null);var minutes = cljs.core.nth.call(null,vec__25527,4,null);var seconds = cljs.core.nth.call(null,vec__25527,5,null);var ms = cljs.core.nth.call(null,vec__25527,6,null);var offset = cljs.core.nth.call(null,vec__25527,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
