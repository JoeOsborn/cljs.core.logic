...
{{
var G__83329 = cljs.core.pop.call(null,v__$1);
v__$1 = G__83329;
continue;
}
} else
...
{var pred__83333 = cljs.core._EQ_;var expr__83334 = limit;if(pred__83333.call(null,1,expr__83334))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__83333.call(null,2,expr__83334))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__83336 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__83337 = (limit__$1 - 1);
var G__83338 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__83336;
limit__$1 = G__83337;
parts = G__83338;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___83340 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___83340))
{var replacement_83341 = temp__4092__auto___83340;buffer.append([cljs.core.str(replacement_83341)].join(''));
} else
{buffer.append(ch);
}
{
var G__83342 = (index + 1);
index = G__83342;
continue;
}
}
