...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__83344 = m;var map__83344__$1 = ((cljs.core.seq_QMARK_.call(null,map__83344))?cljs.core.apply.call(null,cljs.core.hash_map,map__83344):map__83344);var line = cljs.core.get.call(null,map__83344__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__83344__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__83346 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__83346))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__83346))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83347;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_83348 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83348;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_83349 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___83350 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___83350))
{var message_83351 = temp__4094__auto___83350;cljs.core.println.call(null,message_83351);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83349;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_83352 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___83353 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___83353))
{var message_83354 = temp__4094__auto___83353;cljs.core.println.call(null,message_83354);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83355;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_83356 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83356;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__83357){
var ns_sym = cljs.core.first(arglist__83357);
arglist__83357 = cljs.core.next(arglist__83357);
var fixture_type = cljs.core.first(arglist__83357);
var fixture_fns = cljs.core.rest(arglist__83357);
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_83360;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__83367 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__83368 = null;var count__83369 = 0;var i__83370 = 0;while(true){
if((i__83370 < count__83369))
{var v = cljs.core._nth.call(null,chunk__83368,i__83370);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__83367,chunk__83368,count__83369,i__83370,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__83367,chunk__83368,count__83369,i__83370,v))
);
} else
{}
{
var G__83371 = seq__83367;
var G__83372 = chunk__83368;
var G__83373 = count__83369;
var G__83374 = (i__83370 + 1);
seq__83367 = G__83371;
chunk__83368 = G__83372;
count__83369 = G__83373;
i__83370 = G__83374;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__83367);if(temp__4094__auto__)
{var seq__83367__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__83367__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__83367__$1);{
var G__83375 = cljs.core.chunk_rest.call(null,seq__83367__$1);
var G__83376 = c__5421__auto__;
var G__83377 = cljs.core.count.call(null,c__5421__auto__);
var G__83378 = 0;
seq__83367 = G__83375;
chunk__83368 = G__83376;
count__83369 = G__83377;
i__83370 = G__83378;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__83367__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__83367,chunk__83368,count__83369,i__83370,v,seq__83367__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__83367,chunk__83368,count__83369,i__83370,v,seq__83367__$1,temp__4094__auto__))
);
} else
{}
{
var G__83379 = cljs.core.next.call(null,seq__83367__$1);
var G__83380 = null;
var G__83381 = 0;
var G__83382 = 0;
seq__83367 = G__83379;
chunk__83368 = G__83380;
count__83369 = G__83381;
i__83370 = G__83382;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_83384 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___83385 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___83385))
{var test_hook_83386 = temp__4092__auto___83385;test_hook_83386.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_83384;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__83387){
var namespaces = cljs.core.seq(arglist__83387);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__83388_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__83388_SHARP_));
