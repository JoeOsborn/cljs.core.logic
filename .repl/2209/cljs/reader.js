...
reader_error.cljs$lang$applyTo = (function (arglist__83298){
var rdr = cljs.core.first(arglist__83298);
var msg = cljs.core.rest(arglist__83298);
...
{{
var G__83299 = (function (){sb.append(ch);
return sb;
})();
var G__83300 = cljs.reader.read_char.call(null,rdr);
sb = G__83299;
ch = G__83300;
continue;
}
...
{{
var G__83301 = cljs.reader.read_char.call(null,rdr);
ch = G__83301;
continue;
}
} else
...
var G__83302 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__83302;
continue;
}
} else
...
var G__83303 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__83303;
continue;
}
}
...
{{
var G__83304 = (function (){buffer.append(ch);
return buffer;
})();
var G__83305 = cljs.reader.read_char.call(null,reader);
buffer = G__83304;
ch = G__83305;
continue;
}
...
{if(("\\" === ch))
{{
var G__83306 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__83307 = cljs.reader.read_char.call(null,reader);
buffer = G__83306;
ch = G__83307;
continue;
}
...
{{
var G__83308 = (function (){buffer.append(ch);
return buffer;
})();
var G__83309 = cljs.reader.read_char.call(null,reader);
buffer = G__83308;
ch = G__83309;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__83311 = o;if(G__83311)
{var bit__5323__auto__ = (G__83311.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__83311.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__83311.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__83311);
} else
{return false;
}
}
...
{{
var G__83312 = reader;
var G__83313 = eof_is_error;
var G__83314 = sentinel;
var G__83315 = is_recursive;
reader = G__83312;
eof_is_error = G__83313;
sentinel = G__83314;
is_recursive = G__83315;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__83316 = cljs.reader.read_comment.call(null,reader,ch);
var G__83317 = eof_is_error;
var G__83318 = sentinel;
var G__83319 = is_recursive;
reader = G__83316;
eof_is_error = G__83317;
sentinel = G__83318;
is_recursive = G__83319;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__83320 = reader;
var G__83321 = eof_is_error;
var G__83322 = sentinel;
var G__83323 = is_recursive;
reader = G__83320;
eof_is_error = G__83321;
sentinel = G__83322;
is_recursive = G__83323;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__83326 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__83326,0,null);var years = cljs.core.nth.call(null,vec__83326,1,null);var months = cljs.core.nth.call(null,vec__83326,2,null);var days = cljs.core.nth.call(null,vec__83326,3,null);var hours = cljs.core.nth.call(null,vec__83326,4,null);var minutes = cljs.core.nth.call(null,vec__83326,5,null);var seconds = cljs.core.nth.call(null,vec__83326,6,null);var fraction = cljs.core.nth.call(null,vec__83326,7,null);var offset_sign = cljs.core.nth.call(null,vec__83326,8,null);var offset_hours = cljs.core.nth.call(null,vec__83326,9,null);var offset_minutes = cljs.core.nth.call(null,vec__83326,10,null);var v = vec__83326;if(cljs.core.not.call(null,v))
...
{var vec__83328 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__83328,0,null);var months = cljs.core.nth.call(null,vec__83328,1,null);var days = cljs.core.nth.call(null,vec__83328,2,null);var hours = cljs.core.nth.call(null,vec__83328,3,null);var minutes = cljs.core.nth.call(null,vec__83328,4,null);var seconds = cljs.core.nth.call(null,vec__83328,5,null);var ms = cljs.core.nth.call(null,vec__83328,6,null);var offset = cljs.core.nth.call(null,vec__83328,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
