...
reader_error.cljs$lang$applyTo = (function (arglist__10377){
var rdr = cljs.core.first(arglist__10377);
var msg = cljs.core.rest(arglist__10377);
...
{{
var G__10378 = (function (){sb.append(ch);
return sb;
})();
var G__10379 = cljs.reader.read_char.call(null,rdr);
sb = G__10378;
ch = G__10379;
continue;
}
...
{{
var G__10380 = cljs.reader.read_char.call(null,rdr);
ch = G__10380;
continue;
}
} else
...
var G__10381 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10381;
continue;
}
} else
...
var G__10382 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10382;
continue;
}
}
...
{{
var G__10383 = (function (){buffer.append(ch);
return buffer;
})();
var G__10384 = cljs.reader.read_char.call(null,reader);
buffer = G__10383;
ch = G__10384;
continue;
}
...
{if(("\\" === ch))
{{
var G__10385 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10386 = cljs.reader.read_char.call(null,reader);
buffer = G__10385;
ch = G__10386;
continue;
}
...
{{
var G__10387 = (function (){buffer.append(ch);
return buffer;
})();
var G__10388 = cljs.reader.read_char.call(null,reader);
buffer = G__10387;
ch = G__10388;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10390 = o;if(G__10390)
{var bit__5323__auto__ = (G__10390.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__10390.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10390.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10390);
} else
{return false;
}
}
...
{{
var G__10391 = reader;
var G__10392 = eof_is_error;
var G__10393 = sentinel;
var G__10394 = is_recursive;
reader = G__10391;
eof_is_error = G__10392;
sentinel = G__10393;
is_recursive = G__10394;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10395 = cljs.reader.read_comment.call(null,reader,ch);
var G__10396 = eof_is_error;
var G__10397 = sentinel;
var G__10398 = is_recursive;
reader = G__10395;
eof_is_error = G__10396;
sentinel = G__10397;
is_recursive = G__10398;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10399 = reader;
var G__10400 = eof_is_error;
var G__10401 = sentinel;
var G__10402 = is_recursive;
reader = G__10399;
eof_is_error = G__10400;
sentinel = G__10401;
is_recursive = G__10402;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10405 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10405,0,null);var years = cljs.core.nth.call(null,vec__10405,1,null);var months = cljs.core.nth.call(null,vec__10405,2,null);var days = cljs.core.nth.call(null,vec__10405,3,null);var hours = cljs.core.nth.call(null,vec__10405,4,null);var minutes = cljs.core.nth.call(null,vec__10405,5,null);var seconds = cljs.core.nth.call(null,vec__10405,6,null);var fraction = cljs.core.nth.call(null,vec__10405,7,null);var offset_sign = cljs.core.nth.call(null,vec__10405,8,null);var offset_hours = cljs.core.nth.call(null,vec__10405,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10405,10,null);var v = vec__10405;if(cljs.core.not.call(null,v))
...
{var vec__10407 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__10407,0,null);var months = cljs.core.nth.call(null,vec__10407,1,null);var days = cljs.core.nth.call(null,vec__10407,2,null);var hours = cljs.core.nth.call(null,vec__10407,3,null);var minutes = cljs.core.nth.call(null,vec__10407,4,null);var seconds = cljs.core.nth.call(null,vec__10407,5,null);var ms = cljs.core.nth.call(null,vec__10407,6,null);var offset = cljs.core.nth.call(null,vec__10407,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
