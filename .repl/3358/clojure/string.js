...
{{
var G__10408 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10408;
continue;
}
} else
...
{var pred__10412 = cljs.core._EQ_;var expr__10413 = limit;if(pred__10412.call(null,1,expr__10413))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10412.call(null,2,expr__10413))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10415 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10416 = (limit__$1 - 1);
var G__10417 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10415;
limit__$1 = G__10416;
parts = G__10417;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10419 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10419))
{var replacement_10420 = temp__4092__auto___10419;buffer.append([cljs.core.str(replacement_10420)].join(''));
} else
{buffer.append(ch);
}
{
var G__10421 = (index + 1);
index = G__10421;
continue;
}
}
