...
{{
var G__274716 = cljs.core.pop.call(null,v__$1);
v__$1 = G__274716;
continue;
}
} else
...
{var pred__274720 = cljs.core._EQ_;var expr__274721 = limit;if(cljs.core.truth_(pred__274720.call(null,1,expr__274721)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__274720.call(null,2,expr__274721)))
...
var G__274723 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__274724 = (limit__$1 - 1);
var G__274725 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__274723;
limit__$1 = G__274724;
parts = G__274725;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___274727 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___274727))
{var replacement_274728 = temp__4096__auto___274727;buffer.append([cljs.core.str(replacement_274728)].join(''));
} else
{buffer.append(ch);
}
{
var G__274729 = (index + 1);
index = G__274729;
continue;
}
}
