...
{{
var G__8470 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8470;
continue;
}
} else
...
{var pred__8474 = cljs.core._EQ_;var expr__8475 = limit;if(pred__8474.call(null,1,expr__8475))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__8474.call(null,2,expr__8475))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
{var ch = s.charAt(index);var temp__4092__auto___8481 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___8481))
{var replacement_8482 = temp__4092__auto___8481;buffer.append([cljs.core.str(replacement_8482)].join(''));
} else
{buffer.append(ch);
}
{
