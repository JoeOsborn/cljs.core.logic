...
{{
var G__49959 = cljs.core.pop.call(null,v__$1);
v__$1 = G__49959;
continue;
}
} else
...
{var pred__49963 = cljs.core._EQ_;var expr__49964 = limit;if(cljs.core.truth_(pred__49963.call(null,1,expr__49964)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__49963.call(null,2,expr__49964)))
...
var G__49966 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__49967 = (limit__$1 - 1);
var G__49968 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__49966;
limit__$1 = G__49967;
parts = G__49968;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___49970 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___49970))
{var replacement_49971 = temp__4096__auto___49970;buffer.append([cljs.core.str(replacement_49971)].join(''));
} else
{buffer.append(ch);
}
{
var G__49972 = (index + 1);
index = G__49972;
continue;
}
}
