...
reader_error.cljs$lang$applyTo = (function (arglist__21565){
var rdr = cljs.core.first(arglist__21565);
var msg = cljs.core.rest(arglist__21565);
...
{{
var G__21566 = (function (){sb.append(ch);
return sb;
})();
var G__21567 = cljs.reader.read_char.call(null,rdr);
sb = G__21566;
ch = G__21567;
continue;
}
...
{{
var G__21568 = cljs.reader.read_char.call(null,rdr);
ch = G__21568;
continue;
}
} else
...
var G__21569 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__21569;
continue;
}
} else
...
var G__21570 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__21570;
continue;
}
}
...
{{
var G__21571 = (function (){buffer.append(ch);
return buffer;
})();
var G__21572 = cljs.reader.read_char.call(null,reader);
buffer = G__21571;
ch = G__21572;
continue;
}
...
{if(("\\" === ch))
{{
var G__21573 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__21574 = cljs.reader.read_char.call(null,reader);
buffer = G__21573;
ch = G__21574;
continue;
}
...
{{
var G__21575 = (function (){buffer.append(ch);
return buffer;
})();
var G__21576 = cljs.reader.read_char.call(null,reader);
buffer = G__21575;
ch = G__21576;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__21578 = o;if(G__21578)
{var bit__5323__auto__ = (G__21578.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__21578.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__21578.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__21578);
} else
{return false;
}
}
...
{{
var G__21579 = reader;
var G__21580 = eof_is_error;
var G__21581 = sentinel;
var G__21582 = is_recursive;
reader = G__21579;
eof_is_error = G__21580;
sentinel = G__21581;
is_recursive = G__21582;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__21583 = cljs.reader.read_comment.call(null,reader,ch);
var G__21584 = eof_is_error;
var G__21585 = sentinel;
var G__21586 = is_recursive;
reader = G__21583;
eof_is_error = G__21584;
sentinel = G__21585;
is_recursive = G__21586;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__21587 = reader;
var G__21588 = eof_is_error;
var G__21589 = sentinel;
var G__21590 = is_recursive;
reader = G__21587;
eof_is_error = G__21588;
sentinel = G__21589;
is_recursive = G__21590;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__21593 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__21593,0,null);var years = cljs.core.nth.call(null,vec__21593,1,null);var months = cljs.core.nth.call(null,vec__21593,2,null);var days = cljs.core.nth.call(null,vec__21593,3,null);var hours = cljs.core.nth.call(null,vec__21593,4,null);var minutes = cljs.core.nth.call(null,vec__21593,5,null);var seconds = cljs.core.nth.call(null,vec__21593,6,null);var fraction = cljs.core.nth.call(null,vec__21593,7,null);var offset_sign = cljs.core.nth.call(null,vec__21593,8,null);var offset_hours = cljs.core.nth.call(null,vec__21593,9,null);var offset_minutes = cljs.core.nth.call(null,vec__21593,10,null);var v = vec__21593;if(cljs.core.not.call(null,v))
...
{var vec__21595 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__21595,0,null);var months = cljs.core.nth.call(null,vec__21595,1,null);var days = cljs.core.nth.call(null,vec__21595,2,null);var hours = cljs.core.nth.call(null,vec__21595,3,null);var minutes = cljs.core.nth.call(null,vec__21595,4,null);var seconds = cljs.core.nth.call(null,vec__21595,5,null);var ms = cljs.core.nth.call(null,vec__21595,6,null);var offset = cljs.core.nth.call(null,vec__21595,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
