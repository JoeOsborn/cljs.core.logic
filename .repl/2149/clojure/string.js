...
{{
var G__21596 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21596;
continue;
}
} else
...
{var pred__21600 = cljs.core._EQ_;var expr__21601 = limit;if(pred__21600.call(null,1,expr__21601))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__21600.call(null,2,expr__21601))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__21603 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21604 = (limit__$1 - 1);
var G__21605 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__21603;
limit__$1 = G__21604;
parts = G__21605;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___21607 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___21607))
{var replacement_21608 = temp__4092__auto___21607;buffer.append([cljs.core.str(replacement_21608)].join(''));
} else
{buffer.append(ch);
}
{
var G__21609 = (index + 1);
index = G__21609;
continue;
}
}
