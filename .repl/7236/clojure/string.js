...
{{
var G__44141 = cljs.core.pop.call(null,v__$1);
v__$1 = G__44141;
continue;
}
} else
...
{var pred__44145 = cljs.core._EQ_;var expr__44146 = limit;if(pred__44145.call(null,1,expr__44146))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__44145.call(null,2,expr__44146))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__44148 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__44149 = (limit__$1 - 1);
var G__44150 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__44148;
limit__$1 = G__44149;
parts = G__44150;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___44152 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___44152))
{var replacement_44153 = temp__4092__auto___44152;buffer.append([cljs.core.str(replacement_44153)].join(''));
} else
{buffer.append(ch);
}
{
var G__44154 = (index + 1);
index = G__44154;
continue;
}
}
