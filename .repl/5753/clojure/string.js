...
{{
var G__87245 = cljs.core.pop.call(null,v__$1);
v__$1 = G__87245;
continue;
}
} else
...
{var pred__87249 = cljs.core._EQ_;var expr__87250 = limit;if(cljs.core.truth_(pred__87249.call(null,1,expr__87250)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__87249.call(null,2,expr__87250)))
...
var G__87252 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__87253 = (limit__$1 - 1);
var G__87254 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__87252;
limit__$1 = G__87253;
parts = G__87254;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___87256 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___87256))
{var replacement_87257 = temp__4096__auto___87256;buffer.append([cljs.core.str(replacement_87257)].join(''));
} else
{buffer.append(ch);
}
{
var G__87258 = (index + 1);
index = G__87258;
continue;
}
}
