...
{{
var G__111297 = cljs.core.pop.call(null,v__$1);
v__$1 = G__111297;
continue;
}
} else
...
{var pred__111301 = cljs.core._EQ_;var expr__111302 = limit;if(cljs.core.truth_(pred__111301.call(null,1,expr__111302)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__111301.call(null,2,expr__111302)))
...
{var temp__4092__auto__ = cljs.core.re_find.call(null,re,s__$1);if(cljs.core.truth_(temp__4092__auto__))
{var m = temp__4092__auto__;var index = s__$1.indexOf(m);{
var G__111304 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__111305 = (limit__$1 - 1);
var G__111306 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__111304;
limit__$1 = G__111305;
parts = G__111306;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___111308 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___111308))
{var replacement_111309 = temp__4092__auto___111308;buffer.append([cljs.core.str(replacement_111309)].join(''));
} else
{buffer.append(ch);
}
{
var G__111310 = (index + 1);
index = G__111310;
continue;
}
}
