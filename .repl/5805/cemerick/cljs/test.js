...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__111312 = m;var map__111312__$1 = ((cljs.core.seq_QMARK_.call(null,map__111312))?cljs.core.apply.call(null,cljs.core.hash_map,map__111312):map__111312);var line = cljs.core.get.call(null,map__111312__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__111312__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__111314 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__111314))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__111314))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_111315;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_111316 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_111316;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_111317 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___111318 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___111318))
{var message_111319 = temp__4094__auto___111318;cljs.core.println.call(null,message_111319);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_111317;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_111320 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___111321 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___111321))
{var message_111322 = temp__4094__auto___111321;cljs.core.println.call(null,message_111322);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_111320;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_111323 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_111323;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_111324 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_111324;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__111325){
var ns_sym = cljs.core.first(arglist__111325);
arglist__111325 = cljs.core.next(arglist__111325);
var fixture_type = cljs.core.first(arglist__111325);
var fixture_fns = cljs.core.rest(arglist__111325);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_111328 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__5132__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e111329){if((e111329 instanceof Error))
{var e_111330 = e111329;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_111330], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e111329;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_111328;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__111335 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__111336 = null;var count__111337 = 0;var i__111338 = 0;while(true){
if((i__111338 < count__111337))
{var v = cljs.core._nth.call(null,chunk__111336,i__111338);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__111335,chunk__111336,count__111337,i__111338,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__111335,chunk__111336,count__111337,i__111338,v))
);
} else
{}
{
var G__111339 = seq__111335;
var G__111340 = chunk__111336;
var G__111341 = count__111337;
var G__111342 = (i__111338 + 1);
seq__111335 = G__111339;
chunk__111336 = G__111340;
count__111337 = G__111341;
i__111338 = G__111342;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__111335);if(temp__4094__auto__)
{var seq__111335__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__111335__$1))
{var c__5851__auto__ = cljs.core.chunk_first.call(null,seq__111335__$1);{
var G__111343 = cljs.core.chunk_rest.call(null,seq__111335__$1);
var G__111344 = c__5851__auto__;
var G__111345 = cljs.core.count.call(null,c__5851__auto__);
var G__111346 = 0;
seq__111335 = G__111343;
chunk__111336 = G__111344;
count__111337 = G__111345;
i__111338 = G__111346;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__111335__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__111335,chunk__111336,count__111337,i__111338,v,seq__111335__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__111335,chunk__111336,count__111337,i__111338,v,seq__111335__$1,temp__4094__auto__))
);
} else
{}
{
var G__111347 = cljs.core.next.call(null,seq__111335__$1);
var G__111348 = null;
var G__111349 = 0;
var G__111350 = 0;
seq__111335 = G__111347;
chunk__111336 = G__111348;
count__111337 = G__111349;
i__111338 = G__111350;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_111352 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___111353 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___111353))
{var test_hook_111354 = temp__4092__auto___111353;test_hook_111354.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_111352;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__111355){
var namespaces = cljs.core.seq(arglist__111355);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__111356_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__111356_SHARP_));
