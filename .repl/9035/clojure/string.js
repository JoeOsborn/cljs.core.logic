...
{{
var G__197895 = cljs.core.pop.call(null,v__$1);
v__$1 = G__197895;
continue;
}
} else
...
{var pred__197899 = cljs.core._EQ_;var expr__197900 = limit;if(pred__197899.call(null,1,expr__197900))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__197899.call(null,2,expr__197900))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__197902 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__197903 = (limit__$1 - 1);
var G__197904 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__197902;
limit__$1 = G__197903;
parts = G__197904;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___197906 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___197906))
{var replacement_197907 = temp__4092__auto___197906;buffer.append([cljs.core.str(replacement_197907)].join(''));
} else
{buffer.append(ch);
}
{
var G__197908 = (index + 1);
index = G__197908;
continue;
}
}
