...
{{
var G__10163 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10163;
continue;
}
} else
...
{var pred__10167 = cljs.core._EQ_;var expr__10168 = limit;if(pred__10167.call(null,1,expr__10168))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10167.call(null,2,expr__10168))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10170 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10171 = (limit__$1 - 1);
var G__10172 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10170;
limit__$1 = G__10171;
parts = G__10172;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10174 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10174))
{var replacement_10175 = temp__4092__auto___10174;buffer.append([cljs.core.str(replacement_10175)].join(''));
} else
{buffer.append(ch);
}
{
var G__10176 = (index + 1);
index = G__10176;
continue;
}
}
