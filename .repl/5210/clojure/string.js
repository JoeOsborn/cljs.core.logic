...
{{
var G__28354 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28354;
continue;
}
} else
...
{var pred__28358 = cljs.core._EQ_;var expr__28359 = limit;if(pred__28358.call(null,1,expr__28359))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__28358.call(null,2,expr__28359))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__28363 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28364 = (limit__$1 - 1);
var G__28365 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28363;
limit__$1 = G__28364;
parts = G__28365;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___28368 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___28368))
{var replacement_28369 = temp__4092__auto___28368;buffer.append([cljs.core.str(replacement_28369)].join(''));
} else
{buffer.append(ch);
}
{
var G__28370 = (index + 1);
index = G__28370;
continue;
}
}
