...
{{
var G__230434 = cljs.core.pop.call(null,v__$1);
v__$1 = G__230434;
continue;
}
} else
...
{var pred__230438 = cljs.core._EQ_;var expr__230439 = limit;if(cljs.core.truth_(pred__230438.call(null,1,expr__230439)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__230438.call(null,2,expr__230439)))
...
var G__230441 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__230442 = (limit__$1 - 1);
var G__230443 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__230441;
limit__$1 = G__230442;
parts = G__230443;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___230445 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___230445))
{var replacement_230446 = temp__4096__auto___230445;buffer.append([cljs.core.str(replacement_230446)].join(''));
} else
{buffer.append(ch);
}
{
var G__230447 = (index + 1);
index = G__230447;
continue;
}
}
