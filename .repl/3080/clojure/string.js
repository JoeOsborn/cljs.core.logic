...
{{
var G__227526 = cljs.core.pop.call(null,v__$1);
v__$1 = G__227526;
continue;
}
} else
...
{var pred__227530 = cljs.core._EQ_;var expr__227531 = limit;if(pred__227530.call(null,1,expr__227531))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__227530.call(null,2,expr__227531))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__227533 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__227534 = (limit__$1 - 1);
var G__227535 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__227533;
limit__$1 = G__227534;
parts = G__227535;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___227537 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___227537))
{var replacement_227538 = temp__4092__auto___227537;buffer.append([cljs.core.str(replacement_227538)].join(''));
} else
{buffer.append(ch);
}
{
var G__227539 = (index + 1);
index = G__227539;
continue;
}
}
