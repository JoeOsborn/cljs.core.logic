...
{{
var G__312657 = cljs.core.pop.call(null,v__$1);
v__$1 = G__312657;
continue;
}
} else
...
{var pred__312661 = cljs.core._EQ_;var expr__312662 = limit;if(cljs.core.truth_(pred__312661.call(null,1,expr__312662)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__312661.call(null,2,expr__312662)))
...
var G__312664 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__312665 = (limit__$1 - 1);
var G__312666 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__312664;
limit__$1 = G__312665;
parts = G__312666;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___312668 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___312668))
{var replacement_312669 = temp__4096__auto___312668;buffer.append([cljs.core.str(replacement_312669)].join(''));
} else
{buffer.append(ch);
}
{
var G__312670 = (index + 1);
index = G__312670;
continue;
}
}
