...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj15289 = {};return obj15289;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__15290){
var rdr = cljs.core.first(arglist__15290);
var msg = cljs.core.rest(arglist__15290);
...
{{
var G__15291 = (function (){sb.append(ch);
return sb;
})();
var G__15292 = cljs.reader.read_char.call(null,rdr);
sb = G__15291;
ch = G__15292;
continue;
}
...
var G__15294 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__15294;
continue;
}
} else
...
var G__15295 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__15295;
continue;
}
}
...
{{
var G__15296 = (function (){buffer.append(ch);
return buffer;
})();
var G__15297 = cljs.reader.read_char.call(null,reader);
buffer = G__15296;
ch = G__15297;
continue;
}
...
{if(("\\" === ch))
{{
var G__15298 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__15299 = cljs.reader.read_char.call(null,reader);
buffer = G__15298;
ch = G__15299;
continue;
}
...
{{
var G__15300 = (function (){buffer.append(ch);
return buffer;
})();
var G__15301 = cljs.reader.read_char.call(null,reader);
buffer = G__15300;
ch = G__15301;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__15303 = o;if(G__15303)
{var bit__11184__auto__ = (G__15303.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__11184__auto__) || (G__15303.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__15303.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__15303);
} else
{return false;
}
}
...
{{
var G__15304 = reader;
var G__15305 = eof_is_error;
var G__15306 = sentinel;
var G__15307 = is_recursive;
reader = G__15304;
eof_is_error = G__15305;
sentinel = G__15306;
is_recursive = G__15307;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__15308 = cljs.reader.read_comment.call(null,reader,ch);
var G__15309 = eof_is_error;
var G__15310 = sentinel;
var G__15311 = is_recursive;
reader = G__15308;
eof_is_error = G__15309;
sentinel = G__15310;
is_recursive = G__15311;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__15318 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__15318,0,null);var years = cljs.core.nth.call(null,vec__15318,1,null);var months = cljs.core.nth.call(null,vec__15318,2,null);var days = cljs.core.nth.call(null,vec__15318,3,null);var hours = cljs.core.nth.call(null,vec__15318,4,null);var minutes = cljs.core.nth.call(null,vec__15318,5,null);var seconds = cljs.core.nth.call(null,vec__15318,6,null);var fraction = cljs.core.nth.call(null,vec__15318,7,null);var offset_sign = cljs.core.nth.call(null,vec__15318,8,null);var offset_hours = cljs.core.nth.call(null,vec__15318,9,null);var offset_minutes = cljs.core.nth.call(null,vec__15318,10,null);var v = vec__15318;if(cljs.core.not.call(null,v))
...
{var vec__15320 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__15320,0,null);var months = cljs.core.nth.call(null,vec__15320,1,null);var days = cljs.core.nth.call(null,vec__15320,2,null);var hours = cljs.core.nth.call(null,vec__15320,3,null);var minutes = cljs.core.nth.call(null,vec__15320,4,null);var seconds = cljs.core.nth.call(null,vec__15320,5,null);var ms = cljs.core.nth.call(null,vec__15320,6,null);var offset = cljs.core.nth.call(null,vec__15320,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
