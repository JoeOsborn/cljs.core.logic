...
{{
var G__15321 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15321;
continue;
}
} else
...
{var pred__15325 = cljs.core._EQ_;var expr__15326 = limit;if(cljs.core.truth_(pred__15325.call(null,1,expr__15326)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15325.call(null,2,expr__15326)))
...
var G__15328 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15329 = (limit__$1 - 1);
var G__15330 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15328;
limit__$1 = G__15329;
parts = G__15330;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___15332 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___15332))
{var replacement_15333 = temp__4096__auto___15332;buffer.append([cljs.core.str(replacement_15333)].join(''));
} else
{buffer.append(ch);
}
{
var G__15334 = (index + 1);
index = G__15334;
continue;
}
}
