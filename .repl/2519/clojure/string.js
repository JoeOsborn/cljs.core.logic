...
{{
var G__192268 = cljs.core.pop.call(null,v__$1);
v__$1 = G__192268;
continue;
}
} else
...
{var pred__192272 = cljs.core._EQ_;var expr__192273 = limit;if(pred__192272.call(null,1,expr__192273))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__192272.call(null,2,expr__192273))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__192275 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__192276 = (limit__$1 - 1);
var G__192277 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__192275;
limit__$1 = G__192276;
parts = G__192277;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___192279 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___192279))
{var replacement_192280 = temp__4092__auto___192279;buffer.append([cljs.core.str(replacement_192280)].join(''));
} else
{buffer.append(ch);
}
{
var G__192281 = (index + 1);
index = G__192281;
continue;
}
}
