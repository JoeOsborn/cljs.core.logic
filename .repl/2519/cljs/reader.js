...
reader_error.cljs$lang$applyTo = (function (arglist__192564){
var rdr = cljs.core.first(arglist__192564);
var msg = cljs.core.rest(arglist__192564);
...
{{
var G__192565 = (function (){sb.append(ch);
return sb;
})();
var G__192566 = cljs.reader.read_char.call(null,rdr);
sb = G__192565;
ch = G__192566;
continue;
}
...
{{
var G__192567 = cljs.reader.read_char.call(null,rdr);
ch = G__192567;
continue;
}
} else
...
var G__192568 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__192568;
continue;
}
} else
...
var G__192569 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__192569;
continue;
}
}
...
{{
var G__192570 = (function (){buffer.append(ch);
return buffer;
})();
var G__192571 = cljs.reader.read_char.call(null,reader);
buffer = G__192570;
ch = G__192571;
continue;
}
...
{if(("\\" === ch))
{{
var G__192572 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__192573 = cljs.reader.read_char.call(null,reader);
buffer = G__192572;
ch = G__192573;
continue;
}
...
{{
var G__192574 = (function (){buffer.append(ch);
return buffer;
})();
var G__192575 = cljs.reader.read_char.call(null,reader);
buffer = G__192574;
ch = G__192575;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__192577 = o;if(G__192577)
{var bit__5323__auto__ = (G__192577.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__192577.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__192577.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__192577);
} else
{return false;
}
}
...
{{
var G__192578 = reader;
var G__192579 = eof_is_error;
var G__192580 = sentinel;
var G__192581 = is_recursive;
reader = G__192578;
eof_is_error = G__192579;
sentinel = G__192580;
is_recursive = G__192581;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__192582 = cljs.reader.read_comment.call(null,reader,ch);
var G__192583 = eof_is_error;
var G__192584 = sentinel;
var G__192585 = is_recursive;
reader = G__192582;
eof_is_error = G__192583;
sentinel = G__192584;
is_recursive = G__192585;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__192586 = reader;
var G__192587 = eof_is_error;
var G__192588 = sentinel;
var G__192589 = is_recursive;
reader = G__192586;
eof_is_error = G__192587;
sentinel = G__192588;
is_recursive = G__192589;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__192592 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__192592,0,null);var years = cljs.core.nth.call(null,vec__192592,1,null);var months = cljs.core.nth.call(null,vec__192592,2,null);var days = cljs.core.nth.call(null,vec__192592,3,null);var hours = cljs.core.nth.call(null,vec__192592,4,null);var minutes = cljs.core.nth.call(null,vec__192592,5,null);var seconds = cljs.core.nth.call(null,vec__192592,6,null);var fraction = cljs.core.nth.call(null,vec__192592,7,null);var offset_sign = cljs.core.nth.call(null,vec__192592,8,null);var offset_hours = cljs.core.nth.call(null,vec__192592,9,null);var offset_minutes = cljs.core.nth.call(null,vec__192592,10,null);var v = vec__192592;if(cljs.core.not.call(null,v))
...
{var vec__192594 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__192594,0,null);var months = cljs.core.nth.call(null,vec__192594,1,null);var days = cljs.core.nth.call(null,vec__192594,2,null);var hours = cljs.core.nth.call(null,vec__192594,3,null);var minutes = cljs.core.nth.call(null,vec__192594,4,null);var seconds = cljs.core.nth.call(null,vec__192594,5,null);var ms = cljs.core.nth.call(null,vec__192594,6,null);var offset = cljs.core.nth.call(null,vec__192594,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
