...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__192596 = m;var map__192596__$1 = ((cljs.core.seq_QMARK_.call(null,map__192596))?cljs.core.apply.call(null,cljs.core.hash_map,map__192596):map__192596);var line = cljs.core.get.call(null,map__192596__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__192596__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__192598 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__192598))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__192598))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_192599;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_192600 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_192600;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_192601 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___192602 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___192602))
{var message_192603 = temp__4094__auto___192602;cljs.core.println.call(null,message_192603);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_192601;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_192604 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___192605 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___192605))
{var message_192606 = temp__4094__auto___192605;cljs.core.println.call(null,message_192606);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_192604;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_192607 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_192607;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_192608 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_192608;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__192609){
var ns_sym = cljs.core.first(arglist__192609);
arglist__192609 = cljs.core.next(arglist__192609);
var fixture_type = cljs.core.first(arglist__192609);
var fixture_fns = cljs.core.rest(arglist__192609);
...
try{t.call(null);
}catch (e192613){if((e192613 instanceof Error))
{var e_192614 = e192613;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_192614], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e192613;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_192612;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__192619 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__192620 = null;var count__192621 = 0;var i__192622 = 0;while(true){
if((i__192622 < count__192621))
{var v = cljs.core._nth.call(null,chunk__192620,i__192622);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__192619,chunk__192620,count__192621,i__192622,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__192619,chunk__192620,count__192621,i__192622,v))
);
} else
{}
{
var G__192623 = seq__192619;
var G__192624 = chunk__192620;
var G__192625 = count__192621;
var G__192626 = (i__192622 + 1);
seq__192619 = G__192623;
chunk__192620 = G__192624;
count__192621 = G__192625;
i__192622 = G__192626;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__192619);if(temp__4094__auto__)
{var seq__192619__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__192619__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__192619__$1);{
var G__192627 = cljs.core.chunk_rest.call(null,seq__192619__$1);
var G__192628 = c__5421__auto__;
var G__192629 = cljs.core.count.call(null,c__5421__auto__);
var G__192630 = 0;
seq__192619 = G__192627;
chunk__192620 = G__192628;
count__192621 = G__192629;
i__192622 = G__192630;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__192619__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__192619,chunk__192620,count__192621,i__192622,v,seq__192619__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__192619,chunk__192620,count__192621,i__192622,v,seq__192619__$1,temp__4094__auto__))
);
} else
{}
{
var G__192631 = cljs.core.next.call(null,seq__192619__$1);
var G__192632 = null;
var G__192633 = 0;
var G__192634 = 0;
seq__192619 = G__192631;
chunk__192620 = G__192632;
count__192621 = G__192633;
i__192622 = G__192634;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_192636 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___192637 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___192637))
{var test_hook_192638 = temp__4092__auto___192637;test_hook_192638.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_192636;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__192639){
var namespaces = cljs.core.seq(arglist__192639);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__192640_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__192640_SHARP_));
