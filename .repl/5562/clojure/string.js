...
{{
var G__22025 = cljs.core.pop.call(null,v__$1);
v__$1 = G__22025;
continue;
}
} else
...
{var pred__22029 = cljs.core._EQ_;var expr__22030 = limit;if(pred__22029.call(null,1,expr__22030))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__22029.call(null,2,expr__22030))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__22032 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__22033 = (limit__$1 - 1);
var G__22034 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__22032;
limit__$1 = G__22033;
parts = G__22034;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___22036 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___22036))
{var replacement_22037 = temp__4092__auto___22036;buffer.append([cljs.core.str(replacement_22037)].join(''));
} else
{buffer.append(ch);
}
{
var G__22038 = (index + 1);
index = G__22038;
continue;
}
}
