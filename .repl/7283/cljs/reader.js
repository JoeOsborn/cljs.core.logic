...
reader_error.cljs$lang$applyTo = (function (arglist__344200){
var rdr = cljs.core.first(arglist__344200);
var msg = cljs.core.rest(arglist__344200);
...
{{
var G__344201 = (function (){sb.append(ch);
return sb;
})();
var G__344202 = cljs.reader.read_char.call(null,rdr);
sb = G__344201;
ch = G__344202;
continue;
}
...
{{
var G__344203 = cljs.reader.read_char.call(null,rdr);
ch = G__344203;
continue;
}
} else
...
var G__344204 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__344204;
continue;
}
} else
...
var G__344205 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__344205;
continue;
}
}
...
{{
var G__344206 = (function (){buffer.append(ch);
return buffer;
})();
var G__344207 = cljs.reader.read_char.call(null,reader);
buffer = G__344206;
ch = G__344207;
continue;
}
...
{if(("\\" === ch))
{{
var G__344208 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__344209 = cljs.reader.read_char.call(null,reader);
buffer = G__344208;
ch = G__344209;
continue;
}
...
{{
var G__344210 = (function (){buffer.append(ch);
return buffer;
})();
var G__344211 = cljs.reader.read_char.call(null,reader);
buffer = G__344210;
ch = G__344211;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__344213 = o;if(G__344213)
{var bit__5323__auto__ = (G__344213.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__344213.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__344213.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__344213);
} else
{return false;
}
}
...
{{
var G__344214 = reader;
var G__344215 = eof_is_error;
var G__344216 = sentinel;
var G__344217 = is_recursive;
reader = G__344214;
eof_is_error = G__344215;
sentinel = G__344216;
is_recursive = G__344217;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__344218 = cljs.reader.read_comment.call(null,reader,ch);
var G__344219 = eof_is_error;
var G__344220 = sentinel;
var G__344221 = is_recursive;
reader = G__344218;
eof_is_error = G__344219;
sentinel = G__344220;
is_recursive = G__344221;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__344222 = reader;
var G__344223 = eof_is_error;
var G__344224 = sentinel;
var G__344225 = is_recursive;
reader = G__344222;
eof_is_error = G__344223;
sentinel = G__344224;
is_recursive = G__344225;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__344228 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__344228,0,null);var years = cljs.core.nth.call(null,vec__344228,1,null);var months = cljs.core.nth.call(null,vec__344228,2,null);var days = cljs.core.nth.call(null,vec__344228,3,null);var hours = cljs.core.nth.call(null,vec__344228,4,null);var minutes = cljs.core.nth.call(null,vec__344228,5,null);var seconds = cljs.core.nth.call(null,vec__344228,6,null);var fraction = cljs.core.nth.call(null,vec__344228,7,null);var offset_sign = cljs.core.nth.call(null,vec__344228,8,null);var offset_hours = cljs.core.nth.call(null,vec__344228,9,null);var offset_minutes = cljs.core.nth.call(null,vec__344228,10,null);var v = vec__344228;if(cljs.core.not.call(null,v))
...
{var vec__344230 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__344230,0,null);var months = cljs.core.nth.call(null,vec__344230,1,null);var days = cljs.core.nth.call(null,vec__344230,2,null);var hours = cljs.core.nth.call(null,vec__344230,3,null);var minutes = cljs.core.nth.call(null,vec__344230,4,null);var seconds = cljs.core.nth.call(null,vec__344230,5,null);var ms = cljs.core.nth.call(null,vec__344230,6,null);var offset = cljs.core.nth.call(null,vec__344230,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
