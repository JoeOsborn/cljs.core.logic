...
{{
var G__343904 = cljs.core.pop.call(null,v__$1);
v__$1 = G__343904;
continue;
}
} else
...
{var pred__343908 = cljs.core._EQ_;var expr__343909 = limit;if(pred__343908.call(null,1,expr__343909))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__343908.call(null,2,expr__343909))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__343911 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__343912 = (limit__$1 - 1);
var G__343913 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__343911;
limit__$1 = G__343912;
parts = G__343913;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___343915 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___343915))
{var replacement_343916 = temp__4092__auto___343915;buffer.append([cljs.core.str(replacement_343916)].join(''));
} else
{buffer.append(ch);
}
{
var G__343917 = (index + 1);
index = G__343917;
continue;
}
}
