...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__233242 = m;var map__233242__$1 = ((cljs.core.seq_QMARK_.call(null,map__233242))?cljs.core.apply.call(null,cljs.core.hash_map,map__233242):map__233242);var line = cljs.core.get.call(null,map__233242__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__233242__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__233244 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__233244))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__233244))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_233245;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_233246 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_233246;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_233247 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___233248 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___233248))
{var message_233249 = temp__4098__auto___233248;cljs.core.println.call(null,message_233249);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_233247;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_233250 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___233251 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___233251))
{var message_233252 = temp__4098__auto___233251;cljs.core.println.call(null,message_233252);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_233253;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_233254 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_233254;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__233255){
var ns_sym = cljs.core.first(arglist__233255);
arglist__233255 = cljs.core.next(arglist__233255);
var fixture_type = cljs.core.first(arglist__233255);
var fixture_fns = cljs.core.rest(arglist__233255);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_233258 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__10556__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e233259){if((e233259 instanceof Error))
{var e_233260 = e233259;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_233260], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e233259;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_233258;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__233265 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__233266 = null;var count__233267 = 0;var i__233268 = 0;while(true){
if((i__233268 < count__233267))
{var v = cljs.core._nth.call(null,chunk__233266,i__233268);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__233265,chunk__233266,count__233267,i__233268,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__233265,chunk__233266,count__233267,i__233268,v))
);
} else
{}
{
var G__233269 = seq__233265;
var G__233270 = chunk__233266;
var G__233271 = count__233267;
var G__233272 = (i__233268 + 1);
seq__233265 = G__233269;
chunk__233266 = G__233270;
count__233267 = G__233271;
i__233268 = G__233272;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__233265);if(temp__4098__auto__)
{var seq__233265__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__233265__$1))
{var c__11280__auto__ = cljs.core.chunk_first.call(null,seq__233265__$1);{
var G__233273 = cljs.core.chunk_rest.call(null,seq__233265__$1);
var G__233274 = c__11280__auto__;
var G__233275 = cljs.core.count.call(null,c__11280__auto__);
var G__233276 = 0;
seq__233265 = G__233273;
chunk__233266 = G__233274;
count__233267 = G__233275;
i__233268 = G__233276;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__233265__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__233265,chunk__233266,count__233267,i__233268,v,seq__233265__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__233265,chunk__233266,count__233267,i__233268,v,seq__233265__$1,temp__4098__auto__))
);
} else
{}
{
var G__233277 = cljs.core.next.call(null,seq__233265__$1);
var G__233278 = null;
var G__233279 = 0;
var G__233280 = 0;
seq__233265 = G__233277;
chunk__233266 = G__233278;
count__233267 = G__233279;
i__233268 = G__233280;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_233282 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___233283 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___233283))
{var test_hook_233284 = temp__4096__auto___233283;test_hook_233284.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_233282;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__233285){
var namespaces = cljs.core.seq(arglist__233285);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__233286_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__233286_SHARP_));
