...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj232799 = {};return obj232799;
})();
clojure.browser.event.event_types = (function event_types(this$){if(cljs.core.truth_((function (){var and__10544__auto__ = this$;if(cljs.core.truth_(and__10544__auto__))
...
{var x__11159__auto__ = (((this$ == null))?null:this$);return (function (){var or__10556__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__11159__auto__)]);if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{var or__10556__auto____$1 = (clojure.browser.event.event_types["_"]);if(cljs.core.truth_(or__10556__auto____$1))
...
Element.prototype.clojure$browser$event$EventType$event_types$arity$1 = (function (this$){var this$__$1 = this;return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__232802){var vec__232803 = p__232802;var k = cljs.core.nth.call(null,vec__232803,0,null);var v = cljs.core.nth.call(null,vec__232803,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
}),cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
goog.events.EventTarget.prototype.clojure$browser$event$EventType$ = true;
goog.events.EventTarget.prototype.clojure$browser$event$EventType$event_types$arity$1 = (function (this$){var this$__$1 = this;return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__232804){var vec__232805 = p__232804;var k = cljs.core.nth.call(null,vec__232805,0,null);var v = cljs.core.nth.call(null,vec__232805,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
}),cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
