...
{{
var G__233227 = cljs.core.pop.call(null,v__$1);
v__$1 = G__233227;
continue;
}
} else
...
{var pred__233231 = cljs.core._EQ_;var expr__233232 = limit;if(cljs.core.truth_(pred__233231.call(null,1,expr__233232)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__233231.call(null,2,expr__233232)))
...
var G__233234 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__233235 = (limit__$1 - 1);
var G__233236 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__233234;
limit__$1 = G__233235;
parts = G__233236;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___233238 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___233238))
{var replacement_233239 = temp__4096__auto___233238;buffer.append([cljs.core.str(replacement_233239)].join(''));
} else
{buffer.append(ch);
}
{
var G__233240 = (index + 1);
index = G__233240;
continue;
}
}
