...
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__4737__auto__ = this$;if(and__4737__auto__)
...
{var x__5342__auto__ = (((this$ == null))?null:this$);return (function (){var or__4746__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5342__auto__)]);if(or__4746__auto__)
{return or__4746__auto__;
} else
{var or__4746__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__4746__auto____$1)
...
Element.prototype.clojure$browser$event$EventType$event_types$arity$1 = (function (this$){var this$__$1 = this;return cljs.core.into.call(null,cljs.core.with_meta(cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),36,new cljs.core.Keyword(null,"end-column","end-column",3799845882),12], true)),cljs.core.map.call(null,(function (p__10923){var vec__10924 = p__10923;var k = cljs.core.nth.call(null,vec__10924,0,null);var v = cljs.core.nth.call(null,vec__10924,1,null);return cljs.core.with_meta(cljs.core.PersistentVector.fromArray([cljs.core.keyword.call(null,k.toLowerCase()),v], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),40,new cljs.core.Keyword(null,"end-column","end-column",3799845882),17], true));
}),cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
goog.events.EventTarget.prototype.clojure$browser$event$EventType$ = true;
goog.events.EventTarget.prototype.clojure$browser$event$EventType$event_types$arity$1 = (function (this$){var this$__$1 = this;return cljs.core.into.call(null,cljs.core.with_meta(cljs.core.PersistentArrayMap.EMPTY,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),25,new cljs.core.Keyword(null,"end-column","end-column",3799845882),12], true)),cljs.core.map.call(null,(function (p__10925){var vec__10926 = p__10925;var k = cljs.core.nth.call(null,vec__10926,0,null);var v = cljs.core.nth.call(null,vec__10926,1,null);return cljs.core.with_meta(cljs.core.PersistentVector.fromArray([cljs.core.keyword.call(null,k.toLowerCase()),v], true),cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"end-line","end-line",2693041432),29,new cljs.core.Keyword(null,"end-column","end-column",3799845882),17], true));
}),cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
