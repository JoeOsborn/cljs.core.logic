...
{{
var G__15361 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15361;
continue;
}
} else
...
{var pred__15365 = cljs.core._EQ_;var expr__15366 = limit;if(cljs.core.truth_(pred__15365.call(null,1,expr__15366)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15365.call(null,2,expr__15366)))
...
var G__15368 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15369 = (limit__$1 - 1);
var G__15370 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15368;
limit__$1 = G__15369;
parts = G__15370;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___15372 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___15372))
{var replacement_15373 = temp__4096__auto___15372;buffer.append([cljs.core.str(replacement_15373)].join(''));
} else
{buffer.append(ch);
}
{
var G__15374 = (index + 1);
index = G__15374;
continue;
}
}
