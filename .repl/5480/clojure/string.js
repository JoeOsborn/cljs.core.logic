...
{{
var G__364326 = cljs.core.pop.call(null,v__$1);
v__$1 = G__364326;
continue;
}
} else
...
{var pred__364330 = cljs.core._EQ_;var expr__364331 = limit;if(pred__364330.call(null,1,expr__364331))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__364330.call(null,2,expr__364331))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__364333 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__364334 = (limit__$1 - 1);
var G__364335 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__364333;
limit__$1 = G__364334;
parts = G__364335;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___364337 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___364337))
{var replacement_364338 = temp__4092__auto___364337;buffer.append([cljs.core.str(replacement_364338)].join(''));
} else
{buffer.append(ch);
}
{
var G__364339 = (index + 1);
index = G__364339;
continue;
}
}
