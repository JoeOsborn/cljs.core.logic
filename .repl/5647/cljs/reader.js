...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj11349 = {};return obj11349;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__11350){
var rdr = cljs.core.first(arglist__11350);
var msg = cljs.core.rest(arglist__11350);
...
{{
var G__11351 = (function (){sb.append(ch);
return sb;
})();
var G__11352 = cljs.reader.read_char.call(null,rdr);
sb = G__11351;
ch = G__11352;
continue;
}
...
{{
var G__11353 = cljs.reader.read_char.call(null,rdr);
ch = G__11353;
continue;
}
} else
...
var G__11354 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__11354;
continue;
}
} else
...
var G__11355 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__11355;
continue;
}
}
...
{{
var G__11356 = (function (){buffer.append(ch);
return buffer;
})();
var G__11357 = cljs.reader.read_char.call(null,reader);
buffer = G__11356;
ch = G__11357;
continue;
}
...
{if(("\\" === ch))
{{
var G__11358 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__11360 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__11363 = o;if(G__11363)
{var bit__7471__auto__ = (G__11363.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__7471__auto__) || (G__11363.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__11363.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__11363);
} else
{return false;
}
}
...
{{
var G__11364 = reader;
var G__11365 = eof_is_error;
var G__11366 = sentinel;
var G__11367 = is_recursive;
reader = G__11364;
eof_is_error = G__11365;
sentinel = G__11366;
is_recursive = G__11367;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__11368 = cljs.reader.read_comment.call(null,reader,ch);
var G__11369 = eof_is_error;
var G__11370 = sentinel;
var G__11371 = is_recursive;
reader = G__11368;
eof_is_error = G__11369;
sentinel = G__11370;
is_recursive = G__11371;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__11372 = reader;
var G__11373 = eof_is_error;
var G__11374 = sentinel;
var G__11375 = is_recursive;
reader = G__11372;
eof_is_error = G__11373;
sentinel = G__11374;
is_recursive = G__11375;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__11378 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__11378,0,null);var years = cljs.core.nth.call(null,vec__11378,1,null);var months = cljs.core.nth.call(null,vec__11378,2,null);var days = cljs.core.nth.call(null,vec__11378,3,null);var hours = cljs.core.nth.call(null,vec__11378,4,null);var minutes = cljs.core.nth.call(null,vec__11378,5,null);var seconds = cljs.core.nth.call(null,vec__11378,6,null);var fraction = cljs.core.nth.call(null,vec__11378,7,null);var offset_sign = cljs.core.nth.call(null,vec__11378,8,null);var offset_hours = cljs.core.nth.call(null,vec__11378,9,null);var offset_minutes = cljs.core.nth.call(null,vec__11378,10,null);var v = vec__11378;if(cljs.core.not.call(null,v))
...
{var vec__11380 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__11380,0,null);var months = cljs.core.nth.call(null,vec__11380,1,null);var days = cljs.core.nth.call(null,vec__11380,2,null);var hours = cljs.core.nth.call(null,vec__11380,3,null);var minutes = cljs.core.nth.call(null,vec__11380,4,null);var seconds = cljs.core.nth.call(null,vec__11380,5,null);var ms = cljs.core.nth.call(null,vec__11380,6,null);var offset = cljs.core.nth.call(null,vec__11380,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
