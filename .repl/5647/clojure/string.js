...
{{
var G__11381 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11381;
continue;
}
} else
...
{var pred__11385 = cljs.core._EQ_;var expr__11386 = limit;if(cljs.core.truth_(pred__11385.call(null,1,expr__11386)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11385.call(null,2,expr__11386)))
...
var G__11388 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11389 = (limit__$1 - 1);
var G__11390 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11388;
limit__$1 = G__11389;
parts = G__11390;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___11392 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___11392))
{var replacement_11393 = temp__4096__auto___11392;buffer.append([cljs.core.str(replacement_11393)].join(''));
} else
{buffer.append(ch);
}
{
var G__11394 = (index + 1);
index = G__11394;
continue;
}
}
