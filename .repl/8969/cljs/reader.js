...
reader_error.cljs$lang$applyTo = (function (arglist__77821){
var rdr = cljs.core.first(arglist__77821);
var msg = cljs.core.rest(arglist__77821);
...
{{
var G__77822 = (function (){sb.append(ch);
return sb;
})();
var G__77823 = cljs.reader.read_char.call(null,rdr);
sb = G__77822;
ch = G__77823;
continue;
}
...
{{
var G__77824 = cljs.reader.read_char.call(null,rdr);
ch = G__77824;
continue;
}
} else
...
var G__77825 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__77825;
continue;
}
} else
...
var G__77826 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__77826;
continue;
}
}
...
{{
var G__77827 = (function (){buffer.append(ch);
return buffer;
})();
var G__77828 = cljs.reader.read_char.call(null,reader);
buffer = G__77827;
ch = G__77828;
continue;
}
...
{if(("\\" === ch))
{{
var G__77829 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__77830 = cljs.reader.read_char.call(null,reader);
buffer = G__77829;
ch = G__77830;
continue;
}
...
{{
var G__77831 = (function (){buffer.append(ch);
return buffer;
})();
var G__77832 = cljs.reader.read_char.call(null,reader);
buffer = G__77831;
ch = G__77832;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__77834 = o;if(G__77834)
{var bit__5323__auto__ = (G__77834.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__77834.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__77834.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__77834);
} else
{return false;
}
}
...
{{
var G__77835 = reader;
var G__77836 = eof_is_error;
var G__77837 = sentinel;
var G__77838 = is_recursive;
reader = G__77835;
eof_is_error = G__77836;
sentinel = G__77837;
is_recursive = G__77838;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__77839 = cljs.reader.read_comment.call(null,reader,ch);
var G__77840 = eof_is_error;
var G__77841 = sentinel;
var G__77842 = is_recursive;
reader = G__77839;
eof_is_error = G__77840;
sentinel = G__77841;
is_recursive = G__77842;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__77843 = reader;
var G__77844 = eof_is_error;
var G__77845 = sentinel;
var G__77846 = is_recursive;
reader = G__77843;
eof_is_error = G__77844;
sentinel = G__77845;
is_recursive = G__77846;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__77849 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__77849,0,null);var years = cljs.core.nth.call(null,vec__77849,1,null);var months = cljs.core.nth.call(null,vec__77849,2,null);var days = cljs.core.nth.call(null,vec__77849,3,null);var hours = cljs.core.nth.call(null,vec__77849,4,null);var minutes = cljs.core.nth.call(null,vec__77849,5,null);var seconds = cljs.core.nth.call(null,vec__77849,6,null);var fraction = cljs.core.nth.call(null,vec__77849,7,null);var offset_sign = cljs.core.nth.call(null,vec__77849,8,null);var offset_hours = cljs.core.nth.call(null,vec__77849,9,null);var offset_minutes = cljs.core.nth.call(null,vec__77849,10,null);var v = vec__77849;if(cljs.core.not.call(null,v))
...
{var vec__77851 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__77851,0,null);var months = cljs.core.nth.call(null,vec__77851,1,null);var days = cljs.core.nth.call(null,vec__77851,2,null);var hours = cljs.core.nth.call(null,vec__77851,3,null);var minutes = cljs.core.nth.call(null,vec__77851,4,null);var seconds = cljs.core.nth.call(null,vec__77851,5,null);var ms = cljs.core.nth.call(null,vec__77851,6,null);var offset = cljs.core.nth.call(null,vec__77851,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
