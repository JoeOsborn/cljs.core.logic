...
{{
var G__77522 = cljs.core.pop.call(null,v__$1);
v__$1 = G__77522;
continue;
}
} else
...
{var pred__77526 = cljs.core._EQ_;var expr__77527 = limit;if(pred__77526.call(null,1,expr__77527))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__77526.call(null,2,expr__77527))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__77529 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__77530 = (limit__$1 - 1);
var G__77531 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__77529;
limit__$1 = G__77530;
parts = G__77531;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___77533 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___77533))
{var replacement_77534 = temp__4092__auto___77533;buffer.append([cljs.core.str(replacement_77534)].join(''));
} else
{buffer.append(ch);
}
{
var G__77535 = (index + 1);
index = G__77535;
continue;
}
}
