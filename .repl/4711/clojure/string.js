...
{{
var G__73911 = cljs.core.pop.call(null,v__$1);
v__$1 = G__73911;
continue;
}
} else
...
{var pred__73915 = cljs.core._EQ_;var expr__73916 = limit;if(pred__73915.call(null,1,expr__73916))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__73915.call(null,2,expr__73916))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__73918 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__73919 = (limit__$1 - 1);
var G__73920 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__73918;
limit__$1 = G__73919;
parts = G__73920;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___73922 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___73922))
{var replacement_73923 = temp__4092__auto___73922;buffer.append([cljs.core.str(replacement_73923)].join(''));
} else
{buffer.append(ch);
}
{
var G__73924 = (index + 1);
index = G__73924;
continue;
}
}
