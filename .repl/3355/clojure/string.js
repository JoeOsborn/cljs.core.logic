...
{{
var G__45675 = cljs.core.pop.call(null,v__$1);
v__$1 = G__45675;
continue;
}
} else
...
{var pred__45679 = cljs.core._EQ_;var expr__45680 = limit;if(cljs.core.truth_(pred__45679.call(null,1,expr__45680)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__45679.call(null,2,expr__45680)))
...
var G__45682 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__45683 = (limit__$1 - 1);
var G__45684 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__45682;
limit__$1 = G__45683;
parts = G__45684;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___45686 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___45686))
{var replacement_45687 = temp__4096__auto___45686;buffer.append([cljs.core.str(replacement_45687)].join(''));
} else
{buffer.append(ch);
}
{
var G__45688 = (index + 1);
index = G__45688;
continue;
}
}
