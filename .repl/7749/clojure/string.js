...
{{
var G__10975 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10975;
continue;
}
} else
...
{var pred__10979 = cljs.core._EQ_;var expr__10980 = limit;if(pred__10979.call(null,1,expr__10980))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10979.call(null,2,expr__10980))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10982 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10983 = (limit__$1 - 1);
var G__10984 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10982;
limit__$1 = G__10983;
parts = G__10984;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10986 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10986))
{var replacement_10987 = temp__4092__auto___10986;buffer.append([cljs.core.str(replacement_10987)].join(''));
} else
{buffer.append(ch);
}
{
var G__10988 = (index + 1);
index = G__10988;
continue;
}
}
