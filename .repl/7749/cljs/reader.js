...
reader_error.cljs$lang$applyTo = (function (arglist__10944){
var rdr = cljs.core.first(arglist__10944);
var msg = cljs.core.rest(arglist__10944);
...
{{
var G__10945 = (function (){sb.append(ch);
return sb;
})();
var G__10946 = cljs.reader.read_char.call(null,rdr);
sb = G__10945;
ch = G__10946;
continue;
}
...
{{
var G__10947 = cljs.reader.read_char.call(null,rdr);
ch = G__10947;
continue;
}
} else
...
var G__10948 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10948;
continue;
}
} else
...
var G__10949 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10949;
continue;
}
}
...
{{
var G__10950 = (function (){buffer.append(ch);
return buffer;
})();
var G__10951 = cljs.reader.read_char.call(null,reader);
buffer = G__10950;
ch = G__10951;
continue;
}
...
{if(("\\" === ch))
{{
var G__10952 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10953 = cljs.reader.read_char.call(null,reader);
buffer = G__10952;
ch = G__10953;
continue;
}
...
{{
var G__10954 = (function (){buffer.append(ch);
return buffer;
})();
var G__10955 = cljs.reader.read_char.call(null,reader);
buffer = G__10954;
ch = G__10955;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10957 = o;if(G__10957)
{var bit__5323__auto__ = (G__10957.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__10957.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10957.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10957);
} else
{return false;
}
}
...
{{
var G__10958 = reader;
var G__10959 = eof_is_error;
var G__10960 = sentinel;
var G__10961 = is_recursive;
reader = G__10958;
eof_is_error = G__10959;
sentinel = G__10960;
is_recursive = G__10961;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10962 = cljs.reader.read_comment.call(null,reader,ch);
var G__10963 = eof_is_error;
var G__10964 = sentinel;
var G__10965 = is_recursive;
reader = G__10962;
eof_is_error = G__10963;
sentinel = G__10964;
is_recursive = G__10965;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10966 = reader;
var G__10967 = eof_is_error;
var G__10968 = sentinel;
var G__10969 = is_recursive;
reader = G__10966;
eof_is_error = G__10967;
sentinel = G__10968;
is_recursive = G__10969;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10972 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10972,0,null);var years = cljs.core.nth.call(null,vec__10972,1,null);var months = cljs.core.nth.call(null,vec__10972,2,null);var days = cljs.core.nth.call(null,vec__10972,3,null);var hours = cljs.core.nth.call(null,vec__10972,4,null);var minutes = cljs.core.nth.call(null,vec__10972,5,null);var seconds = cljs.core.nth.call(null,vec__10972,6,null);var fraction = cljs.core.nth.call(null,vec__10972,7,null);var offset_sign = cljs.core.nth.call(null,vec__10972,8,null);var offset_hours = cljs.core.nth.call(null,vec__10972,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10972,10,null);var v = vec__10972;if(cljs.core.not.call(null,v))
...
{var vec__10974 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__10974,0,null);var months = cljs.core.nth.call(null,vec__10974,1,null);var days = cljs.core.nth.call(null,vec__10974,2,null);var hours = cljs.core.nth.call(null,vec__10974,3,null);var minutes = cljs.core.nth.call(null,vec__10974,4,null);var seconds = cljs.core.nth.call(null,vec__10974,5,null);var ms = cljs.core.nth.call(null,vec__10974,6,null);var offset = cljs.core.nth.call(null,vec__10974,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
