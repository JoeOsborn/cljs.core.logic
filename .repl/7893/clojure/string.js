...
{var pred__12522 = cljs.core._EQ_;var expr__12523 = limit;if(pred__12522.call(null,1,expr__12523))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__12522.call(null,2,expr__12523))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
{var ch = s.charAt(index);var temp__4092__auto___12529 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___12529))
{var replacement_12530 = temp__4092__auto___12529;buffer.append([cljs.core.str(replacement_12530)].join(''));
} else
{buffer.append(ch);
}
{
