...
{{
var G__280736 = cljs.core.pop.call(null,v__$1);
v__$1 = G__280736;
continue;
}
} else
...
{var pred__280740 = cljs.core._EQ_;var expr__280741 = limit;if(cljs.core.truth_(pred__280740.call(null,1,expr__280741)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__280740.call(null,2,expr__280741)))
...
var G__280743 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__280744 = (limit__$1 - 1);
var G__280745 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__280743;
limit__$1 = G__280744;
parts = G__280745;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___280747 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___280747))
{var replacement_280748 = temp__4096__auto___280747;buffer.append([cljs.core.str(replacement_280748)].join(''));
} else
{buffer.append(ch);
}
{
var G__280749 = (index + 1);
index = G__280749;
continue;
}
}
