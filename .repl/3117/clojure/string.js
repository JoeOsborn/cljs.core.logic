...
{{
var G__78572 = cljs.core.pop.call(null,v__$1);
v__$1 = G__78572;
continue;
}
} else
...
{var pred__78576 = cljs.core._EQ_;var expr__78577 = limit;if(cljs.core.truth_(pred__78576.call(null,1,expr__78577)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__78576.call(null,2,expr__78577)))
...
var G__78579 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__78580 = (limit__$1 - 1);
var G__78581 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__78579;
limit__$1 = G__78580;
parts = G__78581;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___78583 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___78583))
{var replacement_78584 = temp__4096__auto___78583;buffer.append([cljs.core.str(replacement_78584)].join(''));
} else
{buffer.append(ch);
}
{
var G__78585 = (index + 1);
index = G__78585;
continue;
}
}
