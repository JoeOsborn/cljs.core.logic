...
{{
var G__248181 = cljs.core.pop.call(null,v__$1);
v__$1 = G__248181;
continue;
}
} else
...
{var pred__248185 = cljs.core._EQ_;var expr__248186 = limit;if(pred__248185.call(null,1,expr__248186))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__248185.call(null,2,expr__248186))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__248188 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__248189 = (limit__$1 - 1);
var G__248190 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__248188;
limit__$1 = G__248189;
parts = G__248190;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___248192 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___248192))
{var replacement_248193 = temp__4092__auto___248192;buffer.append([cljs.core.str(replacement_248193)].join(''));
} else
{buffer.append(ch);
}
{
var G__248194 = (index + 1);
index = G__248194;
continue;
}
}
