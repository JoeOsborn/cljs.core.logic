...
reader_error.cljs$lang$applyTo = (function (arglist__248477){
var rdr = cljs.core.first(arglist__248477);
var msg = cljs.core.rest(arglist__248477);
...
{{
var G__248478 = (function (){sb.append(ch);
return sb;
})();
var G__248479 = cljs.reader.read_char.call(null,rdr);
sb = G__248478;
ch = G__248479;
continue;
}
...
{{
var G__248480 = cljs.reader.read_char.call(null,rdr);
ch = G__248480;
continue;
}
} else
...
var G__248481 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__248481;
continue;
}
} else
...
var G__248482 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__248482;
continue;
}
}
...
{{
var G__248483 = (function (){buffer.append(ch);
return buffer;
})();
var G__248484 = cljs.reader.read_char.call(null,reader);
buffer = G__248483;
ch = G__248484;
continue;
}
...
{if(("\\" === ch))
{{
var G__248485 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__248486 = cljs.reader.read_char.call(null,reader);
buffer = G__248485;
ch = G__248486;
continue;
}
...
{{
var G__248487 = (function (){buffer.append(ch);
return buffer;
})();
var G__248488 = cljs.reader.read_char.call(null,reader);
buffer = G__248487;
ch = G__248488;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__248490 = o;if(G__248490)
{var bit__5323__auto__ = (G__248490.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__248490.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__248490.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__248490);
} else
{return false;
}
}
...
{{
var G__248491 = reader;
var G__248492 = eof_is_error;
var G__248493 = sentinel;
var G__248494 = is_recursive;
reader = G__248491;
eof_is_error = G__248492;
sentinel = G__248493;
is_recursive = G__248494;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__248495 = cljs.reader.read_comment.call(null,reader,ch);
var G__248496 = eof_is_error;
var G__248497 = sentinel;
var G__248498 = is_recursive;
reader = G__248495;
eof_is_error = G__248496;
sentinel = G__248497;
is_recursive = G__248498;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__248499 = reader;
var G__248500 = eof_is_error;
var G__248501 = sentinel;
var G__248502 = is_recursive;
reader = G__248499;
eof_is_error = G__248500;
sentinel = G__248501;
is_recursive = G__248502;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__248505 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__248505,0,null);var years = cljs.core.nth.call(null,vec__248505,1,null);var months = cljs.core.nth.call(null,vec__248505,2,null);var days = cljs.core.nth.call(null,vec__248505,3,null);var hours = cljs.core.nth.call(null,vec__248505,4,null);var minutes = cljs.core.nth.call(null,vec__248505,5,null);var seconds = cljs.core.nth.call(null,vec__248505,6,null);var fraction = cljs.core.nth.call(null,vec__248505,7,null);var offset_sign = cljs.core.nth.call(null,vec__248505,8,null);var offset_hours = cljs.core.nth.call(null,vec__248505,9,null);var offset_minutes = cljs.core.nth.call(null,vec__248505,10,null);var v = vec__248505;if(cljs.core.not.call(null,v))
...
{var vec__248507 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__248507,0,null);var months = cljs.core.nth.call(null,vec__248507,1,null);var days = cljs.core.nth.call(null,vec__248507,2,null);var hours = cljs.core.nth.call(null,vec__248507,3,null);var minutes = cljs.core.nth.call(null,vec__248507,4,null);var seconds = cljs.core.nth.call(null,vec__248507,5,null);var ms = cljs.core.nth.call(null,vec__248507,6,null);var offset = cljs.core.nth.call(null,vec__248507,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
