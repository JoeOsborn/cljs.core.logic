...
{var pred__28560 = cljs.core._EQ_;var expr__28561 = limit;if(pred__28560.call(null,1,expr__28561))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__28560.call(null,2,expr__28561))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__28563 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28564 = (limit__$1 - 1);
var G__28565 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28563;
limit__$1 = G__28564;
parts = G__28565;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___28567 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___28567))
{var replacement_28568 = temp__4092__auto___28567;buffer.append([cljs.core.str(replacement_28568)].join(''));
} else
{buffer.append(ch);
}
{
var G__28569 = (index + 1);
index = G__28569;
continue;
}
}
