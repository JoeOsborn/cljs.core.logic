...
{{
var G__12187 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12187;
continue;
}
} else
...
{var pred__12191 = cljs.core._EQ_;var expr__12192 = limit;if(cljs.core.truth_(pred__12191.call(null,1,expr__12192)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12191.call(null,2,expr__12192)))
...
var G__12194 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12195 = (limit__$1 - 1);
var G__12196 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12194;
limit__$1 = G__12195;
parts = G__12196;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___12198 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___12198))
{var replacement_12199 = temp__4096__auto___12198;buffer.append([cljs.core.str(replacement_12199)].join(''));
} else
{buffer.append(ch);
}
{
var G__12200 = (index + 1);
index = G__12200;
continue;
}
}
