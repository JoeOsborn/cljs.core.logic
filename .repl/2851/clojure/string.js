...
{{
var G__84867 = cljs.core.pop.call(null,v__$1);
v__$1 = G__84867;
continue;
}
} else
...
{var pred__84871 = cljs.core._EQ_;var expr__84872 = limit;if(pred__84871.call(null,1,expr__84872))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__84871.call(null,2,expr__84872))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__84874 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__84875 = (limit__$1 - 1);
var G__84876 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__84874;
limit__$1 = G__84875;
parts = G__84876;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___84878 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___84878))
{var replacement_84879 = temp__4092__auto___84878;buffer.append([cljs.core.str(replacement_84879)].join(''));
} else
{buffer.append(ch);
}
{
var G__84880 = (index + 1);
index = G__84880;
continue;
}
}
