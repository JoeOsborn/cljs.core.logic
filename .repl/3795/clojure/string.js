...
{{
var G__264858 = cljs.core.pop.call(null,v__$1);
v__$1 = G__264858;
continue;
}
} else
...
{var pred__264862 = cljs.core._EQ_;var expr__264863 = limit;if(pred__264862.call(null,1,expr__264863))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__264862.call(null,2,expr__264863))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__264865 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__264866 = (limit__$1 - 1);
var G__264867 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__264865;
limit__$1 = G__264866;
parts = G__264867;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___264869 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___264869))
{var replacement_264870 = temp__4092__auto___264869;buffer.append([cljs.core.str(replacement_264870)].join(''));
} else
{buffer.append(ch);
}
{
var G__264871 = (index + 1);
index = G__264871;
continue;
}
}
