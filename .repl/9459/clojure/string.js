...
{{
var G__38011 = cljs.core.pop.call(null,v__$1);
v__$1 = G__38011;
continue;
}
} else
...
{var pred__38015 = cljs.core._EQ_;var expr__38016 = limit;if(pred__38015.call(null,1,expr__38016))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__38015.call(null,2,expr__38016))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__38018 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__38019 = (limit__$1 - 1);
var G__38020 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__38018;
limit__$1 = G__38019;
parts = G__38020;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___38022 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___38022))
{var replacement_38023 = temp__4092__auto___38022;buffer.append([cljs.core.str(replacement_38023)].join(''));
} else
{buffer.append(ch);
}
{
