...
{{
var G__13094 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13094;
continue;
}
} else
...
{var pred__13098 = cljs.core._EQ_;var expr__13099 = limit;if(pred__13098.call(null,1,expr__13099))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__13098.call(null,2,expr__13099))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__13101 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13102 = (limit__$1 - 1);
var G__13103 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13101;
limit__$1 = G__13102;
parts = G__13103;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___13105 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___13105))
{var replacement_13106 = temp__4092__auto___13105;buffer.append([cljs.core.str(replacement_13106)].join(''));
} else
{buffer.append(ch);
}
{
var G__13107 = (index + 1);
index = G__13107;
continue;
}
}
