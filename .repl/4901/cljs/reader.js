...
reader_error.cljs$lang$applyTo = (function (arglist__13063){
var rdr = cljs.core.first(arglist__13063);
var msg = cljs.core.rest(arglist__13063);
...
{{
var G__13064 = (function (){sb.append(ch);
return sb;
})();
var G__13065 = cljs.reader.read_char.call(null,rdr);
sb = G__13064;
ch = G__13065;
continue;
}
...
{{
var G__13066 = cljs.reader.read_char.call(null,rdr);
ch = G__13066;
continue;
}
} else
...
var G__13067 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__13067;
continue;
}
} else
...
var G__13068 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__13068;
continue;
}
}
...
{{
var G__13069 = (function (){buffer.append(ch);
return buffer;
})();
var G__13070 = cljs.reader.read_char.call(null,reader);
buffer = G__13069;
ch = G__13070;
continue;
}
...
{if(("\\" === ch))
{{
var G__13071 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__13072 = cljs.reader.read_char.call(null,reader);
buffer = G__13071;
ch = G__13072;
continue;
}
...
{{
var G__13073 = (function (){buffer.append(ch);
return buffer;
})();
var G__13074 = cljs.reader.read_char.call(null,reader);
buffer = G__13073;
ch = G__13074;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__13076 = o;if(G__13076)
{var bit__5323__auto__ = (G__13076.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__13076.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__13076.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__13076);
} else
{return false;
}
}
...
{{
var G__13077 = reader;
var G__13078 = eof_is_error;
var G__13079 = sentinel;
var G__13080 = is_recursive;
reader = G__13077;
eof_is_error = G__13078;
sentinel = G__13079;
is_recursive = G__13080;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__13081 = cljs.reader.read_comment.call(null,reader,ch);
var G__13082 = eof_is_error;
var G__13083 = sentinel;
var G__13084 = is_recursive;
reader = G__13081;
eof_is_error = G__13082;
sentinel = G__13083;
is_recursive = G__13084;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__13085 = reader;
var G__13086 = eof_is_error;
var G__13087 = sentinel;
var G__13088 = is_recursive;
reader = G__13085;
eof_is_error = G__13086;
sentinel = G__13087;
is_recursive = G__13088;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__13091 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__13091,0,null);var years = cljs.core.nth.call(null,vec__13091,1,null);var months = cljs.core.nth.call(null,vec__13091,2,null);var days = cljs.core.nth.call(null,vec__13091,3,null);var hours = cljs.core.nth.call(null,vec__13091,4,null);var minutes = cljs.core.nth.call(null,vec__13091,5,null);var seconds = cljs.core.nth.call(null,vec__13091,6,null);var fraction = cljs.core.nth.call(null,vec__13091,7,null);var offset_sign = cljs.core.nth.call(null,vec__13091,8,null);var offset_hours = cljs.core.nth.call(null,vec__13091,9,null);var offset_minutes = cljs.core.nth.call(null,vec__13091,10,null);var v = vec__13091;if(cljs.core.not.call(null,v))
...
{var vec__13093 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__13093,0,null);var months = cljs.core.nth.call(null,vec__13093,1,null);var days = cljs.core.nth.call(null,vec__13093,2,null);var hours = cljs.core.nth.call(null,vec__13093,3,null);var minutes = cljs.core.nth.call(null,vec__13093,4,null);var seconds = cljs.core.nth.call(null,vec__13093,5,null);var ms = cljs.core.nth.call(null,vec__13093,6,null);var offset = cljs.core.nth.call(null,vec__13093,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
