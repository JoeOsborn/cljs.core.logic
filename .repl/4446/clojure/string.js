...
{{
var G__40661 = cljs.core.pop.call(null,v__$1);
v__$1 = G__40661;
continue;
}
} else
...
{var pred__40665 = cljs.core._EQ_;var expr__40666 = limit;if(cljs.core.truth_(pred__40665.call(null,1,expr__40666)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__40665.call(null,2,expr__40666)))
...
var G__40668 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__40669 = (limit__$1 - 1);
var G__40670 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__40668;
limit__$1 = G__40669;
parts = G__40670;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___40672 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___40672))
{var replacement_40673 = temp__4096__auto___40672;buffer.append([cljs.core.str(replacement_40673)].join(''));
} else
{buffer.append(ch);
}
{
var G__40674 = (index + 1);
index = G__40674;
continue;
}
}
