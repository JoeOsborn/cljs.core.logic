...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj41255 = {};return obj41255;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__41256){
var rdr = cljs.core.first(arglist__41256);
var msg = cljs.core.rest(arglist__41256);
...
{{
var G__41257 = (function (){sb.append(ch);
return sb;
})();
var G__41258 = cljs.reader.read_char.call(null,rdr);
sb = G__41257;
ch = G__41258;
continue;
}
...
{{
var G__41259 = cljs.reader.read_char.call(null,rdr);
ch = G__41259;
continue;
}
} else
...
var G__41260 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__41260;
continue;
}
} else
...
var G__41261 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__41261;
continue;
}
}
...
{{
var G__41262 = (function (){buffer.append(ch);
return buffer;
})();
var G__41263 = cljs.reader.read_char.call(null,reader);
buffer = G__41262;
ch = G__41263;
continue;
}
...
{if(("\\" === ch))
{{
var G__41264 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__41265 = cljs.reader.read_char.call(null,reader);
buffer = G__41264;
ch = G__41265;
continue;
}
...
{{
var G__41266 = (function (){buffer.append(ch);
return buffer;
})();
var G__41267 = cljs.reader.read_char.call(null,reader);
buffer = G__41266;
ch = G__41267;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__41269 = o;if(G__41269)
{var bit__7442__auto__ = (G__41269.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__7442__auto__) || (G__41269.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__41269.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__41269);
} else
{return false;
}
}
...
{{
var G__41270 = reader;
var G__41271 = eof_is_error;
var G__41272 = sentinel;
var G__41273 = is_recursive;
reader = G__41270;
eof_is_error = G__41271;
sentinel = G__41272;
is_recursive = G__41273;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__41274 = cljs.reader.read_comment.call(null,reader,ch);
var G__41275 = eof_is_error;
var G__41276 = sentinel;
var G__41277 = is_recursive;
reader = G__41274;
eof_is_error = G__41275;
sentinel = G__41276;
is_recursive = G__41277;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__41278 = reader;
var G__41279 = eof_is_error;
var G__41280 = sentinel;
var G__41281 = is_recursive;
reader = G__41278;
eof_is_error = G__41279;
sentinel = G__41280;
is_recursive = G__41281;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__41284 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__41284,0,null);var years = cljs.core.nth.call(null,vec__41284,1,null);var months = cljs.core.nth.call(null,vec__41284,2,null);var days = cljs.core.nth.call(null,vec__41284,3,null);var hours = cljs.core.nth.call(null,vec__41284,4,null);var minutes = cljs.core.nth.call(null,vec__41284,5,null);var seconds = cljs.core.nth.call(null,vec__41284,6,null);var fraction = cljs.core.nth.call(null,vec__41284,7,null);var offset_sign = cljs.core.nth.call(null,vec__41284,8,null);var offset_hours = cljs.core.nth.call(null,vec__41284,9,null);var offset_minutes = cljs.core.nth.call(null,vec__41284,10,null);var v = vec__41284;if(cljs.core.not.call(null,v))
...
{var vec__41286 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__41286,0,null);var months = cljs.core.nth.call(null,vec__41286,1,null);var days = cljs.core.nth.call(null,vec__41286,2,null);var hours = cljs.core.nth.call(null,vec__41286,3,null);var minutes = cljs.core.nth.call(null,vec__41286,4,null);var seconds = cljs.core.nth.call(null,vec__41286,5,null);var ms = cljs.core.nth.call(null,vec__41286,6,null);var offset = cljs.core.nth.call(null,vec__41286,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
