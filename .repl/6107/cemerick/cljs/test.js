...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__283818 = m;var map__283818__$1 = ((cljs.core.seq_QMARK_.call(null,map__283818))?cljs.core.apply.call(null,cljs.core.hash_map,map__283818):map__283818);var line = cljs.core.get.call(null,map__283818__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__283818__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__283820 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__283820))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__283820))
...
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"default","default",2558708147),(function (m){var _STAR_print_fn_STAR_283821 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283821;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_283822 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283822;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_283823 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___283824 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___283824))
{var message_283825 = temp__4098__auto___283824;cljs.core.println.call(null,message_283825);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283823;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_283826 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___283827 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___283827))
{var message_283828 = temp__4098__auto___283827;cljs.core.println.call(null,message_283828);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283829;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_283830 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_283830;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__283831){
var ns_sym = cljs.core.first(arglist__283831);
arglist__283831 = cljs.core.next(arglist__283831);
var fixture_type = cljs.core.first(arglist__283831);
var fixture_fns = cljs.core.rest(arglist__283831);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_283834 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__6845__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return v;
}
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_283834;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__283841 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__283842 = null;var count__283843 = 0;var i__283844 = 0;while(true){
if((i__283844 < count__283843))
{var v = cljs.core._nth.call(null,chunk__283842,i__283844);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__283841,chunk__283842,count__283843,i__283844,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__283841,chunk__283842,count__283843,i__283844,v))
);
} else
{}
{
var G__283845 = seq__283841;
var G__283846 = chunk__283842;
var G__283847 = count__283843;
var G__283848 = (i__283844 + 1);
seq__283841 = G__283845;
chunk__283842 = G__283846;
count__283843 = G__283847;
i__283844 = G__283848;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__283841);if(temp__4098__auto__)
{var seq__283841__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__283841__$1))
{var c__7569__auto__ = cljs.core.chunk_first.call(null,seq__283841__$1);{
var G__283849 = cljs.core.chunk_rest.call(null,seq__283841__$1);
var G__283850 = c__7569__auto__;
var G__283851 = cljs.core.count.call(null,c__7569__auto__);
var G__283852 = 0;
seq__283841 = G__283849;
chunk__283842 = G__283850;
count__283843 = G__283851;
i__283844 = G__283852;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__283841__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__283841,chunk__283842,count__283843,i__283844,v,seq__283841__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__283841,chunk__283842,count__283843,i__283844,v,seq__283841__$1,temp__4098__auto__))
);
} else
{}
{
var G__283853 = cljs.core.next.call(null,seq__283841__$1);
var G__283854 = null;
var G__283855 = 0;
var G__283856 = 0;
seq__283841 = G__283853;
chunk__283842 = G__283854;
count__283843 = G__283855;
i__283844 = G__283856;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_283858 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___283859 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___283859))
{var test_hook_283860 = temp__4096__auto___283859;test_hook_283860.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_283858;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__283861){
var namespaces = cljs.core.seq(arglist__283861);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__283862_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__283862_SHARP_));
