...
{{
var G__44852 = cljs.core.pop.call(null,v__$1);
v__$1 = G__44852;
continue;
}
} else
...
{var pred__44856 = cljs.core._EQ_;var expr__44857 = limit;if(pred__44856.call(null,1,expr__44857))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__44856.call(null,2,expr__44857))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__44859 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__44860 = (limit__$1 - 1);
var G__44861 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__44859;
limit__$1 = G__44860;
parts = G__44861;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___44863 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___44863))
{var replacement_44864 = temp__4092__auto___44863;buffer.append([cljs.core.str(replacement_44864)].join(''));
} else
{buffer.append(ch);
}
{
var G__44865 = (index + 1);
index = G__44865;
continue;
}
}
