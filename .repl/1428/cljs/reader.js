...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj98098 = {};return obj98098;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__98099){
var rdr = cljs.core.first(arglist__98099);
var msg = cljs.core.rest(arglist__98099);
...
{{
var G__98100 = (function (){sb.append(ch);
return sb;
})();
var G__98101 = cljs.reader.read_char.call(null,rdr);
sb = G__98100;
ch = G__98101;
continue;
}
...
{{
var G__98102 = cljs.reader.read_char.call(null,rdr);
ch = G__98102;
continue;
}
} else
...
var G__98103 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__98103;
continue;
}
} else
...
var G__98104 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__98104;
continue;
}
}
...
{{
var G__98105 = (function (){buffer.append(ch);
return buffer;
})();
var G__98106 = cljs.reader.read_char.call(null,reader);
buffer = G__98105;
ch = G__98106;
continue;
}
...
{if(("\\" === ch))
{{
var G__98107 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__98108 = cljs.reader.read_char.call(null,reader);
buffer = G__98107;
ch = G__98108;
continue;
}
...
{{
var G__98109 = (function (){buffer.append(ch);
return buffer;
})();
var G__98110 = cljs.reader.read_char.call(null,reader);
buffer = G__98109;
ch = G__98110;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__98112 = o;if(G__98112)
{var bit__7471__auto__ = (G__98112.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__7471__auto__) || (G__98112.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__98112.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__98112);
} else
{return false;
}
}
...
{{
var G__98113 = reader;
var G__98114 = eof_is_error;
var G__98115 = sentinel;
var G__98116 = is_recursive;
reader = G__98113;
eof_is_error = G__98114;
sentinel = G__98115;
is_recursive = G__98116;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__98117 = cljs.reader.read_comment.call(null,reader,ch);
var G__98118 = eof_is_error;
var G__98119 = sentinel;
var G__98120 = is_recursive;
reader = G__98117;
eof_is_error = G__98118;
sentinel = G__98119;
is_recursive = G__98120;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__98121 = reader;
var G__98122 = eof_is_error;
var G__98123 = sentinel;
var G__98124 = is_recursive;
reader = G__98121;
eof_is_error = G__98122;
sentinel = G__98123;
is_recursive = G__98124;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__98127 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__98127,0,null);var years = cljs.core.nth.call(null,vec__98127,1,null);var months = cljs.core.nth.call(null,vec__98127,2,null);var days = cljs.core.nth.call(null,vec__98127,3,null);var hours = cljs.core.nth.call(null,vec__98127,4,null);var minutes = cljs.core.nth.call(null,vec__98127,5,null);var seconds = cljs.core.nth.call(null,vec__98127,6,null);var fraction = cljs.core.nth.call(null,vec__98127,7,null);var offset_sign = cljs.core.nth.call(null,vec__98127,8,null);var offset_hours = cljs.core.nth.call(null,vec__98127,9,null);var offset_minutes = cljs.core.nth.call(null,vec__98127,10,null);var v = vec__98127;if(cljs.core.not.call(null,v))
...
{var vec__98129 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__98129,0,null);var months = cljs.core.nth.call(null,vec__98129,1,null);var days = cljs.core.nth.call(null,vec__98129,2,null);var hours = cljs.core.nth.call(null,vec__98129,3,null);var minutes = cljs.core.nth.call(null,vec__98129,4,null);var seconds = cljs.core.nth.call(null,vec__98129,5,null);var ms = cljs.core.nth.call(null,vec__98129,6,null);var offset = cljs.core.nth.call(null,vec__98129,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
