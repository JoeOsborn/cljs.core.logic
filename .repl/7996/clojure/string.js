...
{{
var G__200463 = cljs.core.pop.call(null,v__$1);
v__$1 = G__200463;
continue;
}
} else
...
{var pred__200467 = cljs.core._EQ_;var expr__200468 = limit;if(pred__200467.call(null,1,expr__200468))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__200467.call(null,2,expr__200468))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__200470 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__200471 = (limit__$1 - 1);
var G__200472 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__200470;
limit__$1 = G__200471;
parts = G__200472;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___200474 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___200474))
{var replacement_200475 = temp__4092__auto___200474;buffer.append([cljs.core.str(replacement_200475)].join(''));
} else
{buffer.append(ch);
}
{
var G__200476 = (index + 1);
index = G__200476;
continue;
}
}
