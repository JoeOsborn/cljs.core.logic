...
reader_error.cljs$lang$applyTo = (function (arglist__200759){
var rdr = cljs.core.first(arglist__200759);
var msg = cljs.core.rest(arglist__200759);
...
{{
var G__200760 = (function (){sb.append(ch);
return sb;
})();
var G__200761 = cljs.reader.read_char.call(null,rdr);
sb = G__200760;
ch = G__200761;
continue;
}
...
{{
var G__200762 = cljs.reader.read_char.call(null,rdr);
ch = G__200762;
continue;
}
} else
...
var G__200763 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__200763;
continue;
}
} else
...
var G__200764 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__200764;
continue;
}
}
...
{{
var G__200765 = (function (){buffer.append(ch);
return buffer;
})();
var G__200766 = cljs.reader.read_char.call(null,reader);
buffer = G__200765;
ch = G__200766;
continue;
}
...
{if(("\\" === ch))
{{
var G__200767 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__200768 = cljs.reader.read_char.call(null,reader);
buffer = G__200767;
ch = G__200768;
continue;
}
...
{{
var G__200769 = (function (){buffer.append(ch);
return buffer;
})();
var G__200770 = cljs.reader.read_char.call(null,reader);
buffer = G__200769;
ch = G__200770;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__200772 = o;if(G__200772)
{var bit__5323__auto__ = (G__200772.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__200772.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__200772.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__200772);
} else
{return false;
}
}
...
{{
var G__200773 = reader;
var G__200774 = eof_is_error;
var G__200775 = sentinel;
var G__200776 = is_recursive;
reader = G__200773;
eof_is_error = G__200774;
sentinel = G__200775;
is_recursive = G__200776;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__200777 = cljs.reader.read_comment.call(null,reader,ch);
var G__200778 = eof_is_error;
var G__200779 = sentinel;
var G__200780 = is_recursive;
reader = G__200777;
eof_is_error = G__200778;
sentinel = G__200779;
is_recursive = G__200780;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__200781 = reader;
var G__200782 = eof_is_error;
var G__200783 = sentinel;
var G__200784 = is_recursive;
reader = G__200781;
eof_is_error = G__200782;
sentinel = G__200783;
is_recursive = G__200784;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__200787 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__200787,0,null);var years = cljs.core.nth.call(null,vec__200787,1,null);var months = cljs.core.nth.call(null,vec__200787,2,null);var days = cljs.core.nth.call(null,vec__200787,3,null);var hours = cljs.core.nth.call(null,vec__200787,4,null);var minutes = cljs.core.nth.call(null,vec__200787,5,null);var seconds = cljs.core.nth.call(null,vec__200787,6,null);var fraction = cljs.core.nth.call(null,vec__200787,7,null);var offset_sign = cljs.core.nth.call(null,vec__200787,8,null);var offset_hours = cljs.core.nth.call(null,vec__200787,9,null);var offset_minutes = cljs.core.nth.call(null,vec__200787,10,null);var v = vec__200787;if(cljs.core.not.call(null,v))
...
{var vec__200789 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__200789,0,null);var months = cljs.core.nth.call(null,vec__200789,1,null);var days = cljs.core.nth.call(null,vec__200789,2,null);var hours = cljs.core.nth.call(null,vec__200789,3,null);var minutes = cljs.core.nth.call(null,vec__200789,4,null);var seconds = cljs.core.nth.call(null,vec__200789,5,null);var ms = cljs.core.nth.call(null,vec__200789,6,null);var offset = cljs.core.nth.call(null,vec__200789,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
