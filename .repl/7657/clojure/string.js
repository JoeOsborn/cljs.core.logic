...
{{
var G__35121 = cljs.core.pop.call(null,v__$1);
v__$1 = G__35121;
continue;
}
} else
...
{var pred__35125 = cljs.core._EQ_;var expr__35126 = limit;if(pred__35125.call(null,1,expr__35126))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__35125.call(null,2,expr__35126))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__35128 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__35129 = (limit__$1 - 1);
var G__35130 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__35128;
limit__$1 = G__35129;
parts = G__35130;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___35132 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___35132))
{var replacement_35133 = temp__4092__auto___35132;buffer.append([cljs.core.str(replacement_35133)].join(''));
} else
{buffer.append(ch);
}
{
