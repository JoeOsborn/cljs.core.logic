...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__35136 = m;var map__35136__$1 = ((cljs.core.seq_QMARK_.call(null,map__35136))?cljs.core.apply.call(null,cljs.core.hash_map,map__35136):map__35136);var line = cljs.core.get.call(null,map__35136__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__35136__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__35138 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__35138))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__35138))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_35139;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_35140 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_35140;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_35141 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___35142 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___35142))
{var message_35143 = temp__4094__auto___35142;cljs.core.println.call(null,message_35143);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_35141;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_35144 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___35145 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___35145))
{var message_35146 = temp__4094__auto___35145;cljs.core.println.call(null,message_35146);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_35147;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_35148 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_35148;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__35149){
var ns_sym = cljs.core.first(arglist__35149);
arglist__35149 = cljs.core.next(arglist__35149);
var fixture_type = cljs.core.first(arglist__35149);
var fixture_fns = cljs.core.rest(arglist__35149);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_35152 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__4704__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return v;
}
...
{var e_35154 = e35153;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_35154], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e35153;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_35152;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__35159 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__35160 = null;var count__35161 = 0;var i__35162 = 0;while(true){
if((i__35162 < count__35161))
{var v = cljs.core._nth.call(null,chunk__35160,i__35162);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__35159,chunk__35160,count__35161,i__35162,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__35159,chunk__35160,count__35161,i__35162,v))
);
} else
{}
{
var G__35163 = seq__35159;
var G__35164 = chunk__35160;
var G__35165 = count__35161;
var G__35166 = (i__35162 + 1);
seq__35159 = G__35163;
chunk__35160 = G__35164;
count__35161 = G__35165;
i__35162 = G__35166;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__35159);if(temp__4094__auto__)
{var seq__35159__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__35159__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__35159__$1);{
var G__35167 = cljs.core.chunk_rest.call(null,seq__35159__$1);
var G__35168 = c__5421__auto__;
var G__35169 = cljs.core.count.call(null,c__5421__auto__);
var G__35170 = 0;
seq__35159 = G__35167;
chunk__35160 = G__35168;
count__35161 = G__35169;
i__35162 = G__35170;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__35159__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__35159,chunk__35160,count__35161,i__35162,v,seq__35159__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__35159,chunk__35160,count__35161,i__35162,v,seq__35159__$1,temp__4094__auto__))
);
} else
{}
{
var G__35171 = cljs.core.next.call(null,seq__35159__$1);
var G__35172 = null;
var G__35173 = 0;
var G__35174 = 0;
seq__35159 = G__35171;
chunk__35160 = G__35172;
count__35161 = G__35173;
i__35162 = G__35174;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_35176 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___35177 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___35177))
{var test_hook_35178 = temp__4092__auto___35177;test_hook_35178.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_35176;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__35179){
var namespaces = cljs.core.seq(arglist__35179);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__35180_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__35180_SHARP_));
