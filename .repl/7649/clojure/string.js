...
{{
var G__30771 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30771;
continue;
}
} else
...
{var pred__30775 = cljs.core._EQ_;var expr__30776 = limit;if(pred__30775.call(null,1,expr__30776))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__30775.call(null,2,expr__30776))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__30778 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30779 = (limit__$1 - 1);
var G__30780 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__30778;
limit__$1 = G__30779;
parts = G__30780;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___30782 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___30782))
{var replacement_30783 = temp__4092__auto___30782;buffer.append([cljs.core.str(replacement_30783)].join(''));
} else
{buffer.append(ch);
}
{
var G__30784 = (index + 1);
index = G__30784;
continue;
}
}
