...
reader_error.cljs$lang$applyTo = (function (arglist__9272){
var rdr = cljs.core.first(arglist__9272);
var msg = cljs.core.rest(arglist__9272);
...
{{
var G__9273 = (function (){sb.append(ch);
return sb;
})();
var G__9274 = cljs.reader.read_char.call(null,rdr);
sb = G__9273;
ch = G__9274;
continue;
}
...
{{
var G__9275 = cljs.reader.read_char.call(null,rdr);
ch = G__9275;
continue;
}
} else
...
var G__9276 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9276;
continue;
}
} else
...
var G__9277 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9277;
continue;
}
}
...
{{
var G__9278 = (function (){buffer.append(ch);
return buffer;
})();
var G__9279 = cljs.reader.read_char.call(null,reader);
buffer = G__9278;
ch = G__9279;
continue;
}
...
{if(("\\" === ch))
{{
var G__9280 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9281 = cljs.reader.read_char.call(null,reader);
buffer = G__9280;
ch = G__9281;
continue;
}
...
{{
var G__9282 = (function (){buffer.append(ch);
return buffer;
})();
var G__9283 = cljs.reader.read_char.call(null,reader);
buffer = G__9282;
ch = G__9283;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9285 = o;if(G__9285)
{var bit__5323__auto__ = (G__9285.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9285.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9285.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9285);
} else
{return false;
}
}
...
{{
var G__9286 = reader;
var G__9287 = eof_is_error;
var G__9288 = sentinel;
var G__9289 = is_recursive;
reader = G__9286;
eof_is_error = G__9287;
sentinel = G__9288;
is_recursive = G__9289;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9290 = cljs.reader.read_comment.call(null,reader,ch);
var G__9291 = eof_is_error;
var G__9292 = sentinel;
var G__9293 = is_recursive;
reader = G__9290;
eof_is_error = G__9291;
sentinel = G__9292;
is_recursive = G__9293;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9294 = reader;
var G__9295 = eof_is_error;
var G__9296 = sentinel;
var G__9297 = is_recursive;
reader = G__9294;
eof_is_error = G__9295;
sentinel = G__9296;
is_recursive = G__9297;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9300 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9300,0,null);var years = cljs.core.nth.call(null,vec__9300,1,null);var months = cljs.core.nth.call(null,vec__9300,2,null);var days = cljs.core.nth.call(null,vec__9300,3,null);var hours = cljs.core.nth.call(null,vec__9300,4,null);var minutes = cljs.core.nth.call(null,vec__9300,5,null);var seconds = cljs.core.nth.call(null,vec__9300,6,null);var fraction = cljs.core.nth.call(null,vec__9300,7,null);var offset_sign = cljs.core.nth.call(null,vec__9300,8,null);var offset_hours = cljs.core.nth.call(null,vec__9300,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9300,10,null);var v = vec__9300;if(cljs.core.not.call(null,v))
...
{var vec__9302 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9302,0,null);var months = cljs.core.nth.call(null,vec__9302,1,null);var days = cljs.core.nth.call(null,vec__9302,2,null);var hours = cljs.core.nth.call(null,vec__9302,3,null);var minutes = cljs.core.nth.call(null,vec__9302,4,null);var seconds = cljs.core.nth.call(null,vec__9302,5,null);var ms = cljs.core.nth.call(null,vec__9302,6,null);var offset = cljs.core.nth.call(null,vec__9302,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
