...
{{
var G__9303 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9303;
continue;
}
} else
...
{var pred__9307 = cljs.core._EQ_;var expr__9308 = limit;if(pred__9307.call(null,1,expr__9308))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9307.call(null,2,expr__9308))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9310 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9311 = (limit__$1 - 1);
var G__9312 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9310;
limit__$1 = G__9311;
parts = G__9312;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9314 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9314))
{var replacement_9315 = temp__4092__auto___9314;buffer.append([cljs.core.str(replacement_9315)].join(''));
} else
{buffer.append(ch);
}
{
