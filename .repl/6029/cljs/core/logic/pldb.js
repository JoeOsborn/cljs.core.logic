...
cljs.core.logic.pldb.facts_for = (function facts_for(dbs,kname){return cljs.core.mapcat.call(null,(function (p1__238166_SHARP_){return cljs.core.get_in.call(null,p1__238166_SHARP_,cljs.core.PersistentVector.fromArray([kname,new cljs.core.Keyword("cljs.core.logic.pldb","unindexed","cljs.core.logic.pldb/unindexed",3813484278)], true));
}),dbs);
});
cljs.core.logic.pldb.facts_using_index = (function facts_using_index(dbs,kname,index,val){return cljs.core.mapcat.call(null,(function (p1__238167_SHARP_){return cljs.core.get_in.call(null,p1__238167_SHARP_,cljs.core.PersistentVector.fromArray([kname,index,val], true));
}),dbs);
});
...
cljs.core.logic.pldb.index_for_query = (function index_for_query(s,q,indexes){var indexable = cljs.core.map.call(null,(function (p1__238168_SHARP_){return cljs.core.logic.pldb.ground_QMARK_.call(null,s,p1__238168_SHARP_);
}),q);var triples = cljs.core.map.call(null,cljs.core.vector,cljs.core.range.call(null),indexable,indexes);return cljs.core.first.call(null,(function (){var iter__5390__auto__ = (function iter__238177(s__238178){return (new cljs.core.LazySeq(null,(function (){var s__238178__$1 = s__238178;while(true){
var temp__4094__auto__ = cljs.core.seq.call(null,s__238178__$1);if(temp__4094__auto__)
{var s__238178__$2 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__238178__$2))
{var c__5388__auto__ = cljs.core.chunk_first.call(null,s__238178__$2);var size__5389__auto__ = cljs.core.count.call(null,c__5388__auto__);var b__238180 = cljs.core.chunk_buffer.call(null,size__5389__auto__);if((function (){var i__238179 = 0;while(true){
if((i__238179 < size__5389__auto__))
{var vec__238183 = cljs.core._nth.call(null,c__5388__auto__,i__238179);var i = cljs.core.nth.call(null,vec__238183,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__238183,1,null);var indexed = cljs.core.nth.call(null,vec__238183,2,null);if(cljs.core.truth_((function (){var and__4695__auto__ = indexable__$1;if(cljs.core.truth_(and__4695__auto__))
{return indexed;
} else
{return and__4695__auto__;
}
})()))
{cljs.core.chunk_append.call(null,b__238180,i);
{
var G__238185 = (i__238179 + 1);
i__238179 = G__238185;
continue;
}
} else
{{
var G__238186 = (i__238179 + 1);
i__238179 = G__238186;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__238180),iter__238177.call(null,cljs.core.chunk_rest.call(null,s__238178__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__238180),null);
}
} else
{var vec__238184 = cljs.core.first.call(null,s__238178__$2);var i = cljs.core.nth.call(null,vec__238184,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__238184,1,null);var indexed = cljs.core.nth.call(null,vec__238184,2,null);if(cljs.core.truth_((function (){var and__4695__auto__ = indexable__$1;if(cljs.core.truth_(and__4695__auto__))
{return indexed;
} else
{return and__4695__auto__;
}
})()))
{return cljs.core.cons.call(null,i,iter__238177.call(null,cljs.core.rest.call(null,s__238178__$2)));
} else
{{
var G__238187 = cljs.core.rest.call(null,s__238178__$2);
s__238178__$1 = G__238187;
continue;
}
}
}
...
return (function (p1__238188_SHARP_){return add_to_set.call(null,p1__238188_SHARP_,args);
});})(key,add_to_set))
...
return (function (db__$1,p__238192){var vec__238193 = p__238192;var is_indexed = cljs.core.nth.call(null,vec__238193,0,null);var index_num = cljs.core.nth.call(null,vec__238193,1,null);var val = cljs.core.nth.call(null,vec__238193,2,null);if(cljs.core.truth_(is_indexed))
{return cljs.core.update_in.call(null,db__$1,cljs.core.PersistentVector.fromArray([key,index_num,val], true),((function (vec__238193,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update){
return (function (p1__238189_SHARP_){return add_to_set.call(null,p1__238189_SHARP_,args);
});})(vec__238193,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update))
);
} else
{return db__$1;
}
...
db_fact.cljs$lang$applyTo = (function (arglist__238194){
var db = cljs.core.first(arglist__238194);
arglist__238194 = cljs.core.next(arglist__238194);
var rel = cljs.core.first(arglist__238194);
var args = cljs.core.rest(arglist__238194);
...
return (function (p1__238195_SHARP_){return cljs.core.disj.call(null,p1__238195_SHARP_,args);
});})(key))
...
return (function (db__$1,p__238198){var vec__238199 = p__238198;var is_indexed = cljs.core.nth.call(null,vec__238199,0,null);var index_num = cljs.core.nth.call(null,vec__238199,1,null);var val = cljs.core.nth.call(null,vec__238199,2,null);if(cljs.core.truth_(is_indexed))
...
db_retraction.cljs$lang$applyTo = (function (arglist__238200){
var db = cljs.core.first(arglist__238200);
arglist__238200 = cljs.core.next(arglist__238200);
var rel = cljs.core.first(arglist__238200);
var args = cljs.core.rest(arglist__238200);
...
var db_facts__delegate = function (base_db,facts){return cljs.core.reduce.call(null,(function (p1__238201_SHARP_,p2__238202_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_fact,p1__238201_SHARP_,p2__238202_SHARP_);
}),base_db,facts);
};
...
db_facts.cljs$lang$applyTo = (function (arglist__238203){
var base_db = cljs.core.first(arglist__238203);
var facts = cljs.core.rest(arglist__238203);
...
db.cljs$lang$applyTo = (function (arglist__238204){
var facts = cljs.core.seq(arglist__238204);
...
var db_retractions__delegate = function (base_db,retractions){return cljs.core.reduce.call(null,(function (p1__238205_SHARP_,p2__238206_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_retraction,p1__238205_SHARP_,p2__238206_SHARP_);
}),base_db,retractions);
};
...
db_retractions.cljs$lang$applyTo = (function (arglist__238207){
var base_db = cljs.core.first(arglist__238207);
var retractions = cljs.core.rest(arglist__238207);
