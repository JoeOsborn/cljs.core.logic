...
reader_error.cljs$lang$applyTo = (function (arglist__238047){
var rdr = cljs.core.first(arglist__238047);
var msg = cljs.core.rest(arglist__238047);
...
{{
var G__238048 = (function (){sb.append(ch);
return sb;
})();
var G__238049 = cljs.reader.read_char.call(null,rdr);
sb = G__238048;
ch = G__238049;
continue;
}
...
{{
var G__238050 = cljs.reader.read_char.call(null,rdr);
ch = G__238050;
continue;
}
} else
...
var G__238051 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__238051;
continue;
}
} else
...
var G__238052 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__238052;
continue;
}
}
...
{{
var G__238053 = (function (){buffer.append(ch);
return buffer;
})();
var G__238054 = cljs.reader.read_char.call(null,reader);
buffer = G__238053;
ch = G__238054;
continue;
}
...
{if(("\\" === ch))
{{
var G__238055 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__238056 = cljs.reader.read_char.call(null,reader);
buffer = G__238055;
ch = G__238056;
continue;
}
...
{{
var G__238057 = (function (){buffer.append(ch);
return buffer;
})();
var G__238058 = cljs.reader.read_char.call(null,reader);
buffer = G__238057;
ch = G__238058;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__238060 = o;if(G__238060)
{var bit__5323__auto__ = (G__238060.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__238060.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__238060.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__238060);
} else
{return false;
}
}
...
{{
var G__238061 = reader;
var G__238062 = eof_is_error;
var G__238063 = sentinel;
var G__238064 = is_recursive;
reader = G__238061;
eof_is_error = G__238062;
sentinel = G__238063;
is_recursive = G__238064;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__238065 = cljs.reader.read_comment.call(null,reader,ch);
var G__238066 = eof_is_error;
var G__238067 = sentinel;
var G__238068 = is_recursive;
reader = G__238065;
eof_is_error = G__238066;
sentinel = G__238067;
is_recursive = G__238068;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__238069 = reader;
var G__238070 = eof_is_error;
var G__238071 = sentinel;
var G__238072 = is_recursive;
reader = G__238069;
eof_is_error = G__238070;
sentinel = G__238071;
is_recursive = G__238072;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__238075 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__238075,0,null);var years = cljs.core.nth.call(null,vec__238075,1,null);var months = cljs.core.nth.call(null,vec__238075,2,null);var days = cljs.core.nth.call(null,vec__238075,3,null);var hours = cljs.core.nth.call(null,vec__238075,4,null);var minutes = cljs.core.nth.call(null,vec__238075,5,null);var seconds = cljs.core.nth.call(null,vec__238075,6,null);var fraction = cljs.core.nth.call(null,vec__238075,7,null);var offset_sign = cljs.core.nth.call(null,vec__238075,8,null);var offset_hours = cljs.core.nth.call(null,vec__238075,9,null);var offset_minutes = cljs.core.nth.call(null,vec__238075,10,null);var v = vec__238075;if(cljs.core.not.call(null,v))
...
{var vec__238077 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__238077,0,null);var months = cljs.core.nth.call(null,vec__238077,1,null);var days = cljs.core.nth.call(null,vec__238077,2,null);var hours = cljs.core.nth.call(null,vec__238077,3,null);var minutes = cljs.core.nth.call(null,vec__238077,4,null);var seconds = cljs.core.nth.call(null,vec__238077,5,null);var ms = cljs.core.nth.call(null,vec__238077,6,null);var offset = cljs.core.nth.call(null,vec__238077,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
