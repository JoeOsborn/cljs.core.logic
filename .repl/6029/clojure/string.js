...
{{
var G__237751 = cljs.core.pop.call(null,v__$1);
v__$1 = G__237751;
continue;
}
} else
...
{var pred__237755 = cljs.core._EQ_;var expr__237756 = limit;if(pred__237755.call(null,1,expr__237756))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__237755.call(null,2,expr__237756))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__237758 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__237759 = (limit__$1 - 1);
var G__237760 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__237758;
limit__$1 = G__237759;
parts = G__237760;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___237762 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___237762))
{var replacement_237763 = temp__4092__auto___237762;buffer.append([cljs.core.str(replacement_237763)].join(''));
} else
{buffer.append(ch);
}
{
var G__237764 = (index + 1);
index = G__237764;
continue;
}
}
