...
{{
var G__39914 = cljs.core.pop.call(null,v__$1);
v__$1 = G__39914;
continue;
}
} else
...
{var pred__39918 = cljs.core._EQ_;var expr__39919 = limit;if(pred__39918.call(null,1,expr__39919))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__39918.call(null,2,expr__39919))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__39921 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__39922 = (limit__$1 - 1);
var G__39923 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__39921;
limit__$1 = G__39922;
parts = G__39923;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___39925 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___39925))
{var replacement_39926 = temp__4092__auto___39925;buffer.append([cljs.core.str(replacement_39926)].join(''));
} else
{buffer.append(ch);
}
{
var G__39927 = (index + 1);
index = G__39927;
continue;
}
}
