...
{{
var G__23259 = cljs.core.pop.call(null,v__$1);
v__$1 = G__23259;
continue;
}
} else
...
{var pred__23263 = cljs.core._EQ_;var expr__23264 = limit;if(cljs.core.truth_(pred__23263.call(null,1,expr__23264)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__23263.call(null,2,expr__23264)))
...
var G__23266 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__23267 = (limit__$1 - 1);
var G__23268 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__23266;
limit__$1 = G__23267;
parts = G__23268;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___23270 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___23270))
{var replacement_23271 = temp__4096__auto___23270;buffer.append([cljs.core.str(replacement_23271)].join(''));
} else
{buffer.append(ch);
}
{
