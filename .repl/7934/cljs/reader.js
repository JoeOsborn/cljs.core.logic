...
reader_error.cljs$lang$applyTo = (function (arglist__9582){
var rdr = cljs.core.first(arglist__9582);
var msg = cljs.core.rest(arglist__9582);
...
{{
var G__9583 = (function (){sb.append(ch);
return sb;
})();
var G__9584 = cljs.reader.read_char.call(null,rdr);
sb = G__9583;
ch = G__9584;
continue;
}
...
{{
var G__9585 = cljs.reader.read_char.call(null,rdr);
ch = G__9585;
continue;
}
} else
...
var G__9586 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9586;
continue;
}
} else
...
var G__9587 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9587;
continue;
}
}
...
{{
var G__9588 = (function (){buffer.append(ch);
return buffer;
})();
var G__9589 = cljs.reader.read_char.call(null,reader);
buffer = G__9588;
ch = G__9589;
continue;
}
...
{if(("\\" === ch))
{{
var G__9590 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9591 = cljs.reader.read_char.call(null,reader);
buffer = G__9590;
ch = G__9591;
continue;
}
...
{{
var G__9592 = (function (){buffer.append(ch);
return buffer;
})();
var G__9593 = cljs.reader.read_char.call(null,reader);
buffer = G__9592;
ch = G__9593;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9595 = o;if(G__9595)
{var bit__5323__auto__ = (G__9595.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9595.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9595.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9595);
} else
{return false;
}
}
...
{{
var G__9596 = reader;
var G__9597 = eof_is_error;
var G__9598 = sentinel;
var G__9599 = is_recursive;
reader = G__9596;
eof_is_error = G__9597;
sentinel = G__9598;
is_recursive = G__9599;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9600 = cljs.reader.read_comment.call(null,reader,ch);
var G__9601 = eof_is_error;
var G__9602 = sentinel;
var G__9603 = is_recursive;
reader = G__9600;
eof_is_error = G__9601;
sentinel = G__9602;
is_recursive = G__9603;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9604 = reader;
var G__9605 = eof_is_error;
var G__9606 = sentinel;
var G__9607 = is_recursive;
reader = G__9604;
eof_is_error = G__9605;
sentinel = G__9606;
is_recursive = G__9607;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9610 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9610,0,null);var years = cljs.core.nth.call(null,vec__9610,1,null);var months = cljs.core.nth.call(null,vec__9610,2,null);var days = cljs.core.nth.call(null,vec__9610,3,null);var hours = cljs.core.nth.call(null,vec__9610,4,null);var minutes = cljs.core.nth.call(null,vec__9610,5,null);var seconds = cljs.core.nth.call(null,vec__9610,6,null);var fraction = cljs.core.nth.call(null,vec__9610,7,null);var offset_sign = cljs.core.nth.call(null,vec__9610,8,null);var offset_hours = cljs.core.nth.call(null,vec__9610,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9610,10,null);var v = vec__9610;if(cljs.core.not.call(null,v))
...
{var vec__9612 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9612,0,null);var months = cljs.core.nth.call(null,vec__9612,1,null);var days = cljs.core.nth.call(null,vec__9612,2,null);var hours = cljs.core.nth.call(null,vec__9612,3,null);var minutes = cljs.core.nth.call(null,vec__9612,4,null);var seconds = cljs.core.nth.call(null,vec__9612,5,null);var ms = cljs.core.nth.call(null,vec__9612,6,null);var offset = cljs.core.nth.call(null,vec__9612,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
