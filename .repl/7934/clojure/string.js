...
{{
var G__9613 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9613;
continue;
}
} else
...
{var pred__9617 = cljs.core._EQ_;var expr__9618 = limit;if(pred__9617.call(null,1,expr__9618))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9617.call(null,2,expr__9618))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9620 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9621 = (limit__$1 - 1);
var G__9622 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9620;
limit__$1 = G__9621;
parts = G__9622;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9624 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9624))
{var replacement_9625 = temp__4092__auto___9624;buffer.append([cljs.core.str(replacement_9625)].join(''));
} else
{buffer.append(ch);
}
{
