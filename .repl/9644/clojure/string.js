...
{{
var G__104513 = cljs.core.pop.call(null,v__$1);
v__$1 = G__104513;
continue;
}
} else
...
{var pred__104517 = cljs.core._EQ_;var expr__104518 = limit;if(cljs.core.truth_(pred__104517.call(null,1,expr__104518)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__104517.call(null,2,expr__104518)))
...
var G__104520 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__104521 = (limit__$1 - 1);
var G__104522 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__104520;
limit__$1 = G__104521;
parts = G__104522;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___104524 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___104524))
{var replacement_104525 = temp__4092__auto___104524;buffer.append([cljs.core.str(replacement_104525)].join(''));
} else
{buffer.append(ch);
}
{
var G__104526 = (index + 1);
index = G__104526;
continue;
}
}
