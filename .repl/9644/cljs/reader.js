...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj104481 = {};return obj104481;
})();
cljs.reader.read_char = (function read_char(reader){if((function (){var and__5120__auto__ = reader;if(and__5120__auto__)
...
{var x__5730__auto__ = (((reader == null))?null:reader);return (function (){var or__5132__auto__ = (cljs.reader.read_char[goog.typeOf(x__5730__auto__)]);if(or__5132__auto__)
{return or__5132__auto__;
} else
{var or__5132__auto____$1 = (cljs.reader.read_char["_"]);if(or__5132__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__5120__auto__ = reader;if(and__5120__auto__)
...
{var x__5730__auto__ = (((reader == null))?null:reader);return (function (){var or__5132__auto__ = (cljs.reader.unread[goog.typeOf(x__5730__auto__)]);if(or__5132__auto__)
{return or__5132__auto__;
} else
{var or__5132__auto____$1 = (cljs.reader.unread["_"]);if(or__5132__auto____$1)
{return or__5132__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__5671__auto__,writer__5672__auto__,opt__5673__auto__){return cljs.core._write.call(null,writer__5672__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__5132__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__104482){
var rdr = cljs.core.first(arglist__104482);
var msg = cljs.core.rest(arglist__104482);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__5120__auto__ = !((ch === "#"));if(and__5120__auto__)
{var and__5120__auto____$1 = !((ch === "'"));if(and__5120__auto____$1)
{var and__5120__auto____$2 = !((ch === ":"));if(and__5120__auto____$2)
...
{{
var G__104483 = (function (){sb.append(ch);
return sb;
})();
var G__104484 = cljs.reader.read_char.call(null,rdr);
sb = G__104483;
ch = G__104484;
continue;
}
...
{{
var G__104485 = cljs.reader.read_char.call(null,rdr);
ch = G__104485;
continue;
}
} else
...
var G__104486 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__104486;
continue;
}
} else
...
var G__104487 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__104487;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__5132__auto__ = (ch == null);if(or__5132__auto__)
{return or__5132__auto__;
} else
{var or__5132__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__5132__auto____$1)
{return or__5132__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__5132__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
...
{{
var G__104488 = (function (){buffer.append(ch);
return buffer;
})();
var G__104489 = cljs.reader.read_char.call(null,reader);
buffer = G__104488;
ch = G__104489;
continue;
}
...
{if(("\\" === ch))
{{
var G__104490 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__104491 = cljs.reader.read_char.call(null,reader);
buffer = G__104490;
ch = G__104491;
continue;
}
...
{{
var G__104492 = (function (){buffer.append(ch);
return buffer;
})();
var G__104493 = cljs.reader.read_char.call(null,reader);
buffer = G__104492;
ch = G__104493;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__104495 = o;if(G__104495)
{var bit__5753__auto__ = (G__104495.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5753__auto__) || (G__104495.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__104495.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__104495);
} else
{return false;
}
}
...
{{
var G__104496 = reader;
var G__104497 = eof_is_error;
var G__104498 = sentinel;
var G__104499 = is_recursive;
reader = G__104496;
eof_is_error = G__104497;
sentinel = G__104498;
is_recursive = G__104499;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__104500 = cljs.reader.read_comment.call(null,reader,ch);
var G__104501 = eof_is_error;
var G__104502 = sentinel;
var G__104503 = is_recursive;
reader = G__104500;
eof_is_error = G__104501;
sentinel = G__104502;
is_recursive = G__104503;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__104504 = reader;
var G__104505 = eof_is_error;
var G__104506 = sentinel;
var G__104507 = is_recursive;
reader = G__104504;
eof_is_error = G__104505;
sentinel = G__104506;
is_recursive = G__104507;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__104510 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__104510,0,null);var years = cljs.core.nth.call(null,vec__104510,1,null);var months = cljs.core.nth.call(null,vec__104510,2,null);var days = cljs.core.nth.call(null,vec__104510,3,null);var hours = cljs.core.nth.call(null,vec__104510,4,null);var minutes = cljs.core.nth.call(null,vec__104510,5,null);var seconds = cljs.core.nth.call(null,vec__104510,6,null);var fraction = cljs.core.nth.call(null,vec__104510,7,null);var offset_sign = cljs.core.nth.call(null,vec__104510,8,null);var offset_hours = cljs.core.nth.call(null,vec__104510,9,null);var offset_minutes = cljs.core.nth.call(null,vec__104510,10,null);var v = vec__104510;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__5132__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return 0;
}
...
{var vec__104512 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__104512,0,null);var months = cljs.core.nth.call(null,vec__104512,1,null);var days = cljs.core.nth.call(null,vec__104512,2,null);var hours = cljs.core.nth.call(null,vec__104512,3,null);var minutes = cljs.core.nth.call(null,vec__104512,4,null);var seconds = cljs.core.nth.call(null,vec__104512,5,null);var ms = cljs.core.nth.call(null,vec__104512,6,null);var offset = cljs.core.nth.call(null,vec__104512,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
