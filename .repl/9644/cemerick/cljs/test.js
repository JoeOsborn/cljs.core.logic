...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__104528 = m;var map__104528__$1 = ((cljs.core.seq_QMARK_.call(null,map__104528))?cljs.core.apply.call(null,cljs.core.hash_map,map__104528):map__104528);var line = cljs.core.get.call(null,map__104528__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__104528__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__104530 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__104530))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__104530))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_104531;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_104532 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_104532;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_104533 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___104534 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___104534))
{var message_104535 = temp__4094__auto___104534;cljs.core.println.call(null,message_104535);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_104533;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_104536 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___104537 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___104537))
{var message_104538 = temp__4094__auto___104537;cljs.core.println.call(null,message_104538);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_104536;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"summary","summary",3451231000),(function (m){var _STAR_print_fn_STAR_104539 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_104539;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_104540 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__5132__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_104540;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__104541){
var ns_sym = cljs.core.first(arglist__104541);
arglist__104541 = cljs.core.next(arglist__104541);
var fixture_type = cljs.core.first(arglist__104541);
var fixture_fns = cljs.core.rest(arglist__104541);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_104544 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__5132__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__5132__auto__))
{return or__5132__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e104545){if((e104545 instanceof Error))
{var e_104546 = e104545;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_104546], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e104545;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_104544;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__104551 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__104552 = null;var count__104553 = 0;var i__104554 = 0;while(true){
if((i__104554 < count__104553))
{var v = cljs.core._nth.call(null,chunk__104552,i__104554);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__104551,chunk__104552,count__104553,i__104554,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__104551,chunk__104552,count__104553,i__104554,v))
);
} else
{}
{
var G__104555 = seq__104551;
var G__104556 = chunk__104552;
var G__104557 = count__104553;
var G__104558 = (i__104554 + 1);
seq__104551 = G__104555;
chunk__104552 = G__104556;
count__104553 = G__104557;
i__104554 = G__104558;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__104551);if(temp__4094__auto__)
{var seq__104551__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__104551__$1))
{var c__5851__auto__ = cljs.core.chunk_first.call(null,seq__104551__$1);{
var G__104559 = cljs.core.chunk_rest.call(null,seq__104551__$1);
var G__104560 = c__5851__auto__;
var G__104561 = cljs.core.count.call(null,c__5851__auto__);
var G__104562 = 0;
seq__104551 = G__104559;
chunk__104552 = G__104560;
count__104553 = G__104561;
i__104554 = G__104562;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__104551__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__104551,chunk__104552,count__104553,i__104554,v,seq__104551__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__104551,chunk__104552,count__104553,i__104554,v,seq__104551__$1,temp__4094__auto__))
);
} else
{}
{
var G__104563 = cljs.core.next.call(null,seq__104551__$1);
var G__104564 = null;
var G__104565 = 0;
var G__104566 = 0;
seq__104551 = G__104563;
chunk__104552 = G__104564;
count__104553 = G__104565;
i__104554 = G__104566;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_104568 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___104569 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___104569))
{var test_hook_104570 = temp__4092__auto___104569;test_hook_104570.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_104568;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__104571){
var namespaces = cljs.core.seq(arglist__104571);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__104572_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__104572_SHARP_));
