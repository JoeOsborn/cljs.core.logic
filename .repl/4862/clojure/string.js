...
{{
var G__321890 = cljs.core.pop.call(null,v__$1);
v__$1 = G__321890;
continue;
}
} else
...
{var pred__321894 = cljs.core._EQ_;var expr__321895 = limit;if(pred__321894.call(null,1,expr__321895))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__321894.call(null,2,expr__321895))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__321897 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__321898 = (limit__$1 - 1);
var G__321899 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__321897;
limit__$1 = G__321898;
parts = G__321899;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___321901 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___321901))
{var replacement_321902 = temp__4092__auto___321901;buffer.append([cljs.core.str(replacement_321902)].join(''));
} else
{buffer.append(ch);
}
{
var G__321903 = (index + 1);
index = G__321903;
continue;
}
}
