...
{{
var G__9422 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9422;
continue;
}
} else
...
{var pred__9426 = cljs.core._EQ_;var expr__9427 = limit;if(pred__9426.call(null,1,expr__9427))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9426.call(null,2,expr__9427))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9429 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9430 = (limit__$1 - 1);
var G__9431 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9429;
limit__$1 = G__9430;
parts = G__9431;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9433 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9433))
{var replacement_9434 = temp__4092__auto___9433;buffer.append([cljs.core.str(replacement_9434)].join(''));
} else
{buffer.append(ch);
}
{
