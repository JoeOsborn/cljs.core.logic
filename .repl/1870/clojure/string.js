...
{{
var G__27743 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27743;
continue;
}
} else
...
{var pred__27747 = cljs.core._EQ_;var expr__27748 = limit;if(pred__27747.call(null,1,expr__27748))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__27747.call(null,2,expr__27748))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
{var ch = s.charAt(index);var temp__4092__auto___27754 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___27754))
{var replacement_27755 = temp__4092__auto___27754;buffer.append([cljs.core.str(replacement_27755)].join(''));
} else
{buffer.append(ch);
}
{
