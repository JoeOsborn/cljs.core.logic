...
{{
var G__21225 = cljs.core.pop.call(null,v__$1);
v__$1 = G__21225;
continue;
}
} else
...
{var pred__21229 = cljs.core._EQ_;var expr__21230 = limit;if(cljs.core.truth_(pred__21229.call(null,1,expr__21230)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__21229.call(null,2,expr__21230)))
...
var G__21232 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__21233 = (limit__$1 - 1);
var G__21234 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__21232;
limit__$1 = G__21233;
parts = G__21234;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___21236 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___21236))
{var replacement_21237 = temp__4096__auto___21236;buffer.append([cljs.core.str(replacement_21237)].join(''));
} else
{buffer.append(ch);
}
{
var G__21238 = (index + 1);
index = G__21238;
continue;
}
}
