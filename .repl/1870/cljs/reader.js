...
reader_error.cljs$lang$applyTo = (function (arglist__27712){
var rdr = cljs.core.first(arglist__27712);
var msg = cljs.core.rest(arglist__27712);
...
{{
var G__27713 = (function (){sb.append(ch);
return sb;
})();
var G__27714 = cljs.reader.read_char.call(null,rdr);
sb = G__27713;
ch = G__27714;
continue;
}
...
{{
var G__27715 = cljs.reader.read_char.call(null,rdr);
ch = G__27715;
continue;
}
} else
...
var G__27716 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__27716;
continue;
}
} else
...
var G__27717 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__27717;
continue;
}
}
...
{{
var G__27718 = (function (){buffer.append(ch);
return buffer;
})();
var G__27719 = cljs.reader.read_char.call(null,reader);
buffer = G__27718;
ch = G__27719;
continue;
}
...
{if(("\\" === ch))
{{
var G__27720 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__27721 = cljs.reader.read_char.call(null,reader);
buffer = G__27720;
ch = G__27721;
continue;
}
...
{{
var G__27722 = (function (){buffer.append(ch);
return buffer;
})();
var G__27723 = cljs.reader.read_char.call(null,reader);
buffer = G__27722;
ch = G__27723;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__27725 = o;if(G__27725)
{var bit__5604__auto__ = (G__27725.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5604__auto__) || (G__27725.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__27725.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__27725);
} else
{return false;
}
}
...
{{
var G__27726 = reader;
var G__27727 = eof_is_error;
var G__27728 = sentinel;
var G__27729 = is_recursive;
reader = G__27726;
eof_is_error = G__27727;
sentinel = G__27728;
is_recursive = G__27729;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__27730 = cljs.reader.read_comment.call(null,reader,ch);
var G__27731 = eof_is_error;
var G__27732 = sentinel;
var G__27733 = is_recursive;
reader = G__27730;
eof_is_error = G__27731;
sentinel = G__27732;
is_recursive = G__27733;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__27734 = reader;
var G__27735 = eof_is_error;
var G__27736 = sentinel;
var G__27737 = is_recursive;
reader = G__27734;
eof_is_error = G__27735;
sentinel = G__27736;
is_recursive = G__27737;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__27740 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__27740,0,null);var years = cljs.core.nth.call(null,vec__27740,1,null);var months = cljs.core.nth.call(null,vec__27740,2,null);var days = cljs.core.nth.call(null,vec__27740,3,null);var hours = cljs.core.nth.call(null,vec__27740,4,null);var minutes = cljs.core.nth.call(null,vec__27740,5,null);var seconds = cljs.core.nth.call(null,vec__27740,6,null);var fraction = cljs.core.nth.call(null,vec__27740,7,null);var offset_sign = cljs.core.nth.call(null,vec__27740,8,null);var offset_hours = cljs.core.nth.call(null,vec__27740,9,null);var offset_minutes = cljs.core.nth.call(null,vec__27740,10,null);var v = vec__27740;if(cljs.core.not.call(null,v))
...
{var vec__27742 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__27742,0,null);var months = cljs.core.nth.call(null,vec__27742,1,null);var days = cljs.core.nth.call(null,vec__27742,2,null);var hours = cljs.core.nth.call(null,vec__27742,3,null);var minutes = cljs.core.nth.call(null,vec__27742,4,null);var seconds = cljs.core.nth.call(null,vec__27742,5,null);var ms = cljs.core.nth.call(null,vec__27742,6,null);var offset = cljs.core.nth.call(null,vec__27742,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
