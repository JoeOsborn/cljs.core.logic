...
{{
var G__13341 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13341;
continue;
}
} else
...
{var pred__13345 = cljs.core._EQ_;var expr__13346 = limit;if(cljs.core.truth_(pred__13345.call(null,1,expr__13346)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13345.call(null,2,expr__13346)))
...
var G__13348 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13349 = (limit__$1 - 1);
var G__13350 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13348;
limit__$1 = G__13349;
parts = G__13350;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___13352 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___13352))
{var replacement_13353 = temp__4096__auto___13352;buffer.append([cljs.core.str(replacement_13353)].join(''));
} else
{buffer.append(ch);
}
{
var G__13354 = (index + 1);
index = G__13354;
continue;
}
}
