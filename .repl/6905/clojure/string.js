...
{{
var G__12560 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12560;
continue;
}
} else
...
{var pred__12564 = cljs.core._EQ_;var expr__12565 = limit;if(pred__12564.call(null,1,expr__12565))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__12564.call(null,2,expr__12565))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__12567 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12568 = (limit__$1 - 1);
var G__12569 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12567;
limit__$1 = G__12568;
parts = G__12569;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___12571 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___12571))
{var replacement_12572 = temp__4092__auto___12571;buffer.append([cljs.core.str(replacement_12572)].join(''));
} else
{buffer.append(ch);
}
{
var G__12573 = (index + 1);
index = G__12573;
continue;
}
}
