...
reader_error.cljs$lang$applyTo = (function (arglist__186733){
var rdr = cljs.core.first(arglist__186733);
var msg = cljs.core.rest(arglist__186733);
...
{{
var G__186734 = (function (){sb.append(ch);
return sb;
})();
var G__186735 = cljs.reader.read_char.call(null,rdr);
sb = G__186734;
ch = G__186735;
continue;
}
...
{{
var G__186736 = cljs.reader.read_char.call(null,rdr);
ch = G__186736;
continue;
}
} else
...
var G__186737 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__186737;
continue;
}
} else
...
var G__186738 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__186738;
continue;
}
}
...
{{
var G__186739 = (function (){buffer.append(ch);
return buffer;
})();
var G__186740 = cljs.reader.read_char.call(null,reader);
buffer = G__186739;
ch = G__186740;
continue;
}
...
{if(("\\" === ch))
{{
var G__186741 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__186742 = cljs.reader.read_char.call(null,reader);
buffer = G__186741;
ch = G__186742;
continue;
}
...
{{
var G__186743 = (function (){buffer.append(ch);
return buffer;
})();
var G__186744 = cljs.reader.read_char.call(null,reader);
buffer = G__186743;
ch = G__186744;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__186746 = o;if(G__186746)
{var bit__5323__auto__ = (G__186746.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__186746.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__186746.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__186746);
} else
{return false;
}
}
...
{{
var G__186747 = reader;
var G__186748 = eof_is_error;
var G__186749 = sentinel;
var G__186750 = is_recursive;
reader = G__186747;
eof_is_error = G__186748;
sentinel = G__186749;
is_recursive = G__186750;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__186751 = cljs.reader.read_comment.call(null,reader,ch);
var G__186752 = eof_is_error;
var G__186753 = sentinel;
var G__186754 = is_recursive;
reader = G__186751;
eof_is_error = G__186752;
sentinel = G__186753;
is_recursive = G__186754;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__186755 = reader;
var G__186756 = eof_is_error;
var G__186757 = sentinel;
var G__186758 = is_recursive;
reader = G__186755;
eof_is_error = G__186756;
sentinel = G__186757;
is_recursive = G__186758;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__186761 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__186761,0,null);var years = cljs.core.nth.call(null,vec__186761,1,null);var months = cljs.core.nth.call(null,vec__186761,2,null);var days = cljs.core.nth.call(null,vec__186761,3,null);var hours = cljs.core.nth.call(null,vec__186761,4,null);var minutes = cljs.core.nth.call(null,vec__186761,5,null);var seconds = cljs.core.nth.call(null,vec__186761,6,null);var fraction = cljs.core.nth.call(null,vec__186761,7,null);var offset_sign = cljs.core.nth.call(null,vec__186761,8,null);var offset_hours = cljs.core.nth.call(null,vec__186761,9,null);var offset_minutes = cljs.core.nth.call(null,vec__186761,10,null);var v = vec__186761;if(cljs.core.not.call(null,v))
...
{var vec__186763 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__186763,0,null);var months = cljs.core.nth.call(null,vec__186763,1,null);var days = cljs.core.nth.call(null,vec__186763,2,null);var hours = cljs.core.nth.call(null,vec__186763,3,null);var minutes = cljs.core.nth.call(null,vec__186763,4,null);var seconds = cljs.core.nth.call(null,vec__186763,5,null);var ms = cljs.core.nth.call(null,vec__186763,6,null);var offset = cljs.core.nth.call(null,vec__186763,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
