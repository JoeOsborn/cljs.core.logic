...
{{
var G__186437 = cljs.core.pop.call(null,v__$1);
v__$1 = G__186437;
continue;
}
} else
...
{var pred__186441 = cljs.core._EQ_;var expr__186442 = limit;if(pred__186441.call(null,1,expr__186442))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__186441.call(null,2,expr__186442))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__186444 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__186445 = (limit__$1 - 1);
var G__186446 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__186444;
limit__$1 = G__186445;
parts = G__186446;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___186448 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___186448))
{var replacement_186449 = temp__4092__auto___186448;buffer.append([cljs.core.str(replacement_186449)].join(''));
} else
{buffer.append(ch);
}
{
var G__186450 = (index + 1);
index = G__186450;
continue;
}
}
