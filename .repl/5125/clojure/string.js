...
{{
var G__43752 = cljs.core.pop.call(null,v__$1);
v__$1 = G__43752;
continue;
}
} else
...
{var pred__43756 = cljs.core._EQ_;var expr__43757 = limit;if(pred__43756.call(null,1,expr__43757))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__43756.call(null,2,expr__43757))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__43759 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__43760 = (limit__$1 - 1);
var G__43761 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__43759;
limit__$1 = G__43760;
parts = G__43761;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___43763 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___43763))
{var replacement_43764 = temp__4092__auto___43763;buffer.append([cljs.core.str(replacement_43764)].join(''));
} else
{buffer.append(ch);
}
{
var G__43765 = (index + 1);
index = G__43765;
continue;
}
}
