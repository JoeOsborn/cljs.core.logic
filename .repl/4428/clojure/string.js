...
{{
var G__24664 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24664;
continue;
}
} else
...
{var pred__24668 = cljs.core._EQ_;var expr__24669 = limit;if(cljs.core.truth_(pred__24668.call(null,1,expr__24669)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24668.call(null,2,expr__24669)))
...
var G__24671 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24672 = (limit__$1 - 1);
var G__24673 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24671;
limit__$1 = G__24672;
parts = G__24673;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___24675 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___24675))
{var replacement_24676 = temp__4096__auto___24675;buffer.append([cljs.core.str(replacement_24676)].join(''));
} else
{buffer.append(ch);
}
{
