...
{{
var G__54763 = cljs.core.pop.call(null,v__$1);
v__$1 = G__54763;
continue;
}
} else
...
{var pred__54767 = cljs.core._EQ_;var expr__54768 = limit;if(cljs.core.truth_(pred__54767.call(null,1,expr__54768)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__54767.call(null,2,expr__54768)))
...
var G__54770 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__54771 = (limit__$1 - 1);
var G__54772 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__54770;
limit__$1 = G__54771;
parts = G__54772;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___54774 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___54774))
{var replacement_54775 = temp__4096__auto___54774;buffer.append([cljs.core.str(replacement_54775)].join(''));
} else
{buffer.append(ch);
}
{
var G__54776 = (index + 1);
index = G__54776;
continue;
}
}
