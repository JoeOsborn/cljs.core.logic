...
goog.require('goog.string');
cljs.reader.PushbackReader = (function (){var obj55997 = {};return obj55997;
})();
...
reader_error.cljs$lang$applyTo = (function (arglist__55998){
var rdr = cljs.core.first(arglist__55998);
var msg = cljs.core.rest(arglist__55998);
...
{{
var G__55999 = (function (){sb.append(ch);
return sb;
})();
var G__56000 = cljs.reader.read_char.call(null,rdr);
sb = G__55999;
ch = G__56000;
continue;
}
...
{{
var G__56001 = cljs.reader.read_char.call(null,rdr);
ch = G__56001;
continue;
}
} else
...
var G__56002 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__56002;
continue;
}
} else
...
var G__56003 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__56003;
continue;
}
}
...
{{
var G__56004 = (function (){buffer.append(ch);
return buffer;
})();
var G__56005 = cljs.reader.read_char.call(null,reader);
buffer = G__56004;
ch = G__56005;
continue;
}
...
{if(("\\" === ch))
{{
var G__56006 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__56007 = cljs.reader.read_char.call(null,reader);
buffer = G__56006;
ch = G__56007;
continue;
}
...
{{
var G__56008 = (function (){buffer.append(ch);
return buffer;
})();
var G__56009 = cljs.reader.read_char.call(null,reader);
buffer = G__56008;
ch = G__56009;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__56011 = o;if(G__56011)
{var bit__5761__auto__ = (G__56011.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5761__auto__) || (G__56011.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__56011.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__56011);
} else
{return false;
}
}
...
{{
var G__56012 = reader;
var G__56013 = eof_is_error;
var G__56014 = sentinel;
var G__56015 = is_recursive;
reader = G__56012;
eof_is_error = G__56013;
sentinel = G__56014;
is_recursive = G__56015;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__56016 = cljs.reader.read_comment.call(null,reader,ch);
var G__56017 = eof_is_error;
var G__56018 = sentinel;
var G__56019 = is_recursive;
reader = G__56016;
eof_is_error = G__56017;
sentinel = G__56018;
is_recursive = G__56019;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__56020 = reader;
var G__56021 = eof_is_error;
var G__56022 = sentinel;
var G__56023 = is_recursive;
reader = G__56020;
eof_is_error = G__56021;
sentinel = G__56022;
is_recursive = G__56023;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__56026 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__56026,0,null);var years = cljs.core.nth.call(null,vec__56026,1,null);var months = cljs.core.nth.call(null,vec__56026,2,null);var days = cljs.core.nth.call(null,vec__56026,3,null);var hours = cljs.core.nth.call(null,vec__56026,4,null);var minutes = cljs.core.nth.call(null,vec__56026,5,null);var seconds = cljs.core.nth.call(null,vec__56026,6,null);var fraction = cljs.core.nth.call(null,vec__56026,7,null);var offset_sign = cljs.core.nth.call(null,vec__56026,8,null);var offset_hours = cljs.core.nth.call(null,vec__56026,9,null);var offset_minutes = cljs.core.nth.call(null,vec__56026,10,null);var v = vec__56026;if(cljs.core.not.call(null,v))
...
{var vec__56028 = temp__4096__auto__;var years = cljs.core.nth.call(null,vec__56028,0,null);var months = cljs.core.nth.call(null,vec__56028,1,null);var days = cljs.core.nth.call(null,vec__56028,2,null);var hours = cljs.core.nth.call(null,vec__56028,3,null);var minutes = cljs.core.nth.call(null,vec__56028,4,null);var seconds = cljs.core.nth.call(null,vec__56028,5,null);var ms = cljs.core.nth.call(null,vec__56028,6,null);var offset = cljs.core.nth.call(null,vec__56028,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
