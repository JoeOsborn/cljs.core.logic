...
{{
var G__56029 = cljs.core.pop.call(null,v__$1);
v__$1 = G__56029;
continue;
}
} else
...
{var pred__56033 = cljs.core._EQ_;var expr__56034 = limit;if(cljs.core.truth_(pred__56033.call(null,1,expr__56034)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__56033.call(null,2,expr__56034)))
...
var G__56036 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__56037 = (limit__$1 - 1);
var G__56038 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__56036;
limit__$1 = G__56037;
parts = G__56038;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___56040 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___56040))
{var replacement_56041 = temp__4096__auto___56040;buffer.append([cljs.core.str(replacement_56041)].join(''));
} else
{buffer.append(ch);
}
{
var G__56042 = (index + 1);
index = G__56042;
continue;
}
}
