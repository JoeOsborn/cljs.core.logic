...
{{
var G__65838 = cljs.core.pop.call(null,v__$1);
v__$1 = G__65838;
continue;
}
} else
...
{var pred__65842 = cljs.core._EQ_;var expr__65843 = limit;if(pred__65842.call(null,1,expr__65843))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__65842.call(null,2,expr__65843))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__65845 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__65846 = (limit__$1 - 1);
var G__65847 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__65845;
limit__$1 = G__65846;
parts = G__65847;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___65849 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___65849))
{var replacement_65850 = temp__4092__auto___65849;buffer.append([cljs.core.str(replacement_65850)].join(''));
} else
{buffer.append(ch);
}
{
var G__65851 = (index + 1);
index = G__65851;
continue;
}
}
