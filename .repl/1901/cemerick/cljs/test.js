...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__172299 = m;var map__172299__$1 = ((cljs.core.seq_QMARK_.call(null,map__172299))?cljs.core.apply.call(null,cljs.core.hash_map,map__172299):map__172299);var line = cljs.core.get.call(null,map__172299__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__172299__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__172301 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__172301))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__172301))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_172302;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_172303 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_172303;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_172304 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___172305 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___172305))
{var message_172306 = temp__4098__auto___172305;cljs.core.println.call(null,message_172306);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_172304;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_172307 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___172308 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___172308))
{var message_172309 = temp__4098__auto___172308;cljs.core.println.call(null,message_172309);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_172310;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_172311 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__10556__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_172311;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__172312){
var ns_sym = cljs.core.first(arglist__172312);
arglist__172312 = cljs.core.next(arglist__172312);
var fixture_type = cljs.core.first(arglist__172312);
var fixture_fns = cljs.core.rest(arglist__172312);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_172315 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__10556__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__10556__auto__))
{return or__10556__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e172316){if((e172316 instanceof Error))
{var e_172317 = e172316;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_172317], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e172316;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_172315;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__172322 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__172323 = null;var count__172324 = 0;var i__172325 = 0;while(true){
if((i__172325 < count__172324))
{var v = cljs.core._nth.call(null,chunk__172323,i__172325);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__172322,chunk__172323,count__172324,i__172325,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__172322,chunk__172323,count__172324,i__172325,v))
);
} else
{}
{
var G__172326 = seq__172322;
var G__172327 = chunk__172323;
var G__172328 = count__172324;
var G__172329 = (i__172325 + 1);
seq__172322 = G__172326;
chunk__172323 = G__172327;
count__172324 = G__172328;
i__172325 = G__172329;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__172322);if(temp__4098__auto__)
{var seq__172322__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__172322__$1))
{var c__11280__auto__ = cljs.core.chunk_first.call(null,seq__172322__$1);{
var G__172330 = cljs.core.chunk_rest.call(null,seq__172322__$1);
var G__172331 = c__11280__auto__;
var G__172332 = cljs.core.count.call(null,c__11280__auto__);
var G__172333 = 0;
seq__172322 = G__172330;
chunk__172323 = G__172331;
count__172324 = G__172332;
i__172325 = G__172333;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__172322__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__172322,chunk__172323,count__172324,i__172325,v,seq__172322__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__172322,chunk__172323,count__172324,i__172325,v,seq__172322__$1,temp__4098__auto__))
);
} else
{}
{
var G__172334 = cljs.core.next.call(null,seq__172322__$1);
var G__172335 = null;
var G__172336 = 0;
var G__172337 = 0;
seq__172322 = G__172334;
chunk__172323 = G__172335;
count__172324 = G__172336;
i__172325 = G__172337;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_172339 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___172340 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___172340))
{var test_hook_172341 = temp__4096__auto___172340;test_hook_172341.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_172339;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__172342){
var namespaces = cljs.core.seq(arglist__172342);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__172343_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__172343_SHARP_));
