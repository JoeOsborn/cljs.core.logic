...
{{
var G__218291 = cljs.core.pop.call(null,v__$1);
v__$1 = G__218291;
continue;
}
} else
...
{var pred__218295 = cljs.core._EQ_;var expr__218296 = limit;if(pred__218295.call(null,1,expr__218296))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__218295.call(null,2,expr__218296))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__218298 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__218299 = (limit__$1 - 1);
var G__218300 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__218298;
limit__$1 = G__218299;
parts = G__218300;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___218302 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___218302))
{var replacement_218303 = temp__4092__auto___218302;buffer.append([cljs.core.str(replacement_218303)].join(''));
} else
{buffer.append(ch);
}
{
var G__218304 = (index + 1);
index = G__218304;
continue;
}
}
