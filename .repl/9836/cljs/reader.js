...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__4695__auto__ = reader;if(and__4695__auto__)
...
{var x__5300__auto__ = (((reader == null))?null:reader);return (function (){var or__4704__auto__ = (cljs.reader.read_char[goog.typeOf(x__5300__auto__)]);if(or__4704__auto__)
{return or__4704__auto__;
} else
{var or__4704__auto____$1 = (cljs.reader.read_char["_"]);if(or__4704__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__4695__auto__ = reader;if(and__4695__auto__)
...
{var x__5300__auto__ = (((reader == null))?null:reader);return (function (){var or__4704__auto__ = (cljs.reader.unread[goog.typeOf(x__5300__auto__)]);if(or__4704__auto__)
{return or__4704__auto__;
} else
{var or__4704__auto____$1 = (cljs.reader.unread["_"]);if(or__4704__auto____$1)
{return or__4704__auto____$1;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__5241__auto__,writer__5242__auto__,opt__5243__auto__){return cljs.core._write.call(null,writer__5242__auto__,"cljs.reader/StringPushbackReader");
});
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__4704__auto__ = goog.string.isBreakingWhitespace(ch);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return ("," === ch);
}
...
reader_error.cljs$lang$applyTo = (function (arglist__218587){
var rdr = cljs.core.first(arglist__218587);
var msg = cljs.core.rest(arglist__218587);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__4695__auto__ = !((ch === "#"));if(and__4695__auto__)
{var and__4695__auto____$1 = !((ch === "'"));if(and__4695__auto____$1)
{var and__4695__auto____$2 = !((ch === ":"));if(and__4695__auto____$2)
...
{{
var G__218588 = (function (){sb.append(ch);
return sb;
})();
var G__218589 = cljs.reader.read_char.call(null,rdr);
sb = G__218588;
ch = G__218589;
continue;
}
...
{{
var G__218590 = cljs.reader.read_char.call(null,rdr);
ch = G__218590;
continue;
}
} else
...
{var temp__4092__auto__ = cljs.reader.macros.call(null,ch);if(cljs.core.truth_(temp__4092__auto__))
{var macrofn = temp__4092__auto__;var mret = macrofn.call(null,rdr,ch);{
var G__218591 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__218591;
continue;
}
} else
...
var G__218592 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__218592;
continue;
}
}
...
{var temp__4092__auto__ = cljs.reader.maybe_read_tagged_type.call(null,rdr,ch);if(cljs.core.truth_(temp__4092__auto__))
{var obj = temp__4092__auto__;return obj;
} else
...
if(cljs.core.truth_((function (){var or__4704__auto__ = (ch == null);if(or__4704__auto__)
{return or__4704__auto__;
} else
{var or__4704__auto____$1 = cljs.reader.whitespace_QMARK_.call(null,ch);if(or__4704__auto____$1)
{return or__4704__auto____$1;
} else
{return cljs.reader.macros.call(null,ch);
}
...
var s = buffer.toString();var or__4704__auto__ = cljs.reader.match_number.call(null,s);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
...
{{
var G__218593 = (function (){buffer.append(ch);
return buffer;
})();
var G__218594 = cljs.reader.read_char.call(null,reader);
buffer = G__218593;
ch = G__218594;
continue;
}
...
{if(("\\" === ch))
{{
var G__218595 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__218596 = cljs.reader.read_char.call(null,reader);
buffer = G__218595;
ch = G__218596;
continue;
}
...
{{
var G__218597 = (function (){buffer.append(ch);
return buffer;
})();
var G__218598 = cljs.reader.read_char.call(null,reader);
buffer = G__218597;
ch = G__218598;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__218600 = o;if(G__218600)
{var bit__5323__auto__ = (G__218600.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__218600.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__218600.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__218600);
} else
{return false;
}
}
...
{{
var G__218601 = reader;
var G__218602 = eof_is_error;
var G__218603 = sentinel;
var G__218604 = is_recursive;
reader = G__218601;
eof_is_error = G__218602;
sentinel = G__218603;
is_recursive = G__218604;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__218605 = cljs.reader.read_comment.call(null,reader,ch);
var G__218606 = eof_is_error;
var G__218607 = sentinel;
var G__218608 = is_recursive;
reader = G__218605;
eof_is_error = G__218606;
sentinel = G__218607;
is_recursive = G__218608;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__218609 = reader;
var G__218610 = eof_is_error;
var G__218611 = sentinel;
var G__218612 = is_recursive;
reader = G__218609;
eof_is_error = G__218610;
sentinel = G__218611;
is_recursive = G__218612;
continue;
}
} else
{return res;
...
cljs.reader.leap_year_QMARK_ = (function leap_year_QMARK_(year){var and__4695__auto__ = cljs.reader.divisible_QMARK_.call(null,year,4);if(cljs.core.truth_(and__4695__auto__))
{var or__4704__auto__ = cljs.reader.indivisible_QMARK_.call(null,year,100);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__218615 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__218615,0,null);var years = cljs.core.nth.call(null,vec__218615,1,null);var months = cljs.core.nth.call(null,vec__218615,2,null);var days = cljs.core.nth.call(null,vec__218615,3,null);var hours = cljs.core.nth.call(null,vec__218615,4,null);var minutes = cljs.core.nth.call(null,vec__218615,5,null);var seconds = cljs.core.nth.call(null,vec__218615,6,null);var fraction = cljs.core.nth.call(null,vec__218615,7,null);var offset_sign = cljs.core.nth.call(null,vec__218615,8,null);var offset_hours = cljs.core.nth.call(null,vec__218615,9,null);var offset_minutes = cljs.core.nth.call(null,vec__218615,10,null);var v = vec__218615;if(cljs.core.not.call(null,v))
{return cljs.reader.reader_error.call(null,null,[cljs.core.str("Unrecognized date/time syntax: "),cljs.core.str(s)].join(''));
} else
{var years__$1 = cljs.reader.parse_int.call(null,years);var months__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,months);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 1;
}
})();var days__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,days);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 1;
}
})();var hours__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,hours);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 0;
}
})();var minutes__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,minutes);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 0;
}
})();var seconds__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,seconds);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 0;
}
})();var fraction__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,cljs.reader.zero_fill_right_and_truncate.call(null,fraction,3));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 0;
}
})();var offset_sign__$1 = ((cljs.core._EQ_.call(null,offset_sign,"-"))?-1:1);var offset_hours__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,offset_hours);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 0;
}
})();var offset_minutes__$1 = (function (){var or__4704__auto__ = cljs.reader.parse_int.call(null,offset_minutes);if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return 0;
}
...
cljs.reader.parse_timestamp = (function parse_timestamp(ts){var temp__4092__auto__ = cljs.reader.parse_and_validate_timestamp.call(null,ts);if(cljs.core.truth_(temp__4092__auto__))
{var vec__218617 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__218617,0,null);var months = cljs.core.nth.call(null,vec__218617,1,null);var days = cljs.core.nth.call(null,vec__218617,2,null);var hours = cljs.core.nth.call(null,vec__218617,3,null);var minutes = cljs.core.nth.call(null,vec__218617,4,null);var seconds = cljs.core.nth.call(null,vec__218617,5,null);var ms = cljs.core.nth.call(null,vec__218617,6,null);var offset = cljs.core.nth.call(null,vec__218617,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
