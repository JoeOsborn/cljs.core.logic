...
{{
var G__356262 = cljs.core.pop.call(null,v__$1);
v__$1 = G__356262;
continue;
}
} else
...
{var pred__356266 = cljs.core._EQ_;var expr__356267 = limit;if(pred__356266.call(null,1,expr__356267))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__356266.call(null,2,expr__356267))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__356269 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__356270 = (limit__$1 - 1);
var G__356271 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__356269;
limit__$1 = G__356270;
parts = G__356271;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___356273 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___356273))
{var replacement_356274 = temp__4092__auto___356273;buffer.append([cljs.core.str(replacement_356274)].join(''));
} else
{buffer.append(ch);
}
{
var G__356275 = (index + 1);
index = G__356275;
continue;
}
}
