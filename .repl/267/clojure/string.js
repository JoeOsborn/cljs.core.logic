...
{{
var G__148084 = cljs.core.pop.call(null,v__$1);
v__$1 = G__148084;
continue;
}
} else
...
{var pred__148088 = cljs.core._EQ_;var expr__148089 = limit;if(cljs.core.truth_(pred__148088.call(null,1,expr__148089)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__148088.call(null,2,expr__148089)))
...
var G__148091 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__148092 = (limit__$1 - 1);
var G__148093 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__148091;
limit__$1 = G__148092;
parts = G__148093;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___148095 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___148095))
{var replacement_148096 = temp__4096__auto___148095;buffer.append([cljs.core.str(replacement_148096)].join(''));
} else
{buffer.append(ch);
}
{
var G__148097 = (index + 1);
index = G__148097;
continue;
}
}
