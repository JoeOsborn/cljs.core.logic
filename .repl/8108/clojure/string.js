...
{{
var G__9337 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9337;
continue;
}
} else
...
{var pred__9341 = cljs.core._EQ_;var expr__9342 = limit;if(pred__9341.call(null,1,expr__9342))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9341.call(null,2,expr__9342))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9344 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9345 = (limit__$1 - 1);
var G__9346 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9344;
limit__$1 = G__9345;
parts = G__9346;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9348 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9348))
{var replacement_9349 = temp__4092__auto___9348;buffer.append([cljs.core.str(replacement_9349)].join(''));
} else
{buffer.append(ch);
}
{
