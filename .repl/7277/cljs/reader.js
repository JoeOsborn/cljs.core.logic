...
reader_error.cljs$lang$applyTo = (function (arglist__174367){
var rdr = cljs.core.first(arglist__174367);
var msg = cljs.core.rest(arglist__174367);
...
{{
var G__174368 = (function (){sb.append(ch);
return sb;
})();
var G__174369 = cljs.reader.read_char.call(null,rdr);
sb = G__174368;
ch = G__174369;
continue;
}
...
{{
var G__174370 = cljs.reader.read_char.call(null,rdr);
ch = G__174370;
continue;
}
} else
...
var G__174371 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__174371;
continue;
}
} else
...
var G__174372 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__174372;
continue;
}
}
...
{{
var G__174373 = (function (){buffer.append(ch);
return buffer;
})();
var G__174374 = cljs.reader.read_char.call(null,reader);
buffer = G__174373;
ch = G__174374;
continue;
}
...
{if(("\\" === ch))
{{
var G__174375 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__174376 = cljs.reader.read_char.call(null,reader);
buffer = G__174375;
ch = G__174376;
continue;
}
...
{{
var G__174377 = (function (){buffer.append(ch);
return buffer;
})();
var G__174378 = cljs.reader.read_char.call(null,reader);
buffer = G__174377;
ch = G__174378;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__174380 = o;if(G__174380)
{var bit__5323__auto__ = (G__174380.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__174380.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__174380.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__174380);
} else
{return false;
}
}
...
{{
var G__174381 = reader;
var G__174382 = eof_is_error;
var G__174383 = sentinel;
var G__174384 = is_recursive;
reader = G__174381;
eof_is_error = G__174382;
sentinel = G__174383;
is_recursive = G__174384;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__174385 = cljs.reader.read_comment.call(null,reader,ch);
var G__174386 = eof_is_error;
var G__174387 = sentinel;
var G__174388 = is_recursive;
reader = G__174385;
eof_is_error = G__174386;
sentinel = G__174387;
is_recursive = G__174388;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__174389 = reader;
var G__174390 = eof_is_error;
var G__174391 = sentinel;
var G__174392 = is_recursive;
reader = G__174389;
eof_is_error = G__174390;
sentinel = G__174391;
is_recursive = G__174392;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__174395 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__174395,0,null);var years = cljs.core.nth.call(null,vec__174395,1,null);var months = cljs.core.nth.call(null,vec__174395,2,null);var days = cljs.core.nth.call(null,vec__174395,3,null);var hours = cljs.core.nth.call(null,vec__174395,4,null);var minutes = cljs.core.nth.call(null,vec__174395,5,null);var seconds = cljs.core.nth.call(null,vec__174395,6,null);var fraction = cljs.core.nth.call(null,vec__174395,7,null);var offset_sign = cljs.core.nth.call(null,vec__174395,8,null);var offset_hours = cljs.core.nth.call(null,vec__174395,9,null);var offset_minutes = cljs.core.nth.call(null,vec__174395,10,null);var v = vec__174395;if(cljs.core.not.call(null,v))
...
{var vec__174397 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__174397,0,null);var months = cljs.core.nth.call(null,vec__174397,1,null);var days = cljs.core.nth.call(null,vec__174397,2,null);var hours = cljs.core.nth.call(null,vec__174397,3,null);var minutes = cljs.core.nth.call(null,vec__174397,4,null);var seconds = cljs.core.nth.call(null,vec__174397,5,null);var ms = cljs.core.nth.call(null,vec__174397,6,null);var offset = cljs.core.nth.call(null,vec__174397,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
