...
{{
var G__174071 = cljs.core.pop.call(null,v__$1);
v__$1 = G__174071;
continue;
}
} else
...
{var pred__174075 = cljs.core._EQ_;var expr__174076 = limit;if(pred__174075.call(null,1,expr__174076))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__174075.call(null,2,expr__174076))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__174078 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__174079 = (limit__$1 - 1);
var G__174080 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__174078;
limit__$1 = G__174079;
parts = G__174080;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___174082 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___174082))
{var replacement_174083 = temp__4092__auto___174082;buffer.append([cljs.core.str(replacement_174083)].join(''));
} else
{buffer.append(ch);
}
{
var G__174084 = (index + 1);
index = G__174084;
continue;
}
}
