...
{{
var G__117201 = cljs.core.pop.call(null,v__$1);
v__$1 = G__117201;
continue;
}
} else
...
{var pred__117205 = cljs.core._EQ_;var expr__117206 = limit;if(cljs.core.truth_(pred__117205.call(null,1,expr__117206)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__117205.call(null,2,expr__117206)))
...
var G__117208 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__117209 = (limit__$1 - 1);
var G__117210 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__117208;
limit__$1 = G__117209;
parts = G__117210;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___117212 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___117212))
{var replacement_117213 = temp__4096__auto___117212;buffer.append([cljs.core.str(replacement_117213)].join(''));
} else
{buffer.append(ch);
}
{
var G__117214 = (index + 1);
index = G__117214;
continue;
}
}
