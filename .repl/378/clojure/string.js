...
{{
var G__426071 = cljs.core.pop.call(null,v__$1);
v__$1 = G__426071;
continue;
}
} else
...
{var pred__426075 = cljs.core._EQ_;var expr__426076 = limit;if(cljs.core.truth_(pred__426075.call(null,1,expr__426076)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__426075.call(null,2,expr__426076)))
...
var G__426078 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__426079 = (limit__$1 - 1);
var G__426080 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__426078;
limit__$1 = G__426079;
parts = G__426080;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___426082 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___426082))
{var replacement_426083 = temp__4096__auto___426082;buffer.append([cljs.core.str(replacement_426083)].join(''));
} else
{buffer.append(ch);
}
{
var G__426084 = (index + 1);
index = G__426084;
continue;
}
}
