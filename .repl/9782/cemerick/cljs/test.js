...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__193781 = m;var map__193781__$1 = ((cljs.core.seq_QMARK_.call(null,map__193781))?cljs.core.apply.call(null,cljs.core.hash_map,map__193781):map__193781);var line = cljs.core.get.call(null,map__193781__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__193781__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__193783 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__193783))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__193783))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_193784;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_193785 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_193785;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_193786 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___193787 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___193787))
{var message_193788 = temp__4094__auto___193787;cljs.core.println.call(null,message_193788);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_193786;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_193789 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___193790 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___193790))
{var message_193791 = temp__4094__auto___193790;cljs.core.println.call(null,message_193791);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_193792;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_193793 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_193793;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__193794){
var ns_sym = cljs.core.first(arglist__193794);
arglist__193794 = cljs.core.next(arglist__193794);
var fixture_type = cljs.core.first(arglist__193794);
var fixture_fns = cljs.core.rest(arglist__193794);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_193797 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__4704__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return v;
}
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_193797;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__193804 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__193805 = null;var count__193806 = 0;var i__193807 = 0;while(true){
if((i__193807 < count__193806))
{var v = cljs.core._nth.call(null,chunk__193805,i__193807);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__193804,chunk__193805,count__193806,i__193807,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__193804,chunk__193805,count__193806,i__193807,v))
);
} else
{}
{
var G__193808 = seq__193804;
var G__193809 = chunk__193805;
var G__193810 = count__193806;
var G__193811 = (i__193807 + 1);
seq__193804 = G__193808;
chunk__193805 = G__193809;
count__193806 = G__193810;
i__193807 = G__193811;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__193804);if(temp__4094__auto__)
{var seq__193804__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__193804__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__193804__$1);{
var G__193812 = cljs.core.chunk_rest.call(null,seq__193804__$1);
var G__193813 = c__5421__auto__;
var G__193814 = cljs.core.count.call(null,c__5421__auto__);
var G__193815 = 0;
seq__193804 = G__193812;
chunk__193805 = G__193813;
count__193806 = G__193814;
i__193807 = G__193815;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__193804__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__193804,chunk__193805,count__193806,i__193807,v,seq__193804__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__193804,chunk__193805,count__193806,i__193807,v,seq__193804__$1,temp__4094__auto__))
);
} else
{}
{
var G__193816 = cljs.core.next.call(null,seq__193804__$1);
var G__193817 = null;
var G__193818 = 0;
var G__193819 = 0;
seq__193804 = G__193816;
chunk__193805 = G__193817;
count__193806 = G__193818;
i__193807 = G__193819;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_193821 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___193822 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___193822))
{var test_hook_193823 = temp__4092__auto___193822;test_hook_193823.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_193821;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__193824){
var namespaces = cljs.core.seq(arglist__193824);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__193825_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__193825_SHARP_));
