...
{{
var G__193453 = cljs.core.pop.call(null,v__$1);
v__$1 = G__193453;
continue;
}
} else
...
{var pred__193457 = cljs.core._EQ_;var expr__193458 = limit;if(pred__193457.call(null,1,expr__193458))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__193457.call(null,2,expr__193458))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__193460 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__193461 = (limit__$1 - 1);
var G__193462 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__193460;
limit__$1 = G__193461;
parts = G__193462;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___193464 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___193464))
{var replacement_193465 = temp__4092__auto___193464;buffer.append([cljs.core.str(replacement_193465)].join(''));
} else
{buffer.append(ch);
}
{
var G__193466 = (index + 1);
index = G__193466;
continue;
}
}
