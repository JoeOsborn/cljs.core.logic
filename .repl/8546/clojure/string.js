...
{{
var G__350670 = cljs.core.pop.call(null,v__$1);
v__$1 = G__350670;
continue;
}
} else
...
{var pred__350674 = cljs.core._EQ_;var expr__350675 = limit;if(pred__350674.call(null,1,expr__350675))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__350674.call(null,2,expr__350675))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__350677 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__350678 = (limit__$1 - 1);
var G__350679 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__350677;
limit__$1 = G__350678;
parts = G__350679;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___350681 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___350681))
{var replacement_350682 = temp__4092__auto___350681;buffer.append([cljs.core.str(replacement_350682)].join(''));
} else
{buffer.append(ch);
}
{
var G__350683 = (index + 1);
index = G__350683;
continue;
}
}
