...
cljs.core.PersistentVector.prototype.cljs$core$logic$nominal$INomSwap$swap_noms$arity$3 = (function (t,swap,s){var t__$1 = this;var vec__350997 = cljs.core.logic.nominal.swap_noms.call(null,cljs.core.seq.call(null,t__$1),swap,s);var ts = cljs.core.nth.call(null,vec__350997,0,null);var s__$1 = cljs.core.nth.call(null,vec__350997,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.vec.call(null,ts),s__$1], true);
});
cljs.core.logic.LCons.prototype.cljs$core$logic$nominal$INomSwap$ = true;
cljs.core.logic.LCons.prototype.cljs$core$logic$nominal$INomSwap$swap_noms$arity$3 = (function (t,swap,s){var t__$1 = this;var vec__350998 = cljs.core.logic.nominal.swap_noms.call(null,cljs.core.logic.nominal.lfirst.call(null,t__$1),swap,s);var tfirst = cljs.core.nth.call(null,vec__350998,0,null);var s__$1 = cljs.core.nth.call(null,vec__350998,1,null);var vec__350999 = cljs.core.logic.nominal.swap_noms.call(null,cljs.core.logic.nominal.lnext.call(null,t__$1),swap,s__$1);var tnext = cljs.core.nth.call(null,vec__350999,0,null);var s__$2 = cljs.core.nth.call(null,vec__350999,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.with_meta.call(null,cljs.core.logic.lcons.call(null,tfirst,tnext),cljs.core.meta.call(null,t__$1)),s__$2], true);
});
...
{var vec__351000 = cljs.core.logic.nominal.swap_noms.call(null,cljs.core.first.call(null,t),swap,s);var tfirst = cljs.core.nth.call(null,vec__351000,0,null);var s__$1 = cljs.core.nth.call(null,vec__351000,1,null);var vec__351001 = cljs.core.logic.nominal.swap_noms.call(null,cljs.core.next.call(null,t),swap,s__$1);var tnext = cljs.core.nth.call(null,vec__351001,0,null);var s__$2 = cljs.core.nth.call(null,vec__351001,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.with_meta.call(null,cljs.core.cons.call(null,tfirst,tnext),cljs.core.meta.call(null,t)),s__$2], true);
} else
{return cljs.core.PersistentVector.fromArray([t,s], true);
}
} else
{if(cljs.core.map_QMARK_.call(null,t))
{var vec__351002 = cljs.core.logic.nominal.swap_noms.call(null,cljs.core.seq.call(null,t),swap,s);var tkvs = cljs.core.nth.call(null,vec__351002,0,null);var s__$1 = cljs.core.nth.call(null,vec__351002,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,tkvs),s__$1], true);
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.PersistentVector.fromArray([t,s], true);
} else
...
var ___$1 = this;var G__351003 = k;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"oname","oname",1119788780),G__351003))
{return new cljs.core.Keyword(null,"oname","oname",1119788780).cljs$core$IFn$_invoke$arity$1(self__.lvar);
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"name","name",1017277949),G__351003))
{return new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(self__.lvar);
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"lvar","lvar",1017238189),G__351003))
{return self__.lvar;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return not_found;
...
cljs.core.logic.nominal._hash = (function _hash(a,x){if(typeof cljs.core.logic.nominal.t351011 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.logic.nominal.t351011 = (function (x,a,_hash,meta351012){
this.x = x;
this.a = a;
this._hash = _hash;
this.meta351012 = meta351012;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
cljs.core.logic.nominal.t351011.cljs$lang$type = true;
cljs.core.logic.nominal.t351011.cljs$lang$ctorStr = "cljs.core.logic.nominal/t351011";
cljs.core.logic.nominal.t351011.cljs$lang$ctorPrWriter = (function (this__5241__auto__,writer__5242__auto__,opt__5243__auto__){return cljs.core._write.call(null,writer__5242__auto__,"cljs.core.logic.nominal/t351011");
});
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IConstraintWatchedStores$ = true;
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IConstraintWatchedStores$_watched_stores$arity$1 = (function (this$){var self__ = this;
...
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IReifiableConstraint$ = true;
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IReifiableConstraint$_reifyc$arity$4 = (function (_,v,r,s){var self__ = this;
...
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IConstraintOp$ = true;
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IConstraintOp$_rator$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return cljs.core.with_meta.call(null,new cljs.core.Symbol("cljs.core.logic.nominal","hash","cljs.core.logic.nominal/hash",99352748,null),cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Keyword(null,"line","line",1017226086)),cljs.core._conj.call(null,cljs.core.List.EMPTY,187),cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Keyword(null,"column","column",3954034376)),cljs.core._conj.call(null,cljs.core.List.EMPTY,18)))));
});
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IConstraintOp$_rands$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return cljs.core.PersistentVector.fromArray([self__.a,self__.x], true);
});
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IConstraintStep$ = true;
cljs.core.logic.nominal.t351011.prototype.cljs$core$logic$protocols$IConstraintStep$_step$arity$2 = (function (this$,s){var self__ = this;
var this$__$1 = this;var a__$2 = cljs.core.logic.protocols.walk.call(null,s,self__.a);var x__$2 = cljs.core.logic.protocols.walk.call(null,s,self__.x);if(typeof cljs.core.logic.nominal.t351014 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.logic.nominal.t351014 = (function (s,this$,meta351012,x,a,_hash,meta351015){
this.s = s;
this.this$ = this$;
this.meta351012 = meta351012;
this.x = x;
this.a = a;
this._hash = _hash;
this.meta351015 = meta351015;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393217;
})
cljs.core.logic.nominal.t351014.cljs$lang$type = true;
cljs.core.logic.nominal.t351014.cljs$lang$ctorStr = "cljs.core.logic.nominal/t351014";
cljs.core.logic.nominal.t351014.cljs$lang$ctorPrWriter = (function (this__5241__auto__,writer__5242__auto__,opt__5243__auto__){return cljs.core._write.call(null,writer__5242__auto__,"cljs.core.logic.nominal/t351014");
});
cljs.core.logic.nominal.t351014.prototype.cljs$core$logic$protocols$IRunnable$ = true;
cljs.core.logic.nominal.t351014.prototype.cljs$core$logic$protocols$IRunnable$_runnable_QMARK_$arity$1 = (function (_){var self__ = this;
...
cljs.core.logic.nominal.t351014.prototype.call = (function (self__,s__$2){var self__ = this;
var self____$1 = this;var _ = self____$1;return cljs.core.logic.composeg.call(null,cljs.core.logic.remcg.call(null,self__.this$),(function (s__$3){if(cljs.core.truth_((function (){var and__4695__auto__ = cljs.core.logic.lvar_QMARK_.call(null,self__.a);if(cljs.core.truth_(and__4695__auto__))
...
cljs.core.logic.nominal.t351014.prototype.apply = (function (self__,args351017){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(args351017.slice()));
});
cljs.core.logic.nominal.t351014.prototype.cljs$core$IFn$_invoke$arity$1 = (function (s__$2){var self__ = this;
var _ = this;return cljs.core.logic.composeg.call(null,cljs.core.logic.remcg.call(null,self__.this$),(function (s__$3){if(cljs.core.truth_((function (){var and__4695__auto__ = cljs.core.logic.lvar_QMARK_.call(null,self__.a);if(cljs.core.truth_(and__4695__auto__))
{var and__4695__auto____$1 = cljs.core.logic.lvar_QMARK_.call(null,self__.x);if(cljs.core.truth_(and__4695__auto____$1))
{return cljs.core._EQ_.call(null,self__.x,self__.a);
} else
{return and__4695__auto____$1;
...
cljs.core.logic.nominal.t351014.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_351016){var self__ = this;
var _351016__$1 = this;return self__.meta351015;
});
cljs.core.logic.nominal.t351014.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_351016,meta351015__$1){var self__ = this;
var _351016__$1 = this;return (new cljs.core.logic.nominal.t351014(self__.s,self__.this$,self__.meta351012,self__.x,self__.a,self__._hash,meta351015__$1));
});
cljs.core.logic.nominal.__GT_t351014 = (function __GT_t351014(s__$1,this$__$2,meta351012__$1,x__$3,a__$3,_hash__$2,meta351015){return (new cljs.core.logic.nominal.t351014(s__$1,this$__$2,meta351012__$1,x__$3,a__$3,_hash__$2,meta351015));
});
}
return (new cljs.core.logic.nominal.t351014(s,this$__$1,self__.meta351012,x__$2,a__$2,self__._hash,null));
});
cljs.core.logic.nominal.t351011.prototype.toString = (function (){var self__ = this;
var _ = this;return [cljs.core.str(self__.a),cljs.core.str("#"),cljs.core.str(self__.x)].join('');
});
cljs.core.logic.nominal.t351011.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_351013){var self__ = this;
var _351013__$1 = this;return self__.meta351012;
});
cljs.core.logic.nominal.t351011.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_351013,meta351012__$1){var self__ = this;
var _351013__$1 = this;return (new cljs.core.logic.nominal.t351011(self__.x,self__.a,self__._hash,meta351012__$1));
});
cljs.core.logic.nominal.__GT_t351011 = (function __GT_t351011(x__$1,a__$1,_hash__$1,meta351012){return (new cljs.core.logic.nominal.t351011(x__$1,a__$1,_hash__$1,meta351012));
});
}
return (new cljs.core.logic.nominal.t351011(x,a,_hash,null));
});
...
return (function (p1__351018_SHARP_){return cljs.core.logic.occurs_check.call(null,a,p1__351018_SHARP_,t1);
});})(vs,seen,vs__$1))
,vs__$1)))
{return false;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{{
var G__351021 = cljs.core.reduce.call(null,((function (vs,seen,vs__$1){
...
var G__351022 = clojure.set.union.call(null,vs__$1,seen);
vs = G__351021;
seen = G__351022;
continue;
}
...
{var vec__351020 = cljs.core.logic.nominal.swap_noms.call(null,t1,swap,a);var t1__$1 = cljs.core.nth.call(null,vec__351020,0,null);var a__$1 = cljs.core.nth.call(null,vec__351020,1,null);return cljs.core.logic._EQ__EQ_.call(null,t1__$1,t2).call(null,a__$1);
} else
{return null;
}
});
cljs.core.logic.nominal._suspc = (function _suspc(v1,v2,swap){if(typeof cljs.core.logic.nominal.t351030 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.logic.nominal.t351030 = (function (swap,v2,v1,_suspc,meta351031){
this.swap = swap;
this.v2 = v2;
this.v1 = v1;
this._suspc = _suspc;
this.meta351031 = meta351031;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
cljs.core.logic.nominal.t351030.cljs$lang$type = true;
cljs.core.logic.nominal.t351030.cljs$lang$ctorStr = "cljs.core.logic.nominal/t351030";
cljs.core.logic.nominal.t351030.cljs$lang$ctorPrWriter = (function (this__5241__auto__,writer__5242__auto__,opt__5243__auto__){return cljs.core._write.call(null,writer__5242__auto__,"cljs.core.logic.nominal/t351030");
});
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IConstraintWatchedStores$ = true;
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IConstraintWatchedStores$_watched_stores$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;return cljs.core.PersistentHashSet.fromArray([new cljs.core.Keyword("cljs.core.logic","subst","cljs.core.logic/subst",3549233440),null], true);
});
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IReifiableConstraint$ = true;
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IReifiableConstraint$_reifyc$arity$4 = (function (c,v,r,a){var self__ = this;
var c__$1 = this;var t1 = cljs.core.logic.walk_STAR_.call(null,r,cljs.core.logic.walk_STAR_.call(null,a,self__.v1));var t2 = cljs.core.logic.walk_STAR_.call(null,r,cljs.core.logic.walk_STAR_.call(null,a,self__.v2));var swap__$2 = cljs.core.logic.walk_STAR_.call(null,r,self__.swap);if((cljs.core.not.call(null,cljs.core.logic.lvar_QMARK_.call(null,t1))) && (cljs.core.not.call(null,cljs.core.logic.lvar_QMARK_.call(null,t2))) && ((cljs.core.first.call(null,swap__$2) instanceof cljs.core.Symbol)) && ((cljs.core.second.call(null,swap__$2) instanceof cljs.core.Symbol)))
{return cljs.core.with_meta.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Symbol(null,"swap","swap",-1636988084,null)),cljs.core._conj.call(null,cljs.core.List.EMPTY,swap__$2),cljs.core._conj.call(null,cljs.core.List.EMPTY,t1),cljs.core._conj.call(null,cljs.core.List.EMPTY,t2))),cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Keyword(null,"line","line",1017226086)),cljs.core._conj.call(null,cljs.core.List.EMPTY,260),cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Keyword(null,"column","column",3954034376)),cljs.core._conj.call(null,cljs.core.List.EMPTY,12)))));
} else
{return null;
}
});
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IConstraintOp$ = true;
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IConstraintOp$_rator$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return cljs.core.with_meta.call(null,new cljs.core.Symbol("cljs.core.logic.nominal","suspc","cljs.core.logic.nominal/suspc",54642610,null),cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Keyword(null,"line","line",1017226086)),cljs.core._conj.call(null,cljs.core.List.EMPTY,248),cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Keyword(null,"column","column",3954034376)),cljs.core._conj.call(null,cljs.core.List.EMPTY,18)))));
});
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IConstraintOp$_rands$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return cljs.core.PersistentVector.fromArray([self__.v1,self__.v2], true);
});
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IConstraintStep$ = true;
cljs.core.logic.nominal.t351030.prototype.cljs$core$logic$protocols$IConstraintStep$_step$arity$2 = (function (this$,a){var self__ = this;
var this$__$1 = this;var t1 = cljs.core.logic.protocols.walk.call(null,a,self__.v1);var t2 = cljs.core.logic.protocols.walk.call(null,a,self__.v2);if(typeof cljs.core.logic.nominal.t351033 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.logic.nominal.t351033 = (function (t2,t1,a,this$,meta351031,swap,v2,v1,_suspc,meta351034){
this.t2 = t2;
this.t1 = t1;
this.a = a;
this.this$ = this$;
...
this.v1 = v1;
this._suspc = _suspc;
this.meta351034 = meta351034;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393217;
})
cljs.core.logic.nominal.t351033.cljs$lang$type = true;
cljs.core.logic.nominal.t351033.cljs$lang$ctorStr = "cljs.core.logic.nominal/t351033";
cljs.core.logic.nominal.t351033.cljs$lang$ctorPrWriter = (function (this__5241__auto__,writer__5242__auto__,opt__5243__auto__){return cljs.core._write.call(null,writer__5242__auto__,"cljs.core.logic.nominal/t351033");
});
cljs.core.logic.nominal.t351033.prototype.cljs$core$logic$protocols$IRunnable$ = true;
cljs.core.logic.nominal.t351033.prototype.cljs$core$logic$protocols$IRunnable$_runnable_QMARK_$arity$1 = (function (_){var self__ = this;
...
cljs.core.logic.nominal.t351033.prototype.call = (function (self__,a__$2){var self__ = this;
...
{{
var G__351037 = cljs.core.rest.call(null,a_STAR_);
var G__351038 = cljs.core.logic.nominal.hash.call(null,cljs.core.first.call(null,a_STAR_),self__.t2).call(null,a__$4);
a_STAR_ = G__351037;
a__$4 = G__351038;
continue;
}
...
cljs.core.logic.nominal.t351033.prototype.apply = (function (self__,args351036){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(args351036.slice()));
});
cljs.core.logic.nominal.t351033.prototype.cljs$core$IFn$_invoke$arity$1 = (function (a__$2){var self__ = this;
...
{{
var G__351039 = cljs.core.rest.call(null,a_STAR_);
var G__351040 = cljs.core.logic.nominal.hash.call(null,cljs.core.first.call(null,a_STAR_),self__.t2).call(null,a__$4);
a_STAR_ = G__351039;
a__$4 = G__351040;
continue;
}
...
cljs.core.logic.nominal.t351033.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_351035){var self__ = this;
var _351035__$1 = this;return self__.meta351034;
});
cljs.core.logic.nominal.t351033.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_351035,meta351034__$1){var self__ = this;
var _351035__$1 = this;return (new cljs.core.logic.nominal.t351033(self__.t2,self__.t1,self__.a,self__.this$,self__.meta351031,self__.swap,self__.v2,self__.v1,self__._suspc,meta351034__$1));
});
cljs.core.logic.nominal.__GT_t351033 = (function __GT_t351033(t2__$1,t1__$1,a__$1,this$__$2,meta351031__$1,swap__$2,v2__$2,v1__$2,_suspc__$2,meta351034){return (new cljs.core.logic.nominal.t351033(t2__$1,t1__$1,a__$1,this$__$2,meta351031__$1,swap__$2,v2__$2,v1__$2,_suspc__$2,meta351034));
});
}
return (new cljs.core.logic.nominal.t351033(t2,t1,a,this$__$1,self__.meta351031,self__.swap,self__.v2,self__.v1,self__._suspc,null));
});
cljs.core.logic.nominal.t351030.prototype.toString = (function (){var self__ = this;
var _ = this;return [cljs.core.str("suspc"),cljs.core.str(self__.v1),cljs.core.str(self__.v2),cljs.core.str(self__.swap)].join('');
});
cljs.core.logic.nominal.t351030.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_351032){var self__ = this;
var _351032__$1 = this;return self__.meta351031;
});
cljs.core.logic.nominal.t351030.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_351032,meta351031__$1){var self__ = this;
var _351032__$1 = this;return (new cljs.core.logic.nominal.t351030(self__.swap,self__.v2,self__.v1,self__._suspc,meta351031__$1));
});
cljs.core.logic.nominal.__GT_t351030 = (function __GT_t351030(swap__$1,v2__$1,v1__$1,_suspc__$1,meta351031){return (new cljs.core.logic.nominal.t351030(swap__$1,v2__$1,v1__$1,_suspc__$1,meta351031));
});
}
return (new cljs.core.logic.nominal.t351030(swap,v2,v1,_suspc,null));
});
...
var t__$1 = this;var vec__351044 = cljs.core.logic.nominal.swap_noms.call(null,new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(t__$1),swap,s);var tbody = cljs.core.nth.call(null,vec__351044,0,null);var s__$1 = cljs.core.nth.call(null,vec__351044,1,null);return cljs.core.PersistentVector.fromArray([cljs.core.with_meta.call(null,cljs.core.logic.nominal.tie.call(null,cljs.core.logic.nominal.nom_swap.call(null,new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822).cljs$core$IFn$_invoke$arity$1(t__$1),swap),tbody),cljs.core.meta.call(null,t__$1)),s__$1], true);
});
...
{var vec__351045 = cljs.core.logic.nominal.swap_noms.call(null,new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(v__$1),cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822).cljs$core$IFn$_invoke$arity$1(v__$1),new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822).cljs$core$IFn$_invoke$arity$1(u)], true),s);var t = cljs.core.nth.call(null,vec__351045,0,null);var s__$1 = cljs.core.nth.call(null,vec__351045,1,null);return cljs.core.logic.composeg.call(null,cljs.core.logic.nominal.hash.call(null,new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822).cljs$core$IFn$_invoke$arity$1(u),new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(v__$1)),cljs.core.logic._EQ__EQ_.call(null,t,new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(u))).call(null,s__$1);
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return null;
...
cljs.core.logic.nominal.Tie.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5261__auto__,k351042,else__5262__auto__){var self__ = this;
var this__5261__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k351042,new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822)))
{return self__.binding_nom;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k351042,new cljs.core.Keyword(null,"body","body",1016933652)))
{return self__.body;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k351042,else__5262__auto__);
} else
{return null;
}
}
...
cljs.core.logic.nominal.Tie.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5266__auto__,k__5267__auto__,G__351041){var self__ = this;
var this__5266__auto____$1 = this;var pred__351046 = cljs.core.keyword_identical_QMARK_;var expr__351047 = k__5267__auto__;if(pred__351046.call(null,new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822),expr__351047))
{return (new cljs.core.logic.nominal.Tie(G__351041,self__.body,self__.__meta,self__.__extmap,null));
} else
{if(pred__351046.call(null,new cljs.core.Keyword(null,"body","body",1016933652),expr__351047))
{return (new cljs.core.logic.nominal.Tie(self__.binding_nom,G__351041,self__.__meta,self__.__extmap,null));
} else
{return (new cljs.core.logic.nominal.Tie(self__.binding_nom,self__.body,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__5267__auto__,G__351041),null));
}
}
});
...
cljs.core.logic.nominal.Tie.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5258__auto__,G__351041){var self__ = this;
var this__5258__auto____$1 = this;return (new cljs.core.logic.nominal.Tie(self__.binding_nom,self__.body,G__351041,self__.__extmap,self__.__hash));
});
...
cljs.core.logic.nominal.map__GT_Tie = (function map__GT_Tie(G__351043){return (new cljs.core.logic.nominal.Tie(new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822).cljs$core$IFn$_invoke$arity$1(G__351043),new cljs.core.Keyword(null,"body","body",1016933652).cljs$core$IFn$_invoke$arity$1(G__351043),null,cljs.core.dissoc.call(null,G__351043,new cljs.core.Keyword(null,"binding-nom","binding-nom",727512822),new cljs.core.Keyword(null,"body","body",1016933652))));
});
