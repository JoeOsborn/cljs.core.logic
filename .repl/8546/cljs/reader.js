...
reader_error.cljs$lang$applyTo = (function (arglist__350966){
var rdr = cljs.core.first(arglist__350966);
var msg = cljs.core.rest(arglist__350966);
...
{{
var G__350967 = (function (){sb.append(ch);
return sb;
})();
var G__350968 = cljs.reader.read_char.call(null,rdr);
sb = G__350967;
ch = G__350968;
continue;
}
...
{{
var G__350969 = cljs.reader.read_char.call(null,rdr);
ch = G__350969;
continue;
}
} else
...
var G__350970 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__350970;
continue;
}
} else
...
var G__350971 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__350971;
continue;
}
}
...
{{
var G__350972 = (function (){buffer.append(ch);
return buffer;
})();
var G__350973 = cljs.reader.read_char.call(null,reader);
buffer = G__350972;
ch = G__350973;
continue;
}
...
{if(("\\" === ch))
{{
var G__350974 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__350975 = cljs.reader.read_char.call(null,reader);
buffer = G__350974;
ch = G__350975;
continue;
}
...
{{
var G__350976 = (function (){buffer.append(ch);
return buffer;
})();
var G__350977 = cljs.reader.read_char.call(null,reader);
buffer = G__350976;
ch = G__350977;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__350979 = o;if(G__350979)
{var bit__5323__auto__ = (G__350979.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__350979.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__350979.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__350979);
} else
{return false;
}
}
...
{{
var G__350980 = reader;
var G__350981 = eof_is_error;
var G__350982 = sentinel;
var G__350983 = is_recursive;
reader = G__350980;
eof_is_error = G__350981;
sentinel = G__350982;
is_recursive = G__350983;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__350984 = cljs.reader.read_comment.call(null,reader,ch);
var G__350985 = eof_is_error;
var G__350986 = sentinel;
var G__350987 = is_recursive;
reader = G__350984;
eof_is_error = G__350985;
sentinel = G__350986;
is_recursive = G__350987;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__350988 = reader;
var G__350989 = eof_is_error;
var G__350990 = sentinel;
var G__350991 = is_recursive;
reader = G__350988;
eof_is_error = G__350989;
sentinel = G__350990;
is_recursive = G__350991;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__350994 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__350994,0,null);var years = cljs.core.nth.call(null,vec__350994,1,null);var months = cljs.core.nth.call(null,vec__350994,2,null);var days = cljs.core.nth.call(null,vec__350994,3,null);var hours = cljs.core.nth.call(null,vec__350994,4,null);var minutes = cljs.core.nth.call(null,vec__350994,5,null);var seconds = cljs.core.nth.call(null,vec__350994,6,null);var fraction = cljs.core.nth.call(null,vec__350994,7,null);var offset_sign = cljs.core.nth.call(null,vec__350994,8,null);var offset_hours = cljs.core.nth.call(null,vec__350994,9,null);var offset_minutes = cljs.core.nth.call(null,vec__350994,10,null);var v = vec__350994;if(cljs.core.not.call(null,v))
...
{var vec__350996 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__350996,0,null);var months = cljs.core.nth.call(null,vec__350996,1,null);var days = cljs.core.nth.call(null,vec__350996,2,null);var hours = cljs.core.nth.call(null,vec__350996,3,null);var minutes = cljs.core.nth.call(null,vec__350996,4,null);var seconds = cljs.core.nth.call(null,vec__350996,5,null);var ms = cljs.core.nth.call(null,vec__350996,6,null);var offset = cljs.core.nth.call(null,vec__350996,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
