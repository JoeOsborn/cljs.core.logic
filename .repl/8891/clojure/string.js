...
{{
var G__9662 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9662;
continue;
}
} else
...
{var pred__9666 = cljs.core._EQ_;var expr__9667 = limit;if(pred__9666.call(null,1,expr__9667))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9666.call(null,2,expr__9667))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9669 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9670 = (limit__$1 - 1);
var G__9671 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9669;
limit__$1 = G__9670;
parts = G__9671;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9673 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9673))
{var replacement_9674 = temp__4092__auto___9673;buffer.append([cljs.core.str(replacement_9674)].join(''));
} else
{buffer.append(ch);
}
{
