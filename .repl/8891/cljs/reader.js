...
reader_error.cljs$lang$applyTo = (function (arglist__9631){
var rdr = cljs.core.first(arglist__9631);
var msg = cljs.core.rest(arglist__9631);
...
{{
var G__9632 = (function (){sb.append(ch);
return sb;
})();
var G__9633 = cljs.reader.read_char.call(null,rdr);
sb = G__9632;
ch = G__9633;
continue;
}
...
{{
var G__9634 = cljs.reader.read_char.call(null,rdr);
ch = G__9634;
continue;
}
} else
...
var G__9635 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9635;
continue;
}
} else
...
var G__9636 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9636;
continue;
}
}
...
{{
var G__9637 = (function (){buffer.append(ch);
return buffer;
})();
var G__9638 = cljs.reader.read_char.call(null,reader);
buffer = G__9637;
ch = G__9638;
continue;
}
...
{if(("\\" === ch))
{{
var G__9639 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9640 = cljs.reader.read_char.call(null,reader);
buffer = G__9639;
ch = G__9640;
continue;
}
...
{{
var G__9641 = (function (){buffer.append(ch);
return buffer;
})();
var G__9642 = cljs.reader.read_char.call(null,reader);
buffer = G__9641;
ch = G__9642;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9644 = o;if(G__9644)
{var bit__5323__auto__ = (G__9644.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9644.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9644.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9644);
} else
{return false;
}
}
...
{{
var G__9645 = reader;
var G__9646 = eof_is_error;
var G__9647 = sentinel;
var G__9648 = is_recursive;
reader = G__9645;
eof_is_error = G__9646;
sentinel = G__9647;
is_recursive = G__9648;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9649 = cljs.reader.read_comment.call(null,reader,ch);
var G__9650 = eof_is_error;
var G__9651 = sentinel;
var G__9652 = is_recursive;
reader = G__9649;
eof_is_error = G__9650;
sentinel = G__9651;
is_recursive = G__9652;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9653 = reader;
var G__9654 = eof_is_error;
var G__9655 = sentinel;
var G__9656 = is_recursive;
reader = G__9653;
eof_is_error = G__9654;
sentinel = G__9655;
is_recursive = G__9656;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9659 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9659,0,null);var years = cljs.core.nth.call(null,vec__9659,1,null);var months = cljs.core.nth.call(null,vec__9659,2,null);var days = cljs.core.nth.call(null,vec__9659,3,null);var hours = cljs.core.nth.call(null,vec__9659,4,null);var minutes = cljs.core.nth.call(null,vec__9659,5,null);var seconds = cljs.core.nth.call(null,vec__9659,6,null);var fraction = cljs.core.nth.call(null,vec__9659,7,null);var offset_sign = cljs.core.nth.call(null,vec__9659,8,null);var offset_hours = cljs.core.nth.call(null,vec__9659,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9659,10,null);var v = vec__9659;if(cljs.core.not.call(null,v))
...
{var vec__9661 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9661,0,null);var months = cljs.core.nth.call(null,vec__9661,1,null);var days = cljs.core.nth.call(null,vec__9661,2,null);var hours = cljs.core.nth.call(null,vec__9661,3,null);var minutes = cljs.core.nth.call(null,vec__9661,4,null);var seconds = cljs.core.nth.call(null,vec__9661,5,null);var ms = cljs.core.nth.call(null,vec__9661,6,null);var offset = cljs.core.nth.call(null,vec__9661,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
