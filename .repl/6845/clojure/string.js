...
{{
var G__638970 = cljs.core.pop.call(null,v__$1);
v__$1 = G__638970;
continue;
}
} else
...
{var pred__638974 = cljs.core._EQ_;var expr__638975 = limit;if(cljs.core.truth_(pred__638974.call(null,1,expr__638975)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__638974.call(null,2,expr__638975)))
...
var G__638977 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__638978 = (limit__$1 - 1);
var G__638979 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__638977;
limit__$1 = G__638978;
parts = G__638979;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___638981 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___638981))
{var replacement_638982 = temp__4096__auto___638981;buffer.append([cljs.core.str(replacement_638982)].join(''));
} else
{buffer.append(ch);
}
{
var G__638983 = (index + 1);
index = G__638983;
continue;
}
}
