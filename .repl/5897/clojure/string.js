...
{{
var G__10158 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10158;
continue;
}
} else
...
{var pred__10162 = cljs.core._EQ_;var expr__10163 = limit;if(pred__10162.call(null,1,expr__10163))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10162.call(null,2,expr__10163))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10165 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10166 = (limit__$1 - 1);
var G__10167 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10165;
limit__$1 = G__10166;
parts = G__10167;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10169 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10169))
{var replacement_10170 = temp__4092__auto___10169;buffer.append([cljs.core.str(replacement_10170)].join(''));
} else
{buffer.append(ch);
}
{
var G__10171 = (index + 1);
index = G__10171;
continue;
}
}
