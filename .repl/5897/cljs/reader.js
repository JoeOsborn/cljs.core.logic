...
reader_error.cljs$lang$applyTo = (function (arglist__10454){
var rdr = cljs.core.first(arglist__10454);
var msg = cljs.core.rest(arglist__10454);
...
{{
var G__10455 = (function (){sb.append(ch);
return sb;
})();
var G__10456 = cljs.reader.read_char.call(null,rdr);
sb = G__10455;
ch = G__10456;
continue;
}
...
{{
var G__10457 = cljs.reader.read_char.call(null,rdr);
ch = G__10457;
continue;
}
} else
...
var G__10458 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10458;
continue;
}
} else
...
var G__10459 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10459;
continue;
}
}
...
{{
var G__10460 = (function (){buffer.append(ch);
return buffer;
})();
var G__10461 = cljs.reader.read_char.call(null,reader);
buffer = G__10460;
ch = G__10461;
continue;
}
...
{if(("\\" === ch))
{{
var G__10462 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10463 = cljs.reader.read_char.call(null,reader);
buffer = G__10462;
ch = G__10463;
continue;
}
...
{{
var G__10464 = (function (){buffer.append(ch);
return buffer;
})();
var G__10465 = cljs.reader.read_char.call(null,reader);
buffer = G__10464;
ch = G__10465;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10467 = o;if(G__10467)
{var bit__5323__auto__ = (G__10467.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__10467.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10467.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10467);
} else
{return false;
}
}
...
{{
var G__10468 = reader;
var G__10469 = eof_is_error;
var G__10470 = sentinel;
var G__10471 = is_recursive;
reader = G__10468;
eof_is_error = G__10469;
sentinel = G__10470;
is_recursive = G__10471;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10472 = cljs.reader.read_comment.call(null,reader,ch);
var G__10473 = eof_is_error;
var G__10474 = sentinel;
var G__10475 = is_recursive;
reader = G__10472;
eof_is_error = G__10473;
sentinel = G__10474;
is_recursive = G__10475;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10476 = reader;
var G__10477 = eof_is_error;
var G__10478 = sentinel;
var G__10479 = is_recursive;
reader = G__10476;
eof_is_error = G__10477;
sentinel = G__10478;
is_recursive = G__10479;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10482 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10482,0,null);var years = cljs.core.nth.call(null,vec__10482,1,null);var months = cljs.core.nth.call(null,vec__10482,2,null);var days = cljs.core.nth.call(null,vec__10482,3,null);var hours = cljs.core.nth.call(null,vec__10482,4,null);var minutes = cljs.core.nth.call(null,vec__10482,5,null);var seconds = cljs.core.nth.call(null,vec__10482,6,null);var fraction = cljs.core.nth.call(null,vec__10482,7,null);var offset_sign = cljs.core.nth.call(null,vec__10482,8,null);var offset_hours = cljs.core.nth.call(null,vec__10482,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10482,10,null);var v = vec__10482;if(cljs.core.not.call(null,v))
...
{var vec__10484 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__10484,0,null);var months = cljs.core.nth.call(null,vec__10484,1,null);var days = cljs.core.nth.call(null,vec__10484,2,null);var hours = cljs.core.nth.call(null,vec__10484,3,null);var minutes = cljs.core.nth.call(null,vec__10484,4,null);var seconds = cljs.core.nth.call(null,vec__10484,5,null);var ms = cljs.core.nth.call(null,vec__10484,6,null);var offset = cljs.core.nth.call(null,vec__10484,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
