...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__10490 = m;var map__10490__$1 = ((cljs.core.seq_QMARK_.call(null,map__10490))?cljs.core.apply.call(null,cljs.core.hash_map,map__10490):map__10490);var line = cljs.core.get.call(null,map__10490__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__10490__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__10492 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__10492))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__10492))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_10493;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_10494 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_10494;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_10495 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___10496 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___10496))
{var message_10497 = temp__4094__auto___10496;cljs.core.println.call(null,message_10497);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_10495;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_10498 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___10499 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___10499))
{var message_10500 = temp__4094__auto___10499;cljs.core.println.call(null,message_10500);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_10501;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_10502 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_10502;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__10503){
var ns_sym = cljs.core.first(arglist__10503);
arglist__10503 = cljs.core.next(arglist__10503);
var fixture_type = cljs.core.first(arglist__10503);
var fixture_fns = cljs.core.rest(arglist__10503);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_10506 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__4704__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return v;
}
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_10506;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__10513 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__10514 = null;var count__10515 = 0;var i__10516 = 0;while(true){
if((i__10516 < count__10515))
{var v = cljs.core._nth.call(null,chunk__10514,i__10516);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__10513,chunk__10514,count__10515,i__10516,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__10513,chunk__10514,count__10515,i__10516,v))
);
} else
{}
{
var G__10517 = seq__10513;
var G__10518 = chunk__10514;
var G__10519 = count__10515;
var G__10520 = (i__10516 + 1);
seq__10513 = G__10517;
chunk__10514 = G__10518;
count__10515 = G__10519;
i__10516 = G__10520;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__10513);if(temp__4094__auto__)
{var seq__10513__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__10513__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__10513__$1);{
var G__10521 = cljs.core.chunk_rest.call(null,seq__10513__$1);
var G__10522 = c__5421__auto__;
var G__10523 = cljs.core.count.call(null,c__5421__auto__);
var G__10524 = 0;
seq__10513 = G__10521;
chunk__10514 = G__10522;
count__10515 = G__10523;
i__10516 = G__10524;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__10513__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__10513,chunk__10514,count__10515,i__10516,v,seq__10513__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__10513,chunk__10514,count__10515,i__10516,v,seq__10513__$1,temp__4094__auto__))
);
} else
{}
{
var G__10525 = cljs.core.next.call(null,seq__10513__$1);
var G__10526 = null;
var G__10527 = 0;
var G__10528 = 0;
seq__10513 = G__10525;
chunk__10514 = G__10526;
count__10515 = G__10527;
i__10516 = G__10528;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_10530 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___10531 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___10531))
{var test_hook_10532 = temp__4092__auto___10531;test_hook_10532.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_10530;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__10533){
var namespaces = cljs.core.seq(arglist__10533);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__10534_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__10534_SHARP_));
