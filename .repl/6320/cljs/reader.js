...
reader_error.cljs$lang$applyTo = (function (arglist__41001){
var rdr = cljs.core.first(arglist__41001);
var msg = cljs.core.rest(arglist__41001);
...
{{
var G__41002 = (function (){sb.append(ch);
return sb;
})();
var G__41003 = cljs.reader.read_char.call(null,rdr);
sb = G__41002;
ch = G__41003;
continue;
}
...
{{
var G__41004 = cljs.reader.read_char.call(null,rdr);
ch = G__41004;
continue;
}
} else
...
var G__41005 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__41005;
continue;
}
} else
...
var G__41006 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__41006;
continue;
}
}
...
{{
var G__41007 = (function (){buffer.append(ch);
return buffer;
})();
var G__41008 = cljs.reader.read_char.call(null,reader);
buffer = G__41007;
ch = G__41008;
continue;
}
...
{if(("\\" === ch))
{{
var G__41009 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__41010 = cljs.reader.read_char.call(null,reader);
buffer = G__41009;
ch = G__41010;
continue;
}
...
{{
var G__41011 = (function (){buffer.append(ch);
return buffer;
})();
var G__41012 = cljs.reader.read_char.call(null,reader);
buffer = G__41011;
ch = G__41012;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__41014 = o;if(G__41014)
{var bit__5323__auto__ = (G__41014.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__41014.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__41014.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__41014);
} else
{return false;
}
}
...
{{
var G__41015 = reader;
var G__41016 = eof_is_error;
var G__41017 = sentinel;
var G__41018 = is_recursive;
reader = G__41015;
eof_is_error = G__41016;
sentinel = G__41017;
is_recursive = G__41018;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__41019 = cljs.reader.read_comment.call(null,reader,ch);
var G__41020 = eof_is_error;
var G__41021 = sentinel;
var G__41022 = is_recursive;
reader = G__41019;
eof_is_error = G__41020;
sentinel = G__41021;
is_recursive = G__41022;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__41023 = reader;
var G__41024 = eof_is_error;
var G__41025 = sentinel;
var G__41026 = is_recursive;
reader = G__41023;
eof_is_error = G__41024;
sentinel = G__41025;
is_recursive = G__41026;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__41029 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__41029,0,null);var years = cljs.core.nth.call(null,vec__41029,1,null);var months = cljs.core.nth.call(null,vec__41029,2,null);var days = cljs.core.nth.call(null,vec__41029,3,null);var hours = cljs.core.nth.call(null,vec__41029,4,null);var minutes = cljs.core.nth.call(null,vec__41029,5,null);var seconds = cljs.core.nth.call(null,vec__41029,6,null);var fraction = cljs.core.nth.call(null,vec__41029,7,null);var offset_sign = cljs.core.nth.call(null,vec__41029,8,null);var offset_hours = cljs.core.nth.call(null,vec__41029,9,null);var offset_minutes = cljs.core.nth.call(null,vec__41029,10,null);var v = vec__41029;if(cljs.core.not.call(null,v))
...
{var vec__41031 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__41031,0,null);var months = cljs.core.nth.call(null,vec__41031,1,null);var days = cljs.core.nth.call(null,vec__41031,2,null);var hours = cljs.core.nth.call(null,vec__41031,3,null);var minutes = cljs.core.nth.call(null,vec__41031,4,null);var seconds = cljs.core.nth.call(null,vec__41031,5,null);var ms = cljs.core.nth.call(null,vec__41031,6,null);var offset = cljs.core.nth.call(null,vec__41031,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
