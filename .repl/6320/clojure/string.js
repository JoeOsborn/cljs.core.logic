...
{{
var G__41032 = cljs.core.pop.call(null,v__$1);
v__$1 = G__41032;
continue;
}
} else
...
{var pred__41036 = cljs.core._EQ_;var expr__41037 = limit;if(pred__41036.call(null,1,expr__41037))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__41036.call(null,2,expr__41037))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__41039 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__41040 = (limit__$1 - 1);
var G__41041 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__41039;
limit__$1 = G__41040;
parts = G__41041;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___41043 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___41043))
{var replacement_41044 = temp__4092__auto___41043;buffer.append([cljs.core.str(replacement_41044)].join(''));
} else
{buffer.append(ch);
}
{
var G__41045 = (index + 1);
index = G__41045;
continue;
}
}
