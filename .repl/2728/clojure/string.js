...
{{
var G__14235 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14235;
continue;
}
} else
...
{var pred__14239 = cljs.core._EQ_;var expr__14240 = limit;if(pred__14239.call(null,1,expr__14240))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__14239.call(null,2,expr__14240))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__14242 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14243 = (limit__$1 - 1);
var G__14244 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14242;
limit__$1 = G__14243;
parts = G__14244;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___14246 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___14246))
{var replacement_14247 = temp__4092__auto___14246;buffer.append([cljs.core.str(replacement_14247)].join(''));
} else
{buffer.append(ch);
}
{
var G__14248 = (index + 1);
index = G__14248;
continue;
}
}
