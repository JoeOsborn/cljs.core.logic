...
{{
var G__624809 = cljs.core.pop.call(null,v__$1);
v__$1 = G__624809;
continue;
}
} else
...
{var pred__624813 = cljs.core._EQ_;var expr__624814 = limit;if(cljs.core.truth_(pred__624813.call(null,1,expr__624814)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__624813.call(null,2,expr__624814)))
...
var G__624816 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__624817 = (limit__$1 - 1);
var G__624818 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__624816;
limit__$1 = G__624817;
parts = G__624818;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___624820 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___624820))
{var replacement_624821 = temp__4096__auto___624820;buffer.append([cljs.core.str(replacement_624821)].join(''));
} else
{buffer.append(ch);
}
{
var G__624822 = (index + 1);
index = G__624822;
continue;
}
}
