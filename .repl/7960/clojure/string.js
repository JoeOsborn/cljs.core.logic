...
{{
var G__341548 = cljs.core.pop.call(null,v__$1);
v__$1 = G__341548;
continue;
}
} else
...
{var pred__341552 = cljs.core._EQ_;var expr__341553 = limit;if(cljs.core.truth_(pred__341552.call(null,1,expr__341553)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__341552.call(null,2,expr__341553)))
...
var G__341555 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__341556 = (limit__$1 - 1);
var G__341557 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__341555;
limit__$1 = G__341556;
parts = G__341557;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___341559 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___341559))
{var replacement_341560 = temp__4096__auto___341559;buffer.append([cljs.core.str(replacement_341560)].join(''));
} else
{buffer.append(ch);
}
{
var G__341561 = (index + 1);
index = G__341561;
continue;
}
}
