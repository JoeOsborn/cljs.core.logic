...
reader_error.cljs$lang$applyTo = (function (arglist__16052){
var rdr = cljs.core.first(arglist__16052);
var msg = cljs.core.rest(arglist__16052);
...
{{
var G__16053 = (function (){sb.append(ch);
return sb;
})();
var G__16054 = cljs.reader.read_char.call(null,rdr);
sb = G__16053;
ch = G__16054;
continue;
}
...
{{
var G__16055 = cljs.reader.read_char.call(null,rdr);
ch = G__16055;
continue;
}
} else
...
var G__16056 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__16056;
continue;
}
} else
...
var G__16057 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__16057;
continue;
}
}
...
{{
var G__16058 = (function (){buffer.append(ch);
return buffer;
})();
var G__16059 = cljs.reader.read_char.call(null,reader);
buffer = G__16058;
ch = G__16059;
continue;
}
...
{if(("\\" === ch))
{{
var G__16060 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__16061 = cljs.reader.read_char.call(null,reader);
buffer = G__16060;
ch = G__16061;
continue;
}
...
{{
var G__16062 = (function (){buffer.append(ch);
return buffer;
})();
var G__16063 = cljs.reader.read_char.call(null,reader);
buffer = G__16062;
ch = G__16063;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__16065 = o;if(G__16065)
{var bit__5604__auto__ = (G__16065.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5604__auto__) || (G__16065.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__16065.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__16065);
} else
{return false;
}
}
...
{{
var G__16066 = reader;
var G__16067 = eof_is_error;
var G__16068 = sentinel;
var G__16069 = is_recursive;
reader = G__16066;
eof_is_error = G__16067;
sentinel = G__16068;
is_recursive = G__16069;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__16070 = cljs.reader.read_comment.call(null,reader,ch);
var G__16071 = eof_is_error;
var G__16072 = sentinel;
var G__16073 = is_recursive;
reader = G__16070;
eof_is_error = G__16071;
sentinel = G__16072;
is_recursive = G__16073;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__16074 = reader;
var G__16075 = eof_is_error;
var G__16076 = sentinel;
var G__16077 = is_recursive;
reader = G__16074;
eof_is_error = G__16075;
sentinel = G__16076;
is_recursive = G__16077;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__16080 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__16080,0,null);var years = cljs.core.nth.call(null,vec__16080,1,null);var months = cljs.core.nth.call(null,vec__16080,2,null);var days = cljs.core.nth.call(null,vec__16080,3,null);var hours = cljs.core.nth.call(null,vec__16080,4,null);var minutes = cljs.core.nth.call(null,vec__16080,5,null);var seconds = cljs.core.nth.call(null,vec__16080,6,null);var fraction = cljs.core.nth.call(null,vec__16080,7,null);var offset_sign = cljs.core.nth.call(null,vec__16080,8,null);var offset_hours = cljs.core.nth.call(null,vec__16080,9,null);var offset_minutes = cljs.core.nth.call(null,vec__16080,10,null);var v = vec__16080;if(cljs.core.not.call(null,v))
...
{var vec__16082 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__16082,0,null);var months = cljs.core.nth.call(null,vec__16082,1,null);var days = cljs.core.nth.call(null,vec__16082,2,null);var hours = cljs.core.nth.call(null,vec__16082,3,null);var minutes = cljs.core.nth.call(null,vec__16082,4,null);var seconds = cljs.core.nth.call(null,vec__16082,5,null);var ms = cljs.core.nth.call(null,vec__16082,6,null);var offset = cljs.core.nth.call(null,vec__16082,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
