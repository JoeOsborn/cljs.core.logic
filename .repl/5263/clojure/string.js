...
{{
var G__16083 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16083;
continue;
}
} else
...
{var pred__16087 = cljs.core._EQ_;var expr__16088 = limit;if(pred__16087.call(null,1,expr__16088))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__16087.call(null,2,expr__16088))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__16090 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16091 = (limit__$1 - 1);
var G__16092 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16090;
limit__$1 = G__16091;
parts = G__16092;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16094 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16094))
{var replacement_16095 = temp__4092__auto___16094;buffer.append([cljs.core.str(replacement_16095)].join(''));
} else
{buffer.append(ch);
}
{
var G__16096 = (index + 1);
index = G__16096;
continue;
}
}
