...
{{
var G__135429 = cljs.core.pop.call(null,v__$1);
v__$1 = G__135429;
continue;
}
} else
...
{var pred__135433 = cljs.core._EQ_;var expr__135434 = limit;if(cljs.core.truth_(pred__135433.call(null,1,expr__135434)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__135433.call(null,2,expr__135434)))
...
var G__135436 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__135437 = (limit__$1 - 1);
var G__135438 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__135436;
limit__$1 = G__135437;
parts = G__135438;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___135440 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___135440))
{var replacement_135441 = temp__4096__auto___135440;buffer.append([cljs.core.str(replacement_135441)].join(''));
} else
{buffer.append(ch);
}
{
var G__135442 = (index + 1);
index = G__135442;
continue;
}
}
