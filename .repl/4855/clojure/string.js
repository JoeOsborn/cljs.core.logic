...
{{
var G__20213 = cljs.core.pop.call(null,v__$1);
v__$1 = G__20213;
continue;
}
} else
...
{var pred__20217 = cljs.core._EQ_;var expr__20218 = limit;if(cljs.core.truth_(pred__20217.call(null,1,expr__20218)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__20217.call(null,2,expr__20218)))
...
var G__20220 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__20221 = (limit__$1 - 1);
var G__20222 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__20220;
limit__$1 = G__20221;
parts = G__20222;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___20224 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___20224))
{var replacement_20225 = temp__4096__auto___20224;buffer.append([cljs.core.str(replacement_20225)].join(''));
} else
{buffer.append(ch);
}
{
var G__20226 = (index + 1);
index = G__20226;
continue;
}
}
