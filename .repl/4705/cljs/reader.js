...
reader_error.cljs$lang$applyTo = (function (arglist__32218){
var rdr = cljs.core.first(arglist__32218);
var msg = cljs.core.rest(arglist__32218);
...
{{
var G__32219 = (function (){sb.append(ch);
return sb;
})();
var G__32220 = cljs.reader.read_char.call(null,rdr);
sb = G__32219;
ch = G__32220;
continue;
}
...
{{
var G__32221 = cljs.reader.read_char.call(null,rdr);
ch = G__32221;
continue;
}
} else
...
var G__32222 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__32222;
continue;
}
} else
...
var G__32223 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__32223;
continue;
}
}
...
{{
var G__32224 = (function (){buffer.append(ch);
return buffer;
})();
var G__32225 = cljs.reader.read_char.call(null,reader);
buffer = G__32224;
ch = G__32225;
continue;
}
...
{if(("\\" === ch))
{{
var G__32226 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__32227 = cljs.reader.read_char.call(null,reader);
buffer = G__32226;
ch = G__32227;
continue;
}
...
{{
var G__32228 = (function (){buffer.append(ch);
return buffer;
})();
var G__32229 = cljs.reader.read_char.call(null,reader);
buffer = G__32228;
ch = G__32229;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__32231 = o;if(G__32231)
{var bit__5323__auto__ = (G__32231.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__32231.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__32231.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__32231);
} else
{return false;
}
}
...
{{
var G__32232 = reader;
var G__32233 = eof_is_error;
var G__32234 = sentinel;
var G__32235 = is_recursive;
reader = G__32232;
eof_is_error = G__32233;
sentinel = G__32234;
is_recursive = G__32235;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__32236 = cljs.reader.read_comment.call(null,reader,ch);
var G__32237 = eof_is_error;
var G__32238 = sentinel;
var G__32239 = is_recursive;
reader = G__32236;
eof_is_error = G__32237;
sentinel = G__32238;
is_recursive = G__32239;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__32240 = reader;
var G__32241 = eof_is_error;
var G__32242 = sentinel;
var G__32243 = is_recursive;
reader = G__32240;
eof_is_error = G__32241;
sentinel = G__32242;
is_recursive = G__32243;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__32246 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__32246,0,null);var years = cljs.core.nth.call(null,vec__32246,1,null);var months = cljs.core.nth.call(null,vec__32246,2,null);var days = cljs.core.nth.call(null,vec__32246,3,null);var hours = cljs.core.nth.call(null,vec__32246,4,null);var minutes = cljs.core.nth.call(null,vec__32246,5,null);var seconds = cljs.core.nth.call(null,vec__32246,6,null);var fraction = cljs.core.nth.call(null,vec__32246,7,null);var offset_sign = cljs.core.nth.call(null,vec__32246,8,null);var offset_hours = cljs.core.nth.call(null,vec__32246,9,null);var offset_minutes = cljs.core.nth.call(null,vec__32246,10,null);var v = vec__32246;if(cljs.core.not.call(null,v))
...
{var vec__32248 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__32248,0,null);var months = cljs.core.nth.call(null,vec__32248,1,null);var days = cljs.core.nth.call(null,vec__32248,2,null);var hours = cljs.core.nth.call(null,vec__32248,3,null);var minutes = cljs.core.nth.call(null,vec__32248,4,null);var seconds = cljs.core.nth.call(null,vec__32248,5,null);var ms = cljs.core.nth.call(null,vec__32248,6,null);var offset = cljs.core.nth.call(null,vec__32248,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
