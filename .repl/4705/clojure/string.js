...
{{
var G__32249 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32249;
continue;
}
} else
...
{var pred__32253 = cljs.core._EQ_;var expr__32254 = limit;if(pred__32253.call(null,1,expr__32254))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__32253.call(null,2,expr__32254))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__32256 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32257 = (limit__$1 - 1);
var G__32258 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__32256;
limit__$1 = G__32257;
parts = G__32258;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___32260 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___32260))
{var replacement_32261 = temp__4092__auto___32260;buffer.append([cljs.core.str(replacement_32261)].join(''));
} else
{buffer.append(ch);
}
{
var G__32262 = (index + 1);
index = G__32262;
continue;
}
}
