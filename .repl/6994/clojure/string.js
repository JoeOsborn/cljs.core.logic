...
{{
var G__247447 = cljs.core.pop.call(null,v__$1);
v__$1 = G__247447;
continue;
}
} else
...
{var pred__247451 = cljs.core._EQ_;var expr__247452 = limit;if(pred__247451.call(null,1,expr__247452))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__247451.call(null,2,expr__247452))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__247454 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__247455 = (limit__$1 - 1);
var G__247456 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__247454;
limit__$1 = G__247455;
parts = G__247456;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___247458 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___247458))
{var replacement_247459 = temp__4092__auto___247458;buffer.append([cljs.core.str(replacement_247459)].join(''));
} else
{buffer.append(ch);
}
{
var G__247460 = (index + 1);
index = G__247460;
continue;
}
}
