...
reader_error.cljs$lang$applyTo = (function (arglist__247743){
var rdr = cljs.core.first(arglist__247743);
var msg = cljs.core.rest(arglist__247743);
...
{{
var G__247744 = (function (){sb.append(ch);
return sb;
})();
var G__247745 = cljs.reader.read_char.call(null,rdr);
sb = G__247744;
ch = G__247745;
continue;
}
...
{{
var G__247746 = cljs.reader.read_char.call(null,rdr);
ch = G__247746;
continue;
}
} else
...
var G__247747 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__247747;
continue;
}
} else
...
var G__247748 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__247748;
continue;
}
}
...
{{
var G__247749 = (function (){buffer.append(ch);
return buffer;
})();
var G__247750 = cljs.reader.read_char.call(null,reader);
buffer = G__247749;
ch = G__247750;
continue;
}
...
{if(("\\" === ch))
{{
var G__247751 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__247752 = cljs.reader.read_char.call(null,reader);
buffer = G__247751;
ch = G__247752;
continue;
}
...
{{
var G__247753 = (function (){buffer.append(ch);
return buffer;
})();
var G__247754 = cljs.reader.read_char.call(null,reader);
buffer = G__247753;
ch = G__247754;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__247756 = o;if(G__247756)
{var bit__5323__auto__ = (G__247756.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__247756.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__247756.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__247756);
} else
{return false;
}
}
...
{{
var G__247757 = reader;
var G__247758 = eof_is_error;
var G__247759 = sentinel;
var G__247760 = is_recursive;
reader = G__247757;
eof_is_error = G__247758;
sentinel = G__247759;
is_recursive = G__247760;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__247761 = cljs.reader.read_comment.call(null,reader,ch);
var G__247762 = eof_is_error;
var G__247763 = sentinel;
var G__247764 = is_recursive;
reader = G__247761;
eof_is_error = G__247762;
sentinel = G__247763;
is_recursive = G__247764;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__247765 = reader;
var G__247766 = eof_is_error;
var G__247767 = sentinel;
var G__247768 = is_recursive;
reader = G__247765;
eof_is_error = G__247766;
sentinel = G__247767;
is_recursive = G__247768;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__247771 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__247771,0,null);var years = cljs.core.nth.call(null,vec__247771,1,null);var months = cljs.core.nth.call(null,vec__247771,2,null);var days = cljs.core.nth.call(null,vec__247771,3,null);var hours = cljs.core.nth.call(null,vec__247771,4,null);var minutes = cljs.core.nth.call(null,vec__247771,5,null);var seconds = cljs.core.nth.call(null,vec__247771,6,null);var fraction = cljs.core.nth.call(null,vec__247771,7,null);var offset_sign = cljs.core.nth.call(null,vec__247771,8,null);var offset_hours = cljs.core.nth.call(null,vec__247771,9,null);var offset_minutes = cljs.core.nth.call(null,vec__247771,10,null);var v = vec__247771;if(cljs.core.not.call(null,v))
...
{var vec__247773 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__247773,0,null);var months = cljs.core.nth.call(null,vec__247773,1,null);var days = cljs.core.nth.call(null,vec__247773,2,null);var hours = cljs.core.nth.call(null,vec__247773,3,null);var minutes = cljs.core.nth.call(null,vec__247773,4,null);var seconds = cljs.core.nth.call(null,vec__247773,5,null);var ms = cljs.core.nth.call(null,vec__247773,6,null);var offset = cljs.core.nth.call(null,vec__247773,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
