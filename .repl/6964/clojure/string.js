...
{{
var G__22634 = cljs.core.pop.call(null,v__$1);
v__$1 = G__22634;
continue;
}
} else
...
{var pred__22638 = cljs.core._EQ_;var expr__22639 = limit;if(pred__22638.call(null,1,expr__22639))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__22638.call(null,2,expr__22639))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__22641 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__22642 = (limit__$1 - 1);
var G__22643 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__22641;
limit__$1 = G__22642;
parts = G__22643;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___22645 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___22645))
{var replacement_22646 = temp__4092__auto___22645;buffer.append([cljs.core.str(replacement_22646)].join(''));
} else
{buffer.append(ch);
}
{
var G__22647 = (index + 1);
index = G__22647;
continue;
}
}
