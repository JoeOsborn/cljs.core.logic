...
{{
var G__540776 = cljs.core.pop.call(null,v__$1);
v__$1 = G__540776;
continue;
}
} else
...
{var pred__540780 = cljs.core._EQ_;var expr__540781 = limit;if(cljs.core.truth_(pred__540780.call(null,1,expr__540781)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__540780.call(null,2,expr__540781)))
...
var G__540783 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__540784 = (limit__$1 - 1);
var G__540785 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__540783;
limit__$1 = G__540784;
parts = G__540785;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___540787 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___540787))
{var replacement_540788 = temp__4096__auto___540787;buffer.append([cljs.core.str(replacement_540788)].join(''));
} else
{buffer.append(ch);
}
{
var G__540789 = (index + 1);
index = G__540789;
continue;
}
}
