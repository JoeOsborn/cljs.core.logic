...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__540731 = m;var map__540731__$1 = ((cljs.core.seq_QMARK_.call(null,map__540731))?cljs.core.apply.call(null,cljs.core.hash_map,map__540731):map__540731);var line = cljs.core.get.call(null,map__540731__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__540731__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__540733 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__540733))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__540733))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_540734;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_540735 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_540735;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_540736 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___540737 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___540737))
{var message_540738 = temp__4098__auto___540737;cljs.core.println.call(null,message_540738);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_540736;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_540739 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4098__auto___540740 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4098__auto___540740))
{var message_540741 = temp__4098__auto___540740;cljs.core.println.call(null,message_540741);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_540742;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_540743 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__6845__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_540743;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__540744){
var ns_sym = cljs.core.first(arglist__540744);
arglist__540744 = cljs.core.next(arglist__540744);
var fixture_type = cljs.core.first(arglist__540744);
var fixture_fns = cljs.core.rest(arglist__540744);
...
{var t = temp__4098__auto__;var _STAR_testing_vars_STAR_540747 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__6845__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e540748){if((e540748 instanceof Error))
{var e_540749 = e540748;cemerick.cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_540749], null));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e540748;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_540747;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__540754 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__540755 = null;var count__540756 = 0;var i__540757 = 0;while(true){
if((i__540757 < count__540756))
{var v = cljs.core._nth.call(null,chunk__540755,i__540757);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__540754,chunk__540755,count__540756,i__540757,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__540754,chunk__540755,count__540756,i__540757,v))
);
} else
{}
{
var G__540758 = seq__540754;
var G__540759 = chunk__540755;
var G__540760 = count__540756;
var G__540761 = (i__540757 + 1);
seq__540754 = G__540758;
chunk__540755 = G__540759;
count__540756 = G__540760;
i__540757 = G__540761;
continue;
}
} else
{var temp__4098__auto__ = cljs.core.seq.call(null,seq__540754);if(temp__4098__auto__)
{var seq__540754__$1 = temp__4098__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__540754__$1))
{var c__7569__auto__ = cljs.core.chunk_first.call(null,seq__540754__$1);{
var G__540762 = cljs.core.chunk_rest.call(null,seq__540754__$1);
var G__540763 = c__7569__auto__;
var G__540764 = cljs.core.count.call(null,c__7569__auto__);
var G__540765 = 0;
seq__540754 = G__540762;
chunk__540755 = G__540763;
count__540756 = G__540764;
i__540757 = G__540765;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__540754__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__540754,chunk__540755,count__540756,i__540757,v,seq__540754__$1,temp__4098__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__540754,chunk__540755,count__540756,i__540757,v,seq__540754__$1,temp__4098__auto__))
);
} else
{}
{
var G__540766 = cljs.core.next.call(null,seq__540754__$1);
var G__540767 = null;
var G__540768 = 0;
var G__540769 = 0;
seq__540754 = G__540766;
chunk__540755 = G__540767;
count__540756 = G__540768;
i__540757 = G__540769;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_540771 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4096__auto___540772 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4096__auto___540772))
{var test_hook_540773 = temp__4096__auto___540772;test_hook_540773.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_540771;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__540774){
var namespaces = cljs.core.seq(arglist__540774);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__540775_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__540775_SHARP_));
