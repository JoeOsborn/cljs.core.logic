...
{{
var G__246272 = cljs.core.pop.call(null,v__$1);
v__$1 = G__246272;
continue;
}
} else
...
{var pred__246276 = cljs.core._EQ_;var expr__246277 = limit;if(cljs.core.truth_(pred__246276.call(null,1,expr__246277)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__246276.call(null,2,expr__246277)))
...
var G__246279 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__246280 = (limit__$1 - 1);
var G__246281 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__246279;
limit__$1 = G__246280;
parts = G__246281;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___246283 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___246283))
{var replacement_246284 = temp__4096__auto___246283;buffer.append([cljs.core.str(replacement_246284)].join(''));
} else
{buffer.append(ch);
}
{
var G__246285 = (index + 1);
index = G__246285;
continue;
}
}
