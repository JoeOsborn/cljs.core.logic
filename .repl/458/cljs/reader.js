...
reader_error.cljs$lang$applyTo = (function (arglist__9269){
var rdr = cljs.core.first(arglist__9269);
var msg = cljs.core.rest(arglist__9269);
...
{{
var G__9270 = (function (){sb.append(ch);
return sb;
})();
var G__9271 = cljs.reader.read_char.call(null,rdr);
sb = G__9270;
ch = G__9271;
continue;
}
...
var G__9273 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9273;
continue;
}
} else
...
var G__9274 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9274;
continue;
}
}
...
{{
var G__9275 = (function (){buffer.append(ch);
return buffer;
})();
var G__9276 = cljs.reader.read_char.call(null,reader);
buffer = G__9275;
ch = G__9276;
continue;
}
...
{if(("\\" === ch))
{{
var G__9277 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9278 = cljs.reader.read_char.call(null,reader);
buffer = G__9277;
ch = G__9278;
continue;
}
...
{{
var G__9279 = (function (){buffer.append(ch);
return buffer;
})();
var G__9280 = cljs.reader.read_char.call(null,reader);
buffer = G__9279;
ch = G__9280;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9282 = o;if(G__9282)
{var bit__5323__auto__ = (G__9282.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9282.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9282.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9282);
} else
{return false;
}
}
...
{{
var G__9287 = cljs.reader.read_comment.call(null,reader,ch);
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9297 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9297,0,null);var years = cljs.core.nth.call(null,vec__9297,1,null);var months = cljs.core.nth.call(null,vec__9297,2,null);var days = cljs.core.nth.call(null,vec__9297,3,null);var hours = cljs.core.nth.call(null,vec__9297,4,null);var minutes = cljs.core.nth.call(null,vec__9297,5,null);var seconds = cljs.core.nth.call(null,vec__9297,6,null);var fraction = cljs.core.nth.call(null,vec__9297,7,null);var offset_sign = cljs.core.nth.call(null,vec__9297,8,null);var offset_hours = cljs.core.nth.call(null,vec__9297,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9297,10,null);var v = vec__9297;if(cljs.core.not.call(null,v))
...
{var vec__9299 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9299,0,null);var months = cljs.core.nth.call(null,vec__9299,1,null);var days = cljs.core.nth.call(null,vec__9299,2,null);var hours = cljs.core.nth.call(null,vec__9299,3,null);var minutes = cljs.core.nth.call(null,vec__9299,4,null);var seconds = cljs.core.nth.call(null,vec__9299,5,null);var ms = cljs.core.nth.call(null,vec__9299,6,null);var offset = cljs.core.nth.call(null,vec__9299,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
