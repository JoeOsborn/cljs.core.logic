...
{{
var G__9300 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9300;
continue;
}
} else
...
{var pred__9304 = cljs.core._EQ_;var expr__9305 = limit;if(pred__9304.call(null,1,expr__9305))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9304.call(null,2,expr__9305))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9307 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9308 = (limit__$1 - 1);
var G__9309 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9307;
limit__$1 = G__9308;
parts = G__9309;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9311 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9311))
{var replacement_9312 = temp__4092__auto___9311;buffer.append([cljs.core.str(replacement_9312)].join(''));
} else
{buffer.append(ch);
}
{
