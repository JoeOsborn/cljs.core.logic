...
{{
var G__475015 = cljs.core.pop.call(null,v__$1);
v__$1 = G__475015;
continue;
}
} else
...
{var pred__475019 = cljs.core._EQ_;var expr__475020 = limit;if(cljs.core.truth_(pred__475019.call(null,1,expr__475020)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__475019.call(null,2,expr__475020)))
...
var G__475022 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__475023 = (limit__$1 - 1);
var G__475024 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__475022;
limit__$1 = G__475023;
parts = G__475024;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___475026 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___475026))
{var replacement_475027 = temp__4096__auto___475026;buffer.append([cljs.core.str(replacement_475027)].join(''));
} else
{buffer.append(ch);
}
{
var G__475028 = (index + 1);
index = G__475028;
continue;
}
}
