...
{{
var G__16061 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16061;
continue;
}
} else
...
{var pred__16065 = cljs.core._EQ_;var expr__16066 = limit;if(pred__16065.call(null,1,expr__16066))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__16065.call(null,2,expr__16066))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__16068 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16069 = (limit__$1 - 1);
var G__16070 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16068;
limit__$1 = G__16069;
parts = G__16070;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16072 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16072))
{var replacement_16073 = temp__4092__auto___16072;buffer.append([cljs.core.str(replacement_16073)].join(''));
} else
{buffer.append(ch);
}
{
var G__16074 = (index + 1);
index = G__16074;
continue;
}
}
