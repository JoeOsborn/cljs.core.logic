...
reader_error.cljs$lang$applyTo = (function (arglist__16030){
var rdr = cljs.core.first(arglist__16030);
var msg = cljs.core.rest(arglist__16030);
...
{{
var G__16031 = (function (){sb.append(ch);
return sb;
})();
var G__16032 = cljs.reader.read_char.call(null,rdr);
sb = G__16031;
ch = G__16032;
continue;
}
...
{{
var G__16033 = cljs.reader.read_char.call(null,rdr);
ch = G__16033;
continue;
}
} else
...
var G__16034 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__16034;
continue;
}
} else
...
var G__16035 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__16035;
continue;
}
}
...
{{
var G__16036 = (function (){buffer.append(ch);
return buffer;
})();
var G__16037 = cljs.reader.read_char.call(null,reader);
buffer = G__16036;
ch = G__16037;
continue;
}
...
{if(("\\" === ch))
{{
var G__16038 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__16039 = cljs.reader.read_char.call(null,reader);
buffer = G__16038;
ch = G__16039;
continue;
}
...
{{
var G__16040 = (function (){buffer.append(ch);
return buffer;
})();
var G__16041 = cljs.reader.read_char.call(null,reader);
buffer = G__16040;
ch = G__16041;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__16043 = o;if(G__16043)
{var bit__5323__auto__ = (G__16043.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__16043.cljs$core$IWithMeta$))
{return true;
} else
...
{{
var G__16044 = reader;
var G__16045 = eof_is_error;
var G__16046 = sentinel;
var G__16047 = is_recursive;
reader = G__16044;
eof_is_error = G__16045;
sentinel = G__16046;
is_recursive = G__16047;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__16048 = cljs.reader.read_comment.call(null,reader,ch);
var G__16049 = eof_is_error;
var G__16050 = sentinel;
var G__16051 = is_recursive;
reader = G__16048;
eof_is_error = G__16049;
sentinel = G__16050;
is_recursive = G__16051;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__16052 = reader;
var G__16053 = eof_is_error;
var G__16054 = sentinel;
var G__16055 = is_recursive;
reader = G__16052;
eof_is_error = G__16053;
sentinel = G__16054;
is_recursive = G__16055;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__16058 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__16058,0,null);var years = cljs.core.nth.call(null,vec__16058,1,null);var months = cljs.core.nth.call(null,vec__16058,2,null);var days = cljs.core.nth.call(null,vec__16058,3,null);var hours = cljs.core.nth.call(null,vec__16058,4,null);var minutes = cljs.core.nth.call(null,vec__16058,5,null);var seconds = cljs.core.nth.call(null,vec__16058,6,null);var fraction = cljs.core.nth.call(null,vec__16058,7,null);var offset_sign = cljs.core.nth.call(null,vec__16058,8,null);var offset_hours = cljs.core.nth.call(null,vec__16058,9,null);var offset_minutes = cljs.core.nth.call(null,vec__16058,10,null);var v = vec__16058;if(cljs.core.not.call(null,v))
...
{var vec__16060 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__16060,0,null);var months = cljs.core.nth.call(null,vec__16060,1,null);var days = cljs.core.nth.call(null,vec__16060,2,null);var hours = cljs.core.nth.call(null,vec__16060,3,null);var minutes = cljs.core.nth.call(null,vec__16060,4,null);var seconds = cljs.core.nth.call(null,vec__16060,5,null);var ms = cljs.core.nth.call(null,vec__16060,6,null);var offset = cljs.core.nth.call(null,vec__16060,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
