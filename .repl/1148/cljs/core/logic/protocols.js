...
cljs.core.logic.protocols.non_storable_QMARK_ = (function non_storable_QMARK_(x){var G__16750 = x;if(G__16750)
...
{return G__16750.cljs$core$logic$protocols$INonStorable$;
}
})()))
{return true;
} else
{if((!G__16750.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.INonStorable,G__16750);
} else
{return false;
}
}
...
cljs.core.logic.protocols.id = (function id(c){if((function (){var G__16813 = c;if(G__16813)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__16813.cljs$core$logic$protocols$IConstraintId$;
}
})()))
{return true;
} else
{if((!G__16813.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IConstraintId,G__16813);
} else
{return false;
}
}
...
cljs.core.logic.protocols.with_id = (function with_id(c,id){if((function (){var G__16817 = c;if(G__16817)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__16817.cljs$core$logic$protocols$IWithConstraintId$;
}
})()))
{return true;
} else
{if((!G__16817.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IWithConstraintId,G__16817);
} else
{return false;
}
}
...
cljs.core.logic.protocols.reifiable_QMARK_ = (function reifiable_QMARK_(x){var G__16820 = x;if(G__16820)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__16820.cljs$core$logic$protocols$IReifiableConstraint$;
}
})()))
{return true;
} else
{if((!G__16820.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IReifiableConstraint,G__16820);
} else
{return false;
}
}
...
cljs.core.logic.protocols.enforceable_QMARK_ = (function enforceable_QMARK_(x){var G__16822 = x;if(G__16822)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__16822.cljs$core$logic$protocols$IEnforceableConstraint$;
}
})()))
{return true;
} else
{if((!G__16822.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IEnforceableConstraint,G__16822);
} else
{return false;
}
}
...
cljs.core.logic.protocols.tree_constraint_QMARK_ = (function tree_constraint_QMARK_(x){var G__16828 = x;if(G__16828)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__16828.clojure$core$logic$protocols$ITreeConstraint$;
}
})()))
{return true;
} else
{if((!G__16828.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,clojure.core.logic.protocols.ITreeConstraint,G__16828);
} else
{return false;
}
}
