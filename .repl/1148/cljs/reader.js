...
reader_error.cljs$lang$applyTo = (function (arglist__17559){
var rdr = cljs.core.first(arglist__17559);
var msg = cljs.core.rest(arglist__17559);
...
{{
var G__17560 = (function (){sb.append(ch);
return sb;
})();
var G__17561 = cljs.reader.read_char.call(null,rdr);
sb = G__17560;
ch = G__17561;
continue;
}
...
{{
var G__17562 = cljs.reader.read_char.call(null,rdr);
ch = G__17562;
continue;
}
} else
...
var G__17563 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__17563;
continue;
}
} else
...
var G__17564 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__17564;
continue;
}
}
...
{{
var G__17565 = (function (){buffer.append(ch);
return buffer;
})();
var G__17566 = cljs.reader.read_char.call(null,reader);
buffer = G__17565;
ch = G__17566;
continue;
}
...
{if(("\\" === ch))
{{
var G__17567 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__17568 = cljs.reader.read_char.call(null,reader);
buffer = G__17567;
ch = G__17568;
continue;
}
...
{{
var G__17569 = (function (){buffer.append(ch);
return buffer;
})();
var G__17570 = cljs.reader.read_char.call(null,reader);
buffer = G__17569;
ch = G__17570;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__17572 = o;if(G__17572)
{var bit__5323__auto__ = (G__17572.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__17572.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__17572.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__17572);
} else
{return false;
}
}
...
{{
var G__17573 = reader;
var G__17574 = eof_is_error;
var G__17575 = sentinel;
var G__17576 = is_recursive;
reader = G__17573;
eof_is_error = G__17574;
sentinel = G__17575;
is_recursive = G__17576;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__17577 = cljs.reader.read_comment.call(null,reader,ch);
var G__17578 = eof_is_error;
var G__17579 = sentinel;
var G__17580 = is_recursive;
reader = G__17577;
eof_is_error = G__17578;
sentinel = G__17579;
is_recursive = G__17580;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__17581 = reader;
var G__17582 = eof_is_error;
var G__17583 = sentinel;
var G__17584 = is_recursive;
reader = G__17581;
eof_is_error = G__17582;
sentinel = G__17583;
is_recursive = G__17584;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__17587 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__17587,0,null);var years = cljs.core.nth.call(null,vec__17587,1,null);var months = cljs.core.nth.call(null,vec__17587,2,null);var days = cljs.core.nth.call(null,vec__17587,3,null);var hours = cljs.core.nth.call(null,vec__17587,4,null);var minutes = cljs.core.nth.call(null,vec__17587,5,null);var seconds = cljs.core.nth.call(null,vec__17587,6,null);var fraction = cljs.core.nth.call(null,vec__17587,7,null);var offset_sign = cljs.core.nth.call(null,vec__17587,8,null);var offset_hours = cljs.core.nth.call(null,vec__17587,9,null);var offset_minutes = cljs.core.nth.call(null,vec__17587,10,null);var v = vec__17587;if(cljs.core.not.call(null,v))
...
{var vec__17589 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__17589,0,null);var months = cljs.core.nth.call(null,vec__17589,1,null);var days = cljs.core.nth.call(null,vec__17589,2,null);var hours = cljs.core.nth.call(null,vec__17589,3,null);var minutes = cljs.core.nth.call(null,vec__17589,4,null);var seconds = cljs.core.nth.call(null,vec__17589,5,null);var ms = cljs.core.nth.call(null,vec__17589,6,null);var offset = cljs.core.nth.call(null,vec__17589,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
