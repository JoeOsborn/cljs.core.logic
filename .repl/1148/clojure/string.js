...
{{
var G__17590 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17590;
continue;
}
} else
...
{var pred__17594 = cljs.core._EQ_;var expr__17595 = limit;if(pred__17594.call(null,1,expr__17595))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__17594.call(null,2,expr__17595))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__17597 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17598 = (limit__$1 - 1);
var G__17599 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17597;
limit__$1 = G__17598;
parts = G__17599;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___17601 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___17601))
{var replacement_17602 = temp__4092__auto___17601;buffer.append([cljs.core.str(replacement_17602)].join(''));
} else
{buffer.append(ch);
}
{
var G__17603 = (index + 1);
index = G__17603;
continue;
}
}
