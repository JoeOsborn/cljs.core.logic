...
{{
var G__43240 = cljs.core.pop.call(null,v__$1);
v__$1 = G__43240;
continue;
}
} else
...
{var pred__43244 = cljs.core._EQ_;var expr__43245 = limit;if(pred__43244.call(null,1,expr__43245))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__43244.call(null,2,expr__43245))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__43247 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__43248 = (limit__$1 - 1);
var G__43249 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__43247;
limit__$1 = G__43248;
parts = G__43249;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___43251 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___43251))
{var replacement_43252 = temp__4092__auto___43251;buffer.append([cljs.core.str(replacement_43252)].join(''));
} else
{buffer.append(ch);
}
{
var G__43253 = (index + 1);
index = G__43253;
continue;
}
}
