...
{{
var G__515756 = cljs.core.pop.call(null,v__$1);
v__$1 = G__515756;
continue;
}
} else
...
{var pred__515760 = cljs.core._EQ_;var expr__515761 = limit;if(cljs.core.truth_(pred__515760.call(null,1,expr__515761)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__515760.call(null,2,expr__515761)))
...
var G__515763 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__515764 = (limit__$1 - 1);
var G__515765 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__515763;
limit__$1 = G__515764;
parts = G__515765;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___515767 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___515767))
{var replacement_515768 = temp__4096__auto___515767;buffer.append([cljs.core.str(replacement_515768)].join(''));
} else
{buffer.append(ch);
}
{
var G__515769 = (index + 1);
index = G__515769;
continue;
}
}
