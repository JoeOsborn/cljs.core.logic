...
{{
var G__29837 = cljs.core.pop.call(null,v__$1);
v__$1 = G__29837;
continue;
}
} else
...
{var pred__29841 = cljs.core._EQ_;var expr__29842 = limit;if(pred__29841.call(null,1,expr__29842))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__29841.call(null,2,expr__29842))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__29844 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__29845 = (limit__$1 - 1);
var G__29846 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__29844;
limit__$1 = G__29845;
parts = G__29846;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___29848 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___29848))
{var replacement_29849 = temp__4092__auto___29848;buffer.append([cljs.core.str(replacement_29849)].join(''));
} else
{buffer.append(ch);
}
{
var G__29850 = (index + 1);
index = G__29850;
continue;
}
}
