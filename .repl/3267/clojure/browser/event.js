...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj692250 = {};return obj692250;
})();
clojure.browser.event.event_types = (function event_types(this$){if(cljs.core.truth_((function (){var and__6833__auto__ = this$;if(and__6833__auto__)
...
{var x__7448__auto__ = (((this$ == null))?null:this$);return (function (){var or__6845__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7448__auto__)]);if(cljs.core.truth_(or__6845__auto__))
{return or__6845__auto__;
} else
{var or__6845__auto____$1 = (clojure.browser.event.event_types["_"]);if(cljs.core.truth_(or__6845__auto____$1))
...
Element.prototype.clojure$browser$event$EventType$event_types$arity$1 = (function (this$){var this$__$1 = this;return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__692253){var vec__692254 = p__692253;var k = cljs.core.nth.call(null,vec__692254,0,null);var v = cljs.core.nth.call(null,vec__692254,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
}),cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
goog.events.EventTarget.prototype.clojure$browser$event$EventType$ = true;
goog.events.EventTarget.prototype.clojure$browser$event$EventType$event_types$arity$1 = (function (this$){var this$__$1 = this;return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__692255){var vec__692256 = p__692255;var k = cljs.core.nth.call(null,vec__692256,0,null);var v = cljs.core.nth.call(null,vec__692256,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
}),cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
