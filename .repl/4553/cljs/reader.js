...
reader_error.cljs$lang$applyTo = (function (arglist__10730){
var rdr = cljs.core.first(arglist__10730);
var msg = cljs.core.rest(arglist__10730);
...
{{
var G__10731 = (function (){sb.append(ch);
return sb;
})();
var G__10732 = cljs.reader.read_char.call(null,rdr);
sb = G__10731;
ch = G__10732;
continue;
}
...
{{
var G__10733 = cljs.reader.read_char.call(null,rdr);
ch = G__10733;
continue;
}
} else
...
var G__10734 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10734;
continue;
}
} else
...
var G__10735 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10735;
continue;
}
}
...
{{
var G__10736 = (function (){buffer.append(ch);
return buffer;
})();
var G__10737 = cljs.reader.read_char.call(null,reader);
buffer = G__10736;
ch = G__10737;
continue;
}
...
{if(("\\" === ch))
{{
var G__10738 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10739 = cljs.reader.read_char.call(null,reader);
buffer = G__10738;
ch = G__10739;
continue;
}
...
{{
var G__10740 = (function (){buffer.append(ch);
return buffer;
})();
var G__10741 = cljs.reader.read_char.call(null,reader);
buffer = G__10740;
ch = G__10741;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10743 = o;if(G__10743)
{var bit__5323__auto__ = (G__10743.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__10743.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10743.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10743);
} else
{return false;
}
}
...
{{
var G__10744 = reader;
var G__10745 = eof_is_error;
var G__10746 = sentinel;
var G__10747 = is_recursive;
reader = G__10744;
eof_is_error = G__10745;
sentinel = G__10746;
is_recursive = G__10747;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10748 = cljs.reader.read_comment.call(null,reader,ch);
var G__10749 = eof_is_error;
var G__10750 = sentinel;
var G__10751 = is_recursive;
reader = G__10748;
eof_is_error = G__10749;
sentinel = G__10750;
is_recursive = G__10751;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10752 = reader;
var G__10753 = eof_is_error;
var G__10754 = sentinel;
var G__10755 = is_recursive;
reader = G__10752;
eof_is_error = G__10753;
sentinel = G__10754;
is_recursive = G__10755;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10758 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10758,0,null);var years = cljs.core.nth.call(null,vec__10758,1,null);var months = cljs.core.nth.call(null,vec__10758,2,null);var days = cljs.core.nth.call(null,vec__10758,3,null);var hours = cljs.core.nth.call(null,vec__10758,4,null);var minutes = cljs.core.nth.call(null,vec__10758,5,null);var seconds = cljs.core.nth.call(null,vec__10758,6,null);var fraction = cljs.core.nth.call(null,vec__10758,7,null);var offset_sign = cljs.core.nth.call(null,vec__10758,8,null);var offset_hours = cljs.core.nth.call(null,vec__10758,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10758,10,null);var v = vec__10758;if(cljs.core.not.call(null,v))
...
{var vec__10760 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__10760,0,null);var months = cljs.core.nth.call(null,vec__10760,1,null);var days = cljs.core.nth.call(null,vec__10760,2,null);var hours = cljs.core.nth.call(null,vec__10760,3,null);var minutes = cljs.core.nth.call(null,vec__10760,4,null);var seconds = cljs.core.nth.call(null,vec__10760,5,null);var ms = cljs.core.nth.call(null,vec__10760,6,null);var offset = cljs.core.nth.call(null,vec__10760,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
