...
{{
var G__10432 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10432;
continue;
}
} else
...
{var pred__10436 = cljs.core._EQ_;var expr__10437 = limit;if(pred__10436.call(null,1,expr__10437))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10436.call(null,2,expr__10437))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10439 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10440 = (limit__$1 - 1);
var G__10441 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10439;
limit__$1 = G__10440;
parts = G__10441;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10443 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10443))
{var replacement_10444 = temp__4092__auto___10443;buffer.append([cljs.core.str(replacement_10444)].join(''));
} else
{buffer.append(ch);
}
{
