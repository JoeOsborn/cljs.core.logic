...
{{
var G__9361 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9361;
continue;
}
} else
...
{var pred__9365 = cljs.core._EQ_;var expr__9366 = limit;if(pred__9365.call(null,1,expr__9366))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9365.call(null,2,expr__9366))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9368 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9369 = (limit__$1 - 1);
var G__9370 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9368;
limit__$1 = G__9369;
parts = G__9370;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9372 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9372))
{var replacement_9373 = temp__4092__auto___9372;buffer.append([cljs.core.str(replacement_9373)].join(''));
} else
{buffer.append(ch);
}
{
