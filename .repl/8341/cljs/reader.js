...
reader_error.cljs$lang$applyTo = (function (arglist__9330){
var rdr = cljs.core.first(arglist__9330);
var msg = cljs.core.rest(arglist__9330);
...
{{
var G__9331 = (function (){sb.append(ch);
return sb;
})();
var G__9332 = cljs.reader.read_char.call(null,rdr);
sb = G__9331;
ch = G__9332;
continue;
}
...
{{
var G__9333 = cljs.reader.read_char.call(null,rdr);
ch = G__9333;
continue;
}
} else
...
var G__9334 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9334;
continue;
}
} else
...
var G__9335 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9335;
continue;
}
}
...
{{
var G__9336 = (function (){buffer.append(ch);
return buffer;
})();
var G__9337 = cljs.reader.read_char.call(null,reader);
buffer = G__9336;
ch = G__9337;
continue;
}
...
{if(("\\" === ch))
{{
var G__9338 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9339 = cljs.reader.read_char.call(null,reader);
buffer = G__9338;
ch = G__9339;
continue;
}
...
{{
var G__9340 = (function (){buffer.append(ch);
return buffer;
})();
var G__9341 = cljs.reader.read_char.call(null,reader);
buffer = G__9340;
ch = G__9341;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9343 = o;if(G__9343)
{var bit__5323__auto__ = (G__9343.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9343.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9343.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9343);
} else
{return false;
}
}
...
{{
var G__9344 = reader;
var G__9345 = eof_is_error;
var G__9346 = sentinel;
var G__9347 = is_recursive;
reader = G__9344;
eof_is_error = G__9345;
sentinel = G__9346;
is_recursive = G__9347;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9348 = cljs.reader.read_comment.call(null,reader,ch);
var G__9349 = eof_is_error;
var G__9350 = sentinel;
var G__9351 = is_recursive;
reader = G__9348;
eof_is_error = G__9349;
sentinel = G__9350;
is_recursive = G__9351;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9352 = reader;
var G__9353 = eof_is_error;
var G__9354 = sentinel;
var G__9355 = is_recursive;
reader = G__9352;
eof_is_error = G__9353;
sentinel = G__9354;
is_recursive = G__9355;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9358 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9358,0,null);var years = cljs.core.nth.call(null,vec__9358,1,null);var months = cljs.core.nth.call(null,vec__9358,2,null);var days = cljs.core.nth.call(null,vec__9358,3,null);var hours = cljs.core.nth.call(null,vec__9358,4,null);var minutes = cljs.core.nth.call(null,vec__9358,5,null);var seconds = cljs.core.nth.call(null,vec__9358,6,null);var fraction = cljs.core.nth.call(null,vec__9358,7,null);var offset_sign = cljs.core.nth.call(null,vec__9358,8,null);var offset_hours = cljs.core.nth.call(null,vec__9358,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9358,10,null);var v = vec__9358;if(cljs.core.not.call(null,v))
...
{var vec__9360 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9360,0,null);var months = cljs.core.nth.call(null,vec__9360,1,null);var days = cljs.core.nth.call(null,vec__9360,2,null);var hours = cljs.core.nth.call(null,vec__9360,3,null);var minutes = cljs.core.nth.call(null,vec__9360,4,null);var seconds = cljs.core.nth.call(null,vec__9360,5,null);var ms = cljs.core.nth.call(null,vec__9360,6,null);var offset = cljs.core.nth.call(null,vec__9360,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
