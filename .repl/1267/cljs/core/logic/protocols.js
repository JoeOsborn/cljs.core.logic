...
cljs.core.logic.protocols.non_storable_QMARK_ = (function non_storable_QMARK_(x){var G__11345 = x;if(G__11345)
...
{return G__11345.cljs$core$logic$protocols$INonStorable$;
}
})()))
{return true;
} else
{if((!G__11345.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.INonStorable,G__11345);
} else
{return false;
}
}
...
cljs.core.logic.protocols.id = (function id(c){if((function (){var G__11347 = c;if(G__11347)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__11347.cljs$core$logic$protocols$IConstraintId$;
}
})()))
{return true;
} else
{if((!G__11347.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IConstraintId,G__11347);
} else
{return false;
}
}
...
cljs.core.logic.protocols.with_id = (function with_id(c,id){if((function (){var G__11349 = c;if(G__11349)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__11349.cljs$core$logic$protocols$IWithConstraintId$;
}
})()))
{return true;
} else
{if((!G__11349.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IWithConstraintId,G__11349);
} else
{return false;
}
}
...
cljs.core.logic.protocols.reifiable_QMARK_ = (function reifiable_QMARK_(x){var G__11351 = x;if(G__11351)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__11351.cljs$core$logic$protocols$IReifiableConstraint$;
}
})()))
{return true;
} else
{if((!G__11351.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IReifiableConstraint,G__11351);
} else
{return false;
}
}
...
cljs.core.logic.protocols.enforceable_QMARK_ = (function enforceable_QMARK_(x){var G__11353 = x;if(G__11353)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__11353.cljs$core$logic$protocols$IEnforceableConstraint$;
}
})()))
{return true;
} else
{if((!G__11353.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.logic.protocols.IEnforceableConstraint,G__11353);
} else
{return false;
}
}
...
cljs.core.logic.protocols.tree_constraint_QMARK_ = (function tree_constraint_QMARK_(x){var G__11355 = x;if(G__11355)
{var bit__5323__auto__ = null;if(cljs.core.truth_((function (){var or__4704__auto__ = bit__5323__auto__;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return G__11355.clojure$core$logic$protocols$ITreeConstraint$;
}
})()))
{return true;
} else
{if((!G__11355.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,clojure.core.logic.protocols.ITreeConstraint,G__11355);
} else
{return false;
}
}
