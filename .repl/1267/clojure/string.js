...
{{
var G__11387 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11387;
continue;
}
} else
...
{var pred__11391 = cljs.core._EQ_;var expr__11392 = limit;if(pred__11391.call(null,1,expr__11392))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__11391.call(null,2,expr__11392))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__11394 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11395 = (limit__$1 - 1);
var G__11396 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11394;
limit__$1 = G__11395;
parts = G__11396;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___11398 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___11398))
{var replacement_11399 = temp__4092__auto___11398;buffer.append([cljs.core.str(replacement_11399)].join(''));
} else
{buffer.append(ch);
}
{
var G__11400 = (index + 1);
index = G__11400;
continue;
}
}
