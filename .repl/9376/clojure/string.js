...
{{
var G__155618 = cljs.core.pop.call(null,v__$1);
v__$1 = G__155618;
continue;
}
} else
...
{var pred__155622 = cljs.core._EQ_;var expr__155623 = limit;if(cljs.core.truth_(pred__155622.call(null,1,expr__155623)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__155622.call(null,2,expr__155623)))
...
var G__155625 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__155626 = (limit__$1 - 1);
var G__155627 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__155625;
limit__$1 = G__155626;
parts = G__155627;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___155629 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___155629))
{var replacement_155630 = temp__4096__auto___155629;buffer.append([cljs.core.str(replacement_155630)].join(''));
} else
{buffer.append(ch);
}
{
var G__155631 = (index + 1);
index = G__155631;
continue;
}
}
