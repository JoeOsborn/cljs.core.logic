...
{{
var G__69586 = cljs.core.pop.call(null,v__$1);
v__$1 = G__69586;
continue;
}
} else
...
{var pred__69590 = cljs.core._EQ_;var expr__69591 = limit;if(pred__69590.call(null,1,expr__69591))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__69590.call(null,2,expr__69591))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__69593 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__69594 = (limit__$1 - 1);
var G__69595 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__69593;
limit__$1 = G__69594;
parts = G__69595;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___69597 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___69597))
{var replacement_69598 = temp__4092__auto___69597;buffer.append([cljs.core.str(replacement_69598)].join(''));
} else
{buffer.append(ch);
}
{
var G__69599 = (index + 1);
index = G__69599;
continue;
}
}
