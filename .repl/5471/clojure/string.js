...
{{
var G__130642 = cljs.core.pop.call(null,v__$1);
v__$1 = G__130642;
continue;
}
} else
...
{var pred__130646 = cljs.core._EQ_;var expr__130647 = limit;if(cljs.core.truth_(pred__130646.call(null,1,expr__130647)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__130646.call(null,2,expr__130647)))
...
var G__130649 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__130650 = (limit__$1 - 1);
var G__130651 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__130649;
limit__$1 = G__130650;
parts = G__130651;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___130653 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___130653))
{var replacement_130654 = temp__4096__auto___130653;buffer.append([cljs.core.str(replacement_130654)].join(''));
} else
{buffer.append(ch);
}
{
var G__130655 = (index + 1);
index = G__130655;
continue;
}
}
