...
{var pred__9332 = cljs.core._EQ_;var expr__9333 = limit;if(pred__9332.call(null,1,expr__9333))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9332.call(null,2,expr__9333))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9335 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9336 = (limit__$1 - 1);
var G__9337 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9335;
limit__$1 = G__9336;
parts = G__9337;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9339 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9339))
{var replacement_9340 = temp__4092__auto___9339;buffer.append([cljs.core.str(replacement_9340)].join(''));
} else
{buffer.append(ch);
}
{
