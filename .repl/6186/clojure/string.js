...
{{
var G__185570 = cljs.core.pop.call(null,v__$1);
v__$1 = G__185570;
continue;
}
} else
...
{var pred__185574 = cljs.core._EQ_;var expr__185575 = limit;if(cljs.core.truth_(pred__185574.call(null,1,expr__185575)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__185574.call(null,2,expr__185575)))
...
var G__185577 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__185578 = (limit__$1 - 1);
var G__185579 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__185577;
limit__$1 = G__185578;
parts = G__185579;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___185581 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___185581))
{var replacement_185582 = temp__4096__auto___185581;buffer.append([cljs.core.str(replacement_185582)].join(''));
} else
{buffer.append(ch);
}
{
var G__185583 = (index + 1);
index = G__185583;
continue;
}
}
