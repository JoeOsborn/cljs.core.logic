...
{{
var G__74360 = cljs.core.pop.call(null,v__$1);
v__$1 = G__74360;
continue;
}
} else
...
{var pred__74364 = cljs.core._EQ_;var expr__74365 = limit;if(pred__74364.call(null,1,expr__74365))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__74364.call(null,2,expr__74365))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__74367 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__74368 = (limit__$1 - 1);
var G__74369 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__74367;
limit__$1 = G__74368;
parts = G__74369;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___74371 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___74371))
{var replacement_74372 = temp__4092__auto___74371;buffer.append([cljs.core.str(replacement_74372)].join(''));
} else
{buffer.append(ch);
}
{
var G__74373 = (index + 1);
index = G__74373;
continue;
}
}
