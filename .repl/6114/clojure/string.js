...
{{
var G__206313 = cljs.core.pop.call(null,v__$1);
v__$1 = G__206313;
continue;
}
} else
...
{var pred__206317 = cljs.core._EQ_;var expr__206318 = limit;if(pred__206317.call(null,1,expr__206318))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__206317.call(null,2,expr__206318))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__206320 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__206321 = (limit__$1 - 1);
var G__206322 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__206320;
limit__$1 = G__206321;
parts = G__206322;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___206324 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___206324))
{var replacement_206325 = temp__4092__auto___206324;buffer.append([cljs.core.str(replacement_206325)].join(''));
} else
{buffer.append(ch);
}
{
var G__206326 = (index + 1);
index = G__206326;
continue;
}
}
