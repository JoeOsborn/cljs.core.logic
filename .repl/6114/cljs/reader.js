...
reader_error.cljs$lang$applyTo = (function (arglist__206611){
var rdr = cljs.core.first(arglist__206611);
var msg = cljs.core.rest(arglist__206611);
...
{{
var G__206612 = (function (){sb.append(ch);
return sb;
})();
var G__206613 = cljs.reader.read_char.call(null,rdr);
sb = G__206612;
ch = G__206613;
continue;
}
...
{{
var G__206614 = cljs.reader.read_char.call(null,rdr);
ch = G__206614;
continue;
}
} else
...
var G__206615 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__206615;
continue;
}
} else
...
var G__206616 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__206616;
continue;
}
}
...
{{
var G__206617 = (function (){buffer.append(ch);
return buffer;
})();
var G__206618 = cljs.reader.read_char.call(null,reader);
buffer = G__206617;
ch = G__206618;
continue;
}
...
{if(("\\" === ch))
{{
var G__206619 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__206620 = cljs.reader.read_char.call(null,reader);
buffer = G__206619;
ch = G__206620;
continue;
}
...
{{
var G__206621 = (function (){buffer.append(ch);
return buffer;
})();
var G__206622 = cljs.reader.read_char.call(null,reader);
buffer = G__206621;
ch = G__206622;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__206624 = o;if(G__206624)
{var bit__5323__auto__ = (G__206624.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__206624.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__206624.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__206624);
} else
{return false;
}
}
...
{{
var G__206625 = reader;
var G__206626 = eof_is_error;
var G__206627 = sentinel;
var G__206628 = is_recursive;
reader = G__206625;
eof_is_error = G__206626;
sentinel = G__206627;
is_recursive = G__206628;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__206629 = cljs.reader.read_comment.call(null,reader,ch);
var G__206630 = eof_is_error;
var G__206631 = sentinel;
var G__206632 = is_recursive;
reader = G__206629;
eof_is_error = G__206630;
sentinel = G__206631;
is_recursive = G__206632;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__206633 = reader;
var G__206634 = eof_is_error;
var G__206635 = sentinel;
var G__206636 = is_recursive;
reader = G__206633;
eof_is_error = G__206634;
sentinel = G__206635;
is_recursive = G__206636;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__206639 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__206639,0,null);var years = cljs.core.nth.call(null,vec__206639,1,null);var months = cljs.core.nth.call(null,vec__206639,2,null);var days = cljs.core.nth.call(null,vec__206639,3,null);var hours = cljs.core.nth.call(null,vec__206639,4,null);var minutes = cljs.core.nth.call(null,vec__206639,5,null);var seconds = cljs.core.nth.call(null,vec__206639,6,null);var fraction = cljs.core.nth.call(null,vec__206639,7,null);var offset_sign = cljs.core.nth.call(null,vec__206639,8,null);var offset_hours = cljs.core.nth.call(null,vec__206639,9,null);var offset_minutes = cljs.core.nth.call(null,vec__206639,10,null);var v = vec__206639;if(cljs.core.not.call(null,v))
...
{var vec__206641 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__206641,0,null);var months = cljs.core.nth.call(null,vec__206641,1,null);var days = cljs.core.nth.call(null,vec__206641,2,null);var hours = cljs.core.nth.call(null,vec__206641,3,null);var minutes = cljs.core.nth.call(null,vec__206641,4,null);var seconds = cljs.core.nth.call(null,vec__206641,5,null);var ms = cljs.core.nth.call(null,vec__206641,6,null);var offset = cljs.core.nth.call(null,vec__206641,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
