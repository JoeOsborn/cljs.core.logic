...
{{
var G__327262 = cljs.core.pop.call(null,v__$1);
v__$1 = G__327262;
continue;
}
} else
...
{var pred__327266 = cljs.core._EQ_;var expr__327267 = limit;if(pred__327266.call(null,1,expr__327267))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__327266.call(null,2,expr__327267))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__327269 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__327270 = (limit__$1 - 1);
var G__327271 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__327269;
limit__$1 = G__327270;
parts = G__327271;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___327273 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___327273))
{var replacement_327274 = temp__4092__auto___327273;buffer.append([cljs.core.str(replacement_327274)].join(''));
} else
{buffer.append(ch);
}
{
var G__327275 = (index + 1);
index = G__327275;
continue;
}
}
