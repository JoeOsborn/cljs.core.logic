...
{{
var G__10152 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10152;
continue;
}
} else
...
{var pred__10156 = cljs.core._EQ_;var expr__10157 = limit;if(pred__10156.call(null,1,expr__10157))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10156.call(null,2,expr__10157))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10159 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10160 = (limit__$1 - 1);
var G__10161 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10159;
limit__$1 = G__10160;
parts = G__10161;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10163 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10163))
{var replacement_10164 = temp__4092__auto___10163;buffer.append([cljs.core.str(replacement_10164)].join(''));
} else
{buffer.append(ch);
}
{
var G__10165 = (index + 1);
index = G__10165;
continue;
}
}
