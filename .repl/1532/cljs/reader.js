...
reader_error.cljs$lang$applyTo = (function (arglist__10448){
var rdr = cljs.core.first(arglist__10448);
var msg = cljs.core.rest(arglist__10448);
...
{{
var G__10449 = (function (){sb.append(ch);
return sb;
})();
var G__10450 = cljs.reader.read_char.call(null,rdr);
sb = G__10449;
ch = G__10450;
continue;
}
...
{{
var G__10451 = cljs.reader.read_char.call(null,rdr);
ch = G__10451;
continue;
}
} else
...
var G__10452 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10452;
continue;
}
} else
...
var G__10453 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10453;
continue;
}
}
...
{{
var G__10454 = (function (){buffer.append(ch);
return buffer;
})();
var G__10455 = cljs.reader.read_char.call(null,reader);
buffer = G__10454;
ch = G__10455;
continue;
}
...
{if(("\\" === ch))
{{
var G__10456 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10457 = cljs.reader.read_char.call(null,reader);
buffer = G__10456;
ch = G__10457;
continue;
}
...
{{
var G__10458 = (function (){buffer.append(ch);
return buffer;
})();
var G__10459 = cljs.reader.read_char.call(null,reader);
buffer = G__10458;
ch = G__10459;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10461 = o;if(G__10461)
{var bit__5323__auto__ = (G__10461.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__10461.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10461.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10461);
} else
{return false;
}
}
...
{{
var G__10462 = reader;
var G__10463 = eof_is_error;
var G__10464 = sentinel;
var G__10465 = is_recursive;
reader = G__10462;
eof_is_error = G__10463;
sentinel = G__10464;
is_recursive = G__10465;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10466 = cljs.reader.read_comment.call(null,reader,ch);
var G__10467 = eof_is_error;
var G__10468 = sentinel;
var G__10469 = is_recursive;
reader = G__10466;
eof_is_error = G__10467;
sentinel = G__10468;
is_recursive = G__10469;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10470 = reader;
var G__10471 = eof_is_error;
var G__10472 = sentinel;
var G__10473 = is_recursive;
reader = G__10470;
eof_is_error = G__10471;
sentinel = G__10472;
is_recursive = G__10473;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10476 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10476,0,null);var years = cljs.core.nth.call(null,vec__10476,1,null);var months = cljs.core.nth.call(null,vec__10476,2,null);var days = cljs.core.nth.call(null,vec__10476,3,null);var hours = cljs.core.nth.call(null,vec__10476,4,null);var minutes = cljs.core.nth.call(null,vec__10476,5,null);var seconds = cljs.core.nth.call(null,vec__10476,6,null);var fraction = cljs.core.nth.call(null,vec__10476,7,null);var offset_sign = cljs.core.nth.call(null,vec__10476,8,null);var offset_hours = cljs.core.nth.call(null,vec__10476,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10476,10,null);var v = vec__10476;if(cljs.core.not.call(null,v))
...
{var vec__10478 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__10478,0,null);var months = cljs.core.nth.call(null,vec__10478,1,null);var days = cljs.core.nth.call(null,vec__10478,2,null);var hours = cljs.core.nth.call(null,vec__10478,3,null);var minutes = cljs.core.nth.call(null,vec__10478,4,null);var seconds = cljs.core.nth.call(null,vec__10478,5,null);var ms = cljs.core.nth.call(null,vec__10478,6,null);var offset = cljs.core.nth.call(null,vec__10478,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
