...
reader_error.cljs$lang$applyTo = (function (arglist__10491){
var rdr = cljs.core.first(arglist__10491);
var msg = cljs.core.rest(arglist__10491);
...
{{
var G__10492 = (function (){sb.append(ch);
return sb;
})();
var G__10493 = cljs.reader.read_char.call(null,rdr);
sb = G__10492;
ch = G__10493;
continue;
}
...
{{
var G__10494 = cljs.reader.read_char.call(null,rdr);
ch = G__10494;
continue;
}
} else
...
var G__10495 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10495;
continue;
}
} else
...
var G__10496 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10496;
continue;
}
}
...
{{
var G__10497 = (function (){buffer.append(ch);
return buffer;
})();
var G__10498 = cljs.reader.read_char.call(null,reader);
buffer = G__10497;
ch = G__10498;
continue;
}
...
{if(("\\" === ch))
{{
var G__10499 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10500 = cljs.reader.read_char.call(null,reader);
buffer = G__10499;
ch = G__10500;
continue;
}
...
{{
var G__10501 = (function (){buffer.append(ch);
return buffer;
})();
var G__10502 = cljs.reader.read_char.call(null,reader);
buffer = G__10501;
ch = G__10502;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10504 = o;if(G__10504)
{var bit__5323__auto__ = (G__10504.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__10504.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10504.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10504);
} else
{return false;
}
}
...
{{
var G__10505 = reader;
var G__10506 = eof_is_error;
var G__10507 = sentinel;
var G__10508 = is_recursive;
reader = G__10505;
eof_is_error = G__10506;
sentinel = G__10507;
is_recursive = G__10508;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__10509 = cljs.reader.read_comment.call(null,reader,ch);
var G__10510 = eof_is_error;
var G__10511 = sentinel;
var G__10512 = is_recursive;
reader = G__10509;
eof_is_error = G__10510;
sentinel = G__10511;
is_recursive = G__10512;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10513 = reader;
var G__10514 = eof_is_error;
var G__10515 = sentinel;
var G__10516 = is_recursive;
reader = G__10513;
eof_is_error = G__10514;
sentinel = G__10515;
is_recursive = G__10516;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10519 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10519,0,null);var years = cljs.core.nth.call(null,vec__10519,1,null);var months = cljs.core.nth.call(null,vec__10519,2,null);var days = cljs.core.nth.call(null,vec__10519,3,null);var hours = cljs.core.nth.call(null,vec__10519,4,null);var minutes = cljs.core.nth.call(null,vec__10519,5,null);var seconds = cljs.core.nth.call(null,vec__10519,6,null);var fraction = cljs.core.nth.call(null,vec__10519,7,null);var offset_sign = cljs.core.nth.call(null,vec__10519,8,null);var offset_hours = cljs.core.nth.call(null,vec__10519,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10519,10,null);var v = vec__10519;if(cljs.core.not.call(null,v))
...
{var vec__10521 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__10521,0,null);var months = cljs.core.nth.call(null,vec__10521,1,null);var days = cljs.core.nth.call(null,vec__10521,2,null);var hours = cljs.core.nth.call(null,vec__10521,3,null);var minutes = cljs.core.nth.call(null,vec__10521,4,null);var seconds = cljs.core.nth.call(null,vec__10521,5,null);var ms = cljs.core.nth.call(null,vec__10521,6,null);var offset = cljs.core.nth.call(null,vec__10521,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
