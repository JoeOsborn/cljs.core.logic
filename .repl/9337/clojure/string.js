...
{{
var G__10522 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10522;
continue;
}
} else
...
{var pred__10526 = cljs.core._EQ_;var expr__10527 = limit;if(pred__10526.call(null,1,expr__10527))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10526.call(null,2,expr__10527))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10529 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10530 = (limit__$1 - 1);
var G__10531 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10529;
limit__$1 = G__10530;
parts = G__10531;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10533 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10533))
{var replacement_10534 = temp__4092__auto___10533;buffer.append([cljs.core.str(replacement_10534)].join(''));
} else
{buffer.append(ch);
}
{
var G__10535 = (index + 1);
index = G__10535;
continue;
}
}
