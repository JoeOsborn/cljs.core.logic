...
{{
var G__29672 = cljs.core.pop.call(null,v__$1);
v__$1 = G__29672;
continue;
}
} else
...
{var pred__29678 = cljs.core._EQ_;var expr__29679 = limit;if(pred__29678.call(null,1,expr__29679))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__29678.call(null,2,expr__29679))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
{var temp__4092__auto__ = cljs.core.re_find.call(null,re,s__$1);if(temp__4092__auto__)
{var m = temp__4092__auto__;var index = s__$1.indexOf(m);{
var G__29681 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__29682 = (limit__$1 - 1);
var G__29683 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__29681;
limit__$1 = G__29682;
parts = G__29683;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___29701 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___29701))
{var replacement_29702 = temp__4092__auto___29701;buffer.append([cljs.core.str(replacement_29702)].join(''));
} else
{buffer.append(ch);
}
{
var G__29703 = (index + 1);
index = G__29703;
continue;
}
}
