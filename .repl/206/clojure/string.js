...
{{
var G__238515 = cljs.core.pop.call(null,v__$1);
v__$1 = G__238515;
continue;
}
} else
...
{var pred__238519 = cljs.core._EQ_;var expr__238520 = limit;if(cljs.core.truth_(pred__238519.call(null,1,expr__238520)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__238519.call(null,2,expr__238520)))
...
var G__238522 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__238523 = (limit__$1 - 1);
var G__238524 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__238522;
limit__$1 = G__238523;
parts = G__238524;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___238526 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___238526))
{var replacement_238527 = temp__4096__auto___238526;buffer.append([cljs.core.str(replacement_238527)].join(''));
} else
{buffer.append(ch);
}
{
var G__238528 = (index + 1);
index = G__238528;
continue;
}
}
