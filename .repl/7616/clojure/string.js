...
{{
var G__61059 = cljs.core.pop.call(null,v__$1);
v__$1 = G__61059;
continue;
}
} else
...
{var pred__61063 = cljs.core._EQ_;var expr__61064 = limit;if(pred__61063.call(null,1,expr__61064))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__61063.call(null,2,expr__61064))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__61066 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__61067 = (limit__$1 - 1);
var G__61068 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__61066;
limit__$1 = G__61067;
parts = G__61068;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___61070 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___61070))
{var replacement_61071 = temp__4092__auto___61070;buffer.append([cljs.core.str(replacement_61071)].join(''));
} else
{buffer.append(ch);
}
{
var G__61072 = (index + 1);
index = G__61072;
continue;
}
}
