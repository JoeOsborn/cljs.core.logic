...
{{
var G__9728 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9728;
continue;
}
} else
...
{var pred__9732 = cljs.core._EQ_;var expr__9733 = limit;if(pred__9732.call(null,1,expr__9733))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9732.call(null,2,expr__9733))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
{var ch = s.charAt(index);var temp__4092__auto___9739 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9739))
{var replacement_9740 = temp__4092__auto___9739;buffer.append([cljs.core.str(replacement_9740)].join(''));
} else
{buffer.append(ch);
}
{
