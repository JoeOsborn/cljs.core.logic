...
reader_error.cljs$lang$applyTo = (function (arglist__9697){
var rdr = cljs.core.first(arglist__9697);
var msg = cljs.core.rest(arglist__9697);
...
{{
var G__9698 = (function (){sb.append(ch);
return sb;
})();
var G__9699 = cljs.reader.read_char.call(null,rdr);
sb = G__9698;
ch = G__9699;
continue;
}
...
{{
var G__9700 = cljs.reader.read_char.call(null,rdr);
ch = G__9700;
continue;
}
} else
...
var G__9701 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9701;
continue;
}
} else
...
var G__9702 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9702;
continue;
}
}
...
{{
var G__9703 = (function (){buffer.append(ch);
return buffer;
})();
var G__9704 = cljs.reader.read_char.call(null,reader);
buffer = G__9703;
ch = G__9704;
continue;
}
...
{if(("\\" === ch))
{{
var G__9705 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9706 = cljs.reader.read_char.call(null,reader);
buffer = G__9705;
ch = G__9706;
continue;
}
...
{{
var G__9707 = (function (){buffer.append(ch);
return buffer;
})();
var G__9708 = cljs.reader.read_char.call(null,reader);
buffer = G__9707;
ch = G__9708;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9710 = o;if(G__9710)
{var bit__5323__auto__ = (G__9710.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9710.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9710.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9710);
} else
{return false;
}
}
...
{{
var G__9711 = reader;
var G__9712 = eof_is_error;
var G__9713 = sentinel;
var G__9714 = is_recursive;
reader = G__9711;
eof_is_error = G__9712;
sentinel = G__9713;
is_recursive = G__9714;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9715 = cljs.reader.read_comment.call(null,reader,ch);
var G__9716 = eof_is_error;
var G__9717 = sentinel;
var G__9718 = is_recursive;
reader = G__9715;
eof_is_error = G__9716;
sentinel = G__9717;
is_recursive = G__9718;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9719 = reader;
var G__9720 = eof_is_error;
var G__9721 = sentinel;
var G__9722 = is_recursive;
reader = G__9719;
eof_is_error = G__9720;
sentinel = G__9721;
is_recursive = G__9722;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9725 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9725,0,null);var years = cljs.core.nth.call(null,vec__9725,1,null);var months = cljs.core.nth.call(null,vec__9725,2,null);var days = cljs.core.nth.call(null,vec__9725,3,null);var hours = cljs.core.nth.call(null,vec__9725,4,null);var minutes = cljs.core.nth.call(null,vec__9725,5,null);var seconds = cljs.core.nth.call(null,vec__9725,6,null);var fraction = cljs.core.nth.call(null,vec__9725,7,null);var offset_sign = cljs.core.nth.call(null,vec__9725,8,null);var offset_hours = cljs.core.nth.call(null,vec__9725,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9725,10,null);var v = vec__9725;if(cljs.core.not.call(null,v))
...
{var vec__9727 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9727,0,null);var months = cljs.core.nth.call(null,vec__9727,1,null);var days = cljs.core.nth.call(null,vec__9727,2,null);var hours = cljs.core.nth.call(null,vec__9727,3,null);var minutes = cljs.core.nth.call(null,vec__9727,4,null);var seconds = cljs.core.nth.call(null,vec__9727,5,null);var ms = cljs.core.nth.call(null,vec__9727,6,null);var offset = cljs.core.nth.call(null,vec__9727,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
