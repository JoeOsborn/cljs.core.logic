...
{{
var G__572841 = cljs.core.pop.call(null,v__$1);
v__$1 = G__572841;
continue;
}
} else
...
{var pred__572845 = cljs.core._EQ_;var expr__572846 = limit;if(cljs.core.truth_(pred__572845.call(null,1,expr__572846)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__572845.call(null,2,expr__572846)))
...
var G__572848 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__572849 = (limit__$1 - 1);
var G__572850 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__572848;
limit__$1 = G__572849;
parts = G__572850;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___572852 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___572852))
{var replacement_572853 = temp__4096__auto___572852;buffer.append([cljs.core.str(replacement_572853)].join(''));
} else
{buffer.append(ch);
}
{
var G__572854 = (index + 1);
index = G__572854;
continue;
}
}
