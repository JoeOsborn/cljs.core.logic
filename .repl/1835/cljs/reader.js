...
reader_error.cljs$lang$applyTo = (function (arglist__10125){
var rdr = cljs.core.first(arglist__10125);
var msg = cljs.core.rest(arglist__10125);
...
{{
var G__10126 = (function (){sb.append(ch);
return sb;
})();
var G__10127 = cljs.reader.read_char.call(null,rdr);
sb = G__10126;
ch = G__10127;
continue;
}
...
{{
var G__10128 = cljs.reader.read_char.call(null,rdr);
ch = G__10128;
continue;
}
} else
...
var G__10129 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10129;
continue;
}
} else
...
var G__10130 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10130;
continue;
}
}
...
{if(("\\" === ch))
{{
var G__10133 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__10134 = cljs.reader.read_char.call(null,reader);
buffer = G__10133;
ch = G__10134;
continue;
}
...
{{
var G__10135 = (function (){buffer.append(ch);
return buffer;
})();
var G__10136 = cljs.reader.read_char.call(null,reader);
buffer = G__10135;
ch = G__10136;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10138 = o;if(G__10138)
{var bit__5323__auto__ = (G__10138.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__10138.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__10138.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__10138);
} else
{return false;
}
}
...
{{
var G__10143 = cljs.reader.read_comment.call(null,reader,ch);
...
{{
var G__10147 = reader;
var G__10148 = eof_is_error;
var G__10149 = sentinel;
var G__10150 = is_recursive;
reader = G__10147;
eof_is_error = G__10148;
sentinel = G__10149;
is_recursive = G__10150;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10153 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10153,0,null);var years = cljs.core.nth.call(null,vec__10153,1,null);var months = cljs.core.nth.call(null,vec__10153,2,null);var days = cljs.core.nth.call(null,vec__10153,3,null);var hours = cljs.core.nth.call(null,vec__10153,4,null);var minutes = cljs.core.nth.call(null,vec__10153,5,null);var seconds = cljs.core.nth.call(null,vec__10153,6,null);var fraction = cljs.core.nth.call(null,vec__10153,7,null);var offset_sign = cljs.core.nth.call(null,vec__10153,8,null);var offset_hours = cljs.core.nth.call(null,vec__10153,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10153,10,null);var v = vec__10153;if(cljs.core.not.call(null,v))
...
{var vec__10155 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__10155,0,null);var months = cljs.core.nth.call(null,vec__10155,1,null);var days = cljs.core.nth.call(null,vec__10155,2,null);var hours = cljs.core.nth.call(null,vec__10155,3,null);var minutes = cljs.core.nth.call(null,vec__10155,4,null);var seconds = cljs.core.nth.call(null,vec__10155,5,null);var ms = cljs.core.nth.call(null,vec__10155,6,null);var offset = cljs.core.nth.call(null,vec__10155,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
