...
{{
var G__10156 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10156;
continue;
}
} else
...
{var pred__10160 = cljs.core._EQ_;var expr__10161 = limit;if(pred__10160.call(null,1,expr__10161))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__10160.call(null,2,expr__10161))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__10163 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10164 = (limit__$1 - 1);
var G__10165 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10163;
limit__$1 = G__10164;
parts = G__10165;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___10167 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___10167))
{var replacement_10168 = temp__4092__auto___10167;buffer.append([cljs.core.str(replacement_10168)].join(''));
} else
{buffer.append(ch);
}
{
var G__10169 = (index + 1);
index = G__10169;
continue;
}
}
