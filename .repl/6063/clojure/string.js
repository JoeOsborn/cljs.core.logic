...
{{
var G__58522 = cljs.core.pop.call(null,v__$1);
v__$1 = G__58522;
continue;
}
} else
...
{var pred__58526 = cljs.core._EQ_;var expr__58527 = limit;if(pred__58526.call(null,1,expr__58527))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__58526.call(null,2,expr__58527))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__58529 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__58530 = (limit__$1 - 1);
var G__58531 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__58529;
limit__$1 = G__58530;
parts = G__58531;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___58533 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___58533))
{var replacement_58534 = temp__4092__auto___58533;buffer.append([cljs.core.str(replacement_58534)].join(''));
} else
{buffer.append(ch);
}
{
var G__58535 = (index + 1);
index = G__58535;
continue;
}
}
