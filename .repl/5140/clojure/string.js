...
{{
var G__18767 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18767;
continue;
}
} else
...
{var pred__18771 = cljs.core._EQ_;var expr__18772 = limit;if(pred__18771.call(null,1,expr__18772))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__18771.call(null,2,expr__18772))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__18774 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18775 = (limit__$1 - 1);
var G__18776 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18774;
limit__$1 = G__18775;
parts = G__18776;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___18778 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___18778))
{var replacement_18779 = temp__4092__auto___18778;buffer.append([cljs.core.str(replacement_18779)].join(''));
} else
{buffer.append(ch);
}
{
var G__18780 = (index + 1);
index = G__18780;
continue;
}
}
