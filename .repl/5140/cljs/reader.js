...
reader_error.cljs$lang$applyTo = (function (arglist__18736){
var rdr = cljs.core.first(arglist__18736);
var msg = cljs.core.rest(arglist__18736);
...
{{
var G__18737 = (function (){sb.append(ch);
return sb;
})();
...
{{
var G__18739 = cljs.reader.read_char.call(null,rdr);
ch = G__18739;
continue;
}
} else
...
var G__18740 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__18740;
continue;
}
} else
...
var G__18741 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__18741;
continue;
}
}
...
{{
var G__18742 = (function (){buffer.append(ch);
return buffer;
})();
var G__18743 = cljs.reader.read_char.call(null,reader);
buffer = G__18742;
ch = G__18743;
continue;
}
...
{if(("\\" === ch))
{{
var G__18744 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__18745 = cljs.reader.read_char.call(null,reader);
buffer = G__18744;
ch = G__18745;
continue;
}
...
{{
var G__18746 = (function (){buffer.append(ch);
return buffer;
})();
var G__18747 = cljs.reader.read_char.call(null,reader);
buffer = G__18746;
ch = G__18747;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__18749 = o;if(G__18749)
{var bit__5323__auto__ = (G__18749.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__18749.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__18749.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__18749);
} else
{return false;
}
}
...
{{
var G__18750 = reader;
var G__18751 = eof_is_error;
var G__18752 = sentinel;
var G__18753 = is_recursive;
reader = G__18750;
eof_is_error = G__18751;
sentinel = G__18752;
is_recursive = G__18753;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__18754 = cljs.reader.read_comment.call(null,reader,ch);
var G__18755 = eof_is_error;
var G__18756 = sentinel;
var G__18757 = is_recursive;
reader = G__18754;
eof_is_error = G__18755;
sentinel = G__18756;
is_recursive = G__18757;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__18758 = reader;
var G__18759 = eof_is_error;
var G__18760 = sentinel;
var G__18761 = is_recursive;
reader = G__18758;
eof_is_error = G__18759;
sentinel = G__18760;
is_recursive = G__18761;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__18764 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__18764,0,null);var years = cljs.core.nth.call(null,vec__18764,1,null);var months = cljs.core.nth.call(null,vec__18764,2,null);var days = cljs.core.nth.call(null,vec__18764,3,null);var hours = cljs.core.nth.call(null,vec__18764,4,null);var minutes = cljs.core.nth.call(null,vec__18764,5,null);var seconds = cljs.core.nth.call(null,vec__18764,6,null);var fraction = cljs.core.nth.call(null,vec__18764,7,null);var offset_sign = cljs.core.nth.call(null,vec__18764,8,null);var offset_hours = cljs.core.nth.call(null,vec__18764,9,null);var offset_minutes = cljs.core.nth.call(null,vec__18764,10,null);var v = vec__18764;if(cljs.core.not.call(null,v))
...
{var vec__18766 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__18766,0,null);var months = cljs.core.nth.call(null,vec__18766,1,null);var days = cljs.core.nth.call(null,vec__18766,2,null);var hours = cljs.core.nth.call(null,vec__18766,3,null);var minutes = cljs.core.nth.call(null,vec__18766,4,null);var seconds = cljs.core.nth.call(null,vec__18766,5,null);var ms = cljs.core.nth.call(null,vec__18766,6,null);var offset = cljs.core.nth.call(null,vec__18766,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
