...
{{
var G__68185 = cljs.core.pop.call(null,v__$1);
v__$1 = G__68185;
continue;
}
} else
...
{var pred__68189 = cljs.core._EQ_;var expr__68190 = limit;if(pred__68189.call(null,1,expr__68190))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__68189.call(null,2,expr__68190))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__68192 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__68193 = (limit__$1 - 1);
var G__68194 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__68192;
limit__$1 = G__68193;
parts = G__68194;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___68196 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___68196))
{var replacement_68197 = temp__4092__auto___68196;buffer.append([cljs.core.str(replacement_68197)].join(''));
} else
{buffer.append(ch);
}
{
var G__68198 = (index + 1);
index = G__68198;
continue;
}
}
