...
reader_error.cljs$lang$applyTo = (function (arglist__68154){
var rdr = cljs.core.first(arglist__68154);
var msg = cljs.core.rest(arglist__68154);
...
{{
var G__68155 = (function (){sb.append(ch);
return sb;
})();
var G__68156 = cljs.reader.read_char.call(null,rdr);
sb = G__68155;
ch = G__68156;
continue;
}
...
{{
var G__68157 = cljs.reader.read_char.call(null,rdr);
ch = G__68157;
continue;
}
} else
...
var G__68158 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__68158;
continue;
}
} else
...
var G__68159 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__68159;
continue;
}
}
...
{{
var G__68160 = (function (){buffer.append(ch);
return buffer;
})();
var G__68161 = cljs.reader.read_char.call(null,reader);
buffer = G__68160;
ch = G__68161;
continue;
}
...
{if(("\\" === ch))
{{
var G__68162 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__68163 = cljs.reader.read_char.call(null,reader);
buffer = G__68162;
ch = G__68163;
continue;
}
...
{{
var G__68164 = (function (){buffer.append(ch);
return buffer;
})();
var G__68165 = cljs.reader.read_char.call(null,reader);
buffer = G__68164;
ch = G__68165;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__68167 = o;if(G__68167)
{var bit__5323__auto__ = (G__68167.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__68167.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__68167.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__68167);
} else
{return false;
}
}
...
{{
var G__68168 = reader;
var G__68169 = eof_is_error;
var G__68170 = sentinel;
var G__68171 = is_recursive;
reader = G__68168;
eof_is_error = G__68169;
sentinel = G__68170;
is_recursive = G__68171;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__68172 = cljs.reader.read_comment.call(null,reader,ch);
var G__68173 = eof_is_error;
var G__68174 = sentinel;
var G__68175 = is_recursive;
reader = G__68172;
eof_is_error = G__68173;
sentinel = G__68174;
is_recursive = G__68175;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__68176 = reader;
var G__68177 = eof_is_error;
var G__68178 = sentinel;
var G__68179 = is_recursive;
reader = G__68176;
eof_is_error = G__68177;
sentinel = G__68178;
is_recursive = G__68179;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__68182 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__68182,0,null);var years = cljs.core.nth.call(null,vec__68182,1,null);var months = cljs.core.nth.call(null,vec__68182,2,null);var days = cljs.core.nth.call(null,vec__68182,3,null);var hours = cljs.core.nth.call(null,vec__68182,4,null);var minutes = cljs.core.nth.call(null,vec__68182,5,null);var seconds = cljs.core.nth.call(null,vec__68182,6,null);var fraction = cljs.core.nth.call(null,vec__68182,7,null);var offset_sign = cljs.core.nth.call(null,vec__68182,8,null);var offset_hours = cljs.core.nth.call(null,vec__68182,9,null);var offset_minutes = cljs.core.nth.call(null,vec__68182,10,null);var v = vec__68182;if(cljs.core.not.call(null,v))
...
{var vec__68184 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__68184,0,null);var months = cljs.core.nth.call(null,vec__68184,1,null);var days = cljs.core.nth.call(null,vec__68184,2,null);var hours = cljs.core.nth.call(null,vec__68184,3,null);var minutes = cljs.core.nth.call(null,vec__68184,4,null);var seconds = cljs.core.nth.call(null,vec__68184,5,null);var ms = cljs.core.nth.call(null,vec__68184,6,null);var offset = cljs.core.nth.call(null,vec__68184,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
