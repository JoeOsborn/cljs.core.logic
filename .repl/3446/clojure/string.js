...
{{
var G__323166 = cljs.core.pop.call(null,v__$1);
v__$1 = G__323166;
continue;
}
} else
...
{var pred__323170 = cljs.core._EQ_;var expr__323171 = limit;if(cljs.core.truth_(pred__323170.call(null,1,expr__323171)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__323170.call(null,2,expr__323171)))
...
var G__323173 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__323174 = (limit__$1 - 1);
var G__323175 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__323173;
limit__$1 = G__323174;
parts = G__323175;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___323177 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___323177))
{var replacement_323178 = temp__4096__auto___323177;buffer.append([cljs.core.str(replacement_323178)].join(''));
} else
{buffer.append(ch);
}
{
var G__323179 = (index + 1);
index = G__323179;
continue;
}
}
