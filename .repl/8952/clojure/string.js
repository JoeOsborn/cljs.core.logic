...
{{
var G__275841 = cljs.core.pop.call(null,v__$1);
v__$1 = G__275841;
continue;
}
} else
...
{var pred__275845 = cljs.core._EQ_;var expr__275846 = limit;if(cljs.core.truth_(pred__275845.call(null,1,expr__275846)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__275845.call(null,2,expr__275846)))
...
var G__275848 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__275849 = (limit__$1 - 1);
var G__275850 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__275848;
limit__$1 = G__275849;
parts = G__275850;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___275852 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___275852))
{var replacement_275853 = temp__4096__auto___275852;buffer.append([cljs.core.str(replacement_275853)].join(''));
} else
{buffer.append(ch);
}
{
var G__275854 = (index + 1);
index = G__275854;
continue;
}
}
