...
{{
var G__93741 = cljs.core.pop.call(null,v__$1);
v__$1 = G__93741;
continue;
}
} else
...
{var pred__93745 = cljs.core._EQ_;var expr__93746 = limit;if(cljs.core.truth_(pred__93745.call(null,1,expr__93746)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__93745.call(null,2,expr__93746)))
...
var G__93748 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__93749 = (limit__$1 - 1);
var G__93750 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__93748;
limit__$1 = G__93749;
parts = G__93750;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___93752 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___93752))
{var replacement_93753 = temp__4096__auto___93752;buffer.append([cljs.core.str(replacement_93753)].join(''));
} else
{buffer.append(ch);
}
{
var G__93754 = (index + 1);
index = G__93754;
continue;
}
}
