...
{{
var G__150946 = cljs.core.pop.call(null,v__$1);
v__$1 = G__150946;
continue;
}
} else
...
{var pred__150950 = cljs.core._EQ_;var expr__150951 = limit;if(pred__150950.call(null,1,expr__150951))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__150950.call(null,2,expr__150951))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__150953 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__150954 = (limit__$1 - 1);
var G__150955 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__150953;
limit__$1 = G__150954;
parts = G__150955;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___150957 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___150957))
{var replacement_150958 = temp__4092__auto___150957;buffer.append([cljs.core.str(replacement_150958)].join(''));
} else
{buffer.append(ch);
}
{
var G__150959 = (index + 1);
index = G__150959;
continue;
}
}
