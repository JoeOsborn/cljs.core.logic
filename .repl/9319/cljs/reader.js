...
reader_error.cljs$lang$applyTo = (function (arglist__151242){
var rdr = cljs.core.first(arglist__151242);
var msg = cljs.core.rest(arglist__151242);
...
{{
var G__151243 = (function (){sb.append(ch);
return sb;
})();
var G__151244 = cljs.reader.read_char.call(null,rdr);
sb = G__151243;
ch = G__151244;
continue;
}
...
{{
var G__151245 = cljs.reader.read_char.call(null,rdr);
ch = G__151245;
continue;
}
} else
...
var G__151246 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__151246;
continue;
}
} else
...
var G__151247 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__151247;
continue;
}
}
...
{{
var G__151248 = (function (){buffer.append(ch);
return buffer;
})();
var G__151249 = cljs.reader.read_char.call(null,reader);
buffer = G__151248;
ch = G__151249;
continue;
}
...
{if(("\\" === ch))
{{
var G__151250 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__151251 = cljs.reader.read_char.call(null,reader);
buffer = G__151250;
ch = G__151251;
continue;
}
...
{{
var G__151252 = (function (){buffer.append(ch);
return buffer;
})();
var G__151253 = cljs.reader.read_char.call(null,reader);
buffer = G__151252;
ch = G__151253;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__151255 = o;if(G__151255)
{var bit__5323__auto__ = (G__151255.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__151255.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__151255.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__151255);
} else
{return false;
}
}
...
{{
var G__151256 = reader;
var G__151257 = eof_is_error;
var G__151258 = sentinel;
var G__151259 = is_recursive;
reader = G__151256;
eof_is_error = G__151257;
sentinel = G__151258;
is_recursive = G__151259;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__151260 = cljs.reader.read_comment.call(null,reader,ch);
var G__151261 = eof_is_error;
var G__151262 = sentinel;
var G__151263 = is_recursive;
reader = G__151260;
eof_is_error = G__151261;
sentinel = G__151262;
is_recursive = G__151263;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__151264 = reader;
var G__151265 = eof_is_error;
var G__151266 = sentinel;
var G__151267 = is_recursive;
reader = G__151264;
eof_is_error = G__151265;
sentinel = G__151266;
is_recursive = G__151267;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__151270 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__151270,0,null);var years = cljs.core.nth.call(null,vec__151270,1,null);var months = cljs.core.nth.call(null,vec__151270,2,null);var days = cljs.core.nth.call(null,vec__151270,3,null);var hours = cljs.core.nth.call(null,vec__151270,4,null);var minutes = cljs.core.nth.call(null,vec__151270,5,null);var seconds = cljs.core.nth.call(null,vec__151270,6,null);var fraction = cljs.core.nth.call(null,vec__151270,7,null);var offset_sign = cljs.core.nth.call(null,vec__151270,8,null);var offset_hours = cljs.core.nth.call(null,vec__151270,9,null);var offset_minutes = cljs.core.nth.call(null,vec__151270,10,null);var v = vec__151270;if(cljs.core.not.call(null,v))
...
{var vec__151272 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__151272,0,null);var months = cljs.core.nth.call(null,vec__151272,1,null);var days = cljs.core.nth.call(null,vec__151272,2,null);var hours = cljs.core.nth.call(null,vec__151272,3,null);var minutes = cljs.core.nth.call(null,vec__151272,4,null);var seconds = cljs.core.nth.call(null,vec__151272,5,null);var ms = cljs.core.nth.call(null,vec__151272,6,null);var offset = cljs.core.nth.call(null,vec__151272,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
