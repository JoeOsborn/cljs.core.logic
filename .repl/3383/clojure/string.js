...
{{
var G__295678 = cljs.core.pop.call(null,v__$1);
v__$1 = G__295678;
continue;
}
} else
...
{var pred__295682 = cljs.core._EQ_;var expr__295683 = limit;if(cljs.core.truth_(pred__295682.call(null,1,expr__295683)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__295682.call(null,2,expr__295683)))
...
var G__295685 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__295686 = (limit__$1 - 1);
var G__295687 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__295685;
limit__$1 = G__295686;
parts = G__295687;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___295689 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___295689))
{var replacement_295690 = temp__4096__auto___295689;buffer.append([cljs.core.str(replacement_295690)].join(''));
} else
{buffer.append(ch);
}
{
var G__295691 = (index + 1);
index = G__295691;
continue;
}
}
