...
{{
var G__14950 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14950;
continue;
}
} else
...
{var pred__14954 = cljs.core._EQ_;var expr__14955 = limit;if(pred__14954.call(null,1,expr__14955))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__14954.call(null,2,expr__14955))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__14957 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14958 = (limit__$1 - 1);
var G__14959 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14957;
limit__$1 = G__14958;
parts = G__14959;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___14961 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___14961))
{var replacement_14962 = temp__4092__auto___14961;buffer.append([cljs.core.str(replacement_14962)].join(''));
} else
{buffer.append(ch);
}
{
