...
cljs.core.logic.pldb.facts_for = (function facts_for(dbs,kname){return cljs.core.mapcat.call(null,(function (p1__14574_SHARP_){return cljs.core.get_in.call(null,p1__14574_SHARP_,cljs.core.PersistentVector.fromArray([kname,new cljs.core.Keyword("cljs.core.logic.pldb","unindexed","cljs.core.logic.pldb/unindexed",3813484278)], true));
}),dbs);
});
cljs.core.logic.pldb.facts_using_index = (function facts_using_index(dbs,kname,index,val){return cljs.core.mapcat.call(null,(function (p1__14575_SHARP_){return cljs.core.get_in.call(null,p1__14575_SHARP_,cljs.core.PersistentVector.fromArray([kname,index,val], true));
}),dbs);
});
...
cljs.core.logic.pldb.index_for_query = (function index_for_query(s,q,indexes){var indexable = cljs.core.map.call(null,(function (p1__14576_SHARP_){return cljs.core.logic.pldb.ground_QMARK_.call(null,s,p1__14576_SHARP_);
}),q);var triples = cljs.core.map.call(null,cljs.core.vector,cljs.core.range.call(null),indexable,indexes);return cljs.core.first.call(null,(function (){var iter__5390__auto__ = (function iter__14585(s__14586){return (new cljs.core.LazySeq(null,(function (){var s__14586__$1 = s__14586;while(true){
var temp__4094__auto__ = cljs.core.seq.call(null,s__14586__$1);if(temp__4094__auto__)
{var s__14586__$2 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__14586__$2))
{var c__5388__auto__ = cljs.core.chunk_first.call(null,s__14586__$2);var size__5389__auto__ = cljs.core.count.call(null,c__5388__auto__);var b__14588 = cljs.core.chunk_buffer.call(null,size__5389__auto__);if((function (){var i__14587 = 0;while(true){
if((i__14587 < size__5389__auto__))
{var vec__14591 = cljs.core._nth.call(null,c__5388__auto__,i__14587);var i = cljs.core.nth.call(null,vec__14591,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__14591,1,null);var indexed = cljs.core.nth.call(null,vec__14591,2,null);if(cljs.core.truth_((function (){var and__4695__auto__ = indexable__$1;if(cljs.core.truth_(and__4695__auto__))
{return indexed;
} else
{return and__4695__auto__;
}
})()))
{cljs.core.chunk_append.call(null,b__14588,i);
{
var G__14593 = (i__14587 + 1);
i__14587 = G__14593;
continue;
}
} else
{{
var G__14594 = (i__14587 + 1);
i__14587 = G__14594;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14588),iter__14585.call(null,cljs.core.chunk_rest.call(null,s__14586__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14588),null);
}
} else
{var vec__14592 = cljs.core.first.call(null,s__14586__$2);var i = cljs.core.nth.call(null,vec__14592,0,null);var indexable__$1 = cljs.core.nth.call(null,vec__14592,1,null);var indexed = cljs.core.nth.call(null,vec__14592,2,null);if(cljs.core.truth_((function (){var and__4695__auto__ = indexable__$1;if(cljs.core.truth_(and__4695__auto__))
{return indexed;
} else
{return and__4695__auto__;
}
})()))
{return cljs.core.cons.call(null,i,iter__14585.call(null,cljs.core.rest.call(null,s__14586__$2)));
} else
{{
var G__14595 = cljs.core.rest.call(null,s__14586__$2);
s__14586__$1 = G__14595;
continue;
}
}
}
...
return (function (p1__14596_SHARP_){return add_to_set.call(null,p1__14596_SHARP_,args);
});})(key,add_to_set))
...
return (function (db__$1,p__14600){var vec__14601 = p__14600;var is_indexed = cljs.core.nth.call(null,vec__14601,0,null);var index_num = cljs.core.nth.call(null,vec__14601,1,null);var val = cljs.core.nth.call(null,vec__14601,2,null);if(cljs.core.truth_(is_indexed))
{return cljs.core.update_in.call(null,db__$1,cljs.core.PersistentVector.fromArray([key,index_num,val], true),((function (vec__14601,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update){
return (function (p1__14597_SHARP_){return add_to_set.call(null,p1__14597_SHARP_,args);
});})(vec__14601,is_indexed,index_num,val,key,add_to_set,db_with_fact,indexes_to_update))
);
} else
{return db__$1;
}
...
db_fact.cljs$lang$applyTo = (function (arglist__14602){
var db = cljs.core.first(arglist__14602);
arglist__14602 = cljs.core.next(arglist__14602);
var rel = cljs.core.first(arglist__14602);
...
return (function (p1__14603_SHARP_){return cljs.core.disj.call(null,p1__14603_SHARP_,args);
});})(key))
...
return (function (db__$1,p__14606){var vec__14607 = p__14606;var is_indexed = cljs.core.nth.call(null,vec__14607,0,null);var index_num = cljs.core.nth.call(null,vec__14607,1,null);var val = cljs.core.nth.call(null,vec__14607,2,null);if(cljs.core.truth_(is_indexed))
...
db_retraction.cljs$lang$applyTo = (function (arglist__14608){
var db = cljs.core.first(arglist__14608);
arglist__14608 = cljs.core.next(arglist__14608);
var rel = cljs.core.first(arglist__14608);
...
var db_facts__delegate = function (base_db,facts){return cljs.core.reduce.call(null,(function (p1__14609_SHARP_,p2__14610_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_fact,p1__14609_SHARP_,p2__14610_SHARP_);
}),base_db,facts);
};
...
db_facts.cljs$lang$applyTo = (function (arglist__14611){
var base_db = cljs.core.first(arglist__14611);
var facts = cljs.core.rest(arglist__14611);
...
db.cljs$lang$applyTo = (function (arglist__14612){
var facts = cljs.core.seq(arglist__14612);
...
var db_retractions__delegate = function (base_db,retractions){return cljs.core.reduce.call(null,(function (p1__14613_SHARP_,p2__14614_SHARP_){return cljs.core.apply.call(null,cljs.core.logic.pldb.db_retraction,p1__14613_SHARP_,p2__14614_SHARP_);
}),base_db,retractions);
};
...
db_retractions.cljs$lang$applyTo = (function (arglist__14615){
var base_db = cljs.core.first(arglist__14615);
var retractions = cljs.core.rest(arglist__14615);
