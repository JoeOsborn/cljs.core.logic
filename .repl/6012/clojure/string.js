...
{{
var G__16267 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16267;
continue;
}
} else
...
{var pred__16271 = cljs.core._EQ_;var expr__16272 = limit;if(pred__16271.call(null,1,expr__16272))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__16271.call(null,2,expr__16272))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__16274 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16275 = (limit__$1 - 1);
var G__16276 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16274;
limit__$1 = G__16275;
parts = G__16276;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___16278 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___16278))
{var replacement_16279 = temp__4092__auto___16278;buffer.append([cljs.core.str(replacement_16279)].join(''));
} else
{buffer.append(ch);
}
{
var G__16280 = (index + 1);
index = G__16280;
continue;
}
}
