...
{{
var G__26778 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26778;
continue;
}
} else
...
{var pred__26782 = cljs.core._EQ_;var expr__26783 = limit;if(pred__26782.call(null,1,expr__26783))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__26782.call(null,2,expr__26783))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__26785 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26786 = (limit__$1 - 1);
var G__26787 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__26785;
limit__$1 = G__26786;
parts = G__26787;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___26789 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___26789))
{var replacement_26790 = temp__4092__auto___26789;buffer.append([cljs.core.str(replacement_26790)].join(''));
} else
{buffer.append(ch);
}
{
var G__26791 = (index + 1);
index = G__26791;
continue;
}
}
