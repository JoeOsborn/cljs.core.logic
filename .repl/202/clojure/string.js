...
{{
var G__174719 = cljs.core.pop.call(null,v__$1);
v__$1 = G__174719;
continue;
}
} else
...
{var pred__174723 = cljs.core._EQ_;var expr__174724 = limit;if(cljs.core.truth_(pred__174723.call(null,1,expr__174724)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__174723.call(null,2,expr__174724)))
...
var G__174726 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__174727 = (limit__$1 - 1);
var G__174728 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__174726;
limit__$1 = G__174727;
parts = G__174728;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___174730 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___174730))
{var replacement_174731 = temp__4096__auto___174730;buffer.append([cljs.core.str(replacement_174731)].join(''));
} else
{buffer.append(ch);
}
{
var G__174732 = (index + 1);
index = G__174732;
continue;
}
}
