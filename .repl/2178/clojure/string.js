...
{{
var G__148667 = cljs.core.pop.call(null,v__$1);
v__$1 = G__148667;
continue;
}
} else
...
{var pred__148671 = cljs.core._EQ_;var expr__148672 = limit;if(cljs.core.truth_(pred__148671.call(null,1,expr__148672)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__148671.call(null,2,expr__148672)))
...
var G__148674 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__148675 = (limit__$1 - 1);
var G__148676 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__148674;
limit__$1 = G__148675;
parts = G__148676;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___148678 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___148678))
{var replacement_148679 = temp__4096__auto___148678;buffer.append([cljs.core.str(replacement_148679)].join(''));
} else
{buffer.append(ch);
}
{
var G__148680 = (index + 1);
index = G__148680;
continue;
}
}
