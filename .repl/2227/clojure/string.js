...
{{
var G__83294 = cljs.core.pop.call(null,v__$1);
v__$1 = G__83294;
continue;
}
} else
...
{var pred__83298 = cljs.core._EQ_;var expr__83299 = limit;if(pred__83298.call(null,1,expr__83299))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__83298.call(null,2,expr__83299))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__83301 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__83302 = (limit__$1 - 1);
var G__83303 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__83301;
limit__$1 = G__83302;
parts = G__83303;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___83305 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___83305))
{var replacement_83306 = temp__4092__auto___83305;buffer.append([cljs.core.str(replacement_83306)].join(''));
} else
{buffer.append(ch);
}
{
var G__83307 = (index + 1);
index = G__83307;
continue;
}
}
