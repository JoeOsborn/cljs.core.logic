...
* current assertion.
*/
cemerick.cljs.test.testing_vars_str = (function testing_vars_str(m){var map__83622 = m;var map__83622__$1 = ((cljs.core.seq_QMARK_.call(null,map__83622))?cljs.core.apply.call(null,cljs.core.hash_map,map__83622):map__83622);var line = cljs.core.get.call(null,map__83622__$1,new cljs.core.Keyword(null,"line","line",1017226086));var file = cljs.core.get.call(null,map__83622__$1,new cljs.core.Keyword(null,"file","file",1017047278));return [cljs.core.str(cljs.core.pr_str.call(null,cljs.core.reverse.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_))),cljs.core.str(" ("),cljs.core.str(file),cljs.core.str(":"),cljs.core.str(line),cljs.core.str(")")].join('');
});
/**
...
*/
cemerick.cljs.test.do_report = (function do_report(m){return cemerick.cljs.test.report.call(null,(function (){var G__83624 = new cljs.core.Keyword(null,"type","type",1017479852).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"error","error",1110689146),G__83624))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"fail","fail",1017039504),G__83624))
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83625;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"pass","pass",1017337731),(function (m){var _STAR_print_fn_STAR_83626 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83626;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"fail","fail",1017039504),(function (m){var _STAR_print_fn_STAR_83627 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___83628 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___83628))
{var message_83629 = temp__4094__auto___83628;cljs.core.println.call(null,message_83629);
} else
{}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83627;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"error","error",1110689146),(function (m){var _STAR_print_fn_STAR_83630 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
{}
var temp__4094__auto___83631 = new cljs.core.Keyword(null,"message","message",1968829305).cljs$core$IFn$_invoke$arity$1(m);if(cljs.core.truth_(temp__4094__auto___83631))
{var message_83632 = temp__4094__auto___83631;cljs.core.println.call(null,message_83632);
} else
{}
cljs.core.println.call(null,"expected:",cljs.core.pr_str.call(null,new cljs.core.Keyword(null,"expected","expected",3373152810).cljs$core$IFn$_invoke$arity$1(m)));
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83633;
}}));
cljs.core._add_method.call(null,cemerick.cljs.test.report,new cljs.core.Keyword(null,"begin-test-ns","begin-test-ns",1359210286),(function (m){var _STAR_print_fn_STAR_83634 = cljs.core._STAR_print_fn_STAR_;try{cljs.core._STAR_print_fn_STAR_ = (function (){var or__4704__auto__ = cemerick.cljs.test._STAR_test_print_fn_STAR_;if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return cljs.core._STAR_print_fn_STAR_;
}
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_83634;
}}));
...
register_fixtures_BANG_.cljs$lang$applyTo = (function (arglist__83635){
var ns_sym = cljs.core.first(arglist__83635);
arglist__83635 = cljs.core.next(arglist__83635);
var fixture_type = cljs.core.first(arglist__83635);
var fixture_fns = cljs.core.rest(arglist__83635);
...
{var t = temp__4094__auto__;var _STAR_testing_vars_STAR_83638 = cemerick.cljs.test._STAR_testing_vars_STAR_;try{cemerick.cljs.test._STAR_testing_vars_STAR_ = cljs.core.conj.call(null,cemerick.cljs.test._STAR_testing_vars_STAR_,(function (){var or__4704__auto__ = new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));if(cljs.core.truth_(or__4704__auto__))
{return or__4704__auto__;
} else
{return v;
}
...
try{t.call(null);
}catch (e83639){if((e83639 instanceof Error))
{var e_83640 = e83639;cemerick.cljs.test.do_report.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"message","message",1968829305),"Uncaught exception, not in assertion.",new cljs.core.Keyword(null,"expected","expected",3373152810),null,new cljs.core.Keyword(null,"actual","actual",3885931776),e_83640], true));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{throw e83639;
} else
...
}finally {cemerick.cljs.test._STAR_testing_vars_STAR_ = _STAR_testing_vars_STAR_83638;
}} else
{return null;
}
});
...
*/
cemerick.cljs.test.test_all_vars = (function test_all_vars(ns_sym){var once_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"once","once",1017319923).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));var each_fixture_fn = cemerick.cljs.test.join_fixtures.call(null,new cljs.core.Keyword(null,"each","each",1017009523).cljs$core$IFn$_invoke$arity$1(ns_sym.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_fixtures))));return once_fixture_fn.call(null,(function (){var seq__83645 = cljs.core.seq.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_tests),ns_sym));var chunk__83646 = null;var count__83647 = 0;var i__83648 = 0;while(true){
if((i__83648 < count__83647))
{var v = cljs.core._nth.call(null,chunk__83646,i__83648);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__83645,chunk__83646,count__83647,i__83648,v){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__83645,chunk__83646,count__83647,i__83648,v))
);
} else
{}
{
var G__83649 = seq__83645;
var G__83650 = chunk__83646;
var G__83651 = count__83647;
var G__83652 = (i__83648 + 1);
seq__83645 = G__83649;
chunk__83646 = G__83650;
count__83647 = G__83651;
i__83648 = G__83652;
continue;
}
} else
{var temp__4094__auto__ = cljs.core.seq.call(null,seq__83645);if(temp__4094__auto__)
{var seq__83645__$1 = temp__4094__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__83645__$1))
{var c__5421__auto__ = cljs.core.chunk_first.call(null,seq__83645__$1);{
var G__83653 = cljs.core.chunk_rest.call(null,seq__83645__$1);
var G__83654 = c__5421__auto__;
var G__83655 = cljs.core.count.call(null,c__5421__auto__);
var G__83656 = 0;
seq__83645 = G__83653;
chunk__83646 = G__83654;
count__83647 = G__83655;
i__83648 = G__83656;
continue;
}
} else
{var v = cljs.core.first.call(null,seq__83645__$1);if(cljs.core.truth_(new cljs.core.Keyword(null,"test","test",1017460740).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v))))
{each_fixture_fn.call(null,((function (seq__83645,chunk__83646,count__83647,i__83648,v,seq__83645__$1,temp__4094__auto__){
return (function (){return cemerick.cljs.test.test_function.call(null,v);
});})(seq__83645,chunk__83646,count__83647,i__83648,v,seq__83645__$1,temp__4094__auto__))
);
} else
{}
{
var G__83657 = cljs.core.next.call(null,seq__83645__$1);
var G__83658 = null;
var G__83659 = 0;
var G__83660 = 0;
seq__83645 = G__83657;
chunk__83646 = G__83658;
count__83647 = G__83659;
i__83648 = G__83660;
continue;
}
}
...
* *report-counters*.
*/
cemerick.cljs.test.test_ns = (function test_ns(ns_sym){var _STAR_report_counters_STAR_83662 = cemerick.cljs.test._STAR_report_counters_STAR_;try{cemerick.cljs.test._STAR_report_counters_STAR_ = cljs.core.atom.call(null,cemerick.cljs.test._STAR_initial_report_counters_STAR_);
...
var temp__4092__auto___83663 = cljs.core.get.call(null,cljs.core.deref.call(null,cemerick.cljs.test.registered_test_hooks),ns_sym);if(cljs.core.truth_(temp__4092__auto___83663))
{var test_hook_83664 = temp__4092__auto___83663;test_hook_83664.call(null);
} else
...
}finally {cemerick.cljs.test._STAR_report_counters_STAR_ = _STAR_report_counters_STAR_83662;
}});
/**
...
run_tests_STAR_.cljs$lang$applyTo = (function (arglist__83665){
var namespaces = cljs.core.seq(arglist__83665);
...
var run_all_tests__1 = (function (re){return cljs.core.apply.call(null,cemerick.cljs.test.run_tests_STAR_,cljs.core.filter.call(null,(function (p1__83666_SHARP_){return cljs.core.re_matches.call(null,re,cljs.core.name.call(null,p1__83666_SHARP_));
