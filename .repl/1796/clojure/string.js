...
{{
var G__253474 = cljs.core.pop.call(null,v__$1);
v__$1 = G__253474;
continue;
}
} else
...
{var pred__253478 = cljs.core._EQ_;var expr__253479 = limit;if(pred__253478.call(null,1,expr__253479))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__253478.call(null,2,expr__253479))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__253481 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__253482 = (limit__$1 - 1);
var G__253483 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__253481;
limit__$1 = G__253482;
parts = G__253483;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___253485 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___253485))
{var replacement_253486 = temp__4092__auto___253485;buffer.append([cljs.core.str(replacement_253486)].join(''));
} else
{buffer.append(ch);
}
{
var G__253487 = (index + 1);
index = G__253487;
continue;
}
}
