...
{{
var G__16300 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16300;
continue;
}
} else
...
{var pred__16304 = cljs.core._EQ_;var expr__16305 = limit;if(cljs.core.truth_(pred__16304.call(null,1,expr__16305)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16304.call(null,2,expr__16305)))
...
var G__16307 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16308 = (limit__$1 - 1);
var G__16309 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16307;
limit__$1 = G__16308;
parts = G__16309;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___16311 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___16311))
{var replacement_16312 = temp__4096__auto___16311;buffer.append([cljs.core.str(replacement_16312)].join(''));
} else
{buffer.append(ch);
}
{
var G__16313 = (index + 1);
index = G__16313;
continue;
}
}
