...
{{
var G__39998 = cljs.core.pop.call(null,v__$1);
v__$1 = G__39998;
continue;
}
} else
...
{var pred__40002 = cljs.core._EQ_;var expr__40003 = limit;if(pred__40002.call(null,1,expr__40003))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__40002.call(null,2,expr__40003))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__40005 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__40006 = (limit__$1 - 1);
var G__40007 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__40005;
limit__$1 = G__40006;
parts = G__40007;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___40009 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___40009))
{var replacement_40010 = temp__4092__auto___40009;buffer.append([cljs.core.str(replacement_40010)].join(''));
} else
{buffer.append(ch);
}
{
var G__40011 = (index + 1);
index = G__40011;
continue;
}
}
