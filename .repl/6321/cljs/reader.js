...
reader_error.cljs$lang$applyTo = (function (arglist__9288){
var rdr = cljs.core.first(arglist__9288);
var msg = cljs.core.rest(arglist__9288);
...
{{
var G__9289 = (function (){sb.append(ch);
return sb;
})();
var G__9290 = cljs.reader.read_char.call(null,rdr);
sb = G__9289;
ch = G__9290;
continue;
}
...
{{
var G__9291 = cljs.reader.read_char.call(null,rdr);
ch = G__9291;
continue;
}
} else
...
var G__9292 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9292;
continue;
}
} else
...
var G__9293 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9293;
continue;
}
}
...
{{
var G__9294 = (function (){buffer.append(ch);
return buffer;
})();
...
{if(("\\" === ch))
{{
var G__9296 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__9298 = (function (){buffer.append(ch);
return buffer;
})();
var G__9299 = cljs.reader.read_char.call(null,reader);
buffer = G__9298;
ch = G__9299;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9301 = o;if(G__9301)
{var bit__5323__auto__ = (G__9301.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9301.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9301.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9301);
} else
{return false;
}
}
...
{{
var G__9302 = reader;
var G__9303 = eof_is_error;
var G__9304 = sentinel;
var G__9305 = is_recursive;
reader = G__9302;
eof_is_error = G__9303;
sentinel = G__9304;
is_recursive = G__9305;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9306 = cljs.reader.read_comment.call(null,reader,ch);
var G__9307 = eof_is_error;
var G__9308 = sentinel;
var G__9309 = is_recursive;
reader = G__9306;
eof_is_error = G__9307;
sentinel = G__9308;
is_recursive = G__9309;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9316 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9316,0,null);var years = cljs.core.nth.call(null,vec__9316,1,null);var months = cljs.core.nth.call(null,vec__9316,2,null);var days = cljs.core.nth.call(null,vec__9316,3,null);var hours = cljs.core.nth.call(null,vec__9316,4,null);var minutes = cljs.core.nth.call(null,vec__9316,5,null);var seconds = cljs.core.nth.call(null,vec__9316,6,null);var fraction = cljs.core.nth.call(null,vec__9316,7,null);var offset_sign = cljs.core.nth.call(null,vec__9316,8,null);var offset_hours = cljs.core.nth.call(null,vec__9316,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9316,10,null);var v = vec__9316;if(cljs.core.not.call(null,v))
...
{var vec__9318 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9318,0,null);var months = cljs.core.nth.call(null,vec__9318,1,null);var days = cljs.core.nth.call(null,vec__9318,2,null);var hours = cljs.core.nth.call(null,vec__9318,3,null);var minutes = cljs.core.nth.call(null,vec__9318,4,null);var seconds = cljs.core.nth.call(null,vec__9318,5,null);var ms = cljs.core.nth.call(null,vec__9318,6,null);var offset = cljs.core.nth.call(null,vec__9318,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
