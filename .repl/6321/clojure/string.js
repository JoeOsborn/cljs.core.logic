...
{{
var G__9319 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9319;
continue;
}
} else
...
{var pred__9323 = cljs.core._EQ_;var expr__9324 = limit;if(pred__9323.call(null,1,expr__9324))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9323.call(null,2,expr__9324))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9326 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9327 = (limit__$1 - 1);
var G__9328 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9326;
limit__$1 = G__9327;
parts = G__9328;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9330 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9330))
{var replacement_9331 = temp__4092__auto___9330;buffer.append([cljs.core.str(replacement_9331)].join(''));
} else
{buffer.append(ch);
}
{
