...
{{
var G__45930 = cljs.core.pop.call(null,v__$1);
v__$1 = G__45930;
continue;
}
} else
...
{var pred__45934 = cljs.core._EQ_;var expr__45935 = limit;if(cljs.core.truth_(pred__45934.call(null,1,expr__45935)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__45934.call(null,2,expr__45935)))
...
var G__45937 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__45938 = (limit__$1 - 1);
var G__45939 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__45937;
limit__$1 = G__45938;
parts = G__45939;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___45941 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___45941))
{var replacement_45942 = temp__4096__auto___45941;buffer.append([cljs.core.str(replacement_45942)].join(''));
} else
{buffer.append(ch);
}
{
var G__45943 = (index + 1);
index = G__45943;
continue;
}
}
