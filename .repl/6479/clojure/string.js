...
{{
var G__9331 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9331;
continue;
}
} else
...
{var pred__9335 = cljs.core._EQ_;var expr__9336 = limit;if(pred__9335.call(null,1,expr__9336))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__9335.call(null,2,expr__9336))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__9338 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9339 = (limit__$1 - 1);
var G__9340 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9338;
limit__$1 = G__9339;
parts = G__9340;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___9342 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___9342))
{var replacement_9343 = temp__4092__auto___9342;buffer.append([cljs.core.str(replacement_9343)].join(''));
} else
{buffer.append(ch);
}
{
