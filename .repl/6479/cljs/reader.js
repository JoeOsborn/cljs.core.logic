...
reader_error.cljs$lang$applyTo = (function (arglist__9300){
var rdr = cljs.core.first(arglist__9300);
var msg = cljs.core.rest(arglist__9300);
...
{{
var G__9301 = (function (){sb.append(ch);
return sb;
})();
var G__9302 = cljs.reader.read_char.call(null,rdr);
sb = G__9301;
ch = G__9302;
continue;
}
...
{{
var G__9303 = cljs.reader.read_char.call(null,rdr);
ch = G__9303;
continue;
}
} else
...
var G__9304 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9304;
continue;
}
} else
...
var G__9305 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9305;
continue;
}
}
...
{if(("\\" === ch))
{{
var G__9308 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9309 = cljs.reader.read_char.call(null,reader);
buffer = G__9308;
ch = G__9309;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9313 = o;if(G__9313)
{var bit__5323__auto__ = (G__9313.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__9313.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__9313.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__9313);
} else
{return false;
}
}
...
{{
var G__9318 = cljs.reader.read_comment.call(null,reader,ch);
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9328 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9328,0,null);var years = cljs.core.nth.call(null,vec__9328,1,null);var months = cljs.core.nth.call(null,vec__9328,2,null);var days = cljs.core.nth.call(null,vec__9328,3,null);var hours = cljs.core.nth.call(null,vec__9328,4,null);var minutes = cljs.core.nth.call(null,vec__9328,5,null);var seconds = cljs.core.nth.call(null,vec__9328,6,null);var fraction = cljs.core.nth.call(null,vec__9328,7,null);var offset_sign = cljs.core.nth.call(null,vec__9328,8,null);var offset_hours = cljs.core.nth.call(null,vec__9328,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9328,10,null);var v = vec__9328;if(cljs.core.not.call(null,v))
...
{var vec__9330 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__9330,0,null);var months = cljs.core.nth.call(null,vec__9330,1,null);var days = cljs.core.nth.call(null,vec__9330,2,null);var hours = cljs.core.nth.call(null,vec__9330,3,null);var minutes = cljs.core.nth.call(null,vec__9330,4,null);var seconds = cljs.core.nth.call(null,vec__9330,5,null);var ms = cljs.core.nth.call(null,vec__9330,6,null);var offset = cljs.core.nth.call(null,vec__9330,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
