...
{{
var G__226071 = cljs.core.pop.call(null,v__$1);
v__$1 = G__226071;
continue;
}
} else
...
{var pred__226075 = cljs.core._EQ_;var expr__226076 = limit;if(cljs.core.truth_(pred__226075.call(null,1,expr__226076)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__226075.call(null,2,expr__226076)))
...
var G__226078 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__226079 = (limit__$1 - 1);
var G__226080 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__226078;
limit__$1 = G__226079;
parts = G__226080;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___226082 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___226082))
{var replacement_226083 = temp__4096__auto___226082;buffer.append([cljs.core.str(replacement_226083)].join(''));
} else
{buffer.append(ch);
}
{
var G__226084 = (index + 1);
index = G__226084;
continue;
}
}
