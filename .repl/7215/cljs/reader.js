...
reader_error.cljs$lang$applyTo = (function (arglist__15098){
var rdr = cljs.core.first(arglist__15098);
var msg = cljs.core.rest(arglist__15098);
...
{{
var G__15099 = (function (){sb.append(ch);
return sb;
})();
var G__15100 = cljs.reader.read_char.call(null,rdr);
sb = G__15099;
ch = G__15100;
continue;
}
...
{{
var G__15101 = cljs.reader.read_char.call(null,rdr);
ch = G__15101;
continue;
}
} else
...
var G__15102 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__15102;
continue;
}
} else
...
var G__15103 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__15103;
continue;
}
}
...
{{
var G__15104 = (function (){buffer.append(ch);
return buffer;
})();
var G__15105 = cljs.reader.read_char.call(null,reader);
buffer = G__15104;
ch = G__15105;
continue;
}
...
{if(("\\" === ch))
{{
var G__15106 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__15107 = cljs.reader.read_char.call(null,reader);
buffer = G__15106;
ch = G__15107;
continue;
}
...
{{
var G__15108 = (function (){buffer.append(ch);
return buffer;
})();
var G__15109 = cljs.reader.read_char.call(null,reader);
buffer = G__15108;
ch = G__15109;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__15111 = o;if(G__15111)
{var bit__5323__auto__ = (G__15111.cljs$lang$protocol_mask$partition0$ & 262144);if((bit__5323__auto__) || (G__15111.cljs$core$IWithMeta$))
{return true;
} else
{if((!G__15111.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IWithMeta,G__15111);
} else
{return false;
}
}
...
{{
var G__15112 = reader;
var G__15113 = eof_is_error;
var G__15114 = sentinel;
var G__15115 = is_recursive;
reader = G__15112;
eof_is_error = G__15113;
sentinel = G__15114;
is_recursive = G__15115;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__15116 = cljs.reader.read_comment.call(null,reader,ch);
var G__15117 = eof_is_error;
var G__15118 = sentinel;
var G__15119 = is_recursive;
reader = G__15116;
eof_is_error = G__15117;
sentinel = G__15118;
is_recursive = G__15119;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__15120 = reader;
var G__15121 = eof_is_error;
var G__15122 = sentinel;
var G__15123 = is_recursive;
reader = G__15120;
eof_is_error = G__15121;
sentinel = G__15122;
is_recursive = G__15123;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__15126 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__15126,0,null);var years = cljs.core.nth.call(null,vec__15126,1,null);var months = cljs.core.nth.call(null,vec__15126,2,null);var days = cljs.core.nth.call(null,vec__15126,3,null);var hours = cljs.core.nth.call(null,vec__15126,4,null);var minutes = cljs.core.nth.call(null,vec__15126,5,null);var seconds = cljs.core.nth.call(null,vec__15126,6,null);var fraction = cljs.core.nth.call(null,vec__15126,7,null);var offset_sign = cljs.core.nth.call(null,vec__15126,8,null);var offset_hours = cljs.core.nth.call(null,vec__15126,9,null);var offset_minutes = cljs.core.nth.call(null,vec__15126,10,null);var v = vec__15126;if(cljs.core.not.call(null,v))
...
{var vec__15128 = temp__4092__auto__;var years = cljs.core.nth.call(null,vec__15128,0,null);var months = cljs.core.nth.call(null,vec__15128,1,null);var days = cljs.core.nth.call(null,vec__15128,2,null);var hours = cljs.core.nth.call(null,vec__15128,3,null);var minutes = cljs.core.nth.call(null,vec__15128,4,null);var seconds = cljs.core.nth.call(null,vec__15128,5,null);var ms = cljs.core.nth.call(null,vec__15128,6,null);var offset = cljs.core.nth.call(null,vec__15128,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
