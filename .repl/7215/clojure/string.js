...
{{
var G__15129 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15129;
continue;
}
} else
...
{var pred__15133 = cljs.core._EQ_;var expr__15134 = limit;if(pred__15133.call(null,1,expr__15134))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__15133.call(null,2,expr__15134))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__15136 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15137 = (limit__$1 - 1);
var G__15138 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15136;
limit__$1 = G__15137;
parts = G__15138;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___15140 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___15140))
{var replacement_15141 = temp__4092__auto___15140;buffer.append([cljs.core.str(replacement_15141)].join(''));
} else
{buffer.append(ch);
}
{
var G__15142 = (index + 1);
index = G__15142;
continue;
}
}
