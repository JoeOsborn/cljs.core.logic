...
{{
var G__34895 = cljs.core.pop.call(null,v__$1);
v__$1 = G__34895;
continue;
}
} else
...
{var pred__34899 = cljs.core._EQ_;var expr__34900 = limit;if(cljs.core.truth_(pred__34899.call(null,1,expr__34900)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__34899.call(null,2,expr__34900)))
...
var G__34902 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__34903 = (limit__$1 - 1);
var G__34904 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__34902;
limit__$1 = G__34903;
parts = G__34904;
continue;
...
{var ch = s.charAt(index);var temp__4096__auto___34906 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4096__auto___34906))
{var replacement_34907 = temp__4096__auto___34906;buffer.append([cljs.core.str(replacement_34907)].join(''));
} else
{buffer.append(ch);
}
{
var G__34908 = (index + 1);
index = G__34908;
continue;
}
}
