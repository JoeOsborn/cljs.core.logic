...
{{
var G__35664 = cljs.core.pop.call(null,v__$1);
v__$1 = G__35664;
continue;
}
} else
...
{var pred__35668 = cljs.core._EQ_;var expr__35669 = limit;if(pred__35668.call(null,1,expr__35669))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__35668.call(null,2,expr__35669))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__35671 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__35672 = (limit__$1 - 1);
var G__35673 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__35671;
limit__$1 = G__35672;
parts = G__35673;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___35675 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___35675))
{var replacement_35676 = temp__4092__auto___35675;buffer.append([cljs.core.str(replacement_35676)].join(''));
} else
{buffer.append(ch);
}
{
var G__35677 = (index + 1);
index = G__35677;
continue;
}
}
