...
{{
var G__19932 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19932;
continue;
}
} else
...
{var pred__19936 = cljs.core._EQ_;var expr__19937 = limit;if(pred__19936.call(null,1,expr__19937))
{return cljs.core.PersistentVector.fromArray.call(null,[s],true);
} else
{if(pred__19936.call(null,2,expr__19937))
{return cljs.core.PersistentVector.fromArray.call(null,["",s],true);
} else
...
var G__19939 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19940 = (limit__$1 - 1);
var G__19941 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19939;
limit__$1 = G__19940;
parts = G__19941;
continue;
...
{var ch = s.charAt(index);var temp__4092__auto___19943 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4092__auto___19943))
{var replacement_19944 = temp__4092__auto___19943;buffer.append([cljs.core.str(replacement_19944)].join(''));
} else
{buffer.append(ch);
}
{
var G__19945 = (index + 1);
index = G__19945;
continue;
}
}
