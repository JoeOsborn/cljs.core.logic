...
(deftest test-nom-2
  ...
  (is (= (run* [q] (fresh [x]  (nom/fresh [a b] (nom/hash a x) (nom/hash b x) (== [x a b] q)))) '(([_0 a_1 a_2] :- a_1#_0 a_2#_0))))
  ...
  (is (= (run* [q]
           (nom/fresh [a b]
             (fresh [x y]
               ...
               (== [a b x y] q))))
         '(([a_0 a_1 _2 _3] :- (swap [a_0 a_1] _3 _2) a_1#_2))))
  (is (= (run* [q]
           (nom/fresh [a b]
             (fresh [x y]
               (== (nom/tie a (nom/tie a x)) (nom/tie a (nom/tie b y)))
